...
| CHECK                                                      | 更改 `CHECK` 约束。 支持如下操作： * 添加新的 `CHECK`  约束。   * 删除当前名称为 `constraint_name` 的 `CHECK` 约束。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| \[NOT\] ENFORCED                                           | 是否强制执行名为 `constraint_name` 的 `CHECK` 约束。 * 如果省略或指定为 `ENFORCED`，则创建并强制执行约束，为默认状态。   * 如果指定为 `NOT ENFORCED`，则创建约束但不强制执行。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
* 设置表 `tbl1` 的副本数。
  ...
  ```sql
  obclient> ALTER TABLE tbl1 SET REPLICA_NUM=2;
