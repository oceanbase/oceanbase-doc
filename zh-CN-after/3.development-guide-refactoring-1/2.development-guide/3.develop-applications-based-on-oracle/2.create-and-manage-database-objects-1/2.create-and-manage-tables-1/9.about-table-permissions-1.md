...
2. 查看用户 `ny` 的权限。
   ...
   **说明**
   ...
   更多查看用户权限操作，请参见 [查看用户权限](../../../../../5.administrator-guide/2.basic-database-management/4.manage-tenants-1/5.manage-users-and-permissions/2.oracle-3/4.view-user-permissions.md)。
