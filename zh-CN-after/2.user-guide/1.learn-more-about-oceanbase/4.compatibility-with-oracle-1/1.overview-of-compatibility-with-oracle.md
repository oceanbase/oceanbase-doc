...
Oracle 数据库中有 24 个数据类型，OceanBase 数据库目前支持 20 种，详细支持信息请参见 [SQL 数据类型](../4.compatibility-with-oracle-1/2.sql-data-type-1.md)。基于优化考虑，`LONG` 和 `LONG RAW` 数据类型过于老旧，OceanBase 数据库暂不计划支持这两种数据类型。

>**说明**
>
>OceanBase 数据库中大对象数据类型有 48 MB 的大小限制且性能不佳，所以不推荐在复杂场景下使用。详细信息请参见 [大对象数据类型](../../11.sql-reference-oracle-mode/3.basic-elements-1/1.built-in-data-types/6.large-object-data-type/1.data-types-of-large-objects.md)。

## 内建函数

Oracle 数据库中支持内建函数 257 个，OceanBase 数据库当前支持 155 个，详细支持信息请参见 [内建函数](../4.compatibility-with-oracle-1/3.built-in-functions.md)。
...
关于 Hint 的详细说明，请参见《SQL 参考（Oracle 模式）》[Hint](../../11.sql-reference-oracle-mode/3.basic-elements-1/6.annotation-1/4.Hint/1.hint-overview.md)章节。
...
更多 PL 功能的详细信息请参见《[PL 参考](../../9.pl-reference/1.what-is-pl-1/1.pl-introduction-1.md)》。
...
关于兼容的详细视图列表请参见 [系统视图](../4.compatibility-with-oracle-1/4.system-view.md)。

更多系统视图的字段说明信息请参考《参考指南（Oracle 模式）》文档中 [系统视图](../../13.reference-oracle-mode/1.system-view-5/2.dictionary-view-6/2.ALL_ALL_TABLES-1.md) 章节。
...
关于创建、修改、删除表的详细语法，请参见 [CREATE TABLE](../../11.sql-reference-oracle-mode/9.sql-statement-1/1.DDL-1/24.create-table-1.md)、[ALTER TABLE](../../11.sql-reference-oracle-mode/9.sql-statement-1/1.DDL-1/10.alter-table-1.md)、[DROP TABLE](../../11.sql-reference-oracle-mode/9.sql-statement-1/1.DDL-1/39.drop-table-1.md)。
...
更多分区的说明及使用请参见《管理员指南》文档中的 [分区概述](../../5.administrator-guide/5.distributed-storage-management/2.manage-partition-table/1.oracle-1/1.partition-overview-5.md) 章节。
...
更多 OceanBase 数据库物理备份恢复特性的介绍请参见《OceanBase 数据库系统架构》文档中的 [备份恢复概述](../../2.concepts-of-oceanbase-database-system/9.high-data-reliability-and-availability/5.backup-and-restoration/1.backup-and-restoration-overview.md) 章节。
...
更多 OceanBase 数据库的高可用特性介绍请参见《OceanBase 数据库系统概念》文档中的 [高可用架构概述](../../2.concepts-of-oceanbase-database-system/9.high-data-reliability-and-availability/1.high-availability-architecture/1.overview-of-a-highly-available-architecture.md)[高可用方案](t1998128.md#)章节。
...
更多 SQL 引擎的详细信息请参见《[SQL 调优指南](../../6.performance-tuning/5.sql-optimization/1.sql-request-execution-process-1.md)》。
