...
| [执行全量恢复](6.administrator-guide/8.high-data-availability/2.manage-backup-and-restoration/4.restore-data/1.perform-full-restoration.md)                                |[SQL 语法](10.sql-reference/5.sql-statements/1.general-syntax.md)                                                                                |[查看错误信息](13.reference-guide/4.error-codes/1.overview-of-error-messages.md)     |
