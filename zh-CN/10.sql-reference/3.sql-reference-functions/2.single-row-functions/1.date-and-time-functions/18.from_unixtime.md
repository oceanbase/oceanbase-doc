...
有关 `format` 支持的格式的详细信息，请参见 [DATE_FORMAT](/zh-CN/10.sql-reference/3.sql-reference-functions/2.single-row-functions/1.date-and-time-functions/10.date_format.md)。
