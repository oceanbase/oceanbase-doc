...
该函数的第一种声明是 `DATE_ADD()` 的同义词。有关 `unit` 参数的详细信息，请参见 [DATE_ADD](/zh-CN/10.sql-reference/3.sql-reference-functions/2.single-row-functions/1.date-and-time-functions/9.date_add.md)。
