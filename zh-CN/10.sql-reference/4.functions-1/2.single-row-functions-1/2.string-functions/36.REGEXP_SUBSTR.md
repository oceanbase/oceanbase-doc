...
* `match_param` 表示匹配规则，字符串类型。有关匹配规则的详细信息，请参见 [REGEXP_LIKE](/zh-CN/10.sql-reference/4.functions-1/2.single-row-functions-1/2.string-functions/34.REGEXP_LIKE.md)。
