...
有关参数 `unit` 的详细信息，请参见 [DATE_ADD](/zh-CN/10.sql-reference/4.functions-1/2.single-row-functions-1/1.date-and-time-functions/9.DATE_ADD.md)。当 `unit` 为 `WEEK` 时，以周日为每周第一天。
