...
|                         **子程序**                          |     **描述**      |
|----------------------------------------------------------|-----------------|
| [DISABLE](/zh-CN/9.pl-reference/13.pl-system-package/11.DBMS_OUTPUT/2.DISABLE.md)   | 禁用消息输出。         |
| [ENABLE](/zh-CN/9.pl-reference/13.pl-system-package/11.DBMS_OUTPUT/3.ENABLE.md)    | 开启消息输出。         |
| [GET_LINE](/zh-CN/9.pl-reference/13.pl-system-package/11.DBMS_OUTPUT/4.GET_LINE.md)  | 从缓冲区中检索一行数据。    |
| [GET_LINES](/zh-CN/9.pl-reference/13.pl-system-package/11.DBMS_OUTPUT/5.GET_LINES.md) | 从缓冲区检索一组行数据。    |
| [NEW_LINE](/zh-CN/9.pl-reference/13.pl-system-package/11.DBMS_OUTPUT/6.NEW_LINE.md)  | 终止用 `PUT` 创建的行。 |
| [PUT](/zh-CN/9.pl-reference/13.pl-system-package/11.DBMS_OUTPUT/7.PUT.md)       | 将部分行数据放入缓冲区。    |
| [PUT_LINE](/zh-CN/9.pl-reference/13.pl-system-package/11.DBMS_OUTPUT/8.PUT_LINE.md)  | 将单行数据放入缓冲区。     |
