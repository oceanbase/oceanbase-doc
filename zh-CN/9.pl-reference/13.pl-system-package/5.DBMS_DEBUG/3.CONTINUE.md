...
|----------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| run_info       | 有关程序状态的信息。                                                                                                                                                             |
| breakflags     | 感兴趣事件的掩码，暂时仅支持 break_next_line、break_any_call、break_any_return 和 abort_execute。 详细信息请参考 [Breakflags](/zh-CN/9.pl-reference/13.pl-system-package/5.DBMS_DEBUG/1.dbms_debug-overview.md)。 |
