...
* 6 节点硬件配置
  ...
  |     服务类型      |     ECS 类型     | 实例数 | 机器核心数 |  内存  |
  |---------------|----------------|-----|------|------|
  | OceanBase 数据库 | ecs.g7.8xlarge | 6   | 3   |  32c  | 128G |
  | TPC-H         | ecs.g7.8xlarge | 1   | 3   |  32c  | 128G |
...
* 测试数据量：100G。
* 测试步骤详见 [OceanBase 数据库 TPC-H 测试](../300.performance-whitepaper/100.run-the-tpc-h-benchmark-on-oceanbase-database.md)。
