...
有关 OceanBase Connector/C 的详细介绍，请参见 [OceanBase Connector/C](../../../500.oceanbase-database-overview/500.data-links/300.database-drivers/400.oceanbase-database-overview-oceanbase-connector-c.md)。
