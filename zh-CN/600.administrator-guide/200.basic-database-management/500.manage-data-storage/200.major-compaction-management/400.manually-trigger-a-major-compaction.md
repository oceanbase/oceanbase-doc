...
3. 执行以下语句，打开手动合并开关。
   ...
   关于配置项 `enable_manual_merge` 的更多信息，请参见 [enable_manual_merge](../../../../1200.reference-guide/300.system-configuration-items/6200.enable_manual_merge.md)。
...
* [自动触发合并](../200.major-compaction-management/200.automatically-trigger-a-major-compaction.md)
