...
更多 `GRANT` 语句的信息请参见 [GRANT](../../../../1000.sql-reference/500.sql-statements/4100.grant.md)。
...
更多 `REVOKE` 语句的信息请参见 [REVOKE](../../../../1000.sql-reference/500.sql-statements/5300.revoke.md)。
