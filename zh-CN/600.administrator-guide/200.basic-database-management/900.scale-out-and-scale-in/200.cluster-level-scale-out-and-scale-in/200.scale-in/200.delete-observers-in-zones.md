...
2. 根据业务需要，调整租户的资源池，即在每个 Zone 内缩小 Unit 规格或减少 Unit 数量。
   ...
   **注意**
   ...
   通过 OCP 修改资源池的操作请参见 [管理资源池](../../../300.manage-resources/500.manage-resource-pools/100.allocate-resource-pools-to-tenants.md)。
   

3. 依次从 3 个 Zone 内减少 1 台 OBServer。

   通过 OCP 从 Zone 内删除 OBServer 的相关操作请参见 [删除 OBServer](../../../100.manage-clusters/500.manage-observers/600.delete-an-observer.md)。
