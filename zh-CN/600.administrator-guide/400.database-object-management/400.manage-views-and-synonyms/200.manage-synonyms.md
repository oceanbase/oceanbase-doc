...
`CREATE SYNONYM` 语句的更多信息，请参见《SQL 参考》文档中的 [CREATE SYNONYM](../../../6.administrator-guide/4.database-object-management/4.manage-views-and-synonyms/2.manage-synonyms.md) 章节。
...
`DROP SYNONYM` 语句的更多信息，请参见《SQL 参考》文档中的 [DROP SYNONYM](../../../6.administrator-guide/4.database-object-management/4.manage-views-and-synonyms/2.manage-synonyms.md) 章节。
