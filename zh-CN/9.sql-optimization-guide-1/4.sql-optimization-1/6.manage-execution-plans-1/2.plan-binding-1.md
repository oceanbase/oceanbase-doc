...
* Hint 格式为` /*+ xxx */`，关于 Hint 说明的详细信息，请参考 [Optimizer Hint。](/zh-CN/9.sql-optimization-guide-1/4.sql-optimization-1/6.manage-execution-plans-1/1.optimizer-hint-1.md)
...
3. 确定生成的执行计划是否符合预期。
   ...
   [实时执行计划展示](/zh-CN/9.sql-optimization-guide-1/2.sql-execution-plan-3/5.real-time-execution-plan-display-3.md)。
