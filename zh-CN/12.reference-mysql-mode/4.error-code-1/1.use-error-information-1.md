...
|------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 错误码范围                                                                  | 说明                                                                                                                                                                                                                                                                                                                    |
| [0001 \~ 3999](/zh-CN/12.reference-mysql-mode/4.error-code-1/2.0001-3999.md)            | 兼容 MySQL 的错误信息。 * 有关 MySQL 服务端错误码请参见 https://dev.mysql.com/doc/mysql-errors/8.0/en/server-error-reference.html   * 有关 MySQL 客户端错误码请参见 https://dev.mysql.com/doc/mysql-errors/8.0/en/client-error-reference.html    |
| [4000 \~ 4499](/zh-CN/12.reference-mysql-mode/4.error-code-1/3.4000-4499.md)            | 通用错误码。                                                                                                                                                                                                                                                                                                                |
