...
* `workers_per_cpu_quota`表示租户在每个cpu上能分配的最大 worker 数
  ...
  workers_per_cpu_quota 配置项详细信息，请参见 [workers_per_cpu_quota](/zh-CN/12.reference-mysql-mode/3.system-configuration-items-1/3.cluster-level-configuration-items-1/232.workers_per_cpu_quota-1-2-3.md)。
