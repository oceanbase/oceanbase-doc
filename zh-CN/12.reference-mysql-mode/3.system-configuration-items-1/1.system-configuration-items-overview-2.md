...
有关配置项的相关信息，请参见 [系统配置项总览](../3.system-configuration-items-1/2.system-configuration-items-overview-3.md)。

更多配置项的查看和设置操作，请参见《管理员指南》的 [设置参数](../../5.administrator-guide/2.basic-database-management/2.configuration-management/2.set-parameters.md) 章节。
