...
* 通过 `ROLLBACK TO SAVEPOINT` 语句回滚到指定事务保存点。
  ...
  回滚的详细说明，请参考 [回滚事务](/zh-CN/7.development-guide-refactoring-1/2.development-guide/2.mysql-based-application-development/5.about-dml-statements-and-transactions/2.transaction-3/5.roll-back-transactions-2.md)。
