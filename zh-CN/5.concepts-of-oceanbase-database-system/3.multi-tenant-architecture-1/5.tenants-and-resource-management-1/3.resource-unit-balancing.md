# 资源单元的均衡
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/resource-unit-balancing
...
* `enable_rebalance`
  ...
  有关分区副本均衡的详细信息请参见 [自动负载均衡](../../5.distributed-database-objects/3.data-partitions-and-replicas/5.data-balancing-1/1.partition-copy-balancing/1.automatic-load-balancing.md)。
