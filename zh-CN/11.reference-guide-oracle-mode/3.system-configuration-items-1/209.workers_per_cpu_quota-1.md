...
* `cpu_quota_concurrency` 表示租户在每个 CPU 上活跃的工作线程数，也即并发数。`cpu_quota_concurrency` 配置项的详细信息，请参见 [cpu_quota_concurrency](/zh-CN/11.reference-guide-oracle-mode/3.system-configuration-items-1/35.cpu_quota_concurrency-1.md)。
