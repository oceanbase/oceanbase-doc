...
在 OceanBase 数据库的 MySQL 模式中，对函数索引的表达式进行了限制，禁止部分系统函数的表达式作为函数索引，具体的函数列表请参见 [函数索引支持的系统函数列表](../../../7.reference/2.administrator-guide/3.database-object-management/1.manage-object-of-mysql-mode/5.manage-indexes-of-mysql-mode/5.function-index-list-of-supported-functions-of-mysql-mode.md) 和 [函数索引不支持的系统函数列表](../../../7.reference/2.administrator-guide/3.database-object-management/1.manage-object-of-mysql-mode/5.manage-indexes-of-mysql-mode/6.function-index-list-of-not-supported-functions.md)。

您可以使用以下方法创建函数索引：

* [CREATE TABLE](../../../7.reference/4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/26.create-table-of-mysql-mode.md) 时添加函数索引：

  ```sql
  CREATE TABLE table_name({column_name data_type,[column_name data_type,...]} [UNIQUE| SPATIAL] {INDEX|KEY} [index_name](expr));
  ```

* [ALTER TABLE](../../../7.reference/4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/16.alter-table-of-mysql-mode.md) 时添加函数索引：

  ```sql
  ALTER TABLE table_name ADD [UNIQUE | SPATIAL] {INDEX | KEY} [index_name](expr);
  ```

* 通过 [CREATE INDEX](../../../7.reference/4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/22.create-index-of-mysql-mode.md) 语句创建函数索引：
