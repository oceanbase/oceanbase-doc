...
* 请确认您已连接到 OceanBase 数据库，连接数据库的操作请参见 [连接数据库（MySQL 模式）](../1.connect-to-oceanbase-database/1.connect-to-oceanbase-database-of-mysql-mode/1.connection-methods-overview-of-mysql-mode.md) 或者 [连接数据库（Oracle 模式）](../1.connect-to-oceanbase-database/2.connect-to-oceanbase-database-of-oracle-mode/1.connection-methods-overview-of-oracle-mode.md)。
...
更多 `CREATE EXTERNAL TABLE` 语句的详细信息，请参见 **CREATE EXTERNAL TABLE（MySQL 模式）** 和 **CREATE EXTERNAL TABLE（Oracle 模式）**。
...
2. 设置导入的文件路径。
    ...
    2. 执行以下命令，通过直连的方式连接租户 `mysql001`。
        ...
        更多连接数据库的信息，请参见 [连接数据库](../1.connect-to-oceanbase-database/1.connect-to-oceanbase-database-of-mysql-mode/1.connection-methods-overview-of-mysql-mode.md)。
...
* [连接数据库（MySQL 模式）](../1.connect-to-oceanbase-database/1.connect-to-oceanbase-database-of-mysql-mode/1.connection-methods-overview-of-mysql-mode.md)
