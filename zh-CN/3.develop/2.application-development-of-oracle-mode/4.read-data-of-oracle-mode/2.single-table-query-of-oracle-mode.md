...
此外，指定列的查询还支持 `WHERE` 条件查询，请参见 [条件查询](04.condition-query.md)。
更多用法请参见 [在查询中使用操作符和函数](09.Use-operators-and-functions-in-queries/01.use-arithmetic-operator-in-query.md)。
