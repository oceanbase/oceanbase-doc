...
2. 修改 `ny` 用户的密码。
   ...
   <main id="notice" type='explain'>
     <h4>说明</h4>
     <p>为用户设置密码时，用户密码需要符合当前租户的密码复杂度。密码复杂度相关操作及说明请参见 <a href="../../../../6.manage/5.security-and-permissions/2.identification-and-authentication/2.identification-and-authentication-of-oracle-mode/2.password-complexity-of-oracle-mode.md">密码复杂度</a>。</p>
   </main>
