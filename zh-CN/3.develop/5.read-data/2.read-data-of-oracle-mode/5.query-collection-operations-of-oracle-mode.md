...
更多集合查询语法的信息，请参见 [集合类 SELECT](../../../7.reference/4.development-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/2.dml-of-oracle-mode/5.select-of-oracle-mode/2.collection-select-of-oracle-mode.md)。
...
更多集合运算符的规则和限制的信息，请参见 [复合查询](../../../7.reference/4.development-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/8.queries-and-subqueries-of-oracle-mode/4.collection-of-oracle-mode.md)。
...
* [集合类 SELECT](../../../7.reference/4.development-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/2.dml-of-oracle-mode/5.select-of-oracle-mode/2.collection-select-of-oracle-mode.md)
* [复合查询](../../../7.reference/4.development-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/8.queries-and-subqueries-of-oracle-mode/4.collection-of-oracle-mode.md)
