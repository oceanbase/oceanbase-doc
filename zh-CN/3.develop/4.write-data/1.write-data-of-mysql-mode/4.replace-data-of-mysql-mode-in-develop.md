...
通常使用 [REPLACE INTO](../../../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/76.replace-of-mysql-mode.md) 语句替换表中的一条或多条记录。
...
* [删除数据](3.delete-data-of-mysql-mode-in-develop.md)
