...
视图 `V$OB_TRANSACTION_PARTICIPANTS` 中的字段及详细说明请参见 [V$OB_TRANSACTION_PARTICIPANTS](../../../7.reference/7.system-views/5.system-view-of-oracle-mode/3.performance-view-of-oracle-mode/49.v-ob_transaction_participants-of-oracle-mode.md)。
...
* [回滚事务](5.roll-back-transactions-of-oracle-mode.md)