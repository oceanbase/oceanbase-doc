...
视图 `$OB_TRANSACTION_PARTICIPANTS` 中的字段及详细说明请参见 [$OB_TRANSACTION_PARTICIPANTS](../../../7.reference/5.system-reference/5.system-view-of-oracle-mode/3.performance-view-of-oracle-mode/49.v-ob_transaction_participants-of-oracle-mode.md)。
