...
如果事务设置了保存点，可以使用 `ROLLBACK TO SAVEPOINT` 语句回滚到某个保存点。事务保存点相关说明请参见 [事务保存点](3.transaction-savepoints-of-mysql-mode/1.mark-a-savepoint-of-mysql-mode.md)。
...
回滚事务到某个还原点详细示例及说明，请参见 [回滚事务到某个保存点](3.transaction-savepoints-of-mysql-mode/2.rollback-to-a-savepoint-of-mysql-mode.md)。
