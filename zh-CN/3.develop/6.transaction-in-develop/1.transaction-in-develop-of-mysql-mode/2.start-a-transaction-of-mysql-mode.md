...
视图 `oceanbase.V$OB_TRANSACTION_PARTICIPANTS` 中的字段及详细说明请参见 [oceanbase.V$OB_TRANSACTION_PARTICIPANTS](../../../7.reference/5.system-reference/4.system-view-of-mysql-mode/3.performance-view-of-mysql-mode/54.v-ob_transaction_participants-of-mysql-mode.md)。
