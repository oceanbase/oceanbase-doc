...
有关 `NLSSORT` 函数的详细信息，请参见 [NLSSORT](../../6.sql-syntax/3.common-tenant-oracle-mode/5.functions-2/2.single-row-functions/2.string-functions-that-return-a-string/8.NLSSORT.md)。
