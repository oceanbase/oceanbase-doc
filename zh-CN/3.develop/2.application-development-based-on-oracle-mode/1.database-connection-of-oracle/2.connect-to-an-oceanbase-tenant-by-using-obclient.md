...
Your OceanBase connection id is 3221487703
...
通过 OBClient 连接 OceanBase 数据库 MySQL 租户的操作示例请参见 [通过 OBClient 连接 OceanBase 租户](../../1.application-development-based-on-mysql-mode/1.database-connection/3.connect-to-an-oceanbase-tenant-by-using-obclient.md)。
