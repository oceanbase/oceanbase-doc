...
请使用 [INSERT](../../../7.reference/4.development-guide-refactoring/1.sql-syntax/2.common-tenant-of-mysql-mode/4.functions-of-mysql-mode/2.functions-of-mysql-mode/2.string-functions-of-mysql-mode/14.insert-of-mysql-mode.md) 语句，再参考下面的建议，向表中插入数据。
...
* 通过  [`INSERT IGNORE INTO`](../../../7.reference/4.development-guide-refactoring/1.sql-syntax/2.common-tenant-of-mysql-mode/4.functions-of-mysql-mode/2.functions-of-mysql-mode/2.string-functions-of-mysql-mode/14.insert-of-mysql-mode.md) 语句避免约束冲突时，`IGNORE` 关键字可以忽略由于约束冲突导致的 `INSERT` 失败的影响。
...
* 通过 [`INSERT INTO ON DUPLICATE KEY UPDATE`](../../../7.reference/4.development-guide-refactoring/1.sql-syntax/2.common-tenant-of-mysql-mode/4.functions-of-mysql-mode/2.functions-of-mysql-mode/2.string-functions-of-mysql-mode/14.insert-of-mysql-mode.md) 语句避免约束冲突时，可以指定对重复主键或唯一键的后续处理。
...
除了 `INSERT` 语句，当表中无数据记录，或者表中有数据记录但无主键或唯一键冲突时，还可以使用 `REPLACE INTO` 语句代替 `INSERT` 语句插入数据。`REPLACE INTO` 语句的详细语法及说明请参见 [REPLACE](../../../7.reference/4.development-guide-refactoring/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/46.replace-of-mysql-mode.md)。
