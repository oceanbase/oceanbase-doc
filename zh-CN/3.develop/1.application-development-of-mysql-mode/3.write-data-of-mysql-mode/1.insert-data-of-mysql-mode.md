...
请使用 [INSERT](../../../7.reference/4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/4.functions-of-mysql-mode/2.functions-of-mysql-mode/2.string-functions-of-mysql-mode/14.insert-of-mysql-mode.md) 语句，再参考下面的建议，向表中插入数据。
...
* 通过  [`INSERT IGNORE INTO`](../../../7.reference/4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/4.functions-of-mysql-mode/2.functions-of-mysql-mode/2.string-functions-of-mysql-mode/14.insert-of-mysql-mode.md) 语句避免约束冲突时，`IGNORE` 关键字可以忽略由于约束冲突导致的 `INSERT` 失败的影响。
...
* 通过 [`INSERT INTO ON DUPLICATE KEY UPDATE`](../../../7.reference/4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/4.functions-of-mysql-mode/2.functions-of-mysql-mode/2.string-functions-of-mysql-mode/14.insert-of-mysql-mode.md) 语句避免约束冲突时，可以指定对重复主键或唯一键的后续处理。
