...
有关其他常用 SQL Hint 的详细信息，请参考 [注释](../../../7.reference/4.development-guide-refactoring/1.sql-syntax/2.common-tenant-of-mysql-mode/1.basic-elements-of-mysql-mode/7.annotation-of-mysql-mode.md) 章节。
