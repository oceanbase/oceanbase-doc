...
关于查询语句的详细用法，请参见 [SELECT](../../../7.reference/4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/51.select-of-mysql-mode/1.select-of-mysql-mode.md)。
