...
在本地创建一个文件名为 go-oceanbase 的文件夹。也可通过点击 [go-oceanbase](待添加) 下载项目代码。
在项目目录下创建以下文件：
...
创建 Go 示例应用程序在 OceanBase 数据库开源社区中也有相关的完整示例，详情请参考 [Go 示例应用程序](https://github.com/oceanbase/ob-example/tree/master/golang-go-sql-driver)。
