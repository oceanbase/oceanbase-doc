...
本节主要介绍 MySQL 模式下连接和访问 OceanBase 数据库的途径。当前主要支持通过客户端、驱动或 ORM 框架连接到 OceanBase 数据库。
...
* Java 驱动（MySQL Connector/J）
  ...
  使用 Java 应用程序连接 OceanBase 数据库的具体操作示例请参见 [Java 应用程序连接 OceanBase 数据库](../../../2.quickstart/4.oracle-based-application-development.md/2.java-application-1.md)。
...
* C 驱动（OceanBase Connector/C）
  ...
  使用 C 应用程序连接 OceanBase 数据库的具体操作示例请参见 [C 应用程序连接 OceanBase 数据库](../../../2.quickstart/4.oracle-based-application-development.md/3.c-application-1.md)。
...
* Python 驱动（MySQL Connector/Python）
  ...
  使用 Python 应用程序连接 OceanBase 数据库的具体操作示例请参见 [Python 应用程序连接 OceanBase 数据库](../../../2.quickstart/4.oracle-based-application-development.md/1.python-application-1.md)。
