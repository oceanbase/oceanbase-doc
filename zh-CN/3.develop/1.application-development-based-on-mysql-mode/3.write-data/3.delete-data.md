...
```sql
obclient> DELETE FROM t_insert WHERE value=10004;
...
```sql
obclient> DELETE FROM t_insert WHERE value < 100000;

obclient> DELETE FROM t_insert WHERE value < 200000;

obclient> DELETE FROM t_insert WHERE value < 300000;
```
