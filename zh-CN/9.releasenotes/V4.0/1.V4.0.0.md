...
* 性能大幅提升
    ...
    * SYSBENCH 性能优化，综合读写性能（Read Write）1024 并发测试性能相比于 V3.1 版本提升 2 倍。
    
    * TPCH 查询性能优化，100GB 数据量顺序执行 22 条 SQL，整体性能相比于 V3.1 版本提升约 5 倍。
...
|---------|----------|----------|
|tpmC (NewOrders)	|285870.45	|295855.92|
|tpmTOTAL	|635991.43	|657398.9|
...
* OceanBase V4.0.0 节点在生产环境最低要求运行规格为 4C16GB，CPU 资源大于 1C，租户内存资源大于 2GB（建议 4GB 及以上）。
