...
* 性能大幅提升
    ...
    * SYSBENCH 性能优化，综合读写性能（Read Write）1024 并发测试相比于 V3.1 版本性能提升 2 倍。

    * TPCH 查询性能优化，100GB 数据量顺序查询相比于 V3.1 版本性能提升约 5 倍。
...
* 支持租户级备份
    ...
    有关租户级备份的更多详细信息，参见 [备份恢复](../../5.administrator-guide/10.high-data-availability/2.backup-and-restoration-management/1.overview-of-physical-backup-and-recovery.md)
...
* 数据编码开源
    ...
    有关数据编码的更多详细信息，参见 [数据压缩与编码](../../7.reference/1.oceanbase-database-concepts/9.storage-architecture-1/2.data-storage/4.compression-and-encoding.md)
...
* 支持全链路追踪
    ...
    有关全链路追踪的详细介绍，参见 [全链路追踪](../../5.administrator-guide/11.operation-and-maintenance-management/5.daily-inspection/2.full-link-detection/1.full-link-diagnosis-overview.md)
...
|---------|----------|----------|----------|----------|
|32	|164296.53|	0.23|	139124.75|	0.28|
|64	|295501.91	|0.27	|232522.69|	0.36|
|128	|458544.72|	0.41|	322185.31|	0.63|
|256	|571102.89|	0.84|	362650.60|	1.58|
|512	|590594.45|	2.52|	387072.57|	3.96|
|1024|	618938.97|	4.49|	401404.45|	7.84|

**Read Only 性能**

| **Threads** | **V4.0.0_CE QPS** | **V4.0.0_CE 95% Latency (ms)** | **V3.1.0_CE QPS** | **V3.1.0_CE 95% Latency (ms)** | 
|---------|----------|----------|----------|----------|
|32	|113676.45|	5.88|	105416.23|	6.28|
|64	|206428.27|	6.21|	138571.41	|9.22|
|128	|328877.43|	7.70	|205698.25|	13.22|
|256	|424722.31|	12.52|	253858.84	|23.10|
|512	|449341.95	|33.72	|286324.43	|42.61|
|1024	|459894.55	|75.82	|279067.64	|123.28|

**Write Only 性能**

| **Threads** | **V4.0.0_CE QPS** | **V4.0.0_CE 95% Latency (ms)** | **V3.1.0_CE QPS** | **V3.1.0_CE 95% Latency (ms)** | 
|---------|----------|----------|----------|----------|
|32	|37759.61	|6.55	|35737.28	|7.04|
|64	|70608.24	|6.79	|57660.74	|9.56|
...
| **Threads** | **V4.0.0_CE QPS** | **V4.0.0_CE 95% Latency (ms)** | **V3.1.0_CE QPS** | **V3.1.0_CE 95% Latency (ms)** | 
|---------|----------|----------|----------|----------|
|32	|64210.37	|12.30	|64412.17	|12.08|
|64	|104821.27	|15.27	|89716.44	|17.95|
|128	|171487.45	|20.00	|106215.37	|32.53|
|256	|230948.68	|31.37	|114100.12	|66.84|
|512	|277411.42	|58.92	|157859.02	|99.33|
|1024	|283448.81	|167.44	|146540.16	|225.98|
...
|---------|----------|----------|
|tpmC (NewOrders)	|275963.22	|295855.92|
|tpmTOTAL	|613568.29	|657398.9|
...
有关视图的详细信息，参见 [系统视图](../../7.reference/3.system-views/1.overview-2.md)。 
