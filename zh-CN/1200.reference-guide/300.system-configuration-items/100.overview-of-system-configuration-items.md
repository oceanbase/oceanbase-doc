...
当 OBServer 启动后，如果未指定配置项，则系统会使用指定配置项的默认值。更多配置项的查看和设置操作请参见 [集群参数管理](../../600.administrator-guide/200.basic-database-management/100.manage-clusters/300.manage-cluster-parameters/100.overview-of-cluster-parameter-management.md) 章节。
