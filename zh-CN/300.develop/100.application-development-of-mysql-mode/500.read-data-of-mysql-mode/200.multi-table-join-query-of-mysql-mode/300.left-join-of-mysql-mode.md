...
本文主要提供左联接的示例指导，左联接相关示例请参见 [全联接](../200.multi-table-join-query-of-mysql-mode/200.full-join-of-mysql-mode.md)，右联接相关示例请参见 [右联接](../200.multi-table-join-query-of-mysql-mode/400.right-join-of-mysql-mode.md)。
