...
* 本地 Location 格式：`LOCATION = '[file://] local_file_path'`
  ...
  <main id="notice" type='notice'>
  <h4>注意</h4>
  <p>对于使用本地 Location 格式的场景，需设置系统变量 <code>secure_file_priv</code> 配置可以访问的路径。更多信息，请参见 <a href="../../../70000.reference/80000.configuration-items-and-system-variables/20000.system-variable/30000.global-system-variable/1150000.secure_file_priv-global.md">secure_file_priv</a>。</p>
  </main>
...
2. 设置导入的文件路径。
    ...
    <main id="notice" type='notice'>
      <h4>注意</h4>
      <p>由于安全原因，设置系统变量 <code>secure_file_priv</code> 时，只能通过本地 Socket 连接数据库执行修改该全局变量的 SQL 语句。更多信息，请参见 <a href="../../../70000.reference/80000.configuration-items-and-system-variables/20000.system-variable/30000.global-system-variable/1150000.secure_file_priv-global.md">secure_file_priv</a>。</p>
    </main>
