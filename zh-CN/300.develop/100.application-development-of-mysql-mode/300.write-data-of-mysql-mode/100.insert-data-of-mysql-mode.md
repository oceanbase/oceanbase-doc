...
请使用 [INSERT](../../../700.reference/400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/400.functions-of-mysql-mode/700.json-functions-of-mysql-mode/300.function-to-modify-json-text-of-mysql-mode/200.json-array-insert-of-mysql-mode.md) 语句，再参考下面的建议，向表中插入数据。
...
* 通过  [`INSERT IGNORE INTO`](../../../700.reference/400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/400.functions-of-mysql-mode/700.json-functions-of-mysql-mode/300.function-to-modify-json-text-of-mysql-mode/200.json-array-insert-of-mysql-mode.md) 语句避免约束冲突时，`IGNORE` 关键字可以忽略由于约束冲突导致的 `INSERT` 失败的影响。
...
* 通过 [`INSERT INTO ON DUPLICATE KEY UPDATE`](../../../700.reference/400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/400.functions-of-mysql-mode/700.json-functions-of-mysql-mode/300.function-to-modify-json-text-of-mysql-mode/200.json-array-insert-of-mysql-mode.md) 语句避免约束冲突时，可以指定对重复主键或唯一键的后续处理。
