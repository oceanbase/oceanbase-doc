...
通常使用 [UPDATE](../400.read-data-of-mysql-mode/800.use-operators-and-functions-in-query-of-mysql-mode/1000.lock-query-results-select-for-update-of-mysql-mode.md) 语句来更新表数据。
