...
* 确保本地已正确安装 MySQL 客户端。OceanBase 数据库当前版本支持的 MySQL 客户端版本包括 V5.5、V5.6、V5.7 和 V8.0.2。
    ...
    <main id="notice" type='notice'>
      <h4>注意</h4>
      <p>使用 ODP 连接至 OceanBase 数据库的场景中，当前不兼容 MySQL 客户端 V8.0.2 版本。</p>
    </main>
...
<main id="notice" type='explain'>
   <h4>说明</h4>
   <p>支持 OceanBase 数据库到 ODP 的压缩功能，OceanBase 数据库要求 V4.2.1 BP3 或者 4.2.2 BP1 及以上版本，ODP 要求 V4.2.3 及以上版本。具体信息请参考以下文档：<ul><li> 有关控制 ODP 和 OceanBase 数据库之间是否开启 OceanBase 2.0 协议进行传输的详细信息，请参见 <a href= "https://www.oceanbase.com/docs/common-odp-doc-cn-1000000000517753">enable_ob_protocol_v2</a>。
<li> 有关控制是否开启压缩协议的详细信息，请参见 <a href="https://www.oceanbase.com/docs/common-odp-doc-cn-1000000000517630">enable_compression_protocol</a>。</li><li> 有关控制压缩协议和 OceanBase 2.0 协议的压缩级别的详细信息，请参见 <a href="https://www.oceanbase.com/docs/common-odp-doc-cn-1000000000517613">compression_algorithm</a>。</li></ul></p>
</main>
