...
* 连接租户前，请确认当前客户端在租户白名单中，租户白名单的查询及设置具体操作请参见 [查看和设置租户白名单](../../../6.manage/2.tenant-management/6.common-tenant-operations/5.view-and-set-whitelist.md)。
...
通过 OBClient 连接 OceanBase 数据库 Oracle 租户的操作示例请参见 [通过 OBClient 连接 OceanBase 租户](../../2.application-development-of-oracle-mode/1.connect-to-oceanbase-database-of-oracle-mode/2.connect-to-an-oceanbase-tenant-by-using-obclient-of-oracle-mode.md)。
