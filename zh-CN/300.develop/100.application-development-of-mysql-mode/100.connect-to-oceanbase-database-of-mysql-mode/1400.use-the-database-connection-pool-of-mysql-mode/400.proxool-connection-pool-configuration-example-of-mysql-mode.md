...
请点击 [proxool-mysql-client](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.2.0/3.develop/connection-pool/proxool-mysql-client/proxool-mysql-client.zip) 下载项目代码。
...
2. `proxool-mysql-client` 项目代码介绍。
3. 将 `proxool-mysql-client` 项目导入到 IntelliJ IDEA 中。
4. 修改 `proxool-mysql-client` 项目中的数据库连接信息。
5. 运行 `proxool-mysql-client` 项目。
...
### 步骤二：proxool-mysql-client 项目代码介绍
...
### 步骤三：将 proxool-mysql-client 项目导入到 IntelliJ IDEA 中
...
### 步骤四：修改 proxool-mysql-client 项目中的数据库连接信息
...
jdbc-1.password=_Oce2nB2se_
...
```

### 步骤五：运行 proxool-mysql-client 项目
