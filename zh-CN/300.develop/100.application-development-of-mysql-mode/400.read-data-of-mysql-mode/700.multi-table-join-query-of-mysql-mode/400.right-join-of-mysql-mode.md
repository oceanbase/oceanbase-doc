...
本文主要提供右联接的示例指导，左联接相关示例请参见 [全联接](../700.multi-table-join-query-of-mysql-mode/200.full-join-of-mysql-mode.md)，右联接相关示例请参见 [左联接](../700.multi-table-join-query-of-mysql-mode/300.left-join-of-mysql-mode.md)。
