...
本文主要提供左联接的示例指导，全联接相关示例请参见 [全联接](../700.multi-table-join-query-of-mysql-mode/200.full-join-of-mysql-mode.md)，右联接相关示例请参见 [右联接](../700.multi-table-join-query-of-mysql-mode/400.right-join-of-mysql-mode.md)。
