...
2. 修改用户 `ny1` 的密码。
   ...
   <main id="notice" type='explain'>
     <h4>说明</h4>
     <p>为用户设置密码时，用户密码需要符合当前租户的密码复杂度。密码复杂度相关操作及说明请参见 <a href="../../../700.reference/200.administrator-guide/200.basic-database-management/400.manage-tenants/500.manage-users-and-permissions/300.mysql-mode/200.set-password-complexity-of-mysql-mode.md">设置密码复杂度</a>。</p>
   </main>
