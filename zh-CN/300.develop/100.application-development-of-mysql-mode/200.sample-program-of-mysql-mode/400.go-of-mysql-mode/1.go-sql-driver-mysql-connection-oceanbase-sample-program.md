...
2. 获取 `go-oceanbase` 项目代码。
3. 将 `go-oceanbase` 项目导入到 IDEA 中。
4. 修改 `go-oceanbase` 项目中的数据库连接信息。
5. 运行 `go-oceanbase` 项目。
...
### 步骤三：将 `go-oceanbase` 项目导入到 IDEA 中
...
### 步骤四 修改 go-oceanbase 项目中的数据库连接信息
