...
* `wait_timeout` 参数的详细信息，请参见 [wait_timeout](../../../../700.reference/800.configuration-items-and-system-variables/200.system-variable/300.global-system-variable/13700.wait_timeout-global.md)。

* `interactive_timeout` 参数的详细信息，请参见 [interactive_timeout](../../../../700.reference/800.configuration-items-and-system-variables/200.system-variable/300.global-system-variable/3200.interactive_timeout-global.md)。
