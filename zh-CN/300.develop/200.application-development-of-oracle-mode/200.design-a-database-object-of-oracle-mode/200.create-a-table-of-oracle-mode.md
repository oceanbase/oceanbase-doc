...
* 外键约束（`FOREIGN KEY`）：要求约束的列的值取自于另外一个表的主键列。
  ...
  OceanBase 数据库默认开启了外键约束检查，外键约束检查开关由租户变量 `foreign_key_checks` 来控制。`foreign_key_checks` 变量的更多说明，请参见 [foreign_key_checks](../../../700.reference/500.system-reference/300.system-variable-of-oracle-mode/2700.foreign_key_checks-of-oracle-mode.md)。
...
关于分区相关的更多介绍，请参见 [分区](../../../700.reference/200.administrator-guide/400.replica-management/200.manage-partition-table/100.oracle-mode/100.partition-overview-of-oracle-mode.md)。
