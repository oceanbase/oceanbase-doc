...
关于分区相关的更多介绍，请参见 [分区](../../../7.reference/2.administrator-guide/4.replica-management/2.manage-partition-table/1.oracle-mode/1.partition-overview-of-oracle-mode.md)。
