...
* 该语句数据写入操作是全量旁路导入方式，所以操作受全量旁路导入功能限制。有关旁路导入的信息，参见 [使用 INSERT INTO SELECT 语句旁路导入数据](../../../620.obap/300.obap-import-data/20.bypass-import/200.full-bypass-import.md) 中的 **使用限制** 章节。
* 该语句指定旁路导入 Hint 会报错。
