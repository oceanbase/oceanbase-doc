...
2. 在 `tbl1` 表中插入几条数据。
   ...
   ```shell
   obclient [SYS]> INSERT INTO tbl1 (col1, col2) VALUES (15, 2);
                    INSERT INTO tbl1 (col1, col2) VALUES (11, 4);
                    INSERT INTO tbl1 (col1, col2) VALUES (18, 6);
                    INSERT INTO tbl1 (col1, col2) VALUES (13, 3);
                    INSERT INTO tbl1 (col1, col2) VALUES (5, 1);
                    INSERT INTO tbl1 (col1, col2) VALUES (2, 3);
                    INSERT INTO tbl1 (col1, col2) VALUES (8, 5);
                    INSERT INTO tbl1 (col1, col2) VALUES (7, 2);
   ```
...
5. 插入两条数据到表 `tbl2` 中。
   ...
   obclient [SYS]> INSERT INTO tbl2 (col1, col2) VALUES (0, 22);
                   INSERT INTO tbl2 (col1, col2) VALUES (1, 33);
   ```
...
7. 使用 `insert overwrite` 将表 `tbl1` 中的数据导入到表 `tbl2` 中的指定分区 `p0` 和 `p1`。
