...
本文将介绍在 Java 应用程序中如何使用 SpringDataJPA 框架连接并使用 OceanBase 数据库，请点击 [java-oceanbase-springdatajpa](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.2.0/3.develop/demo/java/java-oceanbase-springdatajpa/java-oceanbase-springdatajpa.zip) 下载项目代码。
...
2. 获取 `java-oceanbase-springdatajpa` 项目代码。
3. 将 `java-oceanbase-springdatajpa` 项目导入到 IDEA 中。
4. 修改 `java-oceanbase-springdatajpa` 项目中的数据库连接信息。
5. 运行 `java-oceanbase-springdatajpa` 项目。
...
### 步骤二：获取 `java-oceanbase-springdatajpa` 项目代码
...
### 步骤三：将 `java-oceanbase-springdatajpa` 项目导入到 IDEA 中
...
### 步骤四 修改 `java-oceanbase-springdatajpa` 项目中的数据库连接信息
...
### 步骤五：运行 `java-oceanbase-springdatajpa` 项目
