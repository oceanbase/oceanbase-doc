...
请点击 [dbcp-oceanbase-client](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.2.0/3.develop/connection-pool/dbcp-oceanbase-client/dbcp-oceanbase-client.zip) 下载项目代码。
...
2. `dbcp-oceanbase-client` 项目代码介绍。
3. 将 `dbcp-oceanbase-client` 项目导入到 Eclipse 中。
4. 修改 `dbcp-oceanbase-client` 项目中的数据库连接信息。
5. 运行 `dbcp-oceanbase-client` 项目。
...
### 步骤二：dbcp-oceanbase-client 项目代码介绍
...
### 步骤三：将 dbcp-oceanbase-client 项目导入到 Eclipse 中
...
### 步骤四：修改 dbcp-oceanbase-client 项目中的数据库连接信息
...
### 步骤五：运行 dbcp-oceanbase-client 项目
