...
* Java ORM 框架
  ...
  * SpringDataJPA
    ...
    SpringDataJPA 连接 OceanBase 数据库的具体操作示例请参见 [SpringDataJPA 连接 OceanBase 数据库](../200.sample-program-of-oracle-mode/100.java-of-oracle-mode/1000.connect-to-the-oceanbase-database-through-spring-data-jpa-of-oracle-mode.md)。
