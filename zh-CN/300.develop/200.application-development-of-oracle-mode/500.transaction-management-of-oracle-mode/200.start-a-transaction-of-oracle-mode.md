...
视图 `$OB_TRANSACTION_PARTICIPANTS` 中的字段及详细说明请参见 [$OB_TRANSACTION_PARTICIPANTS](../../../700.reference/500.system-reference/500.system-view-of-oracle-mode/300.performance-view-of-oracle-mode/1100.gv-ob_transaction_participants-of-oracle-mode.md)。
