...
本文主要提供全联接的示例指导，左联接相关示例请参见 [左联接](../200.multi-table-join-query-of-oracle-mode/300.left-join-of-oracle-mode.md)，右联接相关示例请参见 [右联接](../200.multi-table-join-query-of-oracle-mode/400.right-join-of-oracle-mode.md)。
