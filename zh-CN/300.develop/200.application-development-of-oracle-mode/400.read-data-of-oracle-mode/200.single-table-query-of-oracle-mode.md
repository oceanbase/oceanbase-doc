...
此外，指定列的查询还支持 `WHERE` 条件查询，请参见 [条件查询](4.sort-query-of-oracle-mode.md)。
更多用法请参见 [在查询中使用操作符和函数](9.execution-plan-of-oracle-mode/1.view-query-execution-plan-of-oracle-mode.md)。
