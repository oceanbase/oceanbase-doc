...
本文主要提供全联接的示例指导，左联接相关示例请参见 [左联接](../700.multi-table-join-query-of-oracle-mode/300.left-join-of-oracle-mode.md)，右联接相关示例请参见 [右联接](../700.multi-table-join-query-of-oracle-mode/400.right-join-of-oracle-mode.md)。
...
示例 2：将表 `tbl_a` 和表 `tbl_b` 执行全联接查询后，返回表 `tbl_b` 中 `value=1003` 的数据。
