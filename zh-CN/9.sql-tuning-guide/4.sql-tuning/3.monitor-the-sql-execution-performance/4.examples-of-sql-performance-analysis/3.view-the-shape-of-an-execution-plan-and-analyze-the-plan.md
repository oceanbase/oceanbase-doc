...
1. 通过 `EXPLAIN` 命令查看执行计划形状，或者通过实时执行计划展示查看缓存执行计划。详细信息请参见 [SQL 执行计划简介](../../../../5.oceanbase-database-overview/7.sql-engine/4.oceanbase-database-overview-sql-execution-plan/1.introduction-to-sql-execution-plans.md)和 [实时执行计划展示](../../../../5.oceanbase-database-overview/7.sql-engine/4.oceanbase-database-overview-sql-execution-plan/5.oceanbase-database-overview-real-time-execution-plan-display.md)。
