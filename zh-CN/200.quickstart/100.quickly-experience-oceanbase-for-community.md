...
<main id="notice" type='notice'>
  ...
  <ul>
  <li>
  <p>本文中的方法仅适用于 OceanBase 数据库快速上手体验，不适用生产环境，如需在生产环境中部署 OceanBase 数据库，请参考 <a href="../4.deploy/1.deploy-overview.md">部署数据库</a> 章节。</p>
  </li>
  <li>
...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p> 本节仅介绍简单的操作，帮助您快速部署一个分布式 OceanBase 集群。更多配置介绍可参考 <a href="../4.deploy/5.deploy-oceanbase-database-community-edition/2.local-deployment/4.deploy-by-ui/1.deploy-by-obd.md">通过 OBD 白屏部署 OceanBase 集群</a> 一文。</p>
</main>
