...
| 项目 | 描述 |
| --- | --- |
|系统|<ul><li>Anolis OS 8.X 版本（内核 Linux 4.19 版本及以上）</li><li>Alibaba Cloud Linux 2/3 版本（内核 Linux 4.19 版本及以上）</li><li>Red Hat Enterprise Linux Server 7.X 版本、8.X 版本（内核 Linux 4.19 版本及以上）</li><li>CentOS Linux 7.X 版本、8.X 版本（内核 Linux 4.19 版本及以上）</li><li>Debian 9.X 版本及以上版本（内核 Linux 4.19 版本及以上）</li><li>Ubuntu 16.X 版本及以上版本（内核 Linux 4.19 版本及以上）</li><li>SUSE / openSUSE 15.X 版本及以上版本（内核 Linux 4.19 版本及以上） </li><li>openEuler 22.03 和 24.03 版本（内核 Linux 5.10.0 版本及以上）</li><li>KylinOS V10 版本</li><li>统信 UOS V20 版本</li><li>中科方德 NFSChina 4.0 版本及以上</li><li>浪潮 Inspur kos 5.8 版本</li></ul>|
