...
首先我们使用数据准备工具 [CreateData.jar](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.2.0/200.quickstart/CreateData.jar) 生成 5 千万行模拟数据到 `/home/soft` 目录下，生成数据大概需要十几分钟时间，您也可以使用其他工具生成测试数据。
...
```
  ...
  <main id="notice" type='notice'>
    <h4>注意</h4>
    <p>由于安全原因，只能使用通过本地连接的 Client 执行修改 <code>secure_file_priv</code> 的 SQL 语句。详细信息请参见 <a href="../../700.reference/500.system-reference/200.system-variable-of-mysql-mode/11500.secure_file_priv-of-mysql-mode.md">secure_file_priv</a>。</p>
  </main>
