...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>在 Docker 容器中启动的 OceanBase 数据库默认 root@sys 用户登录密码为空，您可登录集群后执行 <code>ALTER USER</code> 命令修改集群，命令详细介绍请参见 <a href='../../700.reference/400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/800.alter-user-of-mysql-mode.md'>ALTER USER</a>。</p>
</main>
