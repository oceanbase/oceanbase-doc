...
有关 Connector/J 连接 OceanBase 数据库的详细示例，请参见[OceanBase Connector/J 连接 OceanBase 数据库示例程序](../../300.develop/200.application-development-of-oracle-mode/200.sample-program-of-oracle-mode/100.java-of-oracle-mode/100.oceanbase-connector-j-connection-to-oceanbase-database-sample-program.md)
