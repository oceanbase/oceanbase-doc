...
更多 `UPDATE` 语句相关的语法，请参见 [UPDATE](../../300.develop/200.application-development-of-oracle-mode/400.read-data-of-oracle-mode/800.use-operators-and-functions-in-query-of-oracle-mode/1000.lock-query-result-select-for-update-of-oracle-mode.md) 章节。
