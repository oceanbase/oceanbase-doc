...
更多 `CREATE DATABASE` 语句相关的语法说明，请参见 [CREATE DATABASE](../../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/21.create-database-of-mysql-mode.md) 章节。
...
更多 `CREATE TABLE` 语句相关的语法说明，请参见 [CREATE TABLE](../../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/26.create-table-of-mysql-mode.md) 章节。
...
更多 `ALTER TABLE` 语句相关的语法说明，请参见 [ALTER TABLE](../../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/16.alter-table-of-mysql-mode.md) 章节。
...
更多 `DROP TABLE` 语句相关的语法说明,请参见 [DROP TABLE](../../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/37.drop-table-of-mysql-mode.md) 章节。
...
更多 `CREATE INDEX` 语句相关的语法说明，请参见 [CREATE INDEX](../../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/22.create-index-of-mysql-mode.md) 章节。
...
更多 `DROP INDEX` 语句相关的语法说明，请参见 [DROP INDEX](../../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/35.drop-index-of-mysql-mode.md) 章节。
...
更多 `INSERT` 语句相关的语法，请参见 [INSERT](../../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/57.insert-sql-of-mysql-mode.md) 章节。
...
更多 `DELETE` 语句相关的语法说明，请参见 [DELETE](../../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/32.delete-of-mysql-mode.md) 章节。
...
更多 `UPDATE` 语句相关的语法，请参见 [UPDATE](../../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/90.update-of-mysql-mode.md) 章节。
...
更多 `SELECT` 语句相关的语法说明，请参见 [SELECT](../../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/81.select-of-mysql-mode/1.select-of-mysql-mode.md) 章节。
...
更多事务控制语句相关的说明请参见 [事务管理概述](../../3.develop/1.application-development-of-mysql-mode/6.transaction-in-develop-of-mysql-mode/1.transaction-management-overview-of-mysql-mode.md)。
...
更多事务控制语句相关的说明，请参见 [事务管理概述](../../3.develop/1.application-development-of-mysql-mode/6.transaction-in-develop-of-mysql-mode/1.transaction-management-overview-of-mysql-mode.md)。
