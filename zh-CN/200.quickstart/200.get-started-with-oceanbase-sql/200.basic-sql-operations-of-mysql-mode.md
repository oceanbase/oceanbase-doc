...
更多 `UPDATE` 语句相关的语法，请参见 [UPDATE](../../700.reference/400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/6000.update-of-mysql-mode.md) 章节。
