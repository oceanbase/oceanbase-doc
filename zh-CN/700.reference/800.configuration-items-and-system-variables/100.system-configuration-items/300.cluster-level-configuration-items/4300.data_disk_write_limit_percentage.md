...
* **设置时其值需要大于等于 [data_disk_usage_limit_percentage](4200.data_disk_usage_limit_percentage.md)。**
...
设置使用 MemStore 的内存占其总可用内存的百分比：[memstore_limit_percentage](14100.memstore_limit_percentage.md)