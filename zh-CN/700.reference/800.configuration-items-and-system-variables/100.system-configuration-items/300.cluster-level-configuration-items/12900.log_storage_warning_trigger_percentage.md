...
<h4>说明</h4>
<p>对于 V4.2.1 版本，该配置项从 V4.2.1 BP7 版本开始引入。</p>
</main>
...
* 配置项 `log_storage_warning_trigger_percentage` 与 配置项 [log_storage_warning_tolerance_time](24800.log_storage_warning_tolerance_time.md) 的关系：
