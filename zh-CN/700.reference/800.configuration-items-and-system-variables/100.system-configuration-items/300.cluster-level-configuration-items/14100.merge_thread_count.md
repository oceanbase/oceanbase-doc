...
<li>在 V4.x 版本中，使用配置项 <code>compaction_low_thread_score</code> 来设置低优先级 Compaction 的工作线程数。有关租户级配置项 <code>compaction_low_thread_score</code> 的更多说明，参见 <a href="../400.tenant-level-configuration-items/1900.compaction_low_thread_score.md">compaction_low_thread_score</a>。</li></ul>
</main>
