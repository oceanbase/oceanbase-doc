...
* **配置项 `syslog_compress_func` 与 配置项 [syslog_file_uncompressed_count](22600.syslog_file_uncompressed_count.md)、[syslog_disk_size](22500.syslog_disk_size.md)、[max_syslog_file_count](13600.max_syslog_file_count.md) 之间的关系：**
