...
* 该配置项与 <code>datafile_disk_percentage</code> 同时配置时，以该配置项设置的值为准。有关 <code>datafile_disk_percentage</code> 的详细介绍，请参见 <a href="4400.datafile_disk_percentage.md">datafile_disk_percentage</a>。
