...
| 是否重启 OBServer 节点生效 | 否        |
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <ul>
    <li>该配置项与 <code>datafile_size</code> 同时配置时，以 <code>datafile_size</code> 设置的值为准。有关 <code>datafile_size</code> 的详细介绍，请参见 <a href="4900.datafile_size.md">datafile_size</a>。</li>
