...
| 参数类型             | Time      |
| 默认值               | 10m       |
| 取值范围             | [0s, +∞)<main id="notice" type='explain'><h4>说明</h4><ul><li>取值为 0 时，表示关闭 <code>schema</code> 多版本记录回收任务功能。</li> <li>非 0 表示执行 <code>schema</code> 多版本记录回收任务的时间间隔。</li></ul></main> |
