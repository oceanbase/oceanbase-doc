...
<h4>说明</h4>
<ul><li>对于 V4.3.x 版本，该配置项从 V4.3.4 版本开始引入。</li>
<li>对于 V4.2.5 版本，该配置项从 V4.2.5 BP1 版本开始引入。</li>
<li>对于 V4.2.1 版本，该配置项从 V4.2.1 BP8 版本开始引入。</li>
</ul>
</main>
...
设置日志流副本的自动降级策略为 `CLUSTER_POLICY`。
