...
从 V4.2.1 BP7 版本开始日志盘故障探测由配置项 [log_storage_warning_trigger_percentage](12900.log_storage_warning_trigger_percentage.md) 和配置项 `log_storage_warning_tolerance_time` 共同控制。
