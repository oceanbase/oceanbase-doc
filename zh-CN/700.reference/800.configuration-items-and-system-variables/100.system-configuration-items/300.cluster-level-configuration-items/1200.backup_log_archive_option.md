...
<ul><li>不再支持通过配置项来设置备份模式，系统租户和所有用户租户可以使用 <a href="../../../500.sql-reference/100.sql-syntax/100.system-tenants/200.alter-system/3800.set-log-archive-dest.md">ALTER SYSTEM SET LOG_ARCHIVE_DEST</a> 语句中的 <code>BINDING</code> 选项来设置归档与业务的优先模式。</li>
