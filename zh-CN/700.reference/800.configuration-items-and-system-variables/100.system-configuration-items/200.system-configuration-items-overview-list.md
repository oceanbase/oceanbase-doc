...
| [tableapi_transport_compress_func](300.cluster-level-configuration-items/20900.tableapi_transport_compress_func.md) | 用于设置 OBKV-Table 查询结果传输使用的压缩算法。      |
...
| [plsql_v2_compatibility](400.tenant-level-configuration-items/3800.plsql_v2_compatibility.md) | 用于控制存储过程 DDL 阶段编译落盘功能是否开启。|
