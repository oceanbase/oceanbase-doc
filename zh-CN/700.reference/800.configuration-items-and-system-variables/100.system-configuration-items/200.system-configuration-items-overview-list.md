...
| [enable_syslog_recycle](300.cluster-level-configuration-items/9100.enable_syslog_recycle.md)                | 用于设置是否打开记录启动前的旧日志的开关。与 `max_syslog_file_count` 配合使用，决定回收逻辑是否考虑旧的日志文件。 |
...
| [minor_freeze_times](300.cluster-level-configuration-items/25200.minor_freeze_times.md) | 用于设置多少次冻结触发一次合并。 |
| [minor_merge_concurrency](300.cluster-level-configuration-items/25300.minor_merge_concurrency.md) | 用于设置转储时的并发线程数。 |
| [minor_warm_up_duration_time](300.cluster-level-configuration-items/25400.minor_warm_up_duration_time.md) | 用于设置转储产生新转储文件的预热时间。 |
...
| 配置项名 | 功能描述 |
|---------|---------|
|[enable_global_background_resource_isolation](300.cluster-level-configuration-items/30500.enable_global_background_resource_isolation.md) |  用于开启全局前后台资源隔离功能。|
| [global_background_cpu_quota](300.cluster-level-configuration-items/30600.global_background_cpu_quota.md) | 用于控制在开启全局前后台资源隔离时后台任务的 CPU 配额。 |
...
|   配置项名     | 功能描述 |
|---------------|-----------|
| [lob_enable_block_cache_threshold](400.tenant-level-configuration-items/27600.lob_enable_block_cache_threshold.md) | 用于设置 OUTROW 存储的 LOB 查询缓存的阈值。 |
...
| [enable_kv_ttl](400.tenant-level-configuration-items/26300.enable_kv_ttl.md) | 用于控制是否启动 TTL 后台任务，该配置项对周期性 TTL 任务有效，用户管控命令不受此配置项限制。 |
...
| [major_compact_trigger](400.tenant-level-configuration-items/1800.major_compact_trigger.md)         | 用于设置多少次冻结触发一次全局合并。  |
