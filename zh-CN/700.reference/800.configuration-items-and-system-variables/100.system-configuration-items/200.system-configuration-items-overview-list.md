...
| [kv_group_commit_batch_size](400.tenant-level-configuration-items/9500.kv_group_commit_batch_size.md) | 用于指定 OBKV 组提交中执行 batch 操作的大小 |
| [kv_group_commit_rw_mode](400.tenant-level-configuration-items/9600.kv_group_commit_rw_mode.md) | 用于在控制走组提交的场景。 |
