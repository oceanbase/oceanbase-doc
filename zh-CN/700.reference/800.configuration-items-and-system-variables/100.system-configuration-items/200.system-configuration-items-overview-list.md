...
|                                          配置项名                                          |                                功能描述                                 |
|----------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| [balancer_log_interval](300.cluster-level-configuration-items\2100.balancer_log_interval.md)                   | 用于负载均衡等后台任务线程打印统计日志的间隔时间。                                           |
...
| [minor_merge_concurrency](300.cluster-level-configuration-items\15300.minor_merge_concurrency.md) | 用于设置小合并时的并发线程数。 |
| [minor_warm_up_duration_time](300.cluster-level-configuration-items\15400.minor_warm_up_duration_time.md) | 用于设置小合并产生新转储文件的预热时间。 |
...
| [major_compact_trigger](400.tenant-level-configuration-items\5600.major_compact_trigger.md)         | 用于设置多少次小合并触发一次全局合并。  |
