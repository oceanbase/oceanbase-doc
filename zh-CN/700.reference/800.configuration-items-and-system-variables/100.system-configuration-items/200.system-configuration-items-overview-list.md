...
| 配置项名 | 功能描述 |
|---------|----------|
| [external_table_disk_cache_max_percentage](300.cluster-level-configuration-items/9350.external_table_disk_cache_max_percentage.md) | 用于设置外表磁盘缓存空间占 [datafile_size](300.cluster-level-configuration-items/4700.datafile_size.md) 的最大比例。|
