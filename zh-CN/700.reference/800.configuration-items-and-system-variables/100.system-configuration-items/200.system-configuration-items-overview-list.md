...
| [esult_cache_max_size](400.tenant-level-configuration-items/7340.result_cache_max_size.md)|用于控制 `result cache` 模块能使用的 `library cache` 的内存量。|
| [result_cache_max_result](400.tenant-level-configuration-items/7350.result_cache_max_result.md)|用于控制 `result cache` 模块中单个缓存对象能使用的 `result cache` 内存量。|
