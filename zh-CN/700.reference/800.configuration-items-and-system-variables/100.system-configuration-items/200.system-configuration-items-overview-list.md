...
|   配置项名  |  功能描述    |
|----------|---------------|
| [backup_backup_dest](300.cluster-level-configuration-items/用于设置备份数据备份的目的端。) | 900.backup_backup_dest.md |
...
| [zone_merge_order](300.cluster-level-configuration-items/zone_merge_order) | 用于设置 Zone 的轮转合并顺序。不指定时，由系统自动决定。 |
