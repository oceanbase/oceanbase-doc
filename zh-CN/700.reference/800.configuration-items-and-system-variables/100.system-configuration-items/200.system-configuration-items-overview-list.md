...
| [enable_clog_encryption](400.tenant-level-configuration-items/2390.enable_clog_encryption.md) | 用于设置是否开启数据透明加密下 bkmi 和 obcloud 方式的 clog 加密。 |
...
| [das_batch_rpc_delay_us](300.cluster-level-configuration-items/3850.das_batch_rpc_delay_us.md)| 用于控制全局索引回表 batch RPC 通道（`LOOKUP_DAS_BATCH_REQ1/2`）的聚合发送延迟。|
...
|                                   配置项名                                    |                功能描述                 |
|---------------------------------------------------------------------------|-------------------------------------|
| [px_workers_per_cpu_quota](400.tenant-level-configuration-items/6870.px_workers_per_cpu_quota.md) | 用于设置并行执行工作线程数的比例。            |
