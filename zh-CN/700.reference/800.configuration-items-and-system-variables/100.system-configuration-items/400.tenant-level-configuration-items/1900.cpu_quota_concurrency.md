...
* `workers_per_cpu_quota` 表示租户在每个 CPU 上能分配的最大 worker 数，有关 `workers_per_cpu_quota` 的详细信息请参见 [workers_per_cpu_quota](../300.cluster-level-configuration-items/25700.workers_per_cpu_quota.md)。
