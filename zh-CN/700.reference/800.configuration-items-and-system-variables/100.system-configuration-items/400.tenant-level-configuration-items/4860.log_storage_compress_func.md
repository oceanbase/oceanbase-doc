...
| 参数类型 | string |
| 默认值   | lz4_1.0 |
| 取值范围 |<ul><li>lz4_1.0  </li><li>zstd_1.0 </li><li>zstd_1.3.8 </li><li>zstd_1.5.7</li><main id="notice" type='explain'><h4>说明</h4><p>对于 V4.5.x 版本，该取值从 V4.5.0 版本开始引入。</p></main></ul>|
