...
该配置项需要和配置项 `kv_transport_compress_threshold` 配合使用，有关配置项 `kv_transport_compress_threshold` 的详细信息，参见 [kv_transport_compress_threshold](4000.kv_transport_compress_threshold.md)。
