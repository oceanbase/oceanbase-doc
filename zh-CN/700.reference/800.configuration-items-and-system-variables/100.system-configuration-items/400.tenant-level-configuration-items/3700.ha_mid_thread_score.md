...
* 设置高可用高优先级线程的当前工作线程数：[ha_high_thread_score](3500.ha_high_thread_score.md)
* 设置高可用低优先级线程的当前工作线程数：[ha_low_thread_score](3600.ha_low_thread_score.md)
