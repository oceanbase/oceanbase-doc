...
<li>在 V4.2.5 版本中，可以通过配置项 <a href="3960.kv_group_commit_batch_size.md">kv_group_commit_batch_size</a> 和 <a href="3970.kv_group_commit_rw_mode.md">kv_group_commit_rw_mode</a> 来查询是否开启组提交功能。</li>
</ul>
</ul>
</main>
