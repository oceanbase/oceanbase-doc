...
| 配置项名                            | 描述                                      |
|------------------------------------|-------------------------------------------|
|  [ob_storage_s3_url_encode_type](100.system-configuration-items/300.cluster-level-configuration-items/16620.ob_storage_s3_url_encode_type.md)  | 对于 V4.4.2 版本，从 V4.4.2 BP1 版本开始，默认值由 <code>default</code> 调整为 <code>compliantRfc3986Encoding</code>。|
...
| 配置项名                                                                                                       | 引入版本    | 描述                             |
|---------------------------------------------------------------------------------------------------------------|-------------|---------------------------------|
| [schema_history_archive_expire_time](100.system-configuration-items/400.tenant-level-configuration-items/7410.schema_history_archive_expire_time.md)     | 对于 V4.4.2 版本，从 V4.4.2 BP1 版本开始引入。  | 用于指定 Schema 多版本历史归档数据的保留时间。 |
| [zone_disk_balance_tolerance_percentage](100.system-configuration-items/400.tenant-level-configuration-items/13001.zone_disk_balance_tolerance_percentage.md) | 对于 V4.4.2 版本，该配置项从 V4.4.2 BP1 版本开始引入。 | 用于控制 Zone 间表组磁盘均衡算法对不均衡的容忍程度。  |
| [enable_ls_leader_balance](100.system-configuration-items/400.tenant-level-configuration-items/2760.enable_ls_leader_balance.md) | <ul><li>对于 V4.4.x 版本，该配置项从 V4.4.2 版本开始引入。</li><li>对于 V4.2.5 版本，该配置项从 V4.2.5 BP6 版本开始引入。</li></ul>  | 用于控制是否开启日志流 Leader 的自动均衡。 |
| [enable_gts_standalone](100.system-configuration-items/400.tenant-level-configuration-items/2550.enable_gts_standalone.md) | <ul><li>对于 V4.4.x 版本，该配置项从 V4.4.2 版本开始引入。</li><li>对于 V4.2.5 版本，该配置项从 V4.2.5 BP5 版本开始引入。</li></ul>    | 用于设置是否开启租户 GTS 服务独占一组 Unit 的功能。   |
| [zone_deploy_mode](100.system-configuration-items/400.tenant-level-configuration-items/13000.zone_deploy_mode.md)          | <ul><li>对于 V4.4.x 版本，该配置项从 V4.4.2 版本开始引入。</li><li>对于 V4.2.5 版本，该配置项从 V4.2.5 BP5 版本开始引入。</li></ul>     |  设置租户在各 Zone 的分布模式。   |
...
| 配置项名                                                                                                                                                      | 描述                      |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|
| [schema_history_recycle_interval](100.system-configuration-items/300.cluster-level-configuration-items/19400.schema_history_recycle_interval.md)     | 内部优化改造，对于 V4.4.2 版本，从 V4.4.2 BP1 版本开始删除。  |
