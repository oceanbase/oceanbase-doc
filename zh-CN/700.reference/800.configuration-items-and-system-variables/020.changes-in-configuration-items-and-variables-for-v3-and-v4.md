...
| 配置项名                                                                                                       | 引入版本    | 描述                             |
|---------------------------------------------------------------------------------------------------------------|-------------|---------------------------------|
| [ob_storage_s3_url_encode_type](100.system-configuration-items/300.cluster-level-configuration-items/16720.ob_storage_s3_url_encode_type.md) | 对于 V4.2.1 版本，从 V4.2.1 BP9 开始引入；对于 V4.2.x 其他版本，从 V4.2.5 版本开始引入。| 设置 S3 发送请求时的 URL 编码方式是否兼容 Rfc3986 标准。|
| [log_storage_warning_trigger_percentage](100.system-configuration-items/300.cluster-level-configuration-items/13050.log_storage_warning_trigger_percentage.md) | 对于 V4.2. 版本，从 V4.2.1 BP7 版本开始引入；对于 V4.2.x 其他版本，从 V4.2.5 版本开始引入。 | 控制触发日志盘故障的写入性能百分比阈值。|
