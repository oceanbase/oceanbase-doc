...
| 配置项名                                                                                                       | 引入版本    | 描述                             |
|---------------------------------------------------------------------------------------------------------------|-------------|---------------------------------|
| [enable_standby_semi_sync](100.system-configuration-items/400.tenant-level-configuration-items/2920.enable_standby_semi_sync.md) | 对于 V4.4.2 版本，从 V4.4.2 BP2 版本开始引入。| 用于控制备库（备租户）是否开启半同步模式。 |
