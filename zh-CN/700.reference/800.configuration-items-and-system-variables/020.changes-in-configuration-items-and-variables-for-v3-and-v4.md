...
| 配置项名                                                                                                       | 引入版本    | 描述                             |
|---------------------------------------------------------------------------------------------------------------|-------------|---------------------------------|
| [enable_ps_parameterize](100.system-configuration-items/400.tenant-level-configuration-items/3250.enable_ps_parameterize.md)                   | V4.2.5 BP2 | 用于控制开启或关闭 PS 语句在解析时是否参数化。|
