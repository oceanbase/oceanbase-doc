...
| 配置项名                          | 描述                                      |
|----------------------------------|-------------------------------------------|
| [enable_cgroup](100.system-configuration-items/300.cluster-level-configuration-items/6600.enable_cgroup.md) | 对于 V4.2.5 版本，从 V4.2.5 BP2 版本开始，生效模式由重启生效变更为立即生效。 |
...
| 配置项名                            | 描述                                      |
|------------------------------------|-------------------------------------------|
| [compaction_dag_cnt_limit](100.system-configuration-items/400.tenant-level-configuration-items/1000.compaction_dag_cnt_limit.md)  | 对于 V4.2.5 版本，从 V4.2.5 BP5 版本开始，默认值由 15000 调整为 50000。  |
| [dump_data_dictionary_to_log_interval](100.system-configuration-items/400.tenant-level-configuration-items/2300.dump_data_dictionary_to_log_interval.md)  | 对于 V4.2.5 版本，从 V4.2.5 BP1 版本开始，默认值由 24H 调整为 0。   |
...
| 配置项名                          | 描述                                      |
|----------------------------------|-------------------------------------------|
| [compaction_schedule_tablet_batch_cnt](100.system-configuration-items/400.tenant-level-configuration-items/1400.compaction_schedule_tablet_batch_cnt.md) | 对于 V4.2.5 版本，从 V4.2.5 BP5 版本开始，取值范围由 [10000，200000] 调整为 [10000，500000]。 |
| [compaction_dag_cnt_limit](100.system-configuration-items/400.tenant-level-configuration-items/1000.compaction_dag_cnt_limit.md)  | 对于 V4.2.5 版本，从 V4.2.5 BP5 版本开始，取值范围由 [10000，200000] 调整为 [10000，500000]。  |
| [dump_data_dictionary_to_log_interval](100.system-configuration-items/400.tenant-level-configuration-items/2300.dump_data_dictionary_to_log_interval.md)  | 对于 V4.2.5 版本，从 V4.2.5 BP1 版本开始，取值范围由 (0s, +∞) 调整为 [0s, +∞)。   |
...
| 配置项名                                                                                                       | 引入版本    | 描述                             |
|---------------------------------------------------------------------------------------------------------------|-------------|---------------------------------|
| [enable_ls_leader_balance](100.system-configuration-items/400.tenant-level-configuration-items/2760.enable_ls_leader_balance.md)               | 对于 V4.2.5 版本，该配置项从 V4.2.5 BP6 版本开始引入。| 用于控制是否开启日志流 Leader 的自动均衡。 |
| [enable_gts_standalone](100.system-configuration-items/400.tenant-level-configuration-items/2550.enable_gts_standalone.md)                     | 对于 V4.2.5 版本，该配置项从 V4.2.5 BP5 版本开始引入。| 用于设置是否开启租户 GTS 服务独占一组 Unit 的功能。|
| [zone_deploy_mode](100.system-configuration-items/400.tenant-level-configuration-items/13000.zone_deploy_mode.md)                              | 对于 V4.2.5 版本，该配置项从 V4.2.5 BP5 版本开始引入。| 用于设置租户在各 Zone 的分布模式。 |
| [temporary_file_max_disk_size](100.system-configuration-items/400.tenant-level-configuration-items/8330.temporary_file_max_disk_size.md)       | 对于 V4.2.5 版本，该配置项从 V4.2.5 BP3 版本开始引入。| 用于设置租户的单个节点内临时文件最大可占用的磁盘空间大小。|
| [enable_ps_parameterize](100.system-configuration-items/400.tenant-level-configuration-items/3250.enable_ps_parameterize.md)                   | 对于 V4.2.5 版本，该配置项从 V4.2.5 BP2 版本开始引入。| 用于控制开启或关闭 PS 语句在解析时是否参数化。|
| [ls_scale_out_factor](100.system-configuration-items/400.tenant-level-configuration-items/5530.ls_scale_out_factor.md)                        | 对于 V4.2.5 版本，该配置项从 V4.2.5 BP1 版本开始引入。 | 日志流的扩容系数，用于控制租户在每台服务节点上日志流的个数。|
| [arbitration_degradation_policy](100.system-configuration-items/300.cluster-level-configuration-items/320.arbitration_degradation_policy.md)  | <ul><li>对于 V4.2.5 版本，该配置项从 V4.2.5 BP1 版本开始引入。</li> <li>对于 V4.2.1 版本，该配置项从 V4.2.1 BP8 版本开始引入。</li> <li>对于 V4.3.x 版本，该配置项从 V4.3.4 版本开始引入。</li></ul> | 用于设置自动降级的策略。|
| [ob_storage_s3_url_encode_type](100.system-configuration-items/300.cluster-level-configuration-items/16720.ob_storage_s3_url_encode_type.md)  | 对于 V4.2.1 版本，从 V4.2.1 BP9 版本开始引入；对于 V4.2.x 其他版本，从 V4.2.5 版本开始引入。| 设置 S3 发送请求时的 URL 编码方式是否兼容 Rfc3986 标准。|
| [log_storage_warning_trigger_percentage](100.system-configuration-items/300.cluster-level-configuration-items/13050.log_storage_warning_trigger_percentage.md) | 对于 V4.2.1 版本，从 V4.2.1 BP7 版本开始引入；对于 V4.2.x 其他版本，从 V4.2.5 版本开始引入。 | 控制触发日志盘故障的写入性能百分比阈值。|
...
| [kv_group_commit_batch_size](100.system-configuration-items/400.tenant-level-configuration-items/3960.kv_group_commit_batch_size.md) | V4.2.5| 指定 obkv 组提交功能 batch 操作的大小。 |
| [kv_group_commit_rw_mode](100.system-configuration-items/400.tenant-level-configuration-items/3970.kv_group_commit_rw_mode.md)     |  V4.2.5 | 在组提交开启的情况下，指定支持组提交的操作类型。 |
| [recover_table_dop](100.system-configuration-items/400.tenant-level-configuration-items/7815.recover_table_dop.md)                 | V4.2.5 | 设置表级恢复的跨租户导表阶段，单表恢复的最大并行度。 |
| [recover_table_concurrency](100.system-configuration-items/400.tenant-level-configuration-items/7810.recover_table_concurrency.md) | V4.2.5  | 设置级恢复的跨租户导表阶段，允许并发恢复的最大表数。   |
...
| [enable_user_defined_rewrite_rules](100.system-configuration-items/400.tenant-level-configuration-items/3200.enable_user_defined_rewrite_rules.md)  | V4.1.0         | 用于控制是否开启改写绑定功能。  |
...
| 配置项名                                                                                                                                                      | 描述                      |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|
| [ob_ssl_invited_common_names](100.system-configuration-items/400.tenant-level-configuration-items/6600.ob_ssl_invited_common_names.md) | 如果需要校验客户证书具体的字段，在创建用户时指定即可，在用户登录时，没有必要再进行一次租户级别的校验，故从 V4.2.5 BP2 版本开始废弃该配置项。|
| [enable_kv_group_commit](100.system-configuration-items/400.tenant-level-configuration-items/2600.enable_kv_group_commit.md)   | 功能优化调整，从V4.2.5 版本开始删除。对于 V4.2.5 之后版本，可以使用配置项 [kv_group_commit_batch_size](100.system-configuration-items/400.tenant-level-configuration-items/3960.kv_group_commit_batch_size.md) 和 [kv_group_commit_rw_mode](100.system-configuration-items/400.tenant-level-configuration-items/3970.kv_group_commit_rw_mode.md) 来控制组提交功能。 |
...
| [clog_max_unconfirmed_log_count](100.system-configuration-items/400.tenant-level-configuration-items/800.clog_max_unconfirmed_log_count.md)                  | 实现逻辑变更，相关功能不再适用，从 V4.0.0 版本开始删除。|
...
| 变量名                          | 描述                                      |
|---------------------------------|-------------------------------------------|
| [ob_default_lob_inrow_threshold](200.system-variable/300.global-system-variable/6390.ob_default_lob_inrow_threshold-global.md)      | <ul><li>对于 V4.2.x 版本，从 V4.2.3 版本开始，默认值由 4096 调整为 8192。</li> <li>对于 V4.3.x 版本，从 V4.3.2 版本开始，默认值由 4096 调整为 8192。</li></ul> |
...
| [ob_max_read_stale_time](200.system-variable/300.global-system-variable/8200.ob_max_read_stale_time-global.md)                      | 从 V4.1.0 版本开始，默认值由 5000000 调整为 -1。|
| [ob_trx_idle_timeout](200.system-variable/300.global-system-variable/10100.ob_trx_idle_timeout-global.md)                           | 从 V4.0.0 版本开始，默认值由 120s 调整为 1d。|
...
| [ob_max_read_stale_time](200.system-variable/300.global-system-variable/8200.ob_max_read_stale_time-global.md)       | 从 V4.1.0 版本开始，取值范围由 \[0, 9223372036854775807\] 修改为 \[-1, 9223372036854775807\]。|
...
| 变量名                                                                               | 引入版本    | 描述                             |
|-------------------------------------------------------------------------------------|-------------|---------------------------------|
| [ob_enable_parameter_anonymous_block](200.system-variable/300.global-system-variable/6570.ob-enable-parameter-anonymous-block-global.md) | V4.2.5 | 控制是否开启匿名块参数化功能。 |
| [partition_index_dive_limit](200.system-variable/300.global-system-variable/10750.partition_index_dive_limit-global.md) | 对于 V4.2.1 版本，从 V4.2.1 BP9 版本开始引入；对于 V4.2.x 其他版本，从 V4.2.5 版本开始引入。 | 指定优化器使用存储层估行时分区数量限制。 |
| [range_index_dive_limit](200.system-variable/300.global-system-variable/11110.range_index_dev_limit.md) | 对于 V4.2.1 版本，从 V4.2.1 BP9 版本开始引入；对于 V4.2.x 其他版本，从 V4.2.5 版本开始引入。| 指定优化器使用存储层估行时的 range 数量限制。 |
| [cardinality_estimation_model](200.system-variable/300.global-system-variable/850.cardinality_estimation_model-global.md)           | V4.2.4 | 设置控制优化器在基数估计时使用的相关性假设。 |
...
| [lc_time_names](200.system-variable/300.global-system-variable/3400.lc_time_names-global.md)                                         | <ul><li>对于 V4.2.x 版本，从 V4.2.2 版本开始引入。</li> <li>对于 V4.3.x 版本，从 V4.3.1 版本开始引入。</li></ul>   | 控制显示日期和月份名称和缩写的语言。  |
| [ob_enable_pl_cache](200.system-variable/300.global-system-variable/6560.ob_enable_pl_cache.md)                               | <ul><li>对于 V4.2.x 版本，从 V4.2.2 版本开始引入。</li> <li>对于 V4.3.x 版本，从 V4.3.1 版本开始引入。</li></ul>   | 控制 PL cache 模块是否开启。 |
...
| [parallel_degree_limit](200.system-variable/300.global-system-variable/10550.parallel_degree_limit-global.md)                        | V4.2.0   | 设置在使用 Auto DOP 策略时，优化器选择并行度的上限值。 |
...
| [ob_create_table_strict_mode](200.system-variable/300.global-system-variable/6100.ob_create_table_strict_mode-global.md)      | 架构升级变更，从 V4.0.0 版本开始删除。 |
| [ob_enable_blk_nestedloop_join](200.system-variable/300.global-system-variable/6500.ob_enable_blk_nestedloop_join-global.md)  | 实现逻辑变更，相应功能不适用，从 V4.0.0 版本开始删除。|
