...
| 配置项名                          | 描述                                      |
|----------------------------------|-------------------------------------------|
| [schema_history_expire_time](100.system-configuration-items/400.tenant-level-configuration-items/7420.schema_history_expire_time.md)  | <ul><li>对于 V5.x 版本，从 V5.0.1 版本开始，由集群级变更为租户级。</li> <li>对于 V4.4.2 版本，从 V4.4.2 BP1 版本开始，由集群级变更为租户级。</li></ul>     |
...
| 配置项名                                                                                                       | 引入版本    | 描述                             |
|---------------------------------------------------------------------------------------------------------------|-------------|---------------------------------|
| [schema_history_archive_expire_time](100.system-configuration-items/400.tenant-level-configuration-items/7410.schema_history_archive_expire_time.md)     | <ul><li>对于 V5.x 版本，从 V5.0.1 版本开始引入。</li> <li>对于 V4.4.2 版本，从 V4.4.2 BP1 版本开始引入。</li></ul>  | 用于指定 Schema 多版本历史归档数据的保留时间。 |
| [zone_disk_balance_tolerance_percentage](100.system-configuration-items/400.tenant-level-configuration-items/13001.zone_disk_balance_tolerance_percentage.md) | <ul><li>对于 V5.x 版本，从 V5.0.1 版本开始引入。</li> <li>对于 V4.4.2 版本，从 V4.4.2 BP1 版本开始引入。</li></ul>  | 用于控制 Zone 间表组磁盘均衡算法对不均衡的容忍程度。  |
...
| 配置项名                                                                                                                                                      | 描述                      |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|
| [schema_history_recycle_interval](100.system-configuration-items/300.cluster-level-configuration-items/19400.schema_history_recycle_interval.md) | 内部改造优化，对于 V5.x 版本，从 V5.0.1 版本开始删除；对于 V4.4.2 版本，从 V4.4.2 BP1 版本开始删除。 |
