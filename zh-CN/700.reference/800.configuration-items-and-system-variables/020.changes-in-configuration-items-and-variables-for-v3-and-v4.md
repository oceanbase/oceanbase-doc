...
下表中列出了在 V4.x 版本中被废弃的 V3.x 版本的配置项。
...
| [system_trace_level](300.cluster-level-configuration-items/23100.system_trace_level.md)                                                                      | 实现逻辑变更，该配置项已不适用，从 V4.2.0 版本开始删除。|
...
下表中列出了在 V4.x 版本中被废弃的 V3.x 版本的变量。
