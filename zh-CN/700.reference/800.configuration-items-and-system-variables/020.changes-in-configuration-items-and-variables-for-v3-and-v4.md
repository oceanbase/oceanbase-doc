...
| 配置项名                            | 描述                                      |
|------------------------------------|-------------------------------------------|
| [kv_group_commit_batch_size](100.system-configuration-items/400.tenant-level-configuration-items/4150.kv_group_commit_batch_size.md)           | 对于 V V4.3.5 版本，从 V4.3.5 BP1 版本开始，默认值由 1 改为 10。|
| [direct_load_allow_fallback](100.system-configuration-items/400.tenant-level-configuration-items/2240.direct_load_allow_fallback.md)           | 对于 V V4.3.5 版本，从 V4.3.5 BP1 版本开始，默认值由 False 改为 True。|
...
| [pid_file]() | <ul><li>对于 V4.3.5 版本，从 V4.3.5 BP1 版本开始引入。</li> <li>对于 V4.2.5 版本，从 V4.2.5 BP1 版本开始引入。</li> <li>对于 V4.2.1 版本，从 V4.2.1 BP10 版本开始引入。</li></ul> | 用于查询服务器写入其进程 ID 的文件的路径名。|
| [port]() | <ul><li>对于 V4.3.5 版本，从 V4.3.5 BP1 版本开始引入。</li> <li>对于 V4.2.5 版本，从 V4.2.5 BP1 版本开始引入。</li> <li>对于 V4.2.1 版本，从 V4.2.1 BP10 版本开始引入。</li></ul>  | 用于在 OBServer 节点部署时，设置服务器监听 TCP/IP 连接的端口号。 |
| [socket]()| <ul><li>对于 V4.3.5 版本，从 V4.3.5 BP1 版本开始引入。</li> <li>对于 V4.2.5 版本，从 V4.2.5 BP1 版本开始引入。</li> <li>对于 V4.2.1 版本，从 V4.2.1 BP10 版本开始引入。</li></ul> | 用于查询本地客户端连接 Socket 文件的名称。|
