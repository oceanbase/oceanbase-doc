...
| 配置项名                          | 描述                                      |
|----------------------------------|-------------------------------------------|
| [schema_history_expire_time](100.system-configuration-items/400.tenant-level-configuration-items/7420.schema_history_expire_time.md)  | <ul><li>对于 V4.6.x 版本，从 V4.6.1 版本开始，由集群级变更为租户级。</li> <li>对于 V4.4.2 版本，从 V4.4.2 BP1 版本开始，由集群级变更为租户级。</li></ul>     |
...
| 配置项名                          | 描述                                      |
|----------------------------------|-------------------------------------------|
| [net_thread_count](100.system-configuration-items/300.cluster-level-configuration-items/15500.net_thread_count.md)                     | 从 V4.4.0 版本开始，生效模式由重启生效变更为立即生效。  |
...
| 配置项名                            | 描述                                      |
|------------------------------------|-------------------------------------------|
| [ob_storage_s3_url_encode_type](100.system-configuration-items/300.cluster-level-configuration-items/16620.ob_storage_s3_url_encode_type.md)      | 对于 V4.6.x 版本，从 V4.6.0 版本开始，默认值由 <code>default</code> 调整为 <code>compliantRfc3986Encoding</code>。              |
| [compaction_dag_cnt_limit](100.system-configuration-items/400.tenant-level-configuration-items/900.compaction_dag_cnt_limit.md)  | 从 V4.4.0 版本开始，默认值由 15000 调整为 50000。  |
| [kv_group_commit_batch_size](100.system-configuration-items/400.tenant-level-configuration-items/4150.kv_group_commit_batch_size.md)           | 对于 V4.3.5 版本，从 V4.3.5 BP1 版本开始，默认值由 1 调整为 10。|
| [direct_load_allow_fallback](100.system-configuration-items/400.tenant-level-configuration-items/2240.direct_load_allow_fallback.md)           | 从 V4.3.5 版本开始，默认值由 False 调整为 True。|
...
| 配置项名                          | 描述                                      |
|----------------------------------|-------------------------------------------|
| [compaction_schedule_tablet_batch_cnt](100.system-configuration-items/400.tenant-level-configuration-items/1300.compaction_schedule_tablet_batch_cnt.md) | 从 V4.4.0 版本开始，取值范围由 [10000，200000] 调整为 [10000，500000]。 |
| [compaction_dag_cnt_limit](100.system-configuration-items/400.tenant-level-configuration-items/900.compaction_dag_cnt_limit.md)  | 从 V4.4.0 版本开始，取值范围由 [10000，200000] 调整为 [10000，500000]。  |
| [net_thread_count](100.system-configuration-items/300.cluster-level-configuration-items/15500.net_thread_count.md)                     | 从 V4.3.5 BP2 版本开始，取值范围由 [0, 64] 调整为 [0, 128]。  |
...
| 配置项名                                                                                                       | 引入版本    | 描述                             |
|---------------------------------------------------------------------------------------------------------------|-------------|---------------------------------|
| [schema_history_archive_expire_time](100.system-configuration-items/400.tenant-level-configuration-items/7410.schema_history_archive_expire_time.md)     | <ul><li>对于 V4.6.x 版本，从 V4.6.1 版本开始引入。</li> <li>对于 V4.4.2 版本，从 V4.4.2 BP1 版本开始引入。</li></ul>  | 用于指定 Schema 多版本历史归档数据的保留时间。 |
| [zone_disk_balance_tolerance_percentage](100.system-configuration-items/400.tenant-level-configuration-items/13001.zone_disk_balance_tolerance_percentage.md) | <ul><li>对于 V4.6.x 版本，从 V4.6.1 版本开始引入。</li> <li>对于 V4.4.2 版本，从 V4.4.2 BP1 版本开始引入。</li></ul>  | 用于控制 Zone 间表组磁盘均衡算法对不均衡的容忍程度。  |
| [storage_cache_clean_macro_interval](100.system-configuration-items/400.tenant-level-configuration-items/7750.storage_cache_clean_macro_interval.md) |  V4.6.0 | 用于控制共享存储（Shared-Storage，SS）模式下宏块级别的热点宏块缓存清理任务的执行频率。 |
| [enable_ttl](100.system-configuration-items/400.tenant-level-configuration-items/3020.enable_ttl.md) | V4.6.0 | 用于控制 SQL 模式下是否开启 TTL 功能。|
| [ttl_duty_time](100.system-configuration-items/400.tenant-level-configuration-items/8095.ttl_duty_time.md) | V4.6.0 | 用于指定 TTL 后台定期触发 TTL 任务的执行时间点。|
| [enable_window_compaction](100.system-configuration-items/400.tenant-level-configuration-items/3150.enable_window_compaction.md) | V4.6.0 | 用于指定当前租户是否使用窗口合并。 |
| [enable_ls_leader_balance](100.system-configuration-items/400.tenant-level-configuration-items/2760.enable_ls_leader_balance.md) | <ul><li>对于 V4.6.x 版本，该配置项从 V4.6.0 版本开始引入。</li> <li>对于 V4.4.x 版本，该配置项从 V4.4.2 版本开始引入。</li><li>对于 V4.2.5 版本，该配置项从 V4.2.5 BP6 版本开始引入。</li></ul>  | 用于控制是否开启日志流 Leader 的自动均衡。 |
| [enable_gts_standalone](100.system-configuration-items/400.tenant-level-configuration-items/2550.enable_gts_standalone.md) | <ul><li>对于 V4.6.x 版本，该配置项从 V4.6.0 版本开始引入。</li> <li>对于 V4.4.x 版本，该配置项从 V4.4.2 版本开始引入。</li><li>对于 V4.2.5 版本，该配置项从 V4.2.5 BP5 版本开始引入。</li></ul>    | 用于设置是否开启租户 GTS 服务独占一组 Unit 的功能。   |
| [zone_deploy_mode](100.system-configuration-items/400.tenant-level-configuration-items/13000.zone_deploy_mode.md)          | <ul><li>对于 V4.6.x 版本，该配置项从 V4.6.0 版本开始引入。</li> <li>对于 V4.4.x 版本，该配置项从 V4.4.2 版本开始引入。</li><li>对于 V4.2.5 版本，该配置项从 V4.2.5 BP5 版本开始引入。</li></ul>     |  设置租户在各 Zone 的分布模式。   |
| [mds_minor_compact_trigger](100.system-configuration-items/400.tenant-level-configuration-items/5460.mds_minor_compact_trigger.md) | V4.4.1 | 用于控制触发 MDS Minor Compaction 的 SSTable 数量。 |
| [mds_compaction_mid_thread_score](100.system-configuration-items/400.tenant-level-configuration-items/5450.mds_compaction_mid_thread_score.md) | V4.4.1 | 用于设置中优先级 MDS Compaction 的 DAG（Direct Acyclic Graph）线程数。 |
| [mds_compaction_high_thread_score](100.system-configuration-items/400.tenant-level-configuration-items/5440.mds_compaction_high_thread_score.md) | V4.4.1 | 用于设置高优先级 MDS Compaction 的 DAG（Direct Acyclic Graph）线程数。 |
| [ls_scale_out_factor](100.system-configuration-items/400.tenant-level-configuration-items/5160.ls_scale_out_factor.md) | <ul><li>对于 V4.4.x 版本，该配置项从 V4.4.1 版本开始引入。</li> <li>对于 V4.2.5 版本，该配置项从 V4.2.5 BP1 版本开始引入。</li></ul> | 日志流的扩容系数，用于控制租户在每台服务节点上日志流的个数。 |
| [external_table_io_hole_size](100.system-configuration-items/400.tenant-level-configuration-items/3230.external_table_io_hole_size.md) | V4.4.0 | 用于设置两个连续 IO 范围之间的最大距离（以字节为单位）。|
| [external_table_io_range_size](100.system-configuration-items/400.tenant-level-configuration-items/3250.external_table_io_range_size.md) | V4.4.0 | 用于设置合并范围的最大大小（以字节为单位）。如果合并两个连续范围会产生大于此大小的范围，则不会合并它们。|
| [async_ps_cursor_max_count](100.system-configuration-items/300.cluster-level-configuration-items/650.async_ps_cursor_max_count.md) | V4.4.0 | 用于控制单节点中异步 PS cursor 的最大个数。|
| [ob_enable_java_udf](100.system-configuration-items/400.tenant-level-configuration-items/5860.ob_enable_java_udf.md) | V4.4.0 | 用于开启或关闭 Java UDF 功能。|
| [load_data_diagnosis_log_compression](100.system-configuration-items/400.tenant-level-configuration-items/4220.load_data_diagnosis_log_compression.md) | V4.4.0 | 用于设置诊断日志使用的压缩算法。 |
| [load_data_diagnosis_log_max_size](100.system-configuration-items/400.tenant-level-configuration-items/4230.load_data_diagnosis_log_max_size.md) | V4.4.0 | 用于设置单个诊断日志文件的大小。|
| [result_cache_max_size](100.system-configuration-items/400.tenant-level-configuration-items/7340.result_cache_max_size.md) | V4.4.0 | 用于控制 `result cache` 模块能使用最大内存量。 |
| [result_cache_max_result](100.system-configuration-items/400.tenant-level-configuration-items/7350.result_cache_max_result.md) | V4.4.0 | 用于控制单个 result cache 缓存对象最多能使用 `result_cache_max_size` 的内存比例。|
| [ob_result_cache_evict_percentage](100.system-configuration-items/400.tenant-level-configuration-items/7360.ob_result_cache_evict_percentage.md) | V4.4.0 | 用于设置 `result cache` 内存淘汰水位线。|
| [ob_deterministic_udf_cache_max_size](100.system-configuration-items/400.tenant-level-configuration-items/7370.ob_deterministic_udf_cache_max_size.md) | V4.4.0 | 用于标记语句执行期，所有 `deterministic` 的 UDF 的缓存池总共可以使用的最大内存量(以字节为单位)，如果为 0，则表示关闭执行期缓存功能。 |
| [attach_shared_sstable_thread_score](100.system-configuration-items/400.tenant-level-configuration-items/230.attach_shared_sstable_thread_score.md) | V4.4.0 | 用于配置租户可用来执行共享存储模式下计算节点共享数据引用的线程数。 |
| [inc_sstable_upload_thread_score](100.system-configuration-items/400.tenant-level-configuration-items/3650.inc_sstable_upload_thread_score.md) | V4.4.0 | 用于配置租户可用来执行共享存储模式下数据共享类任务的线程数。 |
...
| [global_index_auto_split_policy](100.system-configuration-items/400.tenant-level-configuration-items/3350.global_index_auto_split_policy.md) | V4.3.5 BP2 | 用于控制新建的全局索引是否开启自动分区功能。<main id="notice" type='notice'><h4>注意</h4><p>从 V4.4.1 版本开始，开源模式下，该配置项默认值变更为 `ALL`。</p></main> |
...
| [temporary_file_max_disk_size](100.system-configuration-items/400.tenant-level-configuration-items/8030.temporary_file_max_disk_size.md)                  | V4.3.5 BP1 | 设置租户的单个节点内临时文件最大可占用的磁盘空间大小。|
...
| [enable_auto_split](100.system-configuration-items/400.tenant-level-configuration-items/2350.enable_auto_split.md)               | V4.3.4  | 控制该表是否需要开启自动分区功能。<main id="notice" type='notice'><h4>注意</h4><p>从 V4.4.1 版本开始，使用 KV 模版创建的集群，该配置项默认值变更为 true。</p></main> |
| [auto_split_tablet_size](100.system-configuration-items/400.tenant-level-configuration-items/450.auto_split_tablet_size.md)      | V4.3.4  | 控制租户开启自动分区功能之后触发分裂的阈值。<main id="notice" type='notice'><h4>注意</h4><p>从 V4.4.1 版本开始，该配置项默认值变更为 2GB。</p></main> |
...
| 配置项名                                                                                                                                                      | 描述                      |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|
| [schema_history_recycle_interval](100.system-configuration-items/300.cluster-level-configuration-items/19400.schema_history_recycle_interval.md) | 内部改造优化，对于 V4.6.x 版本，从 V4.6.1 版本开始删除；对于 V4.4.2 版本，从 V4.4.2 BP1 版本开始删除。 |
