...
| 变量名                                                                               | 引入版本    | 描述                             |
|-------------------------------------------------------------------------------------|-------------|---------------------------------|
| [ob_enable_parameter_anonymous_block](200.system-variable/400.session-system-variable/7160.ob-enable-parameter-anonymous-block-session.md) | V4.2.5 | 控制是否开启匿名块参数化功能。 |
