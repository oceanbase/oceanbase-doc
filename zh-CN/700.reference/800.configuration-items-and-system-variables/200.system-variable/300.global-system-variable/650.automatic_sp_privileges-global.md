...
设置在存储过程中允许被自动授予 ALTER 和 EXECUTE 的权限。
...
有关存储过程函数的权限信息，可查询视图 [mysql.procs_priv](../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/4100.mysql-procs_priv-of-mysql-mode.md)。
