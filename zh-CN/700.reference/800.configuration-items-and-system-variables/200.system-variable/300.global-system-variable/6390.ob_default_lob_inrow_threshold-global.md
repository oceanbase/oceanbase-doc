...
| ----------| ----- |
| 参数类型    | Int |
| 默认值      | 8192，单位为字节 <main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.2.x 版本，该变量从 V4.2.3 版本开始默认值由 4096 调整为 8192。</li> <li>对于 V4.3.x 版本，该变量从 V4.3.2 版本开始默认值由 4096 调整为 8192。</li></ul></main> |
