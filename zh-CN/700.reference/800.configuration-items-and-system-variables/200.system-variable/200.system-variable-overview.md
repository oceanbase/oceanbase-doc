...
| [ob_compatibility_control](300.global-system-variable/17600.ob_compatibility_control-global.md) | 用于控制 MYSQL5.7、 MYSQL8.0 有兼容性冲突时的行为模式。在创建租户时指定兼容模式，且在租户创建后无法修改。|
...
| [ob_security_version](300.global-system-variable/17800.ob_security_version-global.md)| 用于控制安全功能兼容的 OceanBase 数据库版本。在创建租户时指定兼容版本，且在租户创建后无法修改。|
...
| [cte_max_recursion_depth](300.global-system-variable/14700.cte_max_recursion_depth-global.md)  | 用于设置公共表表达式（CTE）的最大递归深度。服务器会终止执行任何超过此 CTE 值的操作。 |
| [regexp_stack_limit](300.global-system-variable/14800.regexp_stack_limit-global.md)  | 用于正则表达式匹配操作的内部堆栈的最大可用内存。 |
| [regexp_time_limit](300.global-system-variable/14900.regexp_time_limit-global.md)  | 用于正则表达式匹配操作的时间限制。 |

### 调度程序相关

| 变量名 | 功能描述 |
|-------|----------|
| [event_scheduler](300.global-system-variable/14900.event_scheduler-global.md)  | 用于确定事件调度程序是否在服务器上启用和运行。 |
...
|   变量名   |                 功能描述                  |
|----------------|---------------------------------------|
| [activate_all_roles_on_login](300.global-system-variable/17400.activate_all_roles_on_login-global.md)     | 用于控制在登录时是否默认自动启用所有 Roles。  |
...
| [log_row_value_options](300.global-system-variable/15100.log_row_value_options-global.md)  | 用于控制 Lob 是否使用部分更新。 |
| [ob_default_lob_inrow_threshold](300.global-system-variable/16600.ob_default_lob_inrow_threshold-global.md)  | 用于指定建表时，表中 LOB 字段的默认行内存储阈值。 |
...
| [optimizer_features_enable](300.global-system-variable/16500.optimizer_features_enable-global.md) | 用于启用不同 OceanBase 版本优化器功能。 |
