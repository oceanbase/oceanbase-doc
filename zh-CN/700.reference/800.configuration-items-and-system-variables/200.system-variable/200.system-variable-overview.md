...
|[have_query_cache](../200.system-variable-for-mysql/14200.have_query_cache.md) | 用于查询是否支持系统缓存。 |
|[query_cache_limit](../200.system-variable-for-mysql/14300.query_cache_limit.md) | 用于查询系统的最大缓存量。 |
|[query_cache_min_res_unit](../200.system-variable-for-mysql/14400.query_cache_min_res_unit.md) | 用于查询系统缓存分配的最小内存单元。 |
|[query_cache_wlock_invalidate](../200.system-variable-for-mysql/14500.query_cache_wlock_invalidate.md) | 用于对 MyISAM 引擎所查询的表如果被 write 锁锁定，是否使用缓存返回结果。 |
