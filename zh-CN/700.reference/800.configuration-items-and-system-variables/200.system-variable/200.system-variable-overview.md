...
|                                 变量名                                 |                         功能描述                          |
|---------------------------------------------------------------------|-------------------------------------------------------|
| [debug_sync](300.global-system-variable/7800.ob_global_debug_sync-global.md)           | 用于在 Debug 时设置同步点，与 MySQL 兼容。                          |
...
|                                变量名                                 |      功能描述      |
|--------------------------------------------------------------------|----------------|
| [read_only](300.global-system-variable/13300.tx_read_only-global.md)           | 用于设置租户是否为只读模式。 |
