...
|   变量名   |     功能描述 |
|----------------|---------|
| [debug](300.global-system-variable/18200.debug-global.md)           | 用于设置调试选项。                         |
...
|          变量名           |             功能描述             |
|-------------------------------|------------------------------|
| [ob_enable_pl_cache](300.global-system-variable/16900.ob_enable_pl_cache.md)                | 用于控制 PL cache 模块是否开启。        |
...
|    变量名        |     功能描述         |
|-----------------|----------------------------------------|
| [lc_time_names](400.session-system-variable/16800.lc_time_names-global.md)             |   用于控制显示日期和月份名称和缩写的语言。            |
...
| [profiling](300.global-system-variable/18000.profiling-global.md) | 用于启用或禁用语句分析功能。      |
| [profiling_history_size](300.global-system-variable/18100.profiling_history_size-global.md) | 用于设置保存查询性能信息的历史记录数量。      |
| [have_profiling](300.global-system-variable/17900.have_profiling-global.md) | 用于检测是否支持查询性能分析。      |
| [innodb_strict_mode](300.global-system-variable/3100.innodb_strict_mode-global.md)  | 用于设置特定语法的 SQL 检查模式。  |
