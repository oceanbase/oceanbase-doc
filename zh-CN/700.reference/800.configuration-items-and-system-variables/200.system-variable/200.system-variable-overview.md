...
| [ob_compatibility_version](300.global-system-variable/17700.ob_compatibility_control-global.md) | 用于控制产品行为发生变更的功能兼容的 OceanBase 数据库版本。在创建租户时指定兼容版本，且在租户创建后无法修改。|
