...
| [pid_file](300.global-system-variable/10850.pid_file-global.md) | 用于设置服务器写入其进程 ID 的文件的路径名。 |
| [port](300.global-system-variable/10950.port-global.md) | 用于设置服务器监听 TCP/IP 连接的端口号。 |
| [socket](300.global-system-variable/11550.socket-global.md) | 用于设置本地客户端连接 `Socket` 文件的名称。 |
