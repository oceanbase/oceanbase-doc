...
|   变量名   |     功能描述 |
|----------------|---------|
| [debug](300.global-system-variable/2150.debug-global.md)           | 用于设置调试选项，其默认值为 ``。 <main id="notice" type='explain'><h4>说明</h4><p>该变量仅用于兼容 MySQL 5.7，相关功能并不支持，可以查询及设置，设置行为不报错但不生效。</p></main>                         |
...
|   变量名   |     功能描述 |
|----------------|---------|
| [debug](400.session-system-variable/2200.debug-session.md)           | 用于设置调试选项，其默认值为 `d:t:i:o,/tmp/mysqld.trace`。 <main id="notice" type='explain'><h4>说明</h4><p>该变量仅用于兼容 MySQL 5.7，相关功能并不支持，可以查询及设置，设置行为不报错但不生效。</p></main>                         |
