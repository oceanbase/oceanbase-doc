...
2. 查看 ODP 上所有租户连接的全部 Client Session 的内部状态。
    ...
    +----------------------+-------+----------+-----------+------+----------------------+------+-------------+-------------------+-------------------+-------+-------+-----------+
    | 12402504630519660563 | 65166 | test420  | sys       | root | 100.xx.xx.xx:49782   | NULL |           0 |                 1 | MCS_ACTIVE_READER | 76286 | 76286 |         0 |
    | 12402504630519660560 | 75478 | test420  | oracle001 | sys  | 100.xx.xx.xx:54725   | SYS  |           0 |                 1 | MCS_ACTIVE_READER | 76291 | 76286 |         0 |
    +----------------------+-------+----------+-----------+------+----------------------+------+-------------+-------------------+-------------------+-------+-------+-----------+
    2 rows in set
    ```
