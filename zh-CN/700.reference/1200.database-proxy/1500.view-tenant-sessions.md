...
2. 执行以下语句，查看租户会话信息。
      ...
      *************************** 1. row ***************************
         ...
         USER_CLIENT_IP: 100.xx.xxx.xxx
             ...
             RETRY_INFO: 0
              ...
              THREAD_ID: 20230
             SSL_CIPHER: NULL
               TRACE_ID: YB42AC1E87C6-000615DE2E31358C-0-0
            TRANS_STATE:
                 ACTION:
                 MODULE:
            CLIENT_INFO:
   ...
   * Oracle 模式
      ...
      ```shell
      obclient [SYS]> SELECT * FROM SYS.GV$OB_PROCESSLIST;
      ```
      ...
      *************************** 1. row ***************************
         ...
         USER_CLIENT_IP: 100.xx.xxx.xxx
             ...
             RETRY_INFO: 0
              ...
              THREAD_ID: 20625
             SSL_CIPHER: NULL
               TRACE_ID: YB42AC1E87C6-000615DE2ED13592-0-0
            TRANS_STATE: NULL
                 ACTION: NULL
                 MODULE: NULL
            CLIENT_INFO: NULL
