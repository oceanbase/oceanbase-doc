...
有关分区表的相关介绍，请参见 [管理分区](../../3.database-object-management/1.manage-object-of-mysql-mode/3.manage-partitions-of-mysql-mode/1.partition-overview-of-mysql-mode.md)。
