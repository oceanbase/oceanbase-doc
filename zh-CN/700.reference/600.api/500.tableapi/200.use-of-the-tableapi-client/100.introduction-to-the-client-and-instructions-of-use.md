...
Map<String, Object> res = client.get("test_varchar_table_00",
           new Object[] { 1L, "partition".getBytes(), timestamp }, 
           new String[] { "c1", "c2", "c3" }
);

// 返回的结果 value 是 object，直接强转一下就行 例如 Long c1 = (Long) res.get("c1");
```
...
* primaryIndex：设定根据主键值扫描。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>如果需使用索引扫描，则可以把 <code>primaryIndex</code> 替换成 <code>indexName</code>。</p>
  </main>
