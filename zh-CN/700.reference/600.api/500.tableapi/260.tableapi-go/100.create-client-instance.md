...
登录到 [obkv go 客户端仓库](https://github.com/oceanbase/obkv-table-client-go)，获取当前最新客户端版本，并添加到 pom.xml 文件中。
...
* 通过连接 ODP(OceanBase Database Proxy) 连接 OBServer 同时提供直接创建及 Toml 文件创建客户端两种方式。
