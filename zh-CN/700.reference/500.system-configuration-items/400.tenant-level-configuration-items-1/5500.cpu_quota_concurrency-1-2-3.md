...
==========================================
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/cpu_quota_concurrency-1-2-3
...
* `workers_per_cpu_quota`表示租户在每个cpu上能分配的最大 worker 数
  ...
  workers_per_cpu_quota 配置项详细信息，请参见 [workers_per_cpu_quota](../300.cluster-level-configuration-items-1/23200.workers_per_cpu_quota-1-2-3.md)。
