...
* 通过 obshell-sdk-python 请求 API 方法的介绍可参见 [查询 OceanBase 集群的最后一个运维任务](../../500.obshell-sdk-reference/100.python/1000.task-management/2600.get-oceanbase-last-o-m-task-of-python.md)。

* 通过 obshell-sdk-go 请求 API 方法的介绍可参见 [查询 OceanBase 集群的最后一个运维任务](../../500.obshell-sdk-reference/200.go/1000.task-management/2600.get-oceanbase-last-o-m-task-of-go.md)。
