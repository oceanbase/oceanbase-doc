...
判断集群是否被 obshell 管理，以及如何使用 obshell 接管 OceanBase 集群的详细介绍请参见 [接管非 obshell 部署集群](../210.use-case/300.take-over-non-obshell-deployed-clusters.md)。启动 OBServer 节点的详细使用场景可参见 [启动 OceanBase 集群](../210.use-case/310.start-oceanbase-cluster.md)。
