...
<main id="notice" type='explain'>
  ...
  <li><p>对于 OceanBase 数据库 V4.2.5 版本，<code>io_adapter_benchmark</code> 命令自 V4.2.5 BP5 版本更新，之前版本的命令介绍可参见 <a href="https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001111834">io_adapter_benchmark</a>。</p></li>
  </ul>
</main>
