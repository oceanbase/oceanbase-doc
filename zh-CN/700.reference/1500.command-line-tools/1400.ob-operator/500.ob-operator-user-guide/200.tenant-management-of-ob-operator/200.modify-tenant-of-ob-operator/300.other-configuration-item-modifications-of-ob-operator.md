...
* 修改租户资源的详细内容可参考 [资源管理](../200.modify-tenant-of-ob-operator/100.resource-management-of-ob-operator.md)。

* 修改租户副本的详细内容可参考 [副本管理](../200.modify-tenant-of-ob-operator/200.replica-management-of-ob-operator.md)。
...
3. 执行以下语句，查看当前 Kubernetes 集群中租户的 Custom Resource，来判断是否修改成功。
    ...
    当看到租户的 Custom Resource 中 `spec:connectWhiteList` 对应的值变为修改后的值，则说明修改成功。
