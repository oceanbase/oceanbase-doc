...
查看当前拥有权限的操作请参见 [查看用户权限](../4.view-the-user-permissions-of-oracle-mode.md)。如果您没有相应的权限，请联系管理员为您添加，为用户添加权限的相关操作请参见 [修改用户权限](../5.modify-the-user-permissions-of-oracle-mode.md)。查看当前用户拥有的角色的操作请参见 [查看角色](../9.manage-roles-of-oracle-mode/6.view-roles-of-oracle-mode.md)。
