...
查看当前拥有权限的操作请参见 [查看用户权限](../300.mysql-mode/400.to-view-user-permissions-of-mysql-mode.md)。如果您没有全局 `ALTER USER` 权限，请联系管理员为您添加，为用户添加权限的相关操作请参见 [修改用户权限](../300.mysql-mode/500.to-modify-user-permissions-of-mysql-mode.md)。
...
更多 `ALTER USER` 语句的信息请参见 [ALTER USER](../../../../../400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/800.alter-user-of-mysql-mode.md)。
