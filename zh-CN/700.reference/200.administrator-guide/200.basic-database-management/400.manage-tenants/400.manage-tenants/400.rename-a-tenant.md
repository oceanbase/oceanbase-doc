...
更多 `ALTER TENANT` 语句的信息，请参见 [ALTER TENANT](../../../../400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/600.alter-table-of-mysql-mode.md)。
