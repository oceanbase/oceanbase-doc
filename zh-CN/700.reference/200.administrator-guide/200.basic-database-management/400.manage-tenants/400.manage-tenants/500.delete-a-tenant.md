...
* 对于 `DROP TENANT` 操作：
  ...
  * 当系统租户开启回收站功能时，`DROP TENANT` 操作表示删除的租户会进入回收站。对于回收站中的租户，后续系统租户可以通过回收站功能进一步删除或恢复该租户。有关回收站相关操作，参见 [回收站](../../../../../600.manage/400.high-availability/300.recyclebin-management/100.recyclebin-overview.md)。
