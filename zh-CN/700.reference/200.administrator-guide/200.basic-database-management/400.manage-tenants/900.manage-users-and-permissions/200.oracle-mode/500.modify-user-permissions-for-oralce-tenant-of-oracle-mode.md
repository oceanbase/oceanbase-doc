...
查看当前拥有权限的操作请参见 [查看用户权限](../200.oracle-mode/400.view-the-user-permissions-of-oracle-mode.md)。如果您没有所需的权限，请联系管理员为您添加。查看当前拥有角色的操作请参见 [查看角色](900.manage-roles-of-oracle-mode/600.view-roles-of-oracle-mode.md)。
...
查看当前拥有权限的操作请参见 [查看用户权限](../200.oracle-mode/400.view-the-user-permissions-of-oracle-mode.md)。如果您没有所需的权限，请联系管理员为您添加。
...
`REVOKE` 语句的更多信息，请参见 [REVOKE](../../../../../400.development-reference/100.sql-syntax/300.common-tenant-of-oracle-mode/900.sql-statement-of-oracle-mode/300.dcl-of-oracle-mode/2900.revoke-of-oracle-mode.md)。
