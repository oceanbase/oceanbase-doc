...
查看当前拥有权限的操作请参见 [查看用户权限](../300.mysql-mode/400.view-the-user-permissions-of-mysql-mode.md)。
...
更多 `GRANT` 语句的信息请参见 [GRANT](../../../../../400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/5500.grant-of-mysql-mode.md)。
...
更多 `REVOKE` 语句的信息请参见 [REVOKE](../../../../../400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/7700.revoke-of-mysql-mode.md)。
