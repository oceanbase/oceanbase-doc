...
OceanBase 数据库中各集群参数的详细说明信息请参见 [系统配置项](../../../../500.system-reference/100.system-configuration-items/100.system-configuration-items-overview.md) 章节。
...
2. 修改/添加配置文件中的配置项
   ...
   配置文件各个模块的含义可参考 [配置文件说明](https://www.oceanbase.com/docs/community-obd-cn-10000000001031923)。
