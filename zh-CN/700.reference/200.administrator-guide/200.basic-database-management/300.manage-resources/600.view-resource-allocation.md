...
3. 执行以下命令，查看集群内各 Server 的资源分配情况。
   ...
   *************************** 3. row ***************************
   ...
   更多视图 `oceanbase.GV$OB_SERVERS` 的说明信息请参见 [GV$OB_SERVERS](../../../500.system-reference/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/900.gv-ob_servers-of-mysql-mode.md)。
