...
2. 通过修改租户 `tenant1` 的 Locality 来删除副本。
   ...
   根据 Locality 的变更规则，租户从 5 副本变为 3 副本时，可以直接将 Locality 变更为 `F@z1,F@z2,F@z3`，Locality 的变更规则相关信息参见 [修改 Locality](../../../../../600.manage/300.replica-management/200.replica-distribution/200.locality-common-operations/200.modify-locality.md)。
