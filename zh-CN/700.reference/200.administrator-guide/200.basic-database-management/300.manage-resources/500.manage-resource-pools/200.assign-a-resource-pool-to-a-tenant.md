...
4. 通过修改租户 Locality 来增加副本。
   ...
   根据 Locality 的变更规则，租户从 3 副本变为 5 副本时，可以直接将 Locality 变更为 `F@z1,F@z2,F@z3,F@z4,F@z5`。Locality 的变更规则相关信息参见 [修改 Locality](../../../../../600.manage/300.replica-management/200.replica-distribution/200.locality-common-operations/200.modify-locality.md)。
