...
4. 为租户 `tenant1` 在 `z4`、`z5` 上添加资源。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>增加 Zone 成功后，您可以通过扩大租户资源池的 ZONE_LIST 范围或创建新资源池后再将资源池分配给租户等方式为租户添加资源，此处以创建新的资源池后再将资源池分配给租户为例提供操作指导，直接扩大租户资源池的 ZONE_LIST 范围的相关操作请参见 <a href="../../../../200.basic-database-management/400.manage-tenants/900.modify-the-resource-configuration-of-a-tenant.md">修改租户的资源配置</a>。</p>
  </main>
