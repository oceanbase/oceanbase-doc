...
* [检查集群状态](../300.daily-inspection/200.check-the-cluster-status.md)
...
* [检查租户资源使用状态](../300.daily-inspection/500.check-the-resource-usage-status-of-a-tenant.md)

  OceanBase 数据库支持对租户资源使用进行检查，包括不限于 CPU 、内存、副本数和磁盘。
  
* [检查集群资源使用状态](../300.daily-inspection/600.check-cluster-resource-usage.md)
...
* [检查 OBProxy 连接状态](../300.daily-inspection/1000.obproxy-connection-status.md)
