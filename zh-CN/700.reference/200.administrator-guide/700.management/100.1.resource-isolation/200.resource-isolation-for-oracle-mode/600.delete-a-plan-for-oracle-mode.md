...
3. 执行成功后，可以查看 `DBA_RSRC_PLANS` 视图进行确认。
   ...
   `DBA_RSRC_PLANS` 视图的详细介绍请参见 [DBA_RSRC_PLANS](../../../../500.system-reference/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/12400.dba_rsrc_plans-of-oracle-mode.md)。

## 相关文档

[DELETE_PLAN](../../../../400.development-reference/300.pl-reference/400.pl-system-package/1400.dbms-resource-manager-oracle/600.delete-plan-oracle.md)
