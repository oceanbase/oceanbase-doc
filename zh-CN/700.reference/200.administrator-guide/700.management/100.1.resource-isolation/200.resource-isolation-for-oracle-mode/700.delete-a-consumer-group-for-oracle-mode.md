...
3. 执行成功后，可以查看 `DBA_RSRC_CONSUMER_GROUPS` 视图进行确认。
   ...
   `DBA_RSRC_CONSUMER_GROUPS` 视图的详细介绍请参见 [DBA_RSRC_CONSUMER_GROUPS](../../../../500.system-reference/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/12200.dba_rsrc_consumer_groups-of-oracle-mode.md)。

## 相关文档

[DELETE_CONSUMER_GROUP](../../../../400.development-reference/300.pl-reference/400.pl-system-package/1400.dbms-resource-manager-oracle/500.delete-consume-group-oracle.md)
