...
请确认 cgroup 配置所在的 OBServer 已停止运行，停止 OBServer 的相关操作请参见 [停止或启动 OBServer](../../../200.basic-database-management/100.manage-clusters/500.manage-observer/300.stop-or-start-observer.md)。
...
[配置 cgroups](../200.resource-isolation-for-oracle-mode/100.config-cgroups-for-oracle-mode.md)
