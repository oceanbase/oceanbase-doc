...
在开始配置 cgroups，建议您先了解 cgroups 的概念。有关 cgroups 的介绍信息，参见 [资源隔离概述](../1.resource-isolation-overview.md)。
...
cgroup 系统目录配置成功后，即可部署 OceanBase 数据库。 OceanBase 数据库的详细安装操作请参见 [部署数据库](../../../../../4.deploy/3.deploy-oceanbase-database-enterprise/1.deployment-process.md)。
...
* [配置用户级资源隔离](2.resource-isolation-at-user-level-for-oracle-mode.md)

* [配置 SQL 级资源隔离](3.resource-isolation-at-sql-level-for-oracle-mode.md)

## 相关文档

[清除 cgroup 配置](8.clear-cgroup-configuration-for-oracle-mode.md)
