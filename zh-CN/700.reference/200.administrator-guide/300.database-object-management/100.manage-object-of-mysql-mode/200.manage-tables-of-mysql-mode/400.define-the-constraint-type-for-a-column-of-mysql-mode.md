...
* 外键约束（`FOREIGN KEY`）：要求约束的列的值取自于另外一个表的主键列。
  ...
  更多 `foreign_key_checks` 变量的说明，请参见 [foreign_key_checks](../../../../500.system-reference/200.system-variable-of-mysql-mode/2700.foreign_key_checks-of-mysql-mode.md)。
...
更多创建约束的语法及详细介绍请参见 [CREATE TABLE](../../../../400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/1600.create-table-of-mysql-mode.md)。
...
更多创建约束的语法及详细介绍请参见 [ALTER TABLE](../../../../400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/600.alter-table-of-mysql-mode.md)。
