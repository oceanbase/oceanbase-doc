...
更多 `ALTER SEQUENCE` 语句的信息，请参见 [ALTER SEQUENCE](../../../../400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/1400.alter-sequence-of-mysql-mode.md)。
