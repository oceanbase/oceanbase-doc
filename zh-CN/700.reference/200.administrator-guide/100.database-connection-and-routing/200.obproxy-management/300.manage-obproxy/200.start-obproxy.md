...
请确认已部署 OBProxy，部署 OBProxy 的具体操作请参见 [部署 OBProxy](../../../../../400.deploy/300.deploy-oceanbase-database-enterprise/400.command-line-deployment/400.deploy-obproxy-command-line/100.deploy-obproxy-command-line.md)。
