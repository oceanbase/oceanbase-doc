...
4. 在 **创建 OBProxy 集群** 页面填写如下信息：
   ...
   3. 打开 **参数设置**，添加或修改启动参数和其它参数。
      ...
      有关其他参数的详细信息，请参见 [配置参数](https://www.oceanbase.com/docs/enterprise-odp-enterprise-cn-10000000000982784)。有关启动参数的详细信息，请参见 [OBProxy 参数说明](../400.odp-cluster-parameters.md)。
