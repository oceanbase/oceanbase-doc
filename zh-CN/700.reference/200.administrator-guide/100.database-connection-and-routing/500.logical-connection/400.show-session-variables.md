...
有关系统变量的详细介绍请参见 [系统变量概述（MySQL 模式）](../../../500.system-reference/200.system-variable-of-mysql-mode/100.overview-of-system-variables-of-mysql-mode.md) 和 [系统变量概述（Oracle 模式）](../../../500.system-reference/300.system-variable-of-oracle-mode/100.overview-of-system-variables-of-oracle-mode.md)。有关用户变量设置，请参见 [SET](../../../400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/5200.set-of-mysql-mode.md)。
