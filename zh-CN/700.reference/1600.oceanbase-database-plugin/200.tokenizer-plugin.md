...
OceanBase 分词器插件样例代码 `space_ftparser.cpp` 在 OceanBase 插件开发包中的 `usr/share/examples/ObPlugin/ftparser` 目录下。直接复制这个目录到自己的开发目录下，即可以修改 `space_ftparser.cpp` 文件开发自己的分词器插件。
