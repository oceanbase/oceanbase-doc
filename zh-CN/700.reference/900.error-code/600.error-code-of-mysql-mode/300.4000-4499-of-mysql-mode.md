...
<main id="notice" type='explain'>
<h4>说明</h4>
<p>对于 V4.2.5 版本，该错误码从 V4.2.5 BP4 版本开始引入。</p>
</main>
...
* [TableAPI queryAndAppend 操作执行结果不符合预期并且客户端执行前缀查询的时候报错](https://www.oceanbase.com/knowledge-base/oceanbase-database-20000045539)
...
* 错误原因：
  ...
  * 当前日志流有容灾任务在执行，不能并行。
  * Server 上已存在日志流副本。
  * Server 上该日志流副本与目标类型相同。
  * Destination Server 上已经有副本。
...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>对于 V4.2.x 版本，该错误码从 V4.2.5 版本开始引入。</p>
</main>
...
<main id="notice" type='explain'>
  ...
  <li>对于 V4.2.x 版本，该错误码从 V4.2.5 BP3 版本开始引入。</li>
  <li>OceanBase 通过 License 来约定用户可以如何使用 OceanBase 数据库单机版的条款和条件，包括使用期限、功能范围等。有关 License 的详细信息，参见 <a href="https://www.oceanbase.com/docs/common-oceanbase-database-standalone-1000000002701699"> License 管理</a>。</li></ul>
</main>
