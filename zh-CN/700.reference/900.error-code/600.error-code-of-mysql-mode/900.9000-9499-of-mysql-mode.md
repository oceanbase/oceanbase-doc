...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>该错误码从 V4.2.3 版本开始报错信息由 <code>the format file does not exist under the destination</code> 调整为 <code>format file does not exist%s</code>。</p>
</main>
...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>该错误码从 V4.2.3 版本开始报错信息由 <code>the content of the format file at the destination does not match</code> 调整为 <code>format file does not match%s</code>。</p>
</main>
...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <ul><li>在 V4.3.x 版本中，该错误码从 V4.3.0 版本开始引入。</li><li>在 V4.2.x 版本中，该错误码从 V4.2.3 版本开始引入。</li></ul>
</main>
