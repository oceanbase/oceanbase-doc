...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>该错误码从 V4.0.0 版本开始引入，在 V4.2.5 及之前版本报错信息为 <code>the format file does not exist under the destination</code></p>
</main>
...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>该错误码从 V4.0.0 版本开始引入，在 V4.2.5 及之前版本报错信息为 <code>the content of the format file at the destination does not match</code></p>
</main>
