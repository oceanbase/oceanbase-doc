...
|slug|ora-50000-99999-oracle-compatible-mode|
...
* 错误原因：设置的备份路径或归档路径源端不存在。

* 解决方法：查询视图 `DBA_OB_ZONES`，确认所输入的 Locality 是否存在，更正后重新设置。

<main id="notice" type='explain'>
<h4>说明</h4>
<p>对于 V4.2.5 版本，该错误码从 V4.2.5 BP2 版本开始引入。</p>
</main>
...
<main id="notice" type='explain'>
<h4>说明</h4>
<p>对于 V4.2.5 版本，该错误码从 V4.2.5 BP3 版本开始引入。</p>
</main>
...
<main id="notice" type='explain'>
<h4>说明</h4>
<p>对于 V4.2.5 版本，该错误码从 V4.2.5 BP6 版本开始引入。</p>
</main>