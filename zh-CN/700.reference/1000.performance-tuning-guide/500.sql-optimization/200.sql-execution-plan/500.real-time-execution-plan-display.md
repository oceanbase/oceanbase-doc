...
### SQL Plan Monitor 拓展监控指标 PROFILE

视图 `[G]V$SQL_PLAN_MONITOR` 从 V4.4.1 版本开始引入字段 `PROFILE`，用于展示 SQL Plan Monitor 拓展监控指标 profile，将监控指标输出为 Json 格式。关于视图的详细介绍，参见 [GV$SQL_PLAN_MONITOR（MySQL 模式）](../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/5200.gv-sql_plan_monitor-of-mysql-mode.md) 或 [GV$SQL_PLAN_MONITOR（Oracle 模式）](../../../700.system-views/500.system-view-of-oracle-mode/300.performance-view-of-oracle-mode/5000.gv-sql_plan_monitor-of-oracle-mode.md)。

使用视图 `[G]V$SQL_PLAN_MONITOR` 并行查询执行诊断的详细介绍，参见 [并行查询执行诊断](../../../../620.obap/700.performance-tuning/600.parallel-query-execution-diagnosis-in-obap.md)。
