...
其中 `MIN_CPU` 表示 CPU 规格的下限，关于设置每个 Server 上并行查询排队条件的详细信息，参见 [parallel_servers_target](../../../800.configuration-items-and-system-variables/200.system-variable/300.global-system-variable/10600.parallel_servers_target-global.md)。
