...
| **参数名称** | **说明** |
| --- | --- |
| detail_file | 指定将 `__all_plan_baseline_item` 中的内容导出到哪个文件下，使用绝对路径。导出 CSV 文件不能覆写已有的文件，此处需要指定一个还不存在的文件。 |
| overall_file | 指定将 `__all_plan_baseline` 中的内容导出到哪个文件下，使用绝对路径。导出 CSV 文件不能覆写已有的文件，此处需要指定一个还不存在的文件。 |
...
| **参数名称** | **说明** |
| --- | --- |
| detail_file | 指定从哪个文件中导入 `__all_plan_baseline_item` 的数据，使用绝对路径。 |
| overall_file | 指定从哪个文件中导入 `__all_plan_baseline` 的数据，使用绝对路径。 |
