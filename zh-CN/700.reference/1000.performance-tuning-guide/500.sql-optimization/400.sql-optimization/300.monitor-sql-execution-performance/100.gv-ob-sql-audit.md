...
| FLT_TRACE_ID    | VARCHAR:OB_MAX_SPAN_LENGTH | VARCHAR:OB_MAX_SPAN_LENGTH| 该条记录全链路诊断的 Trace ID。如果为空, 则说明没有被全链路诊断监控。该字段是 UUID, 有别于Trace，其表示形式示例为:000600d6-a5de-038c-6c80-df07e4e79149|
