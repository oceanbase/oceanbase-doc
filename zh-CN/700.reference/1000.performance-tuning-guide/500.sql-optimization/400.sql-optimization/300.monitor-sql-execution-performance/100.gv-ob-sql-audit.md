...
|-------------------------|---------------------|---------------|------------------------------|
| SVR_IP                  | varchar(46)         | VARCHAR2(46)    |IP 地址     |
...
| TRACE_ID                | varchar(128)        | VARCHAR2(128)   |这条语句的 Trace ID    |
| SID                     | bigint(20) unsigned | NUMBER(38)     |Session ID      |
| CLIENT_IP               | varchar(46)         | VARCHAR2(46)    |<ul><li>当客户端通过 ODP 与 OBServer 连接时，表示转发请求的 ODP 的 IP</li><li>当客户端直接与 OBServer 连接时，表示发送请求的客户端的 IP</li><ul>    |
| CLIENT_PORT             | bigint(20)          | NUMBER(38)     |发送请求的 Client Port   |
| TENANT_ID               | bigint(20)          | NUMBER(38)     |发送请求的租户 ID    |
| TENANT_NAME             | varchar(64)         | VARCHAR2(46)    |发送请求的租户名称    |
| EFFECTIVE_TENANT_ID     | bigint(20)          | NUMBER(38)     |租户 ID   |
| USER_ID                 | bigint(20)          | NUMBER(38)     |发送请求的用户 ID  |
| USER_NAME               | varchar(64)         | VARCHAR2(46)    |发送请求的用户名称    |
| USER_GROUP              | bigint(20)          | NUMBER(38)     |用户所属资源组的 ID     |
| USER_CLIENT_IP          | varchar(32)         | VARCHAR2(32)    |发送请求的客户端的 IP   |
| DB_ID                   | bigint(20) unsigned | NUMBER(38)     |数据库 ID     |
| DB_NAME                 | varchar(128)        | VARCHAR2(128)   |数据库名称    |
| SQL_ID                  | varchar(32)         | VARCHAR2(32)    |这条 SQL 的 ID    |
...
| EVENT                   | varchar(64)         | VARCHAR2(46)    |最长等待事件名称  |
| P1TEXT                  | varchar(64)         | VARCHAR2(46)    |等待事件参数 1   |
| P1                      | bigint(20) unsigned | NUMBER(38)     |等待事件参数 1 的值      |
| P2TEXT                  | varchar(64)         | VARCHAR2(46)    |等待事件参数 2    |
| P2                      | bigint(20) unsigned | NUMBER(38)     |等待事件参数 2 的值   |
| P3TEXT                  | varchar(64)         | VARCHAR2(46)    |等待事件参数 3       |
...
| WAIT_CLASS              | varchar(64)         | VARCHAR2(46)    |等待事件所属的 Class 名称       |
| STATE                   | varchar(19)         | VARCHAR2(19)    |等待事件的状态      |
...
| DATA_BLOCK_READ_CNT     | bigint(20)          | NUMBER(38)   |  访问的数据微块数量   |
| DATA_BLOCK_CACHE_HIT    | bigint(20)          | NUMBER(38)   |  命中数据微块 Cache 数量   |
| INDEX_BLOCK_READ_CNT    | bigint(20)          | NUMBER(38)   |  访问的中间层微块数量  |
| INDEX_BLOCK_CACHE_HIT   | bigint(20)          | NUMBER(38)   |  命中中间层微块 Cache 数量  |
| BLOCKSCAN_BLOCK_CNT     | bigint(20)          | NUMBER(38)   |  单边扫描的数据微块数量   |
| BLOCKSCAN_ROW_CNT       | bigint(20)          | NUMBER(38)   |  单边扫描的数据行数   |
| PUSHDOWN_STORAGE_FILTER_ROW_CNT | bigint(20)  | NUMBER(38)   |  下压存储 Filter 过滤后行数  |
...
| SCHED_INFO              | varchar(16384)      | VARCHAR2(16384) | 请求的调度信息       |
...
| TX_ID                   | bigint(20)          | NUMBER(38)   | 请求对应的事务的 Hash 值     |
| SNAPSHOT_VERSION        | bigint(20)unsigned  | NUMBER(38)   | 当前语句的快照读版本号     |
...
| FLT_TRACE_ID            | varchar(1024)       | VARCHAR2(1024)| 记录全链路追踪的 Trace ID。如果为空，则说明没有被全链路追踪监控。该字段是 UUID，有别于 Trace，其表示形式示例为:000600d6-a5de-038c-6c80-df07e4e79149|
| NETWORK_WAIT_TIME       | bigint(20) unsigned | NUMBER(38)  |  所有 Network 类事件的总时间，单位为微秒   |
...
+------------+----------------------------+--------------+------------+--------------+--------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|   27731759 | 2024-04-18 16:06:45.122220 |       165406 |         33 |       157268 |              | SELECT request_id,usec_to_time(request_time),ELAPSED_TIME,QUEUE_TIME,EXECUTE_TIME,FLT_TRACE_ID,QUERY_SQL FROM v$OB_SQL_AUDIT where ELAPSED_TIME > 100000 limit 10 |
+------------+----------------------------+--------------+------------+--------------+--------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------+
