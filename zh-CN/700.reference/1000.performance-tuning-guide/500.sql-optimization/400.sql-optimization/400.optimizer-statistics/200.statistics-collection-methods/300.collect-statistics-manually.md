...
<main id="notice" >
    <h4>说明</h4>
    <p>OceanBase 数据库当前不支持对统计信息收集时间的预估。因此建议将 [`ob_query_timeout`](../../../../../800.configuration-items-and-system-variables/200.system-variable/300.global-system-variable/8600.ob_query_timeout-global.md) 设置得足够长，以便完成统计信息的收集。特别是在收集 schema 级别的统计信息时，如果由于超时而中断，已经收集完毕的统计信息将被保留。同时，推荐用户在会话 session 级别调大 [`ob_query_timeout`](../../../../../800.configuration-items-and-system-variables/200.system-variable/300.global-system-variable/8600.ob_query_timeout-global.md) 变量，这样做仅影响当前会话，不会干扰其他操作。</p>
  </main>
