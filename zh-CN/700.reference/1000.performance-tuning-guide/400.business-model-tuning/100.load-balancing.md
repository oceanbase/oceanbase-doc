...
+-------+----------------------------+----------------------------+--------+------+----------------+-----------+
| zone1 | 2024-03-21 09:56:56.232430 | 2024-03-21 09:56:56.232430 | ACTIVE |      | default_region | ReadWrite |
+-------+----------------------------+----------------------------+--------+------+----------------+-----------+
1 row in set
```
...
*************************** 1. row ***************************
               ...
               TENANT_NAME: sys
               TENANT_TYPE: SYS
               CREATE_TIME: 2024-03-21 09:56:56.133597
               MODIFY_TIME: 2024-03-21 09:56:56.133597
              PRIMARY_ZONE: RANDOM
...
*************************** 1. row ***************************
 ...
 LOG_DISK_IN_USE: 2562522334
DATA_DISK_IN_USE: 94371840
          STATUS: NORMAL
     CREATE_TIME: 2024-03-21 09:56:18.698684
1 row in set
```
