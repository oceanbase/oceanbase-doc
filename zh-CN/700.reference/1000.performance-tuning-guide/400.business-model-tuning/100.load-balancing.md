...
+-------+----------------------------+----------------------------+--------+------+----------------+-----------+
| zone1 | 2024-06-05 13:49:12.107886 | 2024-06-05 13:49:12.108941 | ACTIVE |      | default_region | ReadWrite |
+-------+----------------------------+----------------------------+--------+------+----------------+-----------+
1 row in set
```
...
包括 Primary Zone, Locality 等，相关 SQL 如下：
...
*************************** 1. row ***************************
               ...
               TENANT_NAME: sys
               TENANT_TYPE: SYS
               CREATE_TIME: 2024-06-05 13:49:11.939609
               MODIFY_TIME: 2024-06-05 13:49:11.939609
              PRIMARY_ZONE: RANDOM
...
*************************** 1. row ***************************
 ...
 LOG_DISK_IN_USE: 7668614011
DATA_DISK_IN_USE: 2390437888
          STATUS: NORMAL
     CREATE_TIME: 2024-06-05 13:48:32.038578
1 row in set
```
