...
2. 在控制台界面展示报告信息。
    ...
    * 在界面上以 TEXT 的类型展示报告内容。
      ...
      设置诊断开始时间为 `2026-01-25 10:26:47`，诊断结束时间为 `2026-01-25 20:27:07`，报告展示类型为 `TEXT`，其他字段值根据是否需要来设置。
    ...
    * 在界面上以 HTML 的类型展示报告内容。
      ...
      设置诊断开始时间为 `2026-01-25 10:26:47`，诊断结束时间为 `2026-01-25 20:27:07`，报告展示格式为 `HTML`，其他字段值根据是否需要来设置。
