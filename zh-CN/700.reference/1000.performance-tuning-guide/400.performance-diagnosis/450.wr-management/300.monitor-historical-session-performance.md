...
* **通过 `oceanbase.CDB_WR_ACTIVE_SESSION_HISTORY` 视图查看所有租户持久化后的 ASH 数据。**
  ...
  ```
    ...
    *************************** 1. row ***************************
                    CLUSTER_ID: 10001
                      ...
                      SVR_PORT: 2882
                      SAMPLE_ID: 10
                    SESSION_ID: 4611686018427389188
                    SAMPLE_TIME: 2026-03-16 16:30:16.853022
                        USER_ID: 200001
                  SESSION_TYPE: 1
                  SESSION_STATE: ON CPU
                        SQL_ID: F9C0A3AB0A89EA2048B7A9F436596C68
            ...
            IN_PLSQL_EXECUTION: N
              ...
              IN_CONNECTION_MGR: N
                      ...
                      BACKTRACE: NULL
                        PLAN_ID: 289
                  TM_DELTA_TIME: 37301
              TM_DELTA_CPU_TIME: 36278
              TM_DELTA_DB_TIME: 36295
  ...
  | WEIGHT                      | 该条 WR 记录所对应时间范围内，相同租户相同 Action 出现的次数 |
...
* **通过 `oceanbase.DBA_WR_ACTIVE_SESSION_HISTORY` 视图查看本租户持久化后的 ASH 数据。**
  ...
  ```
    ...
    *************************** 1. row ***************************
                  ...
                  SESSION_STATE: ON CPU
                        SQL_ID: F9C0A3AB0A89EA2048B7A9F436596C68
                      TRACE_ID: xx.xx.xx.xx-xx.xx.xx.xx-0-0
                      EVENT_NO: 0
                      EVENT_ID: NULL
                    TIME_WAITED: 0
                            P1: 0
...
* **通过 `GV$OB_ACTIVE_SESSION_HISTORY` 视图查看活跃会话历史记录。**
  ...
  ```shell
    *************************** 1. row ***************************
                      ...
                      SVR_PORT: 2882
                      SAMPLE_ID: 589519
                    SAMPLE_TIME: 2026-03-17 15:36:38.029639
                        CON_ID: 1001
                        USER_ID: 0
                    SESSION_ID: 2305843009213712375
        ...
        IN_REMOTE_DAS_EXECUTION: N
              ...
              IN_CONNECTION_MGR: N
                      ...
                      CLIENT_ID: NULL
                      BACKTRACE: NULL
                  TM_DELTA_TIME: 997367
              TM_DELTA_CPU_TIME: 250
              TM_DELTA_DB_TIME: 997367
              TOP_LEVEL_SQL_ID: NULL
          IN_PLSQL_COMPILATION: N
            IN_PLSQL_EXECUTION: N
          PLSQL_ENTRY_OBJECT_ID: NULL
  ...
  | DELTA_WRITE_IO_BYTES        | 两次采样之间写的文件累计大小     |
  | WEIGHT                      | 该条 WR 记录所对应时间范围内，相同租户相同 Action 出现的次数    |
  | IS_WR_WEIGHT_SAMPLE         | 是否为队列积压等待事件的“聚合”列     |
...
* **通过 `V$OB_ACTIVE_SESSION_HISTORY` 视图查看当前活跃会话历史记录。**
  ...
  *************************** 1. row ***************************
                    ...
                    SVR_PORT: 2882
                    SAMPLE_ID: 611098
                  SAMPLE_TIME: 2026-03-17 16:25:41.380291
                      CON_ID: 1001
                      USER_ID: 0
                  SESSION_ID: 2305843009213712375
                SESSION_TYPE: BACKGROUND
      ...
      IN_REMOTE_DAS_EXECUTION: N
            ...
            IN_CONNECTION_MGR: N
                    ...
                    CLIENT_ID: NULL
                    BACKTRACE: NULL
                TM_DELTA_TIME: 997935
            TM_DELTA_CPU_TIME: 243
            TM_DELTA_DB_TIME: 997935
            TOP_LEVEL_SQL_ID: NULL
        IN_PLSQL_COMPILATION: N
          IN_PLSQL_EXECUTION: N
        PLSQL_ENTRY_OBJECT_ID: NULL
...
* **通过 `GV$OB_SQLSTAT` 视图查看集群中 SQL 的基本性能统计数据。**
  ...
  *************************** 1. row ***************************
                      ...
                      SVR_PORT: 2882
                      TENANT_ID: 1
                        SQL_ID: C37DC12BB691B517FEA330D030D920E2
                        PLAN_ID: 0
                      PLAN_HASH: 10981719669113383604
                      PLAN_TYPE: 0
                      QUERY_SQL:
                      SQL_TYPE: 0
                        MODULE: NULL
  ...
  MAJOR_SSSTORE_READ_ROWS_DELTA: 0
              ...
              ROUTE_MISS_TOTAL: 0
              ROUTE_MISS_DELTA: 0
                FIRST_LOAD_TIME: 2026-03-16 22:00:29.029404
  ...
  | LATEST_ACTIVE_TIME            | TIMESTAMP(6)      | 某一个节点上 SQL ID + Plan Hash 对应计划的最后一次活跃时间 |
...
* **通过 `oceanbase.CDB_WR_SQLSTAT` 视图查看所有租户执行过的 SQL 的基本性能统计数据。**
  ...
  *************************** 1. row ***************************
              ...
              EXECUTIONS_TOTAL: 345
              EXECUTIONS_DELTA: 345
              DISK_READS_TOTAL: 0
              DISK_READS_DELTA: 0
              BUFFER_GETS_TOTAL: 0
              BUFFER_GETS_DELTA: 0
            ELAPSED_TIME_TOTAL: 36311
            ELAPSED_TIME_DELTA: 36311
                CPU_TIME_TOTAL: 0
                CPU_TIME_DELTA: 0
                  CCWAIT_TOTAL: 0
                  CCWAIT_DELTA: 0
  ...
  PHYSICAL_READ_REQUESTS_DELTA: 0
      ...
      PHYSICAL_READ_BYTES_DELTA: 0
          WRITE_THROTTLE_TOTAL: 0
          WRITE_THROTTLE_DELTA: 0
          ROWS_PROCESSED_TOTAL: 344
          ROWS_PROCESSED_DELTA: 344
      MEMSTORE_READ_ROWS_TOTAL: 0
      MEMSTORE_READ_ROWS_DELTA: 0
  MINOR_SSSTORE_READ_ROWS_TOTAL: 0
  MINOR_SSSTORE_READ_ROWS_DELTA: 0
  ...
  MAJOR_SSSTORE_READ_ROWS_DELTA: 0
              ...
              ROUTE_MISS_TOTAL: 0
              ROUTE_MISS_DELTA: 0
                FIRST_LOAD_TIME: 2026-03-16 16:30:26.782836
          PLAN_CACHE_HIT_TOTAL: 343
          PLAN_CACHE_HIT_DELTA: 343
              MUTI_QUERY_TOTAL: 0
              MUTI_QUERY_DELTA: 0
        MUTI_QUERY_BATCH_TOTAL: 0
        MUTI_QUERY_BATCH_DELTA: 0
          ...
          FULL_TABLE_SCAN_DELTA: 0
              ERROR_COUNT_TOTAL: 0
              ERROR_COUNT_DELTA: 0
                    SAMPLE_TIME: 2026-03-16 16:40:15.000000
            LATEST_ACTIVE_TIME: 2026-03-16 16:40:15.526231
  1 row in set (0.026 sec)
  ```
  ...
  | ERROR_COUNT_TOTAL             | 自执行计划生成以来，该 SQL 报错的次数|
  | ERROR_COUNT_DELTA             | 自上次 WR 快照采集后至今，该 SQL 报错的次数|
  | SAMPLE_TIME                   | SQLSTAT 快照落盘的时间。在一次 WR 快照间隔内，SQLSTAT 可能落盘多次     |
  | LATEST_ACTIVE_TIME            | 某一个节点上 SQL ID + Plan Hash 对应计划的最后一次活跃时间     |
...
* **通过 `oceanbase.DBA_WR_SQLSTAT` 视图查看本租户执行过的 SQL 的基本性能统计数据。**
  ...
  *************************** 1. row ***************************
              ...
              BUFFER_GETS_TOTAL: 0
              BUFFER_GETS_DELTA: 0
            ELAPSED_TIME_TOTAL: 1613
            ELAPSED_TIME_DELTA: 1613
                CPU_TIME_TOTAL: 0
                CPU_TIME_DELTA: 0
                  CCWAIT_TOTAL: 0
                  CCWAIT_DELTA: 0
  ...
  MAJOR_SSSTORE_READ_ROWS_DELTA: 0
              ...
              ROUTE_MISS_TOTAL: 0
              ROUTE_MISS_DELTA: 0
                FIRST_LOAD_TIME: 16-MAR-26 04.40.15.465600 PM
          PLAN_CACHE_HIT_TOTAL: 0
          PLAN_CACHE_HIT_DELTA: 0
              MUTI_QUERY_TOTAL: 0
              MUTI_QUERY_DELTA: 0
        ...
        MUTI_QUERY_BATCH_DELTA: 0
          ...
          FULL_TABLE_SCAN_DELTA: 0
              ERROR_COUNT_TOTAL: 0
              ERROR_COUNT_DELTA: 0
                    SAMPLE_TIME: 16-MAR-26 04.40.15.000000 PM
            LATEST_ACTIVE_TIME: 16-MAR-26 04.40.15.500910 PM
