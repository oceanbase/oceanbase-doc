  ...
  返回结果如下：
    ...
    *************************** 1. row ***************************
                    CLUSTER_ID: 10001
                      ...
                      SVR_PORT: 2882
                      SAMPLE_ID: 1370
                    SESSION_ID: 23343147253760
                    SAMPLE_TIME: 2024-12-09 11:04:36.984537
                        USER_ID: 200001
                  SESSION_TYPE: 1
              ...
              SQL_PLAN_LINE_ID: NULL
                      ...
                      STMT_TYPE: NULL
                          TX_ID: NULL
            BLOCKING_SESSION_ID: 3221523694
                    TIME_MODEL: 0
                      IN_PARSE: N
                    IN_PL_PARSE: N
                  IN_PLAN_CACHE: N
          ...
          IN_PLSQL_COMPILATION: N
            IN_PLSQL_EXECUTION: N
                IN_FILTER_ROWS: N
                  ...
                  IN_RPC_DECODE: N
              IN_CONNECTION_MGR: N
                        PROGRAM: T1002_ArcSrv
                        MODULE: NULL
                        ACTION: NULL
                      CLIENT_ID: NULL
                      BACKTRACE: NULL
                        PLAN_ID: 0
                  TM_DELTA_TIME: 455747
              TM_DELTA_CPU_TIME: 1425
              TM_DELTA_DB_TIME: 455747
...
| DELTA_READ_IO_REQUESTS      | bigint(20)          | YES  |  两次采样之间读的次数<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</p></main>    |
| DELTA_READ_IO_BYTES         | bigint(20)          | YES  |  两次采样之间读的文件累计大小<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</p></main>    |
| DELTA_WRITE_IO_REQUESTS     | bigint(20)          | YES  |  两次采样之间写的次数<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</p></main>    |
| DELTA_WRITE_IO_BYTES        | bigint(20)          | YES  |  两次采样之间写的文件累计大小<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</p></main>    |
...
* **通过 `oceanbase.DBA_WR_ACTIVE_SESSION_HISTORY` 视图查看本租户持久化后的 ASH 数据。**
  ...
  | CLIENT_ID| 采样时刻当前 SESSION 上记录的 CLIENT_ID 值，通过 `DBMS_SESSION.set_identifier` 包设置 |
  ...
  | PROXY_SID                   | 代理会话 ID    |
    ...
    有关 `DBA_WR_ACTIVE_SESSION_HISTORY` 视图的更多信息，请参见 [oceanbase.DBA_WR_ACTIVE_SESSION_HISTORY](../../../700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/15500.o-dba_wr_active_session_history-of-mysql-mode.md) 和 [DBA_WR_ACTIVE_SESSION_HISTORY](../../../700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/21900.dba_wr_active_session_history-of-oracle-mode.md)。
...
* **通过 `GV$OB_ACTIVE_SESSION_HISTORY` 视图查看活跃会话历史记录。**
  ...
  | THREAD_ID                   | 当前活跃会话所在的线程 ID。    |
  | STMT_TYPE                   | 当前活跃会话的 SQL 类型。     |
  | TIME_MODEL                  | time model 信息，是所有 IN_XXX 字段（如 IN_PARSE、IN_PL_PARSE 等）的数据组成的集合。     |
  ...
  | CLIENT_ID | 会话在采样时记录的 CLIENT_ID 值，通过 `DBMS_SESSION.set_identifier` 包设置。 |
  ...
  | PROXY_SID                   | 代理会话 ID     |
    ...
    有关 `GV$OB_ACTIVE_SESSION_HISTORY` 视图的更多信息，请参见 [GV$OB_ACTIVE_SESSION_HISTORY](../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/800.gv-ob_active_session_history-of-mysql-mode.md)。
...
* **通过 `V$OB_ACTIVE_SESSION_HISTORY` 视图查看当前活跃会话历史记录。**
  ...
  | PROXY_SID                   | 代理会话 ID     |  
    ...
    有关 `V$OB_ACTIVE_SESSION_HISTORY` 视图的更多信息，请参见 [V$OB_ACTIVE_SESSION_HISTORY](../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/30900.v-ob_active_session_history-of-mysql-mode.md)。
...
* **通过 `oceanbase.CDB_WR_STATNAME` 视图查看所有租户的系统统计项的名称。**
  ...
  | STAT_NAME | 统计项名字 |
    ...
    有关 oceanbase.CDB_WR_STATNAME 视图的更多信息，请参见 [oceanbase.CDB_WR_STATNAME](../../../700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/13800.o-cdb_wr_statname-of-sys-tenant.md)。
...
* **通过 `oceanbase.DBA_WR_STATNAME` 视图查看本租户的系统统计项的名称。**
  ...
  | STAT_NAME | 统计项名字 |
    ...
    有关 DBA_WR_STATNAME 视图的更多信息，请参见 [oceanbase.DBA_WR_STATNAME](../../../700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/16100.o-dba_wr_statname-of-mysql-mode.md) 和 [DBA_WR_STATNAME](../../../700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/22500.dba_wr_statname-of-oracle-mode.md)。
...
* **通过 `oceanbase.CDB_WR_SYSSTAT` 视图查看所有租户的系统统计项的详细信息。**
  ...
  | VALUE  | 统计项的值 |
    ...
    有关 oceanbase.CDB_WR_SYSSTAT 视图的更多信息，请参见 [oceanbase.CDB_WR_SYSSTAT](../../../700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/14000.o-cdb_wr_sysstat-of-sys-tenant.md)。
...
* **通过 `GV$OB_SESS_TIME_MODEL` 查看集群中 Session 级别的 Time Model 统计项。**
  ...
  | VALUE      |  统计项值        |
    ...
    有关 `GV$OB_SESS_TIME_MODEL` 视图的更多信息，请参见 [GV$OB_SESS_TIME_MODEL](../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/2800.gv-ob_sess_time_model-of-mysql-mode.md)。
...
* **通过 `V$OB_SESS_TIME_MODEL` 视图查看当前节点上 Session 级别的 Time Model 统计项。**
  ...
  | VALUE      |  统计项值        |
    ...
    有关 `V$OB_SESS_TIME_MODEL` 视图的更多信息，请参见 [V$OB_SESS_TIME_MODEL](../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/33200.v-ob_sess_time_model-of-mysql-mode.md)。
...
* **通过 `GV$OB_SYS_TIME_MODEL` 视图查看集群中租户级别的 Time Model 统计项。**
  ...
  | VALUE      | 统计项值        |
    ...
    有关 `GV$OB_SYS_TIME_MODEL` 视图的更多信息，请参见 [GV$OB_SYS_TIME_MODEL](../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/3300.gv-ob_sys_time_model-of-mysql-mode.md)。
...
* **通过 `V$OB_SYS_TIME_MODEL` 视图查看当前节点上租户级别的 Time Model 统计项。**
  ...
  | VALUE      | 统计项值        |
    ...
    有关 `V$OB_SYS_TIME_MODEL` 视图的更多信息，请参见 [V$OB_SYS_TIME_MODEL](../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/33700.v-ob_sys_time_model-of-mysql-mode.md)。
...
* **通过 `oceanbase.CDB_WR_SYS_TIME_MODEL` 视图查看所有租户 Time Model 统计项的 WR 数据。**
  ...
  | VALUE      | 统计项值        |
    ...
    有关 oceanbase.CDB_WR_SYS_TIME_MODEL 视图的更多信息，请参见 [oceanbase.CDB_WR_SYS_TIME_MODEL](../../../700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/13900.o-cdb_wr_sys_time_model-of-sys-tenant.md)。
...
* **通过 `oceanbase.DBA_WR_SYS_TIME_MODEL` 视图查看本租户 Time Model 统计项的 WR 数据。**
  ...
  | VALUE      | 统计项值        |
    ...
    有关 oceanbase.DBA_WR_SYS_TIME_MODEL 视图的更多信息，请参见 [oceanbase.DBA_WR_SYS_TIME_MODEL](../../../700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/16200.o-dba_wr_sys_time_model-of-mysql-mode.md) 和 [DBA_WR_SYS_TIME_MODEL](../../../700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/22600.dba_wr_sys_time_model-of-oracle-mode.md)。
...
* **通过 `GV$OB_SQLSTAT` 视图查看集群中 SQL 的基本性能统计数据。**
  ...
  *************************** 1. row ***************************
  ...
  | ROUTE_MISS_TOTAL              | 从 OBServer 启动开始，没有命中请求分区的总次数   |
  | ROUTE_MISS_DELTA              | 从上次 WR 快照采集开始，没有命中请求分区的次数   |
  | FIRST_LOAD_TIME               | 计划生成时间   |
  | PLAN_CACHE_HIT_TOTAL          | 从 OBServer 启动开始，命中 Plan Cache 的总次数   |
  | PLAN_CACHE_HIT_DELTA          | 从上次 WR 快照采集开始，命中 Plan Cache 的次数  |

    有关 `GV$OB_SQLSTAT` 视图的更多信息，请参见 [GV$OB_SQLSTAT](../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/3200.gv-ob_sqlstat-of-mysql-mode.md)。
...
* **通过 `V$OB_SQLSTAT` 视图查看当前节点上 SQL 的基本性能统计数据。**
  ...
  *************************** 1. row ***************************
  ...
  | PLAN_CACHE_HIT_DELTA          | 从上次 WR 快照采集开始，命中 Plan Cache 的次数  |
    ...
    有关 `V$OB_SQLSTAT` 视图的更多信息，请参见 [V$OB_SQLSTAT](../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/33600.v-ob_sqlstat-of-mysql-mode.md)。
...
* **通过 `oceanbase.CDB_WR_SQLSTAT` 视图查看所有租户执行过的 SQL 的基本性能统计数据。**
  ...
  *************************** 1. row ***************************
  ...
  | PLAN_CACHE_HIT_DELTA          | 从上次 WR 快照采集开始，命中 Plan Cache 的次数 |
    ...
    有关 `oceanbase.CDB_WR_SQLSTAT` 视图的更多信息，请参见 [oceanbase.CDB_WR_SQLSTAT](../../../700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/13600.o-cdb_wr_sqlstat-of-sys-tenant.md)。
...
* **通过 `oceanbase.DBA_WR_SQLSTAT` 视图查看本租户执行过的 SQL 的基本性能统计数据。**
  ...
  *************************** 1. row ***************************
  ...
  | PLAN_CACHE_HIT_DELTA          | 从上次 WR 快照采集开始，命中 Plan Cache 的次数 |
    ...
    有关 `DBA_WR_SQLSTAT` 视图的更多信息，请参见 [oceanbase.DBA_WR_SQLSTAT](../../../700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/15900.o-dba_wr_sqlstat-of-mysql-mode.md) 和 [DBA_WR_SQLSTAT](../../../700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/22300.dba_wr_sqlstat-of-oracle-mode.md)。
...
* **通过 `GV$OB_RES_MGR_SYSSTAT` 视图查看所有 OBServer 中资源组的统计项信息。**
  ...
  | STAT_ID    | 统计项 ID     |
    ...
    有关 `GV$OB_RES_MGR_SYSSTAT` 视图的更多信息，请参见 [GV$OB_RES_MGR_SYSSTAT](../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/2650.gv-ob_res_mgr_sysstat-of-mysql-mode.md)。
...
* **通过 `V$OB_RES_MGR_SYSSTAT` 视图查看本 OBServer 中资源组的统计项信息。**
  ...
  | STAT_ID    | 统计项 ID     |
    ...
    有关 `V$OB_RES_MGR_SYSSTAT` 视图的更多信息，请参见 [V$OB_RES_MGR_SYSSTAT](../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/33050.v-ob_res_mgr_sysstat-of-mysql-mode.md)。
