...
* 通过 `GV$ACTIVE_SESSION_HISTORY` 视图查看活跃会话历史记录。
  ...
  *************************** 1. row ***************************
  ...
  有关 `GV$ACTIVE_SESSION_HISTORY` 视图的更多信息，请参见 [GV$ACTIVE_SESSION_HISTORY](../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/11000.gv-active_session_history-of-mysql-mode.md)。
...
* 通过 `V$ACTIVE_SESSION_HISTORY` 视图查看当前活跃会话历史记录。
  ...
  *************************** 1. row ***************************
  ...
  有关 `V$ACTIVE_SESSION_HISTORY` 视图的更多信息，请参见 [V$ACTIVE_SESSION_HISTORY](../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/11100.v-active_session_history-of-mysql-mode.md)。
