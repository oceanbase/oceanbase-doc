...
* **通过 `oceanbase.CDB_WR_SYS_TIME_MODEL` 视图查看所有租户 Time Model 统计项的 WR 数据。**
  ...
  | VALUE      | 统计项值        |
    ...
    有关 oceanbase.CDB_WR_SYS_TIME_MODEL 视图的更多信息，请参见 [oceanbase.CDB_WR_SYS_TIME_MODEL](../../../700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/14000.o-cdb_wr_sys_time_model-of-sys-tenant.md)。
