...
* 通过 `oceanbase.CDB_WR_CONTROL` 视图查看所有租户下 WR 相关的配置信息。
  ...
  | TOPNSQL | 存储的 topN 的 SQL |
    ...
    有关 oceanbase.CDB_WR_CONTROL 视图的更多信息，请参见 [oceanbase.CDB_WR_CONTROL](../../../700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/13300.o-cdb_wr_control-of-sys-tenant.md)。
...
* 通过 `oceanbase.DBA_WR_CONTROL` 视图查看本租户下 WR 相关的配置信息。
  ...
  | TOPNSQL | 存储的 topN 的 SQL |
    ...
    有关 DBA_WR_CONTROL 视图的更多信息，请参见 [oceanbase.DBA_WR_CONTROL](../../../700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/15600.o-dba_wr_control-of-mysql-mode.md)和 [DBA_WR_CONTROL](../../../700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/22000.dba_wr_control-of-oracle-mode.md)。
...
* 通过 `oceanbase.CDB_WR_SNAPSHOT` 视图查看所有租户的快照信息。
  ...
  | STARTUP_TIME  | 进程启动时间，时间戳精确到毫秒 |
    ...
    有关 oceanbase.CDB_WR_SNAPSHOT 视图的更多信息，请参见 [oceanbase.CDB_WR_SNAPSHOT](../../../700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/13500.o-cdb_wr_snapshot-of-sys-tenant.md)。
...
* 通过 `oceanbase.DBA_WR_SNAPSHOT` 视图查看本租户的快照信息。
  ...
  | STARTUP_TIME  | 进程启动时间，时间戳精确到毫秒 |
    ...
    有关 DBA_WR_SNAPSHOT 视图的更多信息，请参见 [oceanbase.DBA_WR_SNAPSHOT](../../../700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/15800.o-dba_wr_snapshot-of-mysql-mode.md) 和 [DBA_WR_SNAPSHOT](../../../700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/22200.dba_wr_snapshot-of-oracle-mode.md)。
