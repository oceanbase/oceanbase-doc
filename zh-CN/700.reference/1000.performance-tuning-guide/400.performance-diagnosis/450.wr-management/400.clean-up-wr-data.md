...
3. 进行合并操作释放空间。有关合并的详细信息，请参见 [合并](../../../100.oceanbase-database-concepts/900.storage-architecture/300.dump-and-merge/300.about-merge.md)。
   ...
   2. 通过 [`oceanbase.CDB_OB_ZONE_MAJOR_COMPACTION`](../../../700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/11800.o-cdb_ob_zone_major_compaction-of-sys-tenant.md) 视图查看合并操作是否完成，当 `STATUS` 字段的值变为 `IDLE` 时，表示合并完成。
