...
|                      系统包                      |            描述                    |
|-------------------------------------------------|------------------------------------|
| [DBMS_APPLICATION_INFO](20500.dbms-application-info-mysql/100.dbms-application-info-overview-mysql.md)| 用于注册和监控应用程序的名称、模块、操作和客户端信息。|
...
| [DBMS_DAILY_MAINTENANCE](3000.dbms-daily-maintenance-mysql/100.dbms-daily-maintenance-overview-mysql.md) | 用于窗口合并的管理与维护. |
...
| [DBMS_JAVA](22000.dbms-java-mysql/100.dbms-java-overview.md) |用于在数据库内集成和管理 Java 程序，支持 Java 存储过程、函数及安全策略的实现。|
|[DBMS_PYTHON](22100.dbms-python-mysql/100.dbms_python-overview.md)|于在数据库内集成和管理 Python 程序，支持 Python 存储过程、函数及安全策略的实现。|
|[DBMS_OB_LIMIT_CALCULATOR](20900.dbms-limit-calculator-mysql/100.dbms-limit-calculator-overview-mysql.md)|用于获取集群当前的资源使用信息，依据这些信息来规划扩缩容、节点替换、备租户创建等操作。|
|[DBMS_DATA_DICT](23000.dbms-data-dict-mysql/100.dbms-data-dict-mysql.md)|用于控制数据字典的调度。|
| [DBMS_SCHEMA](24000.dbms-schema-mysql/100.dbms-schema-overview-mysql.md) | 用于提供 Schema 多版本历史数据（Schema History）回收和 Root Service 自检（Root Inspection）的手动触发能力。|