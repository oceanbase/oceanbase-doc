...
| [DELETE_CATALOG_GLOBAL_PREFS](320.delete_catalog_global_prefs-of-mysql-mode.md) | 用于删除 Catalog 中全局偏好项。|
| [DELETE_CATALOG_TABLE_PREFS](330.delete_catalog_table_prefs-of-mysql-mode.md) | 用于删除 Catalog 中表级偏好项。|
...
| [GATHER_CATALOG_TABLE_STATS](1520.gather_catalog_table_stats-of-mysql-mode.md) | 用于收集 Catalog 中外表的统计信息。|
...
| [GET_CATALOG_GLOBAL_PREFS](1860.get_catalog_global_prefs-of-mysql-mode.md) | 用于获取 Catalog 中全局偏好项的值。|
| [GET_CATALOG_PREFS](1870.get_catalog_prefs-of-mysql-mode.md) | 用于获取 Catalog 中表级偏好项的值。|
...
| [LOCK_CATALOG_PARTITION_STAT](2620.lock_catalog_partition_stat-of-mysql-mode.md) | 用于锁定 Catalog 中分区统计信息。|
| [LOCK_CATALOG_TABLE_STAT](2630.lock_catalog_table_stat-of-mysql-mode.md) | 用于锁定 Catalog 中外表统计信息。|
...
| [SET_CATALOG_GLOBAL_PREFS](3420.set_catalog_global_prefs-of-mysql-mode.md) | 用于设置 Catalog 中全局偏好项值。|
| [SET_CATALOG_TABLE_PREFS](3430.set_catalog_table_prefs-of-mysql-mode.md) | 用于设置 Catalog 中表级偏好项的值。|
...
| [UNLOCK_CATALOG_PARTITION_STAT](4120.unlock_catalog_partition_stat-of-mysql-mode.md) | 用于解锁 Catalog 中分区统计信息。|
| [UNLOCK_CATALOG_TABLE_STAT](4130.unlock_catalog_table_stat-of-mysql-mode.md) | 用于解锁 Catalog 中外表统计信息。|
...
| [COPY_TABLE_STATS](../15900.dbms-stats-mysql/4550.copy-table-stats-mysql.md)                | 用于将源分区（或子分区）的统计信息复制到目标分区（或子分区）。 |
