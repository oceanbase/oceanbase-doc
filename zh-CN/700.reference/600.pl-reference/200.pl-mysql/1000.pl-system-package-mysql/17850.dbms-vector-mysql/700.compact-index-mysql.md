...
`COMPACT_INDEX` 过程用于手动强制触发合并任务，对应 HNSW 向量索引中**增量段之间或与基线段合并**的流程。原理说明请参见 [向量索引原理](../../../../100.oceanbase-database-concepts/400.database-objects/200.database-objects-of-mysql-mode/300.index-of-mysql-mode/330.vector-indexes-of-mysql-mode-in-concepts.md)。
