...
| [SESSION_IS_ROLE_ENABLED](../14500.dbms-session-oracle/1700.session-is-role-enabled-of-oracle.md)|确定指定的角色是否在会话级别启用。|
| [IS_ROLE_ENABLED](../14500.dbms-session-oracle/1800.is-role-enabled-of-oracle.md)|确定会话是否启用了指定的角色。|
