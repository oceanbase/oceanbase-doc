...
| [DBMS_PLSQL_CODE_COVERAGE](12550.dbms-plsql-code-coverage-oracle/100.dbms_plsql_code_coverage-overview-oracle-mode.md)|用于收集 PL/SQL 代码在运行时的覆盖率。|
...
|[DBMS_SCHEMA](14300.dbms-schema-oracle/100.dbms-schema-overview-oracle.md) | 用于提供 Schema 多版本历史数据（Schema History）回收和 Root Service 自检（Root Inspection）的手动触发能力。|
...
| [DBMS_XMLDOM](19500.dbms-xmldom-oracle/100.dbms-xmldom-overview-oracle.md) | 用于以 DOM 方式只读遍历和操作 XML 数据。|
| [DBMS_XMLPARSER](19750.dbms-xmlparser-oracle/100.dbms-xmlparser-overview-oracle.md) | 用于从 CLOB 解析 XML，并结合 DOM 方式满足业务 XML 的解析需求。|