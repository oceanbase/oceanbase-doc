...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>对于 V 4.2.x 版本，从V4.2.5 BP7 开始，DBMS_PROFILER 系统包开启后，可以复用 PL 磁盘缓存。<br>对于 V 4.6.x 版本，从 V4.6.0 开始，DBMS_PROFILER 系统包开启后，可以复用 PL 磁盘缓存。</p>
</main>
...
![DBMS_PROFILER 调用流程图](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer/V4.2.3/2024.4.17.png)
