...
|slug|dbms_utility-overviewy-oracle-compatible-mode|
...
| [EXEC_DDL_STATEMENT](../17900.dbms-utility-oracle/300.exec-ddl-statement-oracle.md)      | 执行指定的 DDL 语句。  |
...
| [VALIDATE](2300.validate-oracle.md)              | 验证并重新编译指定的数据库对象。      |