...
表组创建后，可以查看表组的信息，包括表组的属性、表组内的表、表组创建时间以及表组内表的 Location 信息。

## 查看表组的 SHARDING 属性

### 通过视图查看表组属性及表的分区信息

系统租户和 MySQL 用户租户可以分别通过视图 `CDB_OB_TABLEGROUPS` 和视图 `DBA_OB_TABLEGROUPS` 来查看表组属性及表组内表的分区信息，语句如下。
...
* `SCOPE`：表组的 `SCOPE` 属性。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>对于 V4.4.2 版本，视图 <code>CDB_OB_TABLEGROUPS</code> 和视图 <code>DBA_OB_TABLEGROUPS</code> 从 V4.4.2 BP1 版本开始引入 <code>SCOPE</code> 字段。</p>
  </main>

### 通过 SHOW TABLEGROUPS 语句查看表组属性及表所属数据库

系统租户和 MySQL 用户租户还可以通过 `SHOW TABLEGROUPS` 语句查看表组内表的所属数据库及表组属性。
...
* `Scope`：表组的 `SCOPE` 属性。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>对于 V4.4.2 版本，<code>SHOW TABLEGROUPS</code> 语句返回结果从 V4.4.2 BP1 版本开始引入 Scope 字段。</p>
  </main>
...
* `SCOPE`：表组的 `SCOPE` 属性。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>对于 V4.4.2 版本，视图 <code>CDB_OB_TABLEGROUP_TABLES</code> 和视图 <code>DBA_OB_TABLEGROUP_TABLES</code> 从 V4.4.2 BP1 版本开始引入 <code>SCOPE</code> 字段。</p>
  </main>
...
* `SCOPE`：表组的 `SCOPE` 属性。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>对于 V4.4.2 版本，视图 <code>DBA_OB_TABLE_LOCATIONS</code> 从 V4.4.2 BP1 版本开始引入 <code>SCOPE</code> 字段。</p>
  </main>
