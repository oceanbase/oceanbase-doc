...
* `SCOPE`：表组的 `SCOPE` 属性。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>对于 V5.x 版本，视图 <code>CDB_OB_TABLEGROUPS</code> 和视图 <code>DBA_OB_TABLEGROUPS</code> 从 V5.0.1 版本开始引入 <code>SCOPE</code> 字段。</p>
  </main>
...
* `Scope`：表组的 `SCOPE` 属性。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>对于 V5.x 版本，<code>SHOW TABLEGROUPS</code> 语句返回结果从 V5.0.1 版本开始引入 Scope 字段。</p>
  </main>
...
* `SCOPE`：表组的 `SCOPE` 属性。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>对于 V5.x 版本，视图 <code>CDB_OB_TABLEGROUP_TABLES</code> 和视图 <code>DBA_OB_TABLEGROUP_TABLES</code> 从 V5.0.1 版本开始引入 <code>SCOPE</code> 字段。</p>
  </main>
...
* `SCOPE`：表组的 `SCOPE` 属性。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>对于 V5.x 版本，视图 <code>DBA_OB_TABLE_LOCATIONS</code> 从 V5.0.1 版本开始引入 <code>SCOPE</code> 字段。</p>
  </main>
