...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>可以通过视图 <code>DBA_SCHEDULER_JOBS</code> 查看物化视图后台刷新的任务情况。更多查看物化视图信息，参见 <a href="400.refresh-materialized-views-of-mysql-mode.md">查询物化视图</a>。</p>
</main>
...
| [DBA_SCHEDULER_JOBS]() | 展示数据库中所有调度程序作业的信息。|
