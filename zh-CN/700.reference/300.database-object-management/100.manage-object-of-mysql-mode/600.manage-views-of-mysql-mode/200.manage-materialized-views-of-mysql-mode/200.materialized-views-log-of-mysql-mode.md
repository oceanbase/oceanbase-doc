...
如果开启物化视图日志自动管理功能，那么在创建增量刷新物化视图或实时物化视图时，OceanBase 数据库会自动创建 mlog 或自动更新 mlog 定义。物化视图日志自动管理功能详细介绍信息，参见 [物化视图日志自动管理](250.automatic-management-materialized-views-log-of-mysql-mode.md)。
