...
* 您可以通过 [DBMS_MVIEW.PURGE_LOG(table_name)](../../../../../500.sql-reference/300.pl-reference/200.pl-mysql/1000.pl-system-package-mysql/9950.dbms-mview-mysql/200.purge-log-mysql.md) 来对某个基表的物化视图日志执行 `PURGE` 操作。
