...
为防止其他的 Sequence 缓存过期问题，OceanBase 数据库从 V4.4.1 版本开始引入 `ALTER SYSTEM FLUSH SEQUENCE CACHE` 语句，用于主动清除 Sequence 缓存，以便发生问题后能快速恢复。有关清除 Sequence 缓存的详细信息，参见 [ALTER SYSTEM FLUSH SEQUENCE CACHE](../../../500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/1450.alter-system-flush-sequence-cache-of-mysql-mode.md)。
