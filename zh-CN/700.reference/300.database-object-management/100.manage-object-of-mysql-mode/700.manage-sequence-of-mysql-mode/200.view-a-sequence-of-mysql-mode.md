...
有关 `oceanbase.DBA_OB_SEQUENCE_OBJECTS` 视图字段的更多说明，参见 [oceanbase.DBA_OB_SEQUENCE_OBJECTS](../../../7.system-views/4.system-view-of-mysql-mode/2.dictionary-view-of-mysql-mode/68.oceanbase-dba_ob_sequence_objects-of-mysql-mode.md)。
