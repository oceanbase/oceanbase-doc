...
在对分区表进行 Truncate/Drop 分区操作时，可能会影响表上的全局索引，导致其失效，进而影响查询性能和数据完整性。有关 Truncate/Drop 分区对全局索引影响的介绍，参见 [删除分区](../500.delete-a-partition-of-mysql-mode.md) 和 [Truncate 分区](../600.truncate-partition-of-mysql-mode.md)。