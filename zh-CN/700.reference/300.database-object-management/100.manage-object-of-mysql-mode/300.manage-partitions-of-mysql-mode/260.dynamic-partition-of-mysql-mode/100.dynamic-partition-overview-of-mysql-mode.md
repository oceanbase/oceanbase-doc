...
* 若现存最大分区边界大于当前时间 `2025-04-20 12:34:56`，调度一次动态分区管理后，分区为：

  ```sql
  PARTITION P0 VALUES LESS THAN ('2025-04-20 13:30:00')
  PARTITION P2024111113 VALUES LESS THAN ('2025-04-20 14:00:00'),
  PARTITION P2024111114 VALUES LESS THAN ('2025-04-20 15:00:00'),
  PARTITION P2024111115 VALUES LESS THAN ('2025-04-20 16:00:00')
  ```

* 若现存最大分区边界小于当前时间，预创建分区会尝试补充历史分区。例如现存最大分区为 `PARTITION P0 VALUES LESS THAN ('2025-04-20 11:30:00')`，当前时间为 `2025-04-20 12:34:56`，调度一次动态分区管理后，分区为：

  ```sql
  PARTITION P0 VALUES LESS THAN ('2025-04-20 11:30:00'),
  PARTITION P2024111111 VALUES LESS THAN ('2025-04-20 12:00:00'),
  PARTITION P2024111112 VALUES LESS THAN ('2025-04-20 13:00:00'),
  PARTITION P2024111113 VALUES LESS THAN ('2025-04-20 14:00:00'),
  PARTITION P2024111114 VALUES LESS THAN ('2025-04-20 15:00:00'),
  PARTITION P2024111115 VALUES LESS THAN ('2025-04-20 16:00:00')
  ```

  补充了历史分区 `PARTITION P2024111111 VALUES LESS THAN ('2025-04-20 12:00:00')`。
...
2. 当前时间为 `2025-04-21 17:56:06`，调度一次动态分区管理后，分区为：
...
3. 时间为 `2025-04-21 17:56:16`，再次调度一次动态分区管理后，分区为：
