...
| 视图名 | 功能描述 |
|--------|---------|
| [oceanbase.DBA_OB_DYNAMIC_PARTITION_TABLES](../../../../700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/8650.o-dba_ob_dynamic_partition_tables-of-mysql-mode.md)| 展示本租户的动态分区表信息。|
| [oceanbase.V$OB_DYNAMIC_PARTITION_TABLES](../../../../700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/30950.v-ob_dynamic_partition_tables-of-mysql-mode.md)| 展示当前租户的动态分区表信息。该视图从内存中读取动态分区表相关属性，读取性能较好。|
