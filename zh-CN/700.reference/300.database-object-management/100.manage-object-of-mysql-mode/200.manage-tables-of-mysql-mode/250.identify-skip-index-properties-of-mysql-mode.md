...
OceanBase 数据库只有 `delete_insert`、`append_only` 的表更新模型，才支持增量数据生成 Skip Index。有关表更新模型的介绍，参见 [创建表](200.create-a-table-for-mysql-tenant-of-mysql-mode.md) 下 **指定表的更新模型** 章节。
