...
* `enable_rereplication`
  ...
  集群级配置项 `enable_rereplication` 用于设置是否开启自动补副本的功能。默认值为 `True`。有关配置项 `enable_rereplication` 的详细说明及设置，请参见 [enable_rereplication](../../../800.configuration-items-and-system-variables/100.system-configuration-items/300.cluster-level-configuration-items/8300.enable_rereplication.md)。
