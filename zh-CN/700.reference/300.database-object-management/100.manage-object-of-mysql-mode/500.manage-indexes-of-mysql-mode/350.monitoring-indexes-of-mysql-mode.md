...
5. 查看视图 `DBA_INDEX_USAGE`。
    ...
    3. 再次查看视图 `DBA_INDEX_USAGE`。
        ...
        * `LAST_USED`：索引表最后一次被使用的时间。
        ...
        更多有关视图 `DBA_INDEX_USAGE` 字段的详细信息，请参见 [DBA_INDEX_USAGE](../../../700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/28400.dba_index_usage-of-mysql-mode.md)。
