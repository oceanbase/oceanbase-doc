...
| 视图名 | 功能描述 |
|--------|---------|
| [DBA_OB_DYNAMIC_PARTITION_TABLES](../../../../700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/12850.dba_ob_dynamic_partition_tables-of-oracle-mode.md)| 展示本租户的动态分区表信息。<main id="notice" type='explain'><h4>说明</h4><p>该视图从 V4.3.5 BP2 版本开始引入。</p></main>|
| [V$OB_DYNAMIC_PARTITION_TABLES](../../../../700.system-views/500.system-view-of-oracle-mode/300.performance-view-of-oracle-mode/31810.v-ob_dynamic_partition_tables-of-oracle-mode.md)| 展示当前租户的动态分区表信息。该视图从内存中读取动态分区表相关属性，读取性能较好。<main id="notice" type='explain'><h4>说明</h4><p>该视图从 V4.3.5 BP2 版本开始引入。</p></main>|
