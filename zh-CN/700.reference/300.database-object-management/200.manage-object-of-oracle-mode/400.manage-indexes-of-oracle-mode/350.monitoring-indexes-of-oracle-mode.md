...
6. 查看视图 `DBA_INDEX_USAGE`。
    ...
    3. 再次查看视图 `DBA_INDEX_USAGE`。
       ...
       * `LAST_USED`：索引表最后一次被使用的时间。
       ...
       更多有关视图 `DBA_INDEX_USAGE` 字段的详细信息，请参见 [DBA_INDEX_USAGE](../../../700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/35500.dba_index_usage-of-oracle-mode.md)。
