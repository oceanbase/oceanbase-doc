...
* 对于 OceanBase 数据库 V4.x 版本，使用 DBLink 写功能时，如果远端数据库为 OceanBase 数据库，则要求远端 OceanBase 数据库的版本必须是 V4.1.0 及以上版本；如果远端数据库为 Oracle 数据库，建议使用 Oracle 11g 及以上版本。
...
* 使用 DBLink 功能修改远端 Oracle 数据库中的数据时，需要在本地 OceanBase 数据库中安装并配置 OCI-11.2。安装和配置 OCI-11.2 的详细操作，请参见 [安装和配置 OCI](600.install-and-configure-the-oci.md)。
