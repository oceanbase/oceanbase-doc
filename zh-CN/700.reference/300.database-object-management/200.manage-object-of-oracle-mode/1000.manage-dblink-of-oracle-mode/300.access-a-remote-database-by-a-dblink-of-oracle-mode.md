...
* 调用一个简单的 UDF。
  ...
  * 调用本地 OceanBase 数据库上的同义词。
  ...
  有关更多 UDF 的说明及介绍，请参见 [用户自定义函数](../../../500.sql-reference/300.pl-reference/300.pl-oracle/700.stored-procedure-and-functions-oracle/700.user-defined-aggregation-functions-oracle/100.user-defined-func-overview-oracle.md)。
