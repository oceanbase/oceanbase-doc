...
* 使用 DBLink 功能访问远端 Oracle 数据库的存储过程对象且远端数据库版本为 Oracle-19C 及以上版本时，则需要在本地 OceanBase 数据库中安装并配置 OCI-12.2；其他场景下使用 DBLink 功能访问远端 Oracle 数据库时，需要在本地 OceanBase 数据库中安装并配置 OCI-11.2。
