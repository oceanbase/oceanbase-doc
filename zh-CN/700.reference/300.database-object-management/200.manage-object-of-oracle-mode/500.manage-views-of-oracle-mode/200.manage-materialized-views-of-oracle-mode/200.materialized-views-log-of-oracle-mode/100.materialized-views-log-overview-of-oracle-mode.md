...
* 您可以通过 [DBMS_MVIEW.PURGE_LOG(table_name)](../../../../../500.sql-reference/300.pl-reference/300.pl-oracle/1400.pl-system-package-oracle/9950.dbms-mview-oracle/200.purge-log-oracle.md) 来对某个基表的物化视图日志执行 `PURGE` 操作。
