...
```sql
CREATE MATERIALIZED VIEW view_name [([column_list] [PRIMARY KEY(column_list)])] [opt_table_option_list] [opt_partition_option] [refresh_clause] [ENABLE QUERY REWRITE] [on_query_computation_clause] AS view_select_stmt; 
```
...
更多物化视图改写和改写控制的信息，参见 [物化视图改写](600.materialized-views-rewrite-of-oracle-mode.md)。
