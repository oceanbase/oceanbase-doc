...
也可以在调用 [DBMS_MVIEW.REFRESH](../../../../600.pl-reference/300.pl-oracle/1400.pl-system-package-oracle/9950.dbms-mview-oracle/300.refresh-oracle.md) 函数时，通过指定 `refresh_parallel` 显式设置本次刷新的并行度，目前只影响全量刷新，增量刷新不受此参数影响。
