...
```shell
obclient> SELECT * FROM SYS.DBA_OB_TABLEGROUPS WHERE tablegroup_name = 'TBLGROUP1';
```
...
* `SCOPE`：表组的 `SCOPE` 属性。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>对于 V4.4.2 版本，视图 <code>DBA_OB_TABLEGROUPS</code> 从 V4.4.2 BP1 版本开始引入 <code>SCOPE</code> 字段。</p>
  </main>

### 通过 SHOW TABLEGROUPS 语句查看表组属性及表所属数据库

Oracle 用户租户还可以通过 `SHOW TABLEGROUPS` 语句查看表组内表的所属数据库及表组属性。
...
* `SCOPE`：表组的 `SCOPE` 属性。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>对于 V4.4.2 版本，<code>SHOW TABLEGROUPS</code> 语句返回结果从 V4.4.2 BP1 版本开始引入 <code>SCOPE</code> 字段。</p>
  </main>
...
* `SCOPE`：表组的 `SCOPE` 属性。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>对于 V4.4.2 版本，视图 <code>DBA_OB_TABLEGROUP_TABLES</code> 从 V4.4.2 BP1 版本开始引入 <code>SCOPE</code> 字段。</p>
  </main>
