...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>从 OceanBase 数据库 V5.0.1 版本开始，表创建后可以使用 <code>ALTER TABLE ... SET merge_engine</code> 语句在不同表模式之间进行 Online 转换，具体操作请参见 <a href="600.change-table-of-oracle-mode.md">更改表</a>；在 V5.0.1 之前的版本，参数 <code>MERGE_ENGINE</code> 在创建表时指定之后，其配置值将不可修改。</p>
</main>
