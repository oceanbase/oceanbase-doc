...
|--------------|-----------------|------------|----------------|------------------|
|INT32| INT(8,TRUE)| TINYINT|  \ ||
|INT32| INT(16,TRUE)| SMALLINT| \ ||
|INT32| INT(32,TRUE)| INT| \ ||
|INT64| INT(64,TRUE)| BIGINT| \ ||
|INT32| INT(8,FALSE)| TINYINT（超限为NULL）| \ ||
|INT32| INT(16,FALSE) |SMALLINT（超限为NULL） | \ ||
|INT32| INT(32,FALSE)| INT（超限为NULL）| \ ||
|INT64|INT(64,FALSE) |BIGINT（超限为NULL） | \ ||
...
|INT64| TIMESTAMP(is_adjusted_to_utc=true, parquet::LogicalType::TimeUnit::MICROS)| TIMESTAMP | \ ||
