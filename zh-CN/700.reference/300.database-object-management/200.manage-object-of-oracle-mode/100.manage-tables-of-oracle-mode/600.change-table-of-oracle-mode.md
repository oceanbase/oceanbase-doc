...
* 修改列类型。OceanBase 数据库支持多种列类型之间的转换。
  ...
  OceanBase 数据库中列类型的转换规则及详细信息请参见 [列类型变更规则](../../../5.sql-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/10.ddl-function-of-oracle-mode/9.column-type-change-rule-of-oracle-mode.md)。
