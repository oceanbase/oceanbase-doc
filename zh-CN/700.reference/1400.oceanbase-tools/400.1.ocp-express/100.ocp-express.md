...
* Q：OCP Express 是否可以单独部署？
  ...
  <main id="notice" type='explain'>
  <h4>说明</h4>
  <p>若部署 OCP Express 的节点和 OceanBase 集群不在同一个节点时，需要为 OCP Express 的节点与 OceanBase 集群节点做时钟源同步，防止使用过程中因时钟偏差引发 OCP Express 操作异常。具体操作步骤可参考 <a href="https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000035596">配置时钟源</a>。</p>
  </main>
