...
| [performance_schema](../400.system-variables/10800.performance_schema-1-2-3.md)              | 用于向客户端声明是否支持 Performance 信息的查询，其默认值为 `OFF`。 <main id="notice" type='explain'><h4>说明</h4><p>该变量仅用于兼容 MySQL 8.0，相关功能并不支持，可以查询及设置，设置行为不报错但不生效。</p></main>  |
