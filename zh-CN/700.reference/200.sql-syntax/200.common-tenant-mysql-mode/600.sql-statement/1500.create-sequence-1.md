CREATE SEQUENCE
====================================
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/create-sequence-1
...
创建序列后，您可以在 SQL 语句中使用 `CURRVAL` 伪列返回序列当前值或使用 `NEXTVAL` 伪列返回递增的新值。详细信息，请参见 [序列伪列](../300.sequence-pseudo-column-1.md)。
