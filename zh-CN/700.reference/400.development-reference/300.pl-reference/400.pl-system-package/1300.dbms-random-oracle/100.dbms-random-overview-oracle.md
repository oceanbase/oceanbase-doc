...
| [RANDOM](../1300.dbms-random-oracle/200.initialize-random-oracle.md)     | 生成一个随机数。                                                                             |
...
| [VALUE](../1500.dbms-scheduler-oracle/1200.set-job-argument-value-oracle.md)      | 此函数获取一个大于或等于 0 且小于 1 的随机数，小数点右侧有 38 位数字（38 位精度），而重载函数获取一个随机数 x，其中 x 大于或等于最小值，且小于最大值。 |
