...
|                                子程序                                |                      描述                       |
|-------------------------------------------------------------------|-----------------------------------------------|
| [BEGINCREATE 静态存储过程](../2700.anydata-type-oracle/200.begincreate-static-stored-procedure-oracle.md) | 开始创建新的 `ANYDATA`。                             |
| [ENDCREATE 成员存储过程](../2700.anydata-type-oracle/300.endcreate-stored-procedure-oracle.md)   | 结束创建 `ANYDATA`。                               |
| [GET\* 成员函数](../2700.anydata-type-oracle/400.get-member-stored-procedure-oracle.md)         | 获取当前数据值（应为适当的类型）。                             |
| [GETTYPE 成员函数](../2700.anydata-type-oracle/500.gettype-member-function-oracle.md)       | 获取 `ANYDATA` 的类型。                             |
| [GETTYPENAME 成员函数](../2700.anydata-type-oracle/600.get-oracle.md)   | 获取 `ANYDATA` 的完全限定类型名称。                       |
| [PIECEWISE 成员存储过程](../2700.anydata-type-oracle/700.gettypename-member-function-oracle.md)   | 将当前数据值的访问模式设置为一次属性（如果数据值属于 `TYPECODE_OBJECT`） |
| [SET\* 成员存储过程](../2700.anydata-type-oracle/800.set-member-stored-procedure-oracle.md)       | 设置当前数据值。                                      |
