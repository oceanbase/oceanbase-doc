...
|                         **子程序**                          |     **描述**      |
|----------------------------------------------------------|-----------------|
| [DISABLE](../1100.dbms-output-oracle/200.disable-oracle.md)   | 禁用消息输出。         |
| [ENABLE](../1100.dbms-output-oracle/300.enable-oracle.md)    | 开启消息输出。         |
| [GET_LINE](../1100.dbms-output-oracle/400.get-line-oracle.md)  | 从缓冲区中检索一行数据。    |
| [GET_LINES](../1100.dbms-output-oracle/500.get-lines-oracle.md) | 从缓冲区检索一组行数据。    |
| [NEW_LINE](../1100.dbms-output-oracle/600.new-line-oracle.md)  | 终止用 `PUT` 创建的行。 |
| [PUT](../1100.dbms-output-oracle/700.put-oracle.md)       | 将部分行数据放入缓冲区。    |
| [PUT_LINE](../1100.dbms-output-oracle/800.put-line-oracle.md)  | 将单行数据放入缓冲区。     |
