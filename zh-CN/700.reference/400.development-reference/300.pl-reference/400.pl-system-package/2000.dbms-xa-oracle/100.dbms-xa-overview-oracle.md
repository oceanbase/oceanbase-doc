...
|                           **子程序**                            |                    **描述**                     |
|--------------------------------------------------------------|-----------------------------------------------|
| [DIST_TXN_SYNC](../2000.dbms-xa-oracle/400.dist-txn-sync-oracle.md) | 在使用 Real Application Clusters（RAC）时用于同步的恢复    |
| [XA_COMMIT](../2000.dbms-xa-oracle/500.xa-commit-oracle.md)     | 提交 xid 指定的全局事务。                               |
| [XA_END](../2000.dbms-xa-oracle/600.xa-end-oracle.md)        | 将当前会话与 `xid` 指定的关联事务分支中剥离。                    |
| [XA_FORGET](../2000.dbms-xa-oracle/700.xa-forget-oracle.md)     | 要求资源管理器 RM 丢弃提交或回滚的事务分支。                      |
| [XA_GETLASTOER](../2000.dbms-xa-oracle/800.xa-getlastoer-oracle.md) | 如果先前的 XA 调用失败，则获取最后的错误代码。                     |
| [XA_PREPARE](../2000.dbms-xa-oracle/900.xa-prepare-oracle.md)    | 准备提交 `xid` 中指定的事务分支。                          |
| [XA_RECOVER](../2000.dbms-xa-oracle/1000.xa-recover-oracle.md)    | 从资源管理器 RM 获取准备好的、已提交或者已回滚（但是事务信息还没丢弃）的事务分支列表。 |
| [XA_ROLLBACK](../2000.dbms-xa-oracle/1100.xa-rollback-oracle.md)   | 要求资源管理器 RM 回滚事务分支。                            |
| [XA_SETTIMEOUT](../2000.dbms-xa-oracle/1200.xa-settimeout-oracle.md) | 设置当前会话的事务超时间隔（以秒为单位）。                         |
| [XA_START](../2000.dbms-xa-oracle/1300.xa-start-oracle.md)      | 将当前会话与 `xid` 指定的事务分支相关联。                      |
