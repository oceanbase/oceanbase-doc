...
| `BLOB`       | 变长 | 65536    | `BINARY`  |
| `MEDIUMBLOB` | 变长 | 16777216 | `BINARY`  |
| `LONGBLOB`   | 变长 | 536870911 | `BINARY`  |
| `TINYTEXT`   | 变长 | 256            | `UTF8MB4` |
| `TEXT`       | 变长 | 65536    | `UTF8MB4` |
| `MEDIUMTEXT` | 变长 | 16777216  | `UTF8MB4` |
| `LONGTEXT`   | 变长 | 536870911  | `UTF8MB4` |
