...
> **说明**
>
> 您可使用 Canal 和 oblogproxy 将 OceanBase 数据库的数据实时同步到 MySQL 数据库，详细操作请参考 [使用 Canal 从 OceanBase 数据库迁移数据到 MySQL 数据库](../../../600.data-migration/700.migrate-data-from-OceanBase-database-to-MySQL/100.use-Canal-to-migrate-data-from-OceanBase-database-to-MySQL-database.md)。
