...
6. 下述功能能够帮您更好的在趋势图中查看和分析性能监控数据，您可结合图片及下述文字理解。
   ...
   * 光标悬停在问号图标处可查看对应监控项介绍，光标悬停在监控图表上任意位置，可查看折线图的详细信息。单击趋势图右上角的 ▲ 和 ▼ 可以进行上翻页和下翻页。
   ...
   * 在 **数据库性能** 页签的 **OBServer 维度** 和 **Unit 维度** 页签中，光标悬停在监控图表上任意位置，将默认展示对应性能数据的 IP:Port 信息。

     ![IP+端口2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.4.1/obshell/V4.4.0/420.Performance-monitoring-IP%E7%AB%AF%E5%8F%A32.png)

   * 在 **主机性能** 页签的 **主机维度** 页签中，光标悬停在监控图表上任意位置，将默认展示对应性能数据的主机 IP 信息。

     ![IP+端口5](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.4.1/obshell/V4.4.0/420.Performance-monitoring-%20IP%E7%AB%AF%E5%8F%A35.png)
...
7. 同时可以对监控图表进行放大查看。单击图表右上角的放大图标，可在弹框中查看放大的监控图表。

   * 非自动刷新情况下：单击图表右上角的放大图标，打开放大弹框，在放大弹框中可以查看监控数据，并且可以选择时间范围查看对应数据。外层的时间范围会透传到放大弹框中，改变外层时间范围会默认应用到已打开的弹框中。

    ![放大1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.4.1/obshell/V4.4.2/obshell/obshell/Performance-monitoring-01.png)

    选择时间范围后，会出现刷新按钮，可以手动刷新数据。

    ![放大2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.4.1/obshell/V4.4.2/obshell/obshell/Performance-monitoring-02.png)

   * 自动刷新情况下：单击图表右上角的放大图标，打开放大弹框，弹框会根据外层自动刷新频率进行数据刷新。放大弹框中会隐藏时间范围选择器，不支持单独的时间范围控制。

    ![放大3](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.4.1/obshell/V4.4.2/obshell/obshell/Performance-monitoring-03.png)
...
6. 下述功能能够帮您更好的在趋势图中查看和分析性能监控数据，您可结合图片及下述文字理解。
   ...
   * 在 **Unit 维度** 页签中，光标悬停在监控图表上任意位置，将默认展示对应性能数据的 IP:Port 信息。

     ![IP+端口4](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.4.1/obshell/V4.4.0/420.Performance-monitoring-IP%E7%AB%AF%E5%8F%A34.png)
...
7. 同时可以对监控图表进行放大查看。单击图表右上角的放大图标，可在弹框中查看放大的监控图表。
   ...
   * 非自动刷新情况下：单击图表右上角的放大图标，打开放大弹框，在放大弹框中可以查看监控数据，并且可以选择时间范围查看对应数据。外层的时间范围会透传到放大弹框中，改变外层时间范围会默认应用到已打开的弹框中。
    ...
    ![放大4](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.4.1/obshell/V4.4.2/obshell/obshell/Performance-monitoring-04.png)

    选择时间范围后，会出现刷新按钮，可以手动刷新数据。

    ![放大5](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.4.1/obshell/V4.4.2/obshell/obshell/Performance-monitoring-05.png)

   * 自动刷新情况下：单击图表右上角的放大图标，打开放大弹框，弹框会根据外层自动刷新频率进行数据刷新。放大弹框中会隐藏时间范围选择器，不支持单独的时间范围控制。

    ![放大6](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.4.1/obshell/V4.4.2/obshell/obshell/Performance-monitoring-02.png)