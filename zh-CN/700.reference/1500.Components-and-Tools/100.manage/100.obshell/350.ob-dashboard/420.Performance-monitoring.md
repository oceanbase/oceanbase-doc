...
6. 下述功能能够帮您更好的在趋势图中查看和分析性能监控数据，您可结合图片及下述文字理解。
   ...
   + OBServer 维度和 Unit 维度默认展示每个 IP:Port 的性能数据信息。
   ...
   + 当精确筛选特定 Zone 下的 OBServer 时，各维度的监控数据都将仅展示相应 IP:Port 的性能数据信息。

     ![IP+端口1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.4.1/obshell/V4.4.0/420.Performance-monitoring-IP%E7%AB%AF%E5%8F%A31.png)
...
6. 下述功能能够帮您更好的在趋势图中查看和分析性能监控数据，您可结合图片及下述文字理解。
   ...
   + 当精确筛选特定 Zone 下的 OBServer 时，各维度的监控数据都将仅展示相应 IP:Port 的性能数据信息。
     ...
     ![IP+端口3](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.4.1/obshell/V4.4.0/420.Performance-monitoring-IP%E7%AB%AF%E5%8F%A33.png)
   + 支持对具体的监控项进行操作，如单击下图红色框选位置，将不展示对应线的信息，单击下图蓝色框选位置，将只展示这一条线的信息。
