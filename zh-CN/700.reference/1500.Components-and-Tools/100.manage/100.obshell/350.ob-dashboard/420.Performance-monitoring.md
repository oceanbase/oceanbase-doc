...
6. 下述功能能够帮您更好的在趋势图中查看和分析性能监控数据，您可结合图片及下述文字理解。
   ...
   + 支持对监控指标进行编辑操作。
     ...
     <main id="notice" type='explain'>
       <h4>说明</h4>
       <p>obshell 自 V4.4.1 起支持对监控指标进行编辑操作，您可访问 <a href="https://mirrors.aliyun.com/oceanbase/community/stable/el/?spm=a2c6h.25603864.0.0.1f4328b3mIcuek">阿里云镜像站</a> 获取相应安装包，使用 obshell 直接进行升级，升级操作详参：<a href="300.ob-dashboard-cluster/500.ob-dashboard-obshell-upgrade.md">升级 obshell</a>。</p>
     </main>
...
6. 下述功能能够帮您更好的在趋势图中查看和分析性能监控数据，您可结合图片及下述文字理解。
   ...
   + 支持对监控指标进行编辑操作。
     ...
     <main id="notice" type='explain'>
       <h4>说明</h4>
       <p>obshell 自 V4.4.1 起支持对监控指标进行编辑操作，您可访问 <a href="https://mirrors.aliyun.com/oceanbase/community/stable/el/7/x86_64/?spm=a2c6h.25603864.0.0.23db5d3eN9iVGQ">阿里云镜像站</a> 获取相应安装包，使用 obshell 直接进行升级，升级操作详参：<a href="300.ob-dashboard-cluster/500.ob-dashboard-obshell-upgrade.md">升级 obshell</a>。</p>
     </main>
