...
登录 obshell Dashboard 控制台后，输入 Prometheus 地址、用户名、密码，单击 **开启** 即可进入 **性能监控** 页面，您可以使用已有的 Prometheus 地址开启监控告警，若暂未部署，建议使用 obd 安装部署。在告警中心页面上方点击 **OceanBase 集群**、**OceanBase 租户** 即可进入对应页签。

<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>仅首次登录告警中心页面需输入 Prometheus 地址、用户名、密码等信息。</p>
</main>
