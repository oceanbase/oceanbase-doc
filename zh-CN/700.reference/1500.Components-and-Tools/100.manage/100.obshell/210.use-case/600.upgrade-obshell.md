...
通过 obshell-sdk-go 请求对应 API 方法的介绍可参见 [obshell 升级检查](../500.obshell-sdk-reference/200.go/1000.agent-upgrade-check-of-go.md)。
...
通过 obshell-sdk-go 请求对应 API 方法的介绍可参见 [obshell 升级](../500.obshell-sdk-reference/200.go/1200.upgrade-agent-of-go.md)。
