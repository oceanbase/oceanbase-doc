...
* 通过 obshell-SDK-Python 请求 API 方法的介绍可参见 [在集群初始化前添加节点](../500.obshell-sdk-reference/100.python/300.add-new-node-of-python.md)。

* 通过 obshell-SDK-GO 请求 API 方法的介绍可参见 [在集群初始化前添加节点](../500.obshell-sdk-reference/200.go/300.add-new-node-of-go.md)。
