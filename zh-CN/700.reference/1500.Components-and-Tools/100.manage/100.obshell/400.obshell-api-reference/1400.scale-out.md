...
* 通过 OBShell-SDK-Python 请求 API 方法的介绍可参见 [扩容](../500.obshell-sdk-reference/100.python/1400.scale-out-of-python.md)。

* 通过 OBShell-SDK-GO 请求 API 方法的介绍可参见 [扩容](../500.obshell-sdk-reference/200.go/1400.scale-out-of-go.md)。
