...
本文介绍如何通过 obshell 启动 OBProxy（OceanBase 数据库代理，又称 ODP）。
...
除通过命令行调用 API 接口外，还可以通过 SDK 方法调用 API。通过 obshell-sdk-python 请求 API 方法的介绍可参见 [启动 OBProxy](../../500.obshell-sdk-reference/100.python/230.odp-management/200.start-odp-of-python.md)。
