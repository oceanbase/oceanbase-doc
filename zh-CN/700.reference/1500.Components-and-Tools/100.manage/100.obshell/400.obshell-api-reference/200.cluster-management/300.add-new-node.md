...
| masterPassowrd | string | 否 | ***** | 当加入到一个 MASTER 节点时，如果 MASTER 设置了节点密码，则需要通过该参数指定节点密码。<main id="notice" type='explain'><h4>说明</h4><p>该参数在 V4.3.5 BP2 及之后版本（V4.3.5.x 系列）中支持。</p></main> |
