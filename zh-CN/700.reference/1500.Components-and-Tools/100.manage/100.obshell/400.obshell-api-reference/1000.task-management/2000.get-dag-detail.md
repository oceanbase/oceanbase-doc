...
* 通过 obshell-sdk-python 请求 API 方法的介绍可参见 [获取任务的详细信息](../500.obshell-sdk-reference/100.python/2000.get-dag-detail-of-python.md)。

* 通过 obshell-sdk-go 请求 API 方法的介绍可参见 [获取任务的详细信息](../500.obshell-sdk-reference/200.go/2000.get-dag-detail-of-go.md)。
