...
| TENANT_ROLE| varchar(100) | NO | 集群角色：<ul><li>`PRIMARY` 指主租户   </li><li>  `STANDBY` 指备租户  </li><li> `RESTORE` 指租户处于恢复中 </li></ul>  <main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.1.0 版本开始引入。</p></main> |
...
| LOG_MODE| varchar(100)| NO | 归档模式：<ul><li>  `ARCHIVELOG` 指归档模式开启中 </li><li> `NOARCHIVELOG` 指未开启归档模式 </li></ul>  <main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.1.0 版本开始引入。</p></main> |
...
*************************** 1. row ***************************
               ...
               TENANT_TYPE: USER
               CREATE_TIME: 2024-07-31 14:49:07.116290
               MODIFY_TIME: 2024-07-31 14:49:23.242364
              PRIMARY_ZONE: zone1
        ...
        COMPATIBILITY_MODE: MYSQL
         ...
         SWITCHOVER_STATUS: NORMAL
          SWITCHOVER_EPOCH: 0
                  SYNC_SCN: 1722413788477813685
            REPLAYABLE_SCN: 1722413788477813685
              READABLE_SCN: 1722413788477813685
