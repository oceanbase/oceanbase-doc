...
| [GV$OB_TRANSACTION_PARTICIPANTS](../300.performance-view-of-mysql-mode/1200.gv-ob_transaction_participants-of-mysql-mode.md)   | 展示所有 OBServer 节点上的事务参与者信息。                                  |
...
| [V$ACTIVE_SESSION_HISTORY](../300.performance-view-of-mysql-mode/11000.gv-active_session_history-of-mysql-mode.md)                       | 展示活跃会话历史记录。                              |
...
| [V$OB_COMPACTION_DIAGNOSE_INFO](../300.performance-view-of-mysql-mode/200.gv-ob_compaction_diagnose_info-of-mysql-mode.md)    | 展示 COMPACTION 的诊断信息。                                      |
| [V$OB_TABLET_COMPACTION_HISTORY](../300.performance-view-of-mysql-mode/1000.gv-ob_tablet_compaction_history-of-mysql-mode.md)   | 展示 TABLET 级 COMPACTION 的历史信息。                             |
| [V$OB_TABLET_COMPACTION_PROGRESS](../300.performance-view-of-mysql-mode/1100.gv-ob_tablet_compaction_progress-of-mysql-mode.md)  | 展示 TABLET 级 COMPACTION 的进度信息。                             |
| [V$OB_TRANSACTION_PARTICIPANTS](../300.performance-view-of-mysql-mode/5400.v-ob_transaction_participants-of-mysql-mode.md)    | 展示所有 OBServer 节点上的事务参与者信息。                                  |
...
| [v$V$SESSION_WAIT](../300.performance-view-of-mysql-mode/5900.v-session_wait-of-mysql-mode.md)                   | 每个 Session 当前等待事件明细，按照约定，每个等待事件会有三个参数，各自会记录对应的值。          |
...
| [V$SESSTAT](../300.performance-view-of-mysql-mode/2000.gv-sesstat-of-mysql-mode.md)                        | 展示 Session 级别的统计事件概况。                                     |
| [V$SYSSTAT](../300.performance-view-of-mysql-mode/10500.gv-sysstat-of-mysql-mode.md)                        | 展示当前服务器上租户级别的统计事件信息。                                              |
...
| [V$SESSION_LONGOPS](../300.performance-view-of-mysql-mode/3300.gv-session_longops-of-mysql-mode.md)  | 展示当前 OBServer 节点上索引构建的进度。 |
...
| [V$OB_IO_CALIBRATION_STATUS](../300.performance-view-of-mysql-mode/9900.gv-ob_io_calibration_status-of-mysql-mode.md)        | 展示 I/O 校准任务的执行状态。                  |
...
| [V$OB_MEMSTORE_INFO](../300.performance-view-of-mysql-mode/9700.gv-ob_memstore_info-of-mysql-mode.md)      | 展示所有服务器上所有租户的所有分区的 MemTable 的详细信息。 |
| [GV$OB_SSTABLES](../300.performance-view-of-mysql-mode/4200.gv-sstable-of-mysql-mode.md)      | 展示租户的 SSTable 信息。                 |
| [V$OB_SSTABLES](../300.performance-view-of-mysql-mode/4200.gv-sstable-of-mysql-mode.md)       | 展示租户的 SSTable 信息。                 |
...
| [V$OB_PLAN_CACHE_STAT](../300.performance-view-of-mysql-mode/1400.gv-plan_cache_stat-of-mysql-mode.md)          | 记录当前租户在所有 Server 上的每个计划缓存整体的状态。                                        |
...
| [V$OB_PLAN_CACHE_PLAN_STAT](../300.performance-view-of-mysql-mode/1500.gv-plan_cache_plan_stat-of-mysql-mode.md)     | 记录了当前租户在当前 Server 上的计划缓存中缓存的每一个缓存对象的状态。                                |
...
| [V$OB_PS_ITEM_INFO](../300.performance-view-of-mysql-mode/3600.gv-ps_item_info-of-mysql-mode.md)             | 用于给 prepared statement 提供监控功能，包含 PS Cache 中所有 prepare statement 的基本信息。 |
...
| [V$SQL_PLAN_MONITOR](../300.performance-view-of-mysql-mode/2900.gv-sql_plan_monitor-of-mysql-mode.md)      | 慢查询的 Operation 层面的统计，每个 Operation 会有一条统计信息。                         |
...
|                                  视图名                                   |                                 功能描述                                 |
|------------------------------------------------------------------------|----------------------------------------------------------------------|
| [GV$OB_LOG_STAT](../300.performance-view-of-mysql-mode/11400.gv-ob_log_stat-of-mysql-mode.md) | 展示 Palf 的状态。                                                                |
...
| [V$OB_KVCACHE](../300.performance-view-of-mysql-mode/500.gv-ob_kvcache-of-mysql-mode.md)               | 展示每台 OBServer 节点上的 KVCACHE 信息。                                 |
| [V$OB_PARAMETERS](../300.performance-view-of-mysql-mode/4800.v-ob_parameters-of-mysql-mode.md)            | 展示本 OBServer 节点上的配置项信息。                                        |
| [V$OB_SERVER_SCHEMA_INFO](../300.performance-view-of-mysql-mode/4000.gv-server_schema_info-of-mysql-mode.md)    | 展示所有 Server 上的 Schema 信息。                                    |
...
| [V$SQL_WORKAREA](../300.performance-view-of-mysql-mode/3700.gv-sql_workarea-of-mysql-mode.md)                 | 之前受 SQL 自动内存管理负责执行的所有 Operator 的 Workarea 统计信息。                       |
...
| [V$LATCH](../300.performance-view-of-mysql-mode/2300.gv-latch-of-mysql-mode.md)  | 集群中所有 OBServer 节点的 Latch 信息视图。 |
