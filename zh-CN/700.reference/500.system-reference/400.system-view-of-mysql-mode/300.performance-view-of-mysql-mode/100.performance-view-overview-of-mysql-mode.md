...
| [GV$SESSION_LONGOPS](../300.performance-view-of-mysql-mode/3300.gv-session_longops-of-mysql-mode.md) | 展示集群 DDL 操作的执行状态和进度。            |
| [V$SESSION_LONGOPS](../300.performance-view-of-mysql-mode/7400.v-session_longops-of-mysql-mode.md)  | 展示当前 OBServer 节点上 DDL 操作的执行状态和进度。 |
