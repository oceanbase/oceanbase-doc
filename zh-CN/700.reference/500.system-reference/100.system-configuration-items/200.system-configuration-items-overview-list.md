...
|                                          配置项名                                          |                                功能描述                                 |
|----------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| [balancer_idle_time](300.cluster-level-configuration-items/2600.balancer_idle_time.md)                      | 用于设置负载均衡等后台任务线程空闲时的唤醒间隔时间。                                          |
...
| [enable_rebalance](300.cluster-level-configuration-items/7900.enable_rebalance.md)                        | 用于设置是否开启自动负载均衡的功能。                                                  |
...
|                                          配置项名                                          |               功能描述               |
|----------------------------------------------------------------------------------------|----------------------------------|
| [backup_data_file_size](300.cluster-level-configuration-items/1500.backup_data_file_size.md)                   | 用于控制单个数据备份文件的文件大小上限。                  |
| [restore_concurrency](300.cluster-level-configuration-items/17000.restore_concurrency.md)                     | 用于设置从备份恢复租户数据时的最大并发度。            |
