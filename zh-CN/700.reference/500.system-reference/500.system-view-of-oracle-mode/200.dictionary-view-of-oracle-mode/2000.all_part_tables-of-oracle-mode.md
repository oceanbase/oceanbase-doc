...
| DEF_INMEMORY              | VARCHAR2(8)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL                              |
| DEF_INMEMORY_PRIORITY     | VARCHAR2(8)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL                                      |
| DEF_INMEMORY_DISTRIBUTE   | VARCHAR2(15)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL                         |
| DEF_INMEMORY_COMPRESSION  | VARCHAR2(17)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL               |
| DEF_INMEMORY_DUPLICATE    | VARCHAR2(13)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL                               |
...
| DEF_INMEMORY_SERVICE      | VARCHAR2(12)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL                      |
| DEF_INMEMORY_SERVICE_NAME | VARCHAR2(1000) | NO         | 目前暂不支持该字段，当前该字段默认为 NULL          |
