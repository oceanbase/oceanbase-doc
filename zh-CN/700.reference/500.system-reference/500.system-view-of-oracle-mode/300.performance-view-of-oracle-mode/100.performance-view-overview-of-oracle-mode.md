...
| [V$OB_KVCACHE](../300.performance-view-of-oracle-mode/500.gv-ob_kvcache-of-oracle-mode.md)               | 展示每台 OBServer 节点上的 KVCACHE 信息。                               |
| [V$OB_PARAMETERS](../300.performance-view-of-oracle-mode/4400.v-ob_parameters-of-oracle-mode.md)            | 展示本 OBServer 节点上的配置项信息。                                      |
| [V$SYSSTAT](../300.performance-view-of-oracle-mode/8600.gv-sysstat-of-oracle-mode.md)                  | 展示当前服务器上系统级别的统计事件信息。                                       |
...
| [V$OB_MEMSTORE_INFO](../300.performance-view-of-oracle-mode/8400.gv-ob_memstore_info-of-oracle-mode.md)      | 展示所有服务器上所有租户的所有分区的 MemTable 的详细信息。 |
| [V$OB_MEMORY](../300.performance-view-of-oracle-mode/1600.gv-memory-of-oracle-mode.md)                    | 展示租户级别的内存统计信息。                                         |
| [V$OB_MEMSTORE](../300.performance-view-of-oracle-mode/1800.gv-memstore-of-oracle-mode.md)                  | 展示当前服务器上所有租户的 MemTable 的内存使用状况。                        |
...
| [V$OB_PLAN_CACHE_PLAN_EXPLAIN](../300.performance-view-of-oracle-mode/2200.gv-plan_cache_plan_explain-of-oracle-mode.md)  | 展示缓存在当前 Server 的计划缓存中的物理执行计划。           |
...
| [V$OB_PLAN_CACHE_STAT](../300.performance-view-of-oracle-mode/2400.gv-plan_cache_stat-of-oracle-mode.md)          | 记录当前租户在所有 Server 上的每个计划缓存整体的状态。         |
...
| [V$OB_DTL_INTERM_RESULT_MONITOR](../300.performance-view-of-oracle-mode/9700.gv-ob_dtl_interm_result_monitor-of-oracle-mode.md)  | 展示 DTL 中间结果管理器的监控信息。                                        |
...
| [V$OB_PS_ITEM_INFO](../300.performance-view-of-oracle-mode/2500.gv-ps_item_info-of-oracle-mode.md)       | 给 Prepared Statement提供监控功能，包含 PS Cache 中所有 Prepared Statement 的基本信息。 |
| [V$OB_PS_STAT](../300.performance-view-of-oracle-mode/2600.gv-ps_stat-of-oracle-mode.md)            | 监控 PS Cache 的整体状态，包括命中率、内存占用、缓存的 Item 数目。                            |
...
| [V$OB_SQL_AUDIT](../300.performance-view-of-oracle-mode/3000.gv-sql_audit-of-oracle-mode.md)  | 展示当前 Server 的每一次 SQL 请求的来源、执行状态等统计信息。 |
...
| [V$SQL_WORKAREA](../300.performance-view-of-oracle-mode/3100.gv-sql_workarea-of-oracle-mode.md)                | 统计之前受 SQL 自动内存管理负责执行过的所有 Operator 的 Workarea 统计信息。   |
...
| [GV$OB_TRANSACTION_PARTICIPANTS](../300.performance-view-of-oracle-mode/1100.gv-ob_transaction_participants-of-oracle-mode.md)   | 展示所有 OBServer 节点上的事务参与者信息。                         |
...
| [V$OB_COMPACTION_PROGRESS](../300.performance-view-of-oracle-mode/300.gv-ob_compaction_progress-of-oracle-mode.md)         | 展示租户的 Server 级合并进度信息。                            |
...
| [V$OB_COMPACTION_DIAGNOSE_INFO](../300.performance-view-of-oracle-mode/200.gv-ob_compaction_diagnose_info-of-oracle-mode.md)    | 展示 COMPACTION 的诊断信息。                             |
| [V$OB_TABLET_COMPACTION_HISTORY](../300.performance-view-of-oracle-mode/900.gv-ob_tablet_compaction_history-of-oracle-mode.md)   | 展示 TABLET 级 COMPACTION 的历史信息。                    |
| [V$OB_TABLET_COMPACTION_PROGRESS](../300.performance-view-of-oracle-mode/1000.gv-ob_tablet_compaction_progress-of-oracle-mode.md)  | 展示 TABLET 级 COMPACTION 的进度信息。                    |
| [V$OB_TRANSACTION_PARTICIPANTS](../300.performance-view-of-oracle-mode/1100.gv-ob_transaction_participants-of-oracle-mode.md)    | 展示所有 OBServer 节点上的事务参与者信息。                         |
...
| [V$GLOBAL_TRANSACTION](../300.performance-view-of-oracle-mode/3600.gv-global_transaction-of-oracle-mode.md)             | 显示当前活跃的全局事务的信息。                                  |
