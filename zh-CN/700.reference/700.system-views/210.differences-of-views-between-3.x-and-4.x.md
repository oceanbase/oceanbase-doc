...
| **视图名** | **引入版本**| **描述** |
| ---------- | ---------- | -------- |
| V$OB_SS_SSTABLES           | V4.4.0 | 展示共享存储上的 SSTable 信息。 |
| <ul><li>GV\$OB_TABLET_LOCAL_CACHE </li><li>V\$OB_TABLET_LOCAL_CACHE</li></ul>                                                    | V4.4.0/V4.3.5 BP2 | 展示 Tablet 整体的缓存情况。  |
| <ul><li>GV\$OB_STORAGE_CACHE_TASKS </li><li>V\$OB_STORAGE_CACHE_TASKS </li></ul>                                                  | V4.4.0/V4.3.5 BP2 | 展示当前的缓存任务信息。  |
| <ul><li>oceanbase.CDB_OB_CS_REPLICA_STATS </li><li>oceanbase.DBA_OB_CS_REPLICA_STATS</li><li>DBA_OB_CS_REPLICA_STATS </li></ul>   | V4.4.0/V4.3.5 1 BP1 | 展示租户各个 OBServer 上 C 副本日志流中 Tablet 转换为列存的进度。 |
