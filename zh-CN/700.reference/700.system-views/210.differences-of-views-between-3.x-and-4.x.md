...
|oceanbase.DBA_OB_TABLE_STAT_STALE_INFO| V4.2.0 | 展示自上次收集统计信息以来每个表发生的 DML 操作次数，以及当前统计信息是否已过期|
...
| DBA_OB_TABLE_STAT_STALE_INFO| V4.2.0 | 展示自上次收集统计信息以来每个表发生的 DML 操作次数，以及当前统计信息是否已过期 |
