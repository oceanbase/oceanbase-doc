...
| NORM_IOPS                    | bigint(20)   | NO             | 当前的 IOPS（转换为 16 KB 读对应的值进行展示）<main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.4.x 版本，该字段从 V4.4.0 版本开始引入。</li><li>对于 V4.3.5 版本，该字段从 V4.3.5 BP1 版本开始引入。</li></ul></main>  |
