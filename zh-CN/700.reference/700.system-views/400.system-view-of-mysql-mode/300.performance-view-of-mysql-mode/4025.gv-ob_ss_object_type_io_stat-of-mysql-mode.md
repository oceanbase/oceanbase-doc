...
视图 `GV$OB_SS_OBJECT_TYPE_IO_STAT` 用于展示租户各节点上不同种类的 Object 文件的读、写或删除的使用量。
...
| OBJECT_TYPE     | varchar(128) | NO   | Object 文件的类型     |
...
| DELETE_CNT      | bigint(20)   | NO   | 文件删除的总次数     |
| DELETE_FAIL_CNT | bigint(20)   | NO   | 文件删除失败的总次数    |
| DELETE_IOPS     | bigint(20)   | NO   | 文件删除的 IOPS     |

## 查询示例

用户租户查看本租户在所有节点上不同种类的 Object 文件的读、写及删除的 IO 使用情况。
