...
| READ_BANDWIDTH          | bigint(20)   | NO   | IO 读的平均带宽速率，单位为 MB/s     |
| READ_BANDWIDTH_DISPLAY  | varchar(29)  | NO   | 使用 Human Readable 格式展示，例如转化为 10GB/s，10MB/s 类似的格式     |
| READ_DELAY_US           | bigint(20)   | NO   | IO 读的平均延时时间，单位为 us     |
| WRITE_BANDWIDTH         | bigint(20)   | NO   | IO 写的平均带宽，单位为 MB/s     |
| WRITE_BANDWIDTH_DISPLAY | varchar(29)  | NO   | 使用 Human Readable 格式展示，例如转化为 10GB/s，10MB/s 类似的格式     |
| WRITE_DELAY_US          | bigint(20)   | NO   | IO 写的平均延时时间，单位为 us     |
...
```shell
obclient(root@mysql001)[oceanbase]> SELECT * FROM oceanbase.GV$OB_SS_OBJECT_TYPE_IO_STAT LIMIT 10;
```
