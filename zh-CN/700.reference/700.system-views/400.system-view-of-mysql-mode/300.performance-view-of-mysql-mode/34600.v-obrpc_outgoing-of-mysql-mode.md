...
展示当前租户在当前 OBServer 节点上 RPC 的发送统计信息。
...
用户租户下，查看本租户在当前节点发送的 RPC 请求，展示前 10 条记录。
...
* 查看当前租户在所有节点发送的 PRC 统计信息：[GV$OB_RPC_OUTGOING](4100.gv-obrpc_outgoing-of-mysql-mode.md)

* 查看当前租户在当前节点收到的 RPC 的统计信息：[V$OB_RPC_INCOMING](34500.v-obrpc_incoming-of-mysql-mode.md)
