...
用于展示当前 OBServer 节点上当前用户各表持锁或请求锁的情况。
...
有关表锁的详细操作及介绍，参见 [锁表](../../../300.database-object-management/100.manage-object-of-mysql-mode/200.manage-tables-of-mysql-mode/900.lock-a-table-of-mysql-mode.md)。
