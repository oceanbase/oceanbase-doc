...
| DATA_DISK_SIZE   | bigint(20)   | YES        | 该字段值为 `NULL`，表示未定义。</li></ul> <main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.3.4 版本开始引入。</p></main>     |
...
| REPLICA_TYPE     | varchar(7)   | NO         | 副本类型，默认为 `FULL` <main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.5.x 版本，字段 <code>REPLICA_TYPE</code> 从 V4.5.0 版本开始引入。</li><li>对于 V4.4.x 版本，字段 <code>REPLICA_TYPE</code> 从 V4.4.0 BP1 版本开始引入。</li><li>对于 V4.2.5 版本，字段 <code>REPLICA_TYPE</code> 从 V4.2.5 BP7 版本开始引入。</li></ul></main>   |
