...
展示当前租户在所有节点上 Tablet 级 Compaction 的历史信息。
...
用户租户查询本租户在所有节点上 Tablet 级 Compaction 的历史信息，展示前 5 条记录。
...
* 查看当前节点上 Tablet 级的合并的详细历史信息：[V$OB_TABLET_COMPACTION_HISTORY](33800.v-ob_tablet_compaction_history-of-mysql-mode.md)
