...
展示本租户在当前 OBServer 节点收到的 RPC 请求的统计信息。
...
用户租户下，查看本租户在当前节点收到的 RPC 请求中，有哪些请求在队列中的等待时间大于 1s。
...
* 查看当前租户在所有节点收到的 RPC 的统计信息：[GV$OB_RPC_INCOMING](1900.gv-ob_obrpc_incoming-of-mysql-mode.md)

* 查看当前租户在当前节点发送的 PRC 统计信息：[V$OB_RPC_OUTGOING](32400.v-ob_obrpc_outgoing-of-mysql-mode.md)