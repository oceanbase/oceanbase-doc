...
| NETWORK_WAIT_TIME               | bigint(20) unsigned | YES  |  所有 Network 类事件的总时间，单位为微秒<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.2.1 版本，该字段从 V4.2.1 BP5 版本开始引入。</p></main>    |
...
*************************** 1. row ***************************
                    ...
                    SQL_EXEC_ID: 89243822
                       TRACE_ID: YB4XXXXXXXX-000XXXXXXXXXXXXX-0-0
                            SID: 1
                      CLIENT_IP: 0.0.0.0
                    CLIENT_PORT: 0
                      TENANT_ID: 1002
