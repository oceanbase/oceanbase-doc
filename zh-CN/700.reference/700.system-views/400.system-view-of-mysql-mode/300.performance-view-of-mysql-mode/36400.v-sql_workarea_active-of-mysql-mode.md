...
| ACTIVE_TIME      | bigint(20)   | NO             | Workarea 活跃时平均时间，单位为毫秒                             |
| WORK_AREA_SIZE   | bigint(20)   | NO             | 操作符使用 Workarea 的最大值，单位为字节                      |
| EXPECT_SIZE      | bigint(20)   | NO             | Workarea 期望的大小，单位为字节              |
| ACTUAL_MEM_USED  | bigint(20)   | NO             | 申请 workarea 的内存量，单位为字节           |
| MAX_MEM_USED     | bigint(20)   | NO             | 使用 Workarea 的最大内存使用量，单位为字节    |
