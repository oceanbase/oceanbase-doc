...
* 查看当前节点已完成的 Compaction 相关的统计信息：[V$OB_MERGE_INFO](32200.v-ob_merge_info-of-mysql-mode.md)
...
* 查看所有节点上 Tablet 级 Compaction 的历史信息：[GV$OB_TABLET_COMPACTION_HISTORY](4200.gv-ob_tablet_compaction_history-of-mysql-mode.md)
