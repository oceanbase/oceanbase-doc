...
视图 `GV$ACTIVE_SESSION_HISTORY` 展示本租户下所有 OBServer 节点的活跃会话历史记录。
...
* 查看本租户下所有 OBServer 节点的活跃会话历史记录：[GV$OB_ACTIVE_SESSION_HISTORY](800.gv-ob_active_session_history-of-mysql-mode.md)
