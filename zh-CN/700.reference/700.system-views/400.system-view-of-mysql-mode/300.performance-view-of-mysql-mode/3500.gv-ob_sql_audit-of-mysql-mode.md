...
| RET_CODE                | bigint(20)          | NO             | 执行结果返回码：<ul><li>0：表示没有错误，语句成功执行   </li><li> 其他返回码：表示 OceanBase 错误码。</li></ul><p>有关错误码的详细介绍，请参见 [错误码](../../../900.error-code/600.error-code-of-mysql-mode/100.use-error-information-of-mysql-mode.md)。</p>                             |
...
| BLOCKSCAN_ROW_CNT       | bigint(20)          | YES            | 对于 V4.4.2 版本：<ul><li>V4.4.2 BP1 之前版本：单边扫描的数据行数。 </li><li>V4.4.2 BP1 及之后版本：下压路径下打开的微块在 Range 范围内的总行数。</li></ul>|
