...
* 查看所有节点上所有分区的 MemTable 的详细信息：[GV$OB_MEMSTORE_INFO](1700.gv-ob_memstore_info-of-mysql-mode.md)

* 查看当前节点上租户的 MemTable 的内存使用状况：[V$OB_MEMSTORE](32000.v-ob_memstore-of-mysql-mode.md)