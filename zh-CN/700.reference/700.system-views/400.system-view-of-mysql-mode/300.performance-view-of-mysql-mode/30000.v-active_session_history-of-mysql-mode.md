...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <ul><li>该视图从 V4.2.2 版本开始更名为 <a href="30900.v-ob_active_session_history-of-mysql-mode.md">V$OB_ACTIVE_SESSION_HISTORY</a>。</li>
...
| EVENT_ID | bigint(20) | NO | 表示当前等待事件的 ID <main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.2 版本开始引入。</p></main>|
...
| IN_RPC_ENCODE               | varchar(1)          | NO   | 当前 SQL 正在进行的序列化操作<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.2.x 版本，该字段从 V4.2.5 版本开始引入。</p></main>    |
| IN_RPC_DECODE               | varchar(1)          | NO   | 当前 SQL 正在进行的反序列化操作<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.2.x 版本，该字段从 V4.2.5 版本开始引入。</p></main>     |
| IN_CONNECTION_MGR           | varchar(1)          | NO   | 当前 SQL 正在进行建链接操作<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.2.x 版本，该字段从 V4.2.5 版本开始引入。</p></main>     |
| PROGRAM | varchar(64) | NO | 当前采样点正在执行的程序名：<ul><li>后台线程：指线程名称，例如 `observer`、`WrTimer` 等  </li><li>前台线程：<ul><li>普通请求为 `user@client_ip (thread_name)`  </li><li>`inner_sql` 远程执行为 `INNER SQL REMOTE EXEC (thread_name)` </li><li>DAS 远程执行为 `DAS REMOTE EXEC (thread_name)` </li></ul> </li></ul><main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.2 版本开始引入。</p></main>|
| MODULE | varchar(64) | NO | 会话在采样时记录的 MODULE 值，通过 `DBMS_APPLICATION_INFO.SET_MODULE` 包设置。<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.3 版本开始可以设置。</p></main> |
...
| TM_DELTA_TIME | bigint(20) | NO | 计算 time model 的时间间隔，单位为微秒<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.2 版本开始引入。</p></main> |
| TM_DELTA_CPU_TIME | bigint(20) | NO | 过去 `TM_DELTA_TIME` 时间段内在 CPU 上花费的时间量<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.2 版本开始引入。</p></main> |
| TM_DELTA_DB_TIME | bigint(20) | NO | 过去 `TM_DELTA_TIME` 时间段内在数据库调用中花费的时间量<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.2 版本开始引入。</p></main> |
| TOP_LEVEL_SQL_ID | varchar(32) | NO | 顶层 SQL ID<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.2 版本开始引入。</p></main> |
...
| PLSQL_ENTRY_OBJECT_ID | bigint(20) | NO | 顶层 PL 的 OBJECT ID<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.2 版本开始引入。</p></main> |
| PLSQL_ENTRY_SUBPROGRAM_ID | bigint(20) | NO | 顶层 PL 的 Sub project ID<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.2 版本开始引入。</p></main> |
| PLSQL_ENTRY_SUBPROGRAM_NAME | varchar(32) | NO | 顶层 PL 的 Sub project name<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.2 版本开始引入。</p></main> |
| PLSQL_OBJECT_ID | bigint(20) | NO | 当前正在执行的 PL object ID<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.2 版本开始引入。</p></main> |
| PLSQL_SUBPROGRAM_ID | bigint(20) | NO | 当前正在执行的 PL subprogram ID<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.2 版本开始引入。</p></main> |
| PLSQL_SUBPROGRAM_NAME | varchar(32) | NO | 当前正在执行的 PL subprogram  name<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.2 版本开始引入。</p></main> |
...
| DELTA_READ_IO_REQUESTS      | bigint(20)          | NO  | 两次采样之间读的次数<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.2.x 版本，该字段从 V4.2.5 BP3 版本开始引入。</p></main>     |
| DELTA_READ_IO_BYTES         | bigint(20)          | NO  | 两次采样之间读的文件累计大小<main id="notice" type='explain'><h4>说明</h4> <p>对于 V4.2.x 版本，该字段从 V4.2.5 BP3 版本开始引入。</p></main>     |
| DELTA_WRITE_IO_REQUESTS     | bigint(20)          | NO  | 两次采样之间写的次数<main id="notice" type='explain'><h4>说明</h4> <p>对于 V4.2.x 版本，该字段从 V4.2.5 BP3 版本开始引入。</p></main>     |
| DELTA_WRITE_IO_BYTES        | bigint(20)          | NO  | 两次采样之间写的文件累计大小<main id="notice" type='explain'><h4>说明</h4> <p>对于 V4.2.x 版本，该字段从 V4.2.5 BP3 版本开始引入。</p></main>     |
