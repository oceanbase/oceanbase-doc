...
在 MySQL 租户中查询视图 `GV$OB_KV_CLIENT_INFO` 的语句为：

```shell
obclient [mysql]> SELECT * FROM oceanbase.GV$OB_KV_CLIENT_INFO;
```
...
* [V$OB_KV_CLIENT_INFO](37600.v-ob_kv_client_info-of-mysql-mode.md)
* [使用 OBKV-Table Java 客户端连接集群](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001516163)