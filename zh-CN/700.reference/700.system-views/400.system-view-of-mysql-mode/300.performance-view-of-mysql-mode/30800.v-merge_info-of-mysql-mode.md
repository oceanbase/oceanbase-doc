...
* 查看所有节点已经完成的 Compaction 相关的统计信息：[GV$OB_MERGE_INFO](700.gv-merge_info-of-mysql-mode.md)

* 查看当前节点上 Tablet 级 Compaction 的进度信息：[V$OB_TABLET_COMPACTION_PROGRESS](33900.v-ob_tablet_compaction_progress-of-mysql-mode.md)

* 查看当前节点上 Tablet 级 Compaction 的历史信息：[V$OB_TABLET_COMPACTION_HISTORY](33800.v-ob_tablet_compaction_history-of-mysql-mode.md)
