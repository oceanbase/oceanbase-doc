...
| MEMORY_USAGE     | bigint(20)        | YES         | 单条 SQL 语句当前占用的内存大小，单位为字节   <main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.4.x 版本，该字段从 V4.4.0 版本开始引入。</li><li>对于 V4.3.5 版本，该字段从 V4.3.5 BP2 版本开始引入。</li></ul></main>  |
