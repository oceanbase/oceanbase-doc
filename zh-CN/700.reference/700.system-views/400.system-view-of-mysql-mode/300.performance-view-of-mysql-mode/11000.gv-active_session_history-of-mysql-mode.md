...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <ul><li>该视图从 V4.0.0 版本开始引入。</li><li>该视图从 V4.2.2 版本开始更名为 <a href="17200.gv-ob_active_session_history-of-mysql-mode.md">GV$OB_ACTIVE_SESSION_HISTORY</a>。</li></ul>
</main>
...
*************************** 1. row ***************************
                   ...
                   SVR_PORT: 2882
                  SAMPLE_ID: 4701
                SAMPLE_TIME: 2024-08-05 14:26:45
                     CON_ID: 1002
                    USER_ID: 0
    ...
    IN_REMOTE_DAS_EXECUTION: N
             IN_FILTER_ROWS: N
                    PROGRAM: T1002_TxLoopWor
                     MODULE: NULL
                     ACTION: NULL
                  CLIENT_ID: NULL
                  BACKTRACE: NULL
              TM_DELTA_TIME: 351196
          TM_DELTA_CPU_TIME: 351196
           TM_DELTA_DB_TIME: 351196
