...
视图 `GV$ACTIVE_SESSION_HISTORY` 展示所有 OBServer 节点上的活跃会话历史记录。
...
| TABLET_ID               | bigint(20)   | YES  | 会话在采样时记录的 Tablet 的 ID<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.2.1 版本，该字段从 V4.2.1 BP10 版本开始引入。</p></main>      |
...
[V$ACTIVE_SESSION_HISTORY](11100.v-active_session_history-of-mysql-mode.md)
