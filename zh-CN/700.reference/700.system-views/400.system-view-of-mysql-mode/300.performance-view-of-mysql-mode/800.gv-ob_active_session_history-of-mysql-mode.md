...
视图 `GV$OB_ACTIVE_SESSION_HISTORY` 用于展示本租户下所有 OBServer 节点的活跃会话历史记录：
...
查看本租户所在的所有 OBServer 节点的活跃会话历史记录。
...
* 查看本租户下当前 OBServer 节点的活跃会话历史记录：[V$OB_ACTIVE_SESSION_HISTORY](30900.v-ob_active_session_history-of-mysql-mode.md)
* 有关活跃会话历史记录的更多信息，请参见 [ASH 报告](../../../../700.reference/1000.performance-tuning-guide/400.performance-diagnosis/500.ash-report-diagnosis/100.ash-introduction.md)
