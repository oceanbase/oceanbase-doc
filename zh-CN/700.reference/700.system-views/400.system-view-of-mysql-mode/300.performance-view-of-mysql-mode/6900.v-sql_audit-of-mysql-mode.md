...
视图 `V$OB_SQL_AUDIT` 展示当前 OBServer 节点的每一次 SQL 请求的来源、执行状态等统计信息。该视图是按照租户拆分的，除了系统租户，其他租户不能跨租户查询。
...
| NETWORK_WAIT_TIME               | bigint(20) unsigned | NO  |  所有 Network 类事件的总时间，单位为微秒<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 BP5 版本开始引入。</p></main>    |
...
*************************** 1. row ***************************
            ...
            EFFECTIVE_TENANT_ID: 1002
                 ...
                 USER_CLIENT_IP: 0.0.0.0
                          DB_ID: 201001
                        DB_NAME: oceanbase
                         SQL_ID: 18AB15790D884E6A4823C892456E8650
                      QUERY_SQL: SELECT arbitration_member FROM __all_virtual_log_stat WHERE tenant_id = 1002 AND ls_id = 1 AND role = 'LEADER'
                        PLAN_ID: 898
                  AFFECTED_ROWS: 0
                    RETURN_ROWS: 1
                  PARTITION_CNT: 1
