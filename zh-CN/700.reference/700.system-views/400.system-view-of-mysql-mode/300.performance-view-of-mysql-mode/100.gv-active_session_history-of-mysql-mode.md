...
<main id="notice" type='explain'>
  <h4>说明</h4>
    <ul><li>对于 V4.3.x 版本，该视图从 V4.3.5 版本开始更名为 <a href="400.gv-ob_active_session_history-of-mysql-mode.md">GV$OB_ACTIVE_SESSION_HISTORY</a>；对于 V4.2.x 版本，该视图从 V4.2.2 版本开始更名为 <a href="400.gv-ob_active_session_history-of-mysql-mode.md">GV$OB_ACTIVE_SESSION_HISTORY</a>。</li>
...
| BLOCKING_SESSION_ID         | bigint(20)                            | NO  | 如果当前会话被阻塞，显示阻塞该会话的会话 ID，目前仅在锁冲突场景生效，展示持有锁的会话 ID<main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入，但目前为预留字段，默认值为 NULL。</li> <li>对于 V4.2.x 版本，该字段从 V4.2.3 版本开始引入。</li></ul></main>      |
...
| WEIGHT                      | bigint(20)          | NO   | 该条 WR 记录所对应时间范围内，相同租户相同 Action 出现的次数。<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.4.x 版本，该字段从 V4.4.2 版本开始引入。</p></main>     |
| IS_WR_WEIGHT_SAMPLE         | varchar(1)          | NO   | 是否为队列积压等待事件的“聚合”列。<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.4.x 版本，该字段从 V4.4.2 版本开始引入。</p></main>     |
