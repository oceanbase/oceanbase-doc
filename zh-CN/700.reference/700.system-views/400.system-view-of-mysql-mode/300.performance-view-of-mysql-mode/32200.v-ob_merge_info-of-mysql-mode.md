...
* 查看所有节点已经完成的 Compaction 相关的统计信息：[GV$OB_MERGE_INFO](1800.gv-ob_merge_info-of-mysql-mode.md)

* 查看当前节点上 Tablet 级 Compaction 的进度信息：[V$OB_TABLET_COMPACTION_PROGRESS](34900.v-ob_tablet_compaction_progress-of-mysql-mode.md)

* 查看当前节点上 Tablet 级 Compaction 的历史信息：[V$OB_TABLET_COMPACTION_HISTORY](34800.v-ob_tablet_compaction_history-of-mysql-mode.md)

* 查看各个 Zone 的合并信息：[DBA_OB_ZONE_MAJOR_COMPACTION](../200.dictionary-view-of-mysql-mode/13000.o-dba_ob_zone_major_compaction-of-mysql-mode.md)

* 查看合并全局信息：[DBA_OB_MAJOR_COMPACTION](../200.dictionary-view-of-mysql-mode/10300.o-dba_ob_major_compaction-of-mysql-mode.md)
