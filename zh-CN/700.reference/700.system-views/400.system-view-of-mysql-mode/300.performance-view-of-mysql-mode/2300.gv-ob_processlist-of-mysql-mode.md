...
| TOTAL_CPU_TIME    | bigint(21)          | NO   | 当前命令执行 CPU 使用时间，单位为秒<ul><li>在 V4.3.x 版本中，该字段从 V4.3.1 版本开始引入。</li><li>在 V4.2.x 版本中，该字段从 V4.2.5、V4.2.1 BP5 版本开始引入。</li></ul>     |
| TOP_INFO          | varchar(262143)     | YES  | 展示执行中 SQL 所在的顶层 PL 语句信息<ul><li>在 V4.3.x 版本中，该字段从 V4.3.3 版本开始引入。</li><li>在 V4.2.x 版本中，该字段从 V4.2.5、V4.2.1 BP9 版本开始引入。</li></ul>     |
