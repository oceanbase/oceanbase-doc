...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <ul><li>该视图从 V4.0.0 版本开始视图名由 <code>GV$MEMORY</code> 调整为<code> GV$OB_MEMORY</code>，V4.0.0 及之后版本需要使用新视图名 <code>GV$OB_MEMORY</code> 来查询，使用原视图名 <code>GV$MEMORY</code> 查询将会报错。</li><ul>
</main>
