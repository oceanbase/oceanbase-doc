...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>该视图从 V4.0.0 版本开始视图名由 <code>GV$MEMORY</code> 调整为<code> GV$OB_MEMORY</code>，V4.0.0 及之后版本需要使用新视图名 <code>GV$OB_MEMORY</code> 来查询，使用原视图名 <code>GV$MEMORY</code> 查询将会报错。</p>
</main>

## 功能描述

视图 `GV$OB_MEMORY` 展示当前租户在所有节点上的内存统计信息。
...
用户租户查看本租户在所有节点上的内存统计信息，展示前 10 条记录。
