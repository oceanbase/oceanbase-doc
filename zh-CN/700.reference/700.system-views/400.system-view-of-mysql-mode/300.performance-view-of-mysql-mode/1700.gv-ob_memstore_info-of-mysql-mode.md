...
* 查看当前节点上所有分区的 MemTable 的详细信息：[V$OB_MEMSTORE_INFO](32100.v-ob_memstore_info-of-mysql-mode.md)

* 查看所有节点上租户的 MemTable 的内存使用状况：[GV$OB_MEMSTORE](1600.gv-ob_memstore-of-mysql-mode.md)