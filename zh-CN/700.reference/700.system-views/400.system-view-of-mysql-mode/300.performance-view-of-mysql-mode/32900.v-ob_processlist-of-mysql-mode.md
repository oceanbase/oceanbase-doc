...
| PROXY_USER        | varchar(128)        | NO  |<ul><li>代理用户登录场景，返回代理用户的名称。</li><li>非代理用户登录场景，显示为空。</li></ul><main id="notice" type='explain'><h4>说明</h4><ul><li>在 V4.3.x 版本中，该字段从 V4.3.2 版本开始引入。</li><li>在 V4.2.x 版本中，该字段从 V4.2.3 版本开始引入。</li></ul></main> |
...
| MEMORY_USAGE     | bigint(20)        | NO          | 单条 SQL 语句当前占用的内存大小，单位为字节  <main id="notice" type='explain'><h4>说明</h4><p>对于 V4.4.x 版本，该字段从 V4.4.0 版本开始引入，且当前暂未生效，字段值默认为 <code>NULL</code。</p></main>  |
