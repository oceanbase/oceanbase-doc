...
* 查看当前节点已完成的 Compaction 相关的统计信息：[V$OB_MERGE_INFO](30800.v-merge_info-of-mysql-mode.md)

* 查看所有节点上 Tablet 级 Compaction 的进度信息：[GV$OB_TABLET_COMPACTION_PROGRESS](3500.gv-ob_tablet_compaction_progress-of-mysql-mode.md)

* 查看所有节点上 Tablet 级 Compaction 的历史信息：[GV$OB_TABLET_COMPACTION_HISTORY](3400.gv-ob_tablet_compaction_history-of-mysql-mode.md)

* 查看各个 Zone 的合并信息：[DBA_OB_ZONE_MAJOR_COMPACTION](../200.dictionary-view-of-mysql-mode/12700.o-dba_ob_zone_major_compaction-of-mysql-mode.md)

* 查看合并全局信息：[DBA_OB_MAJOR_COMPACTION](../200.dictionary-view-of-mysql-mode/9900.o-dba_ob_major_compaction-of-mysql-mode.md)
