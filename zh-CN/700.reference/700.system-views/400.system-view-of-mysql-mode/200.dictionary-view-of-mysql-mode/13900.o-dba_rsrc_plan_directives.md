...
* 查看所有资源管理计划：[DBA_RSRC_PLANS](14000.o-dba_rsrc_plans-mysql.md)

* 查看当前活跃租户的资源管理计划：[V$RSRC_PLAN](../300.performance-view-of-mysql-mode/33500.v-ob_rsrc_plan-mysql.md)

* 查看租户在 Resource Manager 中的各类资源配置参数：[DBA_OB_RSRC_DIRECTIVES](11020.o-dba_ob_rsrc_directives-of-mysql-mode.md)