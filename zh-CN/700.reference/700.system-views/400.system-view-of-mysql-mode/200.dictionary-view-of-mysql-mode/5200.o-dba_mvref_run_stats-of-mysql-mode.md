...
|slug|o-dba_mvref_run_stats-mysql-mode|
...
| PURGE_OPTION | bigint(20) | YES | API 指定的 PURGE_OPTION 参数 |
| PARALLELISM | bigint(20) | NO | API 指定的 PARALLELISM 参数 |
| HEAP_SIZE | bigint(20) | YES | API 指定的 HEAP_SIZE 参数 |
...
| RESULT                   | bigint(20)          | YES  | 刷新结果（错误码）。 <main id="notice" type='explain'><h4>说明</h4><p><ul><li>对于 V5.x 版本，该字段从 V5.0.1 版本开始引入。</li><li>对于 V4.4.2 版本，该字段从 V4.4.2 BP2 版本开始引入。</li></ul></p></main>|
| START_TIME | datetime | NO | 刷新运行的开始时间 |
| END_TIME | datetime | NO | 刷新运行的结束时间 |
| ELAPSED_TIME | bigint(20) | NO | 刷新运行的时间长度。 <ul><li>V4.4.2 BP2 和 V5.0.1 之前版本单位为秒。</li><li>对于 V4.4.2 版本，从 V4.4.2 BP2 版本开始单位为微妙。</li><li>对于 V5.x 版本，从 V5.0.1 版本开始单位为微妙。</li></ul>|
| LOG_SETUP_TIME | bigint(1) | NO | 物化视图的日志设置时间，单位为秒<main id="notice" type='explain'> <h4>说明</h4><p>该字段仅兼容，且值默认为 0。</p></main> |
| LOG_PURGE_TIME | bigint(20) | YES | 物化视图的日志清除时间。 <ul><li>V4.4.2 BP2 和 V5.0.1 之前版本单位为秒。</li><li>对于 V4.4.2 版本，从 V4.4.2 BP2 版本开始单位为微妙。</li><li>对于 V5.x 版本，从 V5.0.1 版本开始单位为微妙。</li></ul>|
...
| MVIEW_ID                 | bigint(20)          | YES  | 表示物化视图 ID。 <main id="notice" type='explain'><h4>说明</h4><p><ul><li>对于 V5.x 版本，该字段从 V5.0.1 版本开始引入。</li><li>对于 V4.4.2 版本，该字段从 V4.4.2 BP2 版本开始引入。</li></ul></p></main>|
| MVIEW_NAME               | varchar(128)        | NO   | 表示物化视图名称。 <main id="notice" type='explain'><h4>说明</h4><p><ul><li>对于 V5.x 版本，该字段从 V5.0.1 版本开始引入。</li><li>对于 V4.4.2 版本，该字段从 V4.4.2 BP2 版本开始引入。</li></ul></p></main>|
| DATA_TARGET_SCN          | bigint(20) unsigned | YES  | 表示目标数据同步 SCN。 <main id="notice" type='explain'><h4>说明</h4><p><ul><li>对于 V5.x 版本，该字段从 V5.0.1 版本开始引入。</li><li>对于 V4.4.2 版本，该字段从 V4.4.2 BP2 版本开始引入。</li></ul></p></main>|
| TRACE_ID                 | varchar(64)         | YES  | 表示刷新任务 Trace 标识。 <main id="notice" type='explain'><h4>说明</h4><p><ul><li>对于 V5.x 版本，该字段从 V5.0.1 版本开始引入。</li><li>对于 V4.4.2 版本，该字段从 V4.4.2 BP2 版本开始引入。</li></ul></p></main>|
