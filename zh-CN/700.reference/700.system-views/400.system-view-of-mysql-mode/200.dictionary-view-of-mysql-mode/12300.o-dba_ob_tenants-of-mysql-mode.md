...
| FLASHBACK_LOG_SCN          | bigint(20) unsigned | NO   | 租户最近一次执行日志裁剪的位点。在 Failover 后，支持通过备租户日志裁剪到指定位点的运维命令，将原主租户的备租户接入新主租户。<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.4.1 版本开始引入。</p></main>   |
