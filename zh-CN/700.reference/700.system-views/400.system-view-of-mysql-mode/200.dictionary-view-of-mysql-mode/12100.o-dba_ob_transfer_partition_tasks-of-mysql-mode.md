...
|slug|o-dba_ob_transfer_partition_tasks-of-mysql-mode|
...
* 查看本租户下已执行的 Transfer Partition 任务的历史：[DBA_OB_TRANSFER_PARTITION_TASK_HISTORY](12200.o-dba_ob_transfer_partition_tasks_history-of-mysql-mode.md)
