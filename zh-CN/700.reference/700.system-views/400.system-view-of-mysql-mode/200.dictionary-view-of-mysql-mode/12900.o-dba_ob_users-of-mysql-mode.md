...
| OLD_PASSWORD               | varchar(128)  | NO   | 旧密码的哈希值（密文），在双密码功能开启或密码轮换期间时有效。 <main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.6.1 版本开始引入。</p></main>   |
| OLD_PASSWORD_START_TIME    | bigint(20)    | NO   | 旧密码生效的时间点，值为 `-1` 时表示没有可用的旧密码。 <main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.6.1 版本开始引入。</p></main>     |
