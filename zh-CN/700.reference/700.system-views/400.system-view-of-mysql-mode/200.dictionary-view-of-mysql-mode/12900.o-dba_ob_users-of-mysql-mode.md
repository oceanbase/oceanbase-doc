...
| PLUGIN                    | varchar(64)   | NO   |  记录密码 HASH 计算使用的 plugin 名称，目前只允许三种设置：<ul><li>空串（同 <code>mysql_native_password</code>）</li><li><code>ob_native_password</code>（Oracle 模式下的 <code>mysql_native_password</code>）</li><li><code>mysql_native_password</code></li><li><code>caching_sha2_password</code></li></ul>   |
