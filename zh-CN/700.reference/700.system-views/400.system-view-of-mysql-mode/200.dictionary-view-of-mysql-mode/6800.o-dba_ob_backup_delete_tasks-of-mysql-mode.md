...
| TOTAL_TASK_COUNT | bigint(20) | YES | 子任务数目<ul><li>在 SN 模式下，表示所有 ls_task 的数目。</li><li>在 SS 模式下，对于日志归档piece，表示所有 ls_task 的数目；对于数据备份 set，表示所有宏块级别的 macro_task 的个数。</li></ul> |
| FINISH_TASK_COUNT | bigint(20) | YES | 成功的子任务数目 <ul><li>在 SN 模式下，表示已完成的 ls_task 的数目。</li><li>。在 SS 模式下，对于日志归档 piece，表示已完成的 ls_task 的数目；对于数据备份 set，表示已经完成的 macro_task 的个数。</li></ul> |
