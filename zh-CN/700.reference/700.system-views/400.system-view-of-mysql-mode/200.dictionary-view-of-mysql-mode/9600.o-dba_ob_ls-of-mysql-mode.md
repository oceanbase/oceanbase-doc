...
| UNIT_GROUP_ID | bigint(20)          | NO   | Unit 组 ID，对于系统日志流（1 号日志流）和广播日志流，该字段显示为 0，表示不属于任何 Unit 组 |
| LS_GROUP_ID   | bigint(20)          | NO   | 日志流组 ID，对于系统日志流（1 号日志流）和广播日志流，该字段显示为 0，表示不属于任何日志流组 |
