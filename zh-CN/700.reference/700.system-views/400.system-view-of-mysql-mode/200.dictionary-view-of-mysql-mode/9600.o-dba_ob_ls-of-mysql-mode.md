...
| UNIT_GROUP_ID | bigint(20)          | NO | Unit 组 ID <main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.4.x 版本，该字段从 V4.4.2 版本开始，该字段的值始终为 0。</li><li>对于 V4.2.5 版本，该字段从 V4.2.5 BP5 版本开始，该字段的值始终为 0。</li></ul></main>  |
...
| UNIT_LIST     | varchar(1216)       | NO   | 用户日志流分布的 Unit 列表，系统日志流和广播日志流在不指定具体位置时为空。 <main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.4.x 版本，该字段从 V4.4.2 版本开始引入。</li> <li>对于 V4.2.5 版本，该字段从 V4.2.5 BP5 版本开始引入。</li></ul></main>  | 
