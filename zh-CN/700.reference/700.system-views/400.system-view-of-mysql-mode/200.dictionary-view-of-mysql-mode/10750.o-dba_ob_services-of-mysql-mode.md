...
* 查看所有租户下所有的 `SERVICE_NAME` 的信息：[CDB_OB_SERVICES](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/10250.o-cdb_ob_services-of-sys-tenant.md)

* 有关 `SERVICE_NAME` 相关的操作，参见 [管理服务](../../../../600.manage/200.tenant-management/600.common-tenant-operations/1700.manage-service/100.create-service.md) 章节。