...
| NOTES | varchar(80) | NO | 描述统计信息的一些附加属性：<ul><li>INCREMENTAL：表示该列有概要</li><li>INCREMENTAL(HLL)：表示该列具有概要，并且概要采用 hyperloglog 格式</li><li>INCREMENTAL(SAMPLING)：表示该列具有概要，并且概要采用自适应采样格式<br>此列可用于确定自适应采样格式的概要是否已完全淘汰并正确清除</li></ul> |
...
* 查看 Subpartition 级的列统计信息：[DBA_SUBPART_COL_STATISTICS](14400.o-dba_subpart_col_statistics-of-mysql-mode.md)
...
* 查看 Subpartition 级的直方图统计信息：[DBA_SUBPART_HISTOGRAMS](14500.o-dba_subpart_histograms-of-mysql-mode.md)
