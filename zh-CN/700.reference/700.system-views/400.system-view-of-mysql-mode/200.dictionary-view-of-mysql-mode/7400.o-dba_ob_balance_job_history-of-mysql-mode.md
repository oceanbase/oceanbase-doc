...
| MAX_END_TIME            | timestamp(6) | YES | 负载均衡任务的最大结束时间 负载均衡任务的最大结束时间 <main id="notice" type='explain'><h4>说明</h4><p>对于 V4.2.x 版本，该字段从 V4.2.4 版本开始引入。对于 V4.3.x 版本，该视图从 V4.3.4 版本开始引入。</p></main>   |
