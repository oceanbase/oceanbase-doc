...
* 查看租户自身备份 Job 任务的历史记录：[DBA_OB_BACKUP_JOB_HISTORY](6900.o-dba_ob_backup_job_history-of-mysql-mode.md)

* 查看租户自身的备份 Job 任务：[DBA_OB_BACKUP_JOBS](7000.o-dba_ob_backup_jobs-of-mysql-mode.md)

* 查看租户自身的备份 Task 任务的执行进度：[DBA_OB_BACKUP_TASKS](7600.o-dba_ob_backup_tasks-of-mysql-mode.md)
