...
| plugin                 | varchar(1024) | NO             | 记录密码 HASH 计算使用的 plugin 名称。目前仅允许以下取值：<ul><li>空串（与 <code>mysql_native_password</code> 等价）</li><li><code>mysql_native_password</code></li><li><code>caching_sha2_password</code></li></ul> |
