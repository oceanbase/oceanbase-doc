...
| plugin                 | varchar(1024) | NO             | 记录密码 HASH 计算使用的 plugin 名称，目前支持 <code>mysql_native_password</code> 和 <code>caching_sha2_password</code>。<main id="notice" type='explain'><h4>说明</h4><p><code>caching_sha2_password</code> 取值从 V4.6.1 版本开始引入。</p></main> |
