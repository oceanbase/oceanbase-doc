...
视图 `oceanbase.DBA_WR_ACTIVE_SESSION_HISTORY` 展示本租户持久化后的 ASH 数据。
...
| DELTA_READ_IO_REQUESTS      | bigint(20)          | YES  | 两次采样之间读的次数<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.2.x 版本，该字段从 V4.2.5 BP3 版本开始引入。</p></main>     |
| DELTA_READ_IO_BYTES         | bigint(20)          | YES  | 两次采样之间读的文件累计大小<main id="notice" type='explain'><h4>说明</h4> <p>对于 V4.2.x 版本，该字段从 V4.2.5 BP3 版本开始引入。</p></main>     |
| DELTA_WRITE_IO_REQUESTS     | bigint(20)          | YES  | 两次采样之间写的次数<main id="notice" type='explain'><h4>说明</h4> <p>对于 V4.2.x 版本，该字段从 V4.2.5 BP3 版本开始引入。</p></main>     |
| DELTA_WRITE_IO_BYTES        | bigint(20)          | YES  | 两次采样之间写的文件累计大小<main id="notice" type='explain'><h4>说明</h4> <p>对于 V4.2.x 版本，该字段从 V4.2.5 BP3 版本开始引入。</p></main>     |
