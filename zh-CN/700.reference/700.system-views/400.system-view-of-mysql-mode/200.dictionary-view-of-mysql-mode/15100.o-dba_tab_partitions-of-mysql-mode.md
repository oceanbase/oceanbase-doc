...
* 查看所有租户的分区表的一级分区信息：[CDB_TAB_PARTITIONS](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/12900.o-cdb_tab_partitions-of-sys-tenant.md)

* 查看本租户的分区表的二级分区详细信息：[DBA_TAB_SUBPARTITIONS](15400.o-dba_tab_subpartitions-of-mysql-mode.md)
