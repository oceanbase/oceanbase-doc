...
| --- | --- | --- | --- |
| POLICY_NAME | varchar(256) | NO | 清理策略名：<ul><li>`default`：表示自动清理租户当前 `DATA_BACKUP_DEST` 以及 `LOG_ARCHIVE_DEST` 参数中的备份。</li> <li>`log_only`：表示自动清理租户当前 `LOG_ARCHIVE_DEST` 参数中设置的归档路径中的日志。</li></ul> |
