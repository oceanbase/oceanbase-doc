...
| HIGH_VALUE            | varchar(4096) | NO         | 该字段的值为 `NULL`                        |
| HIGH_VALUE_LENGTH     | bigint(20)    | NO         | 该字段的值为 `NULL`                    |
| PARTITION_POSITION    | bigint(20) unsigned  | NO  | 该字段的值为 `NULL`    |
| SUBPARTITION_POSITION | bigint(20) unsigned  | NO  | 该字段的值为 `NULL`         |
