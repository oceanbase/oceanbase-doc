...
| ROUTE_MISS_TOTAL              | bigint(20)          | NO   |   从 OBServer 启动开始，没有命中请求分区的总次数<ul><li>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</li> <li>对于 V4.2.x 版本，该字段从 V4.2.2 版本开始引入。</li></ul>   |
| ROUTE_MISS_DELTA              | bigint(20)          | NO   |   从上次 WR 快照采集开始，没有命中请求分区的次数<ul><li>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</li> <li>对于 V4.2.x 版本，该字段从 V4.2.2 版本开始引入。</li></ul>   |
| FIRST_LOAD_TIME               | timestamp(6)        | YES  |   计划生成时间<ul><li>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</li> <li>对于 V4.2.x 版本，该字段从 V4.2.5 版本开始引入。</li></ul>   |
| PLAN_CACHE_HIT_TOTAL          | bigint(20)          | NO   |   从 OBServer 启动开始，命中 Plan Cache 的总次数<ul><li>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</li> <li>对于 V4.2.x 版本，该字段从 V4.2.5 版本开始引入。</li></ul>   |
| PLAN_CACHE_HIT_DELTA          | bigint(20)          | NO   |   从上次 WR 快照采集开始，命中 Plan Cache 的次数<ul><li>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</li> <li>对于 V4.2.x 版本，该字段从 V4.2.5 版本开始引入。</li></ul>  |
