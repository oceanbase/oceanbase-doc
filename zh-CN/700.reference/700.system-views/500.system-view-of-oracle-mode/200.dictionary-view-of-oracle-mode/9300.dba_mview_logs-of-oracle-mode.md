...
| MASTER | VARCHAR2(128) | NO | 表示物化视图日志所属的主表名称 |
...
| LAST_PURGE_METHOD  | VARCHAR2(16)  | NO   | 上一次清除物化视图日志任务的方式，取值如下：<ul><li>SQL </li><li>COMPACTION</li></ul> 如果没有执行过清除物化视图日志任务，显示 NULL。 <main id="notice" type='explain'><h4>说明</h4><p>对于 OceanBase 数据库 V4.6.x 版本，该字段从 V4.6.0 版本开始引入。</p></main>|
