...
展示当前租户中可用的所有函数和过程，以及它们的相关属性。其列与 `ALL_PROCEDURES` 中的列相同。
...
查看本租户可用的所有函数和过程，以及它们的相关属性，展示前 10 条记录。
...
* 查看当前用户可访问的所有函数和存储过程：[ALL_PROCEDURES](3100.all_procedures-of-oracle-mode.md)

* 查看当前用户拥有的所有函数和存储过程：[USER_PROCEDURES](27200.user_procedures-of-oracle-mode.md)
