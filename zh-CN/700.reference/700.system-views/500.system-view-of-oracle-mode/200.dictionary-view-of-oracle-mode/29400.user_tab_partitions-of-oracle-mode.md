...
* 查看当前用户可访问的分区表的一级分区信息：[ALL_TAB_PARTITIONS](5000.all_tab_partitions-of-oracle-mode.md)

* 查看当前用户所拥有的分区表的二级分区详细信息：[USER_TAB_SUBPARTITIONS](29800.user_tab_subpartitions-of-oracle-mode.md)
