...
* 如果需要查询所有 PL/SQL 记录类型和表类型的属性，可以查询 [ALL_PLSQL_TYPE_ATTRS](2770.all-plsql-type-attrs-oracle-mode.md)。
* 如果需要查询 package 中定义的 record type 总体信息，可以查询 [DBA_PLSQL_TYPE_ATTRS](16370.dba-plsql-type-attrs-of-oracle-mode.md)。