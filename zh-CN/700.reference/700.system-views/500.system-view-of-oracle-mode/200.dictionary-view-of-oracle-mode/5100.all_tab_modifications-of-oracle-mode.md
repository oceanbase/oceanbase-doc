...
* 查看当前租户下所有表自上次统计信息收集后的修改信息：[DBA_TAB_MODIFICATIONS](21200.dba_tab_modifications-of-oracle-mode.md)

* 查看当前用户拥有的所有表自上次统计信息收集后的修改信息：[USER_TAB_MODIFICATIONS](30800.user_tab_modifications-of-oracle-mode.md)
