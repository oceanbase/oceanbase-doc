...
| SOURCE_REPLICA_SVR_IP  | VARCHAR2(46)   | YES                | 源端副本所在机器的 IP 地址。<main id="notice" type='explain'><h4>说明</h4><p>对于删除副本、修改法定副本数等任务，该字段无效，展示为 NULL。</p></main>|
| SOURCE_REPLICA_SVR_PORT| NUMBER(38)     |YES                 | 源端副本所在机器的端口号。<main id="notice" type='explain'><h4>说明</h4><p>对于删除副本、修改法定副本数等任务，该字段无效，展示为 0。</p></main>|
| SOURCE_PAXOS_REPLICA_NUMBER | NUMBER(38)| YES                | 日志流原法定 Paxos 副本数量 |
| SOURCE_REPLICA_TYPE    | VARCHAR2(16)   | YES                | 源端副本类型。<main id="notice" type='explain'><h4>说明</h4><p>对于删除副本、修改法定副本数等任务，该字段无效，展示为 NULL。</p></main> |
| DATA_SOURCE_SVR_IP     | VARCHAR2(46)   | YES                | 数据源 IP <main id="notice" type='explain'><h4>说明</h4><p>对于 V4.2.1 版本，该字段从 V4.2.1 BP8 版本开始引入。</p></main>    |
| DATA_SOURCE_SVR_PORT   | NUMBER(38)     | YES                | 数据源 PORT <main id="notice" type='explain'><h4>说明</h4><p>对于 V4.2.1 版本，该字段从 V4.2.1 BP8 版本开始引入。</p></main>     |
| IS_MANUAL              | CHAR(6)        | NO                 | 容灾任务来源，可取值：<ul><li>`TRUE`：表示手动运维命令触发的容灾任务</li><li>`FALSE`：默认值，表示 RS 层容灾自动生成的容灾任务</li></ul>  <main id="notice" type='explain'><h4>说明</h4><p>对于 V4.2.1 版本，该字段从 V4.2.1 BP8 版本开始引入。</p></main>   |
