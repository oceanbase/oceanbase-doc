...
| GLOBAL_STATS   | VARCHAR2(3)   | YES            | <ul><li>`YES`：表示统计信息是直接收集的 </li><li> `NO`：表示统计信息是通过二级分区统计信息推导出的或未收集统计信息 </li></ul>   |
...
查看当前用户拥有的分区表中，表 `T_SUBPART` 的一级分区的列统计信息和直方图信息。
...
* 查看本租户下所有分区表中一级分区的列统计信息：[DBA_PART_COL_STATISTICS](16300.dba_part_col_statistics-of-oracle-mode.md)
