...
| ATTR_TYPE_NAME     | VARCHAR2(324) | NO             | 属性的数据类型名                  |
...
* 查看当前租户下的所有用户自定义类型的属性信息：[DBA_TYPE_ATTRS](21400.dba_type_attrs-of-oracle-mode.md)

* 查看当前用户拥有的所有自定义类型的属性信息：[USER_TYPE_ATTRS](30300.user_type_attrs-of-oracle-mode.md)