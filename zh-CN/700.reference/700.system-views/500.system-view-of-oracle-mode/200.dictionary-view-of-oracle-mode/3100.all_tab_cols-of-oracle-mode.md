...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <ul>
  <li>从 V4.2.1 BP7 版本开始，该视图的查询结果中不再展示索引表相关信息。</li>
  <li>该视图从 V2.2.77 版本开始引入。</li>
  </ul>
</main>
...
3. 查询表 `TBL2` 的列信息。
   ...
   ```shell
   obclient [SYS]> SELECT TABLE_NAME, COLUMN_NAME, DATA_TYPE, DATA_DEFAULT FROM SYS.ALL_TAB_COLS WHERE TABLE_NAME LIKE '%TBL2%';
   ```
