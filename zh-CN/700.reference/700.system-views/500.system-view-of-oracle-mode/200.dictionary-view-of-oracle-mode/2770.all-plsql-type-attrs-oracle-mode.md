...
`ALL_PLSQL_TYPE_ATTRS` 用于展示当前用户可访问的 package 中定义的 record type 总体信息。
...
查看当前用户可访问的 package 中定义的 record type 总体信息。
...
* 查看当前当前租户内所有 package 中定义的记录类型信息：[DBA_PLSQL_TYPE_ATTRS](16370.dba-plsql-type-attrs-of-oracle-mode.md)
