...
查看本租户下当前正在处理的 Transfer Partition 任务。
...
* 查看本租户下已执行的 Transfer Partition 任务的历史：[DBA_OB_TRANSFER_PARTITION_TASK_HISTORY](15600.dba_ob_transfer_partition_tasks_history-of-oracle-mode.md)
