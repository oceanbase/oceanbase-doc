...
| GLOBAL_STATS      | VARCHAR2(3)   | NO            | <ul><li>`YES`：表示统计信息已收集 </li><li> `NO`：表示统计信息未收集</li></ul>    |
...
* 查看当前用户可访问的分区表的二级分区的列统计信息：[ALL_SUBPART_COL_STATISTICS](3900.all_subpart_col_statistics-of-oracle-mode.md)
