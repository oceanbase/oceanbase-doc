...
| DATA_TYPE            | VARCHAR2(128) | NO             | 列的数据类型                                   |
...
* 查看当前用户可访问的所有表或视图的列：[ALL_TAB_COLUMNS](4600.all_tab_columns-of-oracle-mode.md)

* 查看当前租户下的所有表或视图的列：[DBA_TAB_COLUMNS](20100.dba_tab_columns-of-oracle-mode.md)