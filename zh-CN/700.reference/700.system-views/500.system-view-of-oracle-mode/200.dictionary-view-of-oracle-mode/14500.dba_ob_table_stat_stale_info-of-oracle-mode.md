...
展示自上次收集统计信息以来每个表发生的 DML 操作次数，以及当前统计信息是否已过期。
...
| INSERTS | NUMBER | NO | 自上次收集统计信息以来，表中发生的插入操作的次数。|
| UPDATES | NUMBER | NO | 自上次收集统计信息以来，表中发生的更新操作的次数。|
| DELETES | NUMBER | NO | 自上次收集统计信息以来，表中发生的删除操作的次数。|
