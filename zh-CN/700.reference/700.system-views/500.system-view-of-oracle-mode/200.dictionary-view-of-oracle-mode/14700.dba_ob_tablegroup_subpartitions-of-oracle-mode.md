...
| HIGH_VALUE            | VARCHAR2(4096) | NO         | 该字段的值为 `NULL`                   |
| HIGH_VALUE_LENGTH     | NUMBER         | NO         | 该字段的值为 `NULL`                              |
| PARTITION_POSITION    | NUMBER         | NO         | 该字段的值为 `NULL`    |
| SUBPARTITION_POSITION | NUMBER         | NO         | 该字段的值为 `NULL`        |
