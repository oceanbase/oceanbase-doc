...
|slug|user_all_tables-of-oracle-mode|
...
展示当前用户拥有的对象表和关系表，除了 OWNER 字段之外，其他字段和 `ALL_ALL_TABLES` 相同。
...
查看用户拥有的对象表和关系表中，表 `T_SUBPART` 的信息。
...
* 查看当前用户可访问的所有对象表和关系表：[ALL_ALL_TABLES](200.all_all_tables-of-oracle-mode.md)
