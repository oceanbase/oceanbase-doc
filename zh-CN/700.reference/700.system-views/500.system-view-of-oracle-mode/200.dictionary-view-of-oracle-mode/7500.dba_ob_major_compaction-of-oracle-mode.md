...
| STATUS                   | VARCHAR2(10) | NO         | <ul><li>`IDLE`：没有在合并中   </li><li> `COMPACTING`：正在合并中   </li><li> `CHECKSUM`：校验 checksum </li></ul>   |
| IS_ERROR                 | VARCHAR2(3)  | NO         | <ul><li>`YES`：合并过程存在错误   </li><li> `NO`：合并过程没有报错 </li></ul> |
| IS_SUSPENDED             | VARCHAR2(3)  | NO         | <ul><li>`YES`：暂停合并状态   </li><li> `NO`：没有暂停合并 </li></ul> |
