...
|slug|all_all_tables-oracle-mode|
...
* 查看当前租户下的所有对象表和关系表：[DBA_ALL_TABLES](6400.dba_all_tables-of-oracle-mode.md)

* 查看当前用户拥有的所有对象表和关系表：[USER_ALL_TABLES](24200.user_all_tables-of-oracle-mode.md)
