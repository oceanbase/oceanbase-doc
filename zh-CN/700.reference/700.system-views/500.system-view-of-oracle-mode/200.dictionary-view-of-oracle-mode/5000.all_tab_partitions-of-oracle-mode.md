...
* 查看本租户所有分区表的一级分区信息：[DBA_TAB_PARTITIONS](20500.dba_tab_partitions-of-oracle-mode.md)

* 查看当前用户所拥有的分区表的一级分区信息：[USER_TAB_PARTITIONS](29400.user_tab_partitions-of-oracle-mode.md)

* 查看当前用户可访问的分区表的二级分区详细信息：[ALL_TAB_SUBPARTITIONS](5400.all_tab_subpartitions-of-oracle-mode.md)
