...
* 查看当前用户可访问的表的统计信息：[ALL_TAB_COL_STATISTICS](4600.all_tab_col_statistics-of-oracle-mode.md)

* 查看本租户下所有表的统计信息：[DBA_TAB_COL_STATISTICS](20700.dba_tab_col_statistics-of-oracle-mode.md)
