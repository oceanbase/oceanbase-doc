...
|slug|all_triggers-of-oracle-mode|
...
| TRIGGER_TYPE      | VARCHAR2(16)    | NO             | 触发器类型：<ul><li>BEFORE EACH ROW</li> <li>AFTER EACH ROW</li> <li>`INSTEAD OF`：INSTEAD OF 触发器</li> <li>`COMPOUND`：组合触发器 </li></ul>    |
...
| STATUS            | VARCHAR2(8)     | NO             | 状态：<ul><li>ENABLE</li><li>DISABLE </li></ul>    |
...
* 查看当前租户下的所有触发器：[DBA_TRIGGERS](21300.dba_triggers-of-oracle-mode.md)

* 查看当前用户拥有的触发器：[USER_TRIGGERS](30200.user_triggers-of-oracle-mode.md)
