...
| INDEXING               | VARCHAR2(4)    | NO             | 目前暂不支持该字段，且当前该字段默认为 NULL |
| READ_ONLY              | VARCHAR2(4)    | NO             | 目前暂不支持该字段，且当前该字段默认为 NULL |
| INMEMORY               | VARCHAR2(8)    | NO             | 目前暂不支持该字段，且当前该字段默认为 NULL |
| INMEMORY_PRIORITY      | VARCHAR2(8)    | NO             | 目前暂不支持该字段，且当前该字段默认为 NULL |
| INMEMORY_DISTRIBUTE    | VARCHAR2(15)   | NO             | 目前暂不支持该字段，且当前该字段默认为 NULL |
| INMEMORY_COMPRESSION   | VARCHAR2(17)   | NO             | 目前暂不支持该字段，且当前该字段默认为 NULL |
| INMEMORY_DUPLICATE     | VARCHAR2(13)   | NO             | 目前暂不支持该字段，且当前该字段默认为 NULL |
| CELLMEMORY             | VARCHAR2(24)   | NO             | 目前暂不支持该字段，且当前该字段默认为 NULL |
| INMEMORY_SERVICE       | VARCHAR2(12)   | NO             | 目前暂不支持该字段，且当前该字段默认为 NULL |
| INMEMORY_SERVICE_NAME  | VARCHAR2(100)  | NO             | 目前暂不支持该字段，且当前该字段默认为 NULL |
| MEMOPTIMIZE_READ       | VARCHAR2(8)    | NO             | 目前暂不支持该字段，且当前该字段默认为 NULL |
