...
`DBA_PLSQL_TYPE_ATTRS` 用于展示当前租户内所有 package 中定义的 record type 总体信息。
...
查看当前租户的所有 package 中定义的 record type 总体信息。
...
* 查看当前用户可访问的所有 package 中定义的记录类型信息：[ALL_PLSQL_TYPE_ATTRS](2770.all-plsql-type-attrs-oracle-mode.md)

* 查看当前用户拥有的所有 package 中定义的记录类型信息：[USER_PLSQL_TYPE_ATTRS](26870.user-plsql-type-attrs-oracle-mode.md)
