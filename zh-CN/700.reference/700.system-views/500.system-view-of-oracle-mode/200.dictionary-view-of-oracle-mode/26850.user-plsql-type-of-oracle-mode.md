...
* 如果需要查看当前用户有访问权限的所有 PL/SQL 数据类型的信息，可以查询 [ALL_PLSQL_TYPES](2750.all-plsql-types-of-oracle-mode.md)。
* 如果需要查看本租户下 package type 总体信息，可以查询 [DBA_PLSQL_TYPES](16350.dba-plsql-types-oracle-mode.md)。
