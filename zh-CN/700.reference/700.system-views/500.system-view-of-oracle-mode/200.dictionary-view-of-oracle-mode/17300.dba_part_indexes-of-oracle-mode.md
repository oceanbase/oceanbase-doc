...
| DEF_INITIAL_EXTENT        | VARCHAR2(40)   | NO         | 默认值为 NULL                                              |
| DEF_NEXT_EXTENT           | VARCHAR2(40)   | NO         | 默认值为 NULL                                                 |
| DEF_MIN_EXTENTS           | VARCHAR2(40)   | NO         | 默认值为 NULL                                           |
| DEF_MAX_EXTENTS           | VARCHAR2(40)   | NO         | 默认值为 NULL                                           |
| DEF_MAX_SIZE              | VARCHAR2(40)   | NO         | 默认值为 NULL                                              |
| DEF_PCT_INCREASE          | VARCHAR2(40)   | NO         | 默认值为 NULL                                          |
