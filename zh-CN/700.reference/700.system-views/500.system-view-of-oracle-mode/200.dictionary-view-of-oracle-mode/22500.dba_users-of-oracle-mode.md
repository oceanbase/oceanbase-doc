...
| PLUGIN                    | VARCHAR2(128)  | NO             | 记录密码 HASH 计算使用的 plugin 名称，目前只允许三种设置：<ul><li>空串（同 ob_native_password）</li><li>ob_native_password（Oracle 模式下的 mysql_native_password）</li><li>caching_sha2_password</li></ul><main id="notice" type='explain'><h4>说明</h4><p>对于 V5.x.x 来说，该字段从 V5.0.1 版本开始引入。</p></main>    |
