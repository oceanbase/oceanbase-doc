...
* 查看本租户所有表的表统计修改历史记录：[DBA_TAB_STATS_HISTORY](20800.dba_tab_stats_history-of-oracle-mode.md)

* 查看当前用户拥有的所有表的表统计修改历史记录：[USER_TAB_STATS_HISTORY](29700.user_tab_stats_history-of-oracle-mode.md)