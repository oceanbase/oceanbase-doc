...
| BLOCKS                    | NUMBER        | NO            | 暂不支持该字段，当前该字段默认为 NULL                                  |
| EMPTY_BLOCKS              | NUMBER        | NO            | 暂不支持该字段，当前该字段默认为 NULL                                 |
| AVG_SPACE                 | NUMBER        | NO            | 暂不支持该字段，当前该字段默认为 NULL                                 |
| CHAIN_CNT                 | NUMBER        | NO            | 暂不支持该字段，当前该字段默认为 NULL                                  |
| AVG_ROW_LEN               | NUMBER        | NO            | 实体的平均行长                                     |
| AVG_SPACE_FREELIST_BLOCKS | NUMBER        | NO            | 暂不支持该字段，当前该字段默认为 NULL                                 |
| NUM_FREELIST_BLOCKS       | NUMBER        | NO            | 暂不支持该字段，当前该字段默认为 NULL                                  |
| AVG_CACHED_BLOCKS         | NUMBER        | NO            | 暂不支持该字段，当前该字段默认为 NULL                                  |
| AVG_CACHE_HIT_RATIO       | NUMBER        | NO            | 暂不支持该字段，当前该字段默认为 NULL                                  |
| IM_IMCU_COUNT             | NUMBER        | NO            | 暂不支持该字段，当前该字段默认为 NULL                                  |
| IM_BLOCK_COUNT            | NUMBER        | NO            | 暂不支持该字段，当前该字段默认为 NULL                                  |
| IM_STAT_UPDATE_TIME       | TIMESTAMP(9)  | NO            | 暂不支持该字段，当前该字段默认为 NULL                                  |
| SCAN_RATE                 | NUMBER        | NO            | 暂不支持该字段，当前该字段默认为 NULL                                  |
...
查看本租户的所有表中，表 `T_SUBPART` 的优化器统计信息。
...
* 查看当前用户可访问的表的优化器统计信息：[ALL_TAB_STATISTICS](5400.all_tab_statistics-of-oracle-mode.md)
