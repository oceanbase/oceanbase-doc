...
展示了当前用户可访问的访问控制策略。对某一个表进行访问控制时，一个表上可以创建多个策略。
...
* 查看当前用户拥有的访问控制策略：[USER_POLICIES](26900.user_policies-oracle.md)

* 查看当前租户下的所有访问控制策略：[DBA_POLICIES](16800.dba_policies-oracle.md)
