...
| CLUSTERING                | VARCHAR2(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| ACTIVITY_TRACKING         | VARCHAR2(23)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| DML_TIMESTAMP             | VARCHAR2(25)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| HAS_IDENTITY              | VARCHAR2(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| CONTAINER_DATA            | VARCHAR2(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| INMEMORY                  | VARCHAR2(8)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| INMEMORY_PRIORITY         | VARCHAR2(8)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| INMEMORY_DISTRIBUTE       | VARCHAR2(15)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| INMEMORY_COMPRESSION      | VARCHAR2(17)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| INMEMORY_DUPLICATE        | VARCHAR2(13)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| DEFAULT_COLLATION         | VARCHAR2(100)  | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| DUPLICATED                | VARCHAR2(1)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| SHARDED                   | VARCHAR2(1)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| EXTERNALLY_SHARDED        | VARCHAR2(1)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| EXTERNALLY_DUPLICATED     | VARCHAR2(1)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| EXTERNAL                  | VARCHAR2(3)    | NO         | 指示表是否为外部表：<ul><li>YES </li> <li>NO </li> </ul>   |
| HYBRID                    | VARCHAR2(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| CELLMEMORY                | VARCHAR2(24)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| CONTAINERS_DEFAULT        | VARCHAR2(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| CONTAINER_MAP             | VARCHAR2(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| EXTENDED_DATA_LINK        | VARCHAR2(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| EXTENDED_DATA_LINK_MAP    | VARCHAR2(3)    | NO         | 仅限内部使用   |
| INMEMORY_SERVICE          | VARCHAR2(12)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| INMEMORY_SERVICE_NAME     | VARCHAR2(1000) | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| CONTAINER_MAP_OBJECT      | VARCHAR2(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| MEMOPTIMIZE_READ          | VARCHAR2(8)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| MEMOPTIMIZE_WRITE         | VARCHAR2(8)    | NO         | 仅限内部使用   |
| HAS_SENSITIVE_COLUMN      | VARCHAR2(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| ADMIT_NULL                | VARCHAR2(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| DATA_LINK_DML_ENABLED     | VARCHAR2(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| LOGICAL_REPLICATION       | VARCHAR2(8)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
