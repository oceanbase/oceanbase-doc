...
| DELTA_FORMAT              | VARCHAR2(1048576) | NO      | 表示表的增量数据转储格式。取值如下：<ul><li>`flat`：默认格式。</li><li>`encoding`：encoding 格式。</li></ul> <main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.6.0 版本开始引入。</p></main>|
