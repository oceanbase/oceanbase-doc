...
| CLUSTERING                | VARCHAR2(3)    | NO         | 值为 NULL，不具备实际含义 |
| ACTIVITY_TRACKING         | VARCHAR2(23)   | NO         | 值为 NULL，不具备实际含义 |
| DML_TIMESTAMP             | VARCHAR2(25)   | NO         | 值为 NULL，不具备实际含义 |
| HAS_IDENTITY              | VARCHAR2(3)    | NO         | 值为 NULL，不具备实际含义 |
| CONTAINER_DATA            | VARCHAR2(3)    | NO         | 值为 NULL，不具备实际含义 |
| INMEMORY                  | VARCHAR2(8)    | NO         | 值为 NULL，不具备实际含义 |
| INMEMORY_PRIORITY         | VARCHAR2(8)    | NO         | 值为 NULL，不具备实际含义 |
| INMEMORY_DISTRIBUTE       | VARCHAR2(15)   | NO         | 值为 NULL，不具备实际含义 |
| INMEMORY_COMPRESSION      | VARCHAR2(17)   | NO         | 值为 NULL，不具备实际含义 |
| INMEMORY_DUPLICATE        | VARCHAR2(13)   | NO         | 值为 NULL，不具备实际含义 |
| DEFAULT_COLLATION         | VARCHAR2(100)  | NO         | 值为 NULL，不具备实际含义 |
| DUPLICATED                | VARCHAR2(1)    | NO         | 值为 NULL，不具备实际含义 |
| SHARDED                   | VARCHAR2(1)    | NO         | 值为 NULL，不具备实际含义 |
| EXTERNALLY_SHARDED        | VARCHAR2(1)    | NO         | 值为 NULL，不具备实际含义 |
| EXTERNALLY_DUPLICATED     | VARCHAR2(1)    | NO         | 值为 NULL，不具备实际含义 |
| EXTERNAL                  | VARCHAR2(3)    | NO         | 指示表是否为外部表：<ul><li>YES </li> <li>NO </li> </ul>   |
| HYBRID                    | VARCHAR2(3)    | NO         | 值为 NULL，不具备实际含义 |
| CELLMEMORY                | VARCHAR2(24)   | NO         | 值为 NULL，不具备实际含义 |
| CONTAINERS_DEFAULT        | VARCHAR2(3)    | NO         | 值为 NULL，不具备实际含义 |
| CONTAINER_MAP             | VARCHAR2(3)    | NO         | 值为 NULL，不具备实际含义 |
| EXTENDED_DATA_LINK        | VARCHAR2(3)    | NO         | 值为 NULL，不具备实际含义 |
| EXTENDED_DATA_LINK_MAP    | VARCHAR2(3)    | NO         | 仅限内部使用   |
| INMEMORY_SERVICE          | VARCHAR2(12)   | NO         | 值为 NULL，不具备实际含义 |
| INMEMORY_SERVICE_NAME     | VARCHAR2(1000) | NO         | 值为 NULL，不具备实际含义 |
| CONTAINER_MAP_OBJECT      | VARCHAR2(3)    | NO         | 值为 NULL，不具备实际含义 |
| MEMOPTIMIZE_READ          | VARCHAR2(8)    | NO         | 值为 NULL，不具备实际含义 |
| MEMOPTIMIZE_WRITE         | VARCHAR2(8)    | NO         | 仅限内部使用   |
| HAS_SENSITIVE_COLUMN      | VARCHAR2(3)    | NO         | 值为 NULL，不具备实际含义 |
| ADMIT_NULL                | VARCHAR2(3)    | NO         | 值为 NULL，不具备实际含义 |
| DATA_LINK_DML_ENABLED     | VARCHAR2(3)    | NO         | 值为 NULL，不具备实际含义 |
| LOGICAL_REPLICATION       | VARCHAR2(8)    | NO         | 值为 NULL，不具备实际含义 |
