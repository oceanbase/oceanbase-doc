...
展示了当前租户下所有表或视图的访问控制策略。对某一个表进行访问控制时，一个表上可以创建多个策略。
...
* 查看当前用户可访问的所有表或视图的访问控制策略：[ALL_POLICIES](2800.all_policies-oracle.md)

* 查看当前用户拥有的表或视图的访问控制策略：[USER_POLICIES](26900.user_policies-oracle.md)
