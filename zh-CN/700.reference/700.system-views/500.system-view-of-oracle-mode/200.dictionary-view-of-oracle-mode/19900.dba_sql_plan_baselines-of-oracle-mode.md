...
| ORIGIN | VARCHAR2(29) | NO | 计划基线的创建方式：<ul><li>MANUAL-LOAD</li><li>AUTO-CAPTURE</li><li>MANUAL-SQLTUNE</li><li>AUTO-SQLTUNE</li></ul> |
...
| ENABLED | VARCHAR2(3) | NO | 指示计划基线是否启用：<ul><li>YES</li><li>NO</li></ul>    |
| ACCEPTED | VARCHAR2(3) | NO | 指示计划基线是否被采纳：<ul><li>YES</li><li>NO</li></ul>    |
| FIXED | VARCHAR2(3) | NO | 指示计划基线是否固定：<ul><li>YES</li><li>NO</li></ul>   |
| REPRODUCED | VARCHAR2(3) | NO | 指示计划基线是否可复现：<ul><li>YES</li><li>NO</li></ul>   |
| AUTOPURGE | VARCHAR2(3) | NO | 指示计划基线是否自动清理：<ul><li>YES</li><li>NO</li></ul>    |
| ADAPTIVE | VARCHAR2(3) | NO | 指示由 SPM 自动捕获的计划基线是否已适应：<ul><li>YES</li><li>NO</li></ul>    |
