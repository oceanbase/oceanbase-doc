...
| STATUS | VARCHAR2(64) | NO | 任务状态，包含：<ul><li>INIT：任务初始化阶段  </li><li>DOING：任务执行中 </li><li>CANCELING：任务取消中 </li><li>CANCELED：任务已取消 </li><li>COMPLETED：任务已完成 </li><li>FAILED：任务已失败   </li></ul> |
| IMPORT_ALL | NUMBER(38) | NO | 表恢复作业是否导入所有的数据 |
