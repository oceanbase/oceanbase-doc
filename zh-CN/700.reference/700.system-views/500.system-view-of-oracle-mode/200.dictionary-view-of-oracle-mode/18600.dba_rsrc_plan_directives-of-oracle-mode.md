...
| MGMT_P1                    | NUMBER(38)     | NO         | 系统满负载情况下，相对可用的最大 CPU 占比，默认值为 `100`。 |
...
| UTILIZATION_LIMIT          | NUMBER(38)     | NO         | 资源组所使用的 CPU 资源占租户 CPU 总资源的百分比上限，默认值为 `100`，表示最大可使用租户全部 CPU 资源。 |
...
* 查看所有资源管理计划：[DBA_RSRC_PLANS](18700.dba_rsrc_plans-of-oracle-mode.md)

* 查看当前活跃租户的资源管理计划：[V$RSRC_PLAN](../300.performance-view-of-oracle-mode/34900.v-rsrc_plan-of-oracle-mode.md)

* 查看租户在 Resource Manager 中的各类资源配置参数：[DBA_OB_RSRC_DIRECTIVES](15020.dba_ob_rsrc_directives-of-oracle-mode.md)