...
|slug|dba_coll_types-oracle-compatible-mode|
...
| COLL_TYPE          | VARCHAR2(10)  | NO             | 集合类型：<ul><li>VARYING   </li><li> ARRAY   </li><li> NESTED TABLE </li><li> TABLE </li></ul>  |
...
| ELEM_STORAGE       | CHAR(3)       | YES            | 目前暂不支持该字段                                                                     |
| NULLS_STORED       | CHAR(1)       | YES            | 目前暂不支持该字段        |
...
* 查看当前用户拥有的自定义集合类型：[USER_COLL_TYPES](25000.user_coll_types-of-oracle-mode.md)

* 有关集合的详细介绍及说明，参见 [集合](../../../500.sql-reference/300.pl-reference/300.pl-oracle/400.collections-and-records-oracle/200.collection-oracle.md)。
