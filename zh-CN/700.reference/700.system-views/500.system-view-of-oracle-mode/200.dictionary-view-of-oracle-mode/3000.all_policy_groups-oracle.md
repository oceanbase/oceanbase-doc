...
展示当前用户可访问的所有视图的策略组信息，配合策略上下文实现对不同的用户生效不同的策略。
...
* 查看当前用户拥有的视图的策略组信息：[USER_POLICY_GROUPS](27100.user_policy_groups-oracle.md)

* 查看当前租户内所有视图的策略组信息：[DBA_POLICY_GROUPS](17000.dba_policy_groups-oracle.md)
