...
展示当前用户可访问的表自上次在该表上收集统计信息以来的修改信息。
...
查看当前用户可访问的表中，表 `T_SUBPART` 自上次在该表上收集统计信息以来的修改信息。
...
* 查看当前租户下所有表自上次统计信息收集后的修改信息：[DBA_TAB_MODIFICATIONS](20400.dba_tab_modifications-of-oracle-mode.md)

* 查看当前用户拥有的所有表自上次统计信息收集后的修改信息：[USER_TAB_MODIFICATIONS](29300.user_tab_modifications-of-oracle-mode.md)
