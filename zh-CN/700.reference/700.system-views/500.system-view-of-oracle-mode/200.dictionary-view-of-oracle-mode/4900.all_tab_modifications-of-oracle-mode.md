...
* 查看当前租户下表的累计修改信息：[DBA_TAB_MODIFICATIONS](20400.dba_tab_modifications-of-oracle-mode.md)

* 查看当前用户拥有的表的累计修改信息：[USER_TAB_MODIFICATIONS](29300.user_tab_modifications-of-oracle-mode.md)
