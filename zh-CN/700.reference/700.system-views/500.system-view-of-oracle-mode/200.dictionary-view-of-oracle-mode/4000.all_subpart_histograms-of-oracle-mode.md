...
查看当前用户可访问的分区表中，表 `T_SUBPART` 的二级分区的直方图信息。
...
* 查看本租户下所有分区表的二级分区的直方图信息：[DBA_SUBPART_HISTOGRAMS](19400.dba_subpart_histograms-of-oracle-mode.md)

* 查看当前用户拥有的分区表的二级分区的直方图信息：[USER_SUBPART_HISTOGRAMS](28300.user_subpart_histograms-of-oracle-mode.md)
