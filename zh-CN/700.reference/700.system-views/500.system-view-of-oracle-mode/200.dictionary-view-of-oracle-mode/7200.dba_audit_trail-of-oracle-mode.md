...
视图 `DBA_AUDIT_TRAIL` 用于查看所有审计跟踪条目。
...
```shell
obclient [SYS]> SELECT * FROM SYS.DBA_AUDIT_TRAIL WHERE ROWNUM =1\G
```

## 相关文档

查询当前用户相关的标准审计跟踪条目：[USER_AUDIT_TRAIL](25400.user_audit_trail-of-oracle-mode.md)
