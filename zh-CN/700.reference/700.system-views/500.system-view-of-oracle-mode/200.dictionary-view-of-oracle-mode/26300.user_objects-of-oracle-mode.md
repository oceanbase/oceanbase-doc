...
视图 `USER_OBJECTS` 展示用户拥有的所有数据库对象，视图与 ALL_OBJECTS 一致，但没有 OWNER 列，因为 OWNER 就是自己本身。
...
| STATUS         | VARCHAR2(7)   | NO             | 对象状态：<ul><li>VALID：有效的</li><li> INVALID：无效的</li></ul>   |
...
| SHARING           | VARCHAR2(18)  | NO         | 该字段默认为 `NULL`                              |
| EDITIONABLE       | VARCHAR2(1)   | NO         | 该字段默认为 `NULL` |
| ORACLE_MAINTAINED | VARCHAR2(1)   | NO         | 该字段默认为 `NULL`           |
| APPLICATION       | VARCHAR2(1)   | NO         | 该字段默认为 `NULL`                            |
| DEFAULT_COLLATION | VARCHAR2(1)   | NO         | 该字段默认为 `NULL`                          |
| DUPLICATED        | VARCHAR2(1)   | NO         | 该字段默认为 `NULL`         |
| SHARDED           | VARCHAR2(1)   | NO         | 该字段默认为 `NULL`                              |
| IMPORTED_OBJECT   | VARCHAR2(1)   | NO         | 该字段默认为 `NULL`                               |
| CREATED_APPID     | NUMBER    | NO         | 该字段默认为 `NULL`      |
| CREATED_VSNID     | NUMBER    | NO         | 该字段默认为 `NULL`          |
| MODIFIED_APPID    | NUMBER    | NO         | 该字段默认为 `NULL`      |
| MODIFIED_VSNID    | NUMBER    | NO         | 该字段默认为 `NULL`      |

## 查询示例

查看当前用户拥有的所有数据库对象，展示前 2 条记录。
