...
`DBA_PLSQL_COLL_TYPES` 视图用于展示当前租户内所有 package 中定义的 collection type 总体信息。
...
查看当前租户 Package 中定义的 collection type 总体信息。
...
* 查看当前用户拥有的 package 中集合类型的信息：[USER_PLSQL_COLL_TYPES](26860.user-plsql-coll-types-oracle-mode.md)
