...
<main id="notice" >
    <h4>说明</h4>
    <p>对于 V4.2.x 版本，该视图从 V4.2.5 版本开始引入。<br>对于 V4.3.x 版本，该视图从 V4.3.5 版本开始引入。</p>
  </main>
...
* 如果需要查看数据库中所有 PL/SQL 集合类型的信息，可以查询 [ALL_PLSQL_COLL_TYPES](2760.all-plsql-coll-type-of-oracle-mode.md)。
* 如果仅需要查看前用户下 package type 总体信息，可以查询 [USER_PLSQL_COLL_TYPES](26850.user-plsql-type-of-oracle-mode.md)。