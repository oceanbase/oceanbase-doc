...
展示当前用户拥有的所有函数和过程，以及它们的关联属性。其列与 `ALL_PROCEDURES` 中的列相同，去除了 `OWNER` 字段。
...
* 查看当前租户内的所有函数和存储过程：[DBA_PROCEDURES](17100.dba_procedures-of-oracle-mode.md)
