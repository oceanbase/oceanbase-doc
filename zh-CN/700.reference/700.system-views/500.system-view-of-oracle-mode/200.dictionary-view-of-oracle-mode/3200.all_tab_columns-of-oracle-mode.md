...
3. 查询表 `TBL2` 的列信息。
   ...
   ```shell
   obclient [SYS]> SELECT TABLE_NAME, COLUMN_NAME, DATA_TYPE, DATA_DEFAULT FROM SYS.ALL_TAB_COLUMNS WHERE TABLE_NAME LIKE '%TBL2%';
   ```
...
* [USER_TAB_COLUMNS](17900.user_tab_columns-of-oracle-mode.md)
