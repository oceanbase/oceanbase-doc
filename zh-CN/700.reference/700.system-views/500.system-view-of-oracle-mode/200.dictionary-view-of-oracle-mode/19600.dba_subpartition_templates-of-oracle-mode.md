...
* 查看所有租户下的分区表的模板化二级分区信息：[CDB_SUBPARTITION_TEMPLATES](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/12500.o-cdb_subpartition_templates-of-sys-tenant.md)

* 查看当前用户可访问的分区表的模板化二级分区信息：[ALL_SUBPARTITION_TEMPLATES](4200.all_subpartition_templates-of-oracle-mode.md)

* 查看当前用户所拥有的分区表的模板化二级分区信息：[USER_SUBPARTITION_TEMPLATES](28500.user_subpartition_templates-of-oracle-mode.md)
