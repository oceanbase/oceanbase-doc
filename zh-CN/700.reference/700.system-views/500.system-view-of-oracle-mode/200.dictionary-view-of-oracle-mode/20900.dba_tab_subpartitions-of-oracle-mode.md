...
展示当前租户分区表的二级分区信息，包含二级分区名称、表和所属分区的名称、其存储属性以及 `DBMS_STATS` 包生成的统计信息。
...
* 查看所有租户的分区表的二级分区信息：[CDB_TAB_SUBPARTITIONS](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/13000.o-cdb_tab_subpartitions-of-sys-tenant.md)

* 查看当前用户可访问的分区表的二级分区信息：[ALL_TAB_SUBPARTITIONS](5400.all_tab_subpartitions-of-oracle-mode.md)

* 查看当前用户所拥有的分区表的二级分区信息：[USER_TAB_SUBPARTITIONS](29800.user_tab_subpartitions-of-oracle-mode.md)。

* 查看本租户的分区表的一级分区详细信息：[DBA_TAB_PARTITIONS](20500.dba_tab_partitions-of-oracle-mode.md)
