...
* 查看当前租户下的所有存储对象的文本源：[DBA_SOURCE](18900.dba_source-of-oracle-mode.md)

* 查看当前用户拥有的存储对象的文本源：[USER_SOURCE](28100.user_source-of-oracle-mode.md)
