...
* 查看正在执行的备份清理的 Job 任务的执行进度：[DBA_OB_BACKUP_DELETE_JOBS](9800.dba_ob_backup_delete_jobs-of-oracle-mode.md)

* 查看备份清理的 Job 任务历史信息：[DBA_OB_BACKUP_DELETE_JOB_HISTORY](9700.dba_ob_backup_delete_job_history-of-oracle-mode.md)

* 查看备份清理的 Task 任务的历史信息：[DBA_OB_BACKUP_DELETE_TASK_HISTORY](10000.dba_ob_backup_delete_task_history-of-oracle-mode.md)
