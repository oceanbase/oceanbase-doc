...
| HEADER_FILE      | NUMBER        | NO             | 目前暂不支持该字段，当前该字段默认为 NULL           |
| HEADER_BLOCK     | NUMBER        | NO             | 目前暂不支持该字段，当前该字段默认为 NULL             |
...
| RELATIVE_FNO     | NUMBER        | NO             | 目前暂不支持该字段，当前该字段默认为 NULL              |
...
查看当前用户拥有的段的物理存储分配情况，查询 [USER_SEGMENTS](29400.user_segments-of-oracle-mode.md)。