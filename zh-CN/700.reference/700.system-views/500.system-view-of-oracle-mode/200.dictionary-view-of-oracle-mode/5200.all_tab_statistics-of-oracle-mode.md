...
* 查看本租户下所有表的优化器统计信息：[DBA_TAB_STATISTICS](20700.dba_tab_statistics-of-oracle-mode.md)

* 查看当前用户所拥有的表的优化器统计信息：[USER_TAB_STATISTICS](29600.user_tab_statistics-of-oracle-mode.md)
