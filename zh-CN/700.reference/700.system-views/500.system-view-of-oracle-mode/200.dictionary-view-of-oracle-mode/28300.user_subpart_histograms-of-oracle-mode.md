...
查看当前用户拥有的分区表中，表 `T_SUBPART` 的二级分区的直方图信息。
...
* 查看当前用户可访问的分区表的二级分区的直方图信息：[ALL_SUBPART_HISTOGRAMS](4000.all_subpart_histograms-of-oracle-mode.md)
