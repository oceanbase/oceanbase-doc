...
| GLOBAL_STATS   | VARCHAR2(3)   | NO            | <ul><li>`YES`：表示统计信息是直接收集的。   </li><li> `NO`：表示统计信息是通过二级分区统计信息推导出的或未收集统计信息。 </li></ul>   |
...
* 查看当前用户可访问的分区表中一级分区的列统计信息：[ALL_PART_COL_STATISTICS](2300.all_part_col_statistics-of-oracle-mode.md)

* 查看当前用户所拥有的分区表中一级分区的列统计信息：[USER_PART_COL_STATISTICS](26400.user_part_col_statistics-of-oracle-mode.md)
