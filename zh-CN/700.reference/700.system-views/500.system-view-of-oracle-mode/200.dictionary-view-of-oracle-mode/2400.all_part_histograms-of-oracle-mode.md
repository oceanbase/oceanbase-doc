...
|slug|all_part_histograms-oracle-compatible-mode|
...
* 查看本租户下所有分区表的一级分区的直方图信息：[DBA_PART_HISTOGRAMS](16400.dba_part_histograms-of-oracle-mode.md)

* 查看当前用户拥有的分区表的一级分区的直方图信息：[USER_PART_HISTOGRAMS](26500.user_part_histograms-of-oracle-mode.md)
