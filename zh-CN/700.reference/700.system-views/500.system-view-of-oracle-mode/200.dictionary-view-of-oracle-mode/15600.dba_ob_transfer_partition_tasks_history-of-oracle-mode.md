...
视图 `DBA_OB_TRANSFER_PARTITION_TASK_HISTORY` 展示了本租户已执行的 Transfer Partition 任务的历史。
...
查看本租户已执行的 Transfer Partition 任务的历史。
...
* 查看本租户下正在处理的 Transfer Partition 任务：[DBA_OB_TRANSFER_PARTITION_TASKS](15500.dba_ob_transfer_partition_tasks-of-oracle-mode.md)
