...
* 查看所有租户的表、视图的列信息：[CDB_TAB_COLS](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/12700.o-cdb_tab_cols-of-sys-tenant.md)

* 查看当前用户可访问的表、视图的列信息：[ALL_TAB_COLS](4500.all_tab_cols-of-oracle-mode.md)
