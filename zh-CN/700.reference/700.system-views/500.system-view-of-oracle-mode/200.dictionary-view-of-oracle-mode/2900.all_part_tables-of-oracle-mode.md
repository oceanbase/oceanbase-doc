...
| DEF_INMEMORY              | VARCHAR2(8)    | NO         | 默认值为 NULL，不具备实际含义 |
| DEF_INMEMORY_PRIORITY     | VARCHAR2(8)    | NO         | 默认值为 NULL，不具备实际含义 |
| DEF_INMEMORY_DISTRIBUTE   | VARCHAR2(15)   | NO         | 默认值为 NULL，不具备实际含义 |
| DEF_INMEMORY_COMPRESSION  | VARCHAR2(17)   | NO         | 默认值为 NULL，不具备实际含义 |
| DEF_INMEMORY_DUPLICATE    | VARCHAR2(13)   | NO         | 默认值为 NULL，不具备实际含义 |
| DEF_READ_ONLY             | VARCHAR2(3)    | NO         | 指示新分区的默认设置：<li>YES：新分区的默认设置是只读的<li>NO：新分区的默认设置是读/写                 |
| DEF_CELLMEMORY            | VARCHAR2(24)   | NO         | 默认值为 NULL，不具备实际含义 |
| DEF_INMEMORY_SERVICE      | VARCHAR2(12)   | NO         | 默认值为 NULL，不具备实际含义 |
| DEF_INMEMORY_SERVICE_NAME | VARCHAR2(1000) | NO         | 默认值为 NULL，不具备实际含义 |
