...
* 查看所有租户的所有分区表的分区信息：[CDB_PART_TABLES](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/12400.o-cdb_part_tables-of-sys-tenant.md)

* 查看当前用户可访问的所有分区表的分区信息：[ALL_PART_TABLES](2900.all_part_tables-of-oracle-mode.md)
