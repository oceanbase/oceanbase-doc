...
|slug|dba_ob_table_locations-of-oracle-mode|
...
| TABLE_TYPE | VARCHAR2(13) | NO | 表类型：<ul><li>USER TABLE：用户表 </li><li>SYSTEM TABLE：系统表，系统自建的表 </li><li>INDEX：索引表 </li><li>LOB AUX TABLE：LOB 辅助表，系统自建的表，用于辅助实现 LOB 列</li></ul> |
