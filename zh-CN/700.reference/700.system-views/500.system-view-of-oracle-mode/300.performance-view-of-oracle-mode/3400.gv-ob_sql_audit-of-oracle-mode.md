...
| REQUEST_TYPE            | NUMBER(38)      | NO             | 请求对应的类型： <li> 0：表示非法   <li> 1：表示是一个内部请求   <li> 2：表示是一个本地请求，例如，Local 计划   <li> 3：表示远程请求   <li> 4：表示分布式请求   <li> 5：表示 SQL 的 Prepare 请求   <li> 6：表示 SQL 的 Execute Stmt 请求 <li> 7：表示 SQL 的 PS Fetch 的请求 <li> 8：表示 PS Send Piece 请求 <li>9：表示 PS Get Piece 请求<li>10：表示 PS Send Long Data 请求<li>11：表示是 PL 的请求 |
