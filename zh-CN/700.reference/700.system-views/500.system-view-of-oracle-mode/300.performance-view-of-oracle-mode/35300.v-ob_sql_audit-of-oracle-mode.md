...
| TX_INTERNAL_ROUTING     | NUMBER          | NO             | 表示当前事务是否启用了事务路由：<ul><li>0：未启用事务路由，语句只能路由到事务开始时的 OBServer 节点上。  </li><li>1：启用事务路由，事务内的语句可以由代理 Proxy 按照最优的方式路由。 </li></ul><main id="notice" type='explain'><h4>说明</h4><ul><li>该字段从 V4.1.0 版本开始引入。</li><li>OBProxy 从 V4.1.0 版本开始支持该功能。</li></ul></main>  |
| TX_STATE_VERSION        | NUMBER(38)      | NO             | 当事务路由开启后，执行语句后事务状态若发生变化，则版本号递增；若未发生变化，则版本号不变<main id="notice" type='explain'><h4>说明</h4><ul><li>该字段从 V4.1.0 版本开始引入。</li><li>OBProxy 从 V4.1.0 版本开始支持该功能。</li></ul></main>  |
...
| FORMAT_SQL_ID                   | VARCHAR2(32)         | NO   | <main id="notice" type='explain'><h4>说明</h4><ul><li>在 V4.3.x 版本中，该字段从 V4.3.2 版本开始引入，但该字段功能暂不支持。</li><li>在 V4.2.x 版本中，该字段从 V4.2.3 版本开始引入。</li></ul></main>|
| STMT_TYPE                       | VARCHAR2(128)        | YES  | <main id="notice" type='explain'><h4>说明</h4><ul><li>在 V4.3.x 版本中，该字段从 V4.3.2 版本开始引入，但该字段功能暂不支持。</li><li>在 V4.2.x 版本中，该字段从 V4.2.3 版本开始引入。</li></ul></main>|
| NETWORK_WAIT_TIME               | NUMBER(38)           | YES  | <main id="notice" type='explain'><h4>说明</h4><ul><li>在 V4.3.x 版本中，该字段从 V4.3.2 版本开始引入，但该字段功能暂不支持。</li><li>在 V4.2.x 版本中，该字段从 V4.2.3 版本开始引入。</li></ul></main>|
