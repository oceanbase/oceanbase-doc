...
```shell
obclient [SYS]> SELECT * FROM SYS.V$OB_ACTIVE_SESSION_HISTORY WHERE ROWNUM <= 2\G
```
...
*************************** 1. row ***************************
                   ...
                   SVR_PORT: 2882
                  SAMPLE_ID: 4278
                SAMPLE_TIME: 05-AUG-24 02.08.53.530851 PM
                     CON_ID: 1004
                    USER_ID: 0
    ...
    IN_REMOTE_DAS_EXECUTION: N
             IN_FILTER_ROWS: N
                  ...
                  CLIENT_ID: NULL
                  BACKTRACE: NULL
              TM_DELTA_TIME: 443698
          TM_DELTA_CPU_TIME: 443698
           TM_DELTA_DB_TIME: 443698
...
*************************** 2. row ***************************
                   ...
                   SVR_PORT: 2882
                  SAMPLE_ID: 4286
                SAMPLE_TIME: 05-AUG-24 02.09.12.618507 PM
                     CON_ID: 1004
                    USER_ID: 0
                 SESSION_ID: 5119601016832
               SESSION_TYPE: BACKGROUND
              SESSION_STATE: ON CPU
                     SQL_ID: NULL
                    PLAN_ID: 0
    ...
    IN_REMOTE_DAS_EXECUTION: N
             IN_FILTER_ROWS: N
                    PROGRAM: T1004_TenantMet
                     MODULE: NULL
                     ACTION: NULL
                  CLIENT_ID: NULL
                  BACKTRACE: NULL
              TM_DELTA_TIME: 67932
          TM_DELTA_CPU_TIME: 67932
           TM_DELTA_DB_TIME: 67932
           TOP_LEVEL_SQL_ID: NULL
       IN_PLSQL_COMPILATION: N
         IN_PLSQL_EXECUTION: N
      PLSQL_ENTRY_OBJECT_ID: NULL
