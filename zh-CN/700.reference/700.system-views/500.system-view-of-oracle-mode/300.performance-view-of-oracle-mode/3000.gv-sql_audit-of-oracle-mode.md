...
视图 `GV$OB_SQL_AUDIT` 展示所有 OBServer 节点上每一次 SQL 请求的来源、执行状态等统计信息。该视图是按照租户拆分的，除了系统租户，其他租户不能跨租户查询。
...
| NETWORK_WAIT_TIME               | NUMBER(38) | YES  |  所有 Network 类事件的总时间，单位为微秒<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 BP5 版本开始引入。</p></main>    |
...
*************************** 1. row ***************************
                       ...
                       SVR_PORT: 2882
                     REQUEST_ID: 7780659
                    SQL_EXEC_ID: 92303079
                       TRACE_ID: YXXXXXXXXXX-000XXXXXXXXXXXXX-0-0
                            SID: 1
                      CLIENT_IP: 0.0.0.0
                    CLIENT_PORT: 0
                      TENANT_ID: 1
            EFFECTIVE_TENANT_ID: 1004
                 ...
                 USER_CLIENT_IP: 0.0.0.0
                      ...
                      QUERY_SQL: SELECT * FROM __all_spatial_reference_systems WHERE (SRS_ID < 70000000 AND SRS_ID != 0) OR SRS_ID > 2000000000
                        PLAN_ID: 247
                  AFFECTED_ROWS: 0
                    RETURN_ROWS: 0
                  PARTITION_CNT: 1
...
PUSHDOWN_STORAGE_FILTER_ROW_CNT: 0
          ...
          EXPECTED_WORKER_COUNT: 0
              ...
              PS_CLIENT_STMT_ID: -1
               PS_INNER_STMT_ID: -1
                          TX_ID: 0
               SNAPSHOT_VERSION: 1713425158912682600
                   REQUEST_TYPE: 1
