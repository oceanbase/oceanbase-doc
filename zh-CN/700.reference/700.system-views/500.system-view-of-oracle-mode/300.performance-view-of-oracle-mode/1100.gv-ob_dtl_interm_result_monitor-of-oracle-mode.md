...
|slug|gv-ob_dtl_interm_result_monitor-oracle-compatible-mode|
...
| HOLD_MEMORY | NUMBER(38) | NO | 占用的内存大小，单位为字节 |
| DUMP_SIZE | NUMBER(38) | NO | dump 大小，单位为字节 |
...
| MAX_HOLD_MEMORY | NUMBER(38) | NO | 最大占用内存大小，单位为字节 |