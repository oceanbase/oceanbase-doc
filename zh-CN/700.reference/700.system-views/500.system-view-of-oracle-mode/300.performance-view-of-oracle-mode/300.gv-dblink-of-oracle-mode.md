...
| PROTOCOL              | NUMBER(38)      | NO             | 数据库链接的通信协议：<ul><li>OceanBase：表示使用 OceanBase 内部协议访问 OceanBase   数据库（Oracle 模式）</li><li>OCI ( Oracle Call Interface )：表示使用 OCI 库访问 Oracle 数据库</li></ul> |
