...
| MDS_FILTER_INFO                 | VARCHAR2(1024) | NO | 展示合并使用的 MD5 过滤信息 <main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.3.5 版本开始引入，从 V4.3.5 BP2 版本开始生效。</p></main> |
| EXECUTE_TIME                    | NUMBER(38)     | NO | 合并任务消耗 CPU 的时间，单位为毫秒 <main id="notice" type='explain'><h4>说明</h4><p>对于 V4.3.5 版本，该字段从 V4.3.5 BP2 版本开始引入。</p></main> |
