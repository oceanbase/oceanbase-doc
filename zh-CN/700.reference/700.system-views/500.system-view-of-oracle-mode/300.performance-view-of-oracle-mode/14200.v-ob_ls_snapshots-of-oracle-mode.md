...
| TSNAP_HAS_UNFINISHED_CREATE_DAG | VARCHAR2(3 CHAR) | NO | 对应租户快照是否存在未完成的 Create （YES/NO） |
| TSNAP_HAS_UNFINISHED_GC_DAG | VARCHAR2(3 CHAR) | NO | 对应租户快照是否存在未完成的 GC（YES/NO） |
