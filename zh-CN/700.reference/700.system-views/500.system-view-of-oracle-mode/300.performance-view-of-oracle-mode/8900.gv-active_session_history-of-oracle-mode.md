...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <ul><li>该视图从 V4.0.0 版本开始引入。</li>
  <li>该视图从 V4.2.2 版本开始更名为 <a href="17200.gv-ob_active_session_history-of-oracle-mode.md">GV$OB_ACTIVE_SESSION_HISTORY</a>。</li></ul>
</main>
...
| MODULE | VARCHAR2(64) | YES | 会话在采样时记录的 MODULE 值，通过 `DBMS_APPLICATION_INFO.SET_MODULE` 包设置。<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.3 版本开始可以设置。</p></main> |
...
*************************** 1. row ***************************
                   ...
                   SVR_PORT: 2882
                  SAMPLE_ID: 4444
                SAMPLE_TIME: 05-AUG-24 02.15.07.300487 PM
                     CON_ID: 1004
                    USER_ID: 0
                 SESSION_ID: 5368709120000
               SESSION_TYPE: BACKGROUND
              SESSION_STATE: ON CPU
                     SQL_ID: NULL
                    PLAN_ID: 0
                   TRACE_ID: Y0-XXXXXXXXXXXXX-0-0
                      EVENT: NULL
                   EVENT_NO: 0
                   EVENT_ID: NULL
                     P1TEXT: NULL
    ...
    IN_REMOTE_DAS_EXECUTION: N
             IN_FILTER_ROWS: N
                    PROGRAM: T1004_TxLoopWor
                     MODULE: NULL
                     ACTION: NULL
                  CLIENT_ID: NULL
                  BACKTRACE: NULL
              TM_DELTA_TIME: 120894
          TM_DELTA_CPU_TIME: 120894
           TM_DELTA_DB_TIME: 120894
