...
| TABLET_ID               | NUMBER        | YES   | 会话在采样时记录的 Tablet 的 ID<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.2.1 版本，该字段从 V4.2.1 BP10 版本开始引入。</p></main> |
...
2. 通过 `GV$ACTIVE_SESSION_HISTORY` 视图查询活跃会话的历史记录。
...
[V$ACTIVE_SESSION_HISTORY](9000.v-active_session_history-of-oracle-mode.md)
