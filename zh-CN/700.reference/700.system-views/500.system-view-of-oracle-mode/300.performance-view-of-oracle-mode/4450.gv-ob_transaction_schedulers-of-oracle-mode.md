...
| PARTICIPANTS | VARCHAR2(1024) | YES | 事务的参与者信息 |
| ISOLATION_LEVEL | VARCHAR2(16) | NO | 隔离级别 |
| SNAPSHOT_VERSION | NUMBER(38)  | YES | 开启 RR  或 SERIAL 隔离级别的快照版本，没有开启则为 -1 |
...
| GLOBALID               | VARCHAR2(256)        | YES  | 全局事务唯一标识符 |
| BRANCHID               | VARCHAR2(256)        | YES  | 分支事务的唯一标识符 |
