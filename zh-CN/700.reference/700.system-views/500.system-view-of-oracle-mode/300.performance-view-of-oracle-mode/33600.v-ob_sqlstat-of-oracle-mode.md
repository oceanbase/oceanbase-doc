...
| SQL_TYPE                      | NUMBER          | NO   | 语句类型 |
| MODULE                        | VARCHAR2(64)    | NO  |   该语句第一次被解析时的应用程序 Module    |
| ACTION                        | VARCHAR2(64)    | NO  |   该语句第一次被解析时的应用程序 Action      |
...
| ROUTE_MISS_TOTAL              | NUMBER          | NO   |   从 OBServer 启动开始，没有命中请求分区的总次数<main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</li> <li>对于 V4.2.x 版本，该字段从 V4.2.2 版本开始引入。</li></ul></main>   |
| ROUTE_MISS_DELTA              | NUMBER          | NO   |   从上次 WR 快照采集开始，没有命中请求分区的次数<main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</li> <li>对于 V4.2.x 版本，该字段从 V4.2.2 版本开始引入。</li></ul></main>   |
...
| PLAN_CACHE_HIT_TOTAL          | NUMBER          | NO   |   从 OBServer 启动开始，命中 Plan Cache 的总次数<main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</li> <li>对于 V4.2.x 版本，该字段从 V4.2.5 版本开始引入。</li></ul></main>   |
| PLAN_CACHE_HIT_DELTA          | NUMBER          | NO   |   从上次 WR 快照采集开始，命中 Plan Cache 的次数<main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</li> <li>对于 V4.2.x 版本，该字段从 V4.2.5 版本开始引入。</li></ul></main>  |
...
| LATEST_ACTIVE_TIME            | TIMESTAMP(6)  | NO   | 某一个节点上 SQL ID + Plan Hash 对应计划的最后一次活跃时间<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.4.x 版本，该字段从 V4.4.2 版本开始引入。</p></main> |
...
查看当前节点中 SQL 的基本性能统计数据，展示第 1 条记录。
