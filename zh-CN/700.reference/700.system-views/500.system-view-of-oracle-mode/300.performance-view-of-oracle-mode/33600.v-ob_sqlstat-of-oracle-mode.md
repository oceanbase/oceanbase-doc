...
| LATEST_ACTIVE_TIME            | TIMESTAMP(6)  | NO   | 某一个节点上 SQL ID + Plan Hash 对应计划的最后一次活跃时间<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.6.x 版本，该字段从 V4.6.0 版本开始引入。</p></main> |
...
*************************** 1. row ***************************
             ...
             DISK_READS_TOTAL: 0
             DISK_READS_DELTA: 0
            BUFFER_GETS_TOTAL: 20
            BUFFER_GETS_DELTA: 0
           ELAPSED_TIME_TOTAL: 8770
...
MAJOR_SSSTORE_READ_ROWS_DELTA: 0
             ...
             ROUTE_MISS_TOTAL: 0
             ROUTE_MISS_DELTA: 0
              FIRST_LOAD_TIME: 24-FEB-26 10.00.08.100573 PM
         PLAN_CACHE_HIT_TOTAL: 11
