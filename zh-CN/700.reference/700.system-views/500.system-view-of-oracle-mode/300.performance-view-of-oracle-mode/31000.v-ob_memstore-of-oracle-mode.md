...
* 展示所有节点上的 MemStore 统计信息：[GV$OB_MEMSTORE](1800.gv-ob_memstore-of-oracle-mode.md)

* 展示当前节点上所有分区的 MemTable 的详细信息：[V$OB_MEMSTORE_INFO](32400.v-ob_memstore_info-of-oracle-mode.md)