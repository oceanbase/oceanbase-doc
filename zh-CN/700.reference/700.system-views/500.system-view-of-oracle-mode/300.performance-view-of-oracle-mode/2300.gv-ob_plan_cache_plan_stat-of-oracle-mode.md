...
| APPLICATION_WAIT_TIME | NUMBER(38)                        | NO             | 该请求执行过程中, 所有 Application 类事件的总时间，单位为微秒                                                                             |
| CONCURRENCY_WAIT_TIME | NUMBER(38)                        | NO             | 该请求执行过程中, 所有 Concurrency 类事件的总时间，单位为微秒                                                                             |
| USER_IO_WAIT_TIME     | NUMBER(38)                        | NO             | 该请求执行过程中, 所有 user_io 类事件的总时间，单位为微秒                                                                                 |
...
| OBJECT_TYPE           | CLOB                              | NO             | 缓存对象的类型：<ul><li>SQL_PLAN</li><li> PROCEDURE   </li><li>FUNCTION</li><li> PACKAGE   </li><li> ANONYMOUS   </li></ul>  |
...
| FORMAT_SQL_ID           | VARCHAR2(32)                    | NO             | 表示当前计划的 Format SQL ID 信息。|
| CACHE_NODE_ID           | NUMBER(38)                      | NO             | 表示对象所属的 Cache Node 节点 ID。 <main id="notice" type='explain'><h4>说明</h4><p>对于 V4.4.2 版本，该字段从 V4.4.2 BP2 版本开始引入。</p></main>|
| PCV_ID                  | NUMBER(38)                      | NO             | 表示对象所属的 Plan Cache Value 节点 ID。 <main id="notice" type='explain'><h4>说明</h4><p>对于 V4.4.2 版本，该字段从 V4.4.2 BP2 版本开始引入。</p></main>|
| PLAN_SET_ID             | NUMBER(38)                      | NO             | 表示对象所属的 Plan Set 节点 ID。 <main id="notice" type='explain'><h4>说明</h4><p>对于 V4.4.2 版本，该字段从 V4.4.2 BP2 版本开始引入。</p></main>|
| CREATE_REASON           | VARCHAR2(16384)                 | NO             | 表示当前计划加入的原因。 <main id="notice" type='explain'><h4>说明</h4><p>对于 V4.4.2 版本，该字段从 V4.4.2 BP2 版本开始引入。</p></main>|
