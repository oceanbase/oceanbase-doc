...
|slug|v-sql_join_filter-oracle-compatible-mode|
...
动态展示本租户在当前 OBServer 节点上 Join Filter 执行的相关信息。
...
用户租户下，查看本租户当前节点上 Join Filter 执行的相关信息。
