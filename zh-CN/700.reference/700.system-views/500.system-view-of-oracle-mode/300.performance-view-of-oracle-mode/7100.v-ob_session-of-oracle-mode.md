...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>对于 V4.2.1 版本，该视图从 V4.2.1 BP5 版本开始引入。</p>
</main>

## 功能描述

视图 `V$OB_SESSION` 用于查询当前租户下 Server 中创建的 Session 信息。
...
| BACKTRACE | VARCHAR2(16384) | NO | 连接引用调用栈 |
| TRANS_STATE | VARCHAR2(32) | NO |  事务状态   |
...
[GV$OB_SESSION](7000.gv-ob_session-of-oracle-mode.md)
