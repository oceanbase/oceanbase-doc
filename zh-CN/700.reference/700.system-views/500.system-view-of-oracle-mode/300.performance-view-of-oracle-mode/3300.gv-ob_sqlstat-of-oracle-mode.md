...
| MODULE                        | VARCHAR2(64)    | YES  |   该语句第一次被解析时的应用程序 Module，通过 `DBMS_APPLICATION_INFO.SET_MODULE` 包设置    |
| ACTION                        | VARCHAR2(64)    | YES  |   该语句第一次被解析时的应用程序 Action，通过 `DBMS_APPLICATION_INFO.SET_ACTION` 包设置      |
...
| FIRST_LOAD_TIME               | TIMESTAMP(6)  | YES   | 执行计划生成时间  |
