...
| OTHERSTAT_3_VALUE       | NUMBER        | NO   | 下压/非下压路径下读取的 Major SSTable 在 Range 范围内的总行数。|
| OTHERSTAT_4_ID          | NUMBER        | NO   | 通过字段 ID 查询字段详细信息。|
| OTHERSTAT_4_TYPE        | NUMBER        | NO   | 预留。|
| OTHERSTAT_4_VALUE       | NUMBER        | NO   | 下压/非下压路径下读取的 Minor SSTable、Mini SSTable、MemTable 行数。|
| OTHERSTAT_5_ID          | NUMBER        | NO   | 预留。|
| OTHERSTAT_5_TYPE        | NUMBER        | NO   | 预留。|
| OTHERSTAT_5_VALUE       | NUMBER        | NO   | 下压路径下打开的微块数。<main id="notice" type='explain'><h4>说明</h4><p>在 V4.5.x 版本中，该字段从 V4.5.0 版本开始生效。</p></main>|
| OTHERSTAT_6_ID          | NUMBER        | NO   | 预留。|
| OTHERSTAT_6_TYPE        | NUMBER        | NO   | 预留。|
| OTHERSTAT_6_VALUE       | NUMBER        | NO   | 下压路径下打开的微块在 Range 范围内的总行数。<main id="notice" type='explain'><h4>说明</h4><p>在 V4.5.x 版本中，该字段从 V4.5.0 版本开始生效。</p></main>|
| OTHERSTAT_7_ID          | NUMBER        | NO   | 预留。|
| OTHERSTAT_7_TYPE        | NUMBER        | NO   | 预留。|
| OTHERSTAT_7_VALUE       | NUMBER        | NO   | 下压/非下压 Filter 过滤的总行数。<main id="notice" type='explain'><h4>说明</h4><p>在 V4.5.x 版本中，该字段从 V4.5.0 版本开始生效。</p></main>|
| OTHERSTAT_8_ID          | NUMBER        | NO   | 预留。|
| OTHERSTAT_8_TYPE        | NUMBER        | NO   | 预留。|
| OTHERSTAT_8_VALUE       | NUMBER        | NO   | 利用 Skip Index 信息而不需要预取的微块数。<main id="notice" type='explain'><h4>说明</h4><p>在 V4.5.x 版本中，该字段从 V4.5.0 版本开始生效。</p></main>|
...
| USER_IO_WAIT_TIME       | NUMBER(38)    | NO   | 取中间层索引和数据微块时 IO wait 的耗时。|
