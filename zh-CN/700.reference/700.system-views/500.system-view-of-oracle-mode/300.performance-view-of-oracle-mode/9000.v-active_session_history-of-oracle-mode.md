...
| TM_DELTA_TIME | NUMBER | NO | 计算 time model 的时间间隔，单位为微秒<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 版本开始引入。</p></main> |
| TM_DELTA_CPU_TIME | NUMBER | NO | 过去 `TM_DELTA_TIME` 时间段内在 CPU 上花费的时间量<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 版本开始引入。</p></main> |
| TM_DELTA_DB_TIME | NUMBER | NO | 过去 `TM_DELTA_TIME` 时间段内在数据库调用中花费的时间量<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 版本开始引入。</p></main> |
| TOP_LEVEL_SQL_ID | CHAR(32) | NO | 顶层 SQL ID<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 版本开始引入。</p></main> |
...
| PLSQL_ENTRY_OBJECT_ID | NUMBER | NO | 顶层 PL 的 OBJECT ID<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 版本开始引入。</p></main> |
| PLSQL_ENTRY_SUBPROGRAM_ID | NUMBER | NO | 顶层 PL 的 Sub project ID<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 版本开始引入。</p></main> |
| PLSQL_ENTRY_SUBPROGRAM_NAME | VARCHAR2(32) | NO | 顶层 PL 的 Sub project name<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 版本开始引入。</p></main> |
| PLSQL_OBJECT_ID | NUMBER | NO | 当前正在执行的 PL object ID<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 版本开始引入。</p></main> |
| PLSQL_SUBPROGRAM_ID | NUMBER | NO | 当前正在执行的 PL subprogram ID<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 版本开始引入。</p></main> |
| PLSQL_SUBPROGRAM_NAME | VARCHAR2(32) | NO | 当前正在执行的 PL subprogram  name<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 版本开始引入。</p></main> |
