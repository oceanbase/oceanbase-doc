...
|slug|v-ob_opt_stat_gather_monitor-oracle-mode|
...
展示当前 OBServer 节点上当前租户的统计信息收集任务的实时状态。
...
| RUNNING_TABLE_PROGRESS      | VARCHAR2(256) | NO   | 收集任务的收集进度 |

## 查询示例

用户租户下，查看本租户在当前节点上的统计信息收集任务的实时状态。
...
* 查看租户级历史统计信息的收集状态：[DBA_OB_TASK_OPT_STAT_GATHER_HISTORY](../200.dictionary-view-of-oracle-mode/15200.dba_ob_task_opt_stat_gather_history-of-oracle-mode.md)

* 查看表级历史统计信息的收集状态：[DBA_OB_TABLE_OPT_STAT_GATHER_HISTORY](../200.dictionary-view-of-oracle-mode/14400.dba_ob_table_opt_stat_gather_history-of-oracle-mode.md)
