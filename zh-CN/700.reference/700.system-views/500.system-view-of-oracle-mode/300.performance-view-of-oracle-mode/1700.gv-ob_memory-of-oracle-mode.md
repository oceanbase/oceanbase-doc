...
<h4>说明</h4>
<ul><li>该视图名从 V4.0.0 版本开始由 V$MEMORY 调整为 V$OB_MEMORY。</li>
<li>该视图当前仅 MySQL 模式支持，Oracle 模式下查询结果为空。</li></ul>
</main>
...
| HOLD        | NUMBER        | NO             | 该 mod 当前占有的内存大小，单位为字节    |
| USED        | NUMBER        | NO             | 该 mod 当前使用的内存数值，单位为字节            |
