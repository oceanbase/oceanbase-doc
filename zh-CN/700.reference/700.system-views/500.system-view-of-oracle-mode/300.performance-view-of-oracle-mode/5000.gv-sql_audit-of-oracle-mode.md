...
| QUERY_SQL               | CLOB            | NO             | 实际的 SQL 语句。<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.5 BP2 版本开始只支持 SYS 租户查看。          |
...
| SEQ_NUM |NUMBER(38)| NO | 事务中的语句序号。</li></ul><main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.5 版本开始引入，字段默认为 NULL。</p></main>|
| PLSQL_COMPILE_TIME              | NUMBER(38)          | NO   |  PL 编译用时。 </li></ul><main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.5 BP2 版本开始引入，字段默认为 NULL。</p></main>   |
| USER_CLIENT_PORT                | NUMBER(38)          | NO   | 用于展示客户端端口号。</li></ul><main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.5 BP2 版本开始引入，字段默认为 NULL。</p></main>     |
| TRANS_STATUS                    | VARCHAR2(256)        | NO   | 用于展示显示开启事务或隐式开启事务或不开启事务。</li></ul><main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.5 BP2 版本开始引入，字段默认为 NULL。</p></main>  |
