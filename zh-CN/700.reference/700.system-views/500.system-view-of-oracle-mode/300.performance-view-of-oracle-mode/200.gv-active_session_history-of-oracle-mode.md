...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <ul>
  <li>该视图从 V4.2.2 版本开始更名为 <a href="900.gv-ob_active_session_history-of-oracle-mode.md">GV$OB_ACTIVE_SESSION_HISTORY</a>。</li>
...
* 查看本租户下所有 OBServer 节点的活跃会话历史记录：[GV$OB_ACTIVE_SESSION_HISTORY](900.gv-ob_active_session_history-of-oracle-mode.md)
* 查看本租户下当前 OBServer 节点的活跃会话历史记录：[V$OB_ACTIVE_SESSION_HISTORY](31200.v-ob_active_session_history-of-oracle-mode.md)
