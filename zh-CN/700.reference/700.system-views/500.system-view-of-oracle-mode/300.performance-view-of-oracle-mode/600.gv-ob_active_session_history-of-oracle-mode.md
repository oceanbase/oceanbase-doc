...
| BLOCKING_SESSION_ID         | NUMBER          | YES  | 如果当前会话被阻塞，显示阻塞该会话的会话 ID，目前仅在锁冲突场景生效，展示持有锁的会话 ID<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.5.x 版本，该字段为预留字段，默认值为 NULL。</p> </main>      |
...
*************************** 1. row ***************************
                   ...
                   SVR_PORT: 2882
                  SAMPLE_ID: 5819676
                SAMPLE_TIME: 29-DEC-25 04.23.33.570793 PM
                     CON_ID: 1004
                    USER_ID: 0
    ...
    IN_REMOTE_DAS_EXECUTION: N
          ...
          IN_CONNECTION_MGR: N
                  ...
                  CLIENT_ID: NULL
                  BACKTRACE: NULL
              TM_DELTA_TIME: 997482
          TM_DELTA_CPU_TIME: 227
           TM_DELTA_DB_TIME: 997482
