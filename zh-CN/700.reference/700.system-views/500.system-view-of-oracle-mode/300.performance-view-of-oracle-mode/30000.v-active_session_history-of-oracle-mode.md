...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <ul><li>该视图从 V4.2.2 版本开始更名为 <a href="31200.v-ob_active_session_history-of-oracle-mode.md">V$OB_ACTIVE_SESSION_HISTORY</a>。</li><li>该视图从 V4.0.0 版本开始引入。</li></ul>
</main>
...
| MODULE | VARCHAR2(64) | NO | 会话在采样时记录的 MODULE 值，通过 `DBMS_APPLICATION_INFO.SET_MODULE` 包设置。<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.3 版本开始可以设置。</p></main> |
