...
```shell
obclient [SYS]> SELECT * FROM SYS.GV$OB_ACTIVE_SESSION_HISTORY WHERE ROWNUM <= 2\G
```
...
*************************** 1. row ***************************
                   ...
                   SVR_PORT: 2882
                  SAMPLE_ID: 4306
                SAMPLE_TIME: 05-AUG-24 02.09.54.814300 PM
                     CON_ID: 1004
                    USER_ID: 0
                 SESSION_ID: 5334349381632
    ...
    IN_REMOTE_DAS_EXECUTION: N
             IN_FILTER_ROWS: N
                  ...
                  CLIENT_ID: NULL
                  BACKTRACE: NULL
              TM_DELTA_TIME: 1227841
          TM_DELTA_CPU_TIME: 1227841
           TM_DELTA_DB_TIME: 1227841
...
*************************** 2. row ***************************
                   ...
                   SVR_PORT: 2882
                  SAMPLE_ID: 4308
                SAMPLE_TIME: 05-AUG-24 02.09.59.836816 PM
                     CON_ID: 1004
                    USER_ID: 0
                 SESSION_ID: 5334349381632
               SESSION_TYPE: BACKGROUND
    ...
    IN_REMOTE_DAS_EXECUTION: N
             IN_FILTER_ROWS: N
                  ...
                  BACKTRACE: NULL
              TM_DELTA_TIME: 21186
          TM_DELTA_CPU_TIME: 21186
           TM_DELTA_DB_TIME: 21186
           TOP_LEVEL_SQL_ID: NULL
       IN_PLSQL_COMPILATION: N
         IN_PLSQL_EXECUTION: N
      PLSQL_ENTRY_OBJECT_ID: NULL
