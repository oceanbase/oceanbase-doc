...
|slug|v-ob_server_schema_info-oracle-compatible-mode|
...
| SCHEMA_COUNT               | NUMBER(38)   | NO         | 对应 Schema 版本下，各 Schema 对象数目的总和                    |
| SCHEMA_SIZE                | NUMBER(38)   | NO         | 对应 Schema 版本下，各 Schema 对象所占的内存总大小，单位为字节                   |
| MIN_SSTABLE_SCHEMA_VERSION | NUMBER(38)   | NO         | 租户 SSTable 上记录的最小 schema_version |

## 查询示例

用户租户查询本租户在当前 OBServer 节点上的 Schema 信息。
