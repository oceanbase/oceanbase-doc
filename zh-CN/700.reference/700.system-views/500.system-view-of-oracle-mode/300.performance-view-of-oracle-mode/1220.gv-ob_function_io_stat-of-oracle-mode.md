...
| MODE                         | VARCHAR2(32) | NO             | IO 对应的读写模式：<ul><li>`LOCAL READ`：本地读</li> <li>`LOCAL WRITE`：本地写</li> <li>`REMOTE READ`：远程读</li> <li>`REMOTE WRITE`：远程写</li></ul>    |
...
* 查看当前 OBServer 节点上 Function 级别的 IO 统计信息：[V$OB_FUNCTION_IO_STAT](31820.v-ob_function_io_stat-of-oracle-mode.md)
