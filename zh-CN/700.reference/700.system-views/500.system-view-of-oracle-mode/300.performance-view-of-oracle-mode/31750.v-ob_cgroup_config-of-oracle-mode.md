...
视图 `V$OB_CGROUP_CONFIG` 用于快捷查询当前 OBServer 节点的 cgroup 配置。视图字段信息来自 OBServer 节点安装目录下的cgroup 目录（如 `/home/admin/oceanbase/cgroup`）。
...
用户租户下，查询当前 OBServer 节点的 cgroup 配置。    
...
更多 cgroup 配置相关信息，参见 [配置 cgroup](../../../../600.manage/200.tenant-management/600.common-tenant-operations/300.resource-isolation/200.resource-isolation-of-oracle-mode/100.config-cgroups-of-oracle-mode.md)。