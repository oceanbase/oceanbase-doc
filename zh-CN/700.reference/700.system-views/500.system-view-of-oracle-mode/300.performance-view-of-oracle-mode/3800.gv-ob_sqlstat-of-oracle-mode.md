...
| LATEST_ACTIVE_TIME            | TIMESTAMP(6)  | YES  | 某一个节点上 SQL ID + Plan Hash 对应计划的最后一次活跃时间<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.4.x 版本，该字段从 V4.4.2 版本开始引入。</p></main> |
