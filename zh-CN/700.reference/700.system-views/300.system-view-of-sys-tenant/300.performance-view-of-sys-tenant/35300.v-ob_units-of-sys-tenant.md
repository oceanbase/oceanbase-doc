...
| REPLICA_TYPE     | varchar(7)   | NO         | 副本类型，默认为 `FULL` <main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.4.x 版本，字段 <code>REPLICA_TYPE</code> 从 V4.4.2 版本开始引入。</li><li>对于 V4.2.5 版本，字段 <code>REPLICA_TYPE</code> 从 V4.2.5 BP7 版本开始引入。</li></ul></main>   |
