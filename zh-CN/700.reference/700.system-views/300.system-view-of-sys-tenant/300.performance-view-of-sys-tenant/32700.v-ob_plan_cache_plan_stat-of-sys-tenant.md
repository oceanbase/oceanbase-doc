...
| FORMAT_SQL_ID           | varchar(32)       | NO         | 表示当前计划的 Format SQL ID 信息。<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.4.0 版本开始引入。</p></main>|
| CACHE_NODE_ID           | bigint(20)        | NO         | 表示对象所属的 Cache Node 节点 ID。<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.6.0 版本开始引入。</p></main>|
| PCV_ID                  | bigint(20)        | NO         | 表示对象所属的 Plan Cache Value 节点 ID。<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.6.0 版本开始引入。</p></main>|
| PLAN_SET_ID             | bigint(20)        | NO         | 表示对象所属的 Plan Set 节点 ID。<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.6.0 版本开始引入。</p></main>|
| CREATE_REASON           | varchar(4096)     | NO         | 表示当前计划加入的原因。<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.6.0 版本开始引入。</p></main>|
