...
视图 `V$OB_CGROUP_CONFIG` 用于快捷查询当前 OBServer 节点的 cgroup 配置。视图字段信息来自 OBServer 节点安装目录下的 cgroup 目录（如 `/home/admin/oceanbase/cgroup`）。
...
sys 租户下，查询当前 OBServer 节点的 cgroup 配置。
