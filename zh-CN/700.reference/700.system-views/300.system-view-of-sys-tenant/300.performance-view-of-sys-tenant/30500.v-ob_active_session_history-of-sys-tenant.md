...
| GROUP_ID                    | bigint(20)          | NO | 采样点的 Group 信息。     |
...
| CLIENT_ID                   | varchar(64)         | NO | 会话在采样时记录的 CLIENT_ID 值，通过 `DBMS_APPLICATION_INFO.SET_IDENTIFIER` 包设置。 |
...
查看所有租户下当前 OBServer 节点的活跃会话历史记录。
...
*************************** 1. row ***************************
                   ...
                   SVR_PORT: 2882
                  SAMPLE_ID: 2254319
                SAMPLE_TIME: 2024-12-11 11:32:35.756098
                     CON_ID: 1003
                    USER_ID: 0
