...
展示所有租户在当前 OBServer 节点上 RPC 的发送统计信息。
...
系统租户下，查看租户 ID 为 1004 的租户在当前节点发送的 RPC 请求，展示前 10 条记录。
...
* 查看所有租户在所有节点发送的 PRC 统计信息：[GV$OB_RPC_OUTGOING](4200.gv-obrpc_outgoing-of-sys-tenant.md)

* 查看所有租户在当前节点收到的 RPC 的统计信息：[V$OB_RPC_INCOMING](34600.v-obrpc_incoming-of-sys-tenant.md)
