...
* 查看所有租户当前节点已完成的 Compaction 相关的统计信息：[V$OB_MERGE_INFO](32200.v-ob_merge_info-of-sys-tenant.md)

* 查看所有租户所有节点上 Tablet 级 Compaction 的进度信息：[GV$OB_TABLET_COMPACTION_PROGRESS](4400.gv-ob_tablet_compaction_progress-of-sys-tenant.md)

* 查看所有租户所有节点上 Tablet 级 Compaction 的历史信息：[GV$OB_TABLET_COMPACTION_HISTORY](4300.gv-ob_tablet_compaction_history-of-sys-tenant.md)

* 查看所有租户各个 Zone 的合并信息：[CDB_OB_ZONE_MAJOR_COMPACTION](../200.dictionary-view-of-sys-tenant/12000.o-cdb_ob_zone_major_compaction-of-sys-tenant.md)

* 查看所有租户的合并全局信息：[CDB_OB_MAJOR_COMPACTION](../200.dictionary-view-of-sys-tenant/10000.o-cdb_ob_major_compaction-of-sys-tenant.md)
