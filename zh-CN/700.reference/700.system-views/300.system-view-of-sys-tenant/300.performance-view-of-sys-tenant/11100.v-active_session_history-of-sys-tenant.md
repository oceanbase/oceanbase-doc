...
视图 `V$ACTIVE_SESSION_HISTORY` 展示所有租户下当前 OBServer 节点中活跃会话的历史记录。
...
| TABLET_ID               | bigint(20)   | NO  | 会话在采样时记录的 Tablet 的 ID<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.2.1 版本，该字段从 V4.2.1 BP10 版本开始引入。</p></main>      |

## 查询示例

查询所有租户下当前 OBServer 节点中活跃会话的历史记录。
...
[GV$ACTIVE_SESSION_HISTORY](3100.gv-active_session_history-of-sys-tenant.md)
