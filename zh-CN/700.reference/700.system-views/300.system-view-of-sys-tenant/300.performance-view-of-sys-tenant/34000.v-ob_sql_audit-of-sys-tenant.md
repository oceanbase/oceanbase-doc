...
| MEMSTORE_READ_ROW_COUNT | bigint(20)          | NO             | 做 Filter 前从 MemStore 读取的行数 |
| SSSTORE_READ_ROW_COUNT  | bigint(20)          | NO             | 下压/非下压路径下读取的 Major SSTable、Minor SSTable、Mini SSTable 行数 |
...
| BLOCKSCAN_BLOCK_CNT     | bigint(20)          | NO            | 下压路径下打开的微块数 |
| BLOCKSCAN_ROW_CNT       | bigint(20)          | NO            | 下压路径下打开的微块在 Range 范围内的总行数 |
| PUSHDOWN_STORAGE_FILTER_ROW_CNT | bigint(20)  | NO            | 下压/非下压 Filter 过滤的总行数 |
...
| TX_TABLE_READ_CNT       | bigint(20)          | NO            | 查询读事务状态表的次数。<main id="notice" type='explain'><h4>说明</h4><p>在 V4.5.x 版本中，该字段从 V4.5.0 版本开始引入。</p></main>|
| OUTROW_LOB_CNT          | bigint(20)          | NO            | 查询过程中，读取到的 outrow lob 列的数量。<main id="notice" type='explain'><h4>说明</h4><p>在 V4.5.x 版本中，该字段从 V4.5.0 版本开始引入。</p></main>|
...
| OBJECT_STORAGE_READS    | bigint(20)          | NO            | <ul><li>共享存储（Shared-Storage，SS）模式下，表示读对象存储的次数。</li><li>无共享（Shared-Nothing，SN）模式下，取值恒为 0。</li></ul><main id="notice" type='explain'><h4>说明</h4><p>在 V4.6.x 版本中，该字段从 V4.6.0 版本开始引入。</p></main> |
