...
SS 模式下，系统租户查看租户 ID 为 `1002` 的租户在当前 OBServer 节点上的整体缓存情况。

```shell
obclient> SELECT SVR_IP, SVR_POR, TENANT_ID, TABLET_ID, STORAGE_CACHE_POLICY, INFO FROM oceanbase.V$OB_TABLET_LOCAL_CACHE WHERE TENANT_ID = 1002;
```
