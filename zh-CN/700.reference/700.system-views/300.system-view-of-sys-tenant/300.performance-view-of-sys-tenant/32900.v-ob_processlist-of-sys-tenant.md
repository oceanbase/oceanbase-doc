...
| USER_CLIENT_PORT  | bigint(20)          | NO   | 客户端地址信息<main id="notice" type='explain'><h4>说明</h4><ul><li>在 V4.3.x 版本中，该字段从 V4.3.2 版本开始引入。</li><li>在 V4.2.x 版本中，该字段从 V4.2.3 版本开始引入。</li></ul></main>|
...
*************************** 1. row ***************************
   ...
   USER_CLIENT_IP: xx.xx.xx.xx
        ...
        RETRY_CNT: 0
       RETRY_INFO: 0
           SQL_ID: AFC78717E0B976D0DC70A25E11A4DD96
         TRANS_ID: 0
        THREAD_ID: 87893
       SSL_CIPHER: NULL
