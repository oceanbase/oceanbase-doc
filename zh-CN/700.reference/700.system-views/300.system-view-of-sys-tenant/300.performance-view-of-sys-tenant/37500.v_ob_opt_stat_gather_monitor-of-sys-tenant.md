...
展示当前 OBServer 节点上所有租户的统计信息收集任务的实时状态。
...
系统租户下，查看租户 ID 为 1006 的租户在当前节点上的统计信息收集任务的实时状态。
...
* 查看租户级历史统计信息的收集状态：[DBA_OB_TASK_OPT_STAT_GATHER_HISTORY](../200.dictionary-view-of-sys-tenant/21900.o-dba_ob_task_opt_stat_gather_history-of-sys-tenant.md)

* 查看表级历史统计信息的收集状态：[DBA_OB_TABLE_OPT_STAT_GATHER_HISTORY](../200.dictionary-view-of-sys-tenant/21100.o-dba_ob_table_opt_stat_gather_history-of-sys-tenant.md)
