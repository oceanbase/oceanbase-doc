...
| FORMATID               | bigint(20)          | NO   | 全局事务的格式标识符 |
| GLOBALID               | varchar(257)        | YES  | 全局事务唯一标识符 |
| BRANCHID               | varchar(257)        | YES  | 分支事务的唯一标识符 |

## 查询示例

查询所有 Server 的事务 Scheduler 信息。
