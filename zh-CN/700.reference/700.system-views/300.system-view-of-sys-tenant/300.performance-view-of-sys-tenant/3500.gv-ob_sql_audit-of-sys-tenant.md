...
| FORMAT_SQL_ID                   | varchar(32)         | NO   | <main id="notice" type='explain'><h4>说明</h4><ul><li>在 V4.3.x 版本中，该字段从 V4.3.2 版本开始引入，但该字段功能暂不支持。</li><li>在 V4.2.x 版本中，该字段从 V4.2.3 版本开始引入。</li></ul></main>|
| STMT_TYPE                       | varchar(128)        | YES  | <main id="notice" type='explain'><h4>说明</h4><ul><li>在 V4.3.x 版本中，该字段从 V4.3.2 版本开始引入，但该字段功能暂不支持。</li><li>在 V4.2.x 版本中，该字段从 V4.2.3 版本开始引入。</li></ul></main>|
| NETWORK_WAIT_TIME               | bigint(20) unsigned | YES  | <main id="notice" type='explain'><h4>说明</h4><ul><li>在 V4.3.x 版本中，该字段从 V4.3.2 版本开始引入，但该字段功能暂不支持。</li><li>在 V4.2.x 版本中，该字段从 V4.2.3 版本开始引入。</li></ul></main>|
