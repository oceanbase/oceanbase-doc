...
| NETWORK_WAIT_TIME               | bigint(20) unsigned | YES  | 所有 Network 类事件的总时间，单位为微秒<main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。</li> <li>对于 V4.2.x 版本，该字段从 V4.2.3 版本开始引入。</li></ul></main>     |
