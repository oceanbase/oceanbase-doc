...
|slug|gv-active_session_history-of-sys-tenant|

# GV$ACTIVE_SESSION_HISTORY

<main id="notice" type='explain'>
  <h4>说明</h4>
  <ul><li>该视图从 V4.2.2 版本开始更名为 <a href="800.gv-ob_active_session_history-of-sys-tenant.md">GV$OB_ACTIVE_SESSION_HISTORY</a>。</li>
  <li>该视图从 V4.0.0 版本开始引入。</li></ul>
</main>

## 功能描述

视图 `GV$ACTIVE_SESSION_HISTORY` 展示所有租户下所有 OBServer 节点的活跃会话历史记录。
...
* 查看所有租户下所有 OBServer 节点的活跃会话历史记录：[GV$OB_ACTIVE_SESSION_HISTORY](800.gv-ob_active_session_history-of-sys-tenant.md)
