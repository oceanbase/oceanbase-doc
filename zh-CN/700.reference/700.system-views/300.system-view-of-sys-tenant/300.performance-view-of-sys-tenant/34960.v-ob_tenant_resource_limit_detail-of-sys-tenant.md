...
|slug|v-ob_tenant_resource_limit_detail-of-sys-tenant|
...
视图 `V$OB_TENANT_RESOURCE_LIMIT_DETAIL` 用于展示所有租户在本 OBServer 上的逻辑资源所受的限制，以及每种限制的上限值。
...
查询所有租户在本 OBServer 上的逻辑资源所受的限制，以及每种限制的上限值。
