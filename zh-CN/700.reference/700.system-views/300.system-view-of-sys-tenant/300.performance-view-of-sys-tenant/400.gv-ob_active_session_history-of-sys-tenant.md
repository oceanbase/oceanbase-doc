...
| WEIGHT                      | bigint(20)          | NO   | WR 中一条落盘 ASH 记录的权重，默认为 1。<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.4.x 版本，该字段从 V4.4.2 版本开始引入。</p></main>     |
| IS_WR_WEIGHT_SAMPLE         | varchar(1)          | NO   | 是否为队列积压等待事件的压缩列。<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.4.x 版本，该字段从 V4.4.2 版本开始引入。</p></main>     |
