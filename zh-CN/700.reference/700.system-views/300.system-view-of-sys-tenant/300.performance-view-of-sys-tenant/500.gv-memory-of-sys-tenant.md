...
<main id="notice" type='explain'>
  ...
  <p>视图 <code>GV$MEMORY</code> 从 V4.0.0 版本开始更名为 <code>GV$OB_MEMORY</code>，V4.0.0 及之后版本需要使用新视图名 <code>GV$OB_MEMORY</code> 来查询，使用原视图名 <code>GV$MEMORY</code> 查询将会报错。</p>
</main>
...
系统租户下查看租户 ID 为 1002 的租户在所有节点上的内存统计信息，展示前 10 条记录。
