...
<main id="notice" type='explain'>
 <h4>说明</h4>
  <ul>
   ...
   <li>在 V4.x 版本中，可以通过视图 <a href="../200.dictionary-view-of-sys-tenant/6400.oceanbase-dba_objects-of-sys-tenant.md">oceanbase.DBA_OBJECTS</a> 和 <a href="../200.dictionary-view-of-sys-tenant/17800.oceanbase-dba_ob_table_locations-of-sys-tenant.md">oceanbase.DBA_OB_TABLE_LOCATIONS</a> 查询数据库对象和表的相关信息。 </li>
 </ul>
</main>

## 功能描述

视图 `GV$TABLE` 展示整个集群中所有表的 Meta 信息。
...
| table_type         | bigint(20)    | NO             | 表类型：<li>0：系统表<li>1：系统视图<li>2：虚拟表<li>3：用户表<li>4：用户视图<li>5：索引<li>6：临时表 <li>（暂不支持）7：物化视图  |
