...
| SESSION_ID | bigint(20)   | NO   | 持锁或请求锁的会话 ID <main id="notice" type='explain'><h4>说明</h4><p><ul><li>在 V4.3.x 版本中，该字段从 V4.3.2 版本开始引入。</li><li>在 V4.2.x 版本中，该字段从 V4.2.5 版本开始引入。</li></ul></p></main>|
