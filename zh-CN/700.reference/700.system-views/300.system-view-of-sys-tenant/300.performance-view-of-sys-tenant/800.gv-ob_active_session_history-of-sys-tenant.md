...
视图 `GV$OB_ACTIVE_SESSION_HISTORY` 用于展示所有租户下所有 OBServer 节点的活跃会话历史记录。
...
查看所有租户下所有 OBServer 节点的活跃会话历史记录。
...
* 查看所有租户下当前 OBServer 节点的活跃会话历史记录：[V$OB_ACTIVE_SESSION_HISTORY](30900.v-ob_active_session_history-of-sys-tenant.md)
