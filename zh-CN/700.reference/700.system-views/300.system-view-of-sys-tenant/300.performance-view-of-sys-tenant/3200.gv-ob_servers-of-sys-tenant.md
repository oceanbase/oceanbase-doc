...
| MEM_CAPACITY            | bigint(20)   | NO         | OBServer 节点可使用的总内存大小，值为 `memory_limit - system_memory`，单位为字节    |
...
+----------------+----------+-------+----------+--------------+------------------+--------------+------------------+--------------+--------------+-------------------+-------------------+-----------------+--------------------+--------------------+------------------+-------------------------+--------------+---------------------+-------------------------+-----------------------+
| 172.xx.xxx.xxx |     2882 | zone1 |     2881 |           64 |               64 |            8 |                8 |  75161927680 |  18253611008 |      179583320064 |       56103010304 |     14763950080 |       179593805824 |               NULL |       4301258752 | NORMAL                  | 107374182400 |        179593805824 | NULL                    | NULL                  |
+----------------+----------+-------+----------+--------------+------------------+--------------+------------------+--------------+--------------+-------------------+-------------------+-----------------+--------------------+--------------------+------------------+-------------------------+--------------+---------------------+-------------------------+-----------------------+
1 row in set
```
