...
| DATA_DISK_CAPACITY      | bigint(20)   | NO         | 表示 OBServer 节点上数据盘空间总大小，单位为字节。  |
| DATA_DISK_ASSIGNED      | bigint(20)   | YES        | 该字段值为 `NULL` ，表示未定义，允许竞争使用其他租户的磁盘空间。<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.3.3 版本开始引入。</p></main>    |
| DATA_DISK_IN_USE        | bigint(20)   | NO         | 表示 OBServer 节点已使用的数据盘大小，单位为字节。  |
| DATA_DISK_HEALTH_STATUS | varchar(20)  | NO         | 数据盘健康状态：<ul><li> `NORMAL`：正常状态 </li><li>`WARNING`：存在异常</li><li>`ERROR`：存在错误 </li></ul>   |
...
| SS_DATA_DISK_OPERATION_SUGGESTED | varchar(32)| YES  | 该字段值为 `NULL`。  <main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.4.x 版本，该字段从 V4.4.0 版本开始引入。</li><li>对于 V4.3.5 版本，该字段从 V4.3.5 BP2 版本开始引入。</li></ul></main>     |
| SS_DATA_DISK_SIZE_SUGGESTED      | bigint(20) | YES  | 该字段值为 `NULL`。  <main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.4.x 版本，该字段从 V4.4.0 版本开始引入。</li><li>对于 V4.3.5 版本，该字段从 V4.3.5 BP2 版本开始引入。</li></ul></main>    |
