...
| MEMORY_LIMIT            | bigint(20)   | NO         | OBServer 进程可用的内存大小    |
| DATA_DISK_ALLOCATED     | bigint(20)   | NO         | OBServer 已分配的数据盘大小<main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.0 版本开始引入。</p></main>    |
