...
| MDS_FILTER_INFO                 | varchar(1024) | NO  | 展示合并使用的 MDS 过滤信息 <main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.4.x 版本，该字段从 V4.4.0 版本开始引入生效。</li><li>对于 V4.3.5 版本，该字段从 V4.3.5 版本开始引入，从 V4.3.5 BP2 版本开始生效。</li></ul></main> |
...
* 查看所有节点上 Tablet 级的合并的详细历史信息：[GV$OB_TABLET_COMPACTION_HISTORY](4300.gv-ob_tablet_compaction_history-of-sys-tenant.md)

* 查看当前节点上 Tablet 级 Compaction 的进度信息：[V$OB_TABLET_COMPACTION_PROGRESS](34800.v-ob_tablet_compaction_progress-of-sys-tenant.md)
