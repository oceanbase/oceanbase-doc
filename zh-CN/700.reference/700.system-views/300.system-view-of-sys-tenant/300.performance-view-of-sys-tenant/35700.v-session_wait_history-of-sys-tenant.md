...
视图 `V$SESSION_WAIT_HISTORY` 用于展示每个 Session 当前等待事件明细，最近 10 次等待事件。
...
查询每个 Session 当前等待事件明细，最近 10 次等待事件。
...
*************************** 1. row ***************************
                  ...
                  SVR_PORT: 2882
                    ...
                    P3TEXT:
                        P3: 0
                 WAIT_TIME: 174572146997.0574
           WAIT_TIME_MICRO: 1745721469970574
