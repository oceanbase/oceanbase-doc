...
|slug|gv-obrpc_outgoing-of-sys-tenant|
...
| COUNT          | bigint(20)   | NO             | 发送 RPC 的次数                  |
| TOTAL_TIME     | bigint(20)   | NO             | 总共花费时间，单位为微秒                |
| TOTAL_SIZE     | bigint(20)   | NO             | 总共发送的数据量大小，单位为字节            |
| FAILURE        | bigint(20)   | NO             | 发送失败的次数                |
| TIMEOUT        | bigint(20)   | NO             | 发送超时的次数                |
| SYNC           | bigint(20)   | NO             | 同步等待 RPC 请求的个数         |
| ASYNC          | bigint(20)   | NO             | 异步回调 RPC 请求的个数         |
...
* 查看所有租户在当前节点发送的 PRC 统计信息：[V$OB_RPC_OUTGOING](34700.v-obrpc_outgoing-of-sys-tenant.md)

* 查看所有租户在所有节点收到的 RPC 的统计信息：[GV$OB_RPC_INCOMING](4100.gv-obrpc_incoming-of-sys-tenant.md)
