...
系统租户查看本 OBServer 节点上配置项 `large_query_threshold` 的详细信息。

```shell
obclient [oceanbase]> SELECT * FROM oceanbase.V$OB_PARAMETERS WHERE NAME='large_query_threshold'\G
```
...
* [GV$OB_PARAMETERS](600.gv-ob_parameters-of-sys-tenant.md)
