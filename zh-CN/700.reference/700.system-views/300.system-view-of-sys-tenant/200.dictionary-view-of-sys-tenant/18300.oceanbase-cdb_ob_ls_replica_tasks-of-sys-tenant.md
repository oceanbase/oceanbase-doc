...
| DATA_SOURCE_SVR_IP     | varchar(46)    | YES                | 数据源 IP <main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 BP8 版本开始引入。</p></main>      |
| DATA_SOURCE_SVR_PORT   | bigint(20)     | YES                | 数据源 PORT <main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 BP8 版本开始引入。</p></main>    |
| IS_MANUAL              | varchar(6)     | NO                 | 容灾任务来源，可取值：<ul><li>`TRUE`：表示手动运维命令触发的容灾任务</li><li>`FALSE`：默认值，表示 RS 层容灾自动生成的容灾任务</li></ul> <main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.1 BP8 版本开始引入。</p></main>    |
