...
| STATUS | varchar(64) | NO | 任务状态：<ul><li>`COMPLETED`：任务执行成功 </li><li>`FAILED`：任务执行失败 </li><li>`CANCELED`：任务取消 </li></ul>|
...
* 查看所有租户正在执行的 Tablet 级别的负载均衡任务（Task）：[CDB_OB_TRANSFER_TASKS](11600.o-cdb_ob_transfer_tasks-of-sys-tenant.md)
