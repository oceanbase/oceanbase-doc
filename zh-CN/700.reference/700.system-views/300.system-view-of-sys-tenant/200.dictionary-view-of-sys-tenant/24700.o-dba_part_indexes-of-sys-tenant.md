...
| DEF_INITIAL_EXTENT        | varchar(40)   | NO         | 默认值为 NULL                                              |
| DEF_NEXT_EXTENT           | varchar(40)   | NO         | 默认值为 NULL                                             |
| DEF_MIN_EXTENTS           | varchar(40)   | NO         | 默认值为 NULL                                          |
| DEF_MAX_EXTENTS           | varchar(40)   | NO         | 默认值为 NULL                                           |
| DEF_MAX_SIZE              | varchar(40)   | NO         | 默认值为 NULL                                              |
| DEF_PCT_INCREASE          | varchar(40)   | NO         | 默认值为 NULL                                          |
