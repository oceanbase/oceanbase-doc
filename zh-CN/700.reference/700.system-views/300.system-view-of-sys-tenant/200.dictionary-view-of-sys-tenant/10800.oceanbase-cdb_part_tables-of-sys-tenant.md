...
|dir-name-en||
|tenant-type||
|slug|oceanbase-cdb_part_tables-of-sys-tenant|
...
| DEF_INMEMORY              | varchar(8)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL                              |
| DEF_INMEMORY_PRIORITY     | varchar(8)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL                                      |
| DEF_INMEMORY_DISTRIBUTE   | varchar(15)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL                         |
| DEF_INMEMORY_COMPRESSION  | varchar(17)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL    |
| DEF_INMEMORY_DUPLICATE    | varchar(13)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL                               |
...
| DEF_INMEMORY_SERVICE      | varchar(12)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL                     |
| DEF_INMEMORY_SERVICE_NAME | text          | NO         | 目前暂不支持该字段，当前该字段默认为 NULL          |
