...
| REPLICA_TYPE     | varchar(18)   | NO  | 资源池支持的副本类型：<ul><li>`FULL`：支持所有的副本类型，不仅仅包括全功能类型副本   </li><li> `LOGONLY`：仅支持日志型副本   </li><li> `READONLY`：仅支持只读型副本   </li><li> `ENCRYPTION_LOGONLY`：仅支持加密日志型副本   </li><li> `NULL`：未知的副本类型 </li></ul>   |
