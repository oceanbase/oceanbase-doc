...
视图 `CDB_OB_SYS_VARIABLES` 展示所有租户的系统变量（包含名称以 "_" 开头的隐藏变量）信息。
...
| SCOPE       | varchar(16)    | NO | 作用范围，取值如下：<ul><li>GLOBAL_ONLY：租户级变量</li><li>SESSION_ONLY：Session 级变量</li><li>GLOBAL &#124; SESSION：租户级和 Session 级变量</li></ul>  |
