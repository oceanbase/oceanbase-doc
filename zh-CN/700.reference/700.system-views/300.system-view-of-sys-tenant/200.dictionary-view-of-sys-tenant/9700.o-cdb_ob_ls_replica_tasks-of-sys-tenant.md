...
* 查看当前租户正在运行中的 Replica 级别的容灾任务：[DBA_OB_LS_REPLICA_TASKS](19400.o-dba_ob_ls_replica_tasks-of-sys-tenant.md)

* 查看当前租户 Replica 级别容灾任务的执行历史：[DBA_OB_LS_REPLICA_TASK_HISTORY](19300.o-dba_ob_ls_replica_task_history-of-sys-tenant.md)

* 查看所有租户 Replica 级别容灾任务的执行历史：[CDB_OB_LS_REPLICA_TASK_HISTORY](9600.o-cdb_ob_ls_replica_task_history-of-sys-tenant.md)
