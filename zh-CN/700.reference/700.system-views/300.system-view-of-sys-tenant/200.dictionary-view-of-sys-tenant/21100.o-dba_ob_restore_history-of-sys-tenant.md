...
* 查看所有租户已完成的租户级恢复任务：[CDB_OB_RESTORE_HISTORY](10300.o-cdb_ob_restore_history-of-sys-tenant.md)

* 查看所有租户物理恢复任务当前的执行进度：[CDB_OB_RESTORE_PROGRESS](10400.o-cdb_ob_restore_progress-of-sys-tenant.md)
