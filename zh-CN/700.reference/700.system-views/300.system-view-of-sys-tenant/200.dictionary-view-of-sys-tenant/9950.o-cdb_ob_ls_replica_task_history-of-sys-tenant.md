...
视图 `CDB_OB_LS_REPLICA_TASK_HISTORY` 用于展示所有租户容灾任务的执行历史。
...
* 查看当前租户容灾任务的执行历史：[DBA_OB_LS_REPLICA_TASK_HISTORY](20450.o-dba_ob_ls_replica_task_history-of-sys-tenant.md)
