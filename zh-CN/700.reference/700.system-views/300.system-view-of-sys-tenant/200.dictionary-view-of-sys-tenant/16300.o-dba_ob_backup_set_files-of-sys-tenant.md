...
| FILE_STATUS | varchar(64) | NO | 备份集的文件状态：<<ul><li>li>COPYING：表示文件正在备份中</li><li>AVAILABLE：表示该备份为有效的备份</li><li>DELETING：表示文件正在删除</li><li>EXPIRED：表示备份文件已失效</li><li>INCOMPLETE：表示备份文件有缺失</li><li>BROKEN：表示备份的文件不完整，不可使用</li><li>DELETED：表示备份文件已删除</li></ul> |
