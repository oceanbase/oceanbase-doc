...
查看本租户已执行的 Transfer Partition 任务历史。
...
* 查看当前租户正在处理的 Transfer Partition 任务：[oceanbase.DBA_OB_TRANSFER_PARTITION_TASKS](23200.o-dba_ob_transfer_partition_tasks-of-sys-tenant.md)

* 查看所有租户已执行的 Transfer Partition 任务历史：[oceanbase.CDB_OB_TRANSFER_PARTITION_TASK_HISTORY](11600.o-cdb_ob_transfer_partition_tasks_history-of-sys-tenant.md)

* 有关 Transfer Partition 的详细操作，参见 [Transfer Partition](../../../../600.manage/300.replica-management/500.load-balancing-manage/200.transfer-partition-management.md)。

* 有关数据负载均衡的更多操作，参见 [数据负载均衡](../../../../600.manage/300.replica-management/500.load-balancing-manage/100.load-balancing-overview.md) 章节。