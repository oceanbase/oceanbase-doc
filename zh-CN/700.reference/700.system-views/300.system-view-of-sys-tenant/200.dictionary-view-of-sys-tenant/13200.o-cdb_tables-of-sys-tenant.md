...
| CLUSTERING                | varchar(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| ACTIVITY_TRACKING         | varchar(23)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| DML_TIMESTAMP             | varchar(25)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| HAS_IDENTITY              | varchar(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| CONTAINER_DATA            | varchar(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
...
| DEFAULT_COLLATION         | varchar(100)  | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| DUPLICATED                | varchar(1)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| SHARDED                   | varchar(1)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| EXTERNALLY_SHARDED        | varchar(1)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| EXTERNALLY_DUPLICATED     | varchar(1)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| EXTERNAL                  | varchar(3)    | NO         | 指示表是否为外部表：<li>YES<li>NO   |
| HYBRID                    | varchar(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| CELLMEMORY                | varchar(24)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| CONTAINERS_DEFAULT        | varchar(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| CONTAINER_MAP             | varchar(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| EXTENDED_DATA_LINK        | varchar(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| EXTENDED_DATA_LINK_MAP    | varchar(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| INMEMORY_SERVICE          | varchar(12)   | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| INMEMORY_SERVICE_NAME     | varchar(1000) | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| CONTAINER_MAP_OBJECT      | varchar(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| MEMOPTIMIZE_READ          | varchar(8)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| MEMOPTIMIZE_WRITE         | varchar(8)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| HAS_SENSITIVE_COLUMN      | varchar(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| ADMIT_NULL                | varchar(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| DATA_LINK_DML_ENABLED     | varchar(3)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
| LOGICAL_REPLICATION       | varchar(8)    | NO         | 目前暂不支持该字段，当前该字段默认为 NULL |
