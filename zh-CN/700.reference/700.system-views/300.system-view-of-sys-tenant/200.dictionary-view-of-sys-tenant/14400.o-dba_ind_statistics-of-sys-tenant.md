...
| OBJECT_TYPE | varchar(12) | NO | 对象类型：<ul><li>INDEX</li><li>PARTITION</li><li>SUBPARTITION </li></ul> |
...
| GLOBAL_STATS            | varchar(3) | NO | 指示统计信息是否被收集或增量维护：<ul><li>YES</li><li>NO </li></ul> |
| USER_STATS              | varchar(3) | NO | 指示统计信息是否由用户直接输入：<ul><li>YES</li><li>NO </li></ul> |
...
* 查看表级的列统计信息：[DBA_TAB_STATISTICS](25800.o-dba_tab_statistics-of-sys-tenant.md)

* 查看 Global 级的列统计信息：[DBA_TAB_COL_STATISTICS](25400.o-dba_tab_col_statistics-of-sys-tenant.md)

* 查看 Partition 级的列统计信息：[DBA_PART_COL_STATISTICS](23500.o-dba_part_col_statistics-of-sys-tenant.md)

* 查看 Subpartition 级的列统计信息：[DBA_SUBPART_COL_STATISTICS](25000.o-dba_subpart_col_statistics-of-sys-tenant.md)

* 查看表级的直方图统计信息：[DBA_TAB_HISTOGRAMS](25500.o-dba_tab_histograms-of-sys-tenant.md)

* 查看 Partition 级的直方图统计信息：[DBA_PART_HISTOGRAMS](23600.o-dba_part_histograms-of-sys-tenant.md)

* 查看 Subpartition 级的直方图统计信息：[DBA_SUBPART_HISTOGRAMS](25100.o-dba_subpart_histograms-of-sys-tenant.md)
