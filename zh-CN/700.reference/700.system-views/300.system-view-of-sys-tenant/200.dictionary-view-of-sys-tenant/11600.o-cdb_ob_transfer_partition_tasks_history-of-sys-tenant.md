...
查看租户 ID 为 1006 的租户已执行的 Transfer Partition 任务历史。
...
* 查看所有租户正在处理的 Transfer Partition 任务：[oceanbase.CDB_OB_TRANSFER_PARTITION_TASKS](11500.o-cdb_ob_transfer_partition_tasks-of-sys-tenant.md)
