...
| JOB_STATUS  | varchar(128) | NO  | 任务状态：<ul><li> `INPROGRESS`：进行中   </li><li> `SUCCESS`：成功   </li><li> `FAILED`：失败</li></ul>    |
...
| TENANT_ID   | bigint(20)   | YES | 租户 ID：<ul><li>`NULL`：Unit 不属于任何租户   </li><li> 有效值：Unit 所属的租户 ID </li></ul>   |
