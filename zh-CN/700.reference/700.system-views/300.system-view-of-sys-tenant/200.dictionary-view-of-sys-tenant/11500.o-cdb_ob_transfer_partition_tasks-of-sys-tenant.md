...
* 查看本租户当前正在处理的分区 Transfer 任务：[oceanbase.DBA_OB_TRANSFER_PARTITION_TASKS](23200.o-dba_ob_transfer_partition_tasks-of-sys-tenant.md)

* 查看本租户已执行的 Transfer Partition 任务历史：[oceanbase.DBA_OB_TRANSFER_PARTITION_TASK_HISTORY](23300.o-dba_ob_transfer_partition_tasks_history-of-sys-tenant.md)
