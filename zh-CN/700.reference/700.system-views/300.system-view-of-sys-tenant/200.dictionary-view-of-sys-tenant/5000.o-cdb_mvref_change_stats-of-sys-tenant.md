...
| RETRY_ID        | bigint(20)   | NO   | 表示该变更记录所属的重试批次 ID。 <main id="notice" type='explain'><h4>说明</h4><p><ul><li>对于 V5.x 版本，该字段从 V5.0.1 版本开始引入。</li><li>对于 V4.4.2 版本，该字段从 V4.4.2 BP2 版本开始引入。</li></ul></p></main>|
