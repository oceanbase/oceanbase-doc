...
| POSITION_IN_UNIQUE_CONSTRAINT | null         | NO         | 当前该字段默认为 NULL |
| REFERENCED_TABLE_SCHEMA       | varchar(128) | NO         | 当前该字段默认为 NULL                                                                                  |
| REFERENCED_TABLE_NAME         | varchar(256) | NO         | 当前该字段默认为 NULL |
| REFERENCED_COLUMN_NAME        | varchar(128) | NO         | 当前该字段默认为 NULL |
