...
该视图默认保留 7 天的数据，如果需要调整数据保留时间，可通过配置项 [ob_event_history_recycle_interval](../../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/300.cluster-level-configuration-items/15300.ob_event_history_recycle_interval.md) 进行设置。
