...
| SPACE_TYPE  | varchar(9)    | NO   | 无共享下展示为 NULL；共享模式下只统计节点私有数据，可分为几类：<ul><li>DATA_TABLE：所有主表 Tablet 的数据，包含 Lob Tablet </li><li>INDEX_TABLE：所有索引表 Tablet 的数据 </li><li>META：所有元数据 </li><li>TMP_FILE：临时文件 </li><li>CLOG：节点上的 clog 总大小 </li><li>SLOG：节点上的 slog 总大小，共享存储没有改行 </li></ul>     |
