...
| INDEX_LENGTH    | bigint(0) unsigned  | NO | 索引长度，即非主键索引占据的存储空间，按宏块大小计算，单位为 Byte。<main id="notice" type='explain'><h4>说明</h4><ul><li>对于 V4.3.x 版本，该字段从 V4.3.5 版本开始不在展示为 <code>NULL</code>。</li> <li>对于 V4.2.x 版本，该字段从 V4.2.4 版本开始不在展示为 <code>NULL</code>。</li></ul></main> |
