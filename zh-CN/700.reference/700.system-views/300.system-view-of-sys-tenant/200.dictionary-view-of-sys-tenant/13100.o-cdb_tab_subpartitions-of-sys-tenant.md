...
| INMEMORY              | varchar(8)      | NO         | 默认值为 NULL，不具备实际含义                     |
| INMEMORY_PRIORITY     | varchar(8)      | NO         | 默认值为 NULL，不具备实际含义                       |
| INMEMORY_DISTRIBUTE   | varchar(15)     | NO         | 目前暂不支持该字段，当前该字段默认为 NULL                       |
| INMEMORY_COMPRESSION  | varchar(17)     | NO         | 默认值为 NULL，不具备实际含义              |
| INMEMORY_DUPLICATE    | varchar(13)     | NO         | 默认值为 NULL，不具备实际含义                         |
| INMEMORY_SERVICE      | varchar(12)     | NO         | 默认值为 NULL，不具备实际含义                         |
| INMEMORY_SERVICE_NAME | varchar(1000)            | NO         | 默认值为 NULL，不具备实际含义                      |
