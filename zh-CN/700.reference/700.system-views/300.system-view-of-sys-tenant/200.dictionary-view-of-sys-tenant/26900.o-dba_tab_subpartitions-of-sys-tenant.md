...
* 查看所有租户的分区表的二级分区信息：[CDB_TAB_SUBPARTITIONS](13100.o-cdb_tab_subpartitions-of-sys-tenant.md)

* 查看本租户的分区表的一级分区详细信息：[DBA_TAB_PARTITIONS](26600.o-dba_tab_partitions-of-sys-tenant.md)