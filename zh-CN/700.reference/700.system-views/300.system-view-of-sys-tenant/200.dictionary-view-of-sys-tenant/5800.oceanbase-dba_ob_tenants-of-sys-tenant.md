...
| LOCKED| varchar(3)| NO | 是否是锁定状态：<ul><li>  `YES`：锁定状态 </li><li>`NO`：不是锁定状态  </li></ul>通过 `ALTER TENANT xxx LOCK&#124;UNLOCK` 命令来影响字段值|
...
*************************** 1. row ***************************
               ...
               TENANT_NAME: sys
               TENANT_TYPE: SYS
               CREATE_TIME: 2024-07-23 15:14:23.646510
               MODIFY_TIME: 2024-07-23 15:14:23.646510
              PRIMARY_ZONE: RANDOM
...
*************************** 2. row ***************************
               ...
               TENANT_TYPE: META
               CREATE_TIME: 2024-07-23 15:19:44.175531
               MODIFY_TIME: 2024-07-23 15:20:00.649714
              PRIMARY_ZONE: zone1
                  LOCALITY: FULL{1}@zone1
         PREVIOUS_LOCALITY: NULL
        COMPATIBILITY_MODE: MYSQL
...
*************************** 3. row ***************************
               ...
               TENANT_TYPE: USER
               CREATE_TIME: 2024-07-23 15:19:44.179336
               MODIFY_TIME: 2024-07-23 15:20:00.677238
              PRIMARY_ZONE: zone1
                  LOCALITY: FULL{1}@zone1
         PREVIOUS_LOCALITY: NULL
        COMPATIBILITY_MODE: MYSQL
         ...
         SWITCHOVER_STATUS: NORMAL
          SWITCHOVER_EPOCH: 0
                  SYNC_SCN: 1722579998944199805
            REPLAYABLE_SCN: 1722579998944199805
              READABLE_SCN: 1722579998443501457
...
*************************** 4. row ***************************
               ...
               TENANT_TYPE: META
               CREATE_TIME: 2024-07-23 15:20:24.733050
               MODIFY_TIME: 2024-07-23 15:20:43.528924
              PRIMARY_ZONE: zone1
                  LOCALITY: FULL{1}@zone1
         PREVIOUS_LOCALITY: NULL
        COMPATIBILITY_MODE: MYSQL
...
*************************** 5. row ***************************
               ...
               TENANT_TYPE: USER
               CREATE_TIME: 2024-07-23 15:20:24.733050
               MODIFY_TIME: 2024-07-23 15:20:43.556286
              PRIMARY_ZONE: zone1
                  LOCALITY: FULL{1}@zone1
         PREVIOUS_LOCALITY: NULL
        COMPATIBILITY_MODE: ORACLE
         ...
         SWITCHOVER_STATUS: NORMAL
          SWITCHOVER_EPOCH: 0
                  SYNC_SCN: 1722579998944429342
            REPLAYABLE_SCN: 1722579998944429342
              READABLE_SCN: 1722579998944429342
        RECOVERY_UNTIL_SCN: 4611686018427387903
                  LOG_MODE: NOARCHIVELOG
ARBITRATION_SERVICE_STATUS: DISABLED
                  UNIT_NUM: 1
