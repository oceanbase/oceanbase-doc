...
* 查看所有租户的分区表的一级分区信息：[CDB_TAB_PARTITIONS](12900.o-cdb_tab_partitions-of-sys-tenant.md)

* 查看本租户的分区表的二级分区详细信息：[DBA_TAB_SUBPARTITIONS](26000.o-dba_tab_subpartitions-of-sys-tenant.md)
