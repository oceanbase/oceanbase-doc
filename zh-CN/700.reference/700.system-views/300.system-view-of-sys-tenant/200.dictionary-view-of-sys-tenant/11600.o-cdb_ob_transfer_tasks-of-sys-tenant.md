...
查看租户 ID 为 1002 的租户当前正在执行的 Transfer 任务。
...
* 查看所有租户 Tablet 级别的负载均衡任务（Task）历史：[CDB_OB_TRANSFER_TASK_HISTORY](11500.o-cdb_ob_transfer_task_history-of-sys-tenant.md)
