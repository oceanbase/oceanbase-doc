...
1. 查看 `cursor_sharing`
   ...
   首先查看 `cursor_sharing` 系统变量，具有不同 `cursor_sharing` 的 SQL 一定会命中到不同的计划。请参见 [cursor_sharing](../../../../7.reference/5.system-reference/3.system-variable-of-oracle-mode/20.cursor_sharing-of-oracle-mode.md)。
