...
| APPLICATION_WATI_TIME | BIGNIT(20) UNSIGNED   |  NUMBER(38)  | 所有执行所有 Application 类事件的总时间     |
| CONCURRENCY_WAIT_TIME | BIGNIT(20) UNSIGNED  |  NUMBER(38)   | 所有执行所有 Concurrency 类事件的总时间     |
| USER_IO_WAIT_TIME     | BIGNIT(20)  UNSIGNED |  NUMBER(38)   | 所有执行所有 `USER_IO` 类事件的总时间   |
