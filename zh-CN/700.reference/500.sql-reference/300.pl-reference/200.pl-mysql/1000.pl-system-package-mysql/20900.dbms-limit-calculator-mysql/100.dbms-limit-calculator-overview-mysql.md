...
| 子程序                   | 描述                  |
| ----------------------- | --------------------- |
|[CALCULATE_MIN_PHY_RES_NEEDED_BY_UNIT]()|用于指定租户以及节点。|
|[CALCULATE_MIN_PHY_RES_NEEDED_BY_LOGIC_RES]()|用于指定租户逻辑资源类型、需要的数量。|
|[CALCULATE_MIN_PHY_RES_NEEDED_BY_STANDBY_TENANT]()|用于指定主租户，给出要创建的备租户的 unit 个数。|