...
1. 查询表的 TABLET ID。
    ...
    **示例如下：**
    ...
    更多视图字段信息，请参见 [oceanbase.CDB_OB_TABLE_LOCATIONS](../../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/10600.o-cdb_ob_table_locations-of-sys-tenant.md)。
