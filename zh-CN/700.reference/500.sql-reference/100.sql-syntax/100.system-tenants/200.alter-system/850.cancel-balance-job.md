...
* 取消、暂停或恢复 Balance Job 的操作只能在主库（即主租户）上执行。
...
| 参数         | 描述        |
|--------------|------------|
| tenant_name  | 指定要暂停、恢复或取消任务的租户名称。可选项，在系统租户下执行时必须指定。|
...
* [暂停和恢复 Balance Job](../../../../../600.manage/300.replica-management/500.load-balancing-manage/420.suspend-or-resume-a-balance-job.md)
