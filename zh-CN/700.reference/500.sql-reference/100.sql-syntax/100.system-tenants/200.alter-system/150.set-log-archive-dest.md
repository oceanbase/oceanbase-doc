...
| 参数                   | 描述                                                                                                                                      |
|-----------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| archive_path          | 指定归档路径及源端配置。有关该参数的详细说明，参见下方 [archive_path](#archive_path)。      |
...
* 系统租户
  ...
  * 系统租户为租户 `mysql_tenant` 配置归档路径，归档介质为 OSS，归档文件的清理模式为 `delete`，归档文件的清理模式为 `delete`，使用 MD5 算法校验归档文件的完整性。
  ...
  * 系统租户为租户 `mysql_tenant` 配置归档目的端，归档介质为 OSS，归档文件的清理模式为 `delete`，不校验归档文件的完整性。
...
* 用户租户
  ...
  * 租户 `mysql_tenant` 为本租户配置归档路径，归档介质为 OSS，归档文件的清理模式为 `delete`，使用 MD5 算法校验归档文件的完整性。
  ...
  * 租户 `mysql_tenant` 为本租户配置归档路径，归档介质为 OSS，归档文件的清理模式为 `delete`，不校验归档文件的完整性。
  ...
  * 租户为本租户配置归档路径，归档介质为 AWS S3，归档文件的清理模式为 `delete`，采用用户业务优先模式，且每隔一天切分一个 Piece。
  ...
  * 租户为本租户配置归档路径，归档介质为 COS，归档文件的清理模式为 `delete`，通过 S3 协议访问。
