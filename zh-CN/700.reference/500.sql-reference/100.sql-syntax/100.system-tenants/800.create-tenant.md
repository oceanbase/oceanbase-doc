...
| LOG_RESTORE_SOURCE | 日志恢复源配置，详细信息参见 [设置日志恢复源](../../../../600.manage/400.high-availability/300.physical-standby-database-disaster-recovery/300.log-transport-service/300.view-log-restore-source.md)。 |
