...
| COLLATE                  | 创建 MySQL 兼容模式的租户时，指定租户级的字符序。有关 MySQL 模式下字符序的详细介绍，请参见 [字符序（MySQL 模式）](../200.common-tenant-of-mysql-mode/100.basic-elements-of-mysql-mode/300.character-set-and-collation-of-mysql-mode/300.collation-of-mysql-mode.md)。<main id="notice" type='explain'><h4>说明</h4><p>如果创建的租户为 Oracle 兼容模式租户，则不支持指定租户级字符序。</p></main>  |
