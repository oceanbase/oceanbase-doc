...
| PUSH_SUBQ                      | 用于指示优化器尽早执行未合并的子查询。<main id="notice" type='explain'><h4>说明</h4><p>对于 OceanBase 数据库 V4.3.5 版本，从 V4.3.5 BP2 版本开始支持 <code>PUSH_SUBQ</code> Hint。</p></main>|
| NO_PUSH_SUBQ                   | 是 `PUSH_SUBQ` 的反向操作，用于优化器将未合并的子查询放在最后执行。<main id="notice" type='explain'><h4>说明</h4><p>对于 OceanBase 数据库 V4.3.5 版本，从 V4.3.5 BP2 版本开始支持 <code>NO_PUSH_SUBQ</code> Hint。</p></main>|
