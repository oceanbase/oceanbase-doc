...
|slug|data-type-conversion-of-oracle-mode|
...
|                **数据类型**         | **to CHAR、VARCHAR2、NCHAR、NVARCHAR2** | **to NUMBER** | **to DATETIME/INTERVAL** | **to RAW** | **to CLOB** |**to BLOB** | **to BINARY_FLOAT** | to BINARY_DOUBLE |
|-------------------------------------|-----------------------------------------|---------------|--------------------------|------------|-------------|------------|---------------------|------------------|
| **from CHAR、VARCHAR2、NCHAR、NVARCHAR2** | TO_CHAR(char . ) 、TO_NCHAR(char . ) | TO_NUMBER  | TO_DATE、TO_TIMESTAMP、TO_TIMESTAMP_TZ、TO_YMINTERVAL、TO_DSINTERVAL | HEXTORAW | TO_CLOB | TO_CLOB | TO_BINARY_FLOAT | TO_BINARY_DOUBLE |
...
| **from RAW**                     | RAWTOHEX、RAWTONHEX                   | -             | -                                            | -      | TO_BLOB | TO_BLOB | -               | -                |
| **from CLOB**                    | TO_CHAR、TO_NCHAR                     | -             | -                                            | -      | TO_CLOB | -       | -               | -                |
| **from BLOB**                    | TO_CHAR、TO_NCHAR                     | -             | -                                            | -      | -       | TO_BLOB | -               | -                |
