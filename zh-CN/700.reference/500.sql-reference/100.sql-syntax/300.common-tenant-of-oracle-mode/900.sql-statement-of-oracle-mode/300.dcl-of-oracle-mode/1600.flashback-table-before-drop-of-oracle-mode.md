...
|      参数       | 描述         |
|---------------|-------------|
| table_name | 指定要恢复表名。 <br>**说明**  恢复表时，也会同步恢复和表相关的索引。 |
...
要使用 FLASHBACK TABLE 语句，您要打开回收站功能。更多信息，参考 [回收站](../../../../../100.oceanbase-database-concepts/1000.high-data-reliability-and-availability/400.data-protection/400.recycle-bin.md)。