...
|       参数        |                   描述                                   |
|-----------------|------------------------------------------------------------|
| session_id      | 终止指定的 Session 的 ID。<main id="notice" type='explain'><h4>说明</h4><p> 可以通过 SQL 语句 <code>SHOW PROCESSLIST;</code> 或者 <code>SHOW FULL PROCESSLIST</code> 查看 <code>session_id</code>。</p></main>  |
