...
|url_external_table_references|可选项，通过 URL 直接读取外表数据，当前 URL 外表支持两种语法形式，详细介绍可参见下文：<ul><li> [table_function](#table_function) 形式。</li><li>[location_url](#location-url) 形式。</li></ul>||
