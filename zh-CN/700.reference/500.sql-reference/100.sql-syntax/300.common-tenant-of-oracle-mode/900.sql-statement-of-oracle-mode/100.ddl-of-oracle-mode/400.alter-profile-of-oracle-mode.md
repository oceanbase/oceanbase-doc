...
| PASSWORD_ROLLOVER_TIME | 指定密码轮转有效期，单位为微秒。在轮转有效期内，旧密码与新密码可同时用于认证。<main id="notice" type="explain"><h4>说明</h4><p>该参数从 V4.4.2 BP1 版本开始支持。</p></main> |
...
* 更改密码轮转有效期：将配置文件 `profile3` 的 `PASSWORD_ROLLOVER_TIME` 设置为 `86400000000` 微秒（示例值）。
