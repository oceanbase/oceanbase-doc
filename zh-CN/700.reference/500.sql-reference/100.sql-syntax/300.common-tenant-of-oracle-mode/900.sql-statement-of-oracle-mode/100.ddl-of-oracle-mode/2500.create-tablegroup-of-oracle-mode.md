...
CREATE TABLEGROUP tablegroup_name 
    [ tablegroup_options ] 
    [ PARTITION BY { 
        HASH(column_list) [ PARTITIONS num ]
        | RANGE(column_list) ( partition_range_desc [, ...] )
        | LIST(column) ( partition_list_desc [, ...] )
    } ]
...
| PARTITION BY | 分区选项，支持:<br>- HASH分区<br>- RANGE分区<br>- LIST分区 |
| PARTITIONS | 分区数量，用于HASH分区 |
