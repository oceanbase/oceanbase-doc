...
|COLUMN_NAME_CASE_SENSITIVE [=] {True \| False} |用于设置生成列的列名是否区分大小写。<ul>其中：<ul><li><code>True</code>：开启列名的大小写敏感性功能。</li><li><code>False</code>：关闭列名的大小写敏感性功能。<main id="notice" type='explain'><h4>说明</h4><p><ul><li>该参数从 V4.5.0 版本开始引入，在 V4.5.0 版本中，默认开启列名大小写敏感。</li><li>从 V4.5.0 之后的版本开始，默认关闭列名大小写敏感。</p></main>|
