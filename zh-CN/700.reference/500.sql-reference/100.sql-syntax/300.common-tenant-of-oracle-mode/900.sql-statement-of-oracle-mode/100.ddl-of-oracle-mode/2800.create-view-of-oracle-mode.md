...
```sql
obclient> create view view3 as select a, --test
    -> b --test
    -> from tbl2;
Query OK, 0 rows affected
```
...
```sql
obclient> show create view view3\G
*************************** 1. row ***************************
                VIEW: VIEW3
         CREATE VIEW: CREATE VIEW "VIEW3" ("A", "B")  AS select a, --test
b --test
from tbl2
...
+------------------------------------------------------------------------------+
| CREATE VIEW "VIEW3" ("A", "B")  AS select a, --test
b --test
from tbl2 |
+------------------------------------------------------------------------------+
