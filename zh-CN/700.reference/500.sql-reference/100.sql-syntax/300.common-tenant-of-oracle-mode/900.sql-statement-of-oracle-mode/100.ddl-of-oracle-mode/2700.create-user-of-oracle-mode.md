...
| IDENTIFIED WITH | 指定认证插件及对应的认证信息，支持的认证插件为 `caching_sha2_password`（基于 SHA-256 的密码认证插件）。<code>BY password</code>：指定明文密码。<main id="notice" type='explain'><h4>说明</h4><p><code>IDENTIFIED WITH</code> 语法从 V4.4.2 BP2 版本开始支持。</p></main> |
