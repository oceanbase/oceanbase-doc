...
* 该函数主要用于函数加密功能，该功能的开启通过 `tde_method` 参数进行控制，详情参见 [tde_method](../../../../../800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/7800.tde_method.md)。
