...
* 该函数主要用于列加密功能，该功能的开启通过 `tde_method` 参数进行控制，详情参见 [tde_method](../../../../../800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/7800.tde_method.md)。
...
* 该函数使用的密钥为租户当前的主密钥。加密算法默认为 AES-128-ECB，可以通过设置系统变量 [block_encryption_mode](../../../../../800.configuration-items-and-system-variables/200.system-variable/300.global-system-variable/600.block_encryption_mode-global.md) 的值来更改加密算法，仅支持 AES 类型的加密算法。
