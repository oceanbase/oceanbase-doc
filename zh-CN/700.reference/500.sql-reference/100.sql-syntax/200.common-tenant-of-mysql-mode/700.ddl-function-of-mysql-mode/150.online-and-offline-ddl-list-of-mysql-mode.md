...
- 列操作与索引/约束操作的组合，即使单个操作是在线，组合操作仍被视为离线。
...
obclient> SELECT table_id, TABLE_TYPE FROM oceanbase.DBA_OB_TABLE_LOCATIONS WHERE table_name='t10';
+----------+------------+
| table_id | TABLE_TYPE |
+----------+------------+
|   500023 | USER TABLE |
