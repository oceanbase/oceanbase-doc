...
<main id="notice" type='notice'>
  <h4>注意</h4>
  <p>下表中关于创建全文索引、多值索引和向量索引后的 DDL 支持情况适用于 V4.3.5 BP2 版本及之后的版本。</p>
</main>
...
| 分区操作 | 修改分区规则 | 与数据量有关，需要重整数据 |例如：`ALTER TABLE t1 PARTITION BY KEY(c1) PARTITIONS 96;`（将分区数从 16 修改为 96，也属于修改分区规则）| 不支持 | 支持 |
