...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>OceanBase 数据库 MySQL 模式从 V5.0.1 开始支持按 MySQL 5.7/8.0 版本分别兼容默认字符序。在建租户时指定 <code>ob_compatibility_control='MYSQL8.0'</code> 时，字符集的默认字符序和 MySQL 8.0 兼容。创建租户后不可修改。创建租户的详细信息，参见 <a href="../../../../../../600.manage/200.tenant-management/600.common-tenant-operations/200.manage-create-tenant.md">创建租户</a>。</p>
</main>
