...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>OceanBase 数据库 MySQL 模式从 V5.0.1 版本开始兼容 MySQL 5.7/8.0 默认字符集字符序。在建租户时指定 <code>ob_compatibility_control='MYSQL8.0'</code> 和 <code>ob_compatibility_version >= 5.0.1.0</code> 开启兼容默认字符集字符序功能，创建租户后不可修改。创建租户的详细信息，参见 <a href="../../../../../../600.manage/200.tenant-management/600.common-tenant-operations/200.manage-create-tenant.md">创建租户</a>。</p>
</main>
