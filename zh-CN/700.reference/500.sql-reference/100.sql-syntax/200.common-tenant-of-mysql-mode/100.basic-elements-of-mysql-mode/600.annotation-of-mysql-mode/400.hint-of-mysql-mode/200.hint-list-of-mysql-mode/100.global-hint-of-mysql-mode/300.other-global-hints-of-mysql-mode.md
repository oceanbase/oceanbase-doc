...
`LOAD_BATCH_SIZE` Hint 中 `batch_size` 指定每次插入批量记录的大小。 `LOAD DATA` 相关介绍可以查看 [LOAD DATA 介绍](../../../../../900.sql-statement-of-mysql-mode/300.dcl-of-mysql-mode/1900.load-data-of-mysql-mode.md)。
