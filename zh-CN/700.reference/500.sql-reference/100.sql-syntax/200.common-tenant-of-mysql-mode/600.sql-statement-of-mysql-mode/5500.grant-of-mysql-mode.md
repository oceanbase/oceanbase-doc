...
| auth_plugin | 用于指定用户身份验证的方式，目前支持 `mysql_native_password` 和 `caching_sha2_password` 身份验证插件。<main id="notice" type='notice'><h4>注意</h4><p><code>caching_sha2_password</code> 取值从 V4.6.1 开始支持。</p></main> |
