...
| TEMPORARY           | 表示删除临时表。<main id="notice" type='explain'><h4>说明</h4><p><ul><li>自 OceanBase 数据库 V4.1.0 BP4 版本起，MySQL 模式下已禁用临时表功能。</li><li>对于 OceanBase 数据库 V4.4.x 版本，自 V4.4.2 版本开始支持临时表功能。</li></p></main>|
