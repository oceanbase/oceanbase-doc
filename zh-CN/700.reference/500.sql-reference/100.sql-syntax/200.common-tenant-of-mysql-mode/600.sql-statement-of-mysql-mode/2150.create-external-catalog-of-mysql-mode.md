...
* 创建 `HMS` 类型的 External Catalog。
  ...
  * 创建 SIMPLE 认证的 HMS Catalog，普通认证模式，不需要设置 Location 认证。
      ...
      <main id="notice" type='explain'>
        <h4>说明</h4>
        <p>有关 Location 认证的介绍信息，参见 <a href="../../../../300.database-object-management/100.manage-object-of-mysql-mode/1000.manage-catalog-of-mysql-mode/200.create-catalog-of-mysql-mode.md">创建 Catalog</a> 下 Location 认证内容。</p>
      </main>
