...
* `LOCATION location_name`：表示 Location 对象。

    <main id="notice" type='explain'>
      <h4>说明</h4>
      <p>对于 OceanBase 数据库 V4.4.x 版本，<code>REVOKE</code> 语句从 V4.4.1 版本开始支持 <code>LOCATION</code> 参数及对应的 <code>READ</code> 和 <code>WRITE</code> 权限。</p>
    </main>

    **示例如下：**

    从用户 `user005` 中撤销对 Location 的对象 `test_location_local` 的 `READ` 权限。
