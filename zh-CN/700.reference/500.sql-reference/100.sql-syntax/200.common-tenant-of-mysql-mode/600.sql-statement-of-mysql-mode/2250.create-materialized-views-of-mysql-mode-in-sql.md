...
| ENABLE QUERY REWRITE  | 可选项，指定当前物化视图开启自动改写。更多物化视图改写的信息，参见 [物化视图改写](../../../../300.database-object-management/100.manage-object-of-mysql-mode/600.manage-views-of-mysql-mode/200.manage-materialized-views-of-mysql-mode/100.materialized-views-of-mysql-mode/600.materialized-views-rewrite-of-mysql-mode.md)。 <main id="notice" type='notice'><h4>注意</h4><p>本功能需要物化视图仅包含 <code>SELECT JOIN</code> 与 <code>WHERE</code> 子句，对于不满足条件的物化视图，不会报错，但不会被用于改写。</p></main>|
