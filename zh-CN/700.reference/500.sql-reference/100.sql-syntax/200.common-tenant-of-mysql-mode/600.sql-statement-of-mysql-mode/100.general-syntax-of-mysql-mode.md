...
|slug|general-syntax-mysql-compatible-mode|
...
`charset_name` 可以是任何有效的字符集名称。更多字符集信息，参考 [与 MySQL 兼容性对比](../../../../../100.learn-more-about-oceanbase/500.compatibility-with-mysql.md)。
...
`collation_name` 可以是任何有效的字符序名称。更多字符序信息，参考 [与 MySQL 兼容性对比](../../../../../100.learn-more-about-oceanbase/500.compatibility-with-mysql.md)。
