...
3. 创建 HDFS 外表
    ...
    obclient> CREATE EXTERNAL TABLE test_ha (
        ...
        LOCATION = 'hdfs://mycluster/hadoop_ha_test?principal=principal_str&keytab=/path/to/keytab&krb5conf=/path/to/krb5conf_file&configs=dfs.data.transfer.protection=integrity#dfs.nameservices=mycluster#dfs.ha.namenodes.mycluster=nn1,nn2#dfs.namenode.rpc-address.mycluster.nn1=xxxx.xxx.xxx-xxx2-xx:xxxxx#dfs.namenode.rpc-address.mycluster.nn2=xxxx.xxx.xxx-xxx1-xx:xxxxx#dfs.ha.automatic-failover.enabled.mycluster=true#dfs.client.failover.proxy.provider.mycluster=org.apache.hadoop.hdfs.server.namenode.ha.ConfiguredFailoverProxyProvider'
        FORMAT = (
            TYPE = 'CSV'
            FIELD_DELIMITER = ','
            FIELD_OPTIONALLY_ENCLOSED_BY = '\''
