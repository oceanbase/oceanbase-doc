...
2. 创建 HDFS 外表。
    ...
    **创建带 kerberos 的 HDFS 外表**
    ...
    ) LOCATION = 'hdfs://localhost:8020/tpch_csv?principal=hdfs/hadoop@XTT.COM&keytab=/data/1/xutengting.xtt/hadoop-kerberos/keytabs/hdfs_20241217.keytab&krb5conf=/etc/krb5.conf&configs=dfs.data.transfer.protection=authentication,privacy'
    FORMAT = (
      TYPE = 'CSV'
      FIELD_DELIMITER = '|'
      FIELD_OPTIONALLY_ENCLOSED_BY ='"'
