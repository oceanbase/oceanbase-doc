...
3. 登录机器，在 OBServer 节点的 `/home/admin/test_data` 目录下查看导出的文件信息。
  ...
  ```shell
  total 12
  -rw-r--r-- 1 admin admin 385 May 20 16:09 data_0_0_0
  -rw-r--r-- 1 admin admin 308 May 20 16:09 data_0_1_0
  -rw-r--r-- 1 admin admin 693 May 20 16:09 test_tbl1.csv
  ```
