...
|url_external_table_references|用于读取外表数据。<main id="notice" type='explain'><h4>说明</h4><p>OceanBase数据库从 V4.3.5 BP1 版本支持了通过 SELECT URL 外表直接读取 CSV、ODPS、PARQUET 和 ORC 格式文件的功能。</p></main>|
