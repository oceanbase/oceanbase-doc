...
| LOG ERRORS                       | 可选项，用于开启导入 URL 外表过程中的错误诊断。详细介绍，可参见下文 [log_errors](#log_errors)。<main id="notice" type='explain'><h4>说明</h4><p>对于 OceanBase 数据库 V4.3.5 版本，LOAD DATA 语句导入 URL 外表语法从 V4.3.5 BP2 版本开始支持指定错误诊断。</p></main>|
