...
| LOG ERRORS                       | 可选项，用于开启导入 URL 外表过程中的错误诊断。详细介绍，可参见下文 [log_errors](#log_errors)。|
...
* 更多有关使用 `LOAD DATA` 旁路导入的示例信息，请参见 [使用 LOAD DATA 语句旁路导入数据](../../../../../620.obap/300.obap-import-data/20.bypass-import/200.full-bypass-import.md)