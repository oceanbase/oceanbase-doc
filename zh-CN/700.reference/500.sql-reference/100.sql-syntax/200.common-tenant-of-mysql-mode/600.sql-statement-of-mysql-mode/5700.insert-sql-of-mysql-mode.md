...
```sql
INSERT 
    [/*+ {APPEND | direct(bool, int, ['full' | 'inc_replace'])} enable_parallel_dml PARALLEL(N) */]
    [IGNORE] [INTO]
    single_table_insert
