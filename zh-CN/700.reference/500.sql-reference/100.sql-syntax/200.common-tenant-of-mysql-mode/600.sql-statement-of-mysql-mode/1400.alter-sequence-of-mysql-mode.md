...
| RESTART                | 重置序列值。升序时从 `MINVALUE` 重新开始取值；降序时从 `MAXVALUE` 重新开始取值。                                                                                                                                                                                                                                               |
| START WITH int_value   | 更改序列的起始值。`int_value` 的取值范围是 \[-(10<sup>27</sup>-1) \~ (10<sup>28</sup>-1)\]。                                                                                                                                                                                                                                                                                           |
...
* 修改序列 `seq1` 的最大值，并指定自增值循环生成。

  ```sql
  -- 需要先创建序列：CREATE SEQUENCE seq1;
