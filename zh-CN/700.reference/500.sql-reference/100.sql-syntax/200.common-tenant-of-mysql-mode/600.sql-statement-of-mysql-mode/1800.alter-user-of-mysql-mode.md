...
* 修改用户密码并保留当前密码（双密码 / 密码轮转场景，自 V4.4.2 BP1 起）：
...
| RETAIN CURRENT PASSWORD | 与 `IDENTIFIED BY` 联用：设置新密码的同时保留旧密码，进入双密码（密码轮转）状态。<main id="notice" type='explain'><h4>说明</h4><p>本功能从 V4.4.2 BP1 版本开始支持。</p></main> |
