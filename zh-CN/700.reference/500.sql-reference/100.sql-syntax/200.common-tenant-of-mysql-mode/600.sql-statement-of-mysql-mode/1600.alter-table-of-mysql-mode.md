...
| PARTITION BY RANDOM SIZE('size_value') | 用于修改随机分布表的分区大小。更多有关修改随机分布表的信息，参见 [修改随机分布表](../../../../300.database-object-management/100.manage-object-of-mysql-mode/300.manage-partitions-of-mysql-mode/270.random-partition-table-of-mysql-mode/400.modify-random-partition-table-of-mysql-mode.md)。 <main id="notice" type='explain'><h4>说明</h4><p>该参数从 V5.0.1 版本开始引入。</p></main>|
