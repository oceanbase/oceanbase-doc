...
| | DUPLICATE_SCOPE | 用于更改复制表属性。<ul><li>`none`：表示将当前表转换为普通表。</li><li>`cluster`：表示将当前表转换为复制表。</li></ul> 更多有关更改复制表属性的信息，请参见 [更改复制表属性](../../../../300.database-object-management/100.manage-object-of-mysql-mode/200.manage-tables-of-mysql-mode/200.create-a-table-for-mysql-tenant-of-mysql-mode.md)。|
