...
| MODIFY PARTITION        | 表示新增二级分区。<main id="notice" type='notice'><h4>注意</h4><p><ul><li>暂不支持二级分区类型是 Hash 或 Key 类型的场景新增二级分区。</li><li>对于 OceanBase 数据库 V4.3.5 版本，从 V4.3.5 BP1 版本开始支持新增二级分区。</li></ul></p></main>|
