...
| EXCHANGE PARTITION partition_name   | 指定分区交换中分区表的分区名称。更多分区交换的信息，参见 [分区交换](../../../../300.database-object-management/100.manage-object-of-mysql-mode/300.manage-partitions-of-mysql-mode/1000.exchange-partition-of-mysql-mode.md)。|
| WITH TABLE non_partition_table_name | 指定分区交换中非分区表名称。|
