...
| CLUSTER BY (column_name_list) | 用于添加或更改聚集列。更多设置聚集列的信息，参见 [更改表](../../../../300.database-object-management/100.manage-object-of-mysql-mode/200.manage-tables-of-mysql-mode/600.change-table-of-mysql-mode.md) 中的 **修改现有表的聚集列** 章节。<main id="notice" type='notice'><h4>注意</h4><p>修改现有表的聚集列会触发数据的重组，可能需要较长时间，请在业务低峰期执行。</p></main>|
