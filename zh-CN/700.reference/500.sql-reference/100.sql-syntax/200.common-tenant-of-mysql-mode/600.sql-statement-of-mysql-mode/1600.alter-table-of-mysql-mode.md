...
|DROP CLUSTERING KEY|用于删除聚集键。<main id="notice" type='notice'><h4>注意</h4><p>该参数从 V4.5.0 版本开始开始引入。</p></main>|
...
|CLUSTER BY (column_name_list)|用于定义聚集键。<main id="notice" type='notice'><h4>注意</h4><p>该参数从 V4.5.0 版本开始开始引入。</p></main>|
