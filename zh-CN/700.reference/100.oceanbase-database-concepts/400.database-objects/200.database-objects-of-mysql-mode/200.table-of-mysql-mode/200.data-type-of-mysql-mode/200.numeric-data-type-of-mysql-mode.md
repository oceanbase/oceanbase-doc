...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>在 OceanBase 数据库 V4.0 版本中，已经禁止使用 <code>FLOAT(scale)</code> 数据类型，并推荐使用 <code>DOUBLE(M,D)</code> 作为替代。如果仍然需要使用 <code>FLOAT(M,D)</code> 数据类型，注意小数位数 <code>D</code> 必须为 0。</p>
</main>
