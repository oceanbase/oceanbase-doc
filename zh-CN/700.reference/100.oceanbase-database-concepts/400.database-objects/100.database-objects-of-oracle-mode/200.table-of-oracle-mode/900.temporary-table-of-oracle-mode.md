...
临时外表是一种在查询过程中临时创建的外表，用于存储和处理数据，查询结束后该表会被自动删除。
...
D:\oceanbase\V4.3.5_pre\oceanbase-database-enterprise-doc\zh-CN\700.reference\500.sql-reference\100.sql-syntax\300.common-tenant-of-oracle-mode\900.sql-statement-of-oracle-mode\200.dml-of-oracle-mode\500.select-of-oracle-mode\100.simple-select-of-oracle-mode.md
