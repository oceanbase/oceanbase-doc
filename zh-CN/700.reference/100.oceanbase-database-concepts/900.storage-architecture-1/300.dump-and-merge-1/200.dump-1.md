...
>**说明**
>
>`memstore_limit_percentage` 用于设置租户使用 Memstore 的内存占其总可用内存的百分比。有关该配置项的详细介绍，请参见 [memstore_limit_percentage](../../../500.system-configuration-items/300.cluster-level-configuration-items-1/13900.memstore_limit_percentage-1-2-3.md)。
...
更多转储操作请参见 [转储](../../../../500.administrator-guide/600.basic-database-management/500.manage-data-storage/100.dump-management-1/100.dump-management-overview-1.md)。
