...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <ul><li><code>all</code>：从 V4.2.1 版本开始，<code>all</code> 和 <code>all_user</code> 具有相同的语义，都表示对所有用户租户生效。<code>all</code> 语法即将被废除，不再推荐使用。  </li><li> <code>all_user</code>：对所有用户租户生效。</li><li><code>all_meta</code>：对所有 META 租户生效。 </li></ul>
</main>
