...
log_archive_dest
    ...
    ├── pieces                                      // Piece 占位符目录
    │   ├── piece_d1002r1p1_start_20230111T193049.obarc // Piece 开始占位符，piece_DESTID_ROUNDID_PIECEID_DATE_start
    │   └── piece_d1002r1p1_end_20230111T193249.obarc   // Piece 结束占位符，piece_DESTID_ROUNDID_PIECEID_DATE_end
...
对于 S3，其日志归档的目录结构与其他介质有所不同，其单个归档文件是由多个小文件和相应的元信息文件组成，具体目录结构如下所示。
