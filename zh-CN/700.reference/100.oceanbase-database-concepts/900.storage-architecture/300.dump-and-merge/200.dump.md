...
您也可以通过以下的运维命令手动触发转储。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p><code>memstore_limit_percentage</code> 用于设置租户使用 MemStore 的内存占其总可用内存的百分比。有关该配置项的详细介绍，请参见 <a href="../../../8.configuration-items-and-system-variables/1.system-configuration-items/3.cluster-level-configuration-items/139.memstore_limit_percentage.md">memstore_limit_percentage</a>。</p>
  </main>
