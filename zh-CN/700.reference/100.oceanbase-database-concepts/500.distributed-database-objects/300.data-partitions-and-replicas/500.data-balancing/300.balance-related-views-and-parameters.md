...
| DBAOB_BALANCE_JOBS_HISTORY/CDB_OB_BALANCE_JOBS_HISTORY| 展示负载均衡任务的历史。 |
...
| DBA_OB_TRANSFER_TASKS/CDB_OB_TRANSFER_TASKS           | 展示正在执行的 Transfer 任务，以 Tablet 级别进行展示。 |
| DBA_OB_TRANSFER_TASK_HISTORY/CDB_OB_TRANSFER_TASK_HISTORY  | 展示 Transfer 任务历史。 |
| GV$OB_UNITS                                           | 展示 Unit 分布及资源使用情况。 |
| GV$OB_SERVERS                                         | 展示 Server 分布及资源使用情况。 |
