...
有关数据库代理的详细内容，请参见 [数据库](200.database-proxy-1/100.agent-overview.md)[代理](200.database-proxy-1/100.agent-overview.md)。
...
* **OceanBase Connector/C**
  ...
  有关 OceanBase Connector/C 的详细介绍，请参见 [OceanBase Connector/C](../600.data-link-1/400.oceanbase-connector-c-1.md)。
