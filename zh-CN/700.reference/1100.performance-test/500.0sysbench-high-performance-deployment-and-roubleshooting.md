...
有关创建租户的详细操作，参见 [创建租户](../../6.manage/2.tenant-management/6.common-tenant-operations/2.manage-create-tenant.md)。
...
* **min_cpu**
  ...
  * 推荐值：`cpu_count`/2
  * 相关文档：`min_cpu` 参数详细信息请参见 [创建租户](../../6.manage/2.tenant-management/6.common-tenant-operations/2.manage-create-tenant.md) 中 **创建资源单元** 的 **参数解释**。
