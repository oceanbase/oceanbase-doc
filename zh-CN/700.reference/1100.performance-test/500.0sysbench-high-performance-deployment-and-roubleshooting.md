...
* **log_disk_size**
  ...
  * 查询：`show parameters where name = 'log_disk_size';`
  ...
  相关文档：[log_disk_size](../800.configuration-items-and-system-variables/100.system-configuration-items/300.cluster-level-configuration-items/22500.log_disk_size.md)
