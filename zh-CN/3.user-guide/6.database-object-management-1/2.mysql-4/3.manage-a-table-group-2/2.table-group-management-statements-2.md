# 表组管理命令
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/table-group-management-statements-2
本节内容主要介绍非分区表组管理命令。

本节主要介绍非分区表组的管理，分区表组的相关内容请参见 [创建一级分区表表组](t2129270.md#topic-2129270)。
