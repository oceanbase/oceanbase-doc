ODP 端故障 
============================
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/odp-failure
...
* 守护进程异常，obproxy 无法自动重启
  ...
  针对这种情况，您可以手动重启 obproxy，具体操作详见 [重启 OBProxy](../../../9.common-o-m-operations/1.service/5.restart-obproxy-2.md)。
