...
2. 依次在 `z1`、`z2`、`z3` 内各添加一台 OBServer。
   ...
   向一个 Zone 内添加 OBServer 的具体操作请参见 [添加 OBServer](../../../../5.basic-database-management/1.manage-clusters/5.manage-observer/1.add-observer-1.md)。
...
2. 依次向 3 个 Zone 内各添加 1 台 OBServer。
   ...
   通过 OCP 向 Zone 内添加 OBServer 的相关操作请参见 [添加 OBServer](../../../../5.basic-database-management/1.manage-clusters/5.manage-observer/1.add-observer-1.md)。
