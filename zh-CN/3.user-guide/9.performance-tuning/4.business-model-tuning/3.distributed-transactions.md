分布式事务 
==========================
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/distributed-transactions
...
单机事务的提交流程，为了提升系统的吞吐能力。对于读写混合的场景，可在系统租户下打开 `_enable_clog_rpc_aggregation` 配置项：
示例如下：
```unknow
