...
* 与 `KILL connection_id` 的作用一致。有关 `KILL` 语句的详细介绍，请参见 [KILL（MySQL 模式）](../../../10.sql-reference-mysql-mode/6.sql-statement/47.KILL.md) 或 [KILL（Oracle 模式）](../../../4.development-guide-refactoring-1/6.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/3.DCL/8.KILL-1.md)。
