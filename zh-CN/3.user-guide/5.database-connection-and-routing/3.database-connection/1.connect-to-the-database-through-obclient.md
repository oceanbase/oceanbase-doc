# 通过 OBClient 连接数据库
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/connect-to-the-database-through-obclient
...
* 通过 OBClient 连接 OceanBase 数据库的 Oracle 租户。
  ...
  Welcome to the OceanBase monitor.  Commands end with ; or \g.
  Your OceanBase connection id is 3221576024
  Server version: 5.7.25 OceanBase 3.2.0 (...)  (Built Jun 18 2021 15:39:59)
