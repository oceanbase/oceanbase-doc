备份恢复相关视图 
=============================
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/backup-and-recovery-related-views-1
...
| TIME_TAKEN_DISPLAY        | time(6)       | NO             | 耗时 hh:mm:ss                                                                                                                                                                                                                                                                                                                                                                   |
| STATUS                    | varchar(64)   | NO             | * `COMPLETED`：表示 backup_set 备份成功   * `FAILED`：表示 backup_set 备份失败   * `DELETING`：表示 backup_set 正在清理                                                                                                                                                                        |
