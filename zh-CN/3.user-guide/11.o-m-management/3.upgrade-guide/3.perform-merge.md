...
2. 配置希望进行的渐进合并轮次：
   ...
   > **注意**
   >
   > 渐进轮次 `num` 必须大于 1。有关该配置项的信息，详见 [default_progressive_merge_num](../../13.system-reference/1.reference-mysql-mode/3.system-configuration-items-1/4.tenant-level-configuration-items-1/14.default_progressive_merge_num-1-2-3.md)。
