重启 OBServer 服务 
===================================
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/restart-observer
...
更多信息请参见 [启动 OBServer 服务](../1.service/1.start-the-observer-service.md) 和 [停止 OBServer 服务](../1.service/2.stop-the-observer-service.md)。
