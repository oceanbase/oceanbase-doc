...
5. 根据获取的资源单元配置信息，修改 `unit1` 的配置。
   ...
   * 调大 unit1 的配置
     ...
     ```sql
     obclient> ALTER RESOURCE UNIT unit1 MAX_CPU 8, MAX_MEMORY '40G', MAX_IOPS 128, MAX_DISK_SIZE '4T', MAX_SESSION_NUM 64, MIN_CPU=8, MIN_MEMORY='40G', MIN_IOPS=128;
     ```

   * 调小 `unit1` 的配置

     ```sql
     obclient> ALTER RESOURCE UNIT unit1 MAX_CPU 5, MAX_MEMORY '5G', MAX_IOPS 128, MAX_DISK_SIZE '1T', MAX_SESSION_NUM 64, MIN_CPU=5, MIN_MEMORY='5G', MIN_IOPS=128;
     ```
