...
| [v$V$SESSION_WAIT](../3.performance-view-5/59.v-session_wait-3.md)                   | 每个 Session 当前等待事件明细，按照约定，每个等待事件会有三个参数，各自会记录对应的值。          |
...
|                                  视图名                                   |                                 功能描述                                 |
|------------------------------------------------------------------------|----------------------------------------------------------------------|
| [GV$OB_DTL_INTERM_RESULT_MONITOR](../3.performance-view-5/116.gv-ob_dtl_interm_result_monitor.md) | 展示 DTL 中间结果管理器的监控信息。                                                                |
| [GV$OB_DTL_INTERM_RESULT_MONITOR](../3.performance-view-5/117.v-ob_dtl_interm_result_monitor.md)      | 展示 DTL 中间结果管理器的监控信息。 |
...
| [GV$OB_MEMSTORE_INFO](../3.performance-view-5/97.gv-ob_memstore_info.md)      | 展示所有服务器上所有租户的所有分区的 Memtable 的详细信息。 |
| [V$OB_MEMSTORE_INFO](../3.performance-view-5/98.v-ob_memstore_info.md)      | 展示所有服务器上所有租户的所有分区的 Memtable 的详细信息。 |
...
|                                  视图名                                   |                                 功能描述                                 |
|------------------------------------------------------------------------|----------------------------------------------------------------------|
| [GV$OB_LOG_STAT](../3.performance-view-5/114.gv-ob_log_stat.md) | 展示 Palf 的状态。                                                                |
| [V$OB_LOG_STAT](../3.performance-view-5/115.v-ob_log_stat.md)      | 展示 Palf 的状态。 |
...
| [GV$DML_STATS](../3.performance-view-5/112.gv-dml_stats.md)                 | 展示当前用户表中的 DML 信息。                                       |
| [V$DML_STATS](../3.performance-view-5/113.v-dml_stats.md)            | 展示当前用户表中的 DML 信息。             |
...
|                                 视图名                                 |                                          功能描述                                           |
|---------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| [GV$OB_PX_WORKER_STAT](../3.performance-view-5/34.gv-ob_px_worker_stat-2.md) | 在并行执行场景中，查看每个线程的执行信息。                                                                   |
| [V$OB_PX_WORKER_STAT](../3.performance-view-5/76.v-ob_px_worker_stat-2.md)  | 在并行执行场景中，查看每个线程的执行信息。 |
...
| [GV$SQL_WORKAREA_ACTIVE](../3.performance-view-5/96.gv-sql_workarea_active.md)          | 展示当前活跃 Operator 的 Workarea 信息。                                       |
