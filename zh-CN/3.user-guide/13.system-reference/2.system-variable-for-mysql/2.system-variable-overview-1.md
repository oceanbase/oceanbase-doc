...
| [sql_auto_is_null](../../2.reference-oracle-mode/2.system-variable-6/115.sql_auto_is_null-1-2-3-4.md)                                                        | 用于获取最后插入行的自增列值。                                                   |
...
| [collation_server](../2.system-variable-5/18.collation_server-1-2-3.md)         | 用于设置服务器默认字符集和字符序。                                                                               |
...
| [ob_max_parallel_degree](../../2.reference-oracle-mode/2.system-variable-6/80.ob_max_parallel_degree-1-2-3-4.md)  | 用于设置每次请求最大的并发数。                                   |
...
| [parallel_max_servers](../../2.reference-oracle-mode/2.system-variable-6/105.parallel_max_servers-1-2-3-4.md)    | 用于设置每个 Server 上并行执行（Parallel eXecution，PX）线程池的大小。 |
...
| [ob_stmt_parallel_degree](../../2.reference-oracle-mode/2.system-variable-6/95.ob_stmt_parallel_degree-1-2-3-4.md) | 用于设置查询的并行度，即可以并行运行的任务数。                         |
...
| [nls_timestamp_tz_format](../../2.reference-oracle-mode/2.system-variable-6/59.nls_timestamp_tz_format-1-2-3.md) | 用于控制 Timestamp tz 类型转 str 的格式，以及 str 隐式转 Timestamp tz 的格式。                               |
...
| [resource_manager_plan](../../2.reference-oracle-mode/2.system-variable-6/113.resource_manager_plan-1-2-3-4.md)           | 用于激活资源管理计划，以适当的参数限制不同负载使用 CPU 的额度。                                          |
