...
* 有关变量的详细参数介绍，请参见 [系统变量总览](2.system-variable-overview-2.md)。

  

* 更多系统变量的查看和设置操作，请参见《管理员指南》的 [设置变量](../../5.basic-database-management/2.configuration-management/3.set-variables.md) 章节。
