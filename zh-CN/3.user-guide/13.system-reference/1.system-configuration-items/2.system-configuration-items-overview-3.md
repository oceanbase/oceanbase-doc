...
|                                   配置项名                                    |                功能描述                 |
|---------------------------------------------------------------------------|-------------------------------------|
| [dag_scheduler_thread_ratio](../1.system-configuration-items/4.tenant-level-configuration-items-1/13.dag_scheduler_thread_ratio.md) | 用于设置 dag 调度器所有工作线程占用 CPU 时间片的比例。           |
...
| [ha_dag_scheduler_thread_score](../1.system-configuration-items/4.tenant-level-configuration-items-1/40.ha_dag_scheduler_thread_score.md) | 用于设置 ha dag 调度程序的当前工作线程数。 |
