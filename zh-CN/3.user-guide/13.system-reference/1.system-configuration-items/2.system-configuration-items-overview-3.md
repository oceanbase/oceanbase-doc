...
|                                         配置项名                                         |                         功能描述                          |
|--------------------------------------------------------------------------------------|-------------------------------------------------------|
| [clog_disk_utilization_threshold](../1.system-configuration-items/4.tenant-level-configuration-items-1/47.clog_disk_utilization_threshold-1-2-3.md)  | 用于控制 Clog 或 ilog 磁盘空间复用的水位值。                     |
