...
| [clog_expire_days](3.cluster-level-configuration-items-1/38.clog_expire_days-1-2-3.md)                 | 用于控制 Clog 文件的过期时间。当 Clog 文件最后修改时间距离当前时间超过过期时间时，该 文件会被删除。 |
...
| [migrate_concurrency](3.cluster-level-configuration-items-1/146.migrate_concurrency-1-2-3.md)              | 用于设置内部数据迁移的最大并发数。                   |
...
| [clog_persistence_compress_func](../../2.reference-oracle-mode/3.system-configuration-items-2/3.tenant-level-configuration-items-2/4.clog_persistence_compress_func-1-2-3-4.md)        | 用于设置事务日志落盘压缩算法。                                       |
| [clog_max_unconfirmed_log_count](../../2.reference-oracle-mode/3.system-configuration-items-2/3.tenant-level-configuration-items-2/3.clog_max_unconfirmed_log_count-1-2-3-4.md)        | 用于设置事务模块中未确认日志的最大数量。                                  |
| [enable_clog_persistence_compress](../../2.reference-oracle-mode/3.system-configuration-items-2/3.tenant-level-configuration-items-2/9.enable_clog_persistence_compress-1-2-3-4.md)      | 用于设置是否开启事务日志落盘压缩。                                     |
...
|                                配置项名                                 |                                     功能描述                                      |
|---------------------------------------------------------------------|-------------------------------------------------------------------------------|
| [plsql_ccflags](../../2.reference-oracle-mode/3.system-configuration-items-2/3.tenant-level-configuration-items-2/28.plsql_ccflags-1-2-3-4.md)        | 用于定义 PL 编译器的编译常量。                                                             |
...
|                                   配置项名                                    |                功能描述                 |
|---------------------------------------------------------------------------|-------------------------------------|
| [dag_scheduler_thread_score](../../2.reference-oracle-mode/3.system-configuration-items-2/3.tenant-level-configuration-items-2/14.dag_scheduler_thread_score-1.md) | 用于设置 dag 调度器的工作线程占用时间片权重。           |
| [major_merge_thread_score](../../2.reference-oracle-mode/3.system-configuration-items-2/3.tenant-level-configuration-items-2/19.major_merge_thread_score.md)   | 用于设置 major compaction 的工作线程占用时间片权重。 |
| [mini_merge_thread_score](../../2.reference-oracle-mode/3.system-configuration-items-2/3.tenant-level-configuration-items-2/21.mini_merge_thread_score-1.md)    | 用于设置 mini compaction 的工作线程占用时间片权重。  |
| [minor_merge_thread_score](../../2.reference-oracle-mode/3.system-configuration-items-2/3.tenant-level-configuration-items-2/23.minor_merge_thread_score-1.md)   | 用于设置 minor compaction 的工作线程占用时间片权重。 |
...
| [ob_enable_batched_multi_statement](../../2.reference-oracle-mode/3.system-configuration-items-2/3.tenant-level-configuration-items-2/24.ob_enable_batched_multi_statement-1-2-3-4.md) | 用于设置是否启用批处理多条语句的功能。                                                             |
