...
8. 完成后，您可以查看以下视图，确认所有宏块是否已完成加密。
   ...
   更多视图 `V$OB_ENCRYPTED_TABLES` 的字段及说明信息请参见 [V$OB_ENCRYPTED_TABLES](../../../13.system-reference/4.system-view-for-mysql/3.performance-view-5/91.v-encrypted_tables-3.md)。
