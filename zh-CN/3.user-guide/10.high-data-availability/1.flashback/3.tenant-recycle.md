租户回收站 
==========================
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/tenant-recycle
...
2. 根据业务需要，选择合适的语句，清理回收站。
   ...
   * 将租户从回收站中彻底清除。
     ...
     **说明**
     ...
     本节主要介绍如何清理回收站中的租户，回收站中其他类型的对象的清理请参见 [数据库、表和索引级回收站](../1.flashback/2.database-table-and-index-recycle-bin.md)。
