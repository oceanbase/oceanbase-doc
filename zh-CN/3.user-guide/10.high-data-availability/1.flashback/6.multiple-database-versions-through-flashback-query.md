# 闪回查询多数据库版本
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/multiple-database-versions-through-flashback-query
...
* 创建 Restore Point
  ...
  当用户创建了 Restore Point，则可使用闪回查询功能查询 Restore Point 点对应的数据版本。 Restore Point 的创建及使用的相关操作请参见 [Restore Point](../1.flashback/5.restore-point.md)。
...
2. 执行以下语句，修改 `undo_retention` 变量的值。
   ...
   更多 `undo_retention` 变量的说明信息请参见 [undo_retention](../../13.system-reference/2.reference-oracle-mode/2.system-variable-6/133.undo_retention-1-2-3-4.md)。
