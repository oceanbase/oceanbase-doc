...
* `enable_auto_leader_switch` 参数已设置为开启状态，即 `enable_auto_leader_switch` 的值为 `True`。
  ...
  `enable_auto_leader_switch` 参数的更多说明请参见 [enable_auto_leader_switch](../../../13.system-reference/1.system-configuration-items/3.cluster-level-configuration-items-1/66.enable_auto_leader_switch-1-2.md)。
