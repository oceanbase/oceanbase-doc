# 查询集群参数
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/you-can-call-this-operation-to-query-cluster-parameters-1
...
OceanBase 数据库中各集群参数的详细说明信息请参见 [系统配置项](../../../13.system-reference/1.reference-mysql-mode/3.system-configuration-items-1/1.system-configuration-items-overview-2.md) 章节。
