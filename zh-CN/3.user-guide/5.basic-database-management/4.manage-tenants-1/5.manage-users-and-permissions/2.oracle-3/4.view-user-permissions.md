...
2. 执行以下命令，查看某个用户被授予的权限。
   ...
   * 查看某个用户被授予的系统权限
     ...
     更多 `DBA_SYS_PRIVS` 视图的字段及说明请参见 [DBA_SYS_PRIVS](../../../../13.system-reference/2.reference-oracle-mode/1.system-view-5/2.dictionary-view-6/104.DBA_SYS_PRIVS-1.md)。
   ...
   * 查看当前用户被授予的系统权限
     ...
     更多 `USER_SYS_PRIVS` 视图的字段及说明请参见 [USER_SYS_PRIVS](../../../../13.system-reference/2.reference-oracle-mode/1.system-view-5/2.dictionary-view-6/172.USER_SYS_PRIVS-1.md)。
   ...
   * 查看某个用户被授予的对象权限
     ...
     更多 `DBA_TAB_PRIVS` 视图的字段及说明请参见 [DBA_TAB_PRIVS](../../../../13.system-reference/2.reference-oracle-mode/1.system-view-5/2.dictionary-view-6/111.DBA_TAB_PRIVS-1.md)。
   ...
   * 查看当前用户被授予的对象权限
     ...
     更多 `USER_TAB_PRIVS` 视图的字段及说明请参见 [USER_TAB_PRIVS](../../../../13.system-reference/2.reference-oracle-mode/1.system-view-5/2.dictionary-view-6/182.USER_TAB_PRIVS-1.md)。
   ...
   * 查看某个用户所拥有的角色。
     ...
     更多 `DBA_ROLE_PRIVS` 视图的字段及说明请参见 [DBA_ROLE_PRIVS](../../../../13.system-reference/2.reference-oracle-mode/1.system-view-5/2.dictionary-view-6/92.DBA_ROLE_PRIVS-1.md)。
   ...
   * 查看当前用户被授予的角色
     ...
     更多 `USER_ROLE_PRIVS` 视图的字段及说明请参见 [USER_ROLE_PRIVS](../../../../13.system-reference/2.reference-oracle-mode/1.system-view-5/2.dictionary-view-6/165.USER_ROLE_PRIVS-1.md)。
