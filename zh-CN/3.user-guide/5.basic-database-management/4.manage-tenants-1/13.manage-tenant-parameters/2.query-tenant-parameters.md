...
OceanBase 数据库中各租户参数的详细说明信息请参见 [系统配置项](../../../13.system-reference/1.reference-mysql-mode/3.system-configuration-items-1/1.system-configuration-items-overview-2.md) 章节。
