...
有关通过 OBClient 连接数据库的详细操作，参见 [通过 OBClient 连接数据库](../4.database-connection-and-routing/2.database-connection/1.connect-to-the-database-through-obclient.md)。
...
有关通过 MySQL 客户端连接数据库的详细操作，参见 [通过 MySQL 客户端连接数据库](../4.database-connection-and-routing/2.database-connection/2.connect-to-a-database-from-a-mysql-client.md)。
...
通过 ODC 连接数据库的相关操作请参见 [通过 ODC 连接数据库](../4.database-connection-and-routing/2.database-connection/3.connect-to-the-database-through-odc-1.md)。
