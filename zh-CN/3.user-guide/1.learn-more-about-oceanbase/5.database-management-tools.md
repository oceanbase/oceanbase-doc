# 数据库管理工具介绍
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/database-management-tools
...
有关通过 OBClient 连接数据库的详细操作，参见 [通过 OBClient 连接数据库](../5.database-connection-and-routing/3.database-connection/1.connect-to-the-database-through-obclient.md)。
...
有关通过 MySQL 客户端连接数据库的详细操作，参见 [通过 MySQL 客户端连接数据库](../5.database-connection-and-routing/3.database-connection/2.connect-to-a-database-from-a-mysql-client.md)。
...
>**说明**
>
>不同 OCP 版本的功能和操作界面可能不同，本文档中介绍的 OCP 功能及操作均以 OCP V4.0.0 版本为例，OCP 其他版本的功能介绍及操作请参考 OCP 对应版本的产品文档。
...
>**说明**
>
>关于如何使用 ODC 连接至 OceanBase 数据库和 ODC 的其他功能介绍等详细内容，您可以在我们的文档中心参阅对应版本的 《OceanBase 开发者中心用户指南》文档。

通过 ODC 连接数据库的相关操作请参见 [通过 ODC 连接数据库](../5.database-connection-and-routing/3.database-connection/3.connect-to-the-database-through-odc-1.md)。
