...
Oracle 数据库中支持内建函数 257 个，OceanBase 数据库当前支持 155 个，更多详细信息请参阅 [函数](../../../4.development-guide-refactoring-1/6.sql-syntax/3.common-tenant-oracle-mode/5.functions-2/1.function-overview.md)。
