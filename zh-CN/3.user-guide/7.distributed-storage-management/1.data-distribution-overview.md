# 数据分布概述
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/data-distribution-overview
...
目前 OceanBase 数据库支持仅支持全能型副本。

有关副本管理的详细信息，参见 [副本概述](4.manage-replicas/1.replica-overview-1.md) 。
