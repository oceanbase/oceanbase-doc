...
| [GV$OB_IO_QUOTA](103.gv-ob_io_quota.md)      | 展示当前磁盘带宽的切分状态。                 |
| [V$OB_IO_QUOTA](104.v-ob_io_quota.md)      | 展示当前磁盘带宽的切分状态。                 |
...
| [V$OB_CLUSTER](77.v-ob_cluster-2.md)               | 用于展示当前集群的基本信息。                                               |
| [V$OB_KVCACHE](47.v-ob_kvcache.md)               | 展示每台 OBServer 上的 KVCACHE 信息。                                 |
| [V$OB_CLUSTER_EVENT_HISTORY](80.v-ob_cluster_event_history-2.md) | 用于显示本集群主备库相关的事件历史，用于跟踪主备库运维、切换流程详细信息，报错日志等，方便诊断问题。           |
