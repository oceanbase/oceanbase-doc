...
| [oceanbase.CDB_TABLE_LOCATIONS](177.oceanbase-cdb_table_locations.md)   | 展示表或者分区所在的位置，包括：系统表、用户表、索引表等。      |
| [oceanbase.DBA_TABLE_LOCATIONS](178.oceanbase-dba_table_locations.md)   | 展示表或者分区所在的位置，包括：系统表、用户表、索引表等。      |
