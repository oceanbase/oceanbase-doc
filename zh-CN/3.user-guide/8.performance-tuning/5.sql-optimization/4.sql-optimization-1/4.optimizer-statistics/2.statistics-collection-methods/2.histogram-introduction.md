...
在 OceanBase 数据库优化器中，列的直方图信息存储在内部表 `__all_histogram_stat_v2` 中，它包含了以下信息：
...
OceanBase 数据库优化器根据 NDV、`bucket_size` 和 `p` 指标选择直方图。直方图的选择策略如下图所示。![直方1](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3149703461/p392712.png)
