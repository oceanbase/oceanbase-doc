...
2. 通过以下方式查看用户权限：
   ...
   * 查看用户所拥有的用户级权限。
     ...
     *************************** 1. row ***************************
     ...
     更多 `mysql.user` 视图的字段及说明请参见 [mysql.user](../../../../13.system-reference/1.reference-mysql-mode/1.system-view-4/2.dictionary-view-5/40.mysql-user-2.md)。
   ...
   * 查看用户所拥有的数据库级权限。
     ...
     *************************** 1. row ***************************
     ...
     更多 `mysql.db` 视图的字段及说明请参见 [mysql.db](../../../../13.system-reference/1.reference-mysql-mode/1.system-view-4/2.dictionary-view-5/30.mysql-db-2.md)。
