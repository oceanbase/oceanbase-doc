...
更多 `DROP ROLE` 语句的说明信息，请参见 [DROP ROLE](../../../../../../4.development-guide-refactoring-1/6.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/36.drop-role.md)。
