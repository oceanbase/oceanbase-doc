...
* 查看当前系统中的角色
  ...
  更多 `DBA_ROLES` 视图的字段及说明请参见 [DBA_ROLES](../../../../../14.system-reference/5.system-view-for-oracle/2.dictionary-view-6/91.DBA_ROLES-1.md)。
...
* 查看角色中包含的角色
  ...
  更多 `ROLE_ROLE_PRIVS` 视图的字段及说明请参见 [ROLE_ROLE_PRIVS](../../../../../14.system-reference/5.system-view-for-oracle/2.dictionary-view-6/199.ROLE_ROLE_PRIVS-1.md)。
...
* 查看角色所拥有的系统权限。
  ...
  更多 `ROLE_SYS_PRIVS` 视图的字段及说明请参见 [ROLE_SYS_PRIVS](../../../../../14.system-reference/5.system-view-for-oracle/2.dictionary-view-6/198.ROLE_SYS_PRIVS-1.md)。
...
* 查看角色所拥有的对象权限。
  ...
  更多 `ROLE_TAB_PRIVS` 视图的字段及说明请参见 [ROLE_TAB_PRIVS](../../../../../14.system-reference/5.system-view-for-oracle/2.dictionary-view-6/197.ROLE_TAB_PRIVS-1.md)。
