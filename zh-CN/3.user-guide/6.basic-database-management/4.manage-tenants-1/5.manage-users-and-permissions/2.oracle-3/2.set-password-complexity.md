...
2. 编写 `PASSWORD_VERIFY_FUNCTION`参数对应的函数并授权。
   ...
   * 如果修改密码，新密码与旧密码至少要有 3 个以上的字符不相同。
   ...
   创建函数的相关操作，请参见 [创建函数](../../../../../4.development-guide-refactoring-1/7.pl-reference/8.stored-procedure-and-functions/3.create-a-function.md)。
...
更多函数管理的相关操作，请参见 [管理存储过程和函数](../../../../../4.development-guide-refactoring-1/7.pl-reference/8.stored-procedure-and-functions/4.view-and-delete-procedures-and-functions.md)。
