...
1. 查看 `cursor_sharing`
   ...
   首先查看 `cursor_sharing` 系统变量，具有不同 `cursor_sharing` 的 SQL 一定会命中到不同的计划。请参见 [cursor_sharing](../../../13.system-reference/2.reference-oracle-mode/2.system-variable-6/20.cursor_sharing.md)。
