...
* [枚举类型](../1.sql-reference-data-types/6.enumeration-data-type.md)

  

* [集合类型](../1.sql-reference-data-types/7.set-data-type.md)
...
关于比较运算的转换规则，请参见 [表达式求值的类型转换](../2.sql-reference-expressions/3.type-conversion-in-expression-evaluation.md)。
