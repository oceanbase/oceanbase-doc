...
* 使用 `EXPLAIN BASIC` 命令展示执行计划。![EXPLAIN BASIC](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8857322561/p438062.png)

  

* 使用 `EXPLAIN` 命令展示执行计划。![EXPLAIN EXTENDED](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7418042561/p438063.png)

  

* 使用 `EXPLAIN EXTENDED` 命令展示执行计划。![EXPLAIN EXTENDED_NOADDR](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7418042561/p438064.png)

  

* 使用 `EXPLAIN EXTENDED_NOADDR` 命令展示执行计划。![1](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7418042561/p438069.png)

  

* 使用 `EXPLAIN OUTLINE` 命令可以显示 Outline 信息。![EXPLAIN EXTENDED_NOADDR](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8418042561/p438067.png)
