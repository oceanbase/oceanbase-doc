...
在 ODC 平台的 SQL 窗口，运行 `EXPLAIN` 命令在结果 1 区域中单击 ![按钮](../images/p446397.png)，查看执行计划信息。

* 使用 `EXPLAIN BASIC` 命令展示执行计划。![EXPLAIN BASIC](../images/p438062.png)

  

* 使用 `EXPLAIN` 命令展示执行计划。![EXPLAIN EXTENDED](../images/p438063.png)

  

* 使用 `EXPLAIN EXTENDED` 命令展示执行计划。![EXPLAIN EXTENDED_NOADDR](../images/p438064.png)

  

* 使用 `EXPLAIN EXTENDED_NOADDR` 命令展示执行计划。![1](../images/p438069.png)

  

* 使用 `EXPLAIN OUTLINE` 命令可以显示 Outline 信息。![EXPLAIN EXTENDED_NOADDR](../images/p438067.png)
