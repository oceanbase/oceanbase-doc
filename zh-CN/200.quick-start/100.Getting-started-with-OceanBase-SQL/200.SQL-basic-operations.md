...
更多管理数据库的操作请参见 《数据库对象管理》中 [管理数据库](../../500.administrator-guide/700.database-object-management/100.manage-databases/100.create-a-database.md) 章节。
...
更多 `CREATE TABLE` 语句相关的语法说明请参见《SQL 参考》中 [CREATE TABLE](../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/1600.create-table.md) 章节。
...
更多 `ALTER TABLE` 语句相关的语法说明请参见《SQL 参考》中 [ALTER TABLE](../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/600.alter-table.md) 章节。
...
更多 `DROP TABLE` 语句相关的语法说明请参见《SQL 参考》中 [DROP TABLE](../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/2700.drop-table.md) 章节。
...
更多 `CREATE INDEX` 语句相关的语法说明请参见《SQL 参考》中的 [CREATE INDEX](../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/1200.create-index.md) 章节。
...
更多 `DROP INDEX` 语句相关的语法说明请参见《SQL 参考》中的 [DROP INDEX](../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/2400.drop-index.md) 章节。
...
更多 `INSERT` 语句相关的语法请参见《SQL 参考》中 [INSERT](../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/3700.INSERT.md) 章节。
...
更多 `DELETE` 语句相关的语法说明请参见《SQL 参考》中 [DELETE](../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/2100.DELETE.md) 章节。
...
更多 `UPDATE` 语句相关的语法请参见《SQL 参考》中 [UPDATE](../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/6000.UPDATE.md) 章节。
...
更多 `SELECT` 语句相关的语法说明请参见《SQL 参考》中 [SELECT](../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/5100.SELECT-1-2/100.SELECT.md) 章节。
...
更多事务控制语句相关的说明请参见 [关于事务控制语句](../../300.developer-guide/400.about-dml-statements-and-transactions/200.transaction/100.about-transactional-control-statements.md
)。
