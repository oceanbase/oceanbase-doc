...
3. （可选）配置密码
   ...
   <main id="notice" type='explain'>
     <h4>说明</h4>
     <p>您也可使用 root 用户登录数据库的 sys 租户后，通过 <code>ALTER USER</code> 命令修改用户密码。详细操作可参见 <a href='../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/800.alter-user.md'>ALTER USER</a> 。</p>
   </main>
...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>在 Docker 容器中启动 OceanBase 数据库后，您可登录集群执行 <code>ALTER USER</code> 命令修改用户密码，命令详细介绍请参见 <a href='../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/800.alter-user.md'>ALTER USER</a>。</p>
</main>
