...
2. 执行以下命令，创建表 test 的索引。
   ...
   更多 `CREATE INDEX` 语句相关的语法说明请参见《SQL 参考》中的 [CREATE INDEX](../../8.sql-reference/5.sql-statements/12.create-index.md)[CREATE INDEX](../../8.sql-reference/5.sql-statements/12.create-index.md)章节。
