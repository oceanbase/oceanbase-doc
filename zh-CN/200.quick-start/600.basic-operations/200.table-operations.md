...
更多 `CREATE TABLE` 语句相关的语法说明请参见《SQL 参考》中 [CREATE TABLE](../../1000.sql-reference/500.sql-statements/1900.create-table.md)章节。
...
更多 `ALTER TABLE` 语句相关的语法说明请参见《SQL 参考》中 [ALTER TABLE](../../1000.sql-reference/500.sql-statements/700.alter-table.md) 章节。
...
更多 `DROP TABLE` 语句相关的语法说明请参见《SQL 参考》中 [DROP TABLE](../../1000.sql-reference/500.sql-statements/3300.drop-table.md)章节。
