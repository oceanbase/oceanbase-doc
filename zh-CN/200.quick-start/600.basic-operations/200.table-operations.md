...
更多 `CREATE TABLE` 语句相关的语法说明请参见《SQL 参考》中 [CREATE TABLE](../../1000.sql-reference/500.sql-statement/1900.sql-statements-create-table.md)章节。
...
更多 `ALTER TABLE` 语句相关的语法说明请参见《SQL 参考》中 [ALTER TABLE](../../1000.sql-reference/500.sql-statement/700.sql-statements-alter-table.md) 章节。
...
更多 `DROP TABLE` 语句相关的语法说明请参见《SQL 参考》中 [DROP TABLE](../../1000.sql-reference/500.sql-statement/3300.sql-statements-drop-table.md)章节。
