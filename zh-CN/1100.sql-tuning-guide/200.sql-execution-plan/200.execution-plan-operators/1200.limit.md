...
由于 Oracle 模式含有 COUNT 的 SQL 改写为 LIMIT 场景在 COUNT 算子章节已经有过相关介绍，详细信息请参见 [COUNT](../../../1200.reference-guide/200.system-variables/11300.validate_password_special_char_count.md)。
