...
您可以升级单个/多个 OBProxy，也可以升级 OBProxy 集群下所有 OBProxy。有关升级 OBProxy 集群下所有 OBProxy 的操作方法，请参见 [升级 OBProxy 集群下全部 OBProxy](../200.manage-the-obproxy-cluster/400.upgrade-all-OBProxy-under-the-OBProxy-cluster.md)。
