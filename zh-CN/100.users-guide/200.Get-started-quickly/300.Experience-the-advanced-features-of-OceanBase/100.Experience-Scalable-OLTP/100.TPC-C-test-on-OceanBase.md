...
也可以通过 OBD 来部署 ODP ，具体可参考 [创建 ODP 集群](../../../500.database-connection-and-routing/200.obproxy-management/200.manage-the-obproxy-cluster/100.create-an-OBProxy-cluster.md)
