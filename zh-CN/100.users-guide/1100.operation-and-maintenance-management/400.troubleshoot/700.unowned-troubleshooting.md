...
8. 判断是否为 Clog 盘满。
   ...
   有关 Clog 盘满的解决方式，请参见 [节点日志盘（Clog）空间满](../500.emergency-problem-handling/100.handling-of-common-emergency-problems/200.problems-caused-by-capacity-changes/600.the-node-log-disk-Clog-space-is-full.md)。
