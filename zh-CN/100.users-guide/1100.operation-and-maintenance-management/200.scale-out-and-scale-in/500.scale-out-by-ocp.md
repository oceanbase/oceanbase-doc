...
* 您已经规划磁盘。详细操作请参考 [规划磁盘](../../3.installation-and-deployment/4.environment-and-configuration-checks/4.plan-disks-optional.md) 。
  
* 您已经配置时钟源。详细操作请参考 [配置时钟源](../../3.installation-and-deployment/4.environment-and-configuration-checks/3.configure-the-clock-source-optional.md)。
  
* 每台机器上已创建 admin 用户。详细操作请参考 [创建用户](../../3.installation-and-deployment/4.environment-and-configuration-checks/8.create-user-optional.md)。
