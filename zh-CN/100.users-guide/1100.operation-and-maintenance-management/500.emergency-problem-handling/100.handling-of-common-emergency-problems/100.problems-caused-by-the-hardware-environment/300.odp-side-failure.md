...
* 守护进程异常，obproxy 无法自动重启
  ...
  针对这种情况，您可以手动重启 obproxy，具体操作详见 [重启 OBProxy](../../../6.common-operation-and-maintenance-operations/1.service-related/5.restart-odp-of-operation-and-maintenance.md)。
