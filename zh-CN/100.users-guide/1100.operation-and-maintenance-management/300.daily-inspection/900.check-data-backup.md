...
3. 进行以下操作：
   ...
   * 查看备份历史
   ...
   更多 `CDB_OB_BACKUP_PROGRESS` 和 `CDB_OB_BACKUP_SET_DETAILS` 视图的说明，请参见 [CDB_OB_BACKUP_PROGRESS](../../1200.reference-guide/100.system-views/100.dictionary-views/4600.oceanbase-cdb_ob_backup_progress.md) 和 [CDB_OB_BACKUP_SET_DETAILS](../../1200.reference-guide/100.system-views/100.dictionary-views/4400.oceanbase-cdb_ob_backup_set_details.md)。
...
3. 执行以下语句，查看日志的备份进度。
   ...
   更多 `CDB_OB_BACKUP_ARCHIVELOG` 视图的说明，请参见 [CDB_OB_BACKUP_ARCHIVELOG](../../1200.reference-guide/100.system-views/100.dictionary-views/3800.oceanbase-cdb_ob_backup_archivelog.md)。
