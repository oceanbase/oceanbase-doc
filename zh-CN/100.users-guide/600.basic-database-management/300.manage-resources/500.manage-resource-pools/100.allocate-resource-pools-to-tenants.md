...
创建租户的更多信息请参见 [新建租户](../../../6.basic-database-management/4.manage-tenants/2.create-a-tenant.md)。
...
4. 通过修改租户 Locality 来增加副本。
   ...
   根据 Locality 的变更规则，每次只能增加一个 Zone 内的 Locality，Locality 的变更规则相关信息请参见 [Locality 概述](../../../8.distributed-storage-management/4.manage-locality/1.overview-of-locality.md)。
