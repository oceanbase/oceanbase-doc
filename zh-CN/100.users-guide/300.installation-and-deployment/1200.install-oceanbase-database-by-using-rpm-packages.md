...
下载 OceanBase 数据库安装包后，您需要部署 OceanBase 数据库。详情参考 [生产环境部署 OceanBase 数据库](../300.installation-and-deployment/1500.deploy-oceanbase-database-in-the-production-environment.md)。
...
您在成功构建 OceanBase 数据库之后，可以使用 OBD 部署 OceanBase 数据库。详细信息请参考 [生产环境部署 OceanBase 数据库](../300.installation-and-deployment/1500.deploy-oceanbase-database-in-the-production-environment.md)。
