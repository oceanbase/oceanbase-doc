...
更多管理数据库的操作请参见 《数据库对象管理》中 [管理数据库](../../700.database-object-management/100.manage-databases/100.create-a-database.md) 章节。
...
更多 `CREATE TABLE` 语句相关的语法说明请参见《SQL 参考》中 [CREATE TABLE](../../../1400.developer-guide/700.sql-reference/500.sql-statements/1900.create-table.md) 章节。
...
- 增加、删除列
  ...
  - 设置表 `test` 的副本数，并且增加列 `c5`。
    ...
    更多 `ALTER TABLE` 语句相关的语法说明请参见《SQL 参考》中 [ALTER TABLE](../../../1400.developer-guide/700.sql-reference/500.sql-statements/700.alter-table.md) 章节。
...
更多 `DROP TABLE` 语句相关的语法说明请参见《SQL 参考》中 [DROP TABLE](../../../1400.developer-guide/700.sql-reference/500.sql-statements/3300.drop-table.md) 章节。
...
2. 执行以下命令，创建表 test 的索引。
    ...
    更多 `CREATE INDEX` 语句相关的语法说明请参见《SQL 参考》中的 [CREATE INDEX](../../../1400.developer-guide/700.sql-reference/500.sql-statements/1400.create-index.md) 章节。
...
更多 `DROP INDEX` 语句相关的语法说明请参见《SQL 参考》中的 [DROP INDEX](../../../1400.developer-guide/700.sql-reference/500.sql-statements/2800.drop-index.md) 章节。
...
- 向表 t1 中插入多行数据。
  ...
  更多 `INSERT` 语句相关的语法请参见《SQL 参考》中 [INSERT](../../../1400.developer-guide/700.sql-reference/500.sql-statements/4300.sql-statements-insert.md) 章节。
...
- 多表删除，删除 `t1`、`t2` 表中 `t1.c1 = t2.c1` 的数据。
  ...
  更多 `DELETE` 语句相关的语法说明请参见《SQL 参考》中 [DELETE](../../../1400.developer-guide/700.sql-reference/500.sql-statements/2500.sql-statements-delete.md) 章节。
...
- 修改多个表。对于表 `t1` 和表 `t2` 中满足 `t1.c2 = t2.c2` 对应行的数据，将表 `t1` 中的 `c2` 列值修改为 `100`，表 `t2` 中的 `c2` 列值修改为 `200`。
  ...
  更多 `UPDATE` 语句相关的语法请参见《SQL 参考》中 [UPDATE](../../../1400.developer-guide/700.sql-reference/500.sql-statements/6800.sql-statements-update.md) 章节。
...
3. 从表 `a` 中根据筛选条件 `name = 'a'` ，输出对应的 `id` 、`name` 和 `num`。
    ...
    更多 `SELECT` 语句相关的语法说明请参见《SQL 参考》中 [SELECT](../../../1400.developer-guide/700.sql-reference/500.sql-statements/5600.sql-statements-select/100.select-statement.md) 章节。
...
更多事务控制语句相关的说明请参见 [关于事务控制语句](../../../1400.developer-guide/400.about-dml-statements-and-transactions/200.transaction/100.about-transactional-control-statements.md)。
