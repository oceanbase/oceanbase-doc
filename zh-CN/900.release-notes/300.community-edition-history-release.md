...
[**点击查看 V4.3.4_CE Release Notes 的完整内容**](https://www.oceanbase.com/product/oceanbase-database-community-rn/releaseNote#V4.3.4)
...
OceanBase 数据库 V4.2.1_CE 版本是 V4.2.x_CE 版本系列的第一个长期支持版本（LTS），该版本新增了 VALUES 语句、JSON_TABLE 表达式等与 MySQL 兼容的功能，推出了 WR 数据采集框架和增强全链路追踪的产品化。同时，该版本还优化了系统资源的使用，并增加了表级恢复能力和对备份介质 COS 的支持。推荐将其用于常规业务的生产环境中。
