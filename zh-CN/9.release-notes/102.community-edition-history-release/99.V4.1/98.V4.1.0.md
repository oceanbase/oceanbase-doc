...
* 支持单机产品形态。
    ...
    更多信息，参见 [单机部署 OceanBase 数据库](../../../4.deploy/3.deploy-oceanbase-enterprise-edition/4.deploy-through-the-command-line/2.deploy-the-oceanbase-cluster-command-line/1.stand-alone-deployment-of-oceanbase-database-new.md)。
