...
* 支持全链路追踪
    ...
    有关全链路追踪的详细介绍，参见 [全链路追踪](../../../6.manage/9.daily-inspection/9.full-link-detection/1.full-link-diagnosis-overview.md)。
...
有关视图的详细信息，参见 [系统视图（MySQL 模式）](../../../7.reference/7.system-views/4.system-view-of-mysql-mode/1.overview-of-mysql-mode.md)、[系统视图（Oracle 模式）](../../../7.reference/7.system-views/5.system-view-of-oracle-mode/1.overview-of-oracle-mode.md)。
