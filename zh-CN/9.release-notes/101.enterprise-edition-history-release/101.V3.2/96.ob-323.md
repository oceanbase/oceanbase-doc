...
* 修复 Oracle 模式下，不能通过 DESC 展示引用 DBLINK 表的视图信息的问题。【[点击查看详细信息](https://www.oceanbase.com/knowledge-base/oceanbase-database-20000043619?back=kb)】
...
* 修复 ARM 平台上，在麒麟和统信操作系统下发现 libunwind 库兼容性问题导致 OBServer 节点启动失败的问题。【[点击查看详细信息](https://www.oceanbase.com/knowledge-base/oceanbase-database-20000038421?back=kb)】
