...
* 支持租户级备份
    ...
    有关租户级备份的更多详细信息，参见 [备份恢复](../../7.reference/2.administrator-guide/5.backup-and-recovery/2.backup-and-restoration-management/1.overview-of-physical-backup-and-recovery.md)
