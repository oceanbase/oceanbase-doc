...
<main id="notice" type='explain'>
  ...
  <li><p>obd 目前支持升级企业版和社区版 OceanBase 集群，本节以升级社区版 OceanBase 集群为例介绍升级 OceanBase 集群的操作。</p></li>
  </ul>
</main>
...
5. 对 OceanBase 数据库进行合并操作
   ...
   `oceanbase.CDB_OB_MAJOR_COMPACTION` 视图的输出字段介绍可参见 [oceanbase.CDB_OB_MAJOR_COMPACTION](../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/9800.o-cdb_ob_major_compaction-of-sys-tenant.md)。
