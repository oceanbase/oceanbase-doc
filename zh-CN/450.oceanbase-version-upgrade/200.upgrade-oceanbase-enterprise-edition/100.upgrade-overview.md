...
* 当有 V4.3 的低版本集群升级到 V4.3.3 及往后的版本集群时，对于备租户，低版本集群无法解析高版本集群生成的日志，此时会在备租户提交日志时报错（仅报错，对应日志不会持久化）。恢复数据的详细信息，参见 [恢复前准备](../../600.manage/600.backup-and-recovery/600.restore-data/100.preparation-before-recovery.md)。
...
建议按以下路径升级至 V4.4.2 BP2：

* V4.4.2/V4.4.2 BP1 版本可以直接升级到 V4.4.2 BP2 版本。
* V4.4.0/V4.4.0 BP1/V4.4.1 版本可以直接升级到 V4.4.2 BP2 版本。
* V4.3.5/V4.3.5 BP1~BP5 版本需要先经停 V4.3.5 BP6 版本后，再升级到 V4.4.2 BP2 版本。
* V4.2.5/V4.2.5 BP1~BP6 版本需要先经停 V4.2.5 BP7 版本后，再升级到 V4.4.2 BP2 版本。
...
* V4.4.x 版本的升级路径：
  ...
  * V4.4.0/V4.4.1 版本可以直接升级到 V4.4.2 版本或 V4.4.2.1/2 版本。
  * V4.4.0/V4.4.1 版本可以直接升级到 V4.6.0.0 版本。

* V5.x 版本的升级路径：

  * V4.6.0.0 版本可以升级到 V5.0.1 版本。
