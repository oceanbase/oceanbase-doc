...
如果在升级前 OceanBase 集群配置了 cgroup，那么在 OceanBase 集群升级后，需要重新配置 cgroup。详细信息，参见 [配置 cgroup](../../600.manage/200.tenant-management/600.common-tenant-operations/300.resource-isolation/300.resource-isolation-of-mysql-mode/100.config-cgroups-of-enterprise-of-mysql.md)。
...
* 有关启动 Zone 的详细信息，请参见 [启动 Zone](../../600.manage/100.cluster-management/300.common-cluster-operations/800.1.start-a-zone.md)。
