...
更多系统视图的说明信息请参考《参考指南（MySQL 模式）》文档中 [系统视图](../500.oceanbase-database-overview/300.database-objects/200.mysql-mode/600.mysql-mode-system-views/100.mysql-mode-dictionary-views.md) 章节。
...
更多分区的说明及使用请参见《管理员指南》文档中 [分区表和分区索引管理](../500.oceanbase-database-overview/300.database-objects/200.mysql-mode/400.mysql-mode-partitions/400.mysql-mode-partitioned-indexes.md) 章节。
...
更多优化器的详细信息请参见《[SQL 调优指南](../1100.sql-tuning-guide/100.execution-process-of-sql-queries.md)》。
