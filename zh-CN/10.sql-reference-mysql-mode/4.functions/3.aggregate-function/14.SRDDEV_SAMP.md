...
返回 `expr` 的样本标准差，该函数返回 `VAR_SAMP()` 函数结果的平方根。有关 `VAR_SAMP()` 函数的详细信息，请参见 [VAR_SAMP](/zh-CN/10.sql-reference-mysql-mode/4.functions/3.aggregate-function/17.VAR_SAMP.md)。
