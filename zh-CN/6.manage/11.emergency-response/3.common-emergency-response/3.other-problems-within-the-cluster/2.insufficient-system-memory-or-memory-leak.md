...
对于系统内部模块的内存问题，一般考虑重启 OBServer 节点解决。建议您通过 OCP 执行指定节点的重启操作，重启 OBServer 节点详细信息请参见 [启动 OBServer 节点](https://www.oceanbase.com/docs/enterprise-oceanbase-ocp-cn-10000000002101077) 和 [停止 OBServer 节点服务](https://www.oceanbase.com/docs/enterprise-oceanbase-ocp-cn-10000000002101078)。
