...
2. 创建 Unit（资源单元）。
   ...
   创建资源单元的详细操作及说明请参见 [创建资源单元](../../../2.basic-database-management/3.manage-resources/2.create-a-resource-unit.md)。
...
3. 创建 Resource Pool（资源池）。
   ...
   创源资源池的详细操作及说明请参见 [创建资源池](../../../2.basic-database-management/3.manage-resources/4.create-a-resource-pool.md)。
