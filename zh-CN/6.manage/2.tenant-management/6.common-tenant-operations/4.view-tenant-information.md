...
`DBA_OB_RESOURCE_POOLS` 视图参数详细说明，参见 [DBA_OB_RESOURCE_POOLS](../../../7.reference/7.system-views/4.system-view-of-mysql-mode/2.dictionary-view-of-mysql-mode/47.oceanbase-dba_ob_resource_pools-of-mysql-mode.m)。
