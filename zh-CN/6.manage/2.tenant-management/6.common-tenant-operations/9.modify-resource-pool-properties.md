...
3. 通过 `DBA_OB_RESOURCE_POOLS` 视图，获取资源池的配置信息。
    ...
    `DBA_OB_RESOURCE_POOLS` 视图的详细说明，参见 [oceanbase.DBA_OB_RESOURCE_POOLS](../../../7.reference/7.system-views/4.system-view-of-mysql-mode/2.dictionary-view-of-mysql-mode/47.oceanbase-dba_ob_resource_pools-of-mysql-mode.md)。
...
4. 通过 `ALTER RESOURCE POOL` 语句，修改资源池配置。
    ...
    * `ZONE_LIST`：资源池的 Zone 分布。
    ...
    `ALTER RESOURCE POOL` 语句的详细说明，参见 [ALTER RESOURCE POOL](../../../7.reference/5.sql-reference/1.sql-syntax/1.system-tenants/3.alter-resource-pool.md)。

    `ALTER RESOURCE TENANT` 语句的详细说明，参见 [ALTER RESOURCE TENANT](../../../7.reference/5.sql-reference/1.sql-syntax/1.system-tenants/3.alter-resource-tenant.md)。
