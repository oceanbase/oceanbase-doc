...
2. 查询 `DBA_OB_SERVERS` 视图，获取集群中的所有节点信息。
   ...
   * `BUILD_VERSION`：OceanBase 数据库软件的版本号。
   ...
   有关 `DBA_OB_SERVERS` 视图的更多详细信息，请参见 [DBA_OB_SERVERS](../../../7.reference/7.system-views/4.system-view-of-mysql-mode/2.dictionary-view-of-mysql-mode/50.oceanbase-dba_ob_servers-of-mysql-mode.md)。
