...
* 请确认待增加的所有 OBServer 服务器已完成相关配置，具体操作可参见 [服务器配置](../../../4.deploy/3.deploy-oceanbase-enterprise-edition/2.preparations-before-deploy/2.configure-servers.md) 章节和 [部署环境配置](../../../4.deploy/3.deploy-oceanbase-enterprise-edition/4.deploy-through-the-command-line/1.configure-a-deployment-environment-command-line/1.initializing-the-observer-server-using-oatcli.md) 章节。
