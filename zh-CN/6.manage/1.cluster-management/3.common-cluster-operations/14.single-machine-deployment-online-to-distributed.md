...
5. 查看 observer 进程是否启动成功。
   ...
   * `ps -ef|grep observer` 命令可以返回 observer 进程信息。
   ...
   admin     60492      0 37 17:14 ?        00:00:37 /home/admin/oceanbase/bin/observer -I 10.10.10.3 -P 2882 -p 2881 -z zone3 -d /home/admin/oceanbase/store/obdemo -r 10.10.10.3:2882:2881 -c 10001 -n obdemo -o system_memory=30G,datafile_size=100G,config_additional_dir=/data/1/obdemo/etc3;/data/log1/obdemo/etc2
   ```
