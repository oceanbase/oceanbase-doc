...
* 部署环境已完成相关配置。有关部署环境的详细信息，请参见 [部署环境配置](../../../4.deploy/3.deploy-oceanbase-enterprise-edition/4.deploy-through-the-command-line/1.configure-a-deployment-environment-command-line/1.initializing-the-observer-server-using-oatcli.md)。
