...
3. 操作成功后，可以查询 `oceanbase.DBA_OB_ZONES` 视图进行确认。
   ...
   有关 `DBA_OB_ZONES` 视图的更多详细信息，请参见 [DBA_OB_ZONES](../../../7.reference/7.system-views/4.system-view-of-mysql-mode/2.dictionary-view-of-mysql-mode/63.oceanbase-dba_ob_zones-of-mysql-mode.md)。
