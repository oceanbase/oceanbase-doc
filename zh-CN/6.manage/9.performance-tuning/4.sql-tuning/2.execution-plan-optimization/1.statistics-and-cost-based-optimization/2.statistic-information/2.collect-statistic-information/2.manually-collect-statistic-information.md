...
<main id="notice" type='explain'>
    <h4>说明</h4>
    <p>有关 `DBMS_STATS` 系统包的详细信息，参见 [DBMS_STATS 概述（MySQL 模式）](../../../../../../../7.reference/4.development-reference/3.pl-reference/2.pl-mysql/10.pl-system-package-mysql/159.dbms-stats-mysql/1.dbms-stats-overview-mysql.md) 和 [DBMS_STATS 概述（Oracle 模式）](../../../../../../../7.reference/4.development-reference/3.pl-reference/3.pl-oracle/14.pl-system-package-oracle/159.dbms-stats-oracle/1.dbms-stats-overview-oracle.md)。</p>
</main>
...
* [PL 语法结构（MySQL 模式）](../../../../../../../7.reference/4.development-reference/3.pl-reference/2.pl-mysql/1.basic-syntax-mysql.md)
