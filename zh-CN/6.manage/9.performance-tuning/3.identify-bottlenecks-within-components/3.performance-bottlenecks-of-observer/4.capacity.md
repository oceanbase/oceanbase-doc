...
* 调整集群参数
    ...
    <main id="notice" type='explain'>
    <h4>说明</h4>
    <p><code>cpu_quota_concurrency</code>用于设置租户的每个 CPU 配额所允许的最大并发数。详细信息，参见 <a href="../../../../7.reference/5.system-reference/1.system-configuration-items/4.tenant-level-configuration-items/55.cpu_quota_concurrency.md">cpu_quota_concurrency</a>。</p>
    </main>
