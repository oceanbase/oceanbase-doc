...
在进行恢复操作前，请务必确认待恢复的备份数据的版本，OceanBase 数据库当前仅支持将低版本的备份数据恢复到同版本或高版本中，同版本下的小版本之间也不支持逆向恢复。例如，如果您的备份数据为 OceanBase 数据库 V4.2.0 版本，则仅支持将该数据恢复到 V4.2.0 及以上版本中。
  
同时，对于 OceanBase 数据库 V4.2.0 版本，支持恢复 V4.1.0 及以上版本的数据，但不支持恢复 V4.0.x 版本的数据。即，OceanBase 数据库 V4.1.x 版本的备份数据可以恢复到 V4.2.0 版本中，而 V4.0.x 版本的数据不能恢复到 V4.2.0 版本中。
