...
2. 获取租户的 Zone、Server 及日志流副本信息。
   ...
   有关 `CDB_OB_LS_LOCATIONS` 视图的更多信息，请参见 [CDB_OB_LS_LOCATIONS](../../../7.reference/5.system-reference/4.system-view-of-mysql-mode/2.dictionary-view-of-mysql-mode/93.oceanbase-cdb_ob_ls_locations-of-mysql-mode.md)。
