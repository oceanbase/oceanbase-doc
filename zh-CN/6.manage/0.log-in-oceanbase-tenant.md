...
关于通过 OBClient 客户端连接的详细信息，参见 [通过 MySQL 客户端连接 OceanBase 租户](../3.develop/1.application-development-of-mysql-mode/1.database-connection-with-client-of-mysql-mode/3.connect-to-an-oceanbase-tenant-by-using-obclient-of-mysql-mode.md)。
### 登录最佳实践
