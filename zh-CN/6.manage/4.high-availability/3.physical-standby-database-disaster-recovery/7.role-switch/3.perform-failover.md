...
3. 检查备租户是否已切换为主租户。
   ...
   有关 `DBA_OB_TENANTS` 视图的更多说明，请参见 [oceanbase.DBA_OB_TENANTS（MySQL 模式）](../../../../7.reference/14.system-reference/4.system-view-of-mysql-mode/1.overview-of-mysql-mode.md) 和 [DBA_OB_TENANTS（Oracle 模式）](链接暂时无法添加)。
