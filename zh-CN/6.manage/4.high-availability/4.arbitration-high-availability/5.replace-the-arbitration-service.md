...
请确认待替换仲裁服务的新机器上已安装 OceanBase 数据库软件并已启动仲裁服务，详细操作可参见 [部署两副本加仲裁服务的 OceanBase 集群](../../../4.deploy/3.deploy-oceanbase-enterprise-edition/4.deploy-through-the-command-line/2.deploy-the-oceanbase-cluster-command-line/2.deploy-the-quorum-high-availability-service-new.md)。
