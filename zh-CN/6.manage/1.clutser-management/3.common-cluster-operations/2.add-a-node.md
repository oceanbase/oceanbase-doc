...
1. 启动 OBServer。
   ...
   2. 执行以下命令，启动 OBServer。
      ...
      * `-o`：用于指定集群的启动配置项。
      ...
      ```shell
      [admin@xxx oceanbase]$ /home/admin/oceanbase/bin/observer -i eth0 -P 2882 -p 2881 -z zone4 -d /home/admin/oceanbase/store/obdemo -r 'xx.xx.xx.10:2882:2881;xx.xx.xx.11:2882:2881;xx.xx.xx.12:2882:2881' -c 20190716 -n obdemo -o "memory_limit_percentage=90,memstore_limit_percentage=60,datafile_disk_percentage=80,config_additional_dir=/data/1/obdemo/etc3;/data/log1/obdemo/etc2"
      ```
