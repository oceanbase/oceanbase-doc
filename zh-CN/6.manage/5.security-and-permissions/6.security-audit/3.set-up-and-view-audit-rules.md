...
| 字典视图     |  功能说明   |
|-----------|--------|
| [ALL_DEF_AUDIT_OPTS](../../../7.reference/5.system-reference/5.system-view-of-oracle-mode/2.dictionary-view-of-oracle-mode/9.all_def_audit_opts-of-oracle-mode.md)  | 记录任何新创建对象的默认审计规则。每列的取值如下：<ul><li>  <code>-/-</code>：默认不审计 </li><li> <code>A/-</code>: 只在语句执行成功时审计 </li><li> <code>-/A</code>: 只在语句执行失败时审计 </li><li> <code>A/A</code>: 语句执行无论成功还是失败时都审计 </li></ul>  |
