...
添加权限后，系统会将该权限添加到租户内的每个用户的权限域中。所有用户都可以立即执行该权限所授权的操作。关于 `PUBLIC` 角色的更多信息，参见 [角色管理概述](4.manage-roles-of-oracle-mode/1.role-management-overview-of-oracle-mode.md)。
