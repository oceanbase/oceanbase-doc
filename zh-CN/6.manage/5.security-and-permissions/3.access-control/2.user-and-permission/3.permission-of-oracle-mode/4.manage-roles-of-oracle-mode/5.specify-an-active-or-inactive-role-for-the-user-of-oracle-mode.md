...
查看当前拥有权限的操作请参见 [查看用户权限](../4.view-the-user-permissions-of-oracle-mode.md)。如果您没有 `GRANT OPTION` 权限，请联系管理员为您添加，为用户添加权限的相关操作请参见 [修改用户权限](../7.modify-user-permissions-of-oracle-mode.md)。查看当前拥有角色的操作请参见 [查看角色](../4.manage-roles-of-oracle-mode/6.view-roles-of-oracle-mode.md)。
