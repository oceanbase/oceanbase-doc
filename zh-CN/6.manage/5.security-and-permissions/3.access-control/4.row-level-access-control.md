...
2. 修改 `LBACSYS` 用户的登录密码。
   ...
   为了保障安全性，`LBACSYS` 用户的密码由 `sys` 用户指定。
...
5. 创建级别 Level 并指定其短名称和长名称。
   ...
   关于创建级别的详细信息，参见 [SA_COMPONENTS.CREATE_LEVEL](../../../7.reference/4.development-reference/3.pl-reference/3.pl-oracle/13.pl-label-security-package/3.sa_components-tag-package/3.sa_components-create_level.md)。
...
6. 创建数据标签 Label 并查看结果。
   ...
   关于创建数据标签的详细信息，参见 [SA_LABEL_ADMIN.CREATE_LABEL](../../../7.reference/4.development-reference/3.pl-reference/3.pl-oracle/13.pl-label-security-package/4.sa_label_admin-tag-management-pack/3.sa_label_admin-create_label.md)。
...
7. 指定用户的 Label。
   ...
   2. 以安全管理员 `LBACSYS` 登录，为用户 `user1` 指定 Label。
      ...
      关于为用户指定标签的详细信息，参见 [SA_USER_ADMIN.SET_LEVELS](../../../7.reference/4.development-reference/3.pl-reference/3.pl-oracle/13.pl-label-security-package/6.sa_user_admin-user-tag-management-pack/2.sa_user_admin-set_levels.md)。
...
8. 应用策略到表上。
   ...
   2. 以安全管理员 `LBACSYS` 登录，将策略 `MY_POLICY` 应用到表 `tbl1` 上。
      ...
      关于将指定的策略添加到表中的详细信息，参见 [SA_POLICY_ADMIN.APPLY_TABLE_POLICY](../../../7.reference/4.development-reference/3.pl-reference/3.pl-oracle/13.pl-label-security-package/5.sa_policy_admin-policy-management-packs/2.sa_policy_admin-apply_table_policy.md)。
...
9. 插入数据，验证查询结果。
   ...
   2. 在 `user1` 用户下设置 `SESSION LABEL` 和 `ROW LABEL`。
      ...
      关于设置当前数据库会话标签的详细信息，参见 [SA_SESSION.SET_LABEL](../../../7.reference/4.development-reference/3.pl-reference/3.pl-oracle/13.pl-label-security-package/7.sa_session-session-management-pack/5.sa_session-set_label.md)。

      关于设置当前数据库会话默认行标签值的详细信息，参见 [SA_SESSION.SET_ROW_LABEL](../../../7.reference/4.development-reference/3.pl-reference/3.pl-oracle/13.pl-label-security-package/7.sa_session-session-management-pack/6.sa_session-set_row_label.md)。
