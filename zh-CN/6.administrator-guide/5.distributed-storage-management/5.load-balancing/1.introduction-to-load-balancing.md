...
详细信息，参见 [管理自动负载均衡](/zh-CN/6.administrator-guide/5.distributed-storage-management/5.load-balancing/2.manage-automatic-load-balancing.md) 和 [手动发起 Partition 的迁移和切换](/zh-CN/6.administrator-guide/5.distributed-storage-management/5.load-balancing/3.manually-manage-load-balancing/1.manually-initiate-partition-migration-and-switchover.md)、[通过 Table group 设置负载均衡](/zh-CN/6.administrator-guide/5.distributed-storage-management/5.load-balancing/3.manually-manage-load-balancing/2.configure-load-balancing-through-table-groups.md)、[通过 Primary Zone 设置负载均衡](/zh-CN/6.administrator-guide/5.distributed-storage-management/5.load-balancing/3.manually-manage-load-balancing/3.configure-load-balancing-through-primary-zone.md)。
