...
有关系统变量的详细介绍请参见 [系统变量概述](../../14.system-reference/3.system-variable-for-oracle/1.overview-of-system-variables-4.md) ，有关用户变量设置，请参见 [SET](../../../10.sql-reference-mysql-mode/6.sql-statement/61.SET-1.md)。
