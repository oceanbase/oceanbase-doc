...
租户级副本变更操作，请参见 [Locality 管理](/zh-CN/6.administrator-guide/5.data-distribution-and-path-management/3.locality-management/1.overview-of-locality-management.md) 章节。
