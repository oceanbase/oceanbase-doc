...
|  **元素**  |                                                                                  **说明**                                                                                   |
|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| replicas | 表示副本类型，副本类型相关说明请参见[副本概述](/zh-CN/6.administrator-guide/5.data-distribution-and-path-management/2.manage-replicas/1.overview-of-replicas.md)章节。  `replicas`的值为副本名称，您可以在副本类型说明表中的 **名称** 列获得支持的值（支持全名和简写）。                        |
