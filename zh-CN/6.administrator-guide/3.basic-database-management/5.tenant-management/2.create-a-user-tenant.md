...
6. 创建租户。
   ...
   详细信息，参考 [租户管理概述](../5.tenant-management/1.overview-of-tenant-management.md)。
...
首次使用新租户连接 OceanBase 数据库时，您必须使用 `root` 用户。成功连接后，您可以创建新用户连接 OceanBase 数据库。详细信息，参考 [创建用户](../../3.basic-database-management/5.tenant-management/2.create-a-user-tenant.md) 文档。
