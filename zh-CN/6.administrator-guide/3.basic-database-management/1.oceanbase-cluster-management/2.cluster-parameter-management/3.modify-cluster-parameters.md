...
更多配置项信息，请参见《参考指南》文档中 [系统配置项概述](../../../6.administrator-guide/3.basic-database-management/1.oceanbase-cluster-management/2.cluster-parameter-management/3.modify-cluster-parameters.md) 章节。
