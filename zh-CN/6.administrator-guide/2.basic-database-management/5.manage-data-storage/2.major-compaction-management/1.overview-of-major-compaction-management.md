...
更多合并相关的详细介绍信息，请参见 [合并](/zh-CN/5.oceanbase-database-overview/8.storage-architecture/3.minor-compaction-and-major-compaction/3.major-compaction.md)。

合并相关的配置项及其说明请参见 [修改合并配置](/zh-CN/6.administrator-guide/2.basic-database-management/5.manage-data-storage/2.major-compaction-management/7.modify-major-compaction-configurations.md)。
...
合并超时与报错的更多介绍信息，请参见 [合并超时与报错](/zh-CN/6.administrator-guide/2.basic-database-management/5.manage-data-storage/2.major-compaction-management/6.major-compaction-timeout-and-errors.md)。
...
MySQL 租户创建表并指定压缩算法的语法请参见 [CREATE TABLE](/zh-CN/10.sql-reference/5.sql-statements/19.create-table.md)。
