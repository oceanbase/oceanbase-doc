...
2. 通过以下方式查看用户权限：
   ...
   * 查看用户所拥有的用户级权限。
     ...
     *************************** 1. row ***************************
     ...
     更多 `mysql.user` 视图的字段及说明请参见 [mysql.user](/zh-CN/12.reference-guide/1.system-views/1.dictionary-views/36.mysql-user.md)。
   ...
   * 查看用户所拥有的数据库级权限。
     ...
     *************************** 1. row ***************************
     ...
     更多 `mysql.db` 视图的字段及说明请参见 [mysql.db](/zh-CN/12.reference-guide/1.system-views/1.dictionary-views/26.mysql-db.md)。
...
* [用户及权限概述](/zh-CN/6.administrator-guide/2.basic-database-management/4.manage-tenants/5.manage-users-and-privileges/1.introduction-to-users-and-privileges/1.overview-of-users-and-privileges.md)

  

* [修改用户权限](/zh-CN/6.administrator-guide/2.basic-database-management/4.manage-tenants/5.manage-users-and-privileges/6.modify-user-privileges.md)
