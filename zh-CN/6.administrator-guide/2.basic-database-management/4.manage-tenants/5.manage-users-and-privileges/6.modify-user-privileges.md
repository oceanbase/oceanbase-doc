...
查看当前拥有权限的操作请参见 [查看用户权限](5.view-user-privileges.md)。
...
更多 `GRANT` 语句的信息请参见 [GRANT](../../../../10.sql-reference/5.sql-statements/41.grant.md)。
...
更多 `REVOKE` 语句的信息请参见 [REVOKE](../../../../10.sql-reference/5.sql-statements/53.revoke.md)。
