...
创建资源单元后，管理员就可以在创建资源池时指定资源单元，并最终分配给相应的租户，更多资源单元的管理操作请参见 [管理资源单元](https://code.alipay.com/oceanbase-docs/oceanbase-doc/tree/zyj3.1.2/zh-CN%2F6.administrator-guide%2F2.basic-database-management%2F3.manage-resources%2F3.manage-resource-units)。
