...
5. 启动 OBServer，并将 OBServer 注册到集群。
   ...
   3. 启动 OBServer。
      ...
      * `-o` 参数用于指定启动配置项。
        ...
        更多配置项的详细信息，请参见《参考指南》文档中的 [系统配置项](https://code.alipay.com/oceanbase-docs/oceanbase-doc/blob/zyj3.1.2/zh-CN/12.reference-guide/3.system-configuration-items/1.overview-of-system-configuration-items.md)。
