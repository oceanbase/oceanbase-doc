# 修改用户权限
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/modify-user-permissions-2
...
更多 `GRANT` 语句的信息请参见 [GRANT](../../../../../10.sql-reference-mysql-mode/6.sql-statement/44.GRANT.md)。
...
更多 `REVOKE` 语句的信息请参见 [REVOKE](../../../../../10.sql-reference-mysql-mode/6.sql-statement/56.REVOKE.md)。
