...
3. 在左侧导航栏单击 **SQL 诊断** ，进入 **SQL 诊断** 页面。
   ...
   ![08251639](http://icms-x-dita.oss-cn-zhangjiakou.aliyuncs.com/xdita-output/zh-CN/task14977521/images/p312416.png?Expires=7258146979&OSSAccessKeyId=LTAIJfoPL6wmrirR&Signature=fRQjIAGe63qZ%2B7wyOn6LYU6lVzM%3D)
...
5. 对可疑 SQL 进行筛选。
   ...
   1. 配置筛选条件
      ...
      * 高级搜索：下拉框中选择 **SQL ID、执行次数、每秒执行次数** 等指标，并配置指标值，查询时将获取指标满足条件的 SQL 展示在查询结果列表中。
      ...
      ![08251810](http://icms-x-dita.oss-cn-zhangjiakou.aliyuncs.com/xdita-output/zh-CN/task14977521/images/p312501.png?Expires=7258146979&OSSAccessKeyId=LTAIJfoPL6wmrirR&Signature=ECw8Lv8SrNDIX3l%2B5rKhKKGKebs%3D)
...
7. 查看可疑 SQL 信息。
   ...
   1. 在 **可疑 SQL** 页签下，可复制 SQL 文本，根据数据库对 SQL 文本进行筛选，根据执行次数、平均 CPU 时间、平均响应时间、总响应时间和最后执行时间对 SQL 文本进行排序，并查看诊断结果。![1](http://icms-x-dita.oss-cn-zhangjiakou.aliyuncs.com/xdita-output/zh-CN/task14977521/images/p268604.png?Expires=7258146979&OSSAccessKeyId=LTAIJfoPL6wmrirR&Signature=%2F1BFoMocq4OpXr31k3mwJTbYcaI%3D)

      
   
   2. 单击 SQL 文本下内容，您可进入具体 SQL 页面。

      1. 您可在SQL 文本区域 复制 或 **查看全部** SQL 信息。![2](http://icms-x-dita.oss-cn-zhangjiakou.aliyuncs.com/xdita-output/zh-CN/task14977521/images/p268593.png?Expires=7258146979&OSSAccessKeyId=LTAIJfoPL6wmrirR&Signature=3SGzlLh5oiyvaLfRSyvUwFCO%2FXE%3D)
      ...
      3. 查看历史趋势：您可选择不同 IP、不同时间段的不同指标查看历史趋势。![1](http://icms-x-dita.oss-cn-zhangjiakou.aliyuncs.com/xdita-output/zh-CN/task14977521/images/p268595.png?Expires=7258146979&OSSAccessKeyId=LTAIJfoPL6wmrirR&Signature=syXRp3Qw3urmuRJiilB8qHh3oc8%3D)
