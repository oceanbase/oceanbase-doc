...
对问题 RS 所在的 OB 节点做重启操作，详情请参见 [重启 OBServer 服务](../../../../../6.administrator-guide/2.basic-database-management/1.manage-clusters/5.manage-observers/4.restart-an-observer.md)。
