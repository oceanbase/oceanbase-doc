...
2. 调高转储线程数，加快转储，让内存尽快释放。
   ...
   **注意**
   ...
   您还可以在 OCP 界面通过修改转储策略调高转储线程数，具体参见[修改转储配置](../../../../../6.administrator-guide/2.basic-database-management/5.manage-data-storage/1.minor-compaction-management/5.modify-minor-compaction-configurations.md))。
