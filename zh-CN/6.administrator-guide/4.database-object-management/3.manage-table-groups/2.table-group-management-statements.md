...
本节主要介绍非分区表组的管理，分区表组的相关内容请参见 [创建一级分区表表组](/zh-CN/6.administrator-guide/5.distributed-storage-management/2.manage-partitions/9.create-partitioned-table-groups.md)。
