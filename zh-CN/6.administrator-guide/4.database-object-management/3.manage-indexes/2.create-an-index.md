...
本节主要介绍如何通过 `CREATE INDEX` 语句在非分区表上创建索引，分区表上索引的创建请参见 [局部索引](/en-US/6.administrator-guide/5.data-distribution-and-path-management/1.manage-partitioned-tables-and-partitioned-indexes/6.create-an-index-on-a-partitioned-table/1.local-index.md)章节。
