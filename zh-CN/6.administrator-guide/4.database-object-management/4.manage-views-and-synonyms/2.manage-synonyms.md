...
`CREATE SYNONYM` 语句的更多信息，请参见《SQL 参考》文档中的 [CREATE SYNONYM](/zh-CN/8.sql-reference/5.sql-statements/17.create-synonym.md) 章节。
...
`DROP SYNONYM` 语句的更多信息，请参见《SQL 参考》文档中的 [DROP SYNONYM](/zh-CN/8.sql-reference/5.sql-statements/33.drop-synonym.md) 章节。
