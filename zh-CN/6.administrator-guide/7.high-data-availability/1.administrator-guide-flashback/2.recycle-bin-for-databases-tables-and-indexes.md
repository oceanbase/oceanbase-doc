...
更多配置项 `recyclebin_object_expire_time` 的说明信息请参见 [recyclebin_object_expire_time](/zh-CN/12.reference-guide/3.system-configuration-items/229.recyclebin_object_expire_time.md)。
