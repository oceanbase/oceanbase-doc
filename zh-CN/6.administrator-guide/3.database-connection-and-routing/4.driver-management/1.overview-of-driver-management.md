...
有关 OB-ODBC 驱动的详细介绍，请参见 [OB-ODBC 驱动](/zh-CN/6.administrator-guide/3.database-connection-and-routing/4.driver-management/2.ob-odbc-driver.md)。
...
有关 OBCI 驱动的详细介绍，请参见 [OBCI 驱动](/zh-CN/6.administrator-guide/3.database-connection-and-routing/4.driver-management/3.obci-driver.md)。
...
有关 OceanBase Connector/C 的详细介绍，请参见 [OceanBase Connector/C](/zh-CN/6.administrator-guide/3.database-connection-and-routing/4.driver-management/4.oceanbase-connector-c.md)。
...
有关 OceanBase Connector/J 驱动的详细介绍，请参见 [OceanBase Connector/J](/zh-CN/6.administrator-guide/3.database-connection-and-routing/4.driver-management/5.oceanbase-connector-j.md)。
