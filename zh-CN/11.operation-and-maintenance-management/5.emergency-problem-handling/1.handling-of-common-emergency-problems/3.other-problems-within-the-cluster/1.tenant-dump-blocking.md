...
* 未提交的长事务
  ...
  租户的转储卡住时，可以排查数据库中的是否存在长事务，根据需要杀掉导致转储卡住的长事务。排查长事务的具体步骤参见 [事务](../../../6.common-operation-and-maintenance-operations/5.performance%20issues/2.Long%20and%20dangling%20transaction%20diagnostics.md)。
