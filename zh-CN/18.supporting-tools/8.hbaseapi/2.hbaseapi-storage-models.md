...
已连接 OceanBase 数据库。
您可使用 obclient 或 MySQL 客户端登录 OceanBase，具体方法可参考 [通过 obclient 连接 OceanBase 租户](../../14.developer-guide/0.connect-to-oceanbase-database/3.connect-oceanbase-tenants-through-obclient.md) 和 [通过 MySQL 客户端连接 OceanBase 数据库](../../14.developer-guide/0.connect-to-oceanbase-database/2.connect-oceanbase-tenants-through-MySQL-client.md)。
