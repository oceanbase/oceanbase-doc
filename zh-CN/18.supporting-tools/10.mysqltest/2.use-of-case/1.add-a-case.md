...
在通用的 t 目录下，假设我们测试 create table like 这个功能，case 文件最好能反映测试点，比如 create_table_like_syntax.test 为语法级别的测试。
...
`sequence_sql_demo_mysql.test` 主要目的是测试 sequence 基本功能。其中井号（#）开头的行内容为备注说明。
...
#owner: 特性负责人
#owner group: 组别
#description: obmysql 模式，sql 使用场景
#tags:sequence
#author: XXX
purge recyclebin;
