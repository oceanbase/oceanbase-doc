...
OBD 全称为 OceanBase Deployer，是 OceanBase 开源软件的安装部署工具。OBD 同时也是包管理器，可以用来管理 OceanBase 所有的开源软件。详细的使用说明，请参考 [OBD 文档](https://github.com/oceanbase/obdeploy/blob/master/README-CN.md)。
