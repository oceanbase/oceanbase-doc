...
* 向量索引检索支持调用本文档中的 `L2_distance`、`Cosine_distance`、`Inner_product`、`Negative_inner_product` 距离函数。
...
![L2 距离的平方](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer/V4.4.1/%E5%90%91%E9%87%8F/l2-squared.jpg?Expires=1758615121&OSSAccessKeyId=TMP.3KmtqadZRg4kcDCz1KXJ1KP81QcwXFYpV7ky9qdyx4eWyDUwFJx6FUswzH6NkrGZVshHhiFXrZy8oyuvwJ8EckrCCTSooh&Signature=5MVcITR59zPx9cSkKknzAGeJdQg%3D&x-oss-request-payer=requester)
