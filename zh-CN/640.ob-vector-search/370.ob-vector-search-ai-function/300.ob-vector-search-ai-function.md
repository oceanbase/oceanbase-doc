...
| expr | 用户输入的数据。文本占位符对应字符串；图片占位符对应 HTTPS URL 或 `FROM_BASE64(...)` 返回的二进制数据。<main id="notice" type='notice'><h4>注意</h4><p>图片处理从 V5.0.1 版本开始支持。</p></main> | VARCHAR(max_length) | No |
