...
| 向量索引 | <ul><li>支持精确搜索和近似最近邻搜索。</li><li>支持 L2 距离、内积和余弦相似度计算。</li><li>支持 HNSW 索引/HNSW SQ 索引，索引列最大维度为 4096。</li><li>支持 IVF 索引/IVF SQ 索引/IVF PQ 索引（实验特性），索引列最大维度为 4096。</li></ul> |
