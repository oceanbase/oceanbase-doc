...
* 可以通过 [[G]V$OB_IVF_INDEX_INFO](../700.reference/700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/960.gv-ob_ivf_index_info-of-mysql-mode.md) 视图查看 IVF/IVF_PQ 索引的基本信息和实时状态。
