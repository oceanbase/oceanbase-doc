...
* 向量索引对 Offline DDL 的支持情况请见[Offline DDL](../../../500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/700.ddl-function-of-mysql-mode/150.online-and-offline-ddl-list-of-mysql-mode.md)。

## 准备工作

使用 HNSW/HNSW_SQ 向量索引前，需要通过设置 [ob_vector_memory_limit_percentage](../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/6150.ob_vector_memory_limit_percentage.md) 开启向量功能。IVF/IVF_SQ/IVF_PQ 索引不需要常驻内存，所以无需手动设置此参数来开启向量功能。
