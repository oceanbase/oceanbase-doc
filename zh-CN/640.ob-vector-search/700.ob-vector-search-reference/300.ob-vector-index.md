...
OceanBase 支持 HNSW 索引，支持 L2 和内积（IP）距离作为索引距离算法。HNSW 索引是一种内存索引，需要完整载入内存，支持 DML 和实时查询。
...
```shell
OceanBase(root@oceanbase)>CREATE TABLE vec_table (id int, c2 vector(10));
Query OK, 0 rows affected

OceanBase(root@oceanbase)>CREATE VECTOR INDEX vec_idx1 ON vec_table(c2) WITH (distance=l2, type=hnsw);
Query OK, 0 rows affected

OceanBase(root@oceanbase)>SHOW CREATE TABLE vec_table;
+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Table     | Create Table                                                                                                                                                                                                                                                                                                                                                                                         |
+-----------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
```shell
OceanBase(root@oceanbase)>DROP INDEX vec_idx1 ON vec_table;
Query OK, 0 rows affected
