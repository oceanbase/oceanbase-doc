...
该配置项的具体数值需要根据您的内存占用情况来规划，内存计算方式请参见 [ob_vector_memory_limit_percentage](../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/8600.ob_vector_memory_limit_percentage.md)。
