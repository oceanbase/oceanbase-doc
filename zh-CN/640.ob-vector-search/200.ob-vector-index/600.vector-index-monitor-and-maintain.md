...
* 可以通过 [[G]V$OB_SINDI_INDEX_INFO](../../700.reference/700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/970.gv-ob_sindi_index_info-of-mysql-mode.md) 视图查看内存稀疏索引的基本信息和实时状态。
