...
| [[G]V$OB_HNSW_INDEX_SEGMENT_INFO](../../700.reference/700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/951.gv-ob_hnsw_index_segment_info-of-mysql-mode.md) | 查看 HNSW 系列索引表的单分区中每个数据段（Segment）的基本信息和实时状态 |
