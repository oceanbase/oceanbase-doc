...
* 如果系统租户的密码通过终端登陆并修改，非默认空值，则需要通过 [obd cluster edit-config](https://open.oceanbase.com/docs/obd-cn/V1.2.0/10000000000017241#title-0v1-i8a-zjf) 命令将密码设置到配置文件，配置项是 `# root_password: # root user password`。
