...
OceanBase 数据库安装完成后，您需要部署 OceanBase 数据库。详情参考 [生产环境部署 OceanBase 数据库](../../1.users-guide/3.installation-and-deployment/15.deploy-oceanbase-database-in-the-production-environment.md)。
