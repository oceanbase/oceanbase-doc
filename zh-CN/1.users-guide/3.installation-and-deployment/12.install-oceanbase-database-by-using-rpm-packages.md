...
OceanBase 数据库安装完成后，您需要部署 OceanBase 数据库。详情参考 [使用 OBD 部署 OceanBase 数据库](../2.quick-start/4.deploy-a-single-cluster-with-obd.md)。
...
您在成功构建 OceanBase 数据库之后，可以使用 OBD 部署 OceanBase 数据库。详细信息请参考 [使用 OBD 部署 OceanBase 数据库](../2.quick-start/4.deploy-a-single-cluster-with-obd.md)。
