...
```bash
[root@obce00 ~]# mysql -h 172.20.249.52 -P 2883 -u proxyro@sys#o***-3zones -puY7Yf8zx -c -A
...
```bash
[root@obce00 ~]# mysql -h 172.20.249.52 -P 2883 -u proxyro@sys#o***-3zones -puY7Yf8zx -c -A -Ns -e "show databases;"
oceanbase
information_schema
[root@obce00 ~]#
```
