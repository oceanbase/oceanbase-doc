...
也可以通过 OBD 来部署 ODP ，具体可参考 [创建 ODP 集群](../../../5.database-connection-and-routing/2.obproxy-management/2.manage-the-obproxy-cluster/1.create-an-OBProxy-cluster.md)
...
conn=jdbc:oceanbase://127.0.0.1:2883/tpccdb?useUnicode=true&characterEncoding=utf-8&rewriteBatchedStatements=true&allowMultiQueries=true
user=root@test
password=root
...
> - conn：此处的 IP 建议填写 OceanBase server 的 IP，并且部署 ODP 通过 2883 端口访问，其他部分保持和模板一致。
