...
>**说明**
>
>更多关于 `obd test tpch` 命令的说明请参考 [测试命令组](https://www.oceanbase.com/docs/community-obd-cn-10000000001031935#obd%20test%20tpch)
...
通过上一步的自动测试，我们已经获得了一个TPCH的测试环境，下面让我们通过手动执行来看看，OceanBase 在 OLAP 方面的能力和特性。
