...
您可以升级单个/多个 OBProxy，也可以升级 OBProxy 集群下所有 OBProxy。有关升级 OBProxy 集群下所有 OBProxy 的操作方法，请参见 [升级 OBProxy 集群下全部 OBProxy](../2.manage-the-obproxy-cluster/4.upgrade-all-OBProxy-under-the-OBProxy-cluster.md)。
