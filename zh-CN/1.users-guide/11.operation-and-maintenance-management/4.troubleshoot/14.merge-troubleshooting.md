...
* 对于社区版 OceanBase 数据库 V3.1.X 版本，查询 `__all_virtual_core_meta_table`、`__all_virtual_core_root_table`、`__all_root_table` 与 `__all_meta_table` 表。
...
1. 定位未合并到指定版本的 partition。
   ...
   *
     ...
     **说明**
     ...
     对于 V3.1.3 版本，meta 表指`__all_virtual_core_meta_table`、`__all_virtual_core_root_table`、`__all_root_table`、`__all_virtual_meta_table`。
