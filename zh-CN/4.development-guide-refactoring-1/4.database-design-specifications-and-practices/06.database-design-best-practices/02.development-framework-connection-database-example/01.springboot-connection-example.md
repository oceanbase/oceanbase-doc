# SpringBoot 连接示例
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/springboot-connection-example
...
然后通过 `http://localhost:8081/xxxxx` 就可以访问 `xxxxx` 就是对应的 `id` 字段，如果数据库存在就可以查询到结果。
