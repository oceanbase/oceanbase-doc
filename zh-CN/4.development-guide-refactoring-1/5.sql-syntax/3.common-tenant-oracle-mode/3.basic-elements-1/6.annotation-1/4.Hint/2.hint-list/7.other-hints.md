...
OceanBase 数据库支持使用绑定变量替换 SQL 语句中的字面量，此功能由 `CURSOR_SHARING` 变量控制，即当`cursor_sharing='exact' ` 时不需要参数化，详细信息请参见 [cursor_sharing](../../../../../13.reference-oracle-mode/2.system-variable-6/20.cursor_sharing.md)。
