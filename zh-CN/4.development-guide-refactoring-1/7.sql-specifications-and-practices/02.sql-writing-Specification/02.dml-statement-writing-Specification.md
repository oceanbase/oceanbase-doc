...
* 在业务 cache 表场景中，比如频繁 insert 或 delete，数据生命周期较短的场景，需要添加 HINT 指定查询。更多内容请参考 [Queuing 表查询缓慢问题](../../../2.user-guide/11.o-m-management/6.emergency-response/3.common-emergency-response/3.other-problems-within-the-cluster/5.query-slow-queues.md)。
