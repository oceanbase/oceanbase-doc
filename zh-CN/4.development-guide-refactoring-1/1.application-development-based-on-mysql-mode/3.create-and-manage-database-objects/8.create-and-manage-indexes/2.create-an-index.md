# 创建索引
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/create-an-index
...
本文主要介绍如何在非分区表上创建索引，分区表上索引的创建请参见 [分区表的索引](../8.create-and-manage-partition-table-2/7.partition-table-index-2.md)。
