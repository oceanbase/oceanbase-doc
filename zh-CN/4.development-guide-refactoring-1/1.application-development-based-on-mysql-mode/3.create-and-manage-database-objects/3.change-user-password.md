# 修改用户密码
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/change-user-password
...
4. 数据密码下方，单击 **修改密码** ，对数据库密码进行修改。![1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V3.2.3/zh-CN/3.deploy-the-oceanbase-database/1010.png)
