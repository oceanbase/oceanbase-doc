# 查询中使用聚合函数
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/use-aggregate-functions-in-queries
...
有关 OceanBase 数据库当前版本所支持的聚合函数详情，请参见手册 **《OceanBase 数据库SQL 语法（MySQL 模式）》** 。
