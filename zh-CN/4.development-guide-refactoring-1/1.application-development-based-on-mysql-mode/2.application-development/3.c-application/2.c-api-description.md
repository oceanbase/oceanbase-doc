...
有关各接口详细信息，请参见官网文档《[OceanBase Connector/C 开发者指南 C API 函数](https://www.oceanbase.com/docs/connector-c/connector-c/V2.0.0/introduction-to-oceanbase-connector-c)》。
