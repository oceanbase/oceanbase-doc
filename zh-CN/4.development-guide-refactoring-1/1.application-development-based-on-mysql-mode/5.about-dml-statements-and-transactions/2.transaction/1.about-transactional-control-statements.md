# 关于事务控制语句
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/about-transactional-control-statements
本文介绍了事务的基本信息和相关控制语句。
...
* [BEGIN](../2.transaction/2.start-a-transaction.md)：显式开启一个事务。此语句在使用过程中可选：
