...
| protection_mode                         | varchar(4096) | NO         | 集群的保护模式。|
| protection_level                        | varchar(4096) | NO         | 集群的保护级别。|
| redo_transport_options                  | varchar(4096) | NO         | 集群接收日志的传输模式。|
