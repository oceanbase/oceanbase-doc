...
其中，`PX PARTITION ITERATO` 算子用于按照分区粒度迭代数据，详细信息请参见 [GI](../../../../5.oceanbase-database-overview/7.sql-engine/4.oceanbase-database-overview-sql-execution-plan/2.oceanbase-database-overview-execution-plan-operators/23.execution-plan-operators-exchange.md)。
