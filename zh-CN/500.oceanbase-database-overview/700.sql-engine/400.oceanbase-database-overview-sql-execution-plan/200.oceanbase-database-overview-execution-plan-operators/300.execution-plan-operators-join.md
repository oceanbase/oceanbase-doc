...
其中，`MATERIAL` 算子用于物化下层算子输出的数据，详细信息请参见 [MATERIAL](../../../../5.oceanbase-database-overview/7.sql-engine/4.oceanbase-database-overview-sql-execution-plan/2.oceanbase-database-overview-execution-plan-operators/3.execution-plan-operators-join.md)。
