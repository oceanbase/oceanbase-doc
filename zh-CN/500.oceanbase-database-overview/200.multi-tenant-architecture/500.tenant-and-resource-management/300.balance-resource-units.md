...
* `enable_rebalance`
  ...
  有关分区副本均衡的详细信息请参见 [自动负载均衡](../../400.distributed-database-objects/300.partitions-and-replicas/400.data-balancing/100.replica-balancing/100.automatic-load-balancing.md)。
