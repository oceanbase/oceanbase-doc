...
OceanBase 数据库兼容大部分 Oracle 数据库中支持数据类型，详细支持信息请参见 [SQL 数据类型](../400.compatibility-with-oracle/200.sql-data-type.md)。
...
OceanBase 数据库兼容大部分 Oracle 数据库中支持内建函数，详细支持信息请参见 [内建函数](../400.compatibility-with-oracle/300.built-in-functions.md)。
