...
更多系统视图的说明信息请参考《参考指南》文档中 [系统视图](../7.reference/5.system-reference/4.system-view-of-mysql-mode/1.overview-of-mysql-mode.md) 章节。
...
更多分区的说明及使用请参见 [分区管理](../7.reference/2.administrator-guide/4.replica-management/2.manage-partition-table/2.mysql-mode/1.partition-overview-of-mysql-mode.md) 。
...
更多优化器的详细信息请参见 [SQL 调优指南](../7.reference/3.performance-tuning-guide/5.sql-optimization/1.sql-request-execution-process.md)。
