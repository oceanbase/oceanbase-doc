...
更多系统视图的说明信息请参考《参考指南》文档中 [系统视图](../7.reference/7.system-views/4.system-view-of-mysql-mode/1.overview-of-mysql-mode.md) 章节。

## 字符集和字符序

OceanBase 数据库兼容 MySQL 数据库的部分字符集和字符序，具体支持情况如下：

* 字符集：binary、utf8mb4、gbk、utf16、gb18030、latin1 和 gb18030_2022。
...
OceanBase 数据库所支持的分析（窗口）函数是 MySQL 数据库的超集，即 MySQL 数据库的分析（窗口）函数都支持。
...
更多分区的说明及使用请参见 [分区概述](../7.reference/3.database-object-management/1.manage-object-of-mysql-mode/3.manage-partitions-of-mysql-mode/1.partition-overview-of-mysql-mode.md) 。
...
更多优化器的详细信息请参见 [SQL 调优指南](../7.reference/10.performance-tuning-guide/5.sql-optimization/1.sql-request-execution-process.md)。
