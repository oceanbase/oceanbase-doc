...
OceanBase 数据库兼容了大部分 MySQL 数据库的优化器功能。有关优化器的详细信息，请参见 [SQL 调优指南](../700.reference/1000.performance-tuning-guide/500.sql-optimization/100.sql-request-execution-process.md)。
