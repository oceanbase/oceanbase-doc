...
* **支持指定分区旁路导入**
    ...
    更多详细信息，参见 [全量旁路导入](620.obap/300.obap-import-data/20.bypass-import/200.full-bypass-import.md) 或者 [增量旁路导入](620.obap/300.obap-import-data/20.bypass-import/300.incremental-bypass-import.md)。
