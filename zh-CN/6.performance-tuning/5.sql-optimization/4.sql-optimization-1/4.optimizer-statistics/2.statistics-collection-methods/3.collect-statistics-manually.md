...
| method_opt       | 设置列级别的统计信息收集方式。详细信息，请参见 [method_opt](#sectiondiv-ixo-h4e-61s)。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
上述语法中，指定列的统计信息直方图收集方式和 DBMS_STATS 包的 `method_opt` 语法相同，请参见 [method_opt](#sectiondiv-ixo-h4e-61s)。
