...
目前 `LIMIT` 算子只支持 MySQL 模式的 SQL 场景。详细信息请参考 [LIMIT](/zh-CN/6.performance-tuning/5.sql-optimization/2.sql-execution-plan/2.execution-plan-operator/12.LIMIT.md)。
