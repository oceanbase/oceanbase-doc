...
其中，`PX PARTITION ITERATO` 算子用于按照分区粒度迭代数据，详细信息请参见 [GI](/zh-CN/6.performance-tuning/5.sql-optimization/2.sql-execution-plan/2.execution-plan-operator/24.GI.md)。
