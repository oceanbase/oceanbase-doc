...
* MySQL 模式
  ...
  更多 MySQL 模式下 `CREATE USER` 语句的信息，请参见 [CREATE USER](t1944412.html#topic-2616636)。
...
6. 在弹出的 **新建数据库用户** 对话框中，配置用户信息。![创建用户](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/2603049061/p206054.png)
