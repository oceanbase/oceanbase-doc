...
本文分几种场景进行介绍，您可根据自身集群情况选择合适的场景参考。
...
1. 查看集群状态。
   ...
   输出如下，详细的状态介绍可参见 [obd cluster list](https://www.oceanbase.com/docs/common-obd-cn-1000000003415263)。
...
2. 查看是否存在备租户。
   ...
   输出如下，表示不存在备租户，且集群中仅有 sys 租户。若集群中的租户存在备租户，其输出内容和字段含义的详细介绍可参见 [创建备租户](https://www.oceanbase.com/docs/common-obd-cn-1000000003415367)。
...
3. （可选）主备租户解耦。
   ...
   主备租户解耦详细操作可参见 [主备租户解耦](https://www.oceanbase.com/docs/common-obd-cn-1000000003415368)。
