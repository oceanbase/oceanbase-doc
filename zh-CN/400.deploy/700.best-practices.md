...
<main id="notice" type='notice'>
  <h4>注意</h4>
  <p>本文中的参数介绍信息基于 OceanBase 数据库 V4.5.0 版本中的配置模板更新。若需查询其他版本的推荐配置，请通过对应版本安装包中的配置文件获取最新参数组合。</p>
</main>
...
| [default_micro_block_format_version](../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/2060.default_micro_block_format_version.md) | 2 | 启用新的 Flat 行存储格式处理简单的 OLTP 工作负载。| tenant |
...
2. 在用户中执行以下语句，配置租户级配置项。
   ...
   * **MySQL 模式租户的配置示例：**
     ...
     ALTER SYSTEM SET default_micro_block_format_version = 2;
     ```
...
| [default_micro_block_format_version](../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/2060.default_micro_block_format_version.md) | 2 | 启用新的 Flat 行存储格式处理复杂的 OLTP 工作负载。| tenant |
...
| [default_load_mode](../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/2050.default_load_mode.md) | DISABLED | 默认不会启用旁路导入能力，有需要使用旁路导入的场景，可以通过 Hint 指定。| tenant |
...
| [default_table_organization](../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/2150.default_table_organization.md) | HEAP | 默认堆表，数据按照写入顺序存储，和主键序无关。| tenant |
...
| [default_micro_block_format_version](../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/2060.default_micro_block_format_version.md) | 2 | 启用新的 Flat 行存储格式处理 OLAP 工作负载。| tenant |
...
| [default_table_merge_engine](../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/2130.default_table_merge_engine.md) | PARTIAL_UPDATE | 默认使用 `partial_update` 表模式。| tenant |
| [default_micro_block_format_version](../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/2060.default_micro_block_format_version.md) | 2 | 启用新的 Flat 行存储格式处理 HTAP 工作负载。| tenant |
| [max_partition_num](../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/5350.max_partition_num.md) | 65536 | 将 AP/HTAP 工作负载的每个表的最大分区数增加到 65536，支持按时间范围和哈希子分区进行大规模分区，这在数据仓库和实时分析场景中很常见。| tenant |
...
| [default_micro_block_format_version](../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/2060.default_micro_block_format_version.md) | 2 | 启用新的 Flat 行存储格式处理 KV 模式。| tenant |
| [enable_auto_split](../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/2350.enable_auto_split.md) | True | KV 模式开启自动分区功能。| tenant |
