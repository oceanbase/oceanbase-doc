...
| Anolis OS 8.X、Alibaba Cloud Linux 3、CentOS 8、RedHat 8、Debian 10              | [el8 下载地址](https://mirrors.aliyun.com/oceanbase/community/stable/el/8/) |
| Alibaba Cloud Linux 3、Rocky Linux 9              | [al8 下载地址](https://mirrors.aliyun.com/oceanbase/community/stable/al/8)  |

<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>Linux Kernel 5.10 及以上的操作系统（glibc>=2.32），推荐使用 al8 RPM 包；Linux Kernel 低于 5.10 的操作系统，推荐使用 el7 RPM 包。</p>
</main>
