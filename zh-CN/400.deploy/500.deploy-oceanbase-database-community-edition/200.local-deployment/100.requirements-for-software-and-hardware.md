...
| 内存     | <ul><li> 测试环境最低要求 8 GB。 </li><li> 生产环境最低要求 16 GB，长期使用要求不低于 32 GB，推荐 256 GB 及以上。  </li><li>性能测试场景推荐 128 GB 及以上。</li></ul><blockquote>**注意**</br>当部署多个集群时, 推荐使用 OCP 进行统一运维管理, 当部署集群比较少时, 建议使用 OBD 进行安装部署。</blockquote>                                                                                |
| 磁盘类型   | 使用 SSD 存储                                                                                                           |
| 磁盘存储空间 | 最低要求 54 GB                                                                                                 |
