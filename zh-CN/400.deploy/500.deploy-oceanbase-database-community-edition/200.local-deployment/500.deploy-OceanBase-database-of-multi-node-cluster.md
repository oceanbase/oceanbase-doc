...
* 方法一：使用 OBD 创建用户租户。
  ...
  该命令默认根据集群剩余全部可用资源创建租户，您可通过配置各个参数控制租户占用资源的多少，命令详细使用方法请参考 OBD 手册 [集群命令组](https://www.oceanbase.com/docs/community-obd-cn-1000000000254576) 中 `obd cluster tenant create` 命令。
