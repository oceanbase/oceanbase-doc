...
2. 在 **创建集群** 页面，设置集群的基础信息。
   ...
   ![1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.2.5/zh-CN/400.deploy/500.deploy-oceanbase-database-community-edition/200.deploy-by-ocp-02.png)
