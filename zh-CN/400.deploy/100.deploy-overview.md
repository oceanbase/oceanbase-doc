...
目前暂未发布 OceanBase 数据库社区版 V4.6.0，因此，本手册将主要介绍 OceanBase 数据库企业版的部署方式和适用场景。
...
* 有关 obd 的信息，请参见 [什么是 obd](https://www.oceanbase.com/docs/common-obd-cn-1000000003892223)。 -->
