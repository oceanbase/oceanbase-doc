...
* 您已准备部署 OceanBase 集群的服务器并且将其添加到 OAT 中完成了初始化。详细信息，请参见 [准备服务器](../../2.preparations-before-deploy/1.prepare-servers.md) 和 [添加服务器](../1.configuring-the-deploy-environment-through-oat/1.add-server.md)。
* 您已安装 OCP。详细信息，请参见 [部署 OCP](../2.deploy-ocp-use-oat/4.deploy-ocp.md)。
...
* [使用 OCP 部署单机集中式 OceanBase 数据库](2.stand-alone-deployment-of-oceanbase-database-use-ocp.md)
* [使用 OCP 部署两副本加仲裁服务的 OceanBase 集群](3.deploy-the-quorum-high-availability-service-use-ocp.md)
* [使用 OCP 部署单副本 OceanBase 集群](4.deploy-single-replica-oceanbase-cluster-use-ocp.md)
* [使用 OCP 部署三副本 OceanBase 集群](5.deploy-three-oceanbase-replica-clusters-use-ocp.md)
