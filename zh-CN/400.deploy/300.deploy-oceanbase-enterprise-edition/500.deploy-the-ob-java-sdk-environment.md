...
<main id="notice" type='notice'>
  <h4>注意</h4>
  <p>OceanBase 集群如果是分布式部署，想要使用 HDFS，那么对应机器节点都需要部署 jdk 和各种下面依赖包的安装。</p>
</main>
...
1. 下载 devdeps-hdfs-sdk RPM 安装包。

   1. 访问镜像下载页。

       进入 [阿里云 OceanBase 镜像下载页](https://mirrors.aliyun.com/oceanbase/)。

   2. 进入开发工具目录。

       在页面中点击 `development-kit/` 目录，进入开发工具资源目录。
   ...
   4. 下载最新版本安装包
       ...
       在目标目录中找到 devdeps-hdfs-sdk 包，选择日期最新的 RPM 安装包进行下载。

       **示例如下：**

       ```shell
       wget https://mirrors.aliyun.com/oceanbase/development-kit/el/7/x86_64/devdeps-hdfs-sdk-3.3.6-112024123116.el7.x86_64.rpm
       ```

2. 安装包下载完成之后，根据如下命令进行安装。
...
1. 下载 devdeps-java-extensions RPM 安装包。
   ...
   4. 下载安装包
      ...
      在目标目录中找到 devdeps-java-extensions 包进行下载。

      <main id="notice" type='notice'>
        <h4>注意</h4>
        <p><ul>
          <li>OceanBase 数据库 V4.3.5 BP1 及之前版本：请下载 1.0.0 版本 devdeps-java-extensions。</li>
          <li>OceanBase 数据库 V4.3.5 BP2 及之后版本：请下载 1.0.1 版本 devdeps-java-extensions。</li>
          <li>OceanBase 数据库 V4.4.0 版本：请下载 1.0.1 版本 devdeps-java-extensions。</li></ul></p>
      </main>

       **示例如下：**

       ```shell
       wget https://mirrors.aliyun.com/oceanbase/development-kit/el/7/x86_64/devdeps-java-extensions-1.0.0-252025041410.el7.x86_64.rpm
       ```
