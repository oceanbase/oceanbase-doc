...
1. 通过 [下载地址](https://www.openlogic.com/openjdk-downloads?field_java_parent_version_target_id=416&field_operating_system_target_id=426&field_architecture_target_id=391&field_java_package_target_id=396&page=0) 下载 OpenJDK JAVA 安装包。
...
2. 通过正常解压缩对应的安装包即可。
    ...
    ```shell
    /home/user/openjdk/jdk8u422-b05
    ```
