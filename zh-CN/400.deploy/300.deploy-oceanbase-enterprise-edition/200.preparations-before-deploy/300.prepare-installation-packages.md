...
<table>
   ...
   <tr>
       ...
       <td>用于部署 OCP。</td>
       <td>OCP V4.2.1 <main id="notice" type='notice'><h4>注意</h4><p>如果要安装具有 nolse 标记的 OceanBase RPM 软件包，必须使用 V4.3.0 或更高版本的 OCP。</p></main></td>
   ...
   <tr>
       ...
       <td><ul><li>X86_64 平台：oceanbase-x.x.x.x-xxxxxxxxxxxxxxxxxx.el7.x86_64.rpm
                ...
                <main id="notice" type='explain'>
                  <h4>说明</h4>
                  <p>对于 OceanBase 数据库 V4.2.1 版本，从 V4.2.1 BP3 版本开始起提供的 ARM 包总是带 LSE。有关 LSE 的介绍信息，参见 <a href="../../../800.FAQ/300.deployment-faq.md">部署 FAQ</a></p>
                </main>
            </li></ul></td>
   </tr>
   <tr>
