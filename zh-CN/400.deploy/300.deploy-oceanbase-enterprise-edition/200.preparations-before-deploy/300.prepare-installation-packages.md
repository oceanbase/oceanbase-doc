...
<table>
   ...
   <tr>
       ...
       <td><ul><li>X86_64 平台：oceanbase-x.x.x.x-xxxxxxxxxxxxxxxxxx.el7.x86_64.rpm
            ...
            <main id="notice" type='explain'><h4>说明</h4><p>操作系统 Rocky Linux 9 和 Alibaba Cloud Linux 3 推荐使用 OceanBase 数据库 al8 安装包，例如 oceanbase-x.x.x.x-xxxxxxxxxxxxxxxxxx.al8.xxxxxx.rpm。</p></main>
            </td>
   </tr>
   <tr>
