...
<table>
   ...
   <tr>
       ...
       <td><ul><li>X86_64 平台：oceanbase-x.x.x.x-xxxxxxxxxxxxxxxxxx.el7.x86_64.rpm
            ...
            <main id="notice" type='explain'><h4>说明</h4><p><ul><li>操作系统 Rocky Linux 9 适配 OceanBase 数据库 el9 安装包，例如 oceanbase-x.x.x.x-xxxxxxxxxxxxxxxxxx.el9.xxxxxx.rpm。</li><li>操作系统 Alibaba Cloud Linux 3 适配 OceanBase 数据库 al8 安装包，例如 oceanbase-x.x.x.x-xxxxxxxxxxxxxxxxxx.al8.xxxxxx.rpm。</li></ul></p></main>
            </td>
   </tr>
   <tr>
