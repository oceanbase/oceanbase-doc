...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p><ul><li>操作系统需要配置网络和软件管理器（ yum 或 zypper 源）。</li><li>部署 OceanBase 集群的服务器需要是小端模式。</li><li>如果使用的是 Hygon 7490 芯片，必须安装 Hygon（海光）服务器厂家推荐的已经包含了 4 号补丁的操作系统。</li><li>操作系统 Rocky Linux 9 和 Alibaba Cloud Linux 3 推荐使用 OceanBase 数据库 al8 安装包。</li></ul></p>
</main>
