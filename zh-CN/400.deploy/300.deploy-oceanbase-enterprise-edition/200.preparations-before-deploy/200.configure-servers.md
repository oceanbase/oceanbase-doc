...
| vm.min_free_kbytes | [32768, 2097152] | 2097152 <main id="notice" type='notice'><h4>注意</h4><p>当您的仲裁服务使用的是最小规格部署时（即仲裁服务器内存小于等于 8GB），建议参数 <code>vm.min_free_kbytes</code> 保持默认配置值，不要进行更改。</p></main>| 用于设置系统保留的最小空闲内存量，以防止内存碎片化。|
