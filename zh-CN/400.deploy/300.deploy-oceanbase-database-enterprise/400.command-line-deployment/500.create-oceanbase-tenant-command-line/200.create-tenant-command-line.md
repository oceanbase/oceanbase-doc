...
* 租户创建完成后的连接信息，请参见 [租户创建后验证](../500.create-oceanbase-tenant-command-line/300.verify-after-deployment-tenant-command-line.md)。
* 更多创建资源单元的详细信息，请参见 [CREATE RESOURCE UNIT](../../../../700.reference/400.development-reference/100.sql-syntax/100.system-tenants/700.create-resource-unit.md)。
* 更多创建资源池的详细信息，请参见 [CREATE RESOURCE POOL](../../../../700.reference/400.development-reference/100.sql-syntax/100.system-tenants/600.create-resource-pool.md)。
* 更多创建租户的详细信息，请参见 [CREATE TENANT](../../../../700.reference/400.development-reference/100.sql-syntax/100.system-tenants/800.create-tenant-sql.md)。
* 更多修改用户密码的详细信息，请参见 [ALTER USER](../../../../700.reference/400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/800.alter-user-of-mysql-mode.md) 和 [SET PASSWORD](../../../../700.reference/400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/5500.set-password-of-mysql-mode.md)。
