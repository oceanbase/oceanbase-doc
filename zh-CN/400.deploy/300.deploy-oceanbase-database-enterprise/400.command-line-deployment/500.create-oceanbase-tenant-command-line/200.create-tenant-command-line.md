...
* 租户创建完成后的连接信息，请参见 [租户创建后验证](3.verify-after-deployment-tenant-command-line.md)。
...
* 更多创建租户的详细信息，请参见 [CREATE TENANT](../../../../7.reference/4.development-reference/1.sql-syntax/1.system-tenants/8.create-tenant-sql.md)。
