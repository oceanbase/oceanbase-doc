...
replace 操作和 insert_or_update 操作很容易混淆，您可参考文档 [replace 和 insert_or_update 的区别](/zh-CN/9.ecological-tools/6.TableApi/1.introduction-to-table-api-1/2.differences-between-replace-and-insert_or_update.md) 对这两种操作进行区分。
...
关于 Query 各种条件的设置方式，可以参考 [客户端简介与使用说明](/zh-CN/9.ecological-tools/6.TableApi/2.use-the-client/1.use-the-client-1.md)。
