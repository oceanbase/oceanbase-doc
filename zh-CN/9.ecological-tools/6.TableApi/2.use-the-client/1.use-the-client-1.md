...
您可使用 obclient 或 MySQL 客户端登录 OceanBase，具体方法可参考 [通过 obclient 连接 OceanBase 租户](/en-US/7.developer-guide-1/2.connect-to-the-oceanbase-database/2.connect-to-an-oceanbase-tenant-by-using-obclient.md) 和 [通过 MySQL 客户端连接 OceanBase 数据库](/en-US/7.developer-guide-1/2.connect-to-the-oceanbase-database/1.connect-to-an-oceanbase-tenant-by-using-a-mysql-client.md)。
...
具体如何使用客户端，您可参考 [客户端使用示例](/en-US/9.ecological-tools/6.TableApi/2.use-the-client/3.client-usage-example.md)。
