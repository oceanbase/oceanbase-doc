...
关于如何部署和使用 liboblog，详细信息请参考 [liboblog 安装部署](/zh-CN/9.ecological-tools/4.CDC/2.oceanbase-cdc/1.install-cdc/2.rve4im.md) 和 [liboblog 开发说明](/zh-CN/9.ecological-tools/4.CDC/2.oceanbase-cdc/1.install-cdc/3.uhg86q.md)。
...
关于如何部署和使用 oblogproxy，详细信息请参考 [使用源码构建 oblogproxy](/zh-CN/9.ecological-tools/4.CDC/3.oblogproxy/1.installation-and-deployment-2/1.installation-and-deployment-1.md) 和 [使用安装包安装部署 oblogproxy](/zh-CN/9.ecological-tools/4.CDC/3.oblogproxy/1.installation-and-deployment-2/2.install-and-deploy-logproxy-by-using-the-installation-package.md)。
**说明**



您可使用 Canal 和 oblogproxy 将 OceanBase 数据库的数据实时同步到 MySQL 数据库，详细操作请参考 [将数据从 OceanBase 同步至 MySQL](/zh-CN/7.developer-guide-1/5.migrate-data-to-oceanbase/7.qlz77w.md)。
...
关于如何安装部署 oblogmsg，详细信息请参考 [安装部署](/zh-CN/9.ecological-tools/4.CDC/4.oblogmsg/1.introduction-to-ologmsg.md)。
