...
这里提供一个简单的 demo 展示如何使用 liboblog，详细信息，请参考 [oblog_tailf](/zh-CN/9.ecological-tools/4.CDC/2.oceanbase-cdc/1.install-cdc/4.oblog_tailf.md) 以及 [oblog_tailf 源码](https://github.com/oceanbase/oceanbase/tree/master/src/liboblog/tests)。
**注意**
