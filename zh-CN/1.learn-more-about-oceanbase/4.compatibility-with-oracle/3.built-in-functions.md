...
Oracle 数据库中支持内建函数 257 个，OceanBase 数据库当前支持 155 个，更多详细信息请参阅 [函数](../../7.reference/5.sql-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/5.functions-of-oracle-mode/1.function-overview-of-oracle-mode.md)。
