...
关于 Hint 的详细说明，请参见 [Hint](../../7.reference/5.sql-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/3.basic-elements-of-oracle-mode/6.annotation-of-oracle-mode/4.hint-of-oracle-mode/1.hint-overview-of-oracle-mode.md)。
...
更多 PL 功能的详细信息请参见 [PL 参考](../../7.reference/5.sql-reference/3.pl-reference/1.what-is-pl/1.pl-introduction.md)。
...
更多系统视图的字段说明信息请参考《参考指南（Oracle 模式）》文档中 [系统视图](../../7.reference/7.system-views/5.system-view-of-oracle-mode/1.overview-of-oracle-mode.md) 章节。
...
关于创建、修改、删除表的详细语法，请参见 [CREATE TABLE](../../7.reference/5.sql-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/1.ddl-of-oracle-mode/24.create-table-of-oracle-mode.md)、[ALTER TABLE](../../7.reference/5.sql-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/1.ddl-of-oracle-mode/10.alter-table-of-oracle-mode.md)、[DROP TABLE](../../7.reference/5.sql-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/1.ddl-of-oracle-mode/39.drop-table-of-oracle-mode.md)。
...
更多分区的说明及使用请参见《管理员指南》文档中的 [分区概述](../../7.reference/3.database-object-management/2.manage-object-of-oracle-mode/2.manage-partitions-of-oracle-mode/1.partition-overview-of-oracle-mode.md) 章节。
...
更多 SQL 引擎的详细信息请参见 [SQL 调优指南](../../7.reference/10.performance-tuning-guide/5.sql-optimization/1.sql-request-execution-process.md)。
