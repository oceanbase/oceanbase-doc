...
更多 OceanBase 数据库物理备份恢复特性的介绍请参见《OceanBase 数据库系统概念》文档中的 [备份恢复概述](../../2.concepts-of-oceanbase-database-system/9.high-data-reliability-and-availability/5.backup-and-restoration/1.backup-and-restoration-overview.md) 章节。
