...
更多系统视图的说明信息请参考《参考指南（MySQL 模式）》文档中 [系统视图](../14.system-reference/4.system-view-for-mysql/1.overview-2.md) 章节。
...
更多分区的说明及使用请参见 [分区管理](../8.distributed-storage-management/2.manage-partition-table/2.mysql-1/1.partition-overview-6.md) 。
...
更多优化器的详细信息请参见 [SQL 调优指南](../9.sql-optimization/1.sql-request-execution-process-1.md)。
...
* 对于备份恢复功能，不支持集群级别的备份恢复，不支持冷备份，不支持数据库和表级的备份恢复。
