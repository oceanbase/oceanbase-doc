# 与 MySQL 兼容性对比
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/compatibility-with-mysql
...
更多系统视图的说明信息请参考《参考指南（MySQL 模式）》文档中 [系统视图](../7.reference/14.system-reference/4.system-view-for-mysql/1.overview-2.md) 章节。
