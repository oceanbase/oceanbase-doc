# 内建函数
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/built-in-functions
本节主要介绍 OceanBase 数据库的 Oracle 模式与原生 Oracle 数据库中内建函数的详细兼容对比信息。

Oracle 数据库中支持内建函数 257 个，OceanBase 数据库当前支持 155 个，更多详细信息请参阅 [函数](../../7.reference/6.sql-syntax/3.common-tenant-oracle-mode/5.functions-2/1.function-overview.md)。
