...
若数据已存放在本地路径、对象存储或 HDFS 等外部位置，并希望通过单条 SQL 导入，可使用 `FILES` 表函数访问外部文件；相关用法参见 [INSERT INTO SELECT FROM FILES](100.insert-into-select-from-files.md) 与 [LOAD DATA FROM FILES](../200.load-data-import.md)。
...
* 更多关于 URL 外部表的信息，请参见[URL 外部表](../../../400.data-lake/300.url-external-table.md)。

## 与数据湖章节的衔接

文件外表、Catalog 与 ODPS 等能力与 **数据湖** 文档互为补充，您可按场景查阅下列文档：

* [Catalog 与外部表](../../../400.data-lake/200.data-lake-integration/400.catalog-externaltable.md)
* [文件外表](../../../400.data-lake/200.data-lake-integration/500.file-external-table.md)
* [ODPS 外表](../../../400.data-lake/200.data-lake-integration/300.odps/200.odps-external-table.md)
