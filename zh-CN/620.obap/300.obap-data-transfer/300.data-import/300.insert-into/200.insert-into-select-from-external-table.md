...
若数据已存放在本地路径、对象存储或 HDFS 等外部位置，并希望通过单条 SQL 导入，可使用 `FILES` 表函数访问外部文件；相关用法参见 [INSERT INTO SELECT FROM FILES](100.insert-into-select-from-files.md) 与 [LOAD DATA FROM FILES](../200.load-data/100.load-data-from-files.md)。
...
* [外表概述](../../../400.data-lake/200.external-table/100.external-table-overview.md)
* [文件外表](../../../400.data-lake/200.external-table/200.file-external-table.md)
* [ODPS 外表](../../../400.data-lake/200.external-table/300.odps-external-table.md)
