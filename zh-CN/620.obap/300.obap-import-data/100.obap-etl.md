...
APPEND Hint 指定 insert into select 开启旁路导入功能，详细介绍见 [insert into select 开启旁路导入](../../500.data-migration/1100.bypass-import/300.use-insert-into-select-statement-to-bypass-import-data.md)。
