...
* 全量旁路导入中，如果目标表最后一级分区为 Hash/Key 分区，支持分区级旁路导入。
* 全量旁路导入中，当 Session 级变量 [foreign_key_checks](../../../700.reference/800.configuration-items-and-system-variables/200.system-variable/300.global-system-variable/2800.foreign_key_checks-global.md) 取值为 False 时，旁路导入操作不会进行外键约束校验。
