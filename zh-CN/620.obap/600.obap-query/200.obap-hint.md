...
如下示例中的 hint 指定了当前 SQL 中 T1 先与 T4 和 T2 的连接结果连接，然后再与 T3 连接。使用该 hint 生成的连接树如下所示。
...
- 有关全量 Hint 列表和每个 Hint 的详细介绍，参见 [Hint 列表](../../700.reference/500.sql-reference/100.sql-syntax/300.common-tenant-of-oracle-mode/300.basic-elements-of-oracle-mode/600.annotation-of-oracle-mode/400.hint-of-oracle-mode/100.hint-overview-of-oracle-mode.md)。
