...
更多关于 Location 参数配置，请参见 [CREATE EXTERNAL TABLE](../../../../700.reference/500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/2200.create-external-table-of-mysql-mode.md) 中的 `LOCATION` 章节及 [Catalog 与外部表](../50.catalog-externaltable.md)。
