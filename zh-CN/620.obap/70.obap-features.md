...
有关列存副本的概念，参见 [列存副本](../700.reference/100.oceanbase-database-concepts/500.distributed-database-objects/300.data-partitions-and-replicas/300.partition-replica-type/400.columnstore-replica.md)；有关列存副本的部署与独立 ODP 接入步骤参见 [部署与使用列存副本](150.obap-deploy/150.uesing-columnstore-replica.md)。
