...
* 增强管理员工具 ob_admin
  ...
  ob_admin 支持解析和显式输出 block_file 文件、归档文件、备份元信息和数据。命令输入形式为 `ob_admin dumpsst`/`archive_tool`/`dump_backup`，详细信息请参考 [ob_admin 简介](/zh-CN/9.ecological-tools/1.ob-admin/1.introduction-to-ob_admin.md)。
