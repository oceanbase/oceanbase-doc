...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>您也可以通过备份恢复功能来实现 OceanBase 数据库租户的数据迁移。有关 OceanBase 数据库备份恢复功能的详细信息，请参见 <a href="../600.manage/600.backup-and-recovery/100.overview-of-physical-backup-and-recovery.md">物理备份与恢复概述</a>。</p>
</main>
