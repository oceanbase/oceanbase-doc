...
本文将简单介绍如何使用 OMS 从 OceanBase 数据库迁移数据到 OceanBase 数据库同类型租户中。

更多使用 OMS 从 OceanBase 数据库迁移数据到 OceanBase 数据库同类型租户的详细信息，请参见 [OceanBase 数据库的单向数据迁移](https://www.oceanbase.com/docs/enterprise-oms-doc-cn-1000000000091365)。
...
3. 创建数据迁移任务。
   ...
   新建数据迁移项目同时启动本迁移项目。详细信息请参见 [OceanBase 数据库的单向数据迁移](https://www.oceanbase.com/docs/enterprise-oms-doc-cn-1000000000091365)。
