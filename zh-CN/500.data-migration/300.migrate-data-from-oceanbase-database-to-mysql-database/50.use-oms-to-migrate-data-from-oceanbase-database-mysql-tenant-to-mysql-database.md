...
本文将简单介绍如何使用 OMS 从 OceanBase 数据库 MySQL 租户迁移数据到 MySQL 数据库中。

更多使用 OMS 从 OceanBase 数据库 MySQL 租户迁移数据到 MySQL 数据库的详细信息，请参见 [迁移 OceanBase 数据库 MySQL 租户的数据至 MySQL 数据库](https://www.oceanbase.com/docs/enterprise-oms-doc-cn-1000000000091364)。
...
3. 创建数据迁移任务。
   ...
   新建数据迁移项目同时启动本迁移项目。详细信息请参见 [迁移 OceanBase 数据库 MySQL 租户的数据至 MySQL 数据库](https://www.oceanbase.com/docs/enterprise-oms-doc-cn-1000000000091364)。
