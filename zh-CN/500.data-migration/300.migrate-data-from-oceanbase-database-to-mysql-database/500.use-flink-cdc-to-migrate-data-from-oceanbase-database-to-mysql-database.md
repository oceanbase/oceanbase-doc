...
2. 参考 [使用安装包安装部署 oblogproxy](../../700.reference/1500.command-line-tools/1100.cdc/300.oblogproxy/100.install-and-deploy-oblogproxy/100.install-and-deploy-oblogproxy-by-using-the-installation-package.md) 完成 oblogproxy 的安装部署。
