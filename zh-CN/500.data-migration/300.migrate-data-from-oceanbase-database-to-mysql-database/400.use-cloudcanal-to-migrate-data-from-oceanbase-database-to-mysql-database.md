...
=======
2. 参考 [OBLogProxy 安装](https://www.oceanbase.com/docs/community-oblogproxy-doc-1000000000438540) 完成 oblogproxy 的安装部署。
>>>>>>> origin/V4.2.1
...
<<<<<<< HEAD
         * oblogproxy host：oblogproxy 的 IP 地址。OceanBase 数据库作为源库增量同步时，不可以为空；OceanBase 数据库作为目标库时，可为空。有关 oblogproxy 的详细信息，请参考 [使用安装包安装部署 oblogproxy](../../400.deploy/300.deploy-oceanbase-enterprise-edition/400.deploy-through-the-command-line/300.deploy-obproxy-command-line.md)。
=======
         * oblogproxy host：oblogproxy 的 IP 地址。OceanBase 数据库作为源库增量同步时，不可以为空；OceanBase 数据库作为目标库时，可为空。有关 oblogproxy 的详细信息，请参考 [OBLogProxy 介绍](https://www.oceanbase.com/docs/community-oblogproxy-doc-1000000000438541)。
>>>>>>> origin/V4.2.1
