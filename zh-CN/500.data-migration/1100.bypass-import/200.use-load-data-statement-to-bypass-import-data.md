...
2. 设置导入的文件路径。
    ...
    系统变量 `secure_file_priv` 用于控制导入或导出到文件时可以访问的路径。默认值为 `NULL`，表示导入、导出被禁用。详细信息，请参见 [secure_file_priv](../../700.reference/500.system-reference/200.system-variable/300.global-system-variable/11500.secure_file_priv-global.md) 。
