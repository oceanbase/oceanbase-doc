# 查询数据
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/query-data-1
使用 `SELECT` 语句查询表中的内容。
...
更多 `SELECT` 语句相关的语法说明请参见 [SELECT](../../4.development-guide-refactoring-1/5.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/2.DML\5.SELECT-1/1.simple-select.md)。
