# 更新数据
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/update-data-1
...
更多 `UPDATE` 语句相关的语法请参见《SQL 参考（Oracle 模式）》中 [UPDATE](../../4.development-guide-refactoring-1/5.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/2.DML/6.UPDATE-1.md)章节。
