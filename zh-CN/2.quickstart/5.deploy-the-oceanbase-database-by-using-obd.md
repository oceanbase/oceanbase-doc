...
* 您已经在中控机器安装了 OBD。详细信息，参考 [安装 OBD](/zh-CN/2.quickstart/4.use-obd-to-obtain-the-oceanbase-database.md)。
...
1. 安装 OceanBase 数据库客户端 OBClient：
   ...
   下载 OBClient 的离线安装包。更多信息，参考 [下载中心](https://open.oceanbase.com/softwareCenter/community)。并执行以下命令安装：
