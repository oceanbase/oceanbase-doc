...
2. 执行以下命令，创建表 test 的索引。
   ...
   更多 `CREATE INDEX` 语句相关的语法说明请参见 [CREATE INDEX](../../10.sql-reference-mysql-mode/6.sql-statement/15.create-index.md)。
...
更多 `DROP INDEX` 语句相关的语法说明请参见 [DROP INDEX](../../10.sql-reference-mysql-mode/6.sql-statement/30.drop-index.md)。
