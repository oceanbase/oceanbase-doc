# 删除数据
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/delete-data
使用 DELETE 语句删除数据。
...
更多 `DELETE`语句相关的语法说明请参见《SQL 参考（MySQL 模式）》中 [DELETE](../../10.sql-reference-mysql-mode/6.sql-statement/27.DELETE.md)章节。
