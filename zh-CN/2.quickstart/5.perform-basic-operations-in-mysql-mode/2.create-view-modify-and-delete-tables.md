# 表操作
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/create-view-modify-and-delete-tables
...
更多 `CREATE TABLE` 语句相关的语法说明请参见《SQL 参考（MySQL 模式）》中 [CREATE TABLE](../../10.sql-reference-mysql-mode/6.sql-statement/21.create-table.md)章节。
...
更多 `ALTER TABLE` 语句相关的语法说明请参见《SQL 参考（MySQL 模式）》中 [ALTER TABLE](../../10.sql-reference-mysql-mode/6.sql-statement/8.alter-table.md) 章节。
...
更多 `DROP TABLE` 语句相关的语法说明请参见《SQL 参考（MySQL 模式）》中 [DROP TABLE](../../10.sql-reference-mysql-mode/6.sql-statement/35.drop-table.md)章节。
