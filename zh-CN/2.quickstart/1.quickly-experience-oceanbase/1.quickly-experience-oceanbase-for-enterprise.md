...
有关 OceanBase 集群部署的详细信息，请参见 [部署简介](../4.deploy-the-oceanbase-database/1.deployment-introduction.md)。
...
3. 安装包准备。
   ...
   >**说明**
   >
   >安装包下载地址在 OceanBase 数据库官方网站左上角单击 **支持与服务** 下的 [软件下载](https://www.oceanbase.com/softwareCenter) 按钮进入下载中心页面。
...
2. 安装 Antman。
   ...
   安装 Antman 的详细信息，请参见 [安装 oat-cli](../4.deploy-the-oceanbase-database/6.command-line-deployment/1.configure-a-deployment-environment-2/1.install-oat-cli.md)。
...
创建普通租户的详细信息，请参见 [创建租户](../4.deploy-the-oceanbase-database/6.command-line-deployment/5.create-an-oceanbase-tenant-2/2.create-a-tenant-2.md)。
...
* 使用 OBClient 连接 OceanBase 数据库，请参见 [通过 Obclient 连接 OceanBase 租户](../3.developer-guide/2.application-development-based-on-mysql-mode/1.client-connects-to-oceanbase-database/3.connect-oceanbase-tenants-through-obclient.md)。
  
* 使用 ODC 连接数据库，请参见 [通过 Obclient 连接 OceanBase 租户](../3.developer-guide/2.application-development-based-on-mysql-mode/1.client-connects-to-oceanbase-database/4.connect-to-oceanbase-database-through-ODC.md)。

连接 OceanBase 数据库更多详情，请参见 [连接方式概述](../3.developer-guide/2.application-development-based-on-mysql-mode/1.client-connects-to-oceanbase-database/1.overview-of-connection-method.md)。
