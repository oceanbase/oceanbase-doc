...
有关 OceanBase 集群部署的详细信息，请参见 [部署简介](../../4.deploy-oceanbase/4.deploy/1.deployment-introduction.md)。
...
2. 安装 Antman。
   ...
   安装 Antman 的详细信息，请参见 [安装 oat-cli](../../4.deploy-oceanbase/4.deploy/6.command-line-deployment/1.configure-a-deployment-environment-2/1.install-oat-cli.md)。
...
创建普通租户的详细信息，请参见 [创建租户](../../4.deploy-oceanbase/4.deploy/6.command-line-deployment/5.create-an-oceanbase-tenant-2/2.create-a-tenant-2.md)。
