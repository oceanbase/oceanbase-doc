...
更多 `CREATE DATABASE` 语句相关的语法说明，请参见 [CREATE DATABASE](../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/11.create-database.md) 章节。
...
更多 `SELECT` 语句相关的语法说明，请参见 [SELECT](../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/51.SELECT-1-2/1.SELECT.md) 章节。
...
更多事务控制语句相关的说明请参见 [关于事务控制语句](../../3.developer-guide/2.application-development-based-on-mysql-mode/5.about-dml-statements-and-transactions/2.transaction/1.about-transactional-control-statements.md)。
...
更多事务控制语句相关的说明，请参见 [关于事务控制语句](../../3.developer-guide/2.application-development-based-on-mysql-mode/5.about-dml-statements-and-transactions/2.transaction/1.about-transactional-control-statements.md)。
