...
更多 `CREATE TABLE` 语句相关的语法说明请参见《SQL 参考（MySQL 模式）》中 [CREATE TABLE](/zh-CN/8.sql-reference/5.sql-statement/18.create-table.md)章节。
...
更多 `ALTER TABLE` 语句相关的语法说明请参见《SQL 参考（MySQL 模式）》中 [ALTER TABLE](/zh-CN/8.sql-reference/5.sql-statement/7.alter-table.md) 章节。
...
更多 `DROP TABLE` 语句相关的语法说明请参见《SQL 参考（MySQL 模式）》中 [DROP TABLE](/zh-CN/8.sql-reference/5.sql-statement/30.drop-table.md)章节。
