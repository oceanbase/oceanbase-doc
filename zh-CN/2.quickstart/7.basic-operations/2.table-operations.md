...
更多 `CREATE TABLE` 语句相关的语法说明请参见《SQL 参考（MySQL 模式）》中 [CREATE TABLE](/en-US/11.sql-reference-1/5.sql-statement-1/18.create-table-1.md)章节。
...
更多 `ALTER TABLE` 语句相关的语法说明请参见《SQL 参考（MySQL 模式）》中 [ALTER TABLE](/en-US/11.sql-reference-1/5.sql-statement-1/7.alter-table-1.md) 章节。
...
更多 `DROP TABLE` 语句相关的语法说明请参见《SQL 参考（MySQL 模式）》中 [DROP TABLE](/en-US/11.sql-reference-1/5.sql-statement-1/30.drop-table-1.md)章节。
