...
目前 `LIMIT` 算子只支持 MySQL 模式的 SQL 场景。详细信息请参考 [LIMIT](../../../../5.oceanbase-database-overview/7.sql-engine/4.oceanbase-database-overview-sql-execution-plan/2.oceanbase-database-overview-execution-plan-operators/15.execution-plan-operators-subplan-scan.md)。
