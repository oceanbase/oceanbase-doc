...
* `enable_rebalance`
  ...
  有关分区副本均衡的详细信息请参见 [自动负载均衡](/zh-CN/5.oceanbase-database-overview/4.distributed-database-objects/3.partitions-and-replicas/4.data-balancing/1.replica-balancing/1.automatic-load-balancing.md)。
