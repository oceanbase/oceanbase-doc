...
在 OceanBase 数据库中，典型情况下提交事务需要执行"两阶段提交"，两阶段提交详细说明请参见 [二阶段提交](/zh-CN/5.oceanbase-database-overview/7.transaction-management/1.transactions/8.distributed-transactions/2.two-phase-commit.md)。
