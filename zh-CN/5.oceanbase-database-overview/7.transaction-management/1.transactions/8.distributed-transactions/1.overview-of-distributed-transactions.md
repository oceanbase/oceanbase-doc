...
为了保证上述特性，通常采用两阶段提交协议。有关两阶段提交协议的详细介绍，参见 [两阶段提交](/zh-CN/5.oceanbase-database-overview/7.transaction-management/1.transactions/8.distributed-transactions/2.two-phase-commit.md)。
