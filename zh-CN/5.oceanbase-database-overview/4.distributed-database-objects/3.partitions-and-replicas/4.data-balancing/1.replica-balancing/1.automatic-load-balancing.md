...
* 第一类均衡组
  ...
  有关 Partition Group 的更多信息请参见 [Table Group](/zh-CN/5.oceanbase-database-overview/4.distributed-database-objects/3.partitions-and-replicas/4.data-balancing/1.replica-balancing/2.table-group.md)。
