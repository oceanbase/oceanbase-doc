...
有关 OBCI 的详细介绍，请参见 [OBCI](/zh-CN/5.oceanbase-database-overview/5.data-links/3.database-drivers/2.obci.md)。
...
有关 OceanBase Connector/J 的详细介绍，请参见 [OceanBase Connector/J](/zh-CN/5.oceanbase-database-overview/5.data-links/3.database-drivers/3.oceanbase-database-overview-oceanbase-connector-j.md)。
...
有关 OceanBase Connector/C 的详细介绍，请参见 [OceanBase Connector/C](/zh-CN/5.oceanbase-database-overview/5.data-links/3.database-drivers/4.oceanbase-database-overview-oceanbase-connector-c.md)。
