...
| 内存 | <ul><li> 个人用户简单试用最低要求 8 GB，长期使用要求不低于 32 GB，推荐设置在 64 GB 至 1024 GB 范围内。 </li><li> 生产环境推荐设置在 256 GB 至 1024 GB 范围内。 </li><li>性能测试场景推荐设置在 128 GB 至 1024 GB 范围内。</li></ul><main id="notice" type='notice'><h4>注意</h4><p>当部署多个集群时，推荐使用 OCP 进行统一运维管理，当部署集群比较少时，建议使用 OBD 进行安装部署。</p></main> |
| 磁盘类型   | 推荐使用 SSD                                                                                                           |
| 磁盘存储空间 | 内存大小的 4 倍及以上                                                                                                 |
