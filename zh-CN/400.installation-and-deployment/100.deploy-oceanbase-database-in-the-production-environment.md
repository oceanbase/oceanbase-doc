...
* 方法二：使用 SQL 语句创建用户租户。创建租户前需要先创建资源池，具体操作请参考 [创建资源池](../600.administrator-guide/200.basic-database-management/300.manage-resources/400.create-a-resource-pool.md)。
  ...
  创建租户的详细命令介绍请参考 [新建租户](../600.administrator-guide/200.basic-database-management/400.manage-tenants/200.create-a-tenant.md)。
