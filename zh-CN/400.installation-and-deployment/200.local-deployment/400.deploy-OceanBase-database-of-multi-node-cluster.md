...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>OBD 除了支持通过命令行方式部署 OceanBase 数据库生产环境外，也支持通过图形化界面部署 OceanBase 集群环境。推荐您通过 OBD 图形化界面进行部署，详细操作步骤请参考 <a href="https://www.oceanbase.com/docs/common-obd-cn-1000000004376589">通过 OBD 图形化界面部署 OceanBase 集群</a>。</p>
</main>
...
* 生产环境下，您需要进行环境和配置检查，具体操作请参考 [部署前配置](../200.local-deployment/200.environment-and-configuration-checks.md) 章节。
...
<main id="notice" type='explain'>
  ...
  <li>
  <p>单机部署操作步骤可参考 obd 文档中 <a href="https://www.oceanbase.com/docs/common-obd-cn-1000000003754549">单机部署 OceanBase 数据库</a> 一文。</p>
  </li>
  </ul>
</main>
...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>本文以 obd V3.5.0 为例提供操作指导。不同 obd 版本的配置文件可能不同，请以实际配置文件为准。更多 obd 相关内容请参见 <a href="https://www.oceanbase.com/docs/obd-cn">obd 文档</a>。</p>
</main>
...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>本节中所使用命令的详细使用方法可参考 obd 文档中的 <a href="https://www.oceanbase.com/docs/community-obd-cn-1000000001881997">集群命令组</a>。</p>
</main>
...
2. 启动 OceanBase 集群
   ...
   启动成功后，会输出监控组件的访问地址。在阿里云或其他云环境下，安装程序可能因无法获取公网 IP 而输出内网地址，此 IP 非公网地址，您需要使用正确的地址。
...
更多连接 OceanBase 集群的详细操作可参见 [连接 OceanBase 数据库](../../300.developer-guide/100.client-connects-to-oceanbase-database/100.overview-of-connection-method.md)。
...
* 方法二：通过命令行创建用户租户，详细操作可参考 [创建用户租户](../../500.administrator-guide/600.basic-database-management/400.manage-tenants-1/100.1.create-a-user-tenant.md)。
