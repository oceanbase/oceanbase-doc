...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>OBD 除了支持通过命令行方式部署 OceanBase 数据库生产环境外，也支持通过白屏部署 OceanBase 集群环境。详细操作步骤请参考 <a href="300.deploy-by-ocp.md">使用 OCP 部署 OceanBase 集群</a>。</p>
</main>
...
* OCP
  ...
  OceanBase Cloud Platform，OceanBase 云平台，简称为 OCP。详细信息请参考 [OCP 文档](https://www.oceanbase.com/docs/ocp-cn)。
