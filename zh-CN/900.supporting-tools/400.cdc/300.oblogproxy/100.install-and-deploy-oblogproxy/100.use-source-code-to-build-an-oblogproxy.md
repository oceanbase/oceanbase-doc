...
1. 获取 liboblog.so
   ...
   * 编译 liboblog
     ...
     您可参考 [liboblog 编译说明](../../200.liboblog/100.deploy-and-use-liboblog/100.install-and-deploy-liboblog.md)，在编译 [OceanBase 代码库](https://github.com/oceanbase/oceanbase#how-to-build) 时，添加参数 `OB_BUILD_LIBOBLOG=ON`。
