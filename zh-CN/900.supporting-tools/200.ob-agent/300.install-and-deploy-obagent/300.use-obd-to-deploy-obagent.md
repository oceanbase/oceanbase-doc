...
更多信息，请参考 [OBD 集群命令组](https://www.oceanbase.com/docs/community-obd-cn-10000000000017241)。
...
要更新 KV 配置，请使用 `obd cluster edit-config`。详细信息，请参考 [OBD 集群命令组](https://www.oceanbase.com/docs/community-obd-cn-10000000000017241)。
