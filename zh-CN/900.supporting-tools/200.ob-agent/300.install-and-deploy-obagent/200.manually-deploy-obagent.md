...
1. 修改配置文件，详细信息，参考 [monagent 配置文件说明](../200.configuration-reference/200.monagent-configuration-file.md) 和 [KV 配置文件说明](../200.configuration-reference/100.kv-configuration-file.md)。
...
1. 配置 Prometheus，详细信息，参考 [Prometheus 配置文件说明](../200.configuration-reference/300.prometheus-configuration-file.md)。
