...
+ [使用 OBD 部署 OceanBase 数据库](../../200.quick-start/400.use-obd-to-deploy-oceanbase-database.md)
+ [通过 MySQL 客户端连接 OceanBase 数据库](../../700.developer-guide/200.connect-to-oceanbase-database/100.connect-to-oceanbase-database-through-a-mysql-client.md)
...
使用 OBClient 或 MySQL 客户端连接 OBServer 集群，创建 SYS_USER_NAME 以及 SYS_PASSWORD。创建方式，请参考 [如何创建租户用户](https://www.oceanbase.com/docs/community-observer-cn-10000000000014143)。
