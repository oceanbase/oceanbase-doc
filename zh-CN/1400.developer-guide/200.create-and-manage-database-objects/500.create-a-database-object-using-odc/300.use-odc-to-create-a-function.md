...
具体数据类型，请参考 [数据类型概述](../../../1500.oceanbase-database-overview/600.database-objects/200.mysql-mode-tables/200.mysql-mode-data-types/100.mysql-mode-overview-of-data-types.md)。
