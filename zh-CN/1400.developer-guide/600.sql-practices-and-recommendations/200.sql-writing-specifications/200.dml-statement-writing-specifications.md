...
* 在业务 cache 表场景中，比如频繁 insert 或 delete，数据生命周期较短的场景，需要添加 Hint 指定查询。更多内容请参考 [Queuing 表查询缓慢问题](https://www.oceanbase.com/docs/community-observer-cn-10000000000900933)。
