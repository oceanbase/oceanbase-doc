...
关于通过 MySQL 客户端连接的详细信息，参见 [通过 MySQL 客户端连接 OceanBase 租户](../3.develop/1.application-development-of-mysql-mode/1.connect-to-oceanbase-database-of-mysql-mode/2.connect-to-an-oceanbase-tenant-by-using-a-mysql-client-of-mysql-mode.md)。
...
关于通过 OBClient 客户端连接的详细信息，参见 [通过 OBClient 连接 OceanBase 租户](../3.develop/2.application-development-of-oracle-mode/1.connect-to-oceanbase-database-of-oracle-mode/2.connect-to-an-oceanbase-tenant-by-using-obclient-of-oracle-mode.md)。
...
* [MySQL 模式下连接 OceanBase 数据库](../3.develop/1.application-development-of-mysql-mode/1.connect-to-oceanbase-database-of-mysql-mode/1.connection-methods-overview-of-mysql-mode.md)

* [Oracle 模式下连接 OceanBase 数据库](../3.develop/2.application-development-of-oracle-mode/1.connect-to-oceanbase-database-of-oracle-mode/1.connection-methods-overview-of-oracle-mode.md)