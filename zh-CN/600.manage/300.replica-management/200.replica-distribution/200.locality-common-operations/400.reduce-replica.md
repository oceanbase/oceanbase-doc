...
有关 Zone 上各节点的资源分配情况，参见 [查看租户和资源信息](../../../200.tenant-management/600.common-tenant-operations/400.view-tenant-information.md)。
...
* 对于 V4.2.1 版本，从 V4.2.1 BP8 开始支持手动删除副本。
...
2. 获取待操作租户的租户 ID 及 Locality 信息。
    ...
    * 用户租户
      ...
      有关视图 `DBA_OB_TENANTS` 中各字段的详细说明，参见 [DBA_OB_TENANTS](../../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/5800.oceanbase-dba_ob_tenants-of-sys-tenant.md)。
...
3. 获取待操作租户的所有日志流信息。
    ...
    * 系统租户
      ...
      有关视图 `CDB_OB_LS` 中各字段的详细说明，参见 [CDB_OB_LS](../../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/17500.oceanbase-cdb_ob_ls-of-sys-tenant.md)。
    ...
    * 用户租户
      ...
      有关视图 `DBA_OB_LS` 中各字段的详细说明，参见 [DBA_OB_LS](../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/17600.oceanbase-dba_ob_ls-of-mysql-mode.md)。
...
4. 根据前面获取到的日志流信息，查看 1001 号日志流的副本分布。
    ...
    * 系统租户
      ...
      有关视图 `CDB_OB_LS_LOCATIONS` 中各字段的详细说明，参见 [CDB_OB_LS_LOCATIONS](../../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/9300.oceanbase-cdb_ob_ls_locations-of-sys-tenant.md)。
    ...
    * 用户租户
      ...
      有关视图 `DBA_OB_LS_LOCATIONS` 中各字段的详细说明，参见 [DBA_OB_LS_LOCATIONS](../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/4400.oceanbase-dba_ob_ls_locations-of-mysql-mode.md)。
