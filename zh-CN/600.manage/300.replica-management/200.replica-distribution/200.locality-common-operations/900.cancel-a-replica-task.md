...
* 对于 V4.2.1 版本，从 V4.2.1 BP8 开始支持手动取消副本任务。
...
2. 查看当前正在执行的容灾任务。
    ...
    * 系统租户
      ...
      有关视图 `CDB_OB_LS_REPLICA_TASKS` 中各字段的详细说明，参见 [CDB_OB_LS_REPLICA_TASKS](../../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/18300.oceanbase-cdb_ob_ls_replica_tasks-of-sys-tenant.md)。  
    ...
    * 用户租户
      ...
      有关视图 `DBA_OB_LS_REPLICA_TASKS` 中各字段的详细说明，参见 [DBA_OB_LS_REPLICA_TASKS](../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/18200.oceanbase-dba_ob_ls_replica_tasks-of-mysql-mode.md)。  
...
4. 查看副本任务的取消结果。
    ...
    * 系统租户
      ...
      有关视图 `CDB_OB_LS_REPLICA_TASK_HISTORY` 中各字段的详细说明，参见 [CDB_OB_LS_REPLICA_TASK_HISTORY](../../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/18240.o-cdb_ob_ls_replica_task_history-of-sys-tenant.md)。
    ...
    * 用户租户
      ...
      有关视图 `DBA_OB_LS_REPLICA_TASK_HISTORY` 中各字段的详细说明，参见 [DBA_OB_LS_REPLICA_TASK_HISTORY](../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/18300.o-dba_ob_ls_replica_task_history-of-mysql-mode.md)。 
