...
有关视图 `DBA_OB_TENANT_JOBS` 的详细介绍，参见 [DBA_OB_TENANT_JOBS](../../../../7.reference/7.system-views/4.system-view-of-mysql-mode/2.dictionary-view-of-mysql-mode/57.oceanbase-dba_ob_tenant_jobs-of-mysql-mode.md) 。
