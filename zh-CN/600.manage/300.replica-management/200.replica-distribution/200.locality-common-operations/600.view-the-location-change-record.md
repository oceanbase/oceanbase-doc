...
有关视图 `DBA_OB_TENANT_JOBS` 的详细介绍，参见 [DBA_OB_TENANT_JOBS](../../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/22100.o-dba_ob_tenant_jobs-of-sys-tenant.md)。
