...
有关视图 `DBA_OB_TENANT_JOBS` 的详细介绍，参见 [DBA_OB_TENANT_JOBS](../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/5700.oceanbase-dba_ob_tenant_jobs-of-mysql-mode.md) 。
