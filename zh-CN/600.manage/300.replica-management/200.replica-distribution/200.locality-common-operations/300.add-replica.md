...
2. 获取待操作租户的租户 ID 及 Locality 信息。
    ...
    * 用户租户
      ...
      有关视图 `DBA_OB_TENANTS` 中各字段的详细说明，请参见 [DBA_OB_TENANTS](../../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/22200.o-dba_ob_tenants-of-sys-tenant.md)。
...
4. 获取待操作租户的 Unit 资源。
    ...
    * 用户租户
      ...
      有关视图 `GV$OB_UNITS` 中各字段的详细说明，请参见 [GV$OB_UNITS](../../../../700.reference/700.system-views/300.system-view-of-sys-tenant/300.performance-view-of-sys-tenant/4000.gv-ob_units-of-sys-tenant.md)。
