...
|  location  | 表示位置。它是系统已知的一组枚举值。location 的值为 Zone 的名称。集群和租户中的各 Zone 的名称可以通过 `oceanbase.DBA_OB_ZONES` 视图查询。<br> 有关 `DBA_OB_ZONES` 视图的详细信息，请参见 [oceanbase.DBA_OB_ZONES](../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/6300.oceanbase-dba_ob_zones-of-sys-tenant.md)。
...
+-----------+-------------+-------------+----------------------------+--------------+----------------------------------------------+--------------------+--------+
|         1 | sys         | SYS         | 2023-05-17 18:10:19.940353 | RANDOM       | FULL{1}@zone1                                | MYSQL              | NORMAL |
|      1001 | META$1002   | META        | 2023-05-17 18:15:21.455549 | zone1;zone2  | FULL{1}@zone1, FULL{1}@zone2, FULL{1}@zone3  | MYSQL              | NORMAL |
|      1002 | mysql001    | USER        | 2023-05-17 18:15:21.461276 | zone1;zone2  | FULL{1}@zone1, FULL{1}@zone2, FULL{1}@zone3  | MYSQL              | NORMAL |
|      1003 | META$1004   | META        | 2023-05-17 18:18:19.927859 | zone1        | FULL{1}@zone1                                | MYSQL              | NORMAL |
|      1004 | oracle001   | USER        | 2023-05-17 18:18:19.928914 | zone1        | FULL{1}@zone1                                | ORACLE             | NORMAL |
+-----------+-------------+-------------+----------------------------+--------------+----------------------------------------------+--------------------+--------+
5 rows in set
```
