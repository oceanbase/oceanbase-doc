...
* 全功能型副本
  ...
  全功能型副本为必选副本，一个租户全功能型副本的个数必须大于或等于 1。有关全功能型副本的更多介绍，参见 [全功能型副本](../../700.reference/100.oceanbase-database-concepts/500.distributed-database-objects/300.data-partitions-and-replicas/300.partition-replica-type/200.all-round-replica.md)。
