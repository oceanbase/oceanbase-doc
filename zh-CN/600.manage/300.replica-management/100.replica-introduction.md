...
* 列存副本
  ...
  AP 场景下，列存副本的详细部署方法，参见 [OceanBase AP 部署概述](../../620.obap/110.obap-deploy/10.obap-deploy-overview.md)。
...
* 查看普通日志流信息
  ...
  ```shell
  obclient(root@sys)[oceanbase]> SELECT * FROM oceanbase.DBA_OB_LS limit 10;
  ```
