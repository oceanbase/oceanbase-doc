...
* 对于 V4.2.1 版本，从 V4.2.1 BP4 版本开始支持手动执行取消 Transfer Partition 操作。
...
2. 查询视图 `CDB_OB_TRANSFER_PARTITION_TASKS`，获取当前任务的状态。
   ...
   有关配置项 `enable_transfer` 的详细说明及设置，请参见 [enable_transfer](../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/25600.enable_transfer.md)。
