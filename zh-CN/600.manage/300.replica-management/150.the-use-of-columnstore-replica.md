...
* 如果是 V4.6.0 之前版本，C 副本需要部署独立的 ODP，要求 ODP 版本必须为 ODP V4.3.2 及以上版本。
...
<main id="notice" type='notice'>
  <h4>注意</h4>
  <p>如果是 OceanBase 数据库 V4.6.0 及之后版本部署列存副本时，可以不部署 ODP，且 ODP 变量等无需设置，跳过此步骤。</p>
</main>
