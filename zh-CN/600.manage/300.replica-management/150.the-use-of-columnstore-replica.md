...
* C 副本需要部署独立的 ODP，要求 ODP 版本必须为 ODP V4.3.2 及以上版本。

    <main id="notice" type='notice'>
      <h4>注意</h4>
      <p>V4.6.0 及之后版本部署列存副本时不需要配置 ODP，且 ODP 变量等无需设置。</p>
    </main>
...
OceanBase 数据库 V4.6.0 版本引入了列存副本自动选择功能，可以通过以下方式进行控制：

* [系统变量配置](#系统变量配置)
* [通过 Hint 实现查询级别的控制](#查询级别控制)
