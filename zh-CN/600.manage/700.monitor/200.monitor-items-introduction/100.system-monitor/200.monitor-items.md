...
```shell
obclient> select distinct class,stat_id,name,VALUE_TYPE from gv$sysstat where class=1 and ```
stat_id in (10000,10001,10002,10003,10004,10005,10006);
```
...
```shell
+-----------+---------+------------+----------------------------------------+----------------------------------------+-------+
| tenant_id | stat_id | statistic# | name                                   | display_name                           | class |
+-----------+---------+------------+----------------------------------------+----------------------------------------+-------+
|         1 |  200001 |        360 | DB time                                | DB time                                |  3072 |
|         1 |  200002 |        361 | DB CPU                                 | DB CPU                                 |  3072 |
|         1 |  200003 |        362 | DB inner sql time                      | DB inner sql time                      |  3072 |
|         1 |  200004 |        363 | DB inner sql CPU                       | DB inner sql CPU                       |  3072 |
|         1 |  200005 |        364 | background elapsed time                | background elapsed time                |  3072 |
|         1 |  200006 |        365 | background cpu time                    | background cpu time                    |  3072 |
|         1 |  200007 |        366 | (backup/restore) cpu time              | (backup/restore) cpu time              |  3072 |
|         1 |  200008 |        367 | Tablespace encryption elapsed time     | Tablespace encryption elapsed time     |  3072 |
|         1 |  200009 |        368 | Tablespace encryption cpu time         | Tablespace encryption cpu time         |  3072 |
|         1 |  200010 |        369 | non idle wait time                     | non idle wait time                     |  3072 |
|         1 |  200011 |        370 | idle wait time                         | idle wait time                         |  3072 |
|         1 |  200012 |        371 | background database time               | background database time               |  3072 |
|         1 |  200013 |        372 | background database non-idle wait time | background database non-idle wait time |  3072 |
|         1 |  200014 |        373 | background database idle wait time     | background database idle wait time     |  3072 |
+-----------+---------+------------+----------------------------------------+----------------------------------------+-------+
...
| NAME | 描述 |
| ---- | ---- |
| DB time                                |  数据库活动的总时间，包括 CPU 和等待时间的累加值  |
| DB CPU                                 |  数据库活动中 CPU 消耗的时间  |
| DB inner sql time                      |  数据库执行内部 SQL 语句的总时间  |
| DB inner sql CPU                       |  数据库执行内部 SQL 语句消耗的 CPU 时间  |
| background elapsed time                |  后台进程执行的总时间  |
| background cpu time                    |  后台进程消耗的 CPU 时间  |
| (backup/restore) cpu time              |  备份或恢复过程中消耗的 CPU 时间  |
| Tablespace encryption elapsed time     |  表空间加密操作的总时间  |
| Tablespace encryption cpu time         |  表空间加密操作消耗的 CPU 时间  |
