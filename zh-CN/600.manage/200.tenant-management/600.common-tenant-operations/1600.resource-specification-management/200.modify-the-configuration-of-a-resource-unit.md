...
* `resource_hard_limit`：是一个配置项的值。
  ...
  有关配置项 `resource_hard_limit` 的更多说明信息，请参见 [resource_hard_limit](../../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/300.cluster-level-configuration-items/18200.resource_hard_limit.md)。
