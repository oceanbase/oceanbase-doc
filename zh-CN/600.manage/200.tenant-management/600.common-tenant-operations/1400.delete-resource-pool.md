...
* 当租户只有一个资源池时，不支持直接移除。
  ...
  * 先新建资源池，分配给该租户，再通过修改资源池配置释放需要删除的资源池。新建资源池操作，参见 [新建资源池](../600.common-tenant-operations/300.create-tenant.md)。
...
* [新建资源池](../600.common-tenant-operations/300.create-tenant.md)
