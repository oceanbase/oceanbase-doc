...
4. 通过 `FLASHBACK TENANT` 语句，恢复回收站中的租户。
    ...
    `FLASHBACK TENANT` 语句的详细说明，参见 [FLASHBACK](../../../700.reference/400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/3400.flashback-database-of-mysql-mode.md)。
