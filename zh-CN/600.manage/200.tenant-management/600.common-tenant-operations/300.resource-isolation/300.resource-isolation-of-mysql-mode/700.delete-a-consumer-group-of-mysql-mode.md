...
3. 执行成功后，可以查看 `oceanbase.DBA_RSRC_CONSUMER_GROUPS` 视图进行确认。
   ...
   有关 `oceanbase.DBA_RSRC_CONSUMER_GROUPS` 视图的详细介绍请参见 [oceanbase.DBA_RSRC_CONSUMER_GROUPS](../../../../../7.reference/7.system-views/4.system-view-of-mysql-mode/2.dictionary-view-of-mysql-mode/208.oceanbase-dba_rsrc_consumer_groups.md)。

## 相关文档

[DELETE_CONSUMER_GROUP](../../../../../7.reference/5.sql-reference/3.pl-reference/2.pl-mysql/10.pl-system-package-mysql/133.dbms-resource-manager-mysql/5.delete-consume-group-mysql.md)
