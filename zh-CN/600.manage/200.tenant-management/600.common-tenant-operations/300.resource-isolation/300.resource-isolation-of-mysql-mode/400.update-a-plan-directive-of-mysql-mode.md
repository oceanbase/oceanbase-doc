...
[UPDATE_PLAN_DIRECTIVE](../../../../../7.reference/5.sql-reference/3.pl-reference/2.pl-mysql/10.pl-system-package-mysql/133.dbms-resource-manager-mysql/9.update-plan-directive-mysql.md)
