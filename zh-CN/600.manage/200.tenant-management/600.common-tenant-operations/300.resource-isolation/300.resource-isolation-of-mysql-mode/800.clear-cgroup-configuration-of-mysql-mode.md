...
请确认 cgroup 配置所在的 OBServer 已停止运行，停止 OBServer 的相关操作请参见 [重启节点](../../../../1.cluster-management/3.common-cluster-operations/3.restart-a-node.md)。
...
[配置 cgroup](1.config-cgroups-of-enterprise-of-mysql.md)
