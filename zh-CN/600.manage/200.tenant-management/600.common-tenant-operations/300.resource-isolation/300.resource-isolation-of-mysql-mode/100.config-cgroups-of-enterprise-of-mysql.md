...
建议使用 cgroup 中的目录文件调用 `DBMS_RESOURCE_MANAGER` 系统包中的子程序 `CREATE_CONSUMER_GROUP` 创建的资源组，来进行资源隔离。配置资源隔离的详细操作，请参见 [配置资源隔离](200.resource-isolation-at-user-level-of-mysql-mode.md)。
