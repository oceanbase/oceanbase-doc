...
3. 执行成功后，可以查看 `DBA_RSRC_CONSUMER_GROUPS` 视图进行确认。
   ...
   有关 `DBA_RSRC_CONSUMER_GROUPS` 视图的详细介绍请参见 [DBA_RSRC_CONSUMER_GROUPS](../../../../../7.reference/7.system-views/5.system-view-of-oracle-mode/2.dictionary-view-of-oracle-mode/122.dba_rsrc_consumer_groups-of-oracle-mode.md)。

## 相关文档

[DELETE_CONSUMER_GROUP](../../../../../7.reference/5.sql-reference/3.pl-reference/3.pl-oracle/14.pl-system-package-oracle/133.dbms-resource-manager-oracle/5.delete-consume-group-oracle.md)
