...
* 在进行 IOPS 资源隔离前，可以先进行磁盘性能校准，磁盘性能校准的相关操作请参见 [磁盘性能校准](../200.resource-isolation-of-oracle-mode/150.disk-performance-calibration-of-oracle-mode.md)。
...
* 同一租户下，如果同时配置了多种级别的隔离策略，其优先级如下：
  ...
  SQL 级资源隔离 > User 级资源隔离 > Function 级资源隔离
