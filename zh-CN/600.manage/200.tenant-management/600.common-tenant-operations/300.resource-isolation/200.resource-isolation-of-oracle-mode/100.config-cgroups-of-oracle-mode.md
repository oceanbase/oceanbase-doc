...
建立软链接并且开启 cgroup 功能后，需要重启 OBServer 节点功能才会生效（如果有多台机器，则每台机器都需要重启一次），重启 OBServer 节点的详细操作，参见 [重启节点](../../../../100.cluster-management/300.common-cluster-operations/300.restart-a-node.md)。
