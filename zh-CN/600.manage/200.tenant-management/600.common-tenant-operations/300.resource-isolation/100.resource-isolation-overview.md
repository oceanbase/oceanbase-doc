...
关于 `DBMS_RESOURCE_MANAGER` 系统包的详细介绍，请参见 [DBMS_RESOURCE_MANAGER 系统包（Oracle 模式）](../../../../7.reference/5.sql-reference/3.pl-reference/3.pl-oracle/14.pl-system-package-oracle/133.dbms-resource-manager-oracle/1.dbms-resource-manager-overview-oracle.md)
 和 [DBMS_RESOURCE_MANAGER 系统包（MySQL 模式）](../../../../7.reference/5.sql-reference/3.pl-reference/2.pl-mysql/10.pl-system-package-mysql/133.dbms-resource-manager-mysql/1.dbms-resource-manager-overview-mysql.md)。
