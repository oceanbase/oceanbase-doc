...
| BACKGROUND_GROUP     | <ul><li>COMPACTION_LOW</li> <li>COMPACTION_MID</li> <li>HA_LOW</li> <li>HA_MID</li> <li>HA_HIGH</li> <li>DDL</li> <li>DDL_HIGH</li> <li>CLOG_LOW</li> <li>CLOG_MID</li> <li>OPT_STATS</li> <li>GC_MACRO_BLOCK</li> <li>SQL_AUDIT</li> <li>MVIEW</li> <li>REPLAY_HIGH</li></ul> |
...
2. （可选）配置后台任务的资源隔离前，可以进行磁盘性能校准，并配置租户 Unit 的 IOPS。
