...
3. 通过 `DBA_OB_TENANTS` 视图，查看租户信息。
   ...
   以查看租户 `mq_t1` 的锁定状态为例：
    ...
    `DBA_OB_TENANTS` 视图的详细说明，参见 [DBA_OB_TENANTS](../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/12300.oceanbase-dba_ob_tenants-of-mysql-mode.md)。
