...
* 通过 `GV$OB_SERVERS` 视图查询资源上限值。
  ...
  关于 `GV$OB_SERVERS` 视图的详细介绍，参见 [GV$OB_SERVERS](../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/2700.gv-ob_servers-of-mysql-mode.md)。
