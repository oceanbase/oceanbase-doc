...
3. 通过 `DBA_OB_TENANTS` 视图，查看所有的租户信息。
   ...
   `DBA_OB_TENANTS` 视图的详细说明，请参见 [DBA_OB_TENANTS](../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/12300.oceanbase-dba_ob_tenants-of-mysql-mode.md)。
