...
使用 `ALTER TENANT` 命令重命名租户名会导致 OCP 上显示该租户不可用。如果您需要使用 OCP 管理租户，请在 OCP 上进行相关操作，有关 OCP 上租户重命名的相关说明，参见 [OceanBase 租户常见问题](https://www.oceanbase.com/docs/common-ocp-1000000002380975)。
