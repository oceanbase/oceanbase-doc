...
为租户创建服务时，需要通过接入 OCP 来保证一个服务下最多只有一个主租户，建议使用 OCP 来维护主备关系并管理服务，有关使用 OCP 管理主备租户的详细介绍及操作，参见 [OCP 官方文档](https://www.oceanbase.com/docs/common-ocp-1000000001126929)。
