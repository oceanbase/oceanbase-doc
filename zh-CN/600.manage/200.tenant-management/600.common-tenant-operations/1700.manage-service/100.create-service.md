...
OceanBase 数据库支持通过 OCP 或 `CREATE SERVICE` 命令来为用户租户创建服务。本节主要介绍如何通过 `CREATE SERVICE` 命令来创建服务，建议使用 OCP 来创建和管理服务，有关使用 OCP 创建服务的详细介绍及操作，参见 [租户详情页概述](https://www.oceanbase.com/docs/common-ocp-1000000001126930)。
