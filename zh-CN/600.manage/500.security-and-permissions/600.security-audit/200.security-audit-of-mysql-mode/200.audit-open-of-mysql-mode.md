...
通过 [AUDIT_LOG_FILTER_SET_FILTER](../../../../700.reference/500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/400.functions-of-mysql-mode/960.audit-functions-of-mysql-mode/400.audit-log-filter-set-filter-of-mysql-mode.md) 函数（表达式）创建过滤器，命令如下：
...
通过 [AUDIT_LOG_FILTER_SET_USER](../../../../700.reference/500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/400.functions-of-mysql-mode/960.audit-functions-of-mysql-mode/500.audit-log-filter-set-user-of-mysql-mode.md) 函数（表达式）将过滤器设置到用户上。
