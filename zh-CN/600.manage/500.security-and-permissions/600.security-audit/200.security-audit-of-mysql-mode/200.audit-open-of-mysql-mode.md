...
以下为过滤器 JSON 极简示例，更多示例请参见文末相关文档中 `AUDIT_LOG_FILTER_SET_FILTER` 函数的参考文档：
...
* `general_sql_command` 语句类型清单：[附录：general_sql_command 支持的完整 SQL 类型](600.general-sql-command-supported-sql-types-of-mysql-mode.md)