...
| SESSION_ID                      | bigint(20) unsigned | Session 连接 ID     |
...
| WAIT_CLASS_NO                   | bigint(20)          | 等待事件所属的 Class 的下标   |
...
| RULE_NAME                       | varchar(256)        | 用户定义规则名       |
| PARTITION_HIT                   | tinyint(4)          | 路由是否准确         |
| TX_INTERNAL_ROUTING             | bigint(20)          | 事务路由标记         |
| TX_STATE_VERSION                | bigint(20) unsigned | 事务状态版本         |
