...
<main id="notice" type='notice'>
  <h4>注意</h4>
  <p>开启 TDE 功能后，`UPDATE` 场景性能无影响，但其他场景的性能略有损耗。具体情况参见[透明数据加密 TDE 测试报告](../150.transparent-data-encryption-tde-test-report.md)。</p>
</main>
...
4. 确认后，执行以下语句，生成主密钥。
      ...
      <main id="notice" type='notice'>
      <h4>注意</h4>
      <p>在执行完该语句之后，需要等 20 秒左右，等待秘钥生效后再执行后续操作。</p>
      </main>
