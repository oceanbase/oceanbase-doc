...
更多 `GRANT` 语句的信息请参见 [GRANT](../../../../../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/55.grant-of-mysql-mode.md)。
...
更多 `REVOKE` 语句的信息请参见 [REVOKE](../../../../../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/77.revoke-of-mysql-mode.md)。
