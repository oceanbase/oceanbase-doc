...
2. 通过以下方式查看用户权限：
   ...
   * 查看用户所拥有的全局权限。
     ...
     *************************** 1. row ***************************
     ...
     更多 `mysql.user` 视图的字段及说明请参见 [mysql.user](../../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/4700.mysql-user-of-mysql-mode.md)。
   ...
   * 查看用户所拥有的数据库级权限。
     ...
     *************************** 1. row ***************************
     ...
     更多 `mysql.db` 视图的字段及说明请参见 [mysql.db](../../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/3400.mysql-db-of-mysql-mode.md)。
