...
用户创建完成后，在生产环境中更常见的是在保留业务可用的前提下轮换密码（双密码）。改密、保留旧口令与丢弃旧口令等操作通过 `ALTER USER` 完成，说明参见 [双密码管理](../../../200.identification-and-authentication/100.identification-and-authentication-of-mysql-mode/400.dual-password-of-mysql-mode.md)。