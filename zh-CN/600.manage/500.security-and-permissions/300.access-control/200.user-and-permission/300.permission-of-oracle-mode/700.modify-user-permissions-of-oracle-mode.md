...
查看当前拥有权限的操作请参见 [查看用户权限](../300.permission-of-oracle-mode/600.view-user-permissions-of-oracle-mode.md)。如果您没有所需的权限，请联系管理员为您添加。查看当前拥有角色的操作请参见 [查看角色](../../../../../700.reference/200.administrator-guide/200.basic-database-management/400.manage-tenants/500.manage-users-and-permissions/200.oracle-mode/900.manage-roles-of-oracle-mode/600.view-roles-of-oracle-mode.md)。
...
`GRANT` 语句的更多信息，请参见 [GRANT](../../../../../700.reference/400.development-reference/100.sql-syntax/300.common-tenant-of-oracle-mode/900.sql-statement-of-oracle-mode/300.dcl-of-oracle-mode/700.grant-of-oracle-mode.md)。
...
`REVOKE` 语句的更多信息，请参见 [REVOKE](../../../../../700.reference/400.development-reference/100.sql-syntax/300.common-tenant-of-oracle-mode/900.sql-statement-of-oracle-mode/300.dcl-of-oracle-mode/900.revoke-of-oracle-mode.md)。
