...
更多 `REVOKE` 语句的说明信息，请参见 [REVOKE](../../../../../../7.reference/5.sql-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/3.dcl-of-oracle-mode/29.revoke-of-oracle-mode.md)。
