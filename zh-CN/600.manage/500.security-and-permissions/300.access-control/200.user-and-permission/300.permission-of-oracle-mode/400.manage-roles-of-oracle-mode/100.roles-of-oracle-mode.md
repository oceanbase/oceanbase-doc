...
* [新建角色](../4.manage-roles-of-oracle-mode/2.create-a-role-for-oracle-tenant-of-oracle-mode.md)

* [将角色授予角色](../4.manage-roles-of-oracle-mode/3.grant-a-role-to-a-role-of-oracle-mode.md)

* [将角色授予用户](../4.manage-roles-of-oracle-mode/4.grant-a-role-to-a-user-of-oracle-mode.md)

* [为用户指定生效或失效的角色](../4.manage-roles-of-oracle-mode/5.specify-an-active-or-inactive-role-for-the-user-of-oracle-mode.md)

* [查看角色](../4.manage-roles-of-oracle-mode/6.view-roles-of-oracle-mode.md)

* [修改角色](../4.manage-roles-of-oracle-mode/7.modify-a-role-of-oracle-mode.md)

* [撤销角色](../4.manage-roles-of-oracle-mode/8.revoke-role-of-oracle-mode.md)

* [删除角色](../4.manage-roles-of-oracle-mode/9.delete-a-role-of-oracle-mode.md)
