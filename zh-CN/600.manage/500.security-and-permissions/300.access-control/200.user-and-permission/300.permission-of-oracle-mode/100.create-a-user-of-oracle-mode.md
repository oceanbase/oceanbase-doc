...
创建用户后，若需要执行改密轮转等运维操作，可参见 [密码轮转](../../../200.identification-and-authentication/200.identification-and-authentication-of-oracle-mode/400.password-rotate-of-oracle-mode.md)。
