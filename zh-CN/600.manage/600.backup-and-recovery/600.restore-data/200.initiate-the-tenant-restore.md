...
4. 执行以下语句，开始执行恢复任务。
   ...
   * `pool_list`、`locality`、`primary_zone`、`concurrency`、`kms_encrypt`：可选。有关这些参数的详细说明，参见 [ALTER SYSTEM - RESTORE](../../../700.reference/500.sql-reference/100.sql-syntax/100.system-tenants/200.alter-system/3300.restore.md)。
