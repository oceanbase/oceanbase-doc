...
2. 执行以下语句，查看恢复进度。 
   ...
   ```sql
   obclient [oceanbase]> SELECT * FROM oceanbase.CDB_OB_RESTORE_PROGRESS WHERE TENANT_ID!=1\G
   ```
   ...
   *************************** 1. row ***************************
           ...
           BACKUP_CLUSTER_NAME: backup_cluster
                   ...
                   RESTORE_SCN: 1704176213189156000
           RESTORE_SCN_DISPLAY: 2024-01-02 14:16:53.189156
                RESTORE_OPTION: pool_list=new_pool
               START_TIMESTAMP: 2024-01-02 14:16:59.007627
                        STATUS: RESTORING
             BACKUP_PIECE_LIST: file:///data/nfs/backup/data/backup_set_1_full
               BACKUP_SET_LIST: file:///data/nfs/backup/archive/2_1_2,file:///data/nfs/backup/archive/2_1_3
                   RECOVER_SCN: 1704174413189156000
           RECOVER_SCN_DISPLAY: 2024-01-02 13:46:53.189156
