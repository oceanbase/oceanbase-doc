...
4. （可选）设置表级恢复并行度
  ...
  在执行表级恢复之前，可通过配置项 [recover_table_dop](../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/9200.recover_table_dop.md) 设置并发度。设置后，系统会在以下两个阶段使用该并行度：
