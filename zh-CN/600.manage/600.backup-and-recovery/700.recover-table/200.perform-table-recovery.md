...
[表级恢复流程](../../../700.reference/100.oceanbase-database-concepts/1000.high-data-reliability-and-availability/500.backup-and-recovery/400.recovery-architecture.md)有三个阶段：物理恢复、跨租户导表和清理辅助租户。由于物理恢复阶段采用全量恢复时，所有数据都要从备份介质恢复到辅助租户，这种恢复方式易产生以下两个问题：
