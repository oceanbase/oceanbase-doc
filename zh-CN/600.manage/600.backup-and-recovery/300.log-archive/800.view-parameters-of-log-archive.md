...
2. 执行以下语句，查看租户的归档相关参数。
   ...
   * 查看所有租户的 `LOG_ARCHIVE_DEST` 参数。
      ...
      更多 `CDB_OB_ARCHIVE_DEST` 视图的说明，请参见 [CDB_OB_ARCHIVE_DEST](../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/5400.o-cdb_ob_archive_dest-of-sys-tenant.md)。
