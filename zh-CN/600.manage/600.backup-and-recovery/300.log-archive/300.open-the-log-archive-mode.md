...
2. 执行以下语句，开启本租户的归档模式。归档服务开启后，本用户租户的数据字典也会被归档。
...
* [数据字典](../../../700.reference/1500.components-and-tools/300.data-integrate/400.cdc/200.obcdc-parameters/200.obcdc-configuration-items.md)
