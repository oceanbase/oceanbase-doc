...
`1002` 租户的第一轮归档产生了 3 个 Piece，`piece id` 分别是`1`~`3`，归档日志的范围是 `'2022-06-01 06:00:00.000000'` ~ `'2022-06-03 12:00:00.000000'`。而且，有 `10GB` 的实际归档数据已被清理，该部分被清理的数据压缩前的数据量是 `25GB`。
...
更多 `CDB_OB_ARCHIVELOG_SUMMARY` 视图的说明，请参见 [CDB_OB_ARCHIVELOG_SUMMARY](../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/5700.o-cdb_ob_archivelog_summary-of-sys-tenant.md)。
