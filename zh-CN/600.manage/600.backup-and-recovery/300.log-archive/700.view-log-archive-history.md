...
`1002` 租户的第一轮归档产生了 3 个 Piece， `piece id` 分别是`1`~`3`，归档日志的范围是 `'2022-06-01 06:00:00.000000'` ~ `'2022-06-03 12:00:00.000000'`。
...
更多 `CDB_OB_ARCHIVELOG_SUMMARY` 视图的说明，请参见 [CDB_OB_ARCHIVELOG_SUMMARY](../../../700.reference/500.system-reference/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/13500.oceanbase-cdb_ob_archivelog_summary-of-mysql-mode.md)。
