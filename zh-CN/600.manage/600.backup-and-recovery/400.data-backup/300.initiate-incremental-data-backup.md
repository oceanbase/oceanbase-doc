...
2. （可选）设置租户的备份并发度。
   ...
   有关配置项 `ha_low_thread_score` 的详细说明，请参见 [ha_low_thread_score](../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/400.ha_high_thread_score.md)。
