...
OceanBase 数据库当前版本除了支持阿里云 OSS、腾讯云 COS 和 NFS 三种备份介质以外，从 V4.2.1 BP7 版本开始，还支持 AWS S3 以及兼容 S3 协议的对象存储（例如：华为 OBS、Google GCS），部分备份介质需要满足一些基本要求才能使用。
...
|---|---|---|---|
| 4.2.1 BP6 及之前版本   | 3.9.2  | 5.0.16  | 不支持  |
| 4.2.1 BP7/8/9   | 3.9.2  | 5.0.16  | 1.11.156  |
| 4.2.1 BP10   | 3.11.2  | 5.0.16  | 1.11.156  |
