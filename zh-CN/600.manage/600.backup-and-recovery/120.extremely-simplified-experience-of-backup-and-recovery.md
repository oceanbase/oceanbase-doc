...
4. 需要恢复出的目标租户 `oracle_backup` 的资源池为 `restore_pool`，副本 `Locality` 为 `F@z1`，并且将租户恢复到最新位点。 
   ...
   如果租户所在的集群为多副本集群，请参考 [恢复数据](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000507964) 章节来一步步进行恢复。
...
更多日志归档的详细操作及说明，请参见 [日志归档]([https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000507978](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000507978)) 章节。
...
更多数据备份的详细操作及说明，请参见 [数据备份]([https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000507988](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000507988)) 章节。
...
更多物理恢复的详细操作及说明，请参见 [恢复数据]([https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000507964](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000507964)) 章节。
