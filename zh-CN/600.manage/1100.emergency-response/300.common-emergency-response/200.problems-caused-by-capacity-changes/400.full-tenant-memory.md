...
2. 调高转储线程数，加快转储，让内存尽快释放。
   ...
   您还可以在 OCP 界面通过修改转储策略调高转储线程数，具体参见[修改转储配置](../../../../700.reference/200.system-management/500.manage-data-storage/100.dump-management/500.modify-dump-configuration.md)。
