...
有关配置项的更多说明，请参见 [系统配置项概述](../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/100.system-configuration-items-overview.md)。
...
3. 执行以下命令，查看集群配置项。
  ...
  有关 `GV$OB_PARAMETERS` 视图的更多信息，请参见 [GV$OB_PARAMETERS（MySQL 模式）](../../../700.reference/700.system-views/500.system-view-of-oracle-mode/300.performance-view-of-oracle-mode/600.gv-ob_parameters-of-oracle-mode.md)。
...
有关每个配置项的详细介绍，请参见 [系统配置项](../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/100.system-configuration-items-overview.md)。
