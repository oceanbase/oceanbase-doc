...
有关配置项的更多说明，请参见 [系统配置项概述](../../../7.reference/8.configuration-items-and-system-variables/1.system-configuration-items/1.system-configuration-items-overview.md)。
...
3. 执行以下命令，查看集群配置项。
  ...
  有关 `GV$OB_PARAMETERS` 视图的更多信息，请参见 [GV$OB_PARAMETERS（MySQL 模式）](../../../7.reference/7.system-views/5.system-view-of-oracle-mode/3.performance-view-of-oracle-mode/6.gv-ob_parameters-of-oracle-mode.md)。
...
有关每个配置项的详细介绍，请参见 [系统配置项](../../../7.reference/8.configuration-items-and-system-variables/1.system-configuration-items/1.system-configuration-items-overview.md)。
