...
3. 将旧节点上的 Unit 迁移到新节点。
   ...
   1. 查询 `DBA_OB_SERVERS` 视图获取待替换节点的相关信息。
      ...
      有关 `DBA_OB_SERVERS` 视图的更多详细信息，请参见 [DBA_OB_SERVERS](../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/20800.o-dba_ob_servers-of-sys-tenant.md)。
