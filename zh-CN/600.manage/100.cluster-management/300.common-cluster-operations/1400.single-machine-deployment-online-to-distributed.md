...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>您也可以通过向 Zone 里添加 OBServer 节点的方式进行单机转分布式部署，即单副本多节点的部署模式。详细信息请参见 <a href="4.add-a-node.md">添加节点</a>。</p>
</main>

## 前提条件

* 服务器已完成相关配置。有关配置服务器详细信息，请参见 [服务器配置](../../../4.deploy/3.deploy-oceanbase-enterprise-edition/2.preparations-before-deploy/2.configure-servers.md)。

* 部署环境已完成初始化。有关部署环境初始化的详细信息，请参见 [使用 oatcli 初始化 OBServer 服务器](../../../4.deploy/3.deploy-oceanbase-enterprise-edition/4.deploy-through-the-command-line/1.configure-a-deployment-environment-command-line/1.initializing-the-observer-server-using-oatcli.md)。
...
* [通过 OBClient 连接 OceanBase 租户](../../../3.develop/1.application-development-of-mysql-mode/1.connect-to-oceanbase-database-of-mysql-mode/3.connect-to-an-oceanbase-tenant-by-using-obclient-of-mysql-mode.md)
* [ALTER SYSTEM ... ZONE](../../../7.reference/5.sql-reference/1.sql-syntax/1.system-tenants/2.alter-system/50.zone.md)
* [ALTER SYSTEM ... SERVER](../../../7.reference/5.sql-reference/1.sql-syntax/1.system-tenants/2.alter-system/36.SERVER.md)
* [ALTER RESOURCE POOL](../../../7.reference/5.sql-reference/1.sql-syntax/1.system-tenants/3.alter-resource-pool.md)
* [ALTER TENANT](../../../7.reference/5.sql-reference/1.sql-syntax/1.system-tenants/5.alter-tenant.md)
