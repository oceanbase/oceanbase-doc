...
<main id="notice" type='notice'>
  <h4>注意</h4>
  <p>OceanBase 数据库暂不支持 V4.2.x 系列或更低版本升级到 V4.4.x 版本。</p>
</main>
...
* 非共享存储模式：
  ...
  * 支持从 V4.3.0（除 V4.3.0 RC1）/V4.3.1/V4.3.2/V4.3.3/V4.3.4/V4.3.5/V4.3.5 BP1/V4.3.5 BP2/V4.4.0/V4.4.0 BP1 各版本平滑升级到 V4.4.1。
  * 非共享存储模式不建议从 V4.3.5 BP2 升级到 V4.4.1。
  * 不支持 V4.2.x 系列或更低版本升级到 V4.4.1。

* 共享存储模式：

  * 支持从 V4.4.0 BP1 升级到 V4.4.1，租户单副本部署升级会停服务。
  * 不支持从 V4.3.5 BP2/V4.4.0 升级到 V4.4.1。
  * V4.4.0 BP1 升级 V4.4.1，需要先升级对应的 logservice 集群到 V1.1.0。

## 升级路径图

![421-425-435-441-2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.3.5/1500.oceanbase-version-upgrade/4-4257-4355-441-2.png)
...
* V4.2.x 的路径：
  ...
  * V4.2.1.2 至 V4.2.1.9 的版本可以升级到 V4.2.1.10，然后升级到 V4.2.5.1/V4.2.5.2，最后再升级到 V4.2.5.7 版本。
  * V4.2.1.2 至 V4.2.1.9 的版本可以升级到 V4.2.1.11 再升级到 V4.2.5.3 及后续的 V4.2.5 系列版本。

    * V4.2.1.11 也可以直接升级到 V4.2.5.7 版本。
...
* V4.4.x 的升级路径：
  ...
  * V4.3.5.1/V4.3.5.2 的版本，可以直接升级到 V4.4.0 版本，然后升级到 V4.4.1 版本。
