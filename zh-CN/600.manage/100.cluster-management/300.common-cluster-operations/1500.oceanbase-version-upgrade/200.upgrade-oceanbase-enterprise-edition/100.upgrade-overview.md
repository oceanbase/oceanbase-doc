...
* 仅支持 V4.2.1 BP2 及之前的版本升级到 V4.2.5 版本，V4.2.1 BP3 及之后 V4.2.1 系列不支持升级到 V4.2.5 版本。在升级时请注意升级路径。
* V4.2.2.1 版本对于 V4.2.2.0 版本是 Barrier 版本，V4.2.2.0 升级到未来更高版本时需要经停 V4.2.2.1。
* V4.2.3/V4.2.4 系列版本可以直接升级到 V4.2.5 版本。
* ODP 和 OBServer 升级顺序：建议先升级 OBServer 版本到 OBServer V4.2.5 版本，再升级 ODP 版本到 V4.3.2。
