...
* V4.3.x 的升级路径：
  ...
  * V4.3.x 的版本都可以升级到下一个 GA 版本，最终升级到 V4.3.5。例如，当前 V4.3.2 版本的集群可以先升级到 V4.3.3，然后再升级到 V4.3.4，最终升级到 V4.3.5 版本的集群。
  * V4.3.x 的版本都可以直接升级到 V4.3.5。例如，当前 V4.3.2 版本的集群可以直接升级到 V4.3.5 版本的集群。
