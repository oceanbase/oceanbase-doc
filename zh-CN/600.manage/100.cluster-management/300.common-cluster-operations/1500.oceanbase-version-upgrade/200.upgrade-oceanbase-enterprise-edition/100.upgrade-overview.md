...
* 支持 V4.3.0 Beta 及之后 BP 版本、V4.3.1 Beta 及之后 BP 版本、V4.3.2 Beta Hotfix1 及之后 BP 版本、V4.3.3 GA 及之后 BP 版本、V4.3.4 GA 及之后 BP 版本，平滑升级到 V4.3.5。
...
![1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.3.5/1500.oceanbase-version-upgrade/%E5%8D%87%E7%BA%A7%E8%B7%AF%E5%BE%844251-435.png)

<main id="notice" type='explain'>
  <h4>说明</h4>
  <p><ul><li>本文升级路径图并未包含 OceanBase 数据库的所有版本，如需了解更多版本的升级路径，可以参考 <code>oceanbase_upgrade_dep.yml</code> 文件，该文件记录了 OceanBase 的版本升级拓扑图。</li><li>解压目标版本的 OceanBase RPM 包后，会在存放 RPM 包的目录下生成 <code>home</code> 和 <code>use</code> 两个目录。升级相关脚本和 <code>oceanbase_upgrade_dep.yml</code> 文件存放 <code>home/admin/oceanbase/etc</code> 目录下。</li></ul>确认升级路径的详细信息，参见 <a href="300.start-upgrade.md">升级 OceanBase 集群</a> 中的 <b>步骤二：确认升级流程</b> 章节。</p>
</main>
...
* V4.2.x 的路径：
  ...
  * V4.2.1.2 至 V4.2.1.9 的版本都要升级到 V4.2.1.10 才能升级到 V4.2.5.1。
  * barrier 版本：V4.2.1.2 和 V4.2.1.10。

* V4.3.x 的升级路径：

  * V4.3.x 的版本都可以升级到下一个 GA 版本，最终升级到 V4.3.5。
  * V4.3.x 的版本都可以直接升级到 V4.3.5。
  * 备份恢复 V4.3.2 的版本无法升级到 V4.3.3。
