...
* 支持从 V4.2.5/V4.2.5 BP1~BP6 版本升级到 V4.2.5 BP7 版本，然后再升级到 V4.4.2 BP1 版本。
* 支持从 V4.3.5/V4.3.5 BP1~BP5 版本升级到 V4.3.5 BP6 版本，然后再升级到 V4.4.2 BP1 版本。
* 支持从 V4.4.0/V4.4.1 版本直接升级到 V4.4.2 BP1 版本。
