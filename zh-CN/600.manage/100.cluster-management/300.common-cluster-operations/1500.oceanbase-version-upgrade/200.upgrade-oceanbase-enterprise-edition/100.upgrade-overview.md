...
![4257-4355-450](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.3.5/1500.oceanbase-version-upgrade/5-4257-4355-450.png)
...
* V4.4.x 的升级路径：
  ...
  * V4.3.0-V4.3.5.2 和 V4.4.0-V4.4.0.1 各版本都可以平滑升级到 V4.4.1 版本。
  * 暂不支持 V4.2.x 系列或更低版本升级到 V4.4.1 版本。

* V4.5.x 的升级路径：

  * V4.3.0-V4.3.5.2 版本可以升级到 V4.4.0-V4.4.1 版本，然后在升级到 V4.5.0 版本。
