...
![421-425-435-441](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.3.5/1500.oceanbase-version-upgrade/4-4257-4355-441.png)
...
* V4.4.x 的升级路径：
  ...
  * V4.3.5.1/V4.3.5.2 的版本，可以直接升级到 V4.4.0 版本。
