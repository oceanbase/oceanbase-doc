...
<!--请参见 OceanBase 集群版本升级下 [开始升级](100.oceanbase-cluster-version-upgrade/200.start-upgrade.md) 中的 **步骤一：分析 oceanbase_upgrade_dep.yml 文件** 章节内容，确认当前版本至目标版本的升级序列。-->通过升级序列判断升级流程如下：
...
* 如果当前版本是 V4.1.0.0-100000982023031415 版本，升级流程如下：
  ...
  1. 您需要先将仲裁服务版本从 V4.1.0.0-100000982023031415 版本升级到 V4.1.0.1(binary) 版本。
  2. 再将 OceanBase 集群从 V4.1.0.0-100000982023031415 版本升级到 V4.1.0.1（binary）版本。
...
<!--OceanBase 集群版本升级的操作步骤，请参见 [开始升级](100.oceanbase-cluster-version-upgrade/200.start-upgrade.md)。
...
* OceanBase 集群版本升级的相关信息，请参见 [升级概述](100.oceanbase-cluster-version-upgrade/100.upgrade-overview.md)。-->
