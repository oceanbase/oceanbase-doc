...
2. （可选）手动迁移待删除节点上的 Unit。
   ...
   1. 查看当前 Unit 分布，获取待迁移的 Unit 的 ID。
      ...
      * `SVR_IP`：表示该 Unit 所属的节点 IP。
      ...
      有关 `DBA_OB_UNITS` 视图的更多说明，请参见 [DBA_OB_UNITS](../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/22900.o-dba_ob_units-of-sys-tenant.md)。
