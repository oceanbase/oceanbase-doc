...
2. 获取租户的 Zone、Server 及日志流副本信息。
   ...
   有关 `CDB_OB_LS_LOCATIONS` 视图的更多信息，参见 [CDB_OB_LS_LOCATIONS](../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/9300.oceanbase-cdb_ob_ls_locations-of-mysql-mode.md)。
