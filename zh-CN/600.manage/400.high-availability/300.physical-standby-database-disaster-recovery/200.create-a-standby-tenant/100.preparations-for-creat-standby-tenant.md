...
假设主租户的 TENANT_ID 为 1001，备租户待创建的 Unit 个数为 2，计算备租户上每个 Unit 所需的物理资源量的语句如下：

```shell
obclient [oceanbase]> CALL DBMS_OB_LIMIT_CALCULATOR.CALCULATE_MIN_PHY_RES_NEEDED_BY_STANDBY_TENANT(PRIMARY_TENANT_ID => 1001, STANDBY_TENANT_UNIT_NUM => 2);
```
