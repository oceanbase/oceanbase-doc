...
* 不允许在通过 SERVICE_NAME 建立的 Session 中执行 Failover 命令。

* 如果待执行 Failover 命令的租户下有 SERVICE_NAME，则需要删除该租户的 SERVICE_NAME，具体操作参见 [删除服务](../../../200.tenant-management/600.common-tenant-operations/1700.manage-service/500.delete-service.md)。
