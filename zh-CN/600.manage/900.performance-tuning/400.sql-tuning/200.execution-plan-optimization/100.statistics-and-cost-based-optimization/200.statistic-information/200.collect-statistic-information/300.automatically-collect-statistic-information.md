...
3. 调整自动统计信息收集的调度时间。
    ...
    <main id="notice" type='notice'>
      <h4>注意</h4>
      <p>设置各维护窗口的 <code>NEXT_DATE</code> 时，指定的日期必须与窗口名称所代表的星期一致。例如，<code>MONDAY_WINDOW</code> 的 <code>NEXT_DATE</code> 必须设置为周一的日期，<code>FRIDAY_WINDOW</code> 必须设置为周五的日期，以此类推。</p>
    </main>
