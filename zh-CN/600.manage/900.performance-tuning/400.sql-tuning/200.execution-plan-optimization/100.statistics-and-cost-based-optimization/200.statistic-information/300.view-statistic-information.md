...
|Oracle|`ALL_PART_COL_STATISTICS`|用于查询 PARTITION 列级统计信息|
|Oracle|`DBA_PART_COL_STATISTICS`|用于查询 PARTITION 列级统计信息|
|Oracle|`USER_PART_COL_STATISTICS`|用于查询 PARTITION 列级统计信息|
|Oracle| `ALL_SUBPART_COL_STATISTICS`|用于查询 SUBPARTITION 列级统计信息|
|Oracle|`DBA_SUBPART_COL_STATISTICS`|用于查询 SUBPARTITION 列级统计信息|
|Oracle|`USER_SUBPART_COL_STATISTICS`|用于查询 SUBPARTITION 列级统计信息|
|MySQL |`OCEANBASE.DBA_TAB_COL_STATISTICS`| 用于查询 GLOBAL 列级统计信息|
|MySQL|`OCEANBASE.DBA_PART_COL_STATISTICS` |用于查询 PARTITION 列级统计信息|
|MySQL|`OCEANBASE.DBA_SUBPART_COL_STATISTICS` |用于查询 SUBPARTITION 列级统计信息|
...
|Oracle|`ALL_PART_HISTOGRAMS`|用于查询 PARTITION 列级直方图信息|
|Oracle|`DBA_PART_HISTOGRAMS`|用于查询 PARTITION 列级直方图信息|
|Oracle|`USER_PART_HISTOGRAMS`|用于查询 PARTITION 列级直方图信息|
|Oracle| `ALL_SUBPART_HISTOGRAMS`|用于查询 SUBPARTITION 列级直方图信息|
|Oracle|`DBA_SUBPART_HISTOGRAMS`|用于查询 SUBPARTITION 列级直方图信息|
|Oracle|`USER_SUBPART_HISTOGRAMS`|用于查询 SUBPARTITION 列级直方图信息|
|MySQL |`OCEANBASE.DBA_TAB_HISTOGRAMS`| 用于查询 GLOBAL 列级直方图统计信息|
|MySQL|`OCEANBASE.DBA_PART_HISTOGRAMS` |用于查询 PARTITION 列级直方图信息|
|MySQL|`OCEANBASE.DBA_SUBPART_HISTOGRAMS` |用于查询 SUBPARTITION 列级直方图信息|
