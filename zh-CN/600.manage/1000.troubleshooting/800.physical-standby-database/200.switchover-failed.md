...
2. 执行以下命令，查看失败原因。
   ...
   有关视图 `DBA_OB_ROOTSERVICE_EVENT_HISTORY` 的更多说明，参见 [DBA_OB_ROOTSERVICE_EVENT_HISTORY](../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/21300.oceanbase-dba_ob_rootservice_event_history-of-sys-tenant.md)。
