...
1. 执行以下 SQL，查询当前租户 `SWITCHOVER_STATUS` 的状态。
    ...
    有关 `SWITCHOVER_STATUS` 字段中各状态的详细说明，请参见 [DBA_OB_TENANTS](../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/22200.o-dba_ob_tenants-of-sys-tenant.md)。
