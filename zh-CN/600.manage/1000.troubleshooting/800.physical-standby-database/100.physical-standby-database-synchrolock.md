...
2. 根据租户的 `TENANT_ID` 或 `TENANT_NAME` 查询问题租户的基本状态信息，包括租户角色、同步位点等信息。
   ...
   * `RECOVERY_UNTIL_SCN`：表示租户可恢复到的终点，如果值为 `4611686018427387903`，则表示恢复到无穷。
   ...
   有关视图 `DBA_OB_TENANTS` 的更多说明，请参见 [DBA_OB_TENANTS](../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/12300.oceanbase-dba_ob_tenants-of-mysql-mode.md)。
...
2. 确认问题租户是否设置了日志恢复源。
   ...
   *************************** 1. row ***************************
   ...
   有关视图 `CDB_OB_LOG_RESTORE_SOURCE` 和视图 `DBA_OB_LOG_RESTORE_SOURCE` 的更多说明，请参见 [CDB_OB_LOG_RESTORE_SOURCE](../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/9300.cdb_ob_log_restore_source-of-sys-tenant.md) 和 [DBA_OB_LOG_RESTORE_SOURCE](../../../700.reference/700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/13500.dba_ob_log_restore_source-of-oracle-mode.md)。
