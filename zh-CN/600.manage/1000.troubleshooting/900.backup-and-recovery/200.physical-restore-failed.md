...
2. 再次查询视图 `CDB_OB_RESTORE_HISTORY`，获取 `comment` 列的信息。
   ...
   有关视图 `CDB_OB_RESTORE_HISTORY` 的详细介绍，请参见 [CDB_OB_RESTORE_HISTORY](../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/9500.oceanbase-cdb_ob_restore_history-of-sys-tenant.md)。
