...
2. 再次查询视图 `CDB_OB_RESTORE_HISTORY`，获取 `comment` 列的信息。
   ...
   有关视图 `CDB_OB_RESTORE_HISTORY` 的详细介绍，请参见 [CDB_OB_RESTORE_HISTORY](../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/9500.oceanbase-cdb_ob_restore_history-of-mysql-mode.md)。
