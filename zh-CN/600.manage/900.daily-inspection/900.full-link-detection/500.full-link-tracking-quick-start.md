...
如果您希望在进行全面诊断时打印全部结果，可以执行**关闭租户 Trace**操作。
...
2024-01-04 16:54:21,218 [INFO] Sending Collect Shell Command to node 172.30.135.202 ...
...
2024-01-04 16:54:21,317 [INFO] [remote host 172.30.135.202] execute cmd = [mkdir -p /tmp/trace_merged_cache]
2024-01-04 16:54:21,365 [INFO] [remote host 172.30.135.202] execute cmd = [grep '00060e1a-dead-7cbd-5d74-6d64084eccfa' /home/admin/oceanbase/log/*trace.log* > /tmp/trace_merged_cache/00060e1a-dead-7cbd-5d74-6d64084eccfa ]
2024-01-04 16:54:21,412 [INFO] Please wait a moment, download file [/tmp/trace_merged_cache/00060e1a-dead-7cbd-5d74-6d64084eccfa] from server 172.30.135.202 to [analyze_flt_result_20240104165421/172.30.135.202/OBSERVER-00060e1a-dead-7cbd-5d74-6d64084eccfa]
2024-01-04 16:54:21,459 [INFO] [chan 2] Opened sftp connection (server version 3)
Download 172.30.135.202:/tmp/trace_merged_cache/00060e1a-dead-7cbd-5d74-6d64084eccfa
Downloading [====================] 100.0% [9.18 KB ]
2024-01-04 16:54:21,463 [INFO] [chan 2] sftp session closed.
2024-01-04 16:54:21,463 [INFO] [remote host 172.30.135.202] execute cmd = [rm -rf /tmp/trace_merged_cache/OBSERVER-00060e1a-dead-7cbd-5d74-6d64084eccfa]
2024-01-04 16:54:21,469 [INFO] [chan 2] sftp session closed.
2024-01-04 16:54:21,475 [INFO] parse file: analyze_flt_result_20240104165421/172.30.135.202/OBSERVER-00060e1a-dead-7cbd-5d74-6d64084eccfa
2024-01-04 16:54:21,476 [INFO] file:analyze_flt_result_20240104165421/172.30.135.202/OBSERVER-00060e1a-dead-7cbd-5d74-6d64084eccfa trace:00060e1a-dead-7cbd-5d74-6d64084eccfa total:21
...
172.30.135.202) |
| 8  | resolve        | 289 μs       | OBSERVER (172.30.135.202) |
| 9  | rewrite        | 460 μs       | OBSERVER (172.30.135.202) |
| 11 | code_generate  | 126 μs

       | OBSERVER (172.30.135.202) |
| 12 | pc_add_plan    | 59 μs        | OBSERVER (172.30.135.202) |
+----+----------------+--------------+---------------------------+
Tags & Logs:
-------------------------------------
...
+---+------------------------------+-------------+--------------------------+
| 1 | TRACE                        | -           |                          |
| 2 | └─com_query_process          | 2.040 ms    | OBSERVER (172.30.135.202)|
| 3 |   └─mpquery_single_stmt      | 2.026 ms    |                          |
| 4 |     ├─sql_compile            | 1.787 ms    |                          |
| 5 |     │ ├─pc_get_plan          | 5 μs        | OBSERVER (172.30.135.202)|
| 6 |     │ └─hard_parse           | 1.738 ms    |                          |
| 7 |     │   ├─parse              | 57 μs       | OBSERVER (172.30.135.202)|
| 8 |     │   ├─resolve            | 289 μs      | OBSERVER (172.30.135.202)|
| 9 |     │   ├─rewrite            | 460 μs      | OBSERVER (172.30.135.202)|
| 10|     │   ├─optimize           | 531 μs      | OBSERVER (172.30.135.202)|
| 11|     │   ├─code_generate      | 126 μs      | OBSERVER (172.30.135.202)|
| 12|     │   └─pc_add_plan        | 59 μs       | OBSERVER (172.30.135.202)|
| 13|     └─sql_execute            | 179 μs      |                          |
| 14|       ├─open                 | 21 μs       | OBSERVER (172.30.135.202)|
| 15|       ├─response_result      | 80 μs       |                          |
| 16|       │ └─do_local_das_task  | 40 μs       | OBSERVER (172.30.135.202)|
| 17|       └─close                | 42 μs       |                          |
| 18|         ├─close_das_task     | 5 μs        | OBSERVER (172.30.135.202)|
| 19|         └─end_transaction    | 2 μs        | OBSERVER (172.30.135.202)|
+---+------------------------------+-------------+--------------------------+
Tags & Logs:
-------------------------------------
1 -    
