...
在查询中可以为指定列使用函数，如下示例中要求用小写字母表示 `job`。详细信息请参见 [查询中使用操作符和函数](9.use-operators-and-functions-in-queries-1/1.use-arithmetic-operators-in-queries-1.md)。
...
* `WHERE` 条件查询，请参见 [条件查询](../4.query-1/4.conditional-query-1.md)。
