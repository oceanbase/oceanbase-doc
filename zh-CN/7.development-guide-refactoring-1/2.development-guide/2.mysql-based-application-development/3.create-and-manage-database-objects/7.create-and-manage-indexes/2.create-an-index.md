...
本文主要介绍如何在非分区表上创建索引，分区表上索引的创建请参见 [分区表的索引](/zh-CN/7.development-guide-refactoring-1/2.development-guide/2.mysql-based-application-development/3.create-and-manage-database-objects/8.create-and-manage-partition-table/7.partition-table-index.md)。
