...
| [pl](/zh-CN/13.reference-oracle-mode/3.system-configuration-items-2/3.tenant-level-configuration-items-2/32.plsql_v2_compatibility-1-2-3.md)[sql_v2_compatibility](/zh-CN/13.reference-oracle-mode/3.system-configuration-items-2/3.tenant-level-configuration-items-2/32.plsql_v2_compatibility-1-2-3.md) | 用于指定 Oracle 8 的兼容功能。 **说明**  该配置项当前暂不生效。      |
