...
有关租户级配置项的相关信息，请参见 [系统配置项总览](/zh-CN/13.reference-oracle-mode/3.system-configuration-items-2/2.system-configuration-items-overview-5.md)。

有关集群级配置项的相关信息，请参见 《参考指南（MySQL 模式）》文档中的 [系统配置项总览](/zh-CN/12.reference-mysql-mode/3.system-configuration-items-1/2.system-configuration-items-overview-3.md)。
