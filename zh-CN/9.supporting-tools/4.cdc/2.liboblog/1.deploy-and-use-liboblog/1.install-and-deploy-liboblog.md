...
* tests 目录：目录中是一个 liboblog 的简单应用（oblog_tailf），oblog_taif 简介具体参考 [oblog_tailf](/zh-CN/9.supporting-tools/4.cdc/2.liboblog/1.deploy-and-use-liboblog/3.oblog_tailf.md)。tests 目录中包含以下内容：
