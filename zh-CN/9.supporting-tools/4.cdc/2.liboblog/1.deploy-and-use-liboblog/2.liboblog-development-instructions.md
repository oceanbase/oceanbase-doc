...
这里提供一个简单的 demo 展示如何使用 liboblog，详细信息，请参考 [oblog_tailf](/en-US/9.supporting-tools/4.cdc/2.liboblog/1.deploy-and-use-liboblog/3.oblog_tailf.md) 以及 [oblog_tailf 源码](https://github.com/oceanbase/oceanbase/tree/master/src/liboblog/tests)。
**注意**
