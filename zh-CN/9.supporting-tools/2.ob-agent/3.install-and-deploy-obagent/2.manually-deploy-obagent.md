...
1. 修改配置文件，详细信息，参考 [monagent 配置文件说明](/zh-CN/9.supporting-tools/2.ob-agent/2.configuration-reference/2.monagent-configuration-file.md) 和 [KV 配置文件说明](/zh-CN/9.supporting-tools/2.ob-agent/2.configuration-reference/1.kv-configuration-file.md)。
...
1. 配置 Prometheus，详细信息，参考 [Prometheus 配置文件说明](/zh-CN/9.supporting-tools/2.ob-agent/2.configuration-reference/3.prometheus-configuration-file.md)。
