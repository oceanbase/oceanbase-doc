...
更多 `CREATE RESTORE POINT` 的说明信息，请参见 MySQL 模式的 [CREATE RESTORE POINT](../../../10.sql-reference-mysql-mode/6.sql-statement/19.create-restore-point.md) 和 Oracle 模式）的 [CREATE RESTORE POINT](../../../11.sql-reference-oracle-mode/9.sql-statement-1/1.DDL-1/20.create-restore-point-3.md)。
...
更多 `DROP RESTORE POINT` 的说明信息，请参见MySQL 模式的 [DROP RESTORE POINT](../../../10.sql-reference-mysql-mode/6.sql-statement/34.create-restore-point-2.md) 和 Oracle 模式的 [DROP RESTORE POINT](../../../11.sql-reference-oracle-mode/9.sql-statement-1/1.DDL-1/35.drop-restore-point-1.md)。
