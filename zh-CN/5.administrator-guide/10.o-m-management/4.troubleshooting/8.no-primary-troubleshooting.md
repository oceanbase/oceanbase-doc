...
8. 判断是否为 Clog 盘满。
   ...
   有关 Clog 盘满的解决方式，请参见 [节点日志盘（Clog）空间满](/zh-CN/5.administrator-guide/10.o-m-management/5.emergency-response/3.common-emergency-response/2.problems-caused-by-capacity-changes/6.the-node-log-disk-clog-space-is-full.md)。
