...
* 检查当前的网络设施是否异常，如异常考虑下线当前主机，具体操作请参见 [故障 OBServer 节点替换](/zh-CN/5.administrator-guide/10.o-m-management/6.common-o-m-operations/1.service/6.failed-observer-node-replacement.md)。
