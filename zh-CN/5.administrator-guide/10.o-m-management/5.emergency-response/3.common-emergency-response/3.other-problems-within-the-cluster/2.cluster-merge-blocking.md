...
3. 磁盘空间满导致合并卡住，清理腾挪部分磁盘空间。详见 [节点数据盘空间满](/zh-CN/5.administrator-guide/10.o-m-management/5.emergency-response/3.common-emergency-response/2.problems-caused-by-capacity-changes/7.the-node-data-disk-is-full.md)。

   

4. 节点 IO/网卡打满，导致 RPC 失败，合并无法推进，处理方法请参见 [节点磁盘 IO 过高](/zh-CN/5.administrator-guide/10.o-m-management/5.emergency-response/3.common-emergency-response/2.problems-caused-by-capacity-changes/2.the-disk-i-o-of-the-node-is-too-high.md) 和 [节点网卡负载过高](/zh-CN/5.administrator-guide/10.o-m-management/5.emergency-response/3.common-emergency-response/2.problems-caused-by-capacity-changes/3.the-network-interface-controller-is-overloaded.md)。

   

5. RS 出现无主等异常，导致合并失败。更多内容请参见 [SYS租户/RS服务问题](/zh-CN/5.administrator-guide/10.o-m-management/5.emergency-response/3.common-emergency-response/3.other-problems-within-the-cluster/3.service-faq-for-sys-tenants-rs.md)。
