...
* [查看资源单元配置](/zh-CN/5.administrator-guide/2.basic-database-management/3.manage-resources/3.management-resource-unit/1.view-resource-unit-configuration.md)

  

* [修改资源单元的配置](/zh-CN/5.administrator-guide/2.basic-database-management/3.manage-resources/3.management-resource-unit/2.modify-the-configuration-of-a-resource-unit.md)

  

* [删除资源单元](/zh-CN/5.administrator-guide/2.basic-database-management/3.manage-resources/3.management-resource-unit/3.delete-a-resource-unit-1.md)
