...
在进行集群的缩容操作前，需要确认集群中资源对当前负载有较多冗余，通过 OCP 查看集群中资源的详细信息的相关操作请参见 [查看集群的资源信息](/zh-CN/5.administrator-guide/2.basic-database-management/1.manage-clusters/10.view-the-resource-information-of-a-cluster.md)。
...
3. 依次从 3 个 Zone 内减少 1 台 OBServer。
   ...
   通过 OCP 从 Zone 内删除 OBServer 的相关操作请参见 [删除 OBServer](/zh-CN/5.administrator-guide/2.basic-database-management/1.manage-clusters/5.manage-observer/6.delete-observer.md)。
