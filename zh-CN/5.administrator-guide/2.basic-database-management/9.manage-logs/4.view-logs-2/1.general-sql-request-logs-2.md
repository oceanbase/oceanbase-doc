...
为了便于查找目标 SQL 请求日志，您可提前通过设置日志打印级别来减少 SQL 模块之外的日志的打印。有关日志打印级别的相关设置请参见 [设置日志打印级别](/zh-CN/5.administrator-guide/2.basic-database-management/9.manage-logs/2.log-print-level/2.set-log-print-level.md)。
