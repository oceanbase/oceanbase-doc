...
2. 通过以下方式查看用户权限：
   ...
   * 查看用户所拥有的用户级权限。
     ...
     *************************** 1. row ***************************
     ...
     更多 `mysql.user` 视图的字段及说明请参见 [mysql.user](/zh-CN/12.reference-mysql-mode/1.system-view-4/2.dictionary-view-5/40.mysql-user-2.md)。
   ...
   * 查看用户所拥有的数据库级权限。
     ...
     *************************** 1. row ***************************
     ...
     更多 `mysql.db` 视图的字段及说明请参见 [mysql.db](/zh-CN/12.reference-mysql-mode/1.system-view-4/2.dictionary-view-5/30.mysql-db-2.md)。
...
* [用户及权限概述](/zh-CN/5.administrator-guide/2.basic-database-management/4.manage-tenants-1/5.manage-users-and-permissions/1.users-and-permissions/1.users-and-their-permissions-1.md)

  

* [修改用户权限](/zh-CN/5.administrator-guide/2.basic-database-management/4.manage-tenants-1/5.manage-users-and-permissions/3.mysql-3/5.modify-user-permissions-2.md)
