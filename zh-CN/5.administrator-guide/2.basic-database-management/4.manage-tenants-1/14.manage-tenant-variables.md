...
关于 OceanBase 数据库中变量的更多详细介绍信息请参见 [配置管理](/zh-CN/5.administrator-guide/2.basic-database-management/2.configuration-management/1.configuration-management-introduction.md)。
