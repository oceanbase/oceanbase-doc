...
* 创建表时，指定编码格式和压缩方式
  ...
  更多 `CREATE TABLE` 语句的说明请参见 [CREATE TABLE](../../../../11.sql-reference-oracle-mode/9.sql-statement-1/1.DDL-1/24.create-table-1.md)。
...
* 修改表时，更改表的编码格式和压缩方式
  ...
  更多 `ALTER TABLE` 语句的说明请参见 [ALTER TABLE](../../../../11.sql-reference-oracle-mode/9.sql-statement-1/1.DDL-1/10.alter-table-1.md)。
...
3. 更改压缩选项。
   ...
   MySQL 模式下更改压缩选项的操作请参见本节 [MySQL 模式下设置数据的压缩与编码方式](#mysql-模式下设置数据的压缩与编码方式)。

   Oracle 模式下更改压缩选项的操作请参见本节 [Oracle 模式下设置数据的压缩与编码方式](#oracle-模式下设置数据的压缩与编码方式)。
