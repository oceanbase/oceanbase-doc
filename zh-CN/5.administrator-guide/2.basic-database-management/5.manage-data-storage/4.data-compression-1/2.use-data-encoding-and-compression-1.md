...
* 创建表时，指定表的编码格式和压缩方式
  ...
  更多 `CREATE TABLE` 语句的说明请参见 [CREATE TABLE](/zh-CN/10.sql-reference-mysql-mode/6.sql-statement/21.create-table.md)。
...
* 修改表时，更改表的编码格式和压缩方式
  ...
  更多 `ALTER TABLE` 语句的说明请参见 [ALTER TABLE](/zh-CN/10.sql-reference-mysql-mode/6.sql-statement/8.alter-table.md)。
...
* 创建表时，指定编码格式和压缩方式
  ...
  更多 `CREATE TABLE` 语句的说明请参见 [CREATE TABLE](/zh-CN/11.sql-reference-oracle-mode/9.sql-statement-1/1.DDL-1/24.create-table-1.md)。
...
* 修改表时，更改表的编码格式和压缩方式
  ...
  更多 `ALTER TABLE` 语句的说明请参见 [ALTER TABLE](/zh-CN/11.sql-reference-oracle-mode/9.sql-statement-1/1.DDL-1/10.alter-table-1.md)。
...
2. 执行以下语句，设置渐进合并轮次。
   ...
   **说明**
   ...
   如果希望尽快完成数据的重写，可以将 `progressive_merge_num` 的值设置为 `1` 后，手动发起一次合并，手动发起合并的操作请参见 [手动触发合并](/zh-CN/5.administrator-guide/2.basic-database-management/5.manage-data-storage/2.merge-management-1/4.manually-trigger-a-merge-1.md)。
   

3. 更改压缩选项。

   MySQL 模式下更改压缩选项的操作请参见本节 [MySQL 模式下设置数据的压缩与编码方式](#section-nxf-mkm-wpe)。

   Oracle 模式下更改压缩选项的操作请参见本节 [Oracle 模式下设置数据的压缩与编码方式](#section-mj2-2jm-x3i)。
