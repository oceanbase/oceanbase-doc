...
更多合并相关的详细介绍信息，请参见 [合并](/zh-CN/2.concepts-of-oceanbase-database-system/8.storage-architecture-1/3.dump-and-merge-1/3.merge-2.md)。

合并相关的配置项及其说明请参见 [修改合并配置](/zh-CN/5.administrator-guide/2.basic-database-management/5.manage-data-storage/2.merge-management-1/7.modify-a-merge-configuration.md)。
...
合并超时与报错的更多介绍信息，请参见 [合并超时与报错](/zh-CN/5.administrator-guide/2.basic-database-management/5.manage-data-storage/2.merge-management-1/6.merge-timeout-and-error-1.md)。
...
MySQL 租户创建表并指定压缩算法的语法请参见 [CREATE TABLE](/zh-CN/10.sql-reference-mysql-mode/6.sql-statement/21.create-table.md)。Oracle 租户创建表并指定压缩算法的语法请参见 [CREATE TABLE](/zh-CN/11.sql-reference-oracle-mode/9.sql-statement-1/1.DDL-1/24.create-table-1.md)。
