...
更多 `CDB_OB_ARCHIVELOG` 视图的说明，请参见 [CDB_OB_ARCHIVELOG](../../../../7.reference/14.system-reference/4.system-view-for-mysql/2.dictionary-view-5/133.oceanbase-cdb_ob_archivelog.md)。
