...
关于 OceanBase 数据库线程的更多详情，请参见 [线程简介](../../../7.reference/1.oceanbase-database-concepts/12.observer-node-architecture/3.observer-thread-model/1.thread-introduction.md)。
