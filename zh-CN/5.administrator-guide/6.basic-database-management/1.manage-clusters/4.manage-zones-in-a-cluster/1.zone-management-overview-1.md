...
有关 Primary Zone 的更多信息请参见 [Primary Zone](../../../../5.concepts-of-oceanbase-database-system/5.distributed-database-objects/3.data-partitions-and-replicas/5.data-balancing-1/2.leader-equalization/2.primary-zone.md) 。

有关副本的更多信息请参见 [副本概述](../../../8.distributed-storage-management/4.manage-replicas/1.replica-overview-1.md)。
