...
2. 执行以下语句，关闭自动合并开关。
   ...
   关于配置项 `enable_major_freeze` 的更多信息，请参见 [enable_major_freeze](../../../14.system-reference/1.system-configuration-items/3.cluster-level-configuration-items-1/72.enable_major_freeze-1-2.md)。
