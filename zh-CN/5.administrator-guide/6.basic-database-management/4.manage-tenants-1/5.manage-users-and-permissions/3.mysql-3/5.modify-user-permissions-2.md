...
更多 `GRANT` 语句的信息请参见 [GRANT](../../../../../7.reference/2.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/35.GRANT.md)。
...
更多 `REVOKE` 语句的信息请参见 [REVOKE](../../../../../7.reference/2.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/47.REVOKE.md)。
