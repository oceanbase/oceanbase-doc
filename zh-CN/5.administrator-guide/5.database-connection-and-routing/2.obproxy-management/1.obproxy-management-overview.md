...
| [添加 OBProxy](3.obproxy-management/1.add-obproxy.md)               | 您可通过该操作向 OBProxy 集群中添加 OBProxy。                  |
|[启动 OBProxy](3.obproxy-management/2.start-obproxy.md)|您可通过该操作启动 OBProxy。|
| [刷新 OBProxy 配置](3.obproxy-management/3.refresh-obproxy-configuration.md)             | 您可通过该操作刷新 OBProxy 的配置。                           |
|[停止 OBProxy](3.obproxy-management/4.stop-obproxy.md)|您可通过该操作停止 OBProxy。 |
| [删除 OBProxy](3.obproxy-management/6.delete-obproxy.md)                | 您可通过该操作删除集群中的 OBProxy。                           |
| [重启 OBProxy](3.obproxy-management/5.restart-obproxy.md)                | 您可通过该操作重启集群中的 OBProxy。                           |
| [升级 OBProxy](3.obproxy-management/7.upgrade-obproxy.md)                | 您可通过该操作升级集群中的 OBProxy。                           |
