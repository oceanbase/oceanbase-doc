...
查看用户权限的详细操作，参见 [查看用户权限](../../2.basic-database-management/4.manage-tenants-1/5.manage-users-and-permissions/2.oracle-3/4.view-user-permissions.md)。授予用户权限的详细操作，参见 [修改用户权限](../../2.basic-database-management/4.manage-tenants-1/5.manage-users-and-permissions/2.oracle-3/5.modify-user-permissions-1.md)。
