...
创建表时，如果未明确定义表的 Collation 和字符集，则默认使用数据库的字符集和字符序，数据库的 Collation 和字符集的详细介绍信息请参见 [数据库级字符集和字符序](/zh-CN/10.sql-reference-mysql-mode/1.basic-elements/3.character-set-and-collation/4.specify-character-set-and-collation.md)。
...
OceanBase 数据库中表的 Collation 和字符集的详细介绍信息请参见 [表级字符集和字符序](/zh-CN/10.sql-reference-mysql-mode/1.basic-elements/3.character-set-and-collation/5.table-level.md)。
**注意**
...
* 新增列，支持在表中新增列，但不支持直接增加主键列。如果需要增加主键列，建议先增加列后再为列添加主键。添加主键的相关操作请参见 [定义列的约束类型](/zh-CN/5.administrator-guide/4.database-object-management-1/2.mysql-4/2.manage-tables-2/4.define-the-constraint-type-for-a-column-2.md)。
...
* 修改列属性，支持修改列名称和列类型。
  ...
  OceanBase 数据库中 MySQL 模式下列类型的转换规则及详细信息请参见 [列类型变更规则](/zh-CN/10.sql-reference-mysql-mode/7.online-ddl/4.column-type-change-rule-1.md)。
...
* 修改列的 Collation 和字符集。
  ...
  OceanBase 数据库中，列的 Collation 和字符集的详细介绍信息请参见 [列级字符集和字符序](/zh-CN/10.sql-reference-mysql-mode/1.basic-elements/3.character-set-and-collation/6.column-level-character-sets-and-collations.md)。
...
OceanBase 数据库支持更改表的主键、外键及 Check 约束，具体操作及详细说明请参见 [定义列的约束类型](/zh-CN/5.administrator-guide/4.database-object-management-1/2.mysql-4/2.manage-tables-2/4.define-the-constraint-type-for-a-column-2.md)。
...
更多 `ALTER TABLE` 语句的介绍，请参见 [ALTER TABLE](/zh-CN/10.sql-reference-mysql-mode/6.sql-statement/8.alter-table.md)。
