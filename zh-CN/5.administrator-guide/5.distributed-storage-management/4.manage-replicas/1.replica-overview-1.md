...
* 加密投票型副本
  ...
  加密投票型副本仅支持部署在加密 Zone 上，不支持部署在常规读写 Zone上。有关加密 Zone 的详细信息，参见 [增加或删除加密 Zone](/zh-CN/5.administrator-guide/2.basic-database-management/1.manage-clusters/4.manage-zones-in-a-cluster/3.add-or-delete-an-encrypted-zone-1.md)。
