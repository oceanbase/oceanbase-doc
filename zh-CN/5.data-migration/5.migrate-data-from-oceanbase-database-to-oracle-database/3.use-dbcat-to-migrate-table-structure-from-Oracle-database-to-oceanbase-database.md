...
这里以导出 4.0.0 版本的 OceanBase 集群中的 Oracle 租户下 test 的所有对象的结构，并将其迁移到 Oracle 12c 版本下为示例。

```bash
bin/dbcat convert -H 172.30.xxx.xxx  -P 2883 -uroot -pxxxxx -D test --from oboracle40 --to oracle12c --all
```
