...
通过 `MERGE INTO ... INSERT ...` 语句进行表与表之间数据迁移，语法详细信息，请参见 [MERGE](../../7.reference/4.development-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/2.dml-of-oracle-mode/3.merge-of-oracle-mode.md)。
