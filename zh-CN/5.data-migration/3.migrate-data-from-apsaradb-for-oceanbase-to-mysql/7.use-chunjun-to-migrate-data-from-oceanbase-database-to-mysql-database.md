...
OceanBase CDC 组件 libobcdc 和 oblogproxy 提供了拉取 OceanBase 增量 commit log 的能力。chunjun-connector-oceanbasecdc 在内部集成了 oblogclient 来连接 oblogproxy，获取相关的日志数据。

以下将介绍使用 ChunJun 的 Local 模式从 OceanBase 数据库 MySQL 模式迁移数据到 MySQL 数据库。
...
* OceanBase 数据库作为源库配置 json 文件的详细信息，请参见 [OceanBase CDC Source](https://github.com/DTStack/chunjun/blob/master/docs_zh/ChunJun%E8%BF%9E%E6%8E%A5%E5%99%A8/oceanbasecdc/OceanBaseCDC-source.md)。
