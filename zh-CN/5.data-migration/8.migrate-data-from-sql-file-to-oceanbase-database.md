...
有关 OceanBase 数据库 SQL 语法的详细信息，请参见 [SQL 语法（MySQL 模式）](../7.reference/5.sql-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/1.general-syntax-of-mysql-mode.md) 和 [SQL 语法（Oracle 模式）](../7.reference/1.oceanbase-database-concepts/7.user-interface-and-query-language/1.SQL/1.sql-introduction/1.sql-overview.md)。
