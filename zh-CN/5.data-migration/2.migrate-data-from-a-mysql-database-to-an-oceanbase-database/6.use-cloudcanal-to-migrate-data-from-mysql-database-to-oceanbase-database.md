...
CloudCanal 是一款数据迁移同步工具，帮助企业快速构建高质量数据流通通道，分为 [CloudCanal 商业版](https://www.clougence.com/cc-doc/business/intro/product_intro/) 和 [CloudCanal 社区版](https://www.clougence.com/cc-doc/intro/product_intro)。
...
>**功能适用性**
>
>* CloudCanal 社区版从 v2.2.0.7 版本开始支持从 MySQL 数据库迁移数据至 OceanBase 数据库 MySQL 模式。详情请参见 [v2.2.0.7](https://www.clougence.com/cc-doc/releaseNote/rn-cloudcanal-2-2-0-7)。
