...
纯钧（ChunJun，原名 FlinkX）是一款稳定、易用、高效、批流一体的数据集成框架，目前基于实时计算引擎 Flink 实现多种异构数据源之间的数据同步与计算。
...
[admin@k08j13249.eu95sqa /home/admin/lukun_test/chunjun/chunjun-dist]
...
chunjun is starting ...
CHUNJUN_HOME is auto set /home/admin/lukun_test/chunjun/chunjun-dist/chunjun-dist
FLINK_HOME is empty!
