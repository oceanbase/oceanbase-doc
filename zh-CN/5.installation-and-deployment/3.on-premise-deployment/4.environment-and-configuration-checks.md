...
OceanBase 数据库支持 Red Hat Enterprise Linux Server 7.X、CentOS 7.X 和 Anolis OS 8.X 等操作系统。详细信息，参考 [软硬件要求](../3.installation-and-deployment/2.download-installation-packages.md)。
