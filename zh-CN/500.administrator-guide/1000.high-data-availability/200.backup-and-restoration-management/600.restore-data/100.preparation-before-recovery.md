...
2. 创建 Unit（资源单元）。
   ...
   创建资源单元的详细操作及说明请参见 [创建资源单元](../../../600.basic-database-management/300.manage-resources/200.create-a-resource-unit-1.md)。
...
3. 创建 Resource Pool（资源池）。
   ...
   创源资源池的详细操作及说明请参见 [创建资源池](../../../600.basic-database-management/300.manage-resources/400.create-a-resource-pool-1.md)。
...
4. 执行以下语句，设置加密信息。
   ...
   >**说明**
   >
   >`external_kms_info` 用于存储一些密钥管理信息。有关该配置项的详细介绍，请参见 [external_kms_info](../../../../700.reference/500.system-configuration-items/400.tenant-level-configuration-items-1/1100.external_kms_info-1-2-3.md)。
...
[执行全量恢复](../600.restore-data/200.initiate-the-tenant-restore.md)
