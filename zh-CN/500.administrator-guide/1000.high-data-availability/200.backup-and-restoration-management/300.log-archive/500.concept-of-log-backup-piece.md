...
更多 `CDB_OB_ARCHIVELOG_PIECE_FILES` 视图的说明，请参见 [CDB_OB_ARCHIVELOG_PIECE_FILES](../../../../700.reference/300.system-views/200.dictionary-view-5/8600.oceanbase-cdb_ob_archivelog_piece_files.md)。
