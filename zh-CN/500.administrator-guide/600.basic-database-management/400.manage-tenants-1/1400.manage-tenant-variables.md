...
```sql
obclient> SELECT * FROM oceanbase.CDB_OB_SYS_VARIABLES WHERE NAME = 'ob_query_timeout';
```

还可以通过查询以下视图来获取 Session/Global 级别的变量值：
...
更多变量的介绍信息，请参见 [系统变量](../../../700.reference/400.system-variables/100.overview-of-system-variables-3.md) 。
