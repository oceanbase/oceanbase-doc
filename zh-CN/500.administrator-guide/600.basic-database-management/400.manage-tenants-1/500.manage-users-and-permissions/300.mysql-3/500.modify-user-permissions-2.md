...
查看当前拥有权限的操作请参见 [查看用户权限](../300.mysql-3/400.view-user-permissions-1.md)。
...
更多 `GRANT` 语句的信息请参见 [GRANT](../../../../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/3500.GRANT.md)。
...
更多 `REVOKE` 语句的信息请参见 [REVOKE](../../../../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/4700.REVOKE.md)。
