...
2. 通过以下方式查看用户权限：
   ...
   * 查看用户所拥有的用户级权限。
     ...
     *************************** 1. row ***************************
     ...
     更多 `mysql.user` 视图的字段及说明请参见 [mysql.user](../../../../../700.reference/300.system-views/200.dictionary-view-5/4000.mysql-user-2.md)。
   ...
   * 查看用户所拥有的数据库级权限。
     ...
     *************************** 1. row ***************************
     ...
     更多 `mysql.db` 视图的字段及说明请参见 [mysql.db](../../../../../700.reference/300.system-views/200.dictionary-view-5/3000.mysql-db-2.md)。
...
* [用户及权限概述](../100.users-and-permissions/100.users-and-their-permissions-1.md)

* [修改用户权限](../300.mysql-3/500.modify-user-permissions-2.md)
