...
2. 查看转储进度，可以查看转储未完成的数据量及预期完成时间等信息。
   ...
   * `ESTIMATED_FINISH_TIME`：表示预计完成时间。
   ...
   有关 `GV$OB_TABLET_COMPACTION_PROGRESS` 视图中字段的详细介绍，请参见 [GV$OB_TABLET_COMPACTION_PROGRESS](../../../../700.reference/300.system-views/300.performance-view-5/1100.gv-ob_tablet_compaction_progress.md)。

   根据查询结果，对于未出现在该视图中的 Tablet 或长时间未完成的 Tablet，可以进一步查看诊断视图 `GV$OB_COMPACTION_DIAGNOSE_INFO`，确认是否有异常情况出现。
   有关 `GV$OB_COMPACTION_DIAGNOSE_INFO` 视图中字段的详细介绍，请参见 [GV$OB_COMPACTION_DIAGNOSE_INFO](../../../../700.reference/300.system-views/300.performance-view-5/4400.gv-ob_compaction_diagnose_info-1.md)。
...
2. 查看转储历史。
   ...
   *************************** 5. row ***************************
   ...
   有关 `GV$OB_TABLET_COMPACTION_HISTORY` 视图中字段的详细介绍，请参见 [GV$OB_TABLET_COMPACTION_HISTORY](../../../../700.reference/300.system-views/300.performance-view-5/1000.gv-ob_tablet_compaction_history-1.md)。
