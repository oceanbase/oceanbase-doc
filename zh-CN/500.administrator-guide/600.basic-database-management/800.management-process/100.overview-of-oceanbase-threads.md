...
关于 OceanBase 数据库线程的更多详情，请参见 [线程简介](../../../700.reference/100.oceanbase-database-concepts/1200.observer-node-architecture/300.observer-thread-model/100.thread-introduction.md)。
