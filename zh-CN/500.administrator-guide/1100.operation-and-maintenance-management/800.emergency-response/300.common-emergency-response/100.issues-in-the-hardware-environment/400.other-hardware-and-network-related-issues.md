...
对于明确是硬件异常导致的数据库问题，直接替换故障机器即可。详细的操作步骤参见 [故障 OBServer 节点替换](../../../../600.basic-database-management/100.manage-clusters/500.manage-observers/700.replace-observer-1.md)。
