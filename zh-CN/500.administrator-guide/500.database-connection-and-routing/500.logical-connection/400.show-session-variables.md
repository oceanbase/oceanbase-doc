...
* `cs_id` 为 ODP 内部标记的每个 client 的 `id` 号，`connection_id` 为整个 OceanBase 数据库标记的每个 client 的 `id` 号。有关 `CONNECTION_ID` 的详细介绍，请参见 [CONNECTION_ID](../../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/400.functions/600.information-functions/500.CONNECTION_ID.md)。
...
有关系统变量的详细介绍请参见 [系统变量概述](../../../700.reference/400.system-variables/100.overview-of-system-variables-3.md)，有关用户变量设置，请参见 [SET](../../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/5200.SET-1.md)。
