# OBProxy 管理概述
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/obproxy-management-overview-1
...
| [升级 OBProxy 集群下全部 OBProxy](200.manage-obproxy-clusters/400.upgrade-obproxy-all-obproxy-in-the-cluster.md)  | 您可通过该操作升级 OBProxy 集群中所有的 OBProxy。                |
| [重启 OBProxy 集群下的全部 OBProxy](200.manage-obproxy-clusters/500.restarts-all-obproxy-nodes-in-a-obproxy-cluster.md) | 您可通过该操作重启 OBProxy 集群下全部 OBProxy。                 |
| [管理 OBProxy 连接的 OB 集群](200.manage-obproxy-clusters/600.ob-cluster-that-manages-obproxy-connections.md)      | 您可通过 OCP 为 OBProxy 添加可连接的 OB 集群或删除已连接的 OB 集群。    |
| [OBProxy 集群性能监控](200.manage-obproxy-clusters/700.obproxy-cluster-performance-monitoring.md)            | 您可以在 OCP 上查看 OBProxy 集群的性能监控信息，包括了服务监控信息和系统监控信息。 |
| [添加 OBProxy](300.obproxy-management/100.add-obproxy.md)               | 您可通过该操作向 OBProxy 集群中添加 OBProxy。                  |
|[启动 OBProxy](300.obproxy-management/200.start-obproxy.md)|您可通过该操作启动 OBProxy。|
| [刷新 OBProxy 配置](300.obproxy-management/300.refresh-obproxy-configuration.md)             | 您可通过该操作刷新 OBProxy 的配置。                           |
|[停止 OBProxy](300.obproxy-management/400.stop-obproxy.md)|您可通过该操作停止 OBProxy。 |
| [删除 OBProxy](300.obproxy-management/600.delete-obproxy.md)                | 您可通过该操作删除集群中的 OBProxy。                           |
| [重启 OBProxy](300.obproxy-management/500.restart-obproxy.md)                | 您可通过该操作重启集群中的 OBProxy。                           |
| [升级 OBProxy](300.obproxy-management/700.upgrade-obproxy.md)                | 您可通过该操作升级集群中的 OBProxy。                           |
