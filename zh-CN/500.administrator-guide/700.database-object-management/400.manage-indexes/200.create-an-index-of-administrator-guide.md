...
本节主要介绍如何在非分区表上创建索引，分区表上索引的创建请参见 [创建索引](../../../300.developer-guide/200.create-and-manage-database-objects/800.create-and-manage-indexes/200.create-an-index.md) 章节。
