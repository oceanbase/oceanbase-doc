...
创建表时，如果未明确定义表的 Collation 和字符集，则默认使用数据库的字符集和字符序，数据库的 Collation 和字符集的详细介绍信息请参见 [数据库级字符集和字符序](../../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/100.basic-elements/300.character-set-and-collation/400.specify-character-set-and-collation.md)。
...
OceanBase 数据库中表的 Collation 和字符集的详细介绍信息请参见 [表级字符集和字符序](../../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/100.basic-elements/300.character-set-and-collation/500.table-level-character-set-and-collation.md)。
...
* 新增列，支持在表中新增列，但不支持直接增加主键列。如果需要增加主键列，建议先增加列后再为列添加主键。添加主键的相关操作请参见 [定义列的约束类型](../200.manage-tables/400.define-the-constraint-type-for-a-column.md)。
...
* 修改列属性，支持修改列名称和列类型。
  ...
  OceanBase 数据库中 MySQL 模式下列类型的转换规则及详细信息请参见 [列类型变更规则](../../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/700.ddl-function/900.column-type-change-rule-1.md)。。。
...
* 修改列的 Collation 和字符集。
  ...
  OceanBase 数据库中，列的 Collation 和字符集的详细介绍信息请参见 [列级字符集和字符序](../../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/100.basic-elements/300.character-set-and-collation/600.column-level-character-sets-and-collations.md)。
...
OceanBase 数据库支持更改表的主键、外键及 Check 约束，具体操作及详细说明请参见 [定义列的约束类型](../200.manage-tables/400.define-the-constraint-type-for-a-column.md)。
