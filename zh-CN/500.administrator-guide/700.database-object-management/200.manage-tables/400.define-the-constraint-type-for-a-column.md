...
* 外键约束（`FOREIGN KEY`）：要求约束的列的值取自于另外一个表的主键列。
  ...
  更多 `foreign_key_checks` 变量的说明，请参见 [foreign_key_checks](../../../7.reference/4.system-variables/27.foreign_key_checks-1-2-3.md)。
...
更多创建约束的语法及详细介绍请参见 [CREATE TABLE](2.create-a-table.md)。
...
更多创建约束的语法及详细介绍请参见 [ALTER TABLE](6.change-table.md)。
