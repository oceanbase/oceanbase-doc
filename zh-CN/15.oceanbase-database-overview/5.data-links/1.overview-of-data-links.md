...
有关数据库代理的详细内容，请参见 [数据库](2.database-proxy/1.proxy-overview.md)[代理](2.database-proxy/1.proxy-overview.md)。
...
有关数据库驱动的详细内容，请参见 [数据库驱动](3.database-drivers/1.overview-of-database-drivers.md)。
