...
<main id="notice" type='notice'>
  ...
  <li>这里的版本号可能不是最新的，参考<a href="[./4.replace-data-of-mysql-mode.md](http://mvnrepository.com/artifact/com.oceanbase/obkv-hbase-client)">中央仓库</a>的已发布 OBKV-HBase 版本，将版本号替换为已发布的最新版本号。</li>
  </ul>
</main>
