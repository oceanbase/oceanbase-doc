...
1. 通过 `EXPLAIN` 命令查看执行计划形状，或者通过实时执行计划展示查看缓存执行计划。详细信息请参见 [SQL 执行计划简介](../../../../11.sql-tuning-guide/2.sql-execution-plan/1.introduction-to-sql-execution-plan.md)和 [实时执行计划展示](t1962412.html#topic-1962412)。
