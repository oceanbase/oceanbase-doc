...
您可以通过 RPM 包或源代码安装 oblogproxy。更多信息，参考 [使用源码构建 oblogproxy](/en-US/9.ecological-tools/4.CDC/3.oblogproxy/1.installation-and-deployment-2/1.installation-and-deployment-1.md)。
...
部署 Canal Adapter， 参考[部署 RDB 适配器](/en-US/7.developer-guide-1/5.migrate-data-to-oceanbase/4.use-canal-to-incrementally-migrate-data-to-oceanbase-database.md) **。** 
