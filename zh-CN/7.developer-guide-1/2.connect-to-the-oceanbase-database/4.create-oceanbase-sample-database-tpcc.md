...
默认情况 OceanBase 没有创建示例数据库 TPCC，需要手动创建。示例数据库必须在业务租户下创建。有关示例数据库介绍请参考 [关于示例数据库 TPCC](/en-US/7.developer-guide-1/1.preface-2/4.about-the-sample-database-tpcc-2.md)。 
