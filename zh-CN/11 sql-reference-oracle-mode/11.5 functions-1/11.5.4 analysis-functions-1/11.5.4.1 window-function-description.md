...
analytic_clause {#analytic-clause}
----------------------------------
...
query_partition_clause {#query-partition-clause}
------------------------------------------------
...
### value_expr PRECEDING 或 value_expr FOLLOWING 关键字 {#e8369408}
