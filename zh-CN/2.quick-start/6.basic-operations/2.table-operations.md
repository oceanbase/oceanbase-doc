...
更多 `CREATE TABLE` 语句相关的语法说明请参见《SQL 参考》中 [CREATE TABLE](../../10.sql-reference/5.sql-statements/19.create-table.md)章节。
...
更多 `ALTER TABLE` 语句相关的语法说明请参见《SQL 参考》中 [ALTER TABLE](../../10.sql-reference/5.sql-statements/7.alter-table.md) 章节。
...
更多 `DROP TABLE` 语句相关的语法说明请参见《SQL 参考》中 [DROP TABLE](../../10.sql-reference/5.sql-statements/33.drop-table.md)章节。
