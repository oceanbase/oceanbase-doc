...
```test
docker exec -it oceanbase-ce ob-mysql sys # 连接 sys 租户的 root 用户
docker exec -it oceanbase-ce ob-mysql root # 连接 test 租户的 root 用户
docker exec -it oceanbase-ce ob-mysql test # 连接 test 租户的 test 用户
```
