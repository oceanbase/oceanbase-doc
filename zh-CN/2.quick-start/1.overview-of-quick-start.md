...
1. [使用 Docker 部署 OceanBase 数据库](../2.quick-start/2.use-docker-to-deploy-oceanbase-database.md)

2. [使用 OBD 部署 OceanBase 数据库](../2.quick-start/4.use-obd-to-deploy-oceanbase-database.md)

3. [OceanBase 数据库通用问题排查方法](../2.quick-start/5.troubleshoot-general-oceanbase-database-issues.md)
