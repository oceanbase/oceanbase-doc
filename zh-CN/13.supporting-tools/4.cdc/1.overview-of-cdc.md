...
关于如何部署和使用 obcdc，详细信息请参考 [obcdc 安装部署](2.liboblog/1.deploy-and-use-liboblog/1.install-and-deploy-liboblog.md) 和 [obcdc 开发说明](2.liboblog/1.deploy-and-use-liboblog/2.liboblog-development-instructions.md)。
