...
* 销毁 obcdc 实例：通过 `ObLogFactory::construct_oblog()` 销毁 obcdc 实例，此后，不能再访问第一步拿到的 obcdc 实例的指针。
...
这里提供一个简单的 demo 展示如何使用 obcdc，详细信息，请参考 [obcdc_tailf](3.oblog_tailf.md) 以及 [obcdc_tailf 源码](https://github.com/oceanbase/oceanbase/tree/master/tools/obcdc/tests)。
