...
有关 OB-ODBC 驱动的详细介绍，请参见 [OB-ODBC 驱动](../6.driver-management-1/2.ob-odbc-driver.md)。

## OBCI 驱动

OBCI 驱动是兼容 Oracle 数据库 OCI 接口的 C 语言的驱动。基于 Oracle OCI 开发的用户和应用可以使用 OBCI 驱动，平滑的迁移使用 OceanBase 数据库的 Oracle 模式。

有关 OBCI 驱动的详细介绍，请参见 [OBCI 驱动](../6.driver-management-1/3.obci-driver.md)。
...
有关 OceanBase Connector/C 的详细介绍，请参见 [OceanBase Connector/C](../6.driver-management-1/4.oceanbase-connector-c.md)。
...
有关 OceanBase Connector/J 驱动的详细介绍，请参见 [OceanBase Connector/J](../6.driver-management-1/5.oceanbase-connector-j.md)。
