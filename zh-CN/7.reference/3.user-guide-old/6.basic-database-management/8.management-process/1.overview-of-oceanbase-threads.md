...
关于 OceanBase 数据库线程的更多详情，请参见 [线程简介](../../../5.concepts-of-oceanbase-database-system/12.observer-node-architecture/3.observer-thread-model/1.thread-introduction.md)。
