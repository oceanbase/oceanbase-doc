...
2. 执行以下语句，确认当前磁盘已经预分配的空间。
   ...
   `GV$OB_SERVERS` 视图的更多字段说明，请参见 [oceanbase.GV$OB_SERVERS](../../../5.system-reference/4.system-view-of-mysql-mode/3.performance-view-of-mysql-mode/9.gv-ob_servers-of-mysql-mode.md)。
...
* [datafile_size](../../../5.system-reference/1.system-configuration-items/3.cluster-level-configuration-items/54.datafile_size.md)
* [datafile_disk_percentage](../../../5.system-reference/1.system-configuration-items/3.cluster-level-configuration-items/53.datafile_disk_percentage.md)
* [datafile_next](待补充)
* [datafile_maxsize](待补充)
