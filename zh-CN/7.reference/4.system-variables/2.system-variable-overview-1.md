...
| [ob_enable_hash_group_by](69.ob_enable_hash_group_by-1-2-3.md)         | 用于设置是否打开 Hash Group by 的路径。                   |
| [ob_enable_blk_nestedloop_join](68.ob_enable_blk_nestedloop_join-1-2-3.md)   | 用于设置是否允许打开 Block Nested Loop Join。            |
