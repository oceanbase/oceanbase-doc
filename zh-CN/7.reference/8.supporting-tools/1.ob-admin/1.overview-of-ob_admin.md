...
ob_admin 提供了 slog_tool、archive_tool、log_tool、dumpsst 和 dump_backup 功能，主要用于排查数据不一致、丢数据、错误数据等问题。下面分别从各个子功能来简要介绍一下 ob_admin。
...
具体用法请参见 [log_tool](../1.ob-admin/3.clog/3.clog_tool.md)。
