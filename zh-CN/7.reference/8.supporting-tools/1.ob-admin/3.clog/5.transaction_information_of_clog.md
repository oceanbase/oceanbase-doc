...
对于事务类型的详细说明，请参考 [本地事务](../../../1.oceanbase-database-concepts/8.transaction-management-1/1.transaction-2/7.local-transaction-1.md)、[分布式事务](../../../1.oceanbase-database-concepts/8.transaction-management-1/1.transaction-2/8.distributed-transactions-1/1.overview-of-distributed-transactions.md)。
