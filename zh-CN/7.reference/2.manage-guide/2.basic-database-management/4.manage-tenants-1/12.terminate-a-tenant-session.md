...
更多 `KILL` 语句的使用和说明，请参见 MySQL 模式的 [KILL](../../../10.sql-reference-mysql-mode/6.sql-statement/47.KILL.md) 和 Oracle 模式的 [KILL](../../../4.development-guide-refactoring-1/6.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/3.DCL/8.KILL-1.md)。
