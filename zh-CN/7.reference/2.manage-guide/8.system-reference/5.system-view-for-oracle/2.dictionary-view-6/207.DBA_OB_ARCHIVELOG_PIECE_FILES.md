...
| CREATE_TIMESTAMP | NUMBER(38) | NO | Piece 创建时间 |
...
| BASE_SCN | NUMBER(38) | NO | Piece 理论上的开始位点，第一个 Piece：base_scn≠start_scn；非第一个 Piece：base_scn=start_scn |
| START_SCN | NUMBER(38) | NO | Piece 实际开始位点 |
...
| COMPATIBLE | NUMBER(38) | NO | 日志备份的兼容版本号 |
