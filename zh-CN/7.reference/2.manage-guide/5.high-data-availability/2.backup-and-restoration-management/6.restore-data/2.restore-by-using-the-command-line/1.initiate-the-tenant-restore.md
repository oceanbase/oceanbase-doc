# 执行全量恢复
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/initiate_the_tenant_restore
...
2. 执行以下语句，开始执行恢复任务。
   ...
   * 恢复到最新位点
   ...
   语句中各参数的详细说明请参见 [恢复参数](6.parameters-of-the-restore.md)。
   ...
   * OSS
   ...
   发起恢复任务后，您可以通过视图查看恢复的进度和结果，具体操作请参见 [查看恢复进度](3.view-the-restore-progress.md)。
