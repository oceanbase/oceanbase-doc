# 转储
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/dump-1
...
>**说明**
>
>`memstore_limit_percentage` 用于设置租户使用 Memstore 的内存占其总可用内存的百分比。有关该配置项的详细介绍，请参见 [memstore_limit_percentage](../../../3.user-guide/14.system-reference/1.system-configuration-items/3.cluster-level-configuration-items-1/139.memstore_limit_percentage-1-2-3.md)。
...
更多转储操作请参见 [转储](../../../3.user-guide/6.basic-database-management/5.manage-data-storage/1.dump-management-1/1.dump-management-overview-1.md)。
