...
有关 OceanBase Connector/J 的详细介绍，请参见 [OceanBase Connector/J](../3.database-driver/3.oceanbase-connector-j-1.md)。
...
有关 OceanBase Connector/C 的详细介绍，请参见 [OceanBase Connector/C](../3.database-driver/4.oceanbase-connector-c-1.md)。
