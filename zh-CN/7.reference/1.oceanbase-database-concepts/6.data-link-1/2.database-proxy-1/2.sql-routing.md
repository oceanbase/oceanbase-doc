# SQL 路由
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/sql-routing
...
开始阅读本节内容之前，您可以先了解一些路由相关的概念（参见 [附录：OceanBase 数据库基础概念](../../../1.oceanbase-database-concepts/13.appendix-basic-concepts-of-oceanbase-databases.md)），便于您更好的了解下面的内容。
