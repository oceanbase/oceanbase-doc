...
obclient> ALTER RESOURCE POOL rp1 UNIT_NUM 1 DELETE UNIT = (1001, 1003); // 指定 Unit 调小 unit_num
...
obclient> ALTER RESOURCE TENANT tt UNIT_NUM = 3; // 同时调大两个 resource pool 的 unit_num。暂不支持
```
