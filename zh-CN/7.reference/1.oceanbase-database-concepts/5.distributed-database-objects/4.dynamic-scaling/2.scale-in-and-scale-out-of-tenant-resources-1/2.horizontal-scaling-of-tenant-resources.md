...
obclient> ALTER RESOURCE POOL rp1 UNIT_NUM 3; // 调大 unit num
obclient> ALTER RESOURCE POOL rp1 UNIT_NUM 2; // 调小 unit num
obclient> ALTER RESOURCE POOL rp1 UNIT_NUM 1 DELETE UNIT = (1001, 1003); // 指定 Unit 调小 unit num
...
obclient> ALTER RESOURCE TENANT tt UNIT_NUM = 3; // 同时调大两个 resource pool 的 unit num。暂不支持
```
