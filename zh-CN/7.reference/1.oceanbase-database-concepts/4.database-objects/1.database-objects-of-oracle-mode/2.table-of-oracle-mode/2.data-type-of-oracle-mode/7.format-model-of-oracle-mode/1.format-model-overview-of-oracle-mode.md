...
* [数字格式模型](../7.format-model-of-oracle-mode/2.digital-format-model-of-oracle-mode.md)

* [日期时间格式模型](../7.format-model-of-oracle-mode/2.digital-format-model-of-oracle-mode.md)
