...
在开始配置 cgroups 前，建议您了解 cgroups 的概念，有关 cgroups 的介绍信息请参见 [资源隔离概述](../1.resource-isolation-overview.md)。
...
cgroup 系统目录配置成功后，即可部署 OceanBase 数据库。 OceanBase 数据库的详细安装操作请参见 [部署数据库](../../../2.deploy-the-oceanbase-database/1.deployment-introduction.md)。
...
3. 重新启动 observer 进程。
   ...
   您需要停止 observer 进程后再重新启动 observer 进程，具体操作请参见 [停止或启动 OBServer](../../../2.basic-database-management/1.manage-clusters/5.manage-observer/3.stop-or-start-observer.md)。
...
* [配置用户级资源隔离](2.resource-isolation-at-user-level-for-mysql-mode.md)

* [配置 SQL 级资源隔离](3.resource-isolation-at-sql-level-for-mysql-mode.md)

## 相关文档

[清除 cgroup 配置](8.clear-cgroup-configuration-of-enterprise-for-mysql-mode.md)
