...
在开始配置 cgroups 前，建议您了解 cgroups 的概念，有关 cgroups 的介绍信息请参见 [概述](../1.resource-isolation-overview.md)。
...
3. 重新启动 observer 进程。
   ...
   您需要停止 observer 进程后再重新启动 observer 进程，具体操作请参见 [停止或启动 OBServer](../../../5.basic-database-management/1.manage-clusters/5.manage-observer/3.stop-or-start-observer.md)。
