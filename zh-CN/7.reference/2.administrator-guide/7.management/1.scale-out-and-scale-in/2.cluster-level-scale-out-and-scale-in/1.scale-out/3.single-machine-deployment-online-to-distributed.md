...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>您也可以通过向 Zone 里添加 OBServer 节点的方式进行单机转分布式部署，即单副本多节点的部署模式。详细信息请参见 <a href="../../../7.reference/2.administrator-guide/7.o-m-management/1.scale-out-and-scale-in/2.cluster-level-scale-out-and-scale-in/1.scale-out/2.add-an-observer-node-to-a-zone.md">向 Zone 内添加 OBServer 节点</a>。</p>
</main>
...
* 服务器已完成相关配置。有关配置服务器详细信息，请参见 [服务器配置](../2.preparations-before-deployment/2.server-configuration.md)。
