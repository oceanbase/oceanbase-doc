...
* 查看集群中资源的分配情况，了解集群中资源的使用情况。
  ...
  查看集群节点的资源总量和分配状态的相关操作请参见 [查看集群的资源信息](../../../6.basic-database-management/1.manage-clusters/10.view-the-resource-information-of-a-cluster.md)。
...
* `resource_hard_limit`：是一个配置项的值。
  ...
  更多配置项 `resource_hard_limit` 的说明信息请参见 [resource_hard_limit](../../../../7.reference/14.system-reference/1.system-configuration-items/3.cluster-level-configuration-items-1/168.resource_hard_limit-1-2-3.md)。
...
更多 `DBA_OB_UNIT_CONFIGS` 视图的字段及说明信息请参见 [DBA_OB_UNIT_CONFIGS](../../../../7.reference/14.system-reference/4.system-view-for-mysql/2.dictionary-view-5/60.oceanbase-dba_ob_unit_configs.md)。
