...
2. 执行以下语句，查看集群所有租户的归档历史信息。
   ...
   ```sql
   obclient> SELECT * FROM oceanbase.CDB_OB_ARCHIVELOG_SUMMARY\G
   *************************** 1. row ***************************
                      TENANT_ID: 1002
                        DEST_ID: 2
                       ROUND_ID: 2
...
更多 `CDB_OB_ARCHIVELOG_SUMMARY` 视图的说明，请参见 [CDB_OB_ARCHIVELOG_SUMMARY](../../../../5.system-reference/4.system-view-of-mysql-mode/2.dictionary-view-of-mysql-mode/135.oceanbase-cdb_ob_archivelog_summary-of-mysql-mode.md)。
...
2. 执行以下语句，查看本租户的日志归档历史。
   ...
   ```sql
   obclient> SELECT * FROM oceanbase.DBA_OB_ARCHIVELOG_SUMMARY\G
   *************************** 1. row ***************************
                        DEST_ID: 2
                       ROUND_ID: 2
                    INCARNATION: 1
