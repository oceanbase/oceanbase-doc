...
更多 `CDB_OB_ARCHIVELOG_SUMMARY` 视图的说明，请参见 [CDB_OB_ARCHIVELOG_SUMMARY](../../../../14.system-reference/4.system-view-for-mysql/2.dictionary-view-5/135.oceanbase-cdb_ob_archivelog_summary.md)。
