...
更多 `CDB_OB_ARCHIVELOG_PIECE_FILES` 视图的说明，请参见 [CDB_OB_ARCHIVELOG_PIECE_FILES](../../../../14.system-reference/4.system-view-for-mysql/2.dictionary-view-5/86.oceanbase-cdb_ob_archivelog_piece_files.md)。
