...
2. 查看数据备份进度。
  ...
  上面的示例中，租户 ID 为 `1002` 的租户正在进行数据备份，其备份目的端为 `file:///data/nfs/backup/data` , 当前的数据备份状态为 `DOING`。
   ...
   更多 `CDB_OB_BACKUP_JOBS` 和 `CDB_OB_BACKUP_TASKS` 视图的说明，请参见 [CDB_OB_BACKUP_JOBS](../../../../14.system-reference/4.system-view-for-mysql/2.dictionary-view-5/119.oceanbase-cdb_ob_backup_jobs.md) 和 [CDB_OB_BACKUP_TASKS](../../../../14.system-reference/4.system-view-for-mysql/2.dictionary-view-5/123.oceanbase-cdb_ob_backup_tasks.md)。
