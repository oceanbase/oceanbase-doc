...
更多 `FLASHBACK` 语句的说明信息，请参见 MySQL 模式中的 [FLASHBACK](../../../4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/34.flashback-database-of-mysql-mode.md) 和 Oracle 模式中的 [FLASHBACK TABLE BEFORE DROP](../../../4.development-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/3.dcl-of-oracle-mode/6.flashback-table-before-drop-of-oracle-mode.md)。
