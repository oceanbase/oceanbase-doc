...
* `data_type`：待修改的列的数据类型。
  ...
  关于数据类型的更多介绍，请参见 [数据类型概述](../../../../4.development-reference1.sql-syntax/2.common-tenant-of-mysql-mode/1.basic-elements-of-mysql-mode/1.data-type-of-mysql-mode/1.data-type-overview-of-mysql-mode.md)。
