...
更多创建约束的语法及详细介绍请参见 [CREATE TABLE](../../../../4.development-guide-refactoring/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/16.create-table-of-mysql-mode.md)。
...
更多创建约束的语法及详细介绍请参见 [ALTER TABLE](../../../../4.development-guide-refactoring/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/6.alter-table-of-mysql-mode.md)。
