...
更多 `CREATE SEQUENCE` 语句的信息，请参见 [CREATE SEQUENCE](../../../4.development-guide-refactoring/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/15.create-sequence-of-mysql-mode.md)。
...
更多 `ALTER SEQUENCE` 语句的信息，请参见 [ALTER SEQUENCE](../../../4.development-guide-refactoring/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/5.alter-sequence-of-mysql-mode.md)。
...
更多 `DROP SEQUENCE` 语句的信息，请参见 [DROP SEQUENCE](../../../4.development-guide-refactoring/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/29.drop-sequence-of-mysql-mode.md)。
