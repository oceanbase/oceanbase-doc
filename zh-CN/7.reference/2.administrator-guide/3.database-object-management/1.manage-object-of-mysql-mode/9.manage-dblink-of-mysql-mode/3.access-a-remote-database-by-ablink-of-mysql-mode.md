...
* MySQL 模式下，支持通过 DBLink 访问的数据类型如下：
  ...
  * 其他类型：ENUM、SET
  ...
  有关各数据类型的详细介绍及说明，请参见 [数据类型概述](../../../../4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/1.basic-elements-of-mysql-mode/1.data-type-of-mysql-mode/1.data-type-overview-of-mysql-mode.md)。

## 前提条件

已创建 DBLink，创建 DBLink 的详细操作，参见 [创建 DBLink](1.create-a-dblink-of-mysql-mode.md)。
...
更多 DBLink 相关的查询语句，参见 [SELECT 语句](../../../../4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/81.select-of-mysql-mode/1.select-of-mysql-mode.md)。
