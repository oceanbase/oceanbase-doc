...
* 为表的每个列选择合适的 SQL 数据类型。
  ...
  有关 SQL 数据类型的详细描述，请参见 [数据类型](../../../../7.reference/6.sql-syntax/3.common-tenant-oracle-mode/3.basic-elements-1/2.data-type-comparison-rules/1.overview-of-data-type-comparison-rules.md)。
