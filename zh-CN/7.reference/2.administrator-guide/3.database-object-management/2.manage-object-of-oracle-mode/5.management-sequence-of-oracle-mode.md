...
更多 `CREATE SEQUENCE` 语句的信息，请参见 [CREATE SEQUENCE](../../../7.reference/6.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/22.create-sequence.md) 。
...
* 更多 DBA_SEQUENCES 视图的字段及说明信息请参见 [DBA_SEQUENCES](../../../7.reference/14.system-reference/5.system-view-for-oracle/2.dictionary-view-6/98.DBA_SEQUENCES-1.md)。

* 更多 ALL_SEQUENCES 视图的字段及说明信息请参见 [ALL_SEQUENCES](../../../7.reference/14.system-reference/5.system-view-for-oracle/2.dictionary-view-6/25.ALL_SEQUENCES-1.md)。

* 更多 USER_SEQUENCES 视图的字段及说明信息请参见 [USER_SEQUENCES](../../../7.reference/14.system-reference/5.system-view-for-oracle/2.dictionary-view-6/167.USER_SEQUENCES-1.md)。
...
更多 `ALTER SEQUENCE` 语句的信息，请参见 [ALTER SEQUENCE](../../../7.reference/6.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/6.alter-sequence.md)。
