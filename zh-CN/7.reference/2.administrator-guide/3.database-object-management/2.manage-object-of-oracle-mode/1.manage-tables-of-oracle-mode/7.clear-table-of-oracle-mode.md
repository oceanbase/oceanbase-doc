# 清空表
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/clear-table-1
...
执行 `TRUNCATE TABLE` 语句需要具备该表的删除和创建权限。查看权限和授予权限的相关操作请参见 [修改用户权限](../../../2.basic-database-management/4.manage-tenants/5.manage-users-and-permissions/2.oracle-mode/5.modify-the-user-permissions-of-oracle-mode.md)。
