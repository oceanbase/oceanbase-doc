...
* 外键约束（`FOREIGN KEY`）：要求约束的列的值取自于另外一个表的主键列。
  ...
  更多 `foreign_key_checks` 变量的说明，请参见 [foreign_key_checks](../../../../7.reference/14.system-reference/3.system-variable-for-oracle/27.foreign_key_checks-1-2-3-4.md)。
...
更多创建约束的语法及详细介绍请参见 [CREATE TABLE](../../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/16.create-table.md)。
...
更多创建约束的语法及详细介绍请参见 [ALTER TABLE](../../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/6.alter-table.md)。
