# 管理序列
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/management-sequence
...
更多 `CREATE SEQUENCE` 语句的信息，请参见 [CREATE SEQUENCE](../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/15.create-sequence-1.md)。
...
更多 `ALTER SEQUENCE` 语句的信息，请参见 [ALTER SEQUENCE](../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/5.alter-sequence-2.md)。
...
更多 `DROP SEQUENCE` 语句的信息，请参见 [DROP SEQUENCE](../../../7.reference/6.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/37.drop-sequence.md)。
