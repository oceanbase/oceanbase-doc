# OBCI 驱动
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/obci-driver
...
obci 使用的是原 oci 的头文件，如果机器之前已经装有 oci 头文件，可以直接使用原来的 oci 头文件。
...
-lobci -Wl,-rpath /u01/obclient/lib/ -o ob_oci_test.out
```
...
有关 OBCI 的详细介绍和使用说明，请参见 [OceanBase C 语言调用接口](https://www.oceanbase.com/docs/enterprise-obci-cn-10000000000785771)。
