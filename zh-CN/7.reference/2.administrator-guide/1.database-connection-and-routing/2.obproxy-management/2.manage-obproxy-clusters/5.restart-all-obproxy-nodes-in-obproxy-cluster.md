...
您可以通过 OCP 或 OBD 重启 OBProxy 集群下的全部 OBProxy。
...
<main id="notice" type='explain'>
  <h4>适用性说明</h4>
  <p>目前仅社区版 OceanBase 数据库可以通过 OBD 重启 OBProxy 集群下全部 OBProxy。</p>
</main>
...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>上述步骤中使用的到 OBD 命令，详细信息可参考 <a href="https://www.oceanbase.com/docs/community-obd-cn-10000000001031933">集群命令组</a>。</p>
</main>
