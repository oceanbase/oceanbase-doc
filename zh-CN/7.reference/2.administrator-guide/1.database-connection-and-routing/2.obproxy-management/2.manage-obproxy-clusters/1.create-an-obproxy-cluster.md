...
4. 在 **创建 OBProxy 集群** 页面填写如下信息：
   ...
   3. 打开 **参数设置** ， 添加或修改启动参数，参数说明参见 [OBProxy 参数说明](../4.odp-cluster-parameters.md)。
