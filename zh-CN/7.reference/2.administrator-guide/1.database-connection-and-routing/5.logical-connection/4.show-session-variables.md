...
有关系统变量的详细介绍请参见 [系统变量概述（MySQL 模式）](../../../7.reference/14.system-reference/2.system-variable-for-mysql/1.overview-of-system-variables-3.md) 和 [系统变量概述（Oracle 模式）](../../../7.reference/14.system-reference/3.system-variable-for-oracle/1.overview-of-system-variables-4.md)。有关用户变量设置，请参见 [SET](../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/52.SET-1.md)。
