...
* 与 `KILL connection_id` 的作用一致。有关 `KILL` 语句的详细介绍，请参见 [KILL（MySQL 模式）](../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/38.KILL.md) 或 [KILL（Oracle 模式）](../../../7.reference/6.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/3.DCL/8.KILL-1.md)。
