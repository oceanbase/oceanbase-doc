...
>**功能适用性**
>
>目前 OceanBase 数据库社区版暂不支持设置行级访问权限功能
...
4. 创建策略 `MY_POLICY`。有关创建新的标签安全策略的详细信息，请参见 [SA_SYSDBA.CREATE_POLICY](../../4.development-guide-refactoring/3.pl-reference/3.pl-oracle/13.pl-label-security-package/2.sa_sysdba-policy-management-package/3.sa_sysdba-create_policy.md)
)。
...
1. 创建级别 Level 并指定其短名称和长名称。有关创建级别的详细信息，请参见 [SA_COMPONENTS.CREATE_LEVEL](../../4.development-guide-refactoring/3.pl-reference/3.pl-oracle/13.pl-label-security-package/3.sa_components-tag-package/3.sa_components-create_level.md)。
...
2. 创建创建数据标签 Label 并查看结果。有关创建数据标签的详细信息，请参见 [SA_LABEL_ADMIN.CREATE_LABEL](../../4.development-guide-refactoring/3.pl-reference/3.pl-oracle/13.pl-label-security-package/4.sa_label_admin-tag-management-pack/3.sa_label_admin-create_label.md)。
...
3. 指定用户的 Label。
   ...
   2. 以安全管理员 `LBACSYS` 登录，为用户 `user1` 指定 Label。有关为用户指定标签的详细信息，请参见 [SA_USER_ADMIN.SET_LEVELS](../../4.development-guide-refactoring/3.pl-reference/3.pl-oracle/13.pl-label-security-package/6.sa_user_admin-user-tag-management-pack/2.sa_user_admin-set_levels.md)。
...
4. 应用策略到表上。
   ...
   2. 以安全管理员 `LBACSYS` 登录，将策略 `MY_POLICY` 应用到表 `tbl1` 上。有关将指定的策略添加到表中的详细信息，请参见 [SA_POLICY_ADMIN.APPLY_TABLE_POLICY](../../4.development-guide-refactoring/3.pl-reference/3.pl-oracle/13.pl-label-security-package/5.sa_policy_admin-policy-management-packs/2.sa_policy_admin-apply_table_policy.md)。
...
5. 插入数据，验证查询结果。
   ...
   2. 在 `user1` 用户下设置 `SESSION LABEL` 和 `ROW LABEL`。有关设置当前数据库会话的标签的详细信息，请参见 [SA_SESSION.SET_LABEL](../../4.development-guide-refactoring/3.pl-reference/3.pl-oracle/13.pl-label-security-package/7.sa_session-session-management-pack/5.sa_session-set_label.md)；有关设置当前数据库会话的默认行标签值，请参见 [SA_SESSION.SET_ROW_LABEL](../../4.development-guide-refactoring/3.pl-reference/3.pl-oracle/13.pl-label-security-package/7.sa_session-session-management-pack/6.sa_session-set_row_label.md)。
