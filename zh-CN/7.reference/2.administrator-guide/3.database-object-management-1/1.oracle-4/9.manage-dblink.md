...
更多 DBLink 相关的查询语句，请参见 [SIMPLE SELECT](../../../4.development-guide-refactoring-1/6.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/2.DML/5.SELECT-1/1.simple-select.md)。
