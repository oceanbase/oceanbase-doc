...
更多变量的介绍信息，请参见 [系统变量（MySQL 模式）](../../../7.reference/14.system-reference/2.system-variable-for-mysql/1.overview-of-system-variables-3.md) 和 [系统变量（Oracle 模式）](../../../7.reference/14.system-reference/3.system-variable-for-oracle/1.overview-of-system-variables-4.md)。
