...
3. 执行以下命令，查看集群内各 Server 的资源分配情况。
   ...
   *************************** 3. row ***************************
   ...
   更多视图 `oceanbase.GV$OB_SERVERS` 的说明信息请参见 [GV$OB_SERVERS](../../../7.reference/14.system-reference/4.system-view-for-mysql/3.performance-view-5/9.gv-ob_servers.md)。
...
4. 执行以下命令，查看集群内所有租户的资源分配情况。
   ...
   *************************** 5. row ***************************
   ...
   更多视图 `oceanbase.GV$OB_UNITS` 的说明信息请参见 [GV$OB_UNITS](../../../7.reference/14.system-reference/4.system-view-for-mysql/3.performance-view-5/13.gv-ob_units.md)。
