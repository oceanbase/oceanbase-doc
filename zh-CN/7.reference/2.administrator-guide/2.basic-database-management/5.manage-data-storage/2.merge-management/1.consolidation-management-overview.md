...
更多合并相关的详细介绍信息，请参见 [合并](../../../../7.reference/4.concepts-of-oceanbase-database-system/9.storage-architecture-1/3.dump-and-merge-1/3.merge-2.md)。
...
租户创建表并指定压缩算法的语法请参见 [CREATE TABLE（MySQL 模式）](../../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/16.create-table.md) 和 [CREATE TABLE（Oracle 模式）](../../../../7.reference/6.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/24.create-table-1.md)。
