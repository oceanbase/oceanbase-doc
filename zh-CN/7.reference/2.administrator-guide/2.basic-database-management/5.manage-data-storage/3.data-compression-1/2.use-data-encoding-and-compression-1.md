...
* 创建表时，指定表的编码格式和压缩方式
  ...
  更多 `CREATE TABLE` 语句的说明请参见 [CREATE TABLE](../../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/16.create-table.md)。
...
* 修改表时，更改表的编码格式和压缩方式
  ...
  更多 `ALTER TABLE` 语句的说明请参见 [ALTER TABLE](../../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/6.alter-table.md)。
...
* 创建表时，指定编码格式和压缩方式
  ...
  更多 `CREATE TABLE` 语句的说明请参见 [CREATE TABLE](../../../../7.reference/6.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/24.create-table-1.md)。
...
* 修改表时，更改表的编码格式和压缩方式
  ...
  更多 `ALTER TABLE` 语句的说明请参见 [ALTER TABLE](../../../../7.reference/6.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/10.alter-table-1.md)。
