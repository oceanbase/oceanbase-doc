...
更多 `SET PASSWORD` 语句的信息请参见 [SET PASSWORD](../../../../../4.development-guide-refactoring/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/3.dcl-of-oracle-mode/13.set-password-of-oracle-mode.md)。
