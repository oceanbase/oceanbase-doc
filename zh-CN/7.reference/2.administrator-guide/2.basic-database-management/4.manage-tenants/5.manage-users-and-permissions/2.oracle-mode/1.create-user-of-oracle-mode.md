...
2. 执行以下命令，创建用户 `test2`。
   ...
   `CREATE USER` 语句的更多信息，请参见 [CREATE USER](../../../../../4.development-guide-refactoring/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/1.ddl-of-oracle-mode/27.create-user-of-oracle-mode.md)。
