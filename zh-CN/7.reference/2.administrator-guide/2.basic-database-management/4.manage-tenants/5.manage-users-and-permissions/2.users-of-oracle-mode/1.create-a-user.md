...
* `PRIMARY_ZONE`：用于指定用户的 Primary Zone。
  ...
  更多 Primary Zone 相关的介绍信息请参见 [Primary Zone](../../../../../7.reference/4.concepts-of-oceanbase-database-system/5.distributed-database-objects/2.cluster-architecture.md)。
...
2. 执行以下命令，创建用户 `test2`。
   ...
   `CREATE USER` 语句的更多信息，请参见 [CREATE USER](../../../../../7.reference/6.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/27.create-user-1.md)。
