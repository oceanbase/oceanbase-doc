...
更多 `ALTER USER` 语句的信息请参见 [ALTER USER](../../../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/8.alter-user.md)。
...
更多 `SET PASSWORD` 语句的信息请参见 [SET PASSWORD](../../../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/55.set-password.md)。
