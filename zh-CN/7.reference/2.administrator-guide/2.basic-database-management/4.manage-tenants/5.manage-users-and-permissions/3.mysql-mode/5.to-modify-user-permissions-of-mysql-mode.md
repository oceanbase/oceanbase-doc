...
查看当前拥有权限的操作请参见 [查看用户权限](../3.mysql-mode/4.to-view-user-permissions-of-mysql-mode.md)。
...
更多 `GRANT` 语句的信息请参见 [GRANT](../../../../../4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/35.grant-of-mysql-mode.md)。
...
更多 `REVOKE` 语句的信息请参见 [REVOKE](../../../../../4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/47.revoke-of-mysql-mode.md)。
