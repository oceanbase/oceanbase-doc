...
更多 `DROP USER` 语句的信息请参见 [DROP USER](../../../../../4.development-reference1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/30.drop-user-of-mysql-mode.md)。
