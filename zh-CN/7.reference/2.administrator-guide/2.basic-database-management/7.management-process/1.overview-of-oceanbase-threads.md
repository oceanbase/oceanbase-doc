# OceanBase 线程简介
#docslug#/oceanbase-database/oceanbase-database/V4.0.0/overview-of-oceanbase-threads
...
关于 OceanBase 数据库线程的更多详情，请参见 [线程简介](../../../7.reference/4.concepts-of-oceanbase-database-system/12.observer-node-architecture/3.observer-thread-model/1.thread-introduction.md)。
