...
2. （可选）开启系统日志自动回收功能。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>仅当 <code>max_syslog_file_count</code> 配置项的值设置为非 0 正数时，系统日志自动回收功能才会生效。有关 <code>max_syslog_file_count</code> 和 <code>enable_syslog_recycle</code> 配置项的详细介绍，请参见 <a href="../../../../5.system-reference/1.system-configuration-items/1.system-configuration-items-overview.md">系统配置项</a> 。</p>
  </main>
