...
> **说明**
>
> 您可使用 Canal 和 oblogproxy 将 OceanBase 数据库的数据实时同步到 MySQL 数据库，详细操作请参考 [使用 Canal 从 OceanBase 数据库迁移数据到 MySQL 数据库](../../../5.data-migration/3.migrate-data-from-apsaradb-for-oceanbase-to-mysql/2.use-canal-to-migrate-data-from-oceanbase-database-to-mysql-database.md)。
