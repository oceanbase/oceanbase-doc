...
|                               配置项名                                |        功能描述         |
|-------------------------------------------------------------------|---------------------|
| [io_category_config](3.tenant-level-configuration-items-2/15.io_category_config.md) | 用于配置各类别 I/O 请求的百分比。 |
...
| [ob_enable_batched_multi_statement](3.tenant-level-configuration-items-2/24.ob_enable_batched_multi_statement-1-2-3-4.md) | 用于设置是否启用批处理功能的成组执行优化。                                                             |
