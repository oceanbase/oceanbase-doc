...
|                            子程序                             |          描述          |
|------------------------------------------------------------|----------------------|
| [BROKEN](2.broken-oracle.md)      | 禁止执行 Job。            |
| [CHANGE](3.change-oracle.md)      | 更改与 Job 关联的用户自定义参数。  |
| [ZONE](4.zone-oracle.md)        | 更改 Job 与 Zone 的从属关系。 |
| [INTERVAL](5.interval-oracle.md)    | 改变指定 Job 的执行间隔。      |
| [NEXT_DATE](6.next-date-oracle.md)   | 更改指定 Job 的下一次执行时间。   |
| [REMOVE](7.remove-oracle.md)      | 从 Job 队列中删除指定的 Job。  |
| [RUN](8.run-oracle.md)         | 强制运行指定的 Job。         |
| [SUBMIT](9.submit-oracle.md)      | 向 Job 队列提交新 Job。     |
| [USER_EXPORT](10.user-export-oracle.md) | 生成重新创建指定 Job 的调用文本。  |
| [WHAT](11.what-oracle.md)        | 更改指定 Job 的执行内容。      |
