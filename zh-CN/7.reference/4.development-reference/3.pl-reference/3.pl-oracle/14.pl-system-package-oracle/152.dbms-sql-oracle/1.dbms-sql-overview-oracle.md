...
| [LAST_ERROR_POSITION](12.last-error-position-of-oracle-mode.md)| 获取最近一次调用 `DBMS_SQL.PARSE` 时出现语法错误的位置。|
| [OPEN_CURSOR](15.open-cursor-oracle.md)       | 返回新游标的 ID。                      |
| [PARSE](20.parse-oracle.md)             | 解析指定的语句。                        |
