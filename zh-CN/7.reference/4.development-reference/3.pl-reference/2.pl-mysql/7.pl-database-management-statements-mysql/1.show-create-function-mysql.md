...
存储函数的信息也可从 `INFORMATION_SCHEMA ROUTINES` 表中获得。详细信息请参见 [INFORMATION_SCHEMA PARAMETERS](../8.information-schema-dictionary-view-mysql/1.information-schema-parameters-mysql.md)。
