...
|                      系统包                      |            描述                    |
|-------------------------------------------------|------------------------------------|
| [DBMS_RESOURCE_MANAGER](133.dbms-resource-manager-mysql/1.dbms-resource-manager-overview-mysql.md)| 用于维护资源使用计划，资源使用组和资源计划指令。|
| [DBMS_STATS](159.dbms-stats-oracle/1.dbms-stats-overview-mysql.md)        | 查看和修改优化器为数据库对象收集的统计信息。                        |
| [DBMS_UDR](178.dbms-udr-mysql/1.dbms-udr-overview-mysql.md)| 提供改写绑定功能，可以在 SQL 开始执行之前根据匹配规则改写数据库接收到的 SQL 语句。|
| [DBMS_XPLAN](207.dbms-xplan-mysql/1.dbms-xplan-overview-mysql.md)|  提供逻辑计划管理相关的功能，包括逻辑计划优化追踪等。 |
