...
要调用存储过程，请使用 `CALL` 语句，详细信息请参见 [CALL](../5.pl-manipulation-statement-mysql/1.CALL-mysql.md)。
...
有关创建存储过程的详细示例信息，请参见 [存储过程](../2.storage-object-mysql/3.pl-stored-procedure-mysql.md)。