...
OceanBase 数据库相关的列类型变更规则，请参考 [列类型变更规则](../../../7.reference/4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/7.ddl-function-of-mysql-mode/8.partitioning-operations-of-mysql-mode.md)。
