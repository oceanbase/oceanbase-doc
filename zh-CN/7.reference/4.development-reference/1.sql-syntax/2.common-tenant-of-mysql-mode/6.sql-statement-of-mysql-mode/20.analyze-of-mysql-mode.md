...
| table_name |指定要分析的表。|
<<<<<<< HEAD
| INT_NUM | 整数，即 Buckets 的个数。有关 Buckets 的取值，请参见 [method_opt](../../../../3.performance-tuning-guide/5.sql-optimization/4.sql-optimization/4.optimizer-statistics/2.statistics-collection-methods/4.collect-statistics-automatically.md)。|
=======
