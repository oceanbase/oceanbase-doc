...
有关 `USERENV` 命名空间的信息，请参见函数 [SYS_CONTEXT](../../5.functions-of-oracle-mode/2.single-row-functions-of-oracle-mode/9.environment-and-identifier-functions-of-oracle-mode/1.lnnvl-of-oracle-mode.md)。
