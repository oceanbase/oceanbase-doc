...
| 配置项名 | 功能描述 |
|[rpc_client_authentication_method](3.cluster-level-configuration-items/281.rpc_client_authentication_method)| 用于设置 RPC 客户端的安全认证方式。 |
...
| [enable_rebalance](3.cluster-level-configuration-items/67.enable_rebalance.md)    | 用于设置是否开启自动负载均衡的功能。   |
