...
更多 `CREATE SEQUENCE` 语句的信息，请参见 [CREATE SEQUENCE](../../5.sql-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/1.ddl-of-oracle-mode/22.create-sequence-of-oracle-mode.md) 。
...
* 更多 DBA_SEQUENCES 视图的字段及说明信息请参见 [DBA_SEQUENCES](../../7.system-views/5.system-view-of-oracle-mode/2.dictionary-view-of-oracle-mode/256.dba_sequences-of-oracle-mode.md)。

* 更多 ALL_SEQUENCES 视图的字段及说明信息请参见 [ALL_SEQUENCES](../../7.system-views/5.system-view-of-oracle-mode/2.dictionary-view-of-oracle-mode/25.all_sequences-of-oracle-mode.md)。

* 更多 USER_SEQUENCES 视图的字段及说明信息请参见 [USER_SEQUENCES](../../7.system-views/5.system-view-of-oracle-mode/2.dictionary-view-of-oracle-mode/167.user_sequences-of-oracle-mode.md)。
...
更多 `ALTER SEQUENCE` 语句的信息，请参见 [ALTER SEQUENCE](../../5.sql-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/1.ddl-of-oracle-mode/6.alter-sequence-of-oracle-mode.md)。
...
更多 `DROP SEQUENCE` 语句的信息，请参见 [DROP SEQUENCE](../../5.sql-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/1.ddl-of-oracle-mode/37.drop-sequence-of-oracle-mode.md) 。
