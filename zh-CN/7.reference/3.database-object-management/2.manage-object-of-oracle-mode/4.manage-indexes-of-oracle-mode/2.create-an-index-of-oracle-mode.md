...
本节主要介绍如何在非分区表上创建索引，分区表上索引的创建请参见 [创建分区表索引](../2.manage-partitions-of-oracle-mode/9.create-partition-table-index-of-oracle-mode/2.local-index-of-oracle-mode.md) 章节。
...
在 OceanBase 数据库的 Oracle 模式中，对函数索引的表达式进行了限制，禁止部分系统函数的表达式作为函数索引，具体的函数列表请参见 [函数索引支持的系统函数列表](5.function-index-list-of-supported-functions-of-oracle-mode.md) 和 [函数索引不支持的系统函数列表](6.function-index-list-of-not-supported-functions-of-oracle-mode.md)。
