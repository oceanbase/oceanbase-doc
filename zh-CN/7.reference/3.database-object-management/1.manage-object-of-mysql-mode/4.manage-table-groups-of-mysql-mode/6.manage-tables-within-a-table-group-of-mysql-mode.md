...
* [修改分区方式](../../../4.replica-management/2.manage-partition-table/2.mysql-mode/3.modify-partition-rules-of-mysql-mode.md)

* [添加分区](../../../4.replica-management/2.manage-partition-table/2.mysql-mode/4.add-a-partition-of-mysql-mode.md)

* [删除分区](../../../4.replica-management/2.manage-partition-table/2.mysql-mode\4.add-a-partition-of-mysql-mode.md)
