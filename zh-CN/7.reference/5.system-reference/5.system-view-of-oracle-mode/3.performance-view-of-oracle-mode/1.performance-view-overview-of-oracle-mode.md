...
|                                    视图名                                    |                            功能描述                            |
|---------------------------------------------------------------------------|------------------------------------------------------------|
| [GV$OB_KVCACHE](5.gv-ob_kvcache-of-oracle-mode.md)              | 展示每台 OBServer 上的 KVCACHE 信息。                               |
| [GV$OB_PARAMETERS](6.gv-ob_parameters-of-oracle-mode.md)           | 展示租户所在的所有 OBServer 上的配置项信息。                                |
...
| [GV$OB_UNITS](12.gv-ob_units-of-oracle-mode.md)                | 展示租户所在的 OBServer 的 UNIT 信息，系统租户看到本集群所有 OBServer 的 UNIT 信息。 |
...
| [V$OB_KVCACHE](43.v-ob_kvcache-of-oracle-mode.md)               | 展示每台 OBServer 上的 KVCACHE 信息。                               |
| [V$OB_PARAMETERS](44.v-ob_parameters-of-oracle-mode.md)            | 展示本 OBServer 上的配置项信息。                                      |
| [V$SYSSTAT](87.v-sysstat-of-oracle-mode.md)                  | 展示当前服务器上系统级别的统计事件信息。                                       |
| [V$OB_UNITS](50.v-ob_units-of-oracle-mode.md)                 | 展示本 OBServer 的 UNIT 信息。                                    |
...
|                                  视图名                                   |                                 功能描述                                 |
|------------------------------------------------------------------------|----------------------------------------------------------------------|
| [GV$OB_PX_TARGET_MONITOR](8.gv-ob_px_target_monitor-of-oracle-mode.md) | 展示所有 OBServer 上的 PX 线程使用情况。                                                                   |
...
| [V$OB_PX_TARGET_MONITOR](46.v-ob_px_target_monitor-of-oracle-mode.md)  | 展示 OBServer 上的 PX 线程使用情况。                                                                   |
...
|                                  视图名                                   |                         功能描述                         |
|------------------------------------------------------------------------|------------------------------------------------------|
| [GV$OB_PROCESSLIST](7.gv-ob_processlist-of-oracle-mode.md)       | 展示租户所在的所有 OBServer 的会话信息。                            |
...
| [V$OB_PROCESSLIST](45.v-ob_processlist-of-oracle-mode.md)        | 展示本 OBServer 的会话信息。                                  |
...
| [GV$SQL_PLAN_MONITOR](95.gv-sql_plan_monitor-of-oracle-mode.md)  | 展示所有 OBServer 慢查询的 Plan 层面的统计，每个慢查询都会有一条统计信息，同时记录该 Plan 的 Trace 信息。 |
| [V$SQL_PLAN_MONITOR](96.v-sql_plan_monitor-of-oracle-mode.md)  | 展示所有 OBServer 慢查询的 Plan 层面的统计，每个慢查询都会有一条统计信息，同时记录该 Plan 的 Trace 信息。 |
...
| [GV$OB_TRANSACTION_PARTICIPANTS](11.gv-ob_transaction_participants-of-oracle-mode.md)   | 展示所有 OBServer 上的事务参与者信息。                         |
...
| [V$OB_TRANSACTION_PARTICIPANTS](49.v-ob_transaction_participants-of-oracle-mode.md)    | 展示所有 OBServer 上的事务参与者信息。                         |
