...
| [DBA_OB_BACKUP_DELETE_TASK_HISTORY](227.DBA_OB_BACKUP_DELETE_TASK_HISTORY.md)              | 展示租户下已完成的 backup_set/backup_piece 清理任务的历史信息。     |
...
| [USER_TAB_PRIVS](182.USER_TAB_PRIVS-1.md)   | 展示当前用户拥有的对象权限。                                                                                                                                              |
