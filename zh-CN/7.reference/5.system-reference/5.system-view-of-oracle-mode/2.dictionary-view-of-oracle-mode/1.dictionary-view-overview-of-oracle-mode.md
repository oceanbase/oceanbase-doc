...
| [ALL_COL_COMMENTS](4.all_col_comments-of-oracle-mode.md)         | 展示用户可访问表的所有列注释。                                             |
| [ALL_TABLES](30.all_tables-of-oracle-mode.md)               | 展示用户可访问的所有表。                                                    |
| [ALL_TAB_COLS](31.all_tab_cols-of-oracle-mode.md)             | 展示当前用户可访问表的所有列。                                          |
| [ALL_TAB_COLUMNS](32.all_tab_columns-of-oracle-mode.md)          | 展示当前用户可访问表的所有列。                                          |
| [ALL_TAB_COMMENTS](33.all_tab_comments-of-oracle-mode.md)         | 展示当前用户可访问表的注释。                                              |
| [DBA_COL_COMMENTS](62.dba_col_comments-of-oracle-mode.md)  | 展示数据库中所有表的所有列注释。 |
| [DBA_TAB_COMMENTS](109.dba_tab_comments-of-oracle-mode.md)  | 展示数据库中所有表的注释。     |
| [USER_COL_COMMENTS](149.user_col_comments-of-oracle-mode.md) | 展示当前用户拥有表的所有列注释。 |
| [USER_TAB_COMMENTS](180.user_tab_comments-of-oracle-mode.md) | 展示当前用户拥有表的注释。    |
...
| [DBA_TAB_COLS](107.dba_tab_cols-of-oracle-mode.md)             | 展示数据库中的所有表的所有列。                                           |
| [DBA_TAB_COLUMNS](108.dba_tab_columns-of-oracle-mode.md)          | 展示数据库中所有表的所有列。                                           |
...
| [USER_TAB_COLS](178.user_tab_cols-of-oracle-mode.md)            | 展示当前用户拥有表的所有列。                                           |
| [USER_TAB_COLUMNS](179.user_tab_columns-of-oracle-mode.md)         | 展示当前用户拥有表的所有列。                                           |
...
| [DBA_SEQUENCES](256.dba_sequences-all-of-oracle-mode.md)  | 展示数据库中所有 SEQUENCE。    |
