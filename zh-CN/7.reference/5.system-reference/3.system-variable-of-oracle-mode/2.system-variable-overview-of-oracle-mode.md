...
|                                                          变量名                                                           |                               功能描述                                |
|------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|
| [auto_increment_increment](4.auto_increment_increment-1-2-3-4.md) | 用于设置自增步长，仅用于 MySQL 客户端登录。                                         |
...
| [transaction_read_only](130.transaction_read_only-1-2-3-4.md)     | 用于控制是否只允许开启只读事务。 <br>**说明**<br>  该变量当前暂不生效。 |
...
| [character_set_server](14.character_set_server-1-2-3-4.md)     | 用于设置服务器字符集。 <br>**说明**<br>  该变量当前暂不生效。         |
...
| [collation_database](17.collation_database-1-2-3-4.md)       | 用于设置创建数据库默认字符集和字符序。 <br>**说明**<br>  该变量当前暂不生效。 |
...
| [ob_enable_show_trace](73.ob_enable_show_trace-1-2-3-4.md)  | 用于设置是否使用 Trace 日志。                    |
