...
| [oceanbase.CDB_OB_BACKUP_DELETE_TASK_HISTORY](149.oceanbase-cdb_ob_backup_delete_task_history.md)              | 展示租户下已完成的 backup_set/backup_piece 清理任务的历史信息。 |
...
| [oceanbase.DBA_OB_BACKUP_DELETE_TASK_HISTORY](150.oceanbase-dba_ob_backup_delete_task_history.md)              | 展示租户下已完成的 backup_set/backup_piece 清理任务的历史信息。 |
...
| [oceanbase.CDB_OB_ARCHIVELOG](133.oceanbase-cdb_ob_archivelog.md)              | 展示每个路径上的日志归档状态。 |
| [oceanbase.CDB_OB_ARCHIVELOG_SUMMARY](135.oceanbase-cdb_ob_archivelog_summary.md)              | 展示历史以及当前所有的日志归档的状态。 |
