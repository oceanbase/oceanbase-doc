...
[DISPLAY_ACTIVE_SESSION_PLAN](../../../5.sql-reference/3.pl-reference/3.pl-oracle/14.pl-system-package-oracle/207.dbms-xplan-oracle/2.display-active-session-plan-of-oracle-mode.md)

[(G)V$OB_SQL_PLAN](../../../7.system-views/4.system-view-of-mysql-mode/3.performance-view-of-mysql-mode/148.gv-ob_sql_plan-of-mysql-mode.md)

[(G)V$OB_PLAN_CACHE_PLAN_EXPLAIN](../../../7.system-views/4.system-view-of-mysql-mode/3.performance-view-of-mysql-mode/26.gv-plan_cache_plan_explain-of-mysql-mode.md)

[GV$SQL_PLAN_MONITOR](../../../7.system-views/4.system-view-of-mysql-mode/3.performance-view-of-mysql-mode/29.gv-sql_plan_monitor-of-mysql-mode.md)

[V$SQL_MONITOR_STATNAME](../../../7.system-views/4.system-view-of-mysql-mode/3.performance-view-of-mysql-mode/89.v-sql_monitor_statname-of-mysql-mode.md)
