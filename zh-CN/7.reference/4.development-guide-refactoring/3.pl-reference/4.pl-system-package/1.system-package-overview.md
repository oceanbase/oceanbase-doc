...
| [DBMS_APPLICATION_INFO](3.DBMS_APPLICATION_INFO/1.dbms_application_info-overview.md)  | 用于将应用程序名称注册在数据库中以进行审计或性能跟踪。                   |
...
| [DBMS_SQL](17.DBMS_SQL/1.dbms_sql-overview.md)              | 使用动态 SQL 访问数据库。                               |
