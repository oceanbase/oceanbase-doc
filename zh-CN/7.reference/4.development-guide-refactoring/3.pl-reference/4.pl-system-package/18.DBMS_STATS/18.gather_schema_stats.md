...
```sql
obclient> CALL DBMS_STATS.GATHER_SCHEMA_STATS(ownname=>'hr',estimate_percent=>'AUTO_SAMPLE_SIZE', 
    FALSE,method_opt=>'EFAULT_METHOD_OPT',DEGREE=>NULL,granularityownname=>'DEFAULT_GRANULARITY',NULL,NULL,NULL,NULL,FALSE,stattype=>'DATA',FALSE);
