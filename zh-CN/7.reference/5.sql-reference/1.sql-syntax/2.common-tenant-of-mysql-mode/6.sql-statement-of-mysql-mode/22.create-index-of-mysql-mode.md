...
| expr            | 表示合法的函数索引表达式，且允许是布尔表达式，例如 `c1=c1`。<main id="notice" type='notice'><h4>注意</h4><p> OceanBase 数据库当前版本禁止创建生成列上的函数索引。函数索引所支持的表达式参见 <a href="../../../../../7.reference/3.database-object-management/1.manage-object-of-mysql-mode/5.manage-indexes-of-mysql-mode/5.function-index-list-of-supported-functions-of-mysql-mode.md"> 函数索引支持的系统函数列表</a>。 </p></main>         |
