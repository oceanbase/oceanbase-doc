...
| expr            | 表示合法的函数索引表达式，但是不允许是布尔表达式，例如 `c1=c1`。<br>**注意** OceanBase 数据库当前版本禁止创建生成列上的函数索引。函数索引所支持的表达式参见 [函数索引支持的系统函数列表](../../../../../3.database-object-management/2.manage-object-of-oracle-mode/4.manage-indexes-of-oracle-mode/5.function-index-list-of-supported-functions-of-oracle-mode.md) 。         |
