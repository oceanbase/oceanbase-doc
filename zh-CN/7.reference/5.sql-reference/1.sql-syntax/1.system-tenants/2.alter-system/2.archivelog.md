...
ALTER SYSTEM SET LOG_ARCHIVE_DEST='LOCATION=archive_path [PIECE_SWITCH_INRERVAL=piece_switch_interval] [BINDING=archive_mode]' TENANT = tenant_name;

/*用户租户配置本租户的归档目的端*/
ALTER SYSTEM SET LOG_ARCHIVE_DEST='LOCATION=archive_path [PIECE_SWITCH_INRERVAL=piece_switch_interval] [BINDING=archive_mode]';
```
