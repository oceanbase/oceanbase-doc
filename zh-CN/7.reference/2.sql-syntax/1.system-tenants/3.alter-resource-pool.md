...
| unit_num                                  | 指定修改后一个 Zone 下的资源单元个数，取值要小于等于对应 Zone 中的 OBServer 个数。<blockquote>**注意**</br>当资源池分配给租户之后，无法再通过 `ALTER RESOURCE POOL` 语法修改资源池 unit 个数，需要通过 `ALTER RESOURCE TENANT` 语法，详情使用方法，参见 [ALTER RESOURCE TENANT](3.alter-resource-tenant.md)。</blockquote>                                                                                                                                                                                                                                                                                                                                                                                                             |
