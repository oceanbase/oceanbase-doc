...
* 企业版安装部署流程
  ...
  * 企业版部署：[部署流程](../../4.deploy/3.deploy-oceanbase-enterprise-edition/1.deployment-process.md)
...
* **memory_limit**
  ...
  * 相关文档：[memory_limit](../8.configuration-items-and-system-variables/1.system-configuration-items/3.cluster-level-configuration-items/136.memory_limit.md)
...
* **memory_limit_percentage**
  ...
  * 相关文档：[memory_limit_percentage](../8.configuration-items-and-system-variables/1.system-configuration-items/3.cluster-level-configuration-items/137.memory_limit_percentage.md)
...
* **system_memory**
  ...
  * 相关文档：[system_memory](../8.configuration-items-and-system-variables/1.system-configuration-items/3.cluster-level-configuration-items/207.system_memory.md)
...
* **cpu_count**
  ...
  * 相关文档：[cpu_count](../8.configuration-items-and-system-variables/1.system-configuration-items/3.cluster-level-configuration-items/45.cpu_count.md)
...
* **net_thread_count**
  ...
  * 相关文档：[net_thread_count](../8.configuration-items-and-system-variables/1.system-configuration-items/3.cluster-level-configuration-items/152.net_thread_count.md)

* **sql_net_thread_count**

  相关文档：[sql_net_thread_count](../8.configuration-items-and-system-variables/1.system-configuration-items/3.cluster-level-configuration-items/251.sql_net_thread_count.md)
...
* **datafile_size**
  ...
  * 相关文档：[datafile_size](../8.configuration-items-and-system-variables/1.system-configuration-items/3.cluster-level-configuration-items/54.datafile_size.md)
...
* **datafile_disk_percentage**
  ...
  * 相关文档：[datafile_disk_percentage](../8.configuration-items-and-system-variables/1.system-configuration-items/3.cluster-level-configuration-items/53.datafile_disk_percentage.md)
...
* **log_disk_size**
  ...
  * 查询：`show parameters where name = 'log_disk_size';`
  ...
  相关文档：[log_disk_size](../8.configuration-items-and-system-variables/1.system-configuration-items/3.cluster-level-configuration-items/237.log_disk_size.md)
...
* 查询：`show parameters where name = 'log_disk_percentage';`
  ...
  相关文档：[log_disk_percentage](../8.configuration-items-and-system-variables/1.system-configuration-items/3.cluster-level-configuration-items/238.log_disk_percentage.md)
...
* **cpu_quota_concurrency**
  ...
  * 相关文档：[cpu_quota_concurrency](../8.configuration-items-and-system-variables/1.system-configuration-items/4.tenant-level-configuration-items/55.cpu_quota_concurrency.md)
