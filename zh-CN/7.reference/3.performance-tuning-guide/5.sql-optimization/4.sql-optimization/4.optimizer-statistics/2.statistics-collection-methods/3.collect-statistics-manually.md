...
obclient> INSERT /*+APPEND*/ INTO t1 SELECT level,level,level,level,level,level,level,level,level,level FROM DUAL CONNECT BY level<=1000000;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your OceanBase version for the right syntax to use near 'CONNECT BY level<=1000000' at line 1
...
obclient> INSERT /*+APPEND*/ INTO t_part SELECT level,level,level,level,level,level,level,level,level,level FROM DUAL CONNECT BY level<=1000000;
```
