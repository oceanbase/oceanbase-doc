...
| TENANT_ROLE                      | longtext            |NO              | 租户角色: <ul><li> `PRIMARY_TENANT` : 主库租户 </li> <li> `STANDBY_TENANT` : 备库租户 </li> </ul>    |
...
| FINISH_MAJOR_BLOCK_BYTES         | bigint(20)          |NO              | 已完成恢复宏块字节数  |
| FINISH_MAJOR_BLOCK_BYTES_DISPLAY | varchar(27)         |NO              | 已完成恢复宏块量，以存储容量单位显示   |
