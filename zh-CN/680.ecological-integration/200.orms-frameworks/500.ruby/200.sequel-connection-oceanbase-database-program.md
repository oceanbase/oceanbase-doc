|description|本文介绍如何使用 Sequel 和 OceanBase 数据库构建一个应用程序，实现创建表、插入数据和查询数据等基本操作。|
|---|---|
|keywords|Ruby, Sequel, OceanBase, 数据库连接, ORM 框架, 生态集成|
|dir-name|Sequel|
|dir-name-en|Sequel Connection to OceanBase Database|
|category|生态集成|
|type|框架和驱动|
