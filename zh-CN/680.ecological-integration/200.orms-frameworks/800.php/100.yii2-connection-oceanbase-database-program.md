...
4. 响应结果示例：
    ...
    ```json
    {
        "success":true,"message":"操作成功","data":{"userCount":6,"sampleUser":{"id":1,"username":"oceanbase_user1749628918","email":"user1749628919@oceanbase.com","age":31,"created_at":1749628919}}
    }
    ```
