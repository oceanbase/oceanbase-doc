...
<main id="notice" >
  <h4>功能适用性</h4>
  <p>Yii 2.0 适用于 OceanBase 数据库 MySQL 模式。</p>
</main>
...
3. 查看 `runtime/logs/app.log` 文件，您应该能看到类似以下的日志输出：
    ...
    2025-06-10 11:30:16 [info][application] 查询数据: {"id":1,"username":"example_user","email":"user@example.com","age":35,"created_at":1654857016}
