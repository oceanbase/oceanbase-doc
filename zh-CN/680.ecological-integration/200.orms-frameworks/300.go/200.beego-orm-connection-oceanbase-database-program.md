...
<main id="notice" >
  <h4>功能适用性</h4>
  <p>beego ORM 适用于 OceanBase 数据库 MySQL 模式。</p>
</main>
...
3. 程序执行完成后，您应该能看到类似以下的输出：
    ...
    2025/06/10 11:08:42.550 [I] [main.go:96]  查询数据成功: &{Id:1 Username:example_user Email:user@example.com Age:28 Created:2025-06-10 11:08:42 +0800 CST Updated:2025-06-10 11:08:42 +0800 CST}
