...
1. 创建一个名为 `main.go` 的文件，并添加以下代码：
    ...
    func init() {
        ...
        // 注册数据库
        dataSource := "root@mysql001:_Oce2nB2se_@tcp(172.30.135.243:2881)/db_test?charset=utf8mb4&parseTime=true&loc=Local"
...
3. 程序执行完成后，您应该能看到类似以下的输出：
    ...
    2025/06/10 11:08:42.550 [I] [main.go:96]  查询数据成功: &{Id:1 Username:oceanbase_user Email:user@oceanbase.com Age:28 Created:2025-06-10 11:08:42 +0800 CST Updated:2025-06-10 11:08:42 +0800 CST}
