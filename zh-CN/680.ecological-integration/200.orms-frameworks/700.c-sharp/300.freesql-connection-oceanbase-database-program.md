...
1. 创建 `Models` 文件夹并添加 `User.cs` 类：
   ...
   public class User
   {
       ...
       [Column(StringLength = 100, IsNullable = false, IsUnique = true)]
   ...
   public class AppDbContext : DbContext
   {
       ...
       public AppDbContext(IConfiguration configuration)
       {
           ...
           if (_fsql == null)
           {
               ...
               {
                   Console.WriteLine($"Before execution: {e.Sql}");
               };
               
               _fsql.Aop.CurdAfter = (s, e) =>
               {
                   Console.WriteLine($"After execution, affected rows: {e.ElapsedMilliseconds}ms");
               };
           }
