|description|本文介绍如何使用 Rust 的 SeaORM ORM 框架连接 OceanBase 数据库，并实现基本的 CRUD 操作。|
|---|---|
|keywords|Rust, SeaORM, OceanBase, 数据库连接, ORM 框架, 生态集成|
|dir-name|SeaORM|
...
<main id="notice" >
  <h4>功能适用性</h4>
  <p>SeaORM 适用于 OceanBase 数据库 MySQL 模式。</p>
</main>
