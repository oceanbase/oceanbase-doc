...
OceanBase 数据库的 MySQL 兼容模式租户建议使用 flyway-core 10.0.0 或更高版本，并依赖 mysql-connector-java 和 flyway-database-oceanbase 组件。

更低版本的 Flyway，请参考以下表格：

| OceanBase 数据库版本 | Flyway 版本 | 备注 |
|---------------------|-------------|------|
| V4.2.5 及之后版本    | < 10.x | 请联系 OceanBase 数据库技术支持 |
| V4.2.5 之前版本      | < 9.x | 暂不支持 |
| V4.2.5 之前版本      | 9.x | 请联系 OceanBase 数据库技术支持 |
...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>可从 <a href="https://github.com/oceanbase/ecology-plugins/releases/download/1.0/flyway-database-oceanbase-10.16.1.jar">GitHub 下载</a> flyway-database-oceanbase 10.16.1 版本，其他版本请联系 OceanBase 数据库技术支持获取。</p>
</main>
