...
# OceanBase MCP Server 与 Google GenAI Toolbox 集成
...
[Google GenAI Toolbox for Databases](https://github.com/googleapis/genai-toolbox) 是一个开源的数据库 MCP 服务器。它通过处理连接池、身份验证等复杂问题，让您能够更轻松、更快速、更安全地开发工具。
