...
本文介绍如何将 OceanBase 中的向量检索功能与 Dify 集成。

## 前提条件

* 您已安装 OceanBase 数据库 V4.3.3 或以上版本并且创建了 MySQL 模式用户租户。创建用户租户的详细信息，参见 [创建租户](../../600.manage/200.tenant-management/600.common-tenant-operations/200.manage-create-tenant.md)。
