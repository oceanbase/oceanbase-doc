...
>**说明**
>
>有关修改表结构的详细信息，请参见 [ALTER TABLE](../../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/600.sql-statement/600.alter-table.md)。
...
>**说明**
>
>有关列类型变更规则的详细信息，请参见 [列类型变更规则](../../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/700.ddl-function/900.column-type-change-rule-1.md)。
...
有关修改表分区的详细信息，请参见 [修改分区规则](../../../500.administrator-guide/800.distributed-storage-management/200.manage-partition-table/300.modify-partition-rules.md)。
