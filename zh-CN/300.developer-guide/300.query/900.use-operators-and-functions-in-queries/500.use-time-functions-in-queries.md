...
有关更多时间类型用法，请参考 [日期时间类型概述](../../../700.reference/200.sql-syntax/200.common-tenant-mysql-mode/100.basic-elements/100.data-type/300.date-and-time-types-1/100.date-and-time-types.md)。
