...
+ [使用 OBD 部署 OceanBase 数据库](../../100.users-guide/200.Get-started-quickly/000.Quickly-experience-OceanBase.md)
...
使用 OBClient 或 MySQL 客户端连接 OceanBase 集群，创建 SYS_USER_NAME 以及 SYS_PASSWORD。创建方式，请参考 [创建用户](../../100.users-guide/600.basic-database-management/400.manage-tenants/500.manage-users-and-privileges/200.create-a-user.md)。
