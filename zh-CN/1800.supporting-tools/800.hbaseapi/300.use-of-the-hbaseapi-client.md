...
使用 OBClient 或 MySQL 客户端连接 OBServer 集群，创建 SYS_USER_NAME 以及 SYS_PASSWORD。创建方式，请参考 [如何创建租户用户](https://www.oceanbase.com/docs/community-observer-cn-10000000000450813)。
