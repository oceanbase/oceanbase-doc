...
> **说明**
>
> 您可使用 Canal 和 oblogproxy 将 OceanBase 数据库的数据实时同步到 MySQL 数据库，详细操作请参考 [将数据从 OceanBase 同步至 MySQL](../../100.users-guide/400.data-migration/700.use-canal-to-synchronize-MySQL-data-to-OceanBase-database-in-real-time.md)。
