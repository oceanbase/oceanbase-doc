...
* 对于线下环境，建议使用 OBD 进行标准部署；具体操作参见 [部署 OceanBase 数据库生产环境](5.deploy-oceanbase-database-community-edition/2.local-deployment/3.deploy-OceanBase-database-of-multi-node-cluster.md)
