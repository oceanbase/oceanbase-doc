...
| 内存     | <ul><li> 测试环境最低要求 8 G。 </li><li> 生产环境最低要求 16 G，长期使用要求不低于 32 G，推荐 256 G 及以上。  </li><li>性能测试场景推荐 128 G 及以上。</li></ul><main id="notice" type='notice'><h4>注意</h4><p>当部署多个集群时, 推荐使用 OCP 进行统一运维管理, 当部署集群比较少时, 建议使用 OBD 进行安装部署。</p></main> |
| 磁盘类型   | 推荐使用 SSD                                                                                                           |
| 磁盘存储空间 | 最低要求 54 GB                                                                                                 |
