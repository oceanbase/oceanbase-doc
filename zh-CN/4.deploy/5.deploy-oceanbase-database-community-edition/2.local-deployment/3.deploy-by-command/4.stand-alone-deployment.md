...
5. 修改密码。
   ...
   通过命令行创建的租户，其管理员用户 `root` 的密码默认为空，首次登录后请修改密码。
...
* [创建用户租户](../../../../7.reference/2.administrator-guide/2.basic-database-management/4.manage-tenants/3.create-a-user-tenant.md)。

* [纯命令行单机部署转分布式部署](6.single-machine-to-distributed.md)
