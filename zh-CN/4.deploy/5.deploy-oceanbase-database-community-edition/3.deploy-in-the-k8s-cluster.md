...
obclient -hxxx.xxx.xxx.xxx -P2883 -uroot -A -c

# use clusterip with password
obclient -hxxx.xxx.xxx.xxx -P2883 -uroot -p****** -A -c

# using nodeport without password
obclient -h<node_ip> -P30083 -uroot -A -c

# using nodeport with password
obclient -h<node_ip> -P30083 -uroot -p****** -A -c
```
