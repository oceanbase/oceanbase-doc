...
5. 在 **创建集群** 页面，设置集群的部署模式信息。
   ...
   <main id="notice" type='notice'>
     <h4>注意</h4>
     <ul><li>如果设置了 Primary Zone，则 Primary Zone 所在的 Region 必须至少有两个 Zone，并且至少有两个全能型（F）副本（一个 Zone 一个副本）。</li></ul>
   </main>
...
* [创建租户](../../../../7.reference/2.administrator-guide/2.basic-database-management/4.manage-tenants/2.create-a-tenant.md)
