...
有关资源隔离和配置 cgroup 的更多信息，请参见 [资源隔离概述](../../../../7.reference/2.administrator-guide/7.management/1.1.resource-isolation/1.resource-isolation-overview.md) 和 [配置 cgroup](../../../../7.reference/2.administrator-guide/7.management/1.1.resource-isolation/2.resource-isolation-for-oracle-mode/1.config-cgroups-for-oracle-mode.md)。
...
* 集群部署完成后，需要创建业务租户，详细信息请参见 [创建租户](../5.create-oceanbase-tenant-command-line/2.create-tenant-command-line.md)。
