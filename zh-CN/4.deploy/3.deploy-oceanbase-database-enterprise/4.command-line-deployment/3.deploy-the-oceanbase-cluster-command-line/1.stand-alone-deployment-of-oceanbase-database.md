...
有关资源隔离和配置 cgroup 的更多信息，请参见 [资源隔离概述](../../../../7.reference/2.administrator-guide/7.management/1.1.resource-isolation/1.resource-isolation-overview.md) 和 [配置 cgroup](../../../../7.reference/2.administrator-guide/7.management/1.1.resource-isolation/2.resource-isolation-of-oracle-mode/1.config-cgroups-of-oracle-mode.md)。
...
* [单机部署转分布式部署](../../../../7.reference/2.administrator-guide/7.management/1.scale-out-and-scale-in/2.cluster-level-scale-out-and-scale-in/1.scale-out/3.single-machine-deployment-online-to-distributed.md)
