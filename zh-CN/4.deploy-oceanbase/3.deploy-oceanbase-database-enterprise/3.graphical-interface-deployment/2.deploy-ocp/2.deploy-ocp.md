...
* 您已添加待安装 OCP 的服务器。详细信息，请参见 [添加服务器](../1.configure-a-deployment-environment/5.add-server.md)。
* 您的服务器满足安装 OCP 的要求。详细信息，请参见 [准备服务器](../../2.preparations-before-deployment/1.prepare-server.md)。
* 您已为 OCP 创建元数据库 MetaDB 组件。详细信息，请参见 [创建 MetaDB](../1.configure-a-deployment-environment/7.create-metadb.md)。
...
创建 MetaDB 的详细信息，请参见 [创建 MetaDB](../1.configure-a-deployment-environment/7.create-metadb.md)。
