...
有关 `USERENV` 命名空间的信息，请参见函数 [SYS_CONTEXT](/zh-CN/11.sql-reference-oracle-mode/5.functions-2/2.single-row-functions/9.environment-and-identifier-functions/1.LNNVL-1-2.md)。
