...
* [夏令时](/zh-CN/11.sql-reference-oracle-mode/1.basic-elements-1/1.built-in-data-types/4.date-time-and-interval-data-types/4.timestamp-with-time-zone-data-type.md)

  

* [日期时间 DATE 和间隔 INTERVAL 的计算](/zh-CN/11.sql-reference-oracle-mode/1.basic-elements-1/1.built-in-data-types/4.date-time-and-interval-data-types/8.calculation-of-date-time-and-interval.md)
