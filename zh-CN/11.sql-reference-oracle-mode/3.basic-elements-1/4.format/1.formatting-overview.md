...
* [数字格式模型](/zh-CN/11.sql-reference-oracle-mode/3.basic-elements-1/4.format/2.format-1.md)

  

* [日期时间格式模型](/zh-CN/11.sql-reference-oracle-mode/3.basic-elements-1/4.format/3.date-and-time-formatting.md)
