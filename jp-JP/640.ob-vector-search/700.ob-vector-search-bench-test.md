...
* MySQLテナントを作成します。[テナントの作成](../600.manage/200.tenant-management/600.common-tenant-operations/200.manage-create-tenant.md)を参照してください。
...
* 業務テナントに接続し、HNSWベクトルインデックス検索に関連するメモリとクエリパラメータを調整します：
  ...
  ```sql
  -- ob_vector_memory_limit_percentageを30%に設定します。
