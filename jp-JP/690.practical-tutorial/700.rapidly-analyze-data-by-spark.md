...
1. **Spark クラスタ**：デプロイと設定が完了しており、Spark SQL を介した分散型計算タスクの実行がサポートされていること。詳細については、[Spark クラスタのデプロイ](https://spark.apache.org/docs/latest/cluster-overview.html) を参照してください。
