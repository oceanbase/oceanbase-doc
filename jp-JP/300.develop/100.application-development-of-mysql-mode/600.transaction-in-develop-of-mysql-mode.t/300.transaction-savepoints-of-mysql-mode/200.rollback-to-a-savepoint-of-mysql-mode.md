...
セーブポイントがマークされていることを確認してください。具体的な操作については、[セーブポイントのマーク](../300.transaction-savepoints-of-mysql-mode/100.mark-a-savepoint-of-mysql-mode.md) を参照してください。

## トランザクションをセーブポイントにロールバック

以下のステートメントを使用して、トランザクションを特定のセーブポイントにロールバックできます。
...
* [セーブポイントのマーク](../300.transaction-savepoints-of-mysql-mode/100.mark-a-savepoint-of-mysql-mode.md)
