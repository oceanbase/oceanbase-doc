...
3.  データベースドライバーの設定。
    ...
    <main id="notice" type='explain'>
      <h4>説明</h4>
      <p>MySQL Connector/J実装クラスの名前情報については、<a href="https://dev.mysql.com/doc/connector-j/en/connector-j-reference-driver-name.html">Driver/Datasource Class Name</a>を参照してください。</p>
    </main>
...
5.  その他のc3p0データベース接続プールのパラメータを設定します。
    ...
    3.  接続プールの最小接続数を5に設定します。つまり、接続プール内で維持される最小接続数は5以上です。
