...
本記事では、具体的な例を通じて、`NULL` 関連関数を使用して `NULL` 値を識別し、変換する方法を説明します。

## NULL関連関数

NULL値の特徴は、いかなる値もNULLに等しいと判断されることはなく、NULLに等しくないと判断されることもないという点です。IS NULL を用いて判断することができ、またNVL関数を使用してNULL値を認識可能な文字列に変換することもできます。
