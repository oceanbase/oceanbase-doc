...
2. 次のSQLステートメントを使用して、Hash + Rangeパーティションタイプのコンポジット・パーティション表 `test_tbl1_hr` を作成し、`TABLEGROUP` を `test_tbl_tg1` と指定します。
...
4. 次のSQLステートメントを使用して、Hash + Rangeパーティションタイプのコンポジット・パーティション表 `test_tbl3_hr` を作成し、`TABLEGROUP` を `test_tbl_tg3` と指定します。
