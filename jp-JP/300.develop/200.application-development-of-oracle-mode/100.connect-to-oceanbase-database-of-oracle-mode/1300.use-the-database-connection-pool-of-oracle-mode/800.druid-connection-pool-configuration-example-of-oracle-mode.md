...
### ステップ１：druid-oceanbase-clientプロジェクトのEclipseにインポートする
...
### ステップ3：druid-oceanbase-clientプロジェクト内のデータベース接続情報を修正する

**ステップ2：OceanBaseデータベースのURLを取得する** に記載されている情報に基づいて、`druid-oceanbase-client/src/main/resources/db.properties` ファイル内のデータベース接続情報を修正します。
