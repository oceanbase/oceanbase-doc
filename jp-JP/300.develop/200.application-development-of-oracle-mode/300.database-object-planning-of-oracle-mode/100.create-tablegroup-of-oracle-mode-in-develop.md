...
2. 次のSQLステートメントを使用して、Hash + Rangeパーティションタイプのコンポジット・パーティションテーブル `test_tbl1_hr` を作成し、`TABLEGROUP` を `test_tbl_tg1` に指定します。
...
2. 以下のSQLステートメントを使用して、Hashパーティションタイプのパーティションテーブル `test_tbl3_h` を作成し、`TABLEGROUP` を `test_tbl_tg3` に指定します。
...
4. 次のSQLステートメントを使用して、Hash + Rangeパーティションタイプのコンポジット・パーティションテーブル `test_tbl3_hr` を作成し、`TABLEGROUP` を `test_tbl_tg3` に指定します。
