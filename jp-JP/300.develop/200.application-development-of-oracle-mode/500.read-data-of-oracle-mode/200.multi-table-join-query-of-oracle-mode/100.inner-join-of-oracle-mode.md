...
サンプルテーブルを作成し、適切なデータを挿入します。結合条件を使用してデータをクエリします。
...
* WHERE結合条件とAND結合条件を使用してデータをクエリします。
...
* 内部結合条件とORDER BYによるソートを使用してデータをクエリします。
