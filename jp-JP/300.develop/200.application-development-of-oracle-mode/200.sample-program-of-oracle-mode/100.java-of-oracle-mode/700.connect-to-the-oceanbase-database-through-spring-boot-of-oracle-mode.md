...
その他のURLパラメーターの説明情報については、[データベースURL](https://www.oceanbase.com/docs/common-oceanbase-connector-j-cn-10000000001943209) を参照してください。
...
2. `User` オブジェクトを作成します。
   `User` クラスのパラメーター付きコンストラクタメソッドを定義します。指定された `id` と `name` を持つ `User` オブジェクトの作成に使用されます。
