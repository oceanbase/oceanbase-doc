...
各テナントにおけるすべてのOBServerノード上での統計イベント情報を表示します。
...
システムテナントの下で、すべてのテナントにおけるすべてのノード上の統計イベント情報を確認し、上位10件のレコードを表示します。
...
* セッションレベルの統計イベント情報を確認するには、次のビューを参照してください。

  * [GV$SESSTAT](5300.gv-sesstat-of-sys-tenant.md)
  * [V$SESSTAT](35900.v-sesstat-of-sys-tenant.md)

* テナントのすべての統計イベントの定義を確認するには、[V$STATNAME](36800.v-statname-of-sys-tenant.md)を参照してください。
