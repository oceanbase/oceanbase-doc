...
ビュー `V$OB_RES_MGR_SYSSTAT` は、すべてのテナントにおける現在のOBServerノード上のリソースグループの統計情報を表示するために使用されます。
...
すべてのテナントの現在のOBServerノード上のリソースグループに関する統計情報を照会します。
