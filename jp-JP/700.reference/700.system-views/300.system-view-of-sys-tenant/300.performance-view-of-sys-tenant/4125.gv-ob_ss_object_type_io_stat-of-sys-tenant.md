...
`GV$OB_SS_OBJECT_TYPE_IO_STAT` ビューは、テナント内の各ノード上におけるさまざまな種類のオブジェクトの読み取り、書き込み、削除の使用量を表示するために使用されます。
...
システムテナントが、テナントIDが1002のテナントにおけるすべてのノード上のさまざまな種類のオブジェクトに対する読み取り、書き込み、削除の使用量を確認します。
