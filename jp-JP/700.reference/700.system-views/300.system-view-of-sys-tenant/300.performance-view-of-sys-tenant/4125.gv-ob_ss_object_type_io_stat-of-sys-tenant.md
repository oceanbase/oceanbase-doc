...
ビュー`GV$OB_SS_OBJECT_TYPE_IO_STAT`は、テナント内の各ノードにおける異なる種類のオブジェクトの読み取り、書き込み、削除の使用量を表示するために使用されます。
...
システムテナントが、テナントIDが1002のテナントのすべてのノードにおける異なる種類のオブジェクトの読み取り、書き込み、削除の使用量を確認します。
