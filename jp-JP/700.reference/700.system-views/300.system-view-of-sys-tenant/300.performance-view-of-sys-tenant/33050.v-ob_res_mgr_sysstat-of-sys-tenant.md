...
|slug|v-ob_res_mgr_sysstat-of-sys-tenant|
...
ビュー`V$OB_RES_MGR_SYSSTAT`は、すべてのテナントにおけるこのOBServer上のリソースグループの統計情報を表示するために使用されます。
...
すべてのテナントにおけるこのOBServer上のリソースグループの統計情報を照会します。
