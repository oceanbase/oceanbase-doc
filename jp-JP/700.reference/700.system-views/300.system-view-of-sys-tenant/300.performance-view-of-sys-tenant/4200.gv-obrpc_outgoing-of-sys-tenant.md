...
すべてのテナントにおけるすべてのOBServerノード上でのRPC送信統計情報を表示します。
...
* 現在のノードで全テナントが送信したPRC統計情報を確認するには、[V$OB_RPC_OUTGOING](34700.v-obrpc_outgoing-of-sys-tenant.md)参照してください。

* すべてのノードで全テナントが受信したRPCの統計情報を確認するには、[GV$OB_RPC_INCOMING](4100.gv-obrpc_incoming-of-sys-tenant.md)参照してください。