...
| BASE_LSN | bigint(20) | NO | 最大復元可能なリトリーブポイント |
| BEGIN_LSN | bigint(20) | NO | 最小消費可能なリトリーブポイント(LSN) |
| BEGIN_SCN | bigint(20) | NO | 最小消費可能なシーン(SCN) |
| END_LSN | bigint(20) | NO | 最大連続多数派のポイント/最大消費可能なリトリーブポイント(LSN) |
| END_SCN | bigint(20) | NO | 最大連続多数派のポイント/最大消費可能なシーン(SCN) |
