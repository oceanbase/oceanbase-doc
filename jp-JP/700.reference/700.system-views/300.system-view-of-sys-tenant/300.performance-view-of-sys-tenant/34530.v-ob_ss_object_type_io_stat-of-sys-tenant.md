...
ビュー `V$OB_SS_OBJECT_TYPE_IO_STAT` は、テナントが現在のノード上で異なる種類のオブジェクトに対して行った読み取り、書き込み、削除の使用量を表示します。
...
システムテナントが、現在のノード上でテナントID 1002のテナントにおける異なる種類のオブジェクトの読み取り、書き込み、削除の使用量を確認します。
