...
1. [V$OB_PLAN_CACHE_PLAN_STAT](32700.v-ob_plan_cache_plan_stat-of-sys-tenant.md) ビューを使用して、現在のOBServerノードの `PLAN_ID` を照会します。
...
2. `PLAN_ID=605` を例に、`V$OB_PLAN_CACHE_PLAN_EXPLAIN` ビューを使用して、プランキャッシュ内の物理実行計画を照会します。
