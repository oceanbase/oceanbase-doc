...
ビュー`GV$OB_TENANT_RESOURCE_LIMIT`は、すべてのテナントにおけるすべてのOBServer上での論理リソース使用量、上限値、有効な制限条件、およびダウンタイム再起動後の最大使用量を表示するために使用されます。
...
すべてのテナントにおけるすべてのOBServer上での論理リソース使用量、上限値、有効な制限条件、およびダウンタイム再起動後の最大使用量を照会します。
