...
現在のOBServerノード上でのすべてのテナントのRPC送信統計情報を表示します。
...
| TOTAL_TIME     | bigint(20)   | NO             | 総使用時間、単位はマイクロ秒                |
...
* すべてのテナントがすべてのノードに送信したPRC統計情報を確認する：[GV$OB_RPC_OUTGOING](2000.gv-ob_obrpc_outgoing-of-sys-tenant.md)
