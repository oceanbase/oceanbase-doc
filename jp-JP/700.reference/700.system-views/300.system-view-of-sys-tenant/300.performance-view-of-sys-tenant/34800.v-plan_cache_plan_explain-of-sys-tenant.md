...
|slug|v-plan_cache_plan_explain-of-sys-tenant|
...
ビュー`V$OB_PLAN_CACHE_PLAN_EXPLAIN`は、現在のOBServerノードの計画キャッシュにキャッシュされている物理実行計画を表示するために使用されます。
  ...
  <main id="notice" type='explain'>
    <h4>説明</h4>
    <p>このビューはGet操作のみをサポートしており、クエリ時には <code>TENANT_ID</code>、<code>PLAN_ID</code> フィールドを指定する必要があります。</p>
  </main>
...
[GV$OB_PLAN_CACHE_PLAN_EXPLAIN](4300.gv-plan_cache_plan_explain-of-sys-tenant.md)