...
すべてのテナントにおけるすべてのノード上でのTabletレベルのCompactionの履歴情報を表示します。
...
システムテナントが、テナントIDが1002のテナントにおけるすべてのノード上でのTabletレベルのCompactionの履歴情報を照会し、上位5件のレコードを表示します。
...
* 現在のノード上でのTabletレベルのコンパクションの詳細な履歴情報を確認するには：[V$OB_TABLET_COMPACTION_HISTORY](33800.v-ob_tablet_compaction_history-of-sys-tenant.md)

* すべてのノード上でのTabletレベルのCompactionの進捗状況を確認するには：[GV$OB_TABLET_COMPACTION_PROGRESS](3500.gv-ob_tablet_compaction_progress-of-sys-tenant.md)
