...
|slug|v-sql_workarea_histogram-of-sys-tenant|
...
以前にすべてのワークエリアで実行された統計情報を表示します。例えば、1MB～2MBの区間でフルインメモリ処理が行われた回数やワンパス処理の回数などです。
...
システムテナントは、テナントIDが`1002`のテナントにおいて、現在のノード上で以前に実行されたすべてのワークエリアの統計情報を確認し、上位10件のレコードを表示します。
