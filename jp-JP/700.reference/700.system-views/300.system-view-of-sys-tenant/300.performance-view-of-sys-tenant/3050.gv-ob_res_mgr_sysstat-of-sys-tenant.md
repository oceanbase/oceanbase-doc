...
|slug|gv-ob_res_mgr_sysstat-sys-tenant|
...
ビュー `GV$OB_RES_MGR_SYSSTAT` は、すべてのテナント内のすべてのOBServerにおけるリソースグループの統計項目情報を表示するために使用されます。
...
すべてのテナント内のすべてのOBServerにおけるリソースグループの統計項目情報を照会します。
