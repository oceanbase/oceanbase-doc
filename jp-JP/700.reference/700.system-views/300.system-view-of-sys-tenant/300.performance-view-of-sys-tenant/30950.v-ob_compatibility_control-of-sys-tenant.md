...
|slug|v-ob_compatibility_control-sys-tenant|
...
ビュー`V$OB_COMPATIBILITY_CONTROL`は、OceanBaseデータベースのリリースバージョンに基づいて製品動作の互換性を制御できるすべての機能を表示するために使用されます。
...
| ENABLE_VERSIONS | longtext | NO | 適用されるバージョン範囲。一連の区間で表します。例：[4.2.3.1, 4.3.0.0), [4.3.1.0, +∞) |

## クエリ例

システムテナントで、OceanBaseデータベースのリリースバージョンに基づいて製品動作の互換性を制御できるすべての機能を確認します。
