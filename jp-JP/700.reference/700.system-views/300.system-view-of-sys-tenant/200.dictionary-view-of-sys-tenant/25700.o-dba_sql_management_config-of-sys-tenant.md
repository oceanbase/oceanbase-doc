...
|slug|oceanbase-dba_sql_management_config-sys-tenant|
...
SPMの進化メカニズムの詳細については、[実行計画の管理](../../../1000.performance-tuning-guide/500.sql-optimization/400.sql-optimization/700.manage-execution-plans/300.sql-execution-plan-management-spm.md)を参照してください。