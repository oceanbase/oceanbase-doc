...
|slug|oceanbase-cdb_ob_server_space_usage-sys-tenant|
...
ビュー `CDB_OB_SERVER_SPACE_USAGE` は、各テナントが各ノードで使用するストレージ容量の詳細を監視するために使用されます。
...
* SNモードで、各テナントがすべてのノードで合計して使用するストレージ容量の詳細を確認する：[oceanbase.CDB_OB_SPACE_USAGE](10470.o-cdb_ob_space_usage-of-sys-tenant.md)