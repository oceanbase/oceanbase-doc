...
* 各テナントがすべてのノードで合計して使用しているストレージ容量の詳細を確認する：[oceanbase.CDB_OB_SPACE_USAGE](10470.o-cdb_ob_space_usage-of-sys-tenant.md)