...
すべてのテナントのログストリーム（LS）レプリカの分布情報を表示します。

## フィールドの説明

|     フィールド名     |      タイプ       | NULL値を許容するか |       説明        |
|--------------|---------------|------------|-------------------------------------|
| CREATE_TIME  | datetime(6)   | NO         |   ログストリームの作成時間  |
| MODIFY_TIME  | datetime(6)   | NO         |   ログストリームの変更時間  |
