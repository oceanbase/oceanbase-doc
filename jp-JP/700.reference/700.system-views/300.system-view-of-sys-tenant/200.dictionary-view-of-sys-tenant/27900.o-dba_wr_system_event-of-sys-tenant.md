...
ビューの`WAIT_CLASS`列の値には、待機イベントが属するタイプ名と対応する待機イベントIDが含まれており、その内容は次の表のとおりです。

| 待機イベントが属するタイプ名 | 待機イベントID | 説明 |
|------|----|------|
...
| ADMINISTRATIVE | 103 | データベース管理者がコマンドを入力したことによるユーザー待機の待機イベント |
