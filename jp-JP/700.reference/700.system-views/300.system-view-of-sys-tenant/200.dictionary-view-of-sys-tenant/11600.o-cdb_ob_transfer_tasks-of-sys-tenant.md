...
| COMMENT | longtext | YES | コメント情報。現在のフリーズの原因と診断情報、およびタスクの失敗状況を記録します |
...
* すべてのテナントのTableレベルのロードバランシングタスク（Task）履歴を確認するには、[CDB_OB_TRANSFER_TASK_HISTORY](11500.o-cdb_ob_transfer_task_history-of-sys-tenant.md)参照してください。
...
* すべてのテナントのログストリームレベルのロードバランシングタスク（Task）を確認するには、次のドキュメントを参照してください。
