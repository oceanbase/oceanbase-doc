...
|slug|o-cdb_ob_database_privilege-of-sys-tenant|
...
システムテナントが、テナントIDが1002のテナントのユーザーが持つデータベース権限を確認します。
...
* [DBA_OB_DATABASE_PRIVILEGE](17500.o-dba_ob_database_privilege-of-sys-tenant.md)
