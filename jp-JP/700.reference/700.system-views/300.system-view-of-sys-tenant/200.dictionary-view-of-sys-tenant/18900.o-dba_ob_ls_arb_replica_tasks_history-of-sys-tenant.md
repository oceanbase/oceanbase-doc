...
|slug|oceanbase-dba_ob_ls_arb_replica_task_history-sys-tenant|
...
| EXECUTE_RESULT | varchar(2048) | NO | タスクの実行結果と所要時間。例："[ret:0; elapsed:72160;]" |
| CREATE_TIME | datetime | NO | タスクの生成時間 |
| FINISH_TIME | datetime | NO | タスクの完了時間 |
