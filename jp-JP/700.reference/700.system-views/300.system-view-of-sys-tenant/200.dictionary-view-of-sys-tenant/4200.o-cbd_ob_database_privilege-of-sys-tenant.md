...
| PRIV_INDEX        | varchar(3)   | NO   |  インデックスを作成および削除する権限があるかどうか   |
...
| PRIV_ALTER_ROUTINE  | varchar(3) | NO   |  ProcedureとFunctionを変更または削除する権限があるかどうか |
| PRIV_CREATE_ROUTINE | varchar(3) | NO   |  ProcedureとFunctionを作成する権限があるかどうか |
| PRIV_REFERENCES     | varchar(3) | NO   |  外部キーを作成する権限があるかどうか |
| PRIV_TRIGGER        | varchar(3) | NO   |  トリガー操作を有効にする権限があるかどうか |
| PRIV_LOCK_TABLE     | varchar(3) | NO   |  テーブルにロックをかける権限があるかどうか |
| PRIV_EVENT          | varchar(3) | NO   |  イベントを作成および管理する権限があるかどうか |
