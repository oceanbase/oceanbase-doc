...
テナント内のすべてのサブパーティションテーブルのサブパーティションに関するヒストグラムデータ（各ヒストグラムのエンドポイント）を表示します。
...
| ENDPOINT_VALUE            | decimal(10,0) | NO   | バケットエンドポイントの正規化値     |
| ENDPOINT_ACTUAL_VALUE     | text          | NO   | バケットエンドポイント値     |
| ENDPOINT_ACTUAL_VALUE_RAW | text          | NO   | バケットエンドポイントのバイナリ値     |
| ENDPOINT_REPEAT_COUNT     | decimal(10,0) | NO   | バケットエンドポイント値の頻度     |
...
* Partitionレベルのヒストグラム統計情報を確認する：[DBA_PART_HISTOGRAMS](24600.o-dba_part_histograms-of-sys-tenant.md)
...
* サブパーティションレベルの列統計情報の確認：[DBA_SUBPART_HISTOGRAMS](26000.o-dba_subpart_histograms-of-sys-tenant.md)
