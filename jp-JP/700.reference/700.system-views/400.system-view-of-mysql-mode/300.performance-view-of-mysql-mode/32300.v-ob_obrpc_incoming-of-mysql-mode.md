...
現在のOBServerノードで受信した、このテナントのRPCリクエスト統計情報を表示します。
...
| COUNT          | bigint(20)   | NO             | このタイプのRPCリクエストの受信数   |
| TOTAL_SIZE     | bigint(20)   | NO             | 合計受信データ量               |
| NET_TIME       | bigint(20)   | NO             | ネットワーク時間                  |
| WAIT_TIME      | bigint(20)   | NO             | 受信時刻からリクエストがキューに入るまでの時間       |
| QUEUE_TIME     | bigint(20)   | NO             | キュー待ち時間             |
| PROCESS_TIME   | bigint(20)   | NO             | 実際の処理にかかった時間             |
| LAST_TIMESTAMP | timestamp(6) | NO             | 前回更新時刻               |
