...
* 現在のノード上のテナントのMemTableのメモリ使用状況を確認する：[V$OB_MEMSTORE](32000.v-ob_memstore-of-mysql-mode.md)

* すべてのノード上のすべてのパーティションのMemTableの詳細情報を確認する：[GV$OB_MEMSTORE_INFO](1700.gv-ob_memstore_info-of-mysql-mode.md)