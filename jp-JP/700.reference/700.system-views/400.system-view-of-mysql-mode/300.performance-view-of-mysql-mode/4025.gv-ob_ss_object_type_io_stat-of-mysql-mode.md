...
|slug|gv-ob_ss_object_type_io_stat-mysql-compatible-mode|
...
`GV$OB_SS_OBJECT_TYPE_IO_STAT` ビューは、テナント内の各ノード上で異なる種類のオブジェクトに対する読み取り、書き込み、削除の使用量を表示するために使用されます。
...
| READ_CNT        | bigint(20)   | NO   | I/O読み取りの総回数     |
| READ_SIZE       | bigint(20)   | NO   | I/O読み取りの総サイズ、バイト単位     |
| READ_FAIL_CNT   | bigint(20)   | NO   | I/O読み取り失敗の総回数     |
| READ_IOPS       | bigint(20)   | NO   | I/O読み取りの平均IOPS     |
| WRITE_CNT       | bigint(20)   | NO   | I/O書き込みの総回数     |
| WRITE_SIZE      | bigint(20)   | NO   | I/O書き込みの総サイズ、バイト単位     |
| WRITE_FAIL_CNT  | bigint(20)   | NO   | I/O書き込み失敗の総回数     |
| WRITE_IOPS      | bigint(20)   | NO   | I/O書き込みの平均IOPS     |
...
ユーザーテナントは、自身のテナントがすべてのノード上で異なる種類のオブジェクトに対して行った読み取り、書き込み、削除の使用量を確認します。
