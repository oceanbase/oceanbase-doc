...
ユーザーテナント内で、現在のノードから送信されたRPCリクエストを確認し、上位10件のレコードを表示します。
...
* 現在のテナントがすべてのノードに送信したPRC統計情報を確認する：[GV$OB_RPC_OUTGOING](2000.gv-ob_obrpc_outgoing-of-mysql-mode.md)

* 現在のテナントが現在のノードで受信したRPCの統計情報を確認する：[V$OB_RPC_INCOMING](32300.v-ob_obrpc_incoming-of-mysql-mode.md)