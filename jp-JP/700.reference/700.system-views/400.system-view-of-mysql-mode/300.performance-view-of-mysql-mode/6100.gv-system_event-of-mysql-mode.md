...
|slug|gv-system_event-mysql-compatible-mode|
...
現在のテナントがすべてのOBServerノード上で待機しているイベントを表示し、各種類の待機イベントの発生回数、待機時間、タイムアウト回数などを統計します。
...
ユーザーテナント内で、このテナントのすべてのノードにおける待機イベントを確認し、上位10件のレコードを表示します。
