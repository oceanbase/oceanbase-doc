...
| ROWS         | bigint(20)    | NO         | 予測される結果行数          |
| COST         | bigint(20)    | NO         | 予測されるコスト            |
| PROPERTY     | varchar(4096) | NO         | 対応するOperatorの情報  |

## クエリ例

1. [V$OB_PLAN_CACHE_PLAN_STAT](32700.v-ob_plan_cache_plan_stat-of-mysql-mode.md) ビューで現在のOBServerノードの `PLAN_ID` を取得します。
