...
|slug|v-sql_workarea_histogram-mysql-compatible-mode|
...
このテナントの現在のノード上で以前に実行されたすべてのワークエリアに関する統計情報を表示します。例えば、1MB～2MBの区間でフルインメモリ処理が行われた回数やワンパス処理の回数などです。
...
このテナントの現在のノード上で以前にすべてのワークエリアが実行した統計情報を確認し、上位10件のレコードを表示します。
