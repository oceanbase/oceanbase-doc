...
| EVENT#        | bigint(20)  | NO             | 待機中のイベントのインデックス      |
| NAME          | varchar(64) | NO             | 待機中のイベント名      |
| DISPLAY_NAME  | varchar(64) | NO             | 待機中のイベントのエイリアス      |
| PARAMETER1    | varchar(64) | NO             | 待機中のイベントのパラメータ1    |
| PARAMETER2    | varchar(64) | NO             | 待機中のイベントのパラメータ2    |
| PARAMETER3    | varchar(64) | NO             | 待機中のイベントのパラメータ3    |
| WAIT_CLASS_ID | bigint(20)  | NO             | 待機中のイベントが属するクラスのID |
| WAIT_CALSS#   | bigint(20)  | NO             | 待機中のイベントが属するクラスのインデックス  |
| WAIT_CLASS    | varchar(64) | NO             | 待機中のイベントが属するクラス名  |
