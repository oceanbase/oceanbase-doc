...
MySQLテナント内で、ビュー`GV$OB_KV_CLIENT_INFO`は、現在のOBKVテナントクライアント接続の設定パラメータ情報にアクセスすることができます。
...
| runtime.continuous_failure.ceiling           | 100          | 連続運行失敗の上限。この値に達するとテーブルのアドレスがリフレッシュされます。 |
