...
1. [GV$OB_PLAN_CACHE_PLAN_STAT](2300.gv-ob_plan_cache_plan_stat-of-mysql-mode.md)ビューで現在のOBServerノードの`PLAN_ID`を照会します。
...
2. `PLAN_ID=605` を例に、`GV$OB_PLAN_CACHE_PLAN_EXPLAIN` ビューを使用してプランキャッシュ内の物理実行計画を照会します。
