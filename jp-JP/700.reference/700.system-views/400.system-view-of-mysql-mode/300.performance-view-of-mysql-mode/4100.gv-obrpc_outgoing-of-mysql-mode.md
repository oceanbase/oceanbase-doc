...
|slug|gv-obrpc_outgoing-mysql-mode|
...
現在のテナントにおけるすべてのOBServerノード上でのRPC送信統計情報を表示します。
...
ユーザーテナント内で、このテナントがすべてのノードに送信したRPCリクエストを確認し、上位10件のレコードを表示します。
...
* 現在のテナントが現在のノードから送信したPRC統計情報を確認するには、[V$OB_RPC_OUTGOING](34600.v-obrpc_outgoing-of-mysql-mode.md)参照してください。

* 現在のテナントがすべてのノードから受信したRPCの統計情報を確認するには、[GV$OB_RPC_INCOMING](4000.gv-obrpc_incoming-of-mysql-mode.md)参照してください。