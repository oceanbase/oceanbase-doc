...
|slug|v-system_event-of-mysql-mode|
...
現在のテナントにおける現在のOBServerノード上での待機イベントを表示し、各種待機イベントの発生回数、待機時間、タイムアウト回数などを統計します。
...
ユーザーテナント内で、現在のノード上における自身のテナントの待機イベントをすべて確認し、上位10件のレコードを表示します。
