...
|slug|v-ob_plan_cache_stat-mysql-mode|
...
現在のテナントが現在のOBServerノード上でキャッシュされている各プランの全体的な状態を表示します。
...
[GV$OB_PLAN_CACHE_STAT](2400.gv-ob_plan_cache_stat-of-mysql-mode.md)