...
| specific_name        | varchar(128)      | NO             | nameフィールドと同じです。</li><li>NO</li></ul>   |
| language             | varchar(4)       | NO             | 使用されていません。現在は固定値SQLになっています。                                                                          |
| sql_data_access      | varchar(32)      | NO             | 使用されていません。現在は固定値CONTAINS_SQL                                                                 |
| is_deterministic     | varchar(4)       | NO             | 使用されていません。ストアドプロシージャが`DETERMINISTIC`特性を定義するかどうかを示します。<ul><li>YES</li><li>NO</li></ul>   |
