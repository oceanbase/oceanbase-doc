...
| type                 | varchar(10)      | NO             | ストアドプロシージャのタイプ：<ul><li>PROCEDURE：ストアドプロシージャ   </li><li> FUNCTION：ストアド関数 </li></ul>    |
...
| sql_mode             | text      | NO             | ストアドプロシージャの作成または変更時に有効なSQLモードです。このモードでストアドプロシージャを実行します                                                       |
