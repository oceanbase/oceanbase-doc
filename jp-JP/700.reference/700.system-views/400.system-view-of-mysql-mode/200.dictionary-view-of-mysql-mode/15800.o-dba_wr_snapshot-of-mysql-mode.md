...
|slug|o-dba_wr_snapshot-of-mysql-mode|
...
| BEGIN_INTERVAL_TIME | timestamp(6) | NO | スナップショット開始時間。タイムスタンプはミリ秒単位で正確です |
| END_INTERVAL_TIME | timestamp(6) | NO | スナップショット終了時間。タイムスタンプはミリ秒単位で正確です |
| SNAP_FLAG | bigint(20) | YES | スナップショットのトリガー理由 |
| STARTUP_TIME | timestamp(6) | YES | プロセス起動時間。タイムスタンプはミリ秒単位で正確です |
