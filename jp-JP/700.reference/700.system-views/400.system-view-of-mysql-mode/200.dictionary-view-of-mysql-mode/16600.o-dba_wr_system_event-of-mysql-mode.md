...
| ADMINISTRATIVE | 103 | データベース管理者がコマンドを入力したことによりユーザーが待機した待機イベント |
| CONCURRENCY | 104 | データベース内部リソースを待機している待機イベント |
| COMMIT | 105 | ログコミットに関連する待機イベント |
| IDLE | 106 | セッションが非アクティブ状態でタスクを待機している待機イベント |
| NETWORK | 107 | ネットワーク通信に関連する待機イベント |
| USER_IO | 108 | ユーザーI/Oを待機している待機イベント |
| SYSTEM_IO | 109 | バックグラウンドプロセスのI/Oを待機している待機イベント |
