...
本テナント内のすべてのノードにおける、過去のすべてのワークエリアで実行された統計情報を表示します。例えば、1MB～2MBの範囲でフルインメモリ処理が行われた回数や、ワンパス処理の回数などです。
...
本テナント内のすべてのノードにおける、過去のすべてのWorkareaで実行された統計情報を確認し、上位10件のレコードを表示します。
