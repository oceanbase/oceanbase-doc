...
このテナントの現在のノード上で、過去にすべてのワークエリアで実行された統計情報を表示します。これには、1MB～2MBの範囲で完全にインメモリ処理された回数や、ワンパス処理の回数などが含まれます。
...
このテナントの現在のノード上で、以前にすべてのワークエリアで実行された統計情報を確認し、上位10件のレコードを表示します。
