...
* 現在のノード上のTabletレベルのコンパクションの詳細な履歴情報を確認するには：[V$OB_TABLET_COMPACTION_HISTORY](33900.v-ob_tablet_compaction_history-of-oracle-mode.md)

* すべてのノード上のTabletレベルのCompactionの進捗状況を確認するには：[GV$OB_TABLET_COMPACTION_PROGRESS](3600.gv-ob_tablet_compaction_progress-of-oracle-mode.md)
