...
1. [GV$OB_PLAN_CACHE_PLAN_STAT](2300.gv-ob_plan_cache_plan_stat-of-oracle-mode.md) ビューを使用して、現在のOBServerノードの `PLAN_ID` を照会します。
...
2. `PLAN_ID=800` を例に、`GV$OB_PLAN_CACHE_PLAN_EXPLAIN` ビューを使用して、プランキャッシュ内の物理実行計画を照会します。
