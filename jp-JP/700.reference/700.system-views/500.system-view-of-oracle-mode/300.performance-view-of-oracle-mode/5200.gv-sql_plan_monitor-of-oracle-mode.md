...
|slug|gv-sql_plan_monitor-oracle-compatible-mode|
...
| FIRST_CHANGE_TIME       | TIMESTAMP(6)  | YES  | 演算子が最初の行のデータを吐き出した時間|
| LAST_CHANGE_TIME        | TIMESTAMP(6)  | YES  | 演算子が最後の行のデータを吐き出した時間|
