...
| DISPLAY_NAME | VARCHAR2(64) | NO | 待機イベントの表示名 |
| PARAMETER1 | VARCHAR2(64) | NO | 待機イベントパラメータ1 |
| PARAMETER2 | VARCHAR2(64) | NO | 待機イベントパラメータ2 |
| PARAMETER3 | VARCHAR2(64) | NO | 待機イベントパラメータ3 |
| WAIT_CLASS_ID | NUMBER | NO | 待機イベントが属するクラスのID |
| WAIT_CLASS# | NUMBER | NO | 待機イベントが属するクラスのインデックス |
| WAIT_CLASS | VARCHAR2(64) | NO | 待機イベントが属するクラス名 |

## クエリ例

ユーザーテナント内で、そのテナントのすべての待機イベントに関する定義を確認し、上位10件のレコードを表示します。
