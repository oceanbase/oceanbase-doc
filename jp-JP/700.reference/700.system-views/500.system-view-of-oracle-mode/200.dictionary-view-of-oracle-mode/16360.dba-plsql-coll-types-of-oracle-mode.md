...
|---------------------------|---|---|--------------------------------------------|
| OWNER              | VARCHAR2(128) | YES  | PL/SQLコレクションタイプの所有者を表します。|
...
* パッケージ内で定義されたコレクションタイプの全体的な情報を確認する：[ALL_PLSQL_COLL_TYPES](2760.all-plsql-coll-type-of-oracle-mode.md)。
* 現在のユーザーパッケージ内で定義されたコレクションタイプの全体的な情報を確認する：[USER_PLSQL_COLL_TYPES](26850.user-plsql-type-of-oracle-mode.md)。