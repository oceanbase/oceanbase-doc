...
データベースで利用可能なユーザー定義の集合型を一覧表示します。列はALL_COLL_TYPESと同じです。
...
| UPPER_BOUND        | NUMBER(38)    | YES            | VARYINGに対して、集合の最大サイズを記録します                                                                           |
| ELEM_TYPE_MOD      | VARCHAR2(7)   | YES            | 現在このフィールドはサポートされていません。現在、このフィールドはデフォルトでNULLです                                                                         |
...
| ELEM_STORAGE       | CHAR(3)       | YES            | 現在このフィールドはサポートされていません。現在、このフィールドはデフォルトでNULLです                                                                         |
| NULLS_STORED       | CHAR(1)       | YES            | 現在このフィールドはサポートされていません。現在、このフィールドはデフォルトでNULLです                                                                         |
