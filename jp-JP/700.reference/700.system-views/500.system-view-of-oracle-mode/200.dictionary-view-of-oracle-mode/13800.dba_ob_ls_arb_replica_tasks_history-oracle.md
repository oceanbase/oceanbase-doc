...
|slug|dba_ob_ls_arb_replica_task_history-oracle-compatible-mode|
...
| EXECUTE_RESULT | VARCHAR2(2048) | NO | タスクの実行結果と実行時間。形式は「[ret:0; elapsed:72160;]」です。 |
| CREATE_TIME | TIMESTAMP(6) | NO | タスク作成時間 |
| FINISH_TIME | TIMESTAMP(6) | NO | タスク完了時間 |
