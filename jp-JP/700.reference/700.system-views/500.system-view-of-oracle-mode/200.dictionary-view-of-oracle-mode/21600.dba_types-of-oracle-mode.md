...
|slug|dba_types-oracle-compatible-mode|
...
| INCOMPLETE       | CHAR(2)       | NO             | 不完全なタイプかどうか。メソッドや属性はなく、名前のみが存在する場合 |
...
* 現在のユーザーがアクセスできるユーザー定義型を確認するには、次のURLを参照してください。[ALL_TYPES](6000.all_types-of-oracle-mode.md)

* 現在のユーザーが所有するユーザー定義型を確認するには、次のURLを参照してください。[USER_TYPES](30500.user_types-of-oracle-mode.md)