...
現在ユーザーがアクセス可能なストレージオブジェクトのテキストソースを表示します。
...
現在ユーザーがアクセス可能なストレージオブジェクトのテキストソースを確認し、最初の2件のレコードを表示します。
...
* 現在ユーザーが所有するストレージオブジェクトのテキストソースを確認する：[USER_SOURCE](29600.user_source-of-oracle-mode.md)