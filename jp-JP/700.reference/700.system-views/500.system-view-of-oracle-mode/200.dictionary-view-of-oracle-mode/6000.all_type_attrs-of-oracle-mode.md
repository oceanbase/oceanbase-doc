...
現在ユーザーがアクセス可能なユーザー定義型の属性情報を一覧表示します。
...
| SCALE              | NUMBER(38)    | NO             | 数値型の小数点以下の桁数          |
...
現在ユーザーがアクセス可能なすべてのユーザー定義型の属性情報を確認し、上位10件を表示します。
...
* 現在のテナント内のすべてのユーザー定義タイプの属性情報を確認する：[DBA_TYPE_ATTRS](22200.dba_type_attrs-of-oracle-mode.md)

* 現在のユーザーが持つすべての定義タイプの属性情報を確認する：[USER_TYPE_ATTRS](31800.user_type_attrs-of-oracle-mode.md)