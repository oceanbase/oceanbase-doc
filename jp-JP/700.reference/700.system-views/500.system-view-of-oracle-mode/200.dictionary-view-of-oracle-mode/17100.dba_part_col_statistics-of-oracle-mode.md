...
本テナントのパーティションテーブルにおけるパーティションの列統計情報とヒストグラム情報を表示します。
...
| GLOBAL_STATS   | VARCHAR2(3)   | NO            | <ul><li>`YES`：統計情報が直接収集されたことを示します。   </li><li> `NO`：統計情報がサブパーティションの統計情報から推定されたか、統計情報が収集されていないことを示します。 </li></ul>   |
| USER_STATS     | VARCHAR2(3)   | NO            | パーティション統計情報がユーザー設定であるかどうかを示します                                                 |
| NOTES          | VARCHAR2(80)  | NO            | 追加の属性を記録します                                                        |
| AVG_COL_LEN    | NUMBER        | NO            | 列の平均長                                                           |
| HISTOGRAM      | VARCHAR2(15)  | NO            | ヒストグラムのタイプ                                                            |

## 関連ビューまたはドキュメント

* 現在ユーザーがアクセス可能なパーティションテーブルのパーティションの列統計情報を確認する：[ALL_PART_COL_STATISTICS](2500.all_part_col_statistics-of-oracle-mode.md)

* 現在ユーザーが所有するパーティションテーブルのパーティションの列統計情報を確認する：[USER_PART_COL_STATISTICS](27900.user_part_col_statistics-of-oracle-mode.md)
