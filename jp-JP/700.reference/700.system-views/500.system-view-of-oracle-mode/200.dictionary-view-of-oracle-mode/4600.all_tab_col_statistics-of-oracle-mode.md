...
`ALL_TAB_COL_STATISTICS`は、現在ユーザーがアクセス可能なテーブルの列統計情報とヒストグラム情報を表示するために使用されます。
...
* テナント内のすべてのテーブルの列統計情報を確認する：[DBA_TAB_COL_STATISTICS](20700.dba_tab_col_statistics-of-oracle-mode.md)
