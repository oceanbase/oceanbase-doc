...
| TYPECODE         | VARCHAR2(10)  | NO             | オブジェクトを表す型。例：OBJECT、COLLなど |
| ATTRIBUTES       | NUMBER(38)    | NO             | 型が含む属性数                  |
| METHODS          | NUMBER(38)    | NO             | 型が含むメソッド数                  |
| PREDEFINED       | CHAR(2)       | NO             | システム定義型かどうか                |
| INCOMPLETE       | CHAR(2)       | NO             | 不完全型かどうか。名前のみでメソッドや属性がない場合 |
| FINAL            | CHAR(3)       | NO             | 継承不可かどうか                   |
...
| TYPEID           | NUMBER(38)    | YES            | 現在このフィールドはサポートされていません。現在デフォルトはNULLです   |

## クエリ例

現在のテナント配下のすべてのユーザー定義タイプを確認します。
