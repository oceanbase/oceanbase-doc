...
| TYPECODE         | VARCHAR2(10)  | NO             | オブジェクトの型を表す文字列。例：OBJECT、COLLなど |
| ATTRIBUTES       | NUMBER(38)    | NO             | 型が含む属性数                  |
| METHODS          | NUMBER(38)    | NO             | 型が含むメソッド数                  |
| PREDEFINED       | CHAR(2)       | NO             | システムで事前に定義された型かどうか                |
...
| TYPEID           | NUMBER(38)    | YES            | 現在このフィールドはサポートされていません。現在のデフォルト値はNULLです   |

## クエリ例

現在のテナント配下のすべてのユーザー定義型を確認します。
...
* 現在のユーザーが所有するユーザー定義型を確認する：[USER_TYPES](32000.user_types-of-oracle-mode.md)