...
現在のテナントで利用可能なユーザー定義型のプロパティ情報を一覧表示します。
...
| CHAR_USED          | CHAR(1)       | YES            | この属性がバイト長(B)で定義されているか、文字長(C)で定義されているかを示す |

## クエリ例

現在のテナント内のすべてのユーザー定義タイプのプロパティ情報を確認し、上位10件を表示します。
