...
現在のテナントで利用可能なユーザー定義型の属性情報を一覧表示します。
...
| ATTR_NAME          | VARCHAR2(64)  | NO             | 型の属性名                   |
...
| NUMBER_PRECISION   | NUMBER(38)    | NO             | 属性数値型の長さ               |
...
現在のテナント内のすべてのユーザー定義型の属性情報を確認し、上位10件を表示します。
...
* 現在のユーザーが所有するすべてのカスタム型のプロパティ情報を確認する：[USER_TYPE_ATTRS](31800.user_type_attrs-of-oracle-mode.md)