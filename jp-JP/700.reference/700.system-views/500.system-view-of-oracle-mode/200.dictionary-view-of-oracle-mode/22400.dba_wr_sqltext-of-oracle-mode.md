...
|slug|dba_wr_sqltext-oracle-compatible-mode|
...
ビュー `DBA_WR_SQLTEXT` は、テナント内のWRから収集されたSQLテキストを表示するために使用されます。
...
| QUERY_SQL | CLOB         | NO   |  SQLテキスト      |
| SQL_TYPE  | NUMBER(38)   | NO   |  ステートメントのタイプ      |
...
このテナントのWRが収集したSQLテキストを照会し、1件目のレコードを表示します。
...
[oceanbase.CDB_WR_SQLTEXT](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/13700.o-cdb_wr_sqltext-of-sys-tenant.md)