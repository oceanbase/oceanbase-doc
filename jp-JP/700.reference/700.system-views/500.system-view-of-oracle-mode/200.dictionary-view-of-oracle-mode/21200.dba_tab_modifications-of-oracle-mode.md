...
| INSERTS | NUMBER | NO | 約合計挿入回数 |
| UPDATES | NUMBER | NO | 約合計更新回数 |
| DELETES | NUMBER | NO | 約合計削除回数 |
| TIMESTAMP | DATE | NO | テーブルの最終変更時刻を示す |
| TRUNCATED | VARCHAR2(3) | NO | 現在実質的な意味はなく、デフォルトはNULL |
| DROP_SEGMENTS | NUMBER | NO | 現在実質的な意味はなく、デフォルトはNULL |
