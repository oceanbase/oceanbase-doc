...
現在ユーザーがアクセス可能なパーティションテーブルのうち、テーブル `T_SUBPART` のパーティションのヒストグラム情報を確認します。
...
* テナント内のすべてのパーティションテーブルのパーティションに関するヒストグラム情報を表示する：[DBA_PART_HISTOGRAMS](17200.dba_part_histograms-of-oracle-mode.md)

* 現在のユーザーが所有するパーティションテーブルのパーティションに関するヒストグラム情報を表示する：[USER_PART_HISTOGRAMS](28000.user_part_histograms-of-oracle-mode.md)

* テーブルレベルのヒストグラム統計情報は、以下のビューを参照してください。
...
* サブパーティションレベルのヒストグラム統計情報は、以下のビューを参照してください。
...
* テーブルレベルの列統計情報は、以下のビューを参照してください。
...
* グローバルレベルの列統計情報は、以下のビューを参照してください。
...
* パーティションレベルの列統計情報は、以下のビューを参照してください。
...
* サブパーティションレベルの列統計情報は、以下のビューを参照してください。
