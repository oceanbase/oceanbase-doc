...
現在ユーザーがアクセス可能なパーティションテーブル内の、すべてのパーティションに関するヒストグラム情報を表示します。
...
現在ユーザーがアクセス可能なパーティションテーブルのうち、テーブル `T_SUBPART` のパーティションに関するヒストグラム情報を確認します。
...
* テナント内のすべてのパーティションテーブルのパーティションに関するヒストグラム情報を確認する：[DBA_PART_HISTOGRAMS](17200.dba_part_histograms-of-oracle-mode.md)

* 現在のユーザーが所有するパーティションテーブルのパーティションに関するヒストグラム情報を確認する：[USER_PART_HISTOGRAMS](28000.user_part_histograms-of-oracle-mode.md)
