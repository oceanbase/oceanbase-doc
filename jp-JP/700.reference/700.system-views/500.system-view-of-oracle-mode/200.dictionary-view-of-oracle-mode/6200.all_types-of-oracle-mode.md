...
| INSTANTIABLE     | CHAR(3)       | NO             | インスタンス化できるかどうか                    |
...
現在ユーザーがアクセス可能なすべてのユーザー定義型を確認します。
...
* 現在のユーザーが持つユーザー定義型を確認する：[USER_TYPES](32000.user_types-of-oracle-mode.md)