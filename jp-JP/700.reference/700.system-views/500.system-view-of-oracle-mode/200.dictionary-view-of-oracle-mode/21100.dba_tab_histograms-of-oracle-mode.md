...
現在のテナント内にあるすべてのテーブルのテーブルレベルヒストグラム情報を表示します。
...
| TABLE_NAME                | VARCHAR2(128)  | NO         | ヒストグラム対象テーブル名       |
| COLUMN_NAME               | VARCHAR2(128)  | NO         | ヒストグラム対象列名       |
...
| SCOPE                     | VARCHAR2(7)    | NO         | ヒストグラム範囲       |

## クエリ例

このテナントのテーブル `T_SUBPART` のテーブルレベルヒストグラムに関する情報を確認します。
...
* 現在のユーザーがアクセス可能なすべてのテーブルのテーブルレベルヒストグラム統計情報を確認する：[ALL_TAB_HISTOGRAMS](5000.all_tab_histograms-of-oracle-mode.md)
...
* Globalレベルの列統計情報については、以下のビューを参照してください：
