...
現在のテナントのテーブル `T_SUBPART` のテーブルレベルのヒストグラム情報を確認します。
...
* 現在のユーザーがアクセス可能なすべてのテーブルのテーブルレベルのヒストグラム統計情報を確認する：[ALL_TAB_HISTOGRAMS](5000.all_tab_histograms-of-oracle-mode.md)

* 現在のユーザーが所有するすべてのテーブルのテーブルレベルのヒストグラム統計情報を確認する：[USER_TAB_HISTOGRAMS](30700.user_tab_histograms-of-oracle-mode.md)
