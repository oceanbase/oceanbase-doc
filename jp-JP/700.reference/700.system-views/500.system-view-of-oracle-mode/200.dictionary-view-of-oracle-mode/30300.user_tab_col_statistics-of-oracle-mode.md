...
現在ユーザーが所有するテーブルの列統計情報とヒストグラム情報を表示します。
...
| NOTES         | VARCHAR2(80)  | YES            | 追加の属性を記録                                   |
...
現在ユーザーが所有するテーブルのうち、`T_SUBPART` テーブルの列統計情報とヒストグラム情報を確認します。
...
* 現在のユーザーがアクセス可能なテーブルの統計情報を確認する：[ALL_TAB_COL_STATISTICS](4600.all_tab_col_statistics-of-oracle-mode.md)

* テナント内のすべてのテーブルの統計情報を確認する：[DBA_TAB_COL_STATISTICS](20700.dba_tab_col_statistics-of-oracle-mode.md)
...
* Partitionレベルの列統計情報については、以下のビューを参照してください：
...
* Subpartitionレベルの列統計情報については、以下のビューを参照してください：
...
* Partitionレベルのヒストグラム統計情報については、以下のビューを参照してください：
...
* Subpartitionレベルのヒストグラム統計情報については、以下のビューを参照してください：
