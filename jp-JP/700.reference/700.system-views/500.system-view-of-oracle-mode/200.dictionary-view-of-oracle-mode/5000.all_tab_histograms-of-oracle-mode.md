...
|           フィールド名            |       型       | NULL許容   |      説明       |
|---------------------------|----------------|------------|---------------|
| OWNER                     | VARCHAR2(128)  | NO         | ヒストグラムの所有者      |
...
| SCOPE                     | VARCHAR2(7)    | YES        | ヒストグラムの範囲       |
...
* 現在のテナントのすべてのテーブルのテーブルレベルヒストグラム統計情報を表示する：[DBA_TAB_HISTOGRAMS](21100.dba_tab_histograms-of-oracle-mode.md)

* 現在のユーザーが所有するすべてのテーブルのテーブルレベルヒストグラム統計情報を表示する：[USER_TAB_HISTOGRAMS](30700.user_tab_histograms-of-oracle-mode.md)
