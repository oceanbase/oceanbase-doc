...
現在ユーザーがアクセス可能なすべてのテーブルのテーブルレベルヒストグラムに関する情報を表示します。
...
| SCOPE                     | VARCHAR2(7)    | YES        | ヒストグラムのスコープ       |

## クエリ例

現在ユーザーがアクセス可能なすべてのテーブルのうち、テーブル `T_SUBPART` のテーブルレベルヒストグラムに関する情報を確認します。
...
* 現在のテナントのすべてのテーブルのテーブルレベルヒストグラム統計情報を確認する：[DBA_TAB_HISTOGRAMS](21100.dba_tab_histograms-of-oracle-mode.md)

* 現在のユーザーが所有するすべてのテーブルのテーブルレベルヒストグラム統計情報を確認する：[USER_TAB_HISTOGRAMS](30700.user_tab_histograms-of-oracle-mode.md)
