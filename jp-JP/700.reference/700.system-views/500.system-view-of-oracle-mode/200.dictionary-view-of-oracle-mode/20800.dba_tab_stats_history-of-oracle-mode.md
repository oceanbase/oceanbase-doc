...
現在のテナントに属するすべてのテーブルの統計変更履歴を表示します。
...
* 現在のユーザーがアクセス可能なすべてのテーブルの統計変更履歴を確認するには：[ALL_TAB_STATS_HISTORY](5300.all_tab_stats_history-of-oracle-mode.md)

* 現在のユーザーが所有するすべてのテーブルの統計変更履歴を確認するには：[USER_TAB_STATS_HISTORY](29700.user_tab_stats_history-of-oracle-mode.md)