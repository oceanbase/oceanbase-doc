...
現在ユーザーがアクセス可能なすべてのテーブルの統計変更履歴を表示します。
...
現在ユーザーがアクセス可能なテーブルのうち、テーブル `T_SUBPART` の統計変更履歴を確認します。
...
* 現在のユーザーが所有するすべてのテーブルの統計変更履歴を確認する：[USER_TAB_STATS_HISTORY](31200.user_tab_stats_history-of-oracle-mode.md)