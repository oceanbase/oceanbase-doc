...
| STATS_UPDATE_TIME | TIMESTAMP(6) WITH TIME ZONE | YES            | 統計情報更新日時 |
...
* 現在ユーザーが所有するすべてのテーブルの統計変更履歴を確認する：[USER_TAB_STATS_HISTORY](31200.user_tab_stats_history-of-oracle-mode.md)