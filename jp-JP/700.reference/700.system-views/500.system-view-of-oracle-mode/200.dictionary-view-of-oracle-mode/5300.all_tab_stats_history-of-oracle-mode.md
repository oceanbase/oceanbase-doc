...
現在のユーザーがアクセス可能なすべてのテーブルの統計変更履歴を表示します。
...
| STATS_UPDATE_TIME | TIMESTAMP(6) WITH TIME ZONE | YES            | 統計情報更新時間 |

## クエリ例

現在のユーザーがアクセス可能なテーブルのうち、テーブル `T_SUBPART` の統計変更履歴を確認します。
...
* このテナントのすべてのテーブルの統計変更履歴を確認するには、[DBA_TAB_STATS_HISTORY](20800.dba_tab_stats_history-of-oracle-mode.md)参照してください。

* 現在のユーザーが所有するすべてのテーブルの統計変更履歴を確認するには、[USER_TAB_STATS_HISTORY](29700.user_tab_stats_history-of-oracle-mode.md)参照してください。