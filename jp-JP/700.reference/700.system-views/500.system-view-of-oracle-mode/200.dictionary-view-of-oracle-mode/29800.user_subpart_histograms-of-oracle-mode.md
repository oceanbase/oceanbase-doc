...
現在ユーザーが所有するパーティションテーブルのサブパーティションに関するヒストグラム情報を表示します。
...
現在ユーザーが所有するパーティションテーブルのうち、テーブル `T_SUBPART` のサブパーティションのヒストグラム情報を確認します。
...
* 現在ユーザーがアクセス可能なパーティションテーブルのサブパーティションのヒストグラム情報を確認する：[ALL_SUBPART_HISTOGRAMS](4200.all_subpart_histograms-of-oracle-mode.md)

* 本テナント内のすべてのパーティションテーブルのサブパーティションのヒストグラム情報を確認する：[DBA_SUBPART_HISTOGRAMS](20200.dba_subpart_histograms-of-oracle-mode.md)
