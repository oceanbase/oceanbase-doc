...
現在のユーザーが所有するパーティションテーブルのパーティションに関する列統計情報とヒストグラム情報を表示します。
...
| GLOBAL_STATS   | VARCHAR2(3)   | YES            | <ul><li>`YES`：統計情報が直接収集されたことを示す   </li><li> `NO`：統計情報がセカンダリパーティションの統計情報から推定されたか、統計情報が収集されていないことを示す</li></ul>    |
...
現在のユーザーが所有するパーティションテーブルのうち、`T_SUBPART` テーブルのパーティションに関する列統計情報とヒストグラム情報を確認します。
...
* 現在のユーザーがアクセス可能なパーティションテーブルのパーティションに関する列統計情報を確認する：[ALL_PART_COL_STATISTICS](2500.all_part_col_statistics-of-oracle-mode.md)
