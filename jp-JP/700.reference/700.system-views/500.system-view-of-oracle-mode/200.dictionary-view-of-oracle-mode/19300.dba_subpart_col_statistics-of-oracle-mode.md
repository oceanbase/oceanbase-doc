...
このテナントのパーティションテーブルにおけるサブパーティションの列統計情報とヒストグラム情報を表示します。
...
| GLOBAL_STATS      | VARCHAR2(3)   | NO            | <ul><li>`YES`：統計情報が収集されたことを示す </li><li> `NO`：統計情報が収集されていないことを示す</li></ul>    |
| USER_STATS        | VARCHAR2(3)   | NO            | パーティション統計情報がユーザー設定であるかどうかを示す                        |
| NOTES             | VARCHAR2(80)  | NO            | その他の追加属性を記録                               |
| AVG_COL_LEN       | NUMBER        | NO            | 列の平均長                                  |
| HISTOGRAM         | VARCHAR2(15)  | NO            | ヒストグラムのタイプ                                   |

## クエリ例

このテナントのパーティションテーブル `T_SUBPART` のコンポジット・パーティションの列統計情報を確認します。
...
* 現在のユーザーがアクセスできるパーティションテーブルのサブパーティションの列統計情報を確認するには、[ALL_SUBPART_COL_STATISTICS](3900.all_subpart_col_statistics-of-oracle-mode.md)を参照してください。

* 現在のユーザーが所有するパーティションテーブルのサブパーティションの列統計情報を確認するには、[USER_SUBPART_COL_STATISTICS](28200.user_subpart_col_statistics-of-oracle-mode.md)を参照してください。
