...
現在のユーザーが所有するパーティションテーブルのうち、テーブル `T_SUBPART` のパーティションに関するヒストグラム情報を確認します。
...
* このテナント内のすべてのパーティションテーブルのパーティションのヒストグラム情報を確認する：[DBA_PART_HISTOGRAMS](17200.dba_part_histograms-of-oracle-mode.md)
