...
現在のユーザーが所有するパーティションテーブルの、テーブル `T_SUBPART` のパーティションに関するヒストグラム情報を表示します。
...
* 現在のユーザーがアクセス可能なパーティションテーブルのパーツのヒストグラム情報を表示する：[ALL_PART_HISTOGRAMS](2600.all_part_histograms-of-oracle-mode.md)

* このテナント内のすべてのパーティションテーブルのパーツのヒストグラム情報を表示する：[DBA_PART_HISTOGRAMS](17200.dba_part_histograms-of-oracle-mode.md)
