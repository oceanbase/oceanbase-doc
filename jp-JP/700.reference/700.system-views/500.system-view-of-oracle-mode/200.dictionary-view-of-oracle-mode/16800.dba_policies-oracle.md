...
現在のテナント内のすべてのテーブルまたはビューに対するアクセス制御ポリシーを表示します。特定のテーブルに対してアクセス制御を行う場合、そのテーブル上に複数のポリシーを作成できます。
...
* 現在のユーザーがアクセスできるすべてのテーブルまたはビューのアクセス制御ポリシーを確認するには、次のURLを参照してください。[ALL_POLICIES](2800.all_policies-oracle.md)

* 現在のユーザーが所有するテーブルまたはビューのアクセス制御ポリシーを確認するには、次のURLを参照してください。[USER_POLICIES](26900.user_policies-oracle.md)