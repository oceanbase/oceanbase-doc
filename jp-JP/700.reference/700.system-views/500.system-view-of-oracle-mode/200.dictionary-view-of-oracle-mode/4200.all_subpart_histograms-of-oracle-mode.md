...
現在ユーザーがアクセス可能なパーティションテーブルのうち、テーブル `T_SUBPART` のサブパーティションに関するヒストグラム情報を確認します。
...
* テナント内のすべてのパーティションテーブルのサブパーティションのヒストグラム情報を確認する：[DBA_SUBPART_HISTOGRAMS](20200.dba_subpart_histograms-of-oracle-mode.md)
