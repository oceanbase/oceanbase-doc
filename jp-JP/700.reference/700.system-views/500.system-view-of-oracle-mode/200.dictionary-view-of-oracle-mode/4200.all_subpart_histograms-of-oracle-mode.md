...
現在ユーザーがアクセス可能なパーティションテーブルのすべてのサブパーティションに関するヒストグラム情報を表示します。

## フィールドの説明

|           フィールド名            |       型       | NULL許容   |      説明       |
|---------------------------|----------------|------------|---------------|
| OWNER                     | VARCHAR2(128)  | NO         | ヒストグラムが属するユーザー      |
...
現在ユーザーがアクセス可能なパーティションテーブルのうち、テーブル `T_SUBPART` のサブパーティションのヒストグラム情報を確認します。
...
* このテナント内のすべてのパーティションテーブルのサブパーティションのヒストグラム情報を確認する：[DBA_SUBPART_HISTOGRAMS](20200.dba_subpart_histograms-of-oracle-mode.md)

* 現在ユーザーが所有するパーティションテーブルのサブパーティションのヒストグラム情報を確認する：[USER_SUBPART_HISTOGRAMS](29800.user_subpart_histograms-of-oracle-mode.md)
