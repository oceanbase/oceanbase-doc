...
`ALL_PART_COL_STATISTICS`は、現在ユーザーがアクセス可能なパーティションテーブルのパーティションにおける列統計情報とヒストグラム情報を表示するために使用されます。
...
| NUM_BUCKETS    | NUMBER        | YES            | 列のヒストグラムにおけるバケットの数                                                        |
...
| NOTES          | VARCHAR2(80)  | YES            | その他の追加情報を記録します                                                        |
| AVG_COL_LEN    | NUMBER        | YES            | 列の平均長                                                           |
| HISTOGRAM      | VARCHAR2(15)  | YES            | ヒストグラムタイプ                                                            |

## クエリ例

現在ユーザーがアクセス可能なパーティションテーブルであるテーブル `T_SUBPART` のパーティションにおける列統計情報とヒストグラム情報を確認します。
...
* このテナント内のすべてのパーティションテーブルのパーティションにおける列統計情報を確認する：[DBA_PART_COL_STATISTICS](17100.dba_part_col_statistics-of-oracle-mode.md)

* 現在ユーザーが所有するパーティションテーブルのパーティションにおける列統計情報を確認する：[USER_PART_COL_STATISTICS](27900.user_part_col_statistics-of-oracle-mode.md)
