...
## 特定期間におけるリクエスト数がトップNにランクインしたSQLの照会

以下のステートメントを実行すると、特定の期間においてリクエスト数がトップNにランクインしたSQLを照会できます。
...
## 特定期間内の平均RTがTOP NにランクインしたSQLを照会する

以下のステートメントを実行すると、特定期間内の平均RTがTOP NにランクインしたSQLを照会できます。
...
## すべてのSQLの中で平均実行時間が上位N位に入るSQLを照会する

以下のステートメントを実行すると、すべてのSQLの中で平均実行時間が上位N位に入るSQLを照会できます。
