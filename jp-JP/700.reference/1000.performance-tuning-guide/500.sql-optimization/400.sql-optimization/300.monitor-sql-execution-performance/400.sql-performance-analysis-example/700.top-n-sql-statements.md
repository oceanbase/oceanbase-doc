...
## 特定時間帯におけるリクエスト回数がTOP NにランクインしたSQLを照会する

以下のステートメントを実行すると、特定時間帯におけるリクエスト回数がTOP NにランクインしたSQLを照会できます。
...
以下のステートメントを実行すると、特定の時間帯における平均RTがTOP Nに入るSQLを照会できます。
...
## すべてのSQLの平均実行時間がTOP Nに入るSQLを照会する

以下のステートメントを実行すると、すべてのSQLの平均実行時間がTOP Nに入るSQLを照会できます。
