...
## 特定の期間内において、リクエスト数がTOP NにランクインしたSQLを照会する

以下のステートメントを実行することで、特定の期間内において、リクエスト数がTOP NにランクインしたSQLを照会できます。
...
## 特定の期間内において、平均RTがTOP NにランクインしたSQLを照会する

以下のステートメントを実行することで、特定の期間内において、平均RTがTOP NにランクインしたSQLを照会できます。
...
## すべてのSQLの中で、平均実行時間がTOP NにランクインしたSQLを照会する

以下のステートメントを実行することで、すべてのSQLの中で、平均実行時間がTOP NにランクインしたSQLを照会できます。
