...
`DISPLAY` 関数は、履歴の `EXPLAIN` プランを照会し、フォーマットするために使用されます。
  ...
  <main id="notice">
  <h4>機能の適用範囲</h4>
  <p>この機能は、コミュニティエディションのV4.2.5バージョンからサポートされています。</p>
  </main>
