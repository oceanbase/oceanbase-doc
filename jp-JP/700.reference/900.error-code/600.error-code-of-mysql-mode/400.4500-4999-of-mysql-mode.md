...
## ERROR 4624 (HY000) : zone '%s' server\'%s\' %sリソースが不足しており、新しいユニットを保持できません
...
## ERROR 4626 (HY000) : リソースプール\'%s\'は既にテナントに付与されています
...
## ERROR 4628 (HY000) : サーバーは既に削除されました
...
## ERROR 4629 (HY000) : サーバーは削除状態ではありません
...
## ERROR 4630 (HY000) : サーバーはサーバーホワイトリストにありません
...
## ERROR 4631 (HY000) : サーバーゾーンが一致しません
...
## ERROR 4759 (HY000) : アクセス中の仮想テーブルでエラーが発生しました。実際のエラーコード：%d
