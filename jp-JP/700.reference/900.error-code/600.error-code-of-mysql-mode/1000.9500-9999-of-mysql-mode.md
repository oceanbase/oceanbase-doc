...
## ERROR 9502 (HY000) : OUTおよびIN/OUTモードはこのコンテキストでは使用できません
...
## ERROR 9503 (HY000) : schema '%.\*s'内で型 %.\*s のオブジェクト '%.\*s' が見つかりません
...
## ERROR 9506 (HY000) : %sはスキーマレベルのプログラムのみが許可されています
...
## ERROR 9507 (HY000) : '%.\*s' に対して最大1つの宣言しか許可されていません
...
## ERROR 9508 (HY000) : RECORD、TABLE、または引数リスト内の重複フィールドは許可されません
...
## ERROR 9509 (HY000) : Pragma AUTONOMOUS_TRANSACTIONはここでは指定できません
...
## ERROR 9514 (HY000) : NOT NULLとして宣言された変数には初期化代入が必要です
