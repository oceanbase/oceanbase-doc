...
ノードの初期化を実行する前に、必要なRPMパッケージをマシンにダウンロードしておいてください。手動でダウンロードするか、obshell-sdk-pythonを使用してダウンロードすることもできます。obshell-sdk-pythonを使用したダウンロードの詳細については、[RPMパッケージのダウンロード](../1500.other-api/400.download-rpm-package-of-python.md)を参照してください。
...
obshell-sdk-goでAPIメソッドを呼び出す方法については、[ノードの初期化](../../200.go/200.cluster-management/550.initialize-node-of-go.md)を参照してください。