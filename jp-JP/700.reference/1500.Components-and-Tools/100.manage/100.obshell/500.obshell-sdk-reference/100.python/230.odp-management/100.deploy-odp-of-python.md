...
<main id="notice" type='explain'>
  ...
  <li><p>obshell V4.2.6以降では、obshell-sdk-pythonを使用して指定ノードにOBProxyをデプロイできます。</p></li>
  </ul>
</main>
...
OBProxyのデプロイAPIに関する説明は、[OBProxyのデプロイ](../../../400.obshell-api-reference/230.odp-management/100.deploy-odp.md)を参照してください。