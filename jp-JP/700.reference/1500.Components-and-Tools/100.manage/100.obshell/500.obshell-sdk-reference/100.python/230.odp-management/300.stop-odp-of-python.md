...
<main id="notice" type='explain'>
  <h4>説明</h4>
  <p>obshell V4.2.6以降、obshell-sdk-pythonを使用して指定したノードのOBProxyを停止できます。</p>
</main>
...
OBProxyを停止するAPIの仕様については、[OBProxyの停止](../../../400.obshell-api-reference/230.odp-management/300.stop-odp.md)を参照してください。