...
本記事では、obshell-sdk-pythonを使用して、指定されたノード上のOBProxy（OceanBaseデータベースプロキシ、ODPとも呼ばれる）を破棄する方法について説明します。

<main id="notice" type='explain'>
  <h4>説明</h4>
  <p>obshell V4.2.6以降、obshell-sdk-pythonを使用して指定ノードのOBProxyを破棄できます。</p>
</main>
...
OBProxyの破棄に関するAPIインターフェースの説明については、[OBProxyの破棄](../../../400.obshell-api-reference/230.odp-management/600.delete-odp.md)を参照してください。