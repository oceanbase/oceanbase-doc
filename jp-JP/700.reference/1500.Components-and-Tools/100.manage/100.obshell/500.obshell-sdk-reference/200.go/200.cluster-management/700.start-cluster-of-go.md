...
* リクエスト元のclientに対応するノードが起動対象のクラスタ内にあることを確認してください。
...
* obshell-sdk-pythonを使用したAPIメソッドのリクエスト方法については、[クラスタの起動](../../100.python/200.cluster-management/700.start-cluster-of-python.md)を参照してください。