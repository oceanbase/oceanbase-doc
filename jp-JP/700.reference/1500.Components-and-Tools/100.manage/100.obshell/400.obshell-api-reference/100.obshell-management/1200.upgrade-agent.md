...
* obshell-sdk-pythonを使用したAPIメソッドのリクエスト方法の詳細については、[Agentのアップグレード](../../500.obshell-sdk-reference/100.python/110.obshell-management/1200.upgrade-agent-of-python.md)を参照してください。

* obshell-sdk-goを使用したAPIメソッドのリクエスト方法の詳細については、[Agentのアップグレード](../../500.obshell-sdk-reference/200.go/110.obshell-management/1200.upgrade-agent-of-go.md)を参照してください。