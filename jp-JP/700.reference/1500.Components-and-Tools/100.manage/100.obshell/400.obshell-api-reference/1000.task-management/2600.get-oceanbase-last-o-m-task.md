...
* obshell-sdk-pythonを使用したAPIメソッドのリクエスト方法については、[OceanBaseクラスタの最後の運用保守タスクの照会](../../500.obshell-sdk-reference/100.python/1000.task-management/2600.get-oceanbase-last-o-m-task-of-python.md)を参照してください。

* obshell-sdk-goを使用したAPIメソッドのリクエスト方法については、[OceanBaseクラスタの最後の運用保守タスクの照会](../../500.obshell-sdk-reference/200.go/1000.task-management/2600.get-oceanbase-last-o-m-task-of-go.md)を参照してください。