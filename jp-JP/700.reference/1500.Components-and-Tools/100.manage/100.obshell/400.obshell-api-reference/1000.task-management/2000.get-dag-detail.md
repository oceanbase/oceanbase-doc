...
本記事では、タスク(DAG)の詳細情報を取得する方法について説明します。
...
ここで、`id`はDAGの汎用IDに設定する必要があります。

### リクエストパラメータ

| パラメータ | タイプ | 必須 | サンプル値 | 説明 |
| --- | --- | --- | --- | --- |
| show_details | bool | いいえ | true | DAGの詳細情報を表示するかどうかを制御します。デフォルトは`true`で、つまり表示が必要です。 |
...
* obshell-sdk-pythonを使用してAPIメソッドをリクエストする方法については、[タスクの詳細情報を取得](../../500.obshell-sdk-reference/100.python/1000.task-management/2000.get-dag-detail-of-python.md)を参照してください。

* obshell-sdk-goを使用してAPIメソッドをリクエストする方法については、[タスクの詳細情報を取得](../../500.obshell-sdk-reference/200.go/1000.task-management/2000.get-dag-detail-of-go.md)を参照してください。