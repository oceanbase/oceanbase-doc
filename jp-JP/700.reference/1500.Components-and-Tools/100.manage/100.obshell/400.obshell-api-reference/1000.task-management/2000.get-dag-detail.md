...
| パラメータ | 型 | 必須 | サンプル値 | 説明 |
| --- | --- | --- | --- | --- |
| show_details | bool | いいえ | true | DAGの詳細情報を表示するかどうかを制御します。デフォルトは`true`で、表示することを意味します。 |
...
| nodes | []NodeDetailDTO | DAG内のすべてのノード情報。詳細は[ノードの詳細情報を取得する](../1000.task-management/2100.get-node-detail.md)を参照してください。 |
