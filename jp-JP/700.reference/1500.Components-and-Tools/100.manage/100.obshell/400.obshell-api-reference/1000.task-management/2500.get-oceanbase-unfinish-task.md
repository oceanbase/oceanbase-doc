...
# OceanBaseクラスタの未完了タスクの確認

このドキュメントでは、CLUSTER AGENTとして識別されるノードの未完了なクラスタタスクを確認する方法について説明します。
...
例では、スケールアウト中のクラスタが示されており、この時点でクラスタ内に完了していないタスクはスケールアウトタスクのみです。
...
* obshell-sdk-pythonを使用したAPIメソッドのリクエスト方法については、[OceanBaseクラスタの未完了タスクの確認](../../500.obshell-sdk-reference/100.python/1000.task-management/2500.get-oceanbase-unfinish-task-of-python.md)を参照してください。

* obshell-sdk-goを使用したAPIメソッドのリクエスト方法については、[OceanBaseクラスタの未完了タスクの確認](../../500.obshell-sdk-reference/200.go/1000.task-management/2500.get-oceanbase-unfinish-task-of-go.md)を参照してください。