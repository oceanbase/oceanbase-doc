...
コマンドラインでAPIを呼び出す以外に、SDKメソッドを使用してAPIを呼び出すこともできます。obshell-sdk-pythonを使用したAPIメソッドの呼び出しについては、[ユーザーの削除](../../500.obshell-sdk-reference/100.python/500.tenant-management/850.delete-user-of-tenant-of-python.md)を参照してください。