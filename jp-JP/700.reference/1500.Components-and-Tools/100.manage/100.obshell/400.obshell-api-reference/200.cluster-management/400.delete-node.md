...
* obshell-sdk-pythonを使用したAPIメソッドのリクエスト方法の詳細については、[クラスタ初期化前にノードを削除する](../../500.obshell-sdk-reference/100.python/200.cluster-management/400.delete-node-of-python.md)を参照してください。

* obshell-sdk-goを使用したAPIメソッドのリクエスト方法の詳細については、[クラスタ初期化前にノードを追加する](../../500.obshell-sdk-reference/200.go/200.cluster-management/400.delete-node-of-go.md)を参照してください。