...
コマンドラインからAPIを呼び出す以外に、SDKメソッドを使用してAPIを呼び出すこともできます。obshell-sdk-pythonを使用したAPIメソッドのリクエスト方法の紹介については、[OBProxyの終了](../../500.obshell-sdk-reference/100.python/230.odp-management/600.delete-odp-of-python.md)を参照してください。