...
|slug|show-function-status-mysql-mode|
...
* `character_set_client`：ストアドプログラムを作成したときの `character_set_client` システム変数の現在のセッションの値。

* `collation_connection`：ストアドプログラムを作成したときの `collation_connection` システム変数の現在のセッションの値。
