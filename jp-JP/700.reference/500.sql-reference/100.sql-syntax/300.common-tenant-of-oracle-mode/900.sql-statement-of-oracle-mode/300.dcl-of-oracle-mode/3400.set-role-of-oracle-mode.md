...
|       パラメータ     |       説明       |
|---------------|----------------- ｜
| role_name              | 現在のセッションで有効にするロール名を指定します。   |
...
obclient> SET ROLE ALL;                             -- すべてのロールを有効化
obclient> SET ROLE ALL EXCEPT analyst_role;         -- アナリスト以外のすべてのロールを有効化
obclient> SET ROLE NONE;                            -- すべてのロールを無効化
```