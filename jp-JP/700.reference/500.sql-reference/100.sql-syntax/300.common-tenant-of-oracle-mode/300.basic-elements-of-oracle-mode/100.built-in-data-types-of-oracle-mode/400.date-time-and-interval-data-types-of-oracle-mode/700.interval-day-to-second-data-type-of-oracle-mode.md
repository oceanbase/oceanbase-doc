...
`INTERVAL DAY TO SECOND` データ型の値を挿入する際にサポートされる形式は、次の表のとおりです。間隔データ型の値の指定に関する詳細は、[間隔リテラル](../../300.literal-of-oracle-mode/500.interval-literal-of-oracle-mode.md)を参照してください。
...
現在サポートされている日付型の計算マトリックス図を確認し、より詳細なデータ型変換の情報については、[DATEとINTERVALの計算](../400.date-time-and-interval-data-types-of-oracle-mode/800.calculation-of-date-time-and-interval-of-oracle-mode.md)および[データ型変換ルール](../../200.data-type-comparison-rules-of-oracle-mode/600.data-type-conversion-of-oracle-mode.md)を参照してください。
