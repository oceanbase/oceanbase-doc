...
このセクションでは、SQL文の汎用構文について説明します。これには、定数、文字セット、データ型、SQL属性、分散属性、ストレージ属性が含まれます。
...
`charset_name` は任意の有効な文字セット名です。詳細な文字セット情報については、[MySQLとの互換性比較](../../../../../100.learn-more-about-oceanbase/500.compatibility-with-mysql.md)を参照してください。
...
`collation_name` は任意の有効な照合順序名です。詳細な照合順序情報については、[MySQLとの互換性比較](../../../../../100.learn-more-about-oceanbase/500.compatibility-with-mysql.md)を参照してください。
...
* `TABLEGROUP`：複数のデータに対するプライマリレプリカ分散ポリシーを指定します。
