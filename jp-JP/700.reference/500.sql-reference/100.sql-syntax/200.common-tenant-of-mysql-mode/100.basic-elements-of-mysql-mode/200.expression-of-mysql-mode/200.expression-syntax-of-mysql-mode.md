...
|slug|expression-syntax-mysql-compatible-mode|

# 式の構文

このセクションでは、式が従わなければならない構文規則を示します。

以下の構文規則は、OceanBaseデータベースの式の構文を定義しています：
...
演算子の優先順位については、[演算子の優先順位](../../200.operator-of-mysql-mode/200.operator-precedence-of-mysql-mode.md)を参照してください。