...
OceanBaseデータベースのMySQLモードにおけるパーティション操作には、リパーティション、パーティションの追加、パーティションの削除、およびパーティションのクリアが含まれます。
...
#### 1次Hashパーティションテーブルを、テンプレート型のHash+Range 2次パーティションテーブルに変更する例
