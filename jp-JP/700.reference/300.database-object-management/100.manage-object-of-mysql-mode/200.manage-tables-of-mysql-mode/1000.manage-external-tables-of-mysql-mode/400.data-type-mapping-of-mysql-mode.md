...
|Parquet物理型| Parquet論理型| Hiveデータ型| MySQLテナントのデータ型| 備考|
|--------------|-----------------|------------|----------------|------------------------|
...
|MaxCompute（ODPS） データ型|MySQLテナントのデータ型| 備考|
|--------------|-----|--------------------|
...
| ARRAY | ARRAY | 詳細については、下記の**OceanBaseデータベースのARRAY型とODPSのマッピング関係**を参照してください。|
