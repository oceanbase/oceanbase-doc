...
以下の不確定系システム関数の式は、関数インデックスに使用することを禁じます。
...
以下の空間系システム関数は、OceanBaseデータベース独自のシステム関数であり、現在関数インデックスに使用することを禁じています。
...
非ユーザー系システム関数は、デフォルトではすべて関数インデックスに使用することを禁じています。

## その他のシステム関数

以下の関数の式は、関数インデックスに使用することを禁じます。
