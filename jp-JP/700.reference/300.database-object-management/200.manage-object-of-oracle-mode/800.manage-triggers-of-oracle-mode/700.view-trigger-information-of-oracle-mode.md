...
現在ユーザーが所有するすべてのトリガーを、タイプ、ステータス、作用対象のテーブルおよびそのユーザーと共に一覧表示します。
...
OceanBaseデータベースのユーザーは、`DBA_SOURCE`、`USER_SOURCE`、`DBA_OBJECTS` ビューを使用してトリガー関連情報を確認することもできます。クエリステートメントの例は以下のとおりです：
