...
本記事では、クラスタ内の特定のテナントのLocalityを変更して、そのテナント配下のログストリームのレプリカ分布を調整する方法について説明します。

Localityの変更手順および注意事項の詳細については、[Localityの変更](../200.locality-common-operations/200.modify-locality.md)を参照してください。
...
* 前回のテナントLocalityの変更が完了する前に、新たなテナントLocalityを変更することはできません。
