...
* システムパラメータ `cpu_quota_concurrency` の値を大きくする
    ...
    `cpu_quota_concurrency` は、テナントの各 CPU クォータが許可する最大並列数を設定します。詳細については、[cpu_quota_concurrency](../../../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/1800.cpu_quota_concurrency.md) を参照してください。
