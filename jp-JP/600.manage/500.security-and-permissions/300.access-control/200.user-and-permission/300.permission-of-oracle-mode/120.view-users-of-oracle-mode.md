...
|slug|check-user-information-oracle-compatible-mode|

# ユーザー情報の確認

ユーザー作成後、ビュー `ALL_USERS`、`DBA_USERS`、`USER_USERS` を使用して関連情報を確認できます。
...
2. 以下のコマンドを実行して、ユーザー情報を確認します。
   ...
   * 現在のユーザーの詳細情報を確認する
     ...
     ```
      ...
      ビュー `USER_USERS` の詳細については、[USER_USERS](../../../../../700.reference/700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/32100.user_users-of-oracle-mode.md)を参照してください。

   * 現在のユーザーが表示できるすべてのユーザーを確認する
      ...
      * `TEST1`、`TEST2` はユーザーが作成したカスタムユーザーです。
      ...
      ビュー `ALL_USERS` の詳細については、[ALL_USERS](../../../../../700.reference/700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/6300.all_users-of-oracle-mode.md)を参照してください。

   * 管理者ユーザーが現在のテナント内のすべてのユーザーの詳細情報を確認する
      ...
      クエリ結果には以下のユーザーが含まれます：

      * `SYS`：システム組み込みのデータベース管理者です。

      * `LBACSYS`：システム組み込みのデータベースセキュリティ管理者です。デフォルトではロック状態になっており、使用する前にこのユーザーのロックを解除する必要があります。

      * `ORAAUDITOR`：システム組み込みのデータベース監査員です。デフォルトではロック状態になっており、使用する前にこのユーザーのロックを解除する必要があります。

      ビュー`DBA_USERS`の詳細については、[DBA_USERS](../../../../../700.reference/700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/22500.dba_users-of-oracle-mode.md)を参照してください。
