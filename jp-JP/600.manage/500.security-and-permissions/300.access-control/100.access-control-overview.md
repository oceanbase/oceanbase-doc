...
Label Securityアクセスポリシーの設定によるデータベースのセキュアなアクセスを確保する詳細な操作手順については、[行レベルアクセス権限制御](../300.access-control/400.row-level-access-control.md)を参照してください。

<main id="notice">
    <h4>機能の適用範囲</h4>
    <p>現在、Label Security機能はOceanBaseデータベースのOracleモードでのみサポートされています。</p>
</main>