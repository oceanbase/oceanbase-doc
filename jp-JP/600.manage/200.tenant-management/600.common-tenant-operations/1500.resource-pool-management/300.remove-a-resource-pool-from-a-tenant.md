...
その他のシナリオでは、テナントの利用可能なリソースを調整する必要がある場合は、リソースプール内のリソース仕様の設定と数量を変更することで実現できます。リソースユニットの設定を変更する操作については、[リソース仕様の変更](../1600.resource-specification-management/200.modify-the-configuration-of-a-resource-unit.md)を参照してください。リソースプール内のリソースユニットの数量を変更する操作については、[リソースプール属性の変更](../900.modify-resource-pool-properties.md)を参照してください。