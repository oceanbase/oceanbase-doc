...
- oblogproxyをインストール済みであること。詳細については、[oblogproxyのインストールドキュメント](https://seatunnel.apache.org/docs/connector-v2/source/FakeSource)を参照してください。
...
4. SeaTunnelを設定します。
    ...
    # https://seatunnel.apache.org/docs/2.3.4/connector-v2/source/MySQL-CDC/。
    }
    ```
