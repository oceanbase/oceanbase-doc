...
Cloudflare Workers AIは、Cloudflareが提供するサービスであり、開発者がグローバルネットワーク上で機械学習モデルを実行できるようにします。REST APIを利用することで、開発者はアプリケーションにAI機能を簡単に統合できます。
...
ここでは、bge-base-en-v1.5を例に、Cloudflare Workers AI埋め込みAPIを使用してベクトルデータを生成する方法を示します。
