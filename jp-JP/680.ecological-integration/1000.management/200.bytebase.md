...
2. OceanBaseクラスタの接続情報を取得しておくこと。これには、インスタンス名、IPアドレス、ポート、接続用ユーザー、ユーザーのパスワードが含まれます。新しいユーザーを作成する必要がある場合は、Bytebaseの権限要件と実際のビジネスニーズに基づいてアカウントに権限を付与してください。詳細については、[ユーザーの作成](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001231781)を参照してください。
