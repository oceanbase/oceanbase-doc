...
6. 表示された **デフォルトのセマンティックモデルの管理** ウィンドウで、対象のテーブルを選択し、**確認** をクリックします。少々お待ちください。自動で作成されたレポートが生成されます。
...
データソースの作成が完了したら、Power BIの使用を開始できます。Power BIの詳細な操作ガイドについては、[Power BI公式ドキュメント](https://learn.microsoft.com/en-us/power-bi/fundamentals/power-bi-overview)を参照してください。