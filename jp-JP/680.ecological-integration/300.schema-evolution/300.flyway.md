...
Flywayは、オープンソースのデータベースバージョン管理ツールであり、履歴テーブルを作成してデータベースの状態を追跡し、自動化されたマイグレーションを実現します。本ドキュメントでは、OceanBaseデータベースにFlywayを統合し、スキーマ変更の自動デプロイとバージョン追跡を実現する方法について説明します。
