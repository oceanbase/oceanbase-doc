...
* .NET SDK 6.0以降がインストールされていること
* Visual StudioまたはVS Codeがインストール済み
...
### ステップ2：必要なNuGetパッケージのインストール

1.  Dapper、MySQL Connectorおよび関連する依存パッケージをインストールします：
...
1. `appsettings.json` 内のデータベース接続文字列が更新されていることを確認します。
