|description|本トピックでは、C#のSqlSugar ORMフレームワークを使用してOceanBaseデータベースに接続し、テーブルの作成、データの挿入、クエリなどの基本的な操作を実行する方法について説明します。|
|---|---|
...
SqlSugarは、.NETプラットフォームをサポートする、豊富な機能と使いやすさを兼ね備えたORMフレームワークです。本トピックでは、SqlSugarを使用してOceanBaseデータベースのMySQLモードに接続する方法について説明します。
...
1. SqlSugarコアパッケージとMySQLデータベースプロバイダーをインストールします。
