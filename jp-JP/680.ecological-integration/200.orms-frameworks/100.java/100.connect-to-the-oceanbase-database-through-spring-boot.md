...
* `TestSpringbootApplicationTests.java`: Spring BootをテストするJavaクラス。
...
* `spring.datasource.driverClassName` を使用して、データベースドライバーを `com.oceanbase.jdbc.Driver` と指定します。これはOceanBaseデータベースとの接続を確立するために使用されます。
