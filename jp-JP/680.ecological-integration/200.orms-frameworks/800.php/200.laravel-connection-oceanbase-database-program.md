...
- `GET http://localhost:8000/api/users` - ユーザーリストを取得する
- `POST http://localhost:8000/api/users` - 新規ユーザーを作成する
- `GET http://localhost:8000/api/users/1` - 指定ユーザーを取得する
- `PUT http://localhost:8000/api/users/1` - ユーザーを更新する
- `DELETE http://localhost:8000/api/users/1` - ユーザーを削除する
