...
<main id="notice" type='explain'>
   ...
   <li>
   <p>OCP ExpressまたはOCPをデプロイするノードとOceanBaseクラスタが同一ノード上にない場合、OCP ExpressまたはOCPのノードとOceanBaseクラスタノードのクロックソースを同期させる必要があります。これは、運用中にクロックずれによってOCP ExpressまたはOCPの動作異常が発生するのを防ぐためです。</p>
   </li>
   </ul>
</main>
