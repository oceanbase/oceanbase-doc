...
<main id="notice" type='explain'>
  <h4>説明</h4>
  <p>本記事では、obd V3.5.0を例に操作手順を説明します。obdのバージョンの違いによって、設定ファイルが異なる場合があります。実際の設定ファイルをご確認ください。obdに関する詳細については、<a href="https://en.oceanbase.com/docs/obd-en">obdドキュメント</a>を参照してください。</p>
</main>
