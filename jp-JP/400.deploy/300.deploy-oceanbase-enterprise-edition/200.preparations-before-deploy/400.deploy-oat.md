...
4. `docker images`コマンドを使用して、OATイメージのラベルを取得します。
...
OATのインストールに関する詳細は、[OATのインストール](https://en.oceanbase.com/docs/common-oat-10000000003867085)を参照してください。