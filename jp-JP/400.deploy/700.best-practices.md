...
本記事では、CLIによるOceanBaseデータベースのデプロイ後、さまざまなビジネスアプリケーションシナリオの主要な設定パラメータとシステム変数の推奨設定について説明します。
...
<main id="notice" type='explain'>
  <h4>説明</h4>
  <p>オンライントランザクション処理（EXPRESS_OLTP）シナリオにおける推奨設定の詳細については、<a href="https://en.oceanbase.com/docs/common-best-practices-10000000001740743">オンライントランザクション処理シナリオにおける設定のベストプラクティス</a>を参照してください。</p>
</main>
...
<main id="notice" type='explain'>
  <h4>説明</h4>
  <p>关于复杂联机事务处理（COMPLEX OLTP）场景下配置推荐的更详细介绍，参见 複雑なオンライントランザクション処理(COMPLEX OLTP)シナリオにおける推奨設定の詳細については、<a href="https://en.oceanbase.com/docs/common-best-practices-10000000001740744">複雑なオンライントランザクション処理シナリオにおける設定のベストプラクティス</a>を参照してください。</p>
</main>
...
<main id="notice" type='explain'>
  <h4>説明</h4>
  <p>リアルタイム分析(OLAP)シナリオにおける推奨設定の詳細については、<a href="https://en.oceanbase.com/docs/common-best-practices-10000000001740746">リアルタイム分析シナリオにおける設定のベストプラクティス</a>を参照してください。</p>
</main>
...
| _force_subquery_unnest     | True          | この設定パラメータは、オプティマイザがサブクエリを結合形式に書き換える際に、事前の仮定に基づいて一部の書き換え機会を放棄するかどうかを制御します。OLAPモードでは、この値を`True`に設定すると、オプティマイザは事前のカットルールを考慮せず、正確性を保証した上で、書き換え可能なサブクエリをすべて結合形式に書き換えます。| tenant |
...
<main id="notice" type='explain'>
  <h4>説明</h4>
  <p>ハイブリッドトランザクション/分析処理（以下、HTAP）シナリオにおける推奨設定の詳細については、<a href="https://en.oceanbase.com/docs/common-best-practices-10000000001740745">ハイブリッドトランザクション/分析処理シナリオにおける設定のベストプラクティス</a>を参照してください。</p>
</main>
...
<main id="notice" type='explain'>
  <h4>说明</h4>
  <p>異なる業務シナリオにおけるOBKVの推奨設定に関する詳細については、<a href="https://en.oceanbase.com/docs/common-best-practices-10000000001740747">OBKV設定のベストプラクティス</a>を参照してください。</p>
</main>
