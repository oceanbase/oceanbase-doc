...
`CREATE TABLE AS SELECT` ステートメントは `DIRECT()` Hint を設定してバイパスインポートのデータロード方式を指定します。Hint が指定されていない場合は、設定項目 [default_load_mode](../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/2050.default_load_mode.md) に基づいてデータインポート動作を決定します。
...
`CREATE TABLE` 構文の詳細については、[CREATE TABLE (MySQL モード)](../../../700.reference/500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/2600.create-table-of-mysql-mode.md) および [CREATE TABLE (Oracle モード)](../../../700.reference/500.sql-reference/100.sql-syntax/300.common-tenant-of-oracle-mode/900.sql-statement-of-oracle-mode/100.ddl-of-oracle-mode/2400.create-table-of-oracle-mode.md) を参照してください。
...
* [SQL 実行計画の概要](../../../700.reference/1000.performance-tuning-guide/500.sql-optimization/200.sql-execution-plan/100.introduction-to-sql-execution-plans.md)
