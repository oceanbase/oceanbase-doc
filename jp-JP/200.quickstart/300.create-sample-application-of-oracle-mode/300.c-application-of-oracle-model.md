...
OBCIのインストールと使用方法の詳細については、公式ドキュメントの《[OceanBase C言語呼び出しインターフェース](https://en.oceanbase.com/docs/obci-en)》を参照してください。