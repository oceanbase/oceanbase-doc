...
Oracleデータベース(19c)は312個の組み込み関数をサポートしていますが、OceanBaseデータベースは現在173個をサポートしています。詳細については、[関数](../../700.reference/500.sql-reference/100.sql-syntax/300.common-tenant-of-oracle-mode/500.functions-of-oracle-mode/100.function-overview-of-oracle-mode.md)を参照してください。

## 算術演算子

| # | Oracleの関数 | OceanBaseのサポート |
|----|----------------|-------------------|
| 1  | ABS            | サポート                |
| 2  | ACOS           | サポート                |
| 3  | ASIN           | サポート                |
...
<main id="notice" type='explain'>
  <h4>説明</h4>
  <p><code>*</code>は、その関数が集計関数と分析関数の両方であることを示しています。</p>
</main>
