...
Oracleデータベース(19c)は312個の組み込み関数をサポートしており、OceanBaseデータベースは現在173個をサポートしています。詳細については、[関数](../../700.reference/500.sql-reference/100.sql-syntax/300.common-tenant-of-oracle-mode/500.functions-of-oracle-mode/100.function-overview-of-oracle-mode.md)を参照してください。

## 数値関数

| # | Oracleデータベースの関数 | OceanBaseデータベースのサポート状態 |
|----|----------------|-------------------|
| 1  | ABS            | サポート               |
| 2  | ACOS           | サポート               |
| 3  | ASIN           | サポート               |
...
| # |    Oracleデータベースの関数    | OceanBaseデータベースののサポート状態 |
|----|---------------------|-------------------|
| 1  | CHR                 | サポート                |
| 2  | CONCAT              | サポート                |
| 3  | INITCAP             | サポート                |
...
<main id="notice" type='explain'>
  <h4>説明</h4>
  <p><code>*</code>は、集約関数でありながら分析関数でもあることを示します。</p>
</main>

## 分析関数

| # |  Oracleデータベースの関数  | OceanBaseデータベースのサポート |
|----|-----------------|-------------------|
| 1  | FIRST_VALUE     | サポート               |
| 2  | LAG             | サポート               |
| 3  | LAST_VALUE      | サポート               |
...
<main id="notice" type='explain'>
  <h4>説明</h4>
  <p>集約関数表で<code>*</code>とマークされた関数は、同時に分析関数にも属するため、この表では重複して記載していません。</p>
</main>