...
Oracleデータベース(19c)は312個のビルトイン関数をサポートしていますが、OceanBaseデータベースは現在、173個をサポートしています。詳細については、[関数](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001974229)を参照してください。

## 算術演算の関数

| # | Oracleデータベースの関数 | OceanBaseデータベースのサポート状況 |
|----|----------------|-------------------|
| 1  | ABS            | サポート                |
| 2  | ACOS           | サポート                |
| 3  | ASIN           | サポート                |
