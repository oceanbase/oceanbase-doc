...
このセクションでは、OceanBaseデータベースのOracleモードとネイティブOracleデータベースのSQLデータ型に関する詳細な互換性比較情報を紹介します。

Oracleデータベースには24種類のデータ型があり、OceanBaseデータベースは現在20種類をサポートしています。詳細は次の表のとおりです。
