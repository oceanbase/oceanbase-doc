...
* 第1レベルのパーティションテーブルでは、第1レベルのパーティションの追加、削除、Truncateをサポートします。

* テンプレート型コンポジット・パーティションテーブルでは、第1レベルのパーティションおよびサブパーティションの追加、削除をサポートします。

* 非テンプレート型コンポジット・パーティションテーブルでは、第1レベルのパーティションおよびサブパーティションの追加、削除、Truncateをサポートします。
...
* 許可リストポリシーをサポートし、ネットワークの安全なアクセス制御を実現します。
