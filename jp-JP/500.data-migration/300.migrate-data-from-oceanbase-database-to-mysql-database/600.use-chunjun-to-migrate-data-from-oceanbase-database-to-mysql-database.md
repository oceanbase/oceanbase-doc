...
* Binlogサービスのインストールとデプロイが完了していること。OceanBase Binlogサービスのインストールとデプロイについては、[Binlogクラスタの作成](https://en.oceanbase.com/docs/common-ocp-10000000001899110)を参照してください。
