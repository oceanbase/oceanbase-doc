...
2. 以下に示す依存パッケージをダウンロードし、それらを`flink-1.15.3/lib/`ディレクトリに配置します。
   ...
   * [flink-sql-connector-mysql-cdc-3.4.0.jar](https://repo1.maven.org/maven2/org/apache/flink/flink-sql-connector-mysql-cdc/3.4.0/flink-sql-connector-mysql-cdc-3.4.0.jar)
