...
OMSは、送信元のTiDBデータベースからデータ送信先のOceanBaseデータベースのMySQLテナントへのデータ移行プロジェクトの作成をサポートします。構造移行、フル移行、増分同期などを通じて、データ送信元データベースの既存業務データと増分データをOceanBaseデータベースのMySQLテナントへシームレスに移行できます。
