...
* obloaderはJavaで開発されたクライアント側のインポートツールです。このツールは非常に柔軟なコマンドラインオプションを提供しており、多様な複雑なシナリオで定義とデータをOceanBaseにインポートすることができます。obloaderの詳細については、[obloaderの概要](https://en.oceanbase.com/docs/enterprise-oceanbase-dumper-loader-en-10000000000860068)を参照してください。
