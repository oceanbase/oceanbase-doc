...
<main id="notice" type='notice'>
  ...
  <ul>
  <li>
  <p>The deployment solutions outlined in this topic are only suitable for quick hands-on with OceanBase Database and are not intended for use in production environments. To deploy OceanBase Database in a production environment, refer to <a href="../4.deploy/1.deploy-overview.md">Deployment overview</a>. </p>
  </li>
  <li>
