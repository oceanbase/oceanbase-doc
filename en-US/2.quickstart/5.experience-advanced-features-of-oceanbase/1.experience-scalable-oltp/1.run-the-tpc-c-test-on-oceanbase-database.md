...
The example below uses the tenant mode `MySQL` and the tenant name `test`. To create your own tenant, follow the steps in [Try out the multitenancy feature](../4.experience-multi-tenant-features.md).
