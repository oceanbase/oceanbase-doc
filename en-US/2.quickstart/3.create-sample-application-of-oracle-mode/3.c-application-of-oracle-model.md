...
4. Exchange data with the OBServer node by using SQL statements, and then perform data processing. Steps of executing an SQL statement in the OBCI application:
