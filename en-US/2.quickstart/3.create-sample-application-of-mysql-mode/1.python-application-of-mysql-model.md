...
For more information about how to create a Python 3.x application, see the [sample Python 3 application](https://github.com/oceanbase/ob-example/tree/master/python3-pymysql) in the open source community of OceanBase Database.
