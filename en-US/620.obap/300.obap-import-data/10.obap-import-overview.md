...
* DataX is suitable for synchronizing data between various data sources, including HDFS, Hive, and relational databases such as MySQL and Oracle. DataX allows you to migrate data from one table at a time, without limiting the amount of data. It can migrate up to 60 MB of data per second.
...
| Huawei Cloud OBS | <ul><li>LOAD DATA INFILE (<a href="https://en.oceanbase.com/docs/common-oceanbase-database-10000000001378364">Click here for more information.</a>)</li><li>Download the data to a local or accessible server. Then use a MySQL CLI tool or SQL management tool to import the data to OceanBase Database. You can also write scripts and execute an SQL statement by using a MySQL connector library to batch insert the data. </li><li>Flink CDC (<a href="https://nightlies.apache.org/flink/flink-docs-release-1.16/docs/deployment/filesystems/overview/">Click here for more information.</a>)</li></ul>|
...
|**Data source**|**Supported import solution**|
|---|---|
| MySQL database | <ul><li>Online data migration: Use OMS to migrate data to OceanBase Database. </li><li>DataX. </li><li>Offline data migration: Dump data from the MySQL database, and then use :obloader or the `LOAD DATA` statement to import the data to OceanBase Database. The solutions are similar to those for migrating data from file systems. </li></ul>|
| Oracle database | <ul><li>Online data migration: Use OMS to migrate data to OceanBase Database. </li><li>DataX. </li><li>Offline data migration: Dump data from the Oracle database, and then use :obloader or the `LOAD DATA` statement to import the data to OceanBase Database. </li></ul>|
| PostgreSQL database | <ul><li>Online data migration: Use OMS to migrate data to OceanBase Database. </li><li>Offline data migration: Dump data from the PostgreSQL database, and then use :obloader or the `LOAD DATA` statement to import the data to OceanBase Database. </li></ul>|
| TiDB | <ul><li>Online data migration: Use OMS to migrate data to OceanBase Database. </li><li>Offline data migration: Dump data from TiDB, and then use :obloader or the `LOAD DATA` statement to import the data to OceanBase Database. </li></ul>|
| SQLServer | <ul><li>DataX. </li><li>Offline data migration: Dump data from SQL Server, and then use :obloader or the `LOAD DATA` statement to import the data to OceanBase Database. </li></ul>|
| StarRocks | Offline data migration: Dump data from StarRocks, and then use :obloader or the `LOAD DATA` statement to import the data to OceanBase Database. |
| Doris | Offline data migration: Dump data from Doris, and then use :obloader or the `LOAD DATA` statement to import the data to OceanBase Database. |
| HBase | <ul><li>DataX. </li><li>Offline data migration: Dump data from HBase, and then use :obloader or the `LOAD DATA` statement to import the data to OceanBase Database. </li></ul>|
| MaxCompute | Offline data migration: Dump data from MaxCompute, and then use :obloader or the `LOAD DATA` statement to import the data to OceanBase Database. |
| Hologres | Offline data migration: Dump data from Hologres, and then use :obloader or the `LOAD DATA` statement to import the data to OceanBase Database. |