...
You can add the `APPEND` hint to the `INSERT INTO SELECT` statement to enable direct load. For more information, see [Import data through direct load by using the INSERT INTO SELECT statement](../../500.data-migration/1100.bypass-import/200.full-bypass-import.md).
