...
+ [Migrate Hive data using OMS Community Edition](https://www.oceanbase.com/docs/community-oms-cn-1000000002947290)
+ [Migrate Hive data using OBLoader](https://www.oceanbase.com/docs/common-oceanbase-dumper-loader-1000000002781921)

### Migrate data from an HBase database

HBase, a distributed NoSQL database, supports the following migration method:

+ [Migrate HBase data using OMS Community Edition](https://www.oceanbase.com/docs/community-oms-cn-1000000002947280)

### Migrate data from files

For data stored in file systems, various formats can be migrated:

+ [Migrate ORC/Parquet/CSV files using OBLoader](https://www.oceanbase.com/docs/common-oceanbase-dumper-loader-1000000002781920)
...
+ [Migrate data from an AnalyticDB for MySQL instance to a MySQL tenant of OceanBase Database](https://help.aliyun.com/document_detail/2857847.html?spm=a2c4g.11186623.help-menu-26458.d_2_4_3_15.5c366dc51jOLZJ&scm=20140722.H_2857847._.OR_help-T_cn~zh-V_1)
...
- **Migration solution**: Refer to [Migrate StarRocks data using Flink-OMT](../../500.data-migration/650.migrate-data-from-starrocks-database-to-oceanbase-database/100.use-flink-omt.md).