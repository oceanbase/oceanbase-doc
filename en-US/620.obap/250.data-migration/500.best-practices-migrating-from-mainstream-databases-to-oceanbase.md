...
| **StarRocks** | [Export data using INSERT INTO FILES](https://docs.starrocks.io/zh/docs/unloading/unload_using_insert_into_files/) |
...
**Reference documentation**: [CREATE EXTERNAL TABLE (MySQL mode)](../../700.reference/500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/2200.create-external-table-of-mysql-mode.md)
...
**Recommendation**: For highly partitioned tables, you can use **Partition Exchange** to avoid these issues. For more information, see [Partition Exchange](https://www.oceanbase.com/docs/enterprise-oms-doc-cn-1000000004023033).
...
- For detailed instructions, see: [Use OMS for data migration](url-placeholder-5637cbf9-4666-4930-86ff-23937b0d7c36)