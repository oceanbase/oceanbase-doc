...
| **OceanBase Database Community Edition**  | Quick experience scenarios in native operating systems (Linux, see the list of supported operating systems) | We recommend that you deploy OceanBase Database by using obd. For more information, see the **Option 1: Deploy an OceanBase demo environment** or **Option 2: Deploy an OceanBase cluster environment** section in the [Quick Start/Quick Deployment of OceanBase Database](https://www.oceanbase.com/docs/community-obd-cn-1000000001882000) topic of the official documentation. | obd |
