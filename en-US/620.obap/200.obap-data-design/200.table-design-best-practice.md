...
The preceding statement creates a columnstore table that is first RANGE-partitioned with the `c1` column as the partitioning key and then HASH-partitioned.
