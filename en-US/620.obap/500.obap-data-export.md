...
- Allows you to quickly restore backup data to a database system.
...
|---|---|---|---|---|---|
| Applicable scenario | Logical data backup</br>Data processing</br>Data compression with a high compression ratio | Simple data export | Full backup | Full backup and incremental backup | Data migration from a variety of data sources, including databases in the running state and message queues; and offline data migration from databases |
