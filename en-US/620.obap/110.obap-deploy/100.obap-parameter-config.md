...
+ For more information about the recommended configurations abd examples for this scenarios, see [Recommeded configurations](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001970925).
+ For a more in-depth discussion of recommended configurations for HTAP scenarios, see [Recommended configurations in HTAP scenarios](https://en.oceanbase.com/docs/common-best-practices-10000000001740745).
...
+ For detailed recommendations and example configurations for this scenario, see [Recommended configurations](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001970925).
+ For a more in-depth discussion of recommended configurations for OLAP scenarios, see [Recommended configurations in OLAP scenarios](https://en.oceanbase.com/docs/common-best-practices-10000000001740746).
...
+ [Configure built-in templates of OCP](https://www.oceanbase.com/docs/common-ocp-1000000002381079)