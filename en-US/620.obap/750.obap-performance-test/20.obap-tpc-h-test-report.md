...
- Software versions
  ...
  |---|---|
  | OceanBase Database | <ul><li>Enterprise Edition: V4.3.3</li><li>Community Edition: V4.3.3_CE</li></ul> |
  | TPC-H | V3.0.0 |
...
* For detailed testing procedures, see [TPC-H benchmark](../750.obap-performance-test/10.obap-tpc-h-test.md).
