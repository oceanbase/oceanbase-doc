...
In OceanBase, Catalog is a top-level namespace for database objects, used to organize and isolate metadata from different data sources. OceanBase supports the following Catalog types:
...
<main id="notice" type='notice'>
  <h4>Note</h4>
  <p>At present, only OceanBase Database in MySQL mode supports the data catalog feature. </p>
</main>
...
For more information, see [View CATALOG](../../../700.reference/300.database-object-management/100.manage-object-of-mysql-mode/1000.manage-catalog-of-mysql-mode/300.view-catalog-of-mysql-mode.md)
...
- Catalog privileges are divided into two levels:
  ...
  * User level (global): Applies to all catalogs (corresponding to *.* in MySQL mode)
...
- [Drop a catalog](../../../700.reference/300.database-object-management/100.manage-object-of-mysql-mode/1000.manage-catalog-of-mysql-mode/400.delete-catalog-of-mysql-mode.md)
