...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>Once manual mapping is used, all columns must be explicitly defined with their mappings. The default sequential mapping will no longer apply. </p>
</main>
...
- `local_file_path` can be a relative or absolute path.
  ...
  + For a relative path, the root directory is the installation directory of the OBServer node.
