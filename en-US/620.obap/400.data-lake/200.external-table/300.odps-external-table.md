...
Starting from OceanBase Database V4.4.0 (MySQL mode) and later, OceanBase Database supports accessing MaxCompute tables through external tables by adapting to the ODPS API.
...
| Limitations | <ul><li>Only MySQL mode is supported.</ul></li><ul><li>Complex types (such as ARRAY<MAP>) are not supported.</ul></li><ul><li>When you write data, the number and order of columns must be strictly consistent. <ul><li> |
...
For more information, see [Insert data in MySQL mode](../../../300.develop/100.application-development-of-mysql-mode/400.write-data-of-mysql-mode/100.insert-data-of-mysql-mode-in-develop.md) and [Insert data in Oracle mode](../../../300.develop/200.application-development-of-oracle-mode/400.write-data-of-oracle-mode/100.insert-data-of-oracle-mode-in-develop.md).
