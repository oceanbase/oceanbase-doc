...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>For full direct load with unique indexes using the <code>LOAD DATA</code> statement, the <code>REPLACE</code> or <code>IGNORE</code> keyword is not currently supported when duplicate unique index keys occur, nor is setting error-tolerant rows. </p>
</main>
...
For more information about direct load, see [Overview of direct load](../../500.data-migration/1100.bypass-import/100.overview-of-bypass-import.md).