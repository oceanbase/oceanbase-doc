...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <ul>
  <li>After you enable auto DOP, verify the <code>parallel_min_scan_time_threshold</code> and <code>parallel_degree_limit</code> parameters to avoid impact on analytical processing (AP) systems. </li>
