...
The `LOAD DATA` statement can bypass the import process by using the `append/direct()` hint. If the hint is not specified, the import behavior is determined by the configuration item [default_load_mode](../../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/2050.default_load_mode.md).
