...
2. Set the path of the imported file.
   ...
   <main id="notice" type='notice'>
     <h4>Notice</h4>
     <p>For security reasons, you can only connect to the database locally to execute the SQL statement that modifies the global variable through a local Unix socket when you set the system variable <code>secure_file_priv</code>. </p>
   </main>
