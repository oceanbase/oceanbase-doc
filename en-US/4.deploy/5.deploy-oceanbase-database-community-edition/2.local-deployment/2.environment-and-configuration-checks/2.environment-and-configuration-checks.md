...
OceanBase Database supports operating systems such as Red Hat Enterprise Linux Server 7.X, CentOS 7.X, and Anolis OS 8.X. For more information, see [Software and hardware requirements](../1.requirements-for-software-and-hardware.md).
