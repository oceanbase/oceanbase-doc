...
更多系统视图的说明信息请参考《数据库参考》文档中 [系统视图](../7.reference/3.system-views/) 章节。
...
更多分区的说明及使用请参见 [分区管理](../6.administrator-guide/8.distributed-storage-management/2.manage-partitions/) 。
...
更多优化器的详细信息请参见 [SQL 调优指南](../6.administrator-guide/9.performance-tuning-guide/5.sql-tuning-guide/)。
