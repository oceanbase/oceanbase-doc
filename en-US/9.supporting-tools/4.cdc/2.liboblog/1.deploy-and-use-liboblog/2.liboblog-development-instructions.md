...
The following demo shows how to use liboblog. For more information, see [oblog_tailf](3.oblog_tailf.md) and its [source code](https://github.com/oceanbase/oceanbase/tree/master/src/liboblog/tests). 
**Notice**
