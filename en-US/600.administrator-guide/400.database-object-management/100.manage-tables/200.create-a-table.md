...
This topic describes the creation of non-partitioned tables. For more information about the creation of partitioned tables, see [Create a partitioned table](../../500.data-distribution-and-path-management/100.manage-partitioned-tables-and-partitioned-indexes/300.create-a-partitioned-table/100.create-partitioned-tables.md).
...
In the preceding example, two tables are created. Some constraints, including primary keys and a foreign key, are defined on different columns. For more information about primary key and foreign key, see [Define column constraints](../100.manage-tables/400.define-column-constraints.md).
