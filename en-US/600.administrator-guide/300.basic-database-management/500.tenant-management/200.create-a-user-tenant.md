...
5. Create a resource pool. 
   ...
   3. If none of the servers in a zone have enough resources available for a resource unit, the resource pool fails to create. 
      ...
      For more information, see [Resource management overview](../400.resource-management/100.overview-of-resource-management.md).
...
6. Create a tenant. 
   ...
   For more information, see [Overview of tenant management](../500.tenant-management/100.overview-of-tenant-management.md).
