...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>The parameter information in this topic is based on the configuration template from OceanBase Database V4.3.5 BP1. For recommended configurations of other versions, please refer to the configuration files included in the installation package of the corresponding version to obtain the latest parameter sets.</p>
</main>
