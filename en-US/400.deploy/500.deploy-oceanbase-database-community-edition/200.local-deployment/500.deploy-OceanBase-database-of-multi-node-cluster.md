...
* In the production environment, you must check the environment and configurations. For more information, see Configuration before deployment <temp-hide-link>.

* You have installed obd and OBClient on the central control server. We recommend that you install the latest versions. For more information, see [Deploy OceanBase Database in a container](../200.local-deployment/700.deploy-by-docker.md) and [OBClient documentation](https://github.com/oceanbase/obclient/blob/master/README.md).
