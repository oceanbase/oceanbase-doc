...
* In the production environment, you must perform environment and configuration checks. For specific operations, see [Configuration before deployment](200.environment-and-configuration-checks/800.create-user-optional.md).
