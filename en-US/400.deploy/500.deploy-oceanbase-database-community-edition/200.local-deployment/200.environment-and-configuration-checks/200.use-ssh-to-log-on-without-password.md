...
To set password-free SSH login on the central control server, follow these steps:
...
```
  ...
  <main id="notice" type='notice'>
    <h4>Notice</h4>
    <p>You must replace the <strong>SERVERS</strong> list and <strong>PASSWORD</strong> in the first two lines of the script with your own actual server list and password.</p>
  </main>
