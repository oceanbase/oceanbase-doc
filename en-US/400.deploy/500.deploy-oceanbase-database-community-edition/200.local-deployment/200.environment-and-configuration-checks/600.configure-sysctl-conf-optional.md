...
This topic describes how to improve the Linux performance by modifying the parameters in the `sysctl.conf` file.
...
# Specify to store the core dump file in the data directory of OceanBase Database.
kernel.core_pattern = /data/core-%e-%p-%t
```

Note that `/data` in the `kernel.core_pattern` field indicates the `data` directory of OceanBase Database.
