...
6. Start the deployment.
   ...
   * Click the connection string of OCP Express to go to the logon page of OCP Express. Log in with the account and password provided on the deployment page, and then change the password. Then, you can manage the cluster on the GUI. 
