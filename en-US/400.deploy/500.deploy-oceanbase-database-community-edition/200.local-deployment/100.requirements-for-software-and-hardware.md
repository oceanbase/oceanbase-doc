...
| Alibaba Cloud Linux 3, CentOS 8, Red Hat 8, Debian 10, Anolis OS 8.X | [RPM packages for el8](https://mirrors.aliyun.com/oceanbase/community/stable/el/8/x86_64/) |
...
| Item | Description |
|----------|-----------------------------------------------------------------------------------------------------------------------|
| Operating system | <ul><li>Anolis OS 8.X (Linux kernel 3.10.0 or above)</li><li>Alibaba Cloud Linux 2/3 (Linux kernel 3.10.0 or above)</li><li>Red Hat Enterprise Linux Server 7.X, 8.X (Linux kernel 3.10.0 or above)</li><li>CentOS Linux 7.X, 8.X (Linux kernel 3.10.0 or above)</li><li>Debian 9.X or later (Linux kernel 3.10.0 or above)</li><li>Ubuntu 16.X or later (Linux kernel 3.10.0 or above)</li><li>SUSE/OpenSUSE 15.X or later (Linux kernel 3.10.0 or above)</li><li>KylinOS V10</li><li>Unity Operating System (UOS) V20</li><li>NFSChina V4.0 or later</li><li>Inspur KOS V5.8</li></ul> |
...
| Memory | <ul><li> For the test environment, at least 6 GB is required.  </li><li> For the production environment, at least 16 GB is required. For long-term use, at least 32 GB is required and a value within the range of 256 GB to 1024 GB is recommended.   </li><li>For performance testing purposes, a value within the range of 128 GB to 1024 GB is recommended. </li></ul><main id="notice" type='notice'><h4>Notice</h4><p>When multiple clusters are deployed, we recommend that you use OceanBase Cloud Platform (OCP) for unified O&M management. When you deploy a small number of clusters, we recommend that you use OceanBase Deployer (OBD) for installation and deployment. </p></main> |
