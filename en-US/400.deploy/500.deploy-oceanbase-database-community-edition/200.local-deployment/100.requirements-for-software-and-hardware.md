|slug|requirements-for-software-and-hardware|
|---|---|
...
| Item | Description |
|----------|-----------------------------------------------------------------------------------------------------------------------|
| Operating system | <ul><li>Alibaba Cloud Linux 2/3 (Linux kernel 4.19 or later, recommended 5.10)</li><li>Anolis OS 8.X (Linux kernel 4.19 or later, recommended 5.10)</li><li>Red Hat Enterprise Linux Server 7.X and 8.X (Linux kernel 4.19 or later, recommended 5.10)</li><li>CentOS Linux 7.X and 8.X (Linux kernel 4.19 or later, recommended 5.10)</li><li>Debian 9.X or later (Linux kernel 4.19 or later, recommended 5.10)</li><li>Ubuntu 16.X or later (Linux kernel 4.19 or later, recommended 5.10)</li><li>SUSE/OpenSUSE 15.X or later (Linux kernel 4.19 or later, recommended 5.10) </li><li>KylinOS V10</li><li>UOS V20</li><li>NFSChina V4.0 or later</li><li>Inspur KOS V5.8</li></ul> |
