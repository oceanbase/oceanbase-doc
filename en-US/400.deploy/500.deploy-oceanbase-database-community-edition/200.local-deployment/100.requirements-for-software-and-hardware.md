...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>If your machine may be restarted, to ensure your settings remain in effect after a reboot, it is recommended that you add the following command to your <code>rc.local</code> or <code>systemd</code> configuration.</p>
</main>
