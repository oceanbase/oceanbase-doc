...
2. Decompress the installation package.
    ...
    <main id="notice" type='notice'>
      <h4>Notice</h4>
      <p>This path is used for setting the Java home directory of the current OBServer node, which corresponds to the value of the configuration item <strong>ob_java_home</strong>.</p>
    </main>
...
3. Check whether the package is installed correctly.
    ...
    <main id="notice" type='notice'>
      <h4>Notice</h4>
      <p>This path is used for setting the path of the jar packages that are to be loaded by the JVM upon OBServer startup, which corresponds to the value of the configuration item <strong>ob_java_connector_path</strong>.</p>
    </main>
