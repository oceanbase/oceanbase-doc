...
3. On the **Install OCP** page, specify the parameters in the **Basic Configurations** section.
   ...
   OCP allows you to configure information about the ocp_meta and ocp_monitor tenants for MetaDB in two ways: **MetaDB Create** and **Other OB_MySQL**.

   * For a newly created MetaDB, if no tenant has been created yet, click the **MetaDB Create** tab. The specific parameters are as follows:
...
1. On the **Install OCP** page, specify the parameters in the **MetaDB configuration** section.
...
2. On the **Install OCP** page, specify the parameters of the **Load Balancing Configuration** section.
...
3. On the **Install OCP** page, specify the parameters in the **OpenSearch Configurations**.
