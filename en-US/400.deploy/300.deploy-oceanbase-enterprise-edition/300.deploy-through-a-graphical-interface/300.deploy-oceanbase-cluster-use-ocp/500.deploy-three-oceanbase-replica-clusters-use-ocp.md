...
|dir-name-en||
|tenant-type||
|slug|deploy-three-oceanbase-replica-clusters-use-ocp|
...
6. On the **Create Cluster** page, configure the deployment mode of the cluster.
   ...
   <!-- ![2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.1.0/4.deploy/3.deploy-oceanbase-database-enterprise/4.deploy-ob/2F%2BA/2%E9%83%A8%E7%BD%B2%E6%A8%A1%E5%BC%8F-%E4%B8%AD%E6%96%87-3.png) -->
...
8. (Optional) On the **Create Cluster** page, configure the path and port settings in the **Custom Settings** module.
