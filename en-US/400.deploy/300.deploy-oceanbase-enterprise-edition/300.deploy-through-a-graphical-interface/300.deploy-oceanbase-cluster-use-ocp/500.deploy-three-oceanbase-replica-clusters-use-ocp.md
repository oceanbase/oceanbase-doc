...
<main id="notice" type='explain'>
   <h4>Note</h4>
   <p>This topic uses OCP V4.2.1 as an example. The GUI may vary with the OCP version. </p>
</main>
...
* You have logged in to the OCP console and have the `CREATE CLUSTER` privilege. For more information, see [Role overview](https://en.oceanbase.com/docs/common-ocp-10000000001187840) and [Default OCP roles](https://en.oceanbase.com/docs/common-ocp-10000000001187841).
...
* For more information about how to create a tenant by using OCP, see [Create a primary tenant](https://en.oceanbase.com/docs/common-ocp-10000000001703535).
...
* [Role overview](https://en.oceanbase.com/docs/common-ocp-10000000001704544)
* [Default OCP roles](https://en.oceanbase.com/docs/common-ocp-10000000001704543)
...
* [Create a cluster](https://en.oceanbase.com/docs/common-ocp-10000000001703701)
