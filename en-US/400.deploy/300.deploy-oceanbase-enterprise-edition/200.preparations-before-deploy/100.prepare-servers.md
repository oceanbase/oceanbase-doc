...
The following table lists the minimum configuration requirements of the servers.
...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p><ul><li>2F indicates a two-replica cluster. </li><li>4F indicates a four-replica cluster. </li><li><code>primary_zone=RANDOM</code>: You can set <code>primary_zone</code> to <code>RANDOM</code> in uppercase to randomly select any zone with the highest priority as the primary zone. </li><li><code>unit_num=1</code>: The resource pool has one unit in the target zone.</li><li>A single-unit tenant has one unit in a zone. </li></ul>For more information about <code>primary_zone</code> and <code>unit_num</code>, see <a href="../../../600.manage/200.tenant-management/600.common-tenant-operations/200.manage-create-tenant.md">Create a tenant</a>. </p>
</main>
