...
|------------------------|---------|---------------------|
| Rocky Linux             |   9   | x86_64 (including Hygon) or AArch64 (Kunpeng and Phytium) |
| Alibaba Cloud Linux     | 2 or 3   | x86_64 (including Hygon) or AArch64 (Kunpeng and Phytium) |
...
| CentOS/Red Hat Enterprise Linux | <ul><li>CentOS Linux 7.X and 8.X (Linux kernel V3.10.0 or later)</li><li>Red Hat Enterprise Linux Server 7.X and 8.X (Linux kernel V3.10.0 or later)</li></ul> | x86_64 (including Hygon) or AArch64 (Kunpeng, Phytium) |
...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p><ul><li>Before you use an operating system, configure the network and install a package manager such as YUM and Zypper first.</li><li>The servers for deploying the OceanBase cluster must be in little-endian mode. </li></ul></p>
</main>
