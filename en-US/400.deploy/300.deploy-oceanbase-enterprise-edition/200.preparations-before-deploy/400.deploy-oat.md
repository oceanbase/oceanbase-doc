...
3. Set a password and activate the account.
   ...
   Log in with the default password of the `admin` account, then set a password to activate the account.
...
For more information about installing OAT, see [Install OAT](https://en.oceanbase.com/docs/enterprise-oat-10000000000949551).