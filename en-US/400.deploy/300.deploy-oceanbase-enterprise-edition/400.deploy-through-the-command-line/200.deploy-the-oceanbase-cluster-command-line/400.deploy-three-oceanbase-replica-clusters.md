...
1. Start the observer process on the nodes.
   ...
   <main id="notice" type='notice'>
   <h4>Notice</h4>
   <p>In a three-replica OceanBase cluster, the startup parameters of the OBServer nodes are not exactly the same When you start the observer process, you only need to specify three or more servers that run RootService. You can add servers after the cluster is created. </p>
   </main>
