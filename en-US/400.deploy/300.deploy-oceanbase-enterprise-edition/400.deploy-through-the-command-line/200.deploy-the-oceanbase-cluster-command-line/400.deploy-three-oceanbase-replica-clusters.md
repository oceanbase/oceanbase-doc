...
2. (Optional) Install OBClient.
   ...
   <main id="notice" type='notice'>
      <h4>Notice</h4>
      <p>OBClient of a version earlier than V2.2.1 depends on OceanBase Connector/C. Therefore, you must first install OceanBase Connector/C.<br> Contact OceanBase Technical Support to obtain the RPM packages of OBClient and OceanBase Connector/C. </p>
   </main>
