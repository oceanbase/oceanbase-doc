...
This topic describes how to install ODP by using the ODP package.
  ...
  <main id="notice" type='notice'>
    <h4>Notice</h4>
    <ul>
    <li>After you deploy ODP on a server, ODP provides the proxy service of OceanBase Database by exposing a socket in the <code>IP address:port</code> format. You can access OceanBase Database through the socket in the same way you access MySQL Database. We recommend that you deploy ODP on an OBServer node. </li>
