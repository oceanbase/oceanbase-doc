...
### OceanBase cluster
You can observe the performance of OceanBase Database in different ways based on the type of your OceanBase cluster. If you have created a single-node OceanBase cluster, you can observe the performance of OceanBase Database in standalone deployment mode. For more information about how to create an OceanBase cluster, see [Quick Start](../../2.Quick-Start.md).<br />You can run the following command to install ODP:
```sql
yum install obproxy-ce-3.2.3-2.el7.x86_64.rpm
```


In this example, the tenant name is **test**. You can create your own tenant. For more information, see the [Experience the multi-tenant feature](../4.Experience-the-multi-tenant-feature.md).
<a name="W51JQ"></a>
