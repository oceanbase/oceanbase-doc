...
## Deploy olumnstore replicas and configure ODP

The following content mainly introduces how to deploy and configure ODP in the OceanBase cluster to access olumnstore replicas.
