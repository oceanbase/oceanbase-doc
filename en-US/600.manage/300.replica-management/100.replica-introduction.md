...
* Columnar replicas
  ...
  AP scenarios: For details about how to deploy columnar replicas in AP scenarios, see [Overview of OceanBase AP deployment](../../620.obap/150.obap-deploy/10.obap-deploy-overview.md).
