...
* Read-only replicas
  ...
  Read-only replicas are optional. You can deploy them based on actual business needs. For more information, see [Read-only replicas](../../700.reference/100.oceanbase-database-concepts/500.distributed-database-objects/300.data-partitions-and-replicas/300.partition-replica-type/300.read-only-replica.md).
...
* Columnstore replicas
  ...
  For detailed deployment of columnstore replicas in AP scenarios, see [Overview of OceanBase AP deployment](../../620.obap/150.obap-deploy/10.obap-deploy-overview.md).
