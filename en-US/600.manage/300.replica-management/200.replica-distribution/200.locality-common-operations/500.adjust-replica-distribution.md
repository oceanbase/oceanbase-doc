...
4. Modify the locality of the `mysql001` tenant to add a replica in zone4.
   ...
   ```shell
   obclient(root@sys)[oceanbase]> ALTER TENANT mysql001 locality="FULL{1}@zone1, FULL{1}@zone2, FULL{1}@zone3, FULL{1}@zone4";
   ```
...
6. Modify the locality of the `mysql001` tenant to remove the replica in zone3.
   ...
   ```shell
   obclient(root@sys)[oceanbase]> ALTER TENANT mysql001 locality="FULL{1}@zone1, FULL{1}@zone2, FULL{1}@zone4";
   ```
