...
3. View locality change jobs.
   ...
   * Query the execution status of locality modification jobs.
   ...
   * View the locality change history of a tenant.
     ...
     Take the job with the ID of `4` as an example. It is a job for changing the locality of the tenant with the ID of `1002` from `FULL{1}@zone1, FULL{1}@zone2` to `FULL{1}@zone1, FULL{1}@zone2, FULL{1}@zone3`. It was created at 2023-01-06 14:39:56.377599 and completed at 2023-01-06 14:40:57.874498.
