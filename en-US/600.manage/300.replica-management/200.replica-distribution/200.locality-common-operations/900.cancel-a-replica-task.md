...
2. Query the ongoing replica task.
    ...
    * User tenant
      ...
      For more information about the fields in the `DBA_OB_LS_REPLICA_TASKS` view, see [DBA_OB_LS_REPLICA_TASKS](../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/10200.o-dba_ob_ls_replica_tasks-of-mysql-mode.md).
...
4. Check whether the replica task is canceled.
    ...
    * User tenant
      ...
      For more information about the fields in the `DBA_OB_LS_REPLICA_TASK_HISTORY` view, see [DBA_OB_LS_REPLICA_TASK_HISTORY](../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/10250.o-dba_ob_ls_replica_task_history-of-mysql-mode.md).
