...
The elements in the syntax are described as follows:

|  **Element**  |       **Description**        |
|------------|-----------------------|
|  replicas  | Specifies the replica type. The value of replicas is the replica name, which can be obtained from the Name column of the replica type description table in [Replica Overview](../100.replica-introduction.md). It supports both the full name and abbreviation.|
...
* The locality attribute of the sys tenant is `F@z1,F@z2,F@z3,F@z4,F@z5`.

  This indicates that the sys tenant has one all-purpose replica in each of the zones z1, z2, z3, z4, and z5.

* The locality attribute of tenant1 is `F@z1,F@z2,F@z3`.

  This indicates that tenant1 has one all-purpose replica in each of the zones z1, z2, and z3.

* The locality attribute of tenant2 is `F@z3,F@z4,F@z5`.

  This indicates that tenant2 has one all-purpose replica in each of the zones z3, z4, and z5.
