...
| unit_server | The OBServer where the tenant unit is located. |
| max_cpu | The maximum number of CPU cores that the tenant unit can use. |
| min_cpu | The minimum number of CPU cores that the tenant unit can use. |
