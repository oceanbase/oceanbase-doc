...
This topic will guide you on how to quickly perform an end-to-end diagnosis of OceanBase Database using obdiag.
...
Here, a SQL query statement is used as an example to demonstrate how to perform an end-to-end diagnosis.
...
Exit the OBServer node and execute the following command to perform the end-to-end diagnosis:
...
```
 ...
 ### Step 4: View end-to-end diagnosis details

```bash
$ cat analyze_pack_20231008171201/result_details.txt
```

The end-to-end diagnosis results will include the TOP 5 time-consuming Leaf Spans, as well as detailed information and tags for each Span.  