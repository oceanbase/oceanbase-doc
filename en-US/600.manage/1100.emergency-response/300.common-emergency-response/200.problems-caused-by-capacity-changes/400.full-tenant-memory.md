...
1. Increase the tenant memory configuration. We recommend that you directly expand tenant memory in OCP by referring to [Expand tenant memory](https://en.oceanbase.com/docs/ocp-en). If you use the command line, follow these sub-steps:
