...
If a tenant in the cluster experiences a backlog of queued requests, you can address the issue in the following ways:
...
3. If you find SQL with abnormal execution count spikes, perform throttling after confirming with the business.

   1. Identify SQL with execution count spikes.

      Use the SQL Diagnostics feature in OCP. Check the execution count option to view the execution count trend of an SQL statement within a specified period.
