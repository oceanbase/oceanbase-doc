...
* obproxy nodes being centrally deployed in a cluster
   ...
   3. In the cluster list, select the OBProxy cluster to operate and enter the OBProxy cluster overview page.

   4. Click **Add OBProxy**.

   5. In the dialog box, fill in **Software version, IDC, SQL port, Exporter, Machine type, Host selection method, Host**, and other information.

   6. Click **OK**.

   For more information, see [Add OBProxy](../../../../700.reference/1200.database-proxy/200.obproxy-management/300.manage-obproxy/100.add-obproxy.md).
