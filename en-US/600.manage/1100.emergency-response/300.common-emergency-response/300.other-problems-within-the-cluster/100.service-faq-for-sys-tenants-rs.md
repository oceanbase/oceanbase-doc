...
Restart the OBServer node where the faulty RootService is located. For more information, see [Restart an OBServer node](https://en.oceanbase.com/docs/enterprise-oceanbase-ocp-en-10000000000838283).