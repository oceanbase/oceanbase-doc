...
In addition to views of statistics and details, OceanBase Database displays information such as the number of calls and spins of each type of latch events in the `GV$LATCH` view. Here is an example:
