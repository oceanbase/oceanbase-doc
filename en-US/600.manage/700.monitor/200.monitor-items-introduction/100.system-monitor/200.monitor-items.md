...
Metrics provide general diagnostics. A metric is a specific value collected during event tracking, such as the number of SQL statement executions, execution time, and I/O throughput. OceanBase Database supports more than 600 metrics, which are classified into 14 classes to provide all key execution information such as the information about the network, request queues, transactions, SQL statements, cache, storage, resource quotas, and logs. Some metrics, such as QPS, TPS, QPS_RT, TPS_RT, and Active_sessions, provide real-time information and are collected by second in OceanBase Database. Metrics of other information are collected by minute.
...
The `STAT_ID` and `NAME` fields describe the ID and name of a metric. For example, the following example shows the information about all metrics in the SQL class:
...
| sql select time | The total time spent in executing the `SELECT` statement, in microseconds. |
| sql insert count | The number times that the `INSERT` statement is executed. |
| sql insert time | The total time spent in executing the `INSERT` statement, in microseconds. |
| sql replace count | The number of times that the `REPLACE` statement is executed. |
| sql replace time | The total time spent in executing the `REPLACE` statement, in microseconds. |
| sql update count | The number of times that the `UPDATE` statement is executed. |
| sql update time | The total time spent in executing the `UPDATE` statement, in microseconds. |
| sql delete count | The number of times that the `DELETE` statement is executed. |
| sql delete time | The total time spent in executing the `DELETE` statement, in microseconds. |
| sql other count | The number of times that other statements are executed. |
| sql other time | The total time spent in executing other statements, in microseconds. |
| ps prepare count | The number of PrepareStatements. |
| ps prepare time | The time spent in executing PrepareStatements, in microseconds. |
| ps execute count | The number of executed PrepareStatements. |
| ps close count | The number of closed PrepareStatements. |
| ps close time | The time spent in closing PrepareStatements, in microseconds. |
| sql commit count | The number of transaction commits. |
| sql commit time | The time spent in transaction commits, in microseconds. |
| sql rollback count | The number of transaction rollbacks. |
| sql rollback time | The time spent in transaction rollbacks, in microseconds. |
| opened cursors current | The number of currently open cursors, which is the number of cursors cached in the session that OceanBase Cloud Platform (OCP) uses. |
| opened cursors cumulative | The cumulative number of open cursors. |
| sql local count | The number of times that local statements are executed. |
| sql remote count | The number of times that remote statements are executed. |
| sql distributed count | The number of times that distributed statements are executed. |
...
| sql inner select time | The total time spent in executing inner SQL `SELECT` statements, in microseconds. |
| sql inner insert count | The number times that inner SQL `INSERT` statements are executed. |
| sql inner insert time | The total time spent in executing inner SQL `INSERT` statements, in microseconds. |
| sql inner replace count | The number of times that inner SQL `REPLACE` statements are executed. |
| sql inner replace time | The total time spent in executing inner SQL `REPLACE` statements, in microseconds. |
| sql inner update count | The number of times that inner SQL `UPDATE` statements are executed. |
| sql inner update time | The total time spent in executing inner SQL `UPDATE` statements, in microseconds. |
| sql inner delete count | The number of times that inner SQL `DELETE` statements are executed. |
| sql inner delete time | The total time spent in executing inner SQL `DELETE` statements, in microseconds. |
| sql inner other count | The number of times that other inner SQL statements are executed. |
| sql inner other time | The total time spent in executing other inner SQL statements, in microseconds. |
| user logons cumulative | The cumulative number of user logins. |
| user logouts cumulative | The cumulative number of user logouts. |
| user logons failed cumulative | The cumulative number of failed user logins. |
| user logons time cumulative | The total time spent on user logins, in microseconds. |
| sql local execute time | The time spent in executing SQL queries on local database nodes, in microseconds. |
| sql remote execute time | The time spent in executing SQL queries on remote nodes, in microseconds. |
| sql distributed execute time | The total time spent in executing SQL queries in distributed transactions or across multiple nodes, in microseconds. |
| sql fail count | The number of failed SQL executions. |
| inner sql local count | The number of times that internally generated local SQL statements are executed. |
| inner sql remote count | The number of times that internally generated remote SQL statements are executed. |
| inner sql distributed count | The number of times that internally generated distributed SQL statements are executed. |
...
| rpc net delay | The network latency during RPC distribution, which is the period between receiving time and the sending time. |
...
| request queue time | The cumulative time that requests take from being received to being processed and queued, which is the period requests wait to end minus the time in the queue, in microseconds. |
...
| Parameter | Description |
| --- | --- |
| trans commit log sync time | The total duration for synchronizing commit logs (clogs) to the majority of replicas, in microseconds. |
| trans commit log sync count | The total number of clogs. |
| trans commit log submit count | The number of clogs committed in the tenant. |
| trans start count | The number of transactions started in the tenant. |
| trans total used time | The total time spent on transactions in the tenant, in microseconds. |
| trans commit count | The number of times that the transaction was committed. |
| trans commit time | The time consumed in the transaction commit phase, in microseconds. |
| trans rollback count | The number of transaction rollbacks. |
| trans rollback time | The time consumed in the transaction rollback phase, in microseconds. |
| trans timeout count | The number of timed-out transactions. |
...
| xa start total count           | The total number of `XA_START` statements, including successful and failed ones. |
| xa start total used time       | The total time spent in executing the `XA_START` statements, including successful and failed ones, in microseconds. |
| xa start with rpc total count  | The total number of successful `XA_START` statements by using RPCs. |
| failed xa start total count    | The total number of failed `XA_START` statements. |
| xa end total count             | The total number of `XA_END` statements, including successful and failed ones. |
| xa end total used count        | The total time spent in executing the `XA_END` statements, including successful and failed ones, in microseconds. |
| xa end with rpc total count    | The total number of successful `XA_END` statements by using RPCs. |
| failed xa end total count      | The total number of failed `XA_END` statements. |
| xa prepare total count         | The total number of `XA_PREPARE` statements, including successful and failed ones. |
| xa prepare total used time     | The total time spent in executing the `XA_PREPARE` statements, including successful and failed ones, in microseconds. |
| xa prepare with rpc total count| The total number of successful `XA_PREPARE` statements by using RPCs. |
| failed xa prepare total count  | The total number of failed `XA_PREPARE` statements. |
| xa commit total count          | The total number of `XA_COMMIT` statements, including successful and failed ones. |
| xa commit total used time      | The total time spent in executing the `XA_COMMIT` statements, including successful and failed ones, in microseconds. |
| xa commit with rpc total count | The total number of successful `XA_COMMIT` statements by using RPCs. |
| failed xa commit total count   | The total number of failed `XA_COMMIT` statements. |
| xa rollback total count        | The total number of `XA_ROLLBACK` statements, including successful and failed ones. |
| xa rollback total used time    | The total time spent in executing the `XA_ROLLBACK` statements, including successful and failed ones, in microseconds. |
| xa rollback with rpc total count | The total number of successful `XA_ROLLBACK` statements by using RPCs. |
| failed xa rollback total count | The total number of failed `XA_ROLLBACK` statements. |
...
| location cache size | The size of the location cache. |
| tablet ls cache size | The size of the clog cache. |
...
| io read bytes | The number of I/O read bytes. |
...
| memstore wait write lock time | The time spent in waiting for row locks, in microseconds. |
| memstore wait read lock time | The time spent in waiting for snapshot reads, in microseconds. |
...
| major freeze trigger | The threshold for triggering a major compaction. |
...
| Parameter | Description |
| --- | --- |
| max memory size | The maximum memory for the tenant. |
| memory usage | The memory currently in use by the tenant. |
| min cpus | The value of the `min_cpu` field of UNIT_CONFIG for the tenant × 100. |
| max cpus | The value of the `max_cpu` field of UNIT_CONFIG for the tenant × 100. |
| cpu usage | The logical CPU usage. For example, the value `148` represents 148%, indicating that the tenant uses multiple logical CPU cores. |

The metrics described in the preceding sample code can be used to calculate the CPU utilization, thread utilization, and memory usage of the tenant based on the following formulas:

* Tenant CPU utilization = cpu usage (stat_id = 140006) / max cpus (stat_id = 140005)

* Tenant thread utilization = cpu usage (stat_id = 140006) / max cpus (stat_id = 140005)
...
| clog write time | The time spent on disk writes of clogs, in microseconds. |
| clog trans log total size | The total size of committed clogs. |
...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>If the name of a metric does not contain <code>background</code>, the metric does not incorporate the time spent in the background. For example, the <code>idle wait time</code> metric measures only the time spent on sessions in the foreground, and does not incorporate the time measured by the <code>background database idle wait time</code> metric. The statistical values of the two metrics are mutually exclusive. </p>
</main>

| Parameter | Description |
| ---- | ---- |
| DB time                                | The total amount of active time of the database, which is an accumulative value of the CPU time and non-idle wait time, in microseconds. |
| DB CPU                                 | The CPU time consumed by the database in the active state, in microseconds. |
| background elapsed time                | The total amount of time spent on background process execution, in microseconds. |
| background cpu time                    | The CPU time consumed by background processes, in microseconds. |
| non idle wait time                     | The amount of non-idle wait time, namely, the total amount of time elapsed when the session is in the wait but not idle state, in microseconds. |
| idle wait time                         | The amount of idle wait time, namely, the total amount of time elapsed when the session is in the idle wait state, in microseconds. |
| background database time               | The total amount of time spent in executing database operations by background processes, in microseconds. |
| background database non-idle wait time | The amount of time spent in executing database operations by background processes in the non-idle wait state, in microseconds. |
| background database idle wait time     | The amount of time spent in executing database operations by background processes in the idle wait state, in microseconds. |
| concurrency wait total time            | The total amount of wait time caused by concurrency issues, such as the wait time caused by resource locking, in microseconds. |
| user io wait total time                | The total amount of time spent by user processes in waiting for the I/O operations, such as data reads from or data writes to the disk, to complete, in microseconds. |
| application wait total time            | The total amount of wait time caused by the application code, such as lock waits caused by row-level locking or explicit lock commands, in microseconds. |
...
* The following example shows how to query the `GV$OB_PROCESSLIST` view for the number of active sessions at the unit level:
