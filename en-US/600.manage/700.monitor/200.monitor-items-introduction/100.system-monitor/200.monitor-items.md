...
| sql other time | The total time spent in executing other statements. |
| ps prepare count | The number of PrepareStatements. |
| ps prepare time | The time spent in executingPrepareStatements. |
| ps execute count | The number of executed PrepareStatements. |
| ps close count | The number of closed PrepareStatements. |
| ps close time | The time spent in closing PrepareStatements. |
| opened cursors current | The number of currently open cursors, which is the number of cursors cached in the session that OceanBase Cloud Platform (OCP). |
...
| sql inner select time | The total time spent in executing inner SQL `SELECT` statements. |
| sql inner insert count | The number times that inner SQL `INSERT` statements are executed. |
| sql inner insert time | The total time spent in executing inner SQL `INSERT` statements. |
| sql inner replace count | The number of times that inner SQL `REPLACE` statements are executed. |
| sql inner replace time | The total time spent in executing inner SQL `REPLACE` statements. |
| sql inner update count | The number of times that inner SQL `UPDATE` statements are executed. |
| sql inner update time | The total time spent in executing inner SQL `UPDATE` statements. |
| sql inner delete count | The number of times that inner SQL `DELETE` statements are executed. |
| sql inner delete time | The total time spent in executing inner SQL `DELETE` statements. |
| sql inner other count | The number of times that other inner SQL  statements are executed. |
| sql inner other time | The total time spent in executing other inner SQL statements. |
...
| user logons time cumulative | The total time spent on user logins. |
...
| request queue time | The cumulative time that requests take from being received to being processed and queued, which is the period requests wait to end minus the time in the queue. |
...
| Parameter | Description |
| --- | --- |
| trans commit log sync time | The total duration for synchronizing commit logs (clogs) to the majority of replicas. |
...
| xa start total used time       | The total time spent in executing the `XA_START` statements, including successful and failed ones. |
...
| xa end total used count        | The total time spent in executing the `XA_END` statements, including successful and failed ones. |
...
| xa prepare total used time     | The total time spent in executing the `XA_PREPARE` statements, including successful and failed ones. |
...
| xa commit total used time      | The total time spent in executing the `XA_COMMIT` statements, including successful and failed ones. |
...
| xa rollback total used time    | The total time spent in executing the `XA_ROLLBACK` statements, including successful and failed ones. |
...
| background database time               | The total amount of time spent in executing database operations by background processes. |
| background database non-idle wait time | The amount of time spent in executing database operations by background processes in the non-idle wait state. |
| background database idle wait time     | The amount of time spent in executing database operations by background processes in the idle wait state. |
