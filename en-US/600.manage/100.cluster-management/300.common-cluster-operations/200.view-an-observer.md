...
2. Query the `DBA_OB_SERVERS` view for information about all nodes in the cluster.
   ...
   * `BUILD_VERSION`: the version number of the OceanBase Database software.
   ...
   For more information about the `DBA_OB_SERVERS` view, see [DBA_OB_SERVERS](../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/5000.oceanbase-dba_ob_servers-of-sys-tenant.md).
