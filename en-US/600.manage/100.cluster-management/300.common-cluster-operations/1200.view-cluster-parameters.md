...
For more information about the `GV$OB_PARAMETERS` view, see [GV$OB_PARAMETERS (MySQL mode)](../../../7.reference/5.system-reference/4.system-overview-of-mysql-mode/3.performance-view-of-mysql-mode/6.gv-ob_parameters-of-mysql-mode.md) and [GV$OB_PARAMETERS (Oracle mode)](../../../7.reference/5.system-reference/5.system-overview-of-oracle-mode/3.performance-view-of-oracle-mode/6.gv-ob_parameters-of-oracle-mode.md).
