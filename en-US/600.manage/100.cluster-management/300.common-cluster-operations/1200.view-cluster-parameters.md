...
You can view the current and default values of cluster parameters from the `sys` tenant or a user tenant.
...
2. Execute the following statement to view cluster parameters:
   ...
   * You can specify the `TENANT` keyword to view the parameters of the specified tenant.
   ...
   | data_type  | The data type of the parameter. Valid values are `STRING`, `CAPACITY`, and so on.              |
   ...
   | section    | The category of the parameter. Valid values:<ul><li>`SSTABLE`: indicates an SSTable-related parameter. </li> <li>`OBSERVER`: indicates an OBServer node-related parameter. </li>  <li>`ROOT_SERVICE`: indicates a RootService-related parameter. </li> <li>`TENANT`: indicates a tenant-related parameter. </li> <li>`TRANS`: indicates a transaction-related parameter. </li> <li>`LOAD_BALANCE`: indicates a load balancing-related parameter. </li>  <li>`DAILY_MERGE`: indicates a major compaction-related parameter. </li> <li>`CLOG`: indicates a clog-related parameter. </li>   <li>`LOCATION_CACHE`: indicates a location cache-related parameter. </li> <li>`CACHE`: indicates a cache-related parameter. </li>   <li>`RPC`: indicates an RPC-related parameter. </li> <li>`OBPROXY`: indicates an ODP-related parameter. </li></ul> |
