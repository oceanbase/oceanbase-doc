...
3. Migrate the resource units from the old node to the new node.
   ...
   1. Query the `oceanbase.DBA_OB_SERVERS` view for information about the node to be replaced.
      ...
      For more information about the `oceanbase.DBA_OB_SERVERS` view, see [oceanbase.DBA_OB_SERVERS](../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/5000.oceanbase-dba_ob_servers-of-sys-tenant.md).
