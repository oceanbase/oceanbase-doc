...
* **When a barrier version exists between the current version and the target version:**
...
* **When no barrier version exists between the current version and the target version:**
