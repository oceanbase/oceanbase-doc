...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>You can query the oceanbase.DBA_OB_ARBITRATION_SERVICE view of the sys tenant to check whether the current OceanBase cluster is associated with the arbitration service. </p>
</main>
