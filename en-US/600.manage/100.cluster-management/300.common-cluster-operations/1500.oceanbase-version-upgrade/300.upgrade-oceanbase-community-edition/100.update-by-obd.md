...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <ul>
    <li><p>If the cluster to be upgraded has standby tenants, you need to first upgrade the cluster where the standby tenant resides, or perform a switchover to switch the primary and standby roles.</p></li>
    <li><p>obd supports upgrading both Enterprise and Community editions of OceanBase clusters. This section uses upgrading a Community edition OceanBase cluster as an example to illustrate the upgrade process.</p></li>
  </ul>
</main>

:::tab

tab Method 1: Upgrade OceanBase Database online
...
5. Perform a major compaction of OceanBase Database.
   ...
   For more information about the `oceanbase.CDB_OB_MAJOR_COMPACTION` view, see [oceanbase.CDB_OB_MAJOR_COMPACTION](../../../../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/10000.o-cdb_ob_major_compaction-of-sys-tenant.md).
...
tab Method 2: Upgrade OceanBase Database offline
...
1. Configure the RPM package.
   ...
   * Method 2: Download the all-in-one installation package of the required version from [OceanBase Download Center](https://www.oceanbase.com/softwarecenter), copy the installation package to the server where obd is installed, and run the following command to decompress and install the package:
     ...
     <main id="notice" type='notice'>
       <h4>Notice</h4>
       <p>You must install the all-in-one installation package with the same account that you use to deploy OceanBase Database, such as the admin account.</p>
     </main>
