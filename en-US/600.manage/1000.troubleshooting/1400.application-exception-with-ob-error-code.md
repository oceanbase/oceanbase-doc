...
<!-- The troubleshooting process for application exceptions where error messages contain OceanBase error codes is shown in the figure below.

![Troubleshooting process for application exceptions where error messages contain OceanBase error codes](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.3.5/troublethooting/app-exception-with-error-code-V4x-new1.png) -->
