...
<!-- The troubleshooting process for application disconnection is shown in the figure below.

![Troubleshooting process for application disconnection](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.3.5/troublethooting/application-disconnection-new1.png) -->
...
* When connecting to OceanBase Database in MySQL-compatible mode, the connection is disconnected and the error `ERROR 2013` is returned.
