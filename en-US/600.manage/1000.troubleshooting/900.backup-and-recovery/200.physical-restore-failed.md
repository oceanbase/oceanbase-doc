...
2. Query the `CDB_OB_RESTORE_HISTORY` view for information in the `comment` column.
   ...
   For more information about the `CDB_OB_RESTORE_HISTORY` view, see [CDB_OB_RESTORE_HISTORY](../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/9500.oceanbase-cdb_ob_restore_history-of-mysql-mode.md).
