...
1. Log on to the OBServer node where the arbitration service resides as the `root` user.
...
For more information about O&M operations related to the arbitration service, see [Overview](../400.high-availability/400.arbitration-high-availability/100.arbitration-service-overview.md).
