...
1. Log in to the machine where the arbitration server resides as the `root` user.

2. View the value of the system minimum free memory. The unit of this parameter is KB.
...
For more information about O&M operations related to the arbitration service, see [Arbitration high availability](../400.high-availability/400.arbitration-high-availability/100.arbitration-service-overview.md).
