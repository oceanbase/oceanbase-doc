...
# Migration, replication, and rebuild
...
1. Obtain the list of tasks that have been scheduled by RootService but have not been completed (`tenant_id`, `ls_id`):
...
2. Obtain and analyze the migration or replication tasks that have reported errors:
