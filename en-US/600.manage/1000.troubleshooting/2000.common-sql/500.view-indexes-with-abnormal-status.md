...
# View the status of indexes with exceptions
...
For a user tenant in MySQL mode, run the following statement:
...
For a user tenant in Oracle mode, run the following statement:
...
You can run the following statements to query the index usage.

* For the sys tenant

  For the sys tenant, run the following statement:
