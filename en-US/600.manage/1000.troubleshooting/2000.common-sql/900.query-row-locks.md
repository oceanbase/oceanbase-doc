...
* User tenant
  ...
  In MySQL mode of a user tenant, you can execute the following statement:
  ...
  In Oracle mode of a user tenant, you can execute the following statement:
...
After you obtain the `session_id` of the transaction that holds a lock, you can execute the `kill session_id` statement to roll back the transaction.
