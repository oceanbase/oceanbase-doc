...
* For the sys tenant
  ...
  You can execute the following statement to query table fragmentation:
...
* For user tenants
  ...
  In MySQL mode, you can execute the following statement to query table fragmentation:
  ...
  In Oracle mode, you can execute the following statement to query table fragmentation:
