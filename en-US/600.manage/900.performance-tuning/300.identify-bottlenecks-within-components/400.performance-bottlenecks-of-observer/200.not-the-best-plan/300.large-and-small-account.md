...
# Plan optimality for account size skew
...
For more information, see the section **How to resolve SQL query issues related to account size skew** in the [SQL FAQ](../../../../../800.FAQ/200.sql-related-problems-faq.md), and the **Account size skew scenario** in [Typical SQL tuning scenarios and cases](../../../400.sql-tuning/800.sql-tuning-samples.md).