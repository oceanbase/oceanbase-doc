...
The performance-related data is summarized as follows:
...
alter proxyconfig set use_local_dbconfig=true; -- Available in ODP V3.x series only
...
1. `top` command
   ...
   2. Use `top -H` to view thread CPU consumption. ODP thread consumption is very even.
