...
In OceanBase Database, we can also plan and design better indexes to help the optimizer filter out poor execution plans based on rules and avoid jitter.