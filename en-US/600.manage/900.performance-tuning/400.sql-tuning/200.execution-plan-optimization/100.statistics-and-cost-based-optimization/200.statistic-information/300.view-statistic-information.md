...
Key fields of these views are described as follows:
...
* `LAST_ANALYZED`: the time when statistics were collected. A non-NULL value indicates that statistics of the column have been collected.
