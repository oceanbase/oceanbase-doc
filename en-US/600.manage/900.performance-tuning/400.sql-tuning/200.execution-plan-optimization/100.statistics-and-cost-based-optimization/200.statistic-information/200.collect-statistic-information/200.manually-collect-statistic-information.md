...
* `method_opt`: the statistics collection method at the column level. You can use the following syntax to set this parameter:
    ...
    ```
    `size_clause` specifies how to collect histograms from column statistics. The options of `size_clause` are described as follows:
