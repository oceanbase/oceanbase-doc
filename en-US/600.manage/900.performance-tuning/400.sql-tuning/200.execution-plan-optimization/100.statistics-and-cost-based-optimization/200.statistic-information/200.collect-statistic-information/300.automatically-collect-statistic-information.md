...
Key fields of the `DBA_SCHEDULER_JOBS` view are described as follows:
...
The OceanBase Database optimizer allows you to set the start time and collection duration of automatic statistics collection jobs to cope with your business requirements.
...
This section describes the working mechanism of automatic statistics collection jobs. The following figure shows how an automatic statistics collection job is executed.
...
| Mode | View | Description |
|---|---|---|
|Oracle |`ALL_TAB_MODIFICATIONS`|Displays all DML STATS information in the table.|
|Oracle| `DBA_TAB_MODIFICATIONS`|Displays all DML STATS information in the table.|
|Oracle| `USER_TAB_MODIFICATIONS`|Displays all DML STATS information in the table.|
|MySQL |`OCEANBASE.DBA_TAB_MODIFICATIONS`|Displays all DML STATS information in the table.|
