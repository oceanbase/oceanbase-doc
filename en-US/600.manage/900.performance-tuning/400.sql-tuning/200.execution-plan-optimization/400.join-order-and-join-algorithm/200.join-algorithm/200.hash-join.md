...
## When does the optimizer choose hash joins
...
* Use a data source with a small amount of data to build a hash table, which serves as the driving table, if possible.
