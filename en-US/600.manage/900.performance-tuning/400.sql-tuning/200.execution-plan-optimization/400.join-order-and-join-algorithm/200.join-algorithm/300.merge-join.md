...
This section provides sample pseudocode to briefly describe the connection process of the merge join algorithm. Note that actual execution of the algorithm is more complex than that described in the example. Here is the sample pseudocode of merge join execution:
...
## When does the optimizer choose merge joins
