...
As shown in the preceding figure, the tenant model includes the following concepts:
...
| Tenant type (TENANT_TYPE) | SYS | USER | META |
...
| Data property | Private cluster data | Non-private tenant data | Private tenant data |
