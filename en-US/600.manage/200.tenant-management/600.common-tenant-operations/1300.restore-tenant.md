...
3. Execute the `SHOW RECYCLEBIN` statement to view the objects in the recycle bin of the current sys tenant.
   ...
   For more information about the parameter related to the recycle bin, see the [recyclebin](../../../700.reference/500.system-reference/200.system-variable-of-mysql-mode/11300.recyclebin-of-mysql-mode.md) topic of the System Variables (MySQL Mode) chapter and the [recyclebin](../../../700.reference/500.system-reference/300.system-variable-of-oracle-mode/11200.recyclebin-of-oracle-mode.md) topic of the System Variables (Oracle Mode) chapter.
