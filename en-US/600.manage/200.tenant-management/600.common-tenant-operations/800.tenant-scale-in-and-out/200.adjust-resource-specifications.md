...
* Query the `GV$OB_SERVERS` view for the upper limit of each resource item.
   ...
   For more information about the `GV$OB_SERVERS` view, see [GV$OB_SERVERS](../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/900.gv-ob_servers-of-mysql-mode.md).
