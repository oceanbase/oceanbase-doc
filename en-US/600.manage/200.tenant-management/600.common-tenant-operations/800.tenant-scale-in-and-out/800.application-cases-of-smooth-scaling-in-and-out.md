...
![Before scaling out](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.2.5/management/smooth-scaling-out-1-1-new.png)
...
4. Update the tenant's locality to include `zone3` and `zone4`.
   ...
   ![After scaling out](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.2.5/management/smooth-scaling-out-1-2-new.png)
...
3. Change the `UNIT_NUM` of `pool2` to 4.
   ...
   ![After scaling out zone2](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.2.5/management/smooth-scaling-out-image2-2-new.png)
...
5. Change the `UNIT_NUM` of `pool1` to 4.
   ...
   ![After scaling out zone1](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.2.5/management/smooth-scaling-out-image2-3-new.png)
