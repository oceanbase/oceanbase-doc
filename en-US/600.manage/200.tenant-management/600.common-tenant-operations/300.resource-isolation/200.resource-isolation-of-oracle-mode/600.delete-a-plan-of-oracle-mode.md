...
3. Query the `DBA_RSRC_PLANS` view to verify whether the resource management plan is deleted.
   ...
   For more information about the `DBA_RSRC_PLANS` view, see [DBA_RSRC_PLANS](../../../../../700.reference/700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/17900.dba_rsrc_plans-of-oracle-mode.md).
