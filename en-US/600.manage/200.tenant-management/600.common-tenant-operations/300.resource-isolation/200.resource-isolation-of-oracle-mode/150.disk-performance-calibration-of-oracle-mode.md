...
<h4>Note</h4>
<p>In the current version, CPU and IOPS resource isolation no longer strongly depend on disk performance calibration operations.</p>
</main>
...
1. Log in to the `sys` tenant of the cluster as the `root` user.
   ...
   For more information about how to connect to a database, see [Overview of connection methods](../../../../../300.develop/200.application-development-of-oracle-mode/100.connect-to-oceanbase-database-of-oracle-mode/100.connection-methods-overview-of-oracle-mode.md).
