...
6. Run the following command to set the inheritance attribute for subdirectories in the `oceanbase` directory:
...
1. Log in as the `admin` user to the OBServer node.
