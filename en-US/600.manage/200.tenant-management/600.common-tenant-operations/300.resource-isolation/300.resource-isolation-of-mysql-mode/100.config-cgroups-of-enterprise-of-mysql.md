...
3. Restart the observer process.
   ...
   If the observer process detects that a soft link has been established, it will create the cgroup directory for each tenant in the `/sys/fs/cgroup/cpu/oceanbase/` directory.
