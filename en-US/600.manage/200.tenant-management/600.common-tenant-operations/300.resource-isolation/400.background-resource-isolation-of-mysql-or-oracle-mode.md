...
2. (Optional) Before you configure resource isolation for background tasks, you can calibrate the disk performance and configure the IOPS of the tenant unit.
   ...
   3. Configure the IOPS of the tenant unit. Use the 16 KB read disk calibration value as the upper limit of the IOPS setting for the node.
      ...
      For more information about how to configure the IOPS of the tenant unit, see **Configure MAX_IOPS and MIN_IOPS of the tenant** in [Configure resource isolation at the tenant level](300.resource-isolation-of-mysql-mode/200.resource-isolation-at-user-level-of-mysql-mode.md).

### Procedure

1. Log in as the tenant administrator of the user tenant to the MySQL or Oracle tenant in the cluster.
