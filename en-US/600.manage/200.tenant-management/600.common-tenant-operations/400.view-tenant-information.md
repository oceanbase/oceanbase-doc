...
In the third row of the query result, the tenant name is `mysql001`, the tenant ID is `1002`, the tenant type is USER, the creation time is `2025-12-29 15:44:48.704354`, the primary zones are zone1 (with a higher priority) and zone2, the locality is zone1, zone2, and zone3, and the compatibility mode is MySQL.
