...
* If the recycle bin feature is enabled in the sys tenant, `DROP TENANT` drops the specified tenant to the recycle bin. The sys tenant can purge or restore tenants in the recycle bin. For more information, see [Overview](../../400.high-availability/500.recyclebin-management/100.recyclebin-overview.md).
