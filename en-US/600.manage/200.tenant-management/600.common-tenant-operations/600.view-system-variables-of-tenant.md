...
3. Query views for variable values.
   ...
   * Query the `INFORMATION_SCHEMA.SESSION_VARIABLES` view for the session-level variable value of `ob_query_timeout`.
   ...
   * Query the `INFORMATION_SCHEMA.GLOBAL_VARIABLES` view for the global-level variable value of `ob_query_timeout`.
...
2. Query views for variable values.
   ...
   * Query the `SYS.TENANT_VIRTUAL_SESSION_VARIABLE` view for the session-level variable value of `ob_query_timeout`.
   ...
   * Query the `SYS.TENANT_VIRTUAL_GLOBAL_VARIABLE` view for the global-level variable value of `ob_query_timeout`.
