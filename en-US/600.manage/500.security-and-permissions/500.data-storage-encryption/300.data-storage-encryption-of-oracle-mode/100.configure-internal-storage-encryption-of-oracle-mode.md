...
2. Execute the following statement to enable TDE in internal mode.
   ...
   <main id="notice" type='notice'>
    <h4>Notice</h4>
    <p>After the <code>tde_method</code> parameter is set, it cannot be modified. If a standby tenant exists, the same value should be set in the standby tenant as well. </p>
   </main>
...
7. Create a tablespace and specify the encryption algorithm.
   ...
   You can specify any one of the following encryption algorithms: `aes-256`, `aes-128`, `aes-192`, `sm4-cbc`, `aes-128-gcm`, `aes-192-gcm`, `aes-256-gcm`, and `sm4-gcm`.
...
1. Log in to an Oracle tenant as a regular user.
