...
After a user is created, you may need to rotate the user's password while ensuring business continuity. Operations such as changing the password, retaining the old password, and discarding the old password are performed by using the `ALTER USER` statement. For more information, see [Dual-password management](../../../200.identification-and-authentication/100.identification-and-authentication-of-mysql-mode/400.dual-password-of-mysql-mode.md).
