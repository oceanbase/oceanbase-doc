...
After a user is created, it is more common in production environments to rotate passwords (two-factor authentication) while ensuring business continuity. Operations such as changing the password, retaining the old password, and discarding the old password are performed using the `ALTER USER` statement. For details, see [Two-factor authentication management](../../../200.identification-and-authentication/100.identification-and-authentication-of-mysql-mode/400.dual-password-of-mysql-mode.md).