...
To grant a role to a user or role, you must have the granted role and the `ADMIN OPTION` privilege. For more information about how to view your privileges, see [View user privileges](../200.permission-of-mysql-mode/400.view-user-permissions-of-mysql-mode.md).
