...
|slug|revoke-role-from-user-or-another-role-mysql-mode|
...
Executing the `REVOKE` statement to revoke a role from a user does not take immediate effect on the current logged-in user.
