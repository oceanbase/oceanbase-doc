...
* For more information about the privileges supported in MySQL-compatible mode, see [Privilege types in MySQL-compatible mode](../100.permission-classification-of-mysql.md).