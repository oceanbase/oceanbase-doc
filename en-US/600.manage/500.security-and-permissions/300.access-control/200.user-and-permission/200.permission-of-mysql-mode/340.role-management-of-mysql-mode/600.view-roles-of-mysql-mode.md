...
For more information about the fields in the `mysql.default_roles` view, see [mysql.default_roles](../../../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/3500.mysql-default_roles-of-mysql-mode.md).
...
* The first row indicates that all privileges of the `employee` role are granted to the `test2` user, which is allowed to grant the `employee` role to other users or roles.

* The second row indicates that all privileges of the `employee` role are granted to the `role1` role, which is allowed to grant the `employee` role to other users or roles.

* The third row indicates that all privileges of the `developer` role are granted to the `test1` user, which cannot grant the `developer` role to other users or roles.

For more information about the fields in the `mysql.role_edges` view, see [mysql.role_edges](../../../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/4200.mysql-role_edges-of-mysql-mode.md).
...
For more information about the fields in the `role_table_grants` view, see [information_schema.role_table_grants](../../../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/28600.information_schema-role-table-grants-of-mysql-tenant.md).
...
For more information about the fields in the `role_column_grants` view, see [information_schema.role_column_grants](../../../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/28700.information_schema-role-column-grants-of-mysql-tenant.md).
...
The query result shows that the `root` user has granted the `developer` role the `EXECUTE` and`ALTER ROUTINE` privileges on the `test.add_numbers` routine.

For more information about the fields in the `role_routine_grants` view, see [information_schema.role_routine_grants](../../../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/28800.information_schema-role-routine-grants-of-mysql-tenant.md).
