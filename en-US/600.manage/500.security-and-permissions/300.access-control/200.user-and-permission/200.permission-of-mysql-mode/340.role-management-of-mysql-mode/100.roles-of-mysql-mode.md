...
OceanBase Database supports role management in MySQL-compatible mode.

In MySQL-compatible mode, a role is a set of privileges. You can use roles to manage user privileges.
...
Currently, OceanBase Database does not provide built-in system roles in MySQL-compatible mode by default.

## References

For more information about how to manage roles in MySQL-compatible mode, see the following topics:
