...
2. Execute the following statements to view user privileges:
   ...
   * View the global privileges of a user.
     ...
     *************************** 1. row ***************************
     ...
     For more information about the fields in the `mysql.db` view, see [mysql.user](../../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/4700.mysql-user-of-mysql-mode.md).

   * View the database privileges of a user.

     You can view the database privileges of a user by querying the `mysql.db` view.
     ...
     *************************** 1. row ***************************
     ...
     For more information about the fields in the `mysql.db` view, see [mysql.db](../../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/3400.mysql-db-of-mysql-mode.md).
...
* [Revoke privileges](../200.permission-of-mysql-mode/500.modify-user-permissions-of-mysql-mode.md)
