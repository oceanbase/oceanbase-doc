...
2. Execute the following statements to view user privileges:
   ...
   * View the administrator privileges of a user.

      An administrator can query the `mysql.user` view for the administrator privileges of a user. A regular user can query the `mysql.user` view for its administrator privileges.
