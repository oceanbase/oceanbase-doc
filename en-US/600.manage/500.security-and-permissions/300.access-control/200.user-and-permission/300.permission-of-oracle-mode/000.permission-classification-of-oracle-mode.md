...
| Privilege | CREATE LOCATION             | The privilege to execute the `CREATE LOCATION`, `ALTER LOCATION`, and `DROP LOCATION` statements.|
...
| Privilege | RESTRICTED SESSION | The privilege to log in to the database in restricted mode. Restricted mode can be enabled or disabled by using the [ALTER SYSTEM ENABLE/DISABLE RESTRICTED SESSION](../../../../../700.reference/500.sql-reference/100.sql-syntax/300.common-tenant-of-oracle-mode/900.sql-statement-of-oracle-mode/100.ddl-of-oracle-mode/790.alter-system-enable-restricted-session-of-oracle-mode.md) statement.<main id="notice" type='explain'><h4>Note</h4><p>For OceanBase Database V4.6.x, this privilege was introduced starting from V4.6.1. </p></main>|
