...
1. Log on to an Oracle tenant of the cluster as a user with the `ALTER USER` privilege.
...
4. Use the `USERA` user to log on to OceanBase Database on behalf of the `USERB` user.
...
* [Overview](../../../../../300.develop/200.application-development-of-oracle-mode/100.connect-to-oceanbase-database-of-oracle-mode/100.connection-methods-overview-of-oracle-mode.md)
