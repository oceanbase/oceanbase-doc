...
* `IDENTIFIED BY` indicates the password for the user. This parameter is required in Oracle-compatible mode.
...
1. Log in to an Oracle-compatible tenant of the cluster as the `SYS` user.
