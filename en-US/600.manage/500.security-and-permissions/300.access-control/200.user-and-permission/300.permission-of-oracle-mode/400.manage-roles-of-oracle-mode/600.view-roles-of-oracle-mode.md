...
You can view roles in the cluster, roles granted to a role, and the privileges of a role.
...
* View roles granted to a role
  ...
  You can query the `ROLE_ROLE_PRIVS` view to view the roles granted to a role. If no roles are granted to the role, no result is returned.
