...
|slug|drop-user-oracle-mode-management|
...
You must have the `DROP USER` system privilege to execute the `DROP USER` statement. For information about how to view your privileges, see [View user privileges](../300.permission-of-oracle-mode/600.view-user-permissions-of-oracle-mode.md). If you do not have the `DROP USER` privilege, contact the administrator to obtain the privilege. For more information about how to grant privileges to a user, see [Grant direct privileges](../300.permission-of-oracle-mode/200.authority-of-oracle-mode.md).
...
2. Drop a user.
   ...
   * `username` specifies the user to be dropped. Only a single user can be dropped at a time.
   ...
   For example, drop the `sqluser` user.
