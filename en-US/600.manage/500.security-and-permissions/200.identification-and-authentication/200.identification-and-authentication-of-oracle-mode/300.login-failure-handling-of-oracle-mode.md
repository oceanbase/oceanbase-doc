...
<main id="notice" >
  <h4>Applicability</h4>
  <p>This topic applies only to the Oracle-compatible mode of OceanBase Database. OceanBase Database Community Edition only supports MySQL mode. For more information about login failure processing in MySQL mode, see <a href="../100.identification-and-authentication-of-mysql-mode/300.login-failure-handling-of-mysql-mode.md">Login failure processing</a>. </p>
</main>
