...
* View the rotation validity period: You can view the rotation strategy configured for a tenant/profile by checking the corresponding row for the `PASSWORD_ROLLOVER_TIME` resource name `DBA_PROFILES` (../../../../700.reference/700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/18000.dba_profiles-of-oracle-mode.md), where the `LIMIT` column displays the configured strategy.
