...
<main id="notice" >
    <h4>Applicability</h4>
    <p>This topic applies only to the Oracle-compatible mode of OceanBase Database. OceanBase Database Community Edition only supports MySQL mode. For more information about password complexity in MySQL mode, see <a href="../100.identification-and-authentication-of-mysql-mode/200.password-complexity-of-mysql-mode.md">Password complexity</a>. </p>
</main>
