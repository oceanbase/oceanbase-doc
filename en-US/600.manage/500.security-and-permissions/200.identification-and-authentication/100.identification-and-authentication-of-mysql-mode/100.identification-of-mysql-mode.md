...
In the MySQL-compatible mode of OceanBase Database, a user is identified by a username and a host. Execute the following statements to create three users with the same username.
