...
|slug|password-complexity-mysql-mode|
...
| validate_password_mixed_case_count | The minimum number of uppercase and lowercase letters required in a user's password.  | Default value: `0`.  |
