...
* Data encryption
  ...
  OceanBase Database supports encrypting data for transmission and storage. OceanBase Database supports end-to-end data encryption at the transport layer. In addition, OceanBase Database supports transparent encryption of stored data to maximize data security even when the storage medium is lost. Column encryption is supported, allowing users with the relevant privileges to create column-level sensitive data protection rules on tables. For more information, see Data transmission encryption <temp-hide-link-0302>, Transparent data encryption <temp-hide-link-0302>, and Column encryption <temp-hide-link-0302>.
