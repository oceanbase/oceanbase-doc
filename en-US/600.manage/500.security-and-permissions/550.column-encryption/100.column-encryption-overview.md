...
* **Create column encryption rules (MySQL mode)**
* **Create a column encryption rule (Oracle mode)**
* **Column encryption privilege management (MySQL mode)**
* **Column encryption privilege management (Oracle mode)** -->