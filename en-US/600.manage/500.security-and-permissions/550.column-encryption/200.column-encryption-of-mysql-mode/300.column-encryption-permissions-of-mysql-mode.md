...
The column encryption feature uses rule-based privileges to control user access to sensitive columns. OceanBase Database added dedicated column encryption privileges to the MySQL privilege system. The column encryption feature includes two types of privileges: user-level privileges and column encryption rule-level privileges.
