...
|slug|create-column-encryption-rule-mysql-mode|
...
Before you create a column encryption rule, enable Transparent Data Encryption (TDE) and create a master key:
...
Before you create a column encryption rule, you must understand the syntax. OceanBase Database provides complete DDL statements to manage column encryption rules, including create, drop, and alter operations.
...
In actual use, you may need to adjust column encryption rules based on business requirements. OceanBase provides flexible modification syntax to meet these needs:
...
-- When you do not specify an encryption algorithm, the default algorithm AES-256-ECB is used. This is equivalent to USING ENCRYPTION = 'aes-256'.
