...
* For excessively long SQL statements, memory is allocated using the current thread’s Allocator during asynchronous log printing, with a fallback to synchronous printing if needed.
