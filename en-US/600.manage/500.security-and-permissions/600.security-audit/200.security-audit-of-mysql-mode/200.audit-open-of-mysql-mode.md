...
Create a filter by using the [AUDIT_LOG_FILTER_SET_FILTER](../../../../700.reference/500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/400.functions-of-mysql-mode/970.audit-functions-of-mysql-mode/400.audit-log-filter-set-filter-of-mysql-mode.md) function (expression). The syntax is as follows:
...
View the definition of the auditing filter in the [mysql.audit_log_filter](../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/3170.mysql-audit_log_filter-of-mysql-mode.md) view.
...
Set a filter on a user by using the [AUDIT_LOG_FILTER_SET_USER](../../../../700.reference/500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/400.functions-of-mysql-mode/970.audit-functions-of-mysql-mode/500.audit-log-filter-set-user-of-mysql-mode.md) function (expression).
...
View the mapping between auditing filters and users in the [mysql.audit_log_user](../../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/3175.mysql.audit_log_user-of-mysql-mode.md) view.
...
Enable the auditing feature for the MySQL-compatible tenant by setting the parameter [audit_log_enable](../../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/230.audit_log_enable.md).
