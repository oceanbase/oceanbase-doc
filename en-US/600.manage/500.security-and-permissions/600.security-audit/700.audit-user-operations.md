...
1. Log in to the database as the `ORAAUDITOR` user and audit `user1`'s successful DDL operations on all tables.
...
1. Log in to the database as the `ORAAUDITOR` user and audit `user1`'s all operations, including the login and logoff operations.
...
* [Audit user login operations](../600.security-audit/600.audit-user-logon.md)
