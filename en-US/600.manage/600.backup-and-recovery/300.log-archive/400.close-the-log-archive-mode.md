...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>To prevent the archiving task from being stuck in the STOPPING state and failing to close, archiving can be properly closed even when the archive media is unavailable. Accordingly, the log consumption module can correctly consume logs in the scenario of force-closing archiving.</p>
</main>
