...
2. Execute the following statements to view the archiving parameter settings of tenants.
   ...
   * View the settings of the `LOG_ARCHIVE_DEST` parameter of all tenants.
      ...
      For more information about the `CDB_OB_ARCHIVE_DEST` view, see [CDB_OB_ARCHIVE_DEST](../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/13100.oceanbase-cdb_ob_archive_dest-of-mysql-mode.md).
