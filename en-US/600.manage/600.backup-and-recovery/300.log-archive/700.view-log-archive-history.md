...
For tenant `1002`, three pieces with the piece IDs `1` to `3` are generated during the first round of archiving. Logs whose SCNs fall in the range from `'2022-06-01 06:00:00.000000'` to `'2022-06-03 12:00:00.000000'` are archived. The amount of raw log data is `90 GB` and the amount of archive log data is `40 GB`, with a compression ratio of 2.25. `10 GB` of archived data is deleted, which sized `25 GB` before it is compressed.
...
For more information about the `CDB_OB_ARCHIVELOG_SUMMARY` view, see [CDB_OB_ARCHIVELOG_SUMMARY](../../../700.reference/700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/13500.oceanbase-cdb_ob_archivelog_summary-of-mysql-mode.md).
