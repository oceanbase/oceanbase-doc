...
2. Configure the archive destination.
   ...
   * `LOCATION` (required)
      ...
      * When using OSS as the archive media, set the archive path for the tenant `mysql_tenant` in the sys tenant, configure the `delete` mode for deleting archive files, and specify the `md5` algorithm for verifying the integrity of archive files.
      ...
      * When using S3 as the archive media, set the archive path for the tenant `mysql_tenant` in the sys tenant, configure the `delete` mode for deleting archive files, and specify the `crc32` algorithm for verifying the integrity of archive files.
      ...
      * When using S3 as the archive media, set the archive path for the current tenant, configure the `delete` mode for deleting archive files, and specify the `crc32` algorithm for verifying the integrity of archive files.
      ...
      * When using OBS as the archive media, set the archive path for the tenant `mysql_tenant` in the sys tenant.
      ...
      * When using OBS as the archive media, set the archive path for the current tenant.
      ...
      * When using GCS as the archive media, set the archive path for the tenant `mysql_tenant` in the sys tenant.
      ...
      * When using GCS as the archive media, set the archive path for the current tenant.
