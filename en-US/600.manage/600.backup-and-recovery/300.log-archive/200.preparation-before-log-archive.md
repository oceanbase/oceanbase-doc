...
2. Configure the archive destination.
   ...
   * Configure the archive destination for a user tenant from the current tenant:
   ...
   <main id="notice" type='notice'>
   <h4>Notice</h4>
   <p>After upgrading OceanBase Database from V4.0.x to V4.1.0, it is necessary to change the archive path. However, when upgrading from V4.1.x to V4.2.2, there is no need to modify the archive path. Moreover, during the upgrade process from V4.1.x to V4.2.2, you have the option to archive logs.</p>
   </main>
