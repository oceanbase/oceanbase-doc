...
* Data of all user tables
  ...
  <h4>Note</h4>
  <p>Data backup backs up system variables and tenant parameter but does not back up cluster-level parameter or private system table data.</p>
  </main>
...
For backup and restore partners certified with OceanBase Database, see [Industry Partners](https://www.oceanbase.com/partner/product-ecology).

On the [Industry Partners](https://www.oceanbase.com/partner/product-ecology) page, under **Select Solution Type**, choose **Data Integration and Backup** > **Backup & Recovery** to view the list of backup and restore partners certified with OceanBase Database, the certified versions, and the certificate validity periods. -->
