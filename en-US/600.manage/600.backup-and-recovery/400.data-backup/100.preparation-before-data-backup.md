...
2. Configure the backup destination.
   ...
   * Configure the backup destination for the current tenant in a user tenant.
   ...
   <h4>Notice</h4>
   <p>After upgrading OceanBase Database from V4.0.x to V4.1.0, it is necessary to change the backup path. However, when upgrading from V4.1.x to V4.2.0, there is no need to modify the backup path. Moreover, during the upgrade process from V4.1.x to V4.2.0, you have the option to backup logs. </p>
   </main>
