...
![Table restore process](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer-enterprise/V4.3.3/system-principle/tables-restore-process-new.png)
...
3. Create a resource pool.
   ...
   We recommend that you create a resource pool with the same specifications as the source tenant if possible, namely using the same `unit_num` value as the source tenant.
