...
This topic describes the parameters in table-level restore statements.

## Table-level restore commands
...
* Cancel an ongoing table-level restore
...
The table-level restore during the auxiliary tenant restore phase is consistent with tenant-level restore. For related performance parameters and explanations, see [Physical restore parameters](../600.restore-data/800.parameters-of-the-restore.md).
