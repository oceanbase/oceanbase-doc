...
L1/L2/L3-level parallel tasks require thread resources from the table-level restore thread pool. The number of threads in this pool is controlled by the parameter [ddl_thread_score](../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/1850.ddl_thread_score.md).
