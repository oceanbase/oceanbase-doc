...
| Foreign key          |    Yes      | During foreign key restore, the system checks the integrity of the foreign key constraint. If a foreign key references a non-existent row, the restore will fail. |
...
| LOB          |    Yes      | N/A |
| SEQUENCE     |    No      | Sequences associated with the table are not restored. |

## Related topics

* [View table-level restore progress](400.view-the-table-recovery-progress.md)

* [View table-level restore results](500.view-the-table-recovery-history.md)