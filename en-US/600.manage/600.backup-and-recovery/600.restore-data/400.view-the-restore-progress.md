...
3. Execute the following statement to view the restore progress:
   ...
   * For the target tenant:
   ...
   For more information about the `CDB_OB_RESTORE_PROGRESS` view, see [Views related to physical restore](9.views-of-the-restore.md).

   After the restore is completed, you can view the restore result. For more information, see [Query the restore result](5.view-the-restore-history.md).
