...
* Execute the `ACTIVATE` statement to convert the standby tenant into primary tenant. For more information, see [Convert a standby tenant into primary tenant](600.active-standby-tenant.md).
