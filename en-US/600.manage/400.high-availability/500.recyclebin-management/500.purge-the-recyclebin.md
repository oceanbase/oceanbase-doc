...
* When the value is not `0s`, the schema objects that have been stored in the recycle bin for the specified period of time (the value of `recyclebin_object_expire_time`) are automatically purged.
