...
2. Select an appropriate statement and specify the `_ob_enable_standby_db_parallel_log_transport` parameter.
...
1. Log on to the primary tenant or the `sys` tenant of the cluster where the primary tenant resides as the administrator.
