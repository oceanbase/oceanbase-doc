...
You can disable the arbitration service for a tenant after it is enabled.
...
2. Execute the following statement to view the status of the arbitration service for the tenant.
