...
After you disable the arbitration service for all tenants, you can remove the arbitration service if you no longer need it. For more information, see [Remove the arbitration service](6.remove-the-arbitration-service.md).
