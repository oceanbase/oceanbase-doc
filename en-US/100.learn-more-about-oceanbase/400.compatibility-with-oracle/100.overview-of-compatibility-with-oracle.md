...
* OceanBase Database supports most query features, including single- and multi-table queries, subqueries, lateral derived tables, inner-join, semi-join, outer-join, grouping, aggregation, hierarchical queries, and regular data mining functions such as probability and linear regression.
...
The following table lists the collations supported by OceanBase Database.
...
* Backup and restore for some databases within tenants are not supported.
