...
OceanBase Database supports hints. 
...
OceanBase Database is compatible with most PL features of Oracle Database. 
...
OceanBase Database is compatible with some system views of Oracle Database. For a detailed list of compatible views, see [System views](../400.compatibility-with-oracle/400.system-view.md). 
...
* Modify base tables: OceanBase Database allows you to use the `ALTER TABLE` statement to add, drop, or modify columns, add or drop constraints, and add, drop, or modify partitions. 

* Drop base tables: OceanBase Database allows to you drop tables and the constraints on the tables. 
