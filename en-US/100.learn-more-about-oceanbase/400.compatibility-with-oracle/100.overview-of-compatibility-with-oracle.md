...
For more information about partitioning, see [Overview](../../700.reference/300.database-object-management/200.manage-object-of-oracle-mode/200.manage-partitions-of-oracle-mode/100.partition-overview-of-oracle-mode.md).
...
* Allows you to use the `SELECT` statement to query views.
...
* Supports the generation and display of execution plans by using the `EXPLAIN` statement.
