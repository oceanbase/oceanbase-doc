...
* Does not support the following items in the syntax of the `CREATE MATERIALIZED VIEW LOG` statement:
  ...
  * The `EXCLUDING NEW VALUES` clause. If it is used, an error will be returned.
  * Partitions.
...
* Supports `SET NULL` for cascaded tables.
...
OceanBase Database also offers backup and restore features. For more information about the physical backup and restore features of OceanBase Database, see [Overview](../../700.reference/100.oceanbase-database-concepts/1000.high-data-reliability-and-availability/500.backup-and-recovery/100.backup-and-recovery-overview.md).
