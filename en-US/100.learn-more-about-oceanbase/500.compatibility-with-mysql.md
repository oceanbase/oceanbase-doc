...
This topic describes the compatibility between OceanBase Database's MySQL-compatible mode and native MySQL Database.

The MySQL-compatible mode of OceanBase Database is compatible with most features and statements of MySQL 5.7 and 8.0. Some features are not supported because of their limited popularity or the product architecture differences between the two databases. This topic will cover the following aspects of compatibility between OceanBase Database and MySQL Database:
...
* utf8mb4/utf8mb3
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p><code>utf8mb3</code> is an alias of <code>utf8</code>.</p>
  </main>
...
The following collations are supported in OceanBase Database.
  ...
  | gb18030_2022_chinese_ci | gb18030_2022 | Uses pinyin collation, which is case-insensitive. Default collation for this character set in MySQL-compatible mode. |
...
The MySQL-compatible mode of OceanBase Database does not support the following functions:
...
* OceanBase Database supports adding and dropping subpartitions in partitioned tables. MySQL Database does not support adding and dropping subpartitions.
  ...
  <main id="notice" type='notice'>
    <h4>Notice</h4>
    <p><ul><li>Adding and dropping subpartitions is not supported for scenarios where the subpartition type is HASH or KEY.</li></ul></p>
  </main>
...
* Log archive and backup data verification
...
* Backup of some databases and tables within a tenant
