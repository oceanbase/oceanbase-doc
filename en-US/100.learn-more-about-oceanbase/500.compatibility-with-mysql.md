...
For more information about columns in system views, see [Outline of system views](../700.reference/700.system-views/200.system-view-overview.md).
...
* XML functions: `EXTRACTVALUE` and `UPDATEXML`.
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p>The MySQL mode of OceanBase Database complies with the XML 1.0 and XPath 1.0 specifications for processing XML and XPath data. OceanBase Database's MySQL mode may differ from MySQL Database in processing XML data in terms of compatibility and feature support. </p>
  </main>
