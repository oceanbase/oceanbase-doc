...
* OceanBase Database supports most query features, including single- and multi-table queries, subqueries, lateral derived tables, inner join, semi join, outer join, grouping, aggregation, and regular data mining functions such as probability and linear regression.
...
OceanBase Database is compatible with most PL features of MySQL Database. For more information about PL features, see [PL reference](../700.reference/500.sql-reference/300.pl-reference/100.what-is-pl/100.pl-introduction.md).
...
OceanBase Database is compatible with some character sets of MySQL Database.
...
OceanBase Database is compatible with some collations of MySQL Database.
...
* XML functions, including `EXTRACTVALUE` and `UPDATEXML`, are supported.

  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p>The MySQL mode of OceanBase Database complies with the XML 1.0 and XPath 1.0 specifications for processing XML and XPath data. It may differ from MySQL Database in processing XML data in terms of compatibility and feature support.</p>
  </main>
