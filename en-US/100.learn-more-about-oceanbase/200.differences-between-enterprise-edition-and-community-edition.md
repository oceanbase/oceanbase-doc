...
|Security     | Advanced security scaling         | Supported         | Not supported. <br> OceanBase Database Community Edition does not support row-level labels, transparent data encryption (TDE), or ShangMi 4 (SM4). |
