...
<div role="videolist">
      ...
      <!-- <a role='video' href='https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/video-center/video/video/08%20sqlsugar-oceanbase-odbc%2001.mp4'>
          ...
          Connect to OceanBase Database by using SqlSugar (Oracle-compatible mode)
      </a> -->
</div>

## Prerequisites

* You have installed OceanBase Database and created an Oracle-compatible tenant. For more information about how to install OceanBase Database, see [Deployment overview](../../../../400.deploy/100.deploy-overview.md).
...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>The steps outlined in this topic are for compiling and running the project in the Windows environment using Visual Studio Community 2019. If you are using a different operating system or compiler, the steps may vary slightly.</p>
</main>
