...
<div role="videolist">
      ...
      <!-- <a role='video' href='https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/video-center/video/video/03%20java-%20ob-mybatis_e03.mp4'>
          ...
          Connect to OceanBase Database by using MyBatis (Oracle-compatible mode)
       </a> -->
</div>
...
* The tenant account is `sys@xyoracle`, where `xyoracle` is a user tenant created in Oracle-compatible mode of OceanBase Database. `sys` is a username in the `xyoracle` tenant.
* The password is `******`.
