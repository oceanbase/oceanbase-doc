...
<div role="videolist">
      ...
      <!-- <a role='video' href='https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/video-center/video/video/05%20spring-jdbc-oceanbase-client.mp4'>
          ...
          Connect to OceanBase Database by using Spring Data JDBC (Oracle-compatible mode)
      </a> -->
</div>
...
* The tenant account is `test_user001@oracle001`, where `oracle001` is a user tenant created in the Oracle-compatible mode of OceanBase Database, and `test_user001` is a username in the `oracle001` tenant.
* The password is `******`.
