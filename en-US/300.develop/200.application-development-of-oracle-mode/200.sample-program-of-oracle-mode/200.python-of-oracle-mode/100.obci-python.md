|description|This topic describes how to use the cx_Oracle driver to connect to OceanBase Database in Oracle mode and perform basic operations such as creating tables, inserting data, updating data, and querying data.|
|---|---|
|keywords|cx_Oracle, Python, OceanBase, database connection, Oracle mode|
|dir-name|Python Driver Oracle Mode|
|dir-name-en|Python Driver Oracle Mode|
|tenant-type|Oracle Mode|

# Connect to OceanBase Database in Oracle mode using Python

This topic describes how to connect to OceanBase Database in Oracle mode by using the Python cx_Oracle driver. cx_Oracle is an official Python database interface provided by Oracle. It is compatible with Oracle OCI and can seamlessly connect to an Oracle tenant of OceanBase Database.

## Prerequisites

* You have installed Python 3.7 or later.
* You have installed OceanBase Database and created an Oracle mode tenant.
...
def main():
    """Main function."""
    try:
        print("Starting to test the connection to OceanBase Database in Oracle mode...")
