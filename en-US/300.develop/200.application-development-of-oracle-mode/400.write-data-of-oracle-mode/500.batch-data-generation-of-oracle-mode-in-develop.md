...
1. Connect to the prepared Oracle-compatible tenant.
...
1. Open the terminal or CLI and connect to the Oracle-compatible tenant of OceanBase Database.
...
2. In the database command line interface, use the `source` command to run the SQL script.
