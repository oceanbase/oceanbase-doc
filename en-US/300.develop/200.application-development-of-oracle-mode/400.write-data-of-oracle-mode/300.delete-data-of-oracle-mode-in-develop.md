...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>If a table contains millions of records, a large transaction is generated, which may deteriorate the performance. We recommend that you specify the <code>WHERE</code> clause to delete data in batches or use the <code>TRUNCATE TABLE</code> statement.  </p>
</main>
