...
1. Contact the deployment personnel or administrator of OceanBase Database to obtain the connection string.
   ...
   **Here is an example:**
   ...
   For more information about the connection string, see [Connect to an OceanBase Database tenant by using OBClient](../200.connect-to-an-oceanbase-tenant-by-using-obclient-of-oracle-mode.md).
