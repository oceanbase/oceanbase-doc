# Connect to OceanBase Database by using Navicat (Oracle-compatible mode)
...
<main id="notice" type="explain">
    <h4>Note</h4>
    <p>This topic describes how to connect to OceanBase Database's Oracle-compatible mode by using Navicat through the Oracle protocol. </p>
</main>
...
<main id="notice" type="notice">
    <h4>Notice</h4>
    <p>The macOS version of Navicat does not support OceanBase Database's Oracle-compatible mode. </p>
</main>
...
1. Go to the [OceanBase Download Center](https://en.oceanbase.com/softwarecenter-cloud) and download OceanBase Connector/J.
