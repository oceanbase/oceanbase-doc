...
* If you use the `BEGIN` statement to start a transaction, you must use the `COMMIT` statement to commit the transaction after you execute a DML statement.
