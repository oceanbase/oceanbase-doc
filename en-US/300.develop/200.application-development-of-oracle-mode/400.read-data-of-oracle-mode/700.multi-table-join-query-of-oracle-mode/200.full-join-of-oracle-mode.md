...
This topic describes how to use FULL JOIN queries. For more information about LEFT JOIN queries and RIGHT JOIN queries, see [LEFT JOIN queries](3.left-join-of-oracle-mode.md) and [RIGHT JOIN queries](4.right-join-of-oracle-mode.md). 
