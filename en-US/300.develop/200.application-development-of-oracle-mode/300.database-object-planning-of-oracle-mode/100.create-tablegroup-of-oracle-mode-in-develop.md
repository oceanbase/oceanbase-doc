...
* The table group name cannot use reserved keywords in OceanBase Database. For more information about the reserved keywords in OceanBase Database's Oracle mode, see [Reserved keywords](../../../700.reference/500.sql-reference/900.reserved-keywords-of-oracle-mode.md).
