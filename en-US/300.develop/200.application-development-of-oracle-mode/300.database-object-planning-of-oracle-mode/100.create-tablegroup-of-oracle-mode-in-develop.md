...
5. Query tables in the `test_tbl_tg1` table group.
    ...
    <h4>Notice</h4>
    <p>In Oracle mode of OceanBase Database, when you query a table group from the <code>sys.DBA_OB_TABLEGROUP_TABLES</code> view, the table group name specified in the query statement must be in uppercase. </p>
    </main>
