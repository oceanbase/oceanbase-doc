...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>You can use the USER_INDEXES view to query information about the indexes in the table.</p>
</main>
...
* Before using the GIS feature, you need to configure GIS meta data in the business tenant. 
