...
1. Use the following SQL statement to create a DBLink for connecting to a remote OceanBase database in Oracle mode. The DBLink name is `my_link`, and the remote tenant is `oracle001`.
