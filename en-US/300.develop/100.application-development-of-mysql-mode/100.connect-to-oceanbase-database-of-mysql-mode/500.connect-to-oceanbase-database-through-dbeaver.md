...
You can connect to a MySQL-compatible tenant of OceanBase Database by using the OceanBase or MySQL driver that comes with DBeaver. This topic describes how to connect to a MySQL-compatible tenant of OceanBase Database by using the OceanBase driver of DBeaver.
