...
This topic describes how to connect to a MySQL-compatible tenant of OceanBase Database by using OBClient.
...
* `-u`: the account for connecting to OceanBase Database. The format of `$user_name` is `username@tenant name`. The default username of the administrator of a MySQL-compatible tenant is `root`.
...
2. Use OBClient to connect to a MySQL-compatible tenant of OceanBase Database by using ODP.
...
For information about how to connect to an Oracle-compatible tenant of OceanBase Database by using OBClient, see [Connect to an OceanBase tenant by using OBClient](../../200.application-development-of-oracle-mode/100.connect-to-oceanbase-database-of-oracle-mode/200.connect-to-an-oceanbase-tenant-by-using-obclient-of-oracle-mode.md).