...
|slug|connect-oceanbase-using-spring-data-jpa-mysql-compatible-mode|
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="dataSource" class="org.apache.commons.dbcp.BasicDataSource"
        ...
        <!-- Evict a session that has been idle for 1 hour -->
...
```
  ...
  <main id="notice" type='notice'>
    <h4>Notice</h4>
    <p>In Oracle mode, set <code>spring.jpa.properties.hibernate.dialect</code> to <code>org.hibernate.dialect.Oracle12cDialect</code>. In MySQL mode, set the parameter value to <code>org.hibernate.dialect.MySQL5Dialect</code> instead, or leave this parameter unspecified. </p>
  </main>
