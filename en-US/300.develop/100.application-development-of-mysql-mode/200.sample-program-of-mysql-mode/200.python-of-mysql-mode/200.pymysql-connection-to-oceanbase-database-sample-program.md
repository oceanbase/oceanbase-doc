...
<div role="videolist">
      ...
      <!-- <a role='video' href='https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/video-center/video/video/03%20python-pymysql.mp4'>
          ...
          Connect to OceanBase Database by using PyMySQL (MySQL-compatible mode)
      </a> -->
</div>
...
Code in the `main.py` file obtained in this topic calls the `pymysql` module to connect to the MySQL-compatible mode of OceanBase Database, calls the `logging` module to output logs, and implements database operations such as creating tables, inserting data, querying data, and dropping tables.
