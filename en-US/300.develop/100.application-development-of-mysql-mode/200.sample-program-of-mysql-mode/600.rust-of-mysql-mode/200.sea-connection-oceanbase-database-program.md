|description|This topic describes how to connect to OceanBase Database by using Rust and perform basic database operations such as creating tables, inserting data, and querying data.|
|---|---|
|keywords|Rust, RustMySQL, OceanBase, Database connection, MySQL-compatible mode|
|dir-name|SeaORM|
|dir-name-en||
