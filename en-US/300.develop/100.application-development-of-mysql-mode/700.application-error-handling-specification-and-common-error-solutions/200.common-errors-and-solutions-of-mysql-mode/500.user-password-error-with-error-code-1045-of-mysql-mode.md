...
This topic describes how to handle `ERROR 1045`, where an incorrect password is entered for logging on to the MySQL-compatible mode of OceanBase Database.
