...
This topic describes how to handle `ERROR 2013`, where the connection to the server is disconnected in the MySQL-compatible mode of OceanBase Database.
...
1. Reconnect to the corresponding MySQL-compatible tenant.
