...
3. Set the value of the `wait_timeout` variable to `28800`.
   ...
   <main id="notice" type='explain'>
    <h4>Note</h4>
    <p> The <code>wait_timeout</code> variable specifies the time in seconds that the server waits for an interactive connection to become active before closing it.  </p>
   </main>
...
4. Set the value of the `interactive_timeout` variable to `28800`.
   ...
   <main id="notice" type='explain'>
    <h4>Note</h4>
    <p>The <code>interactive_timeout</code> variable specifies the time in seconds that the server waits for an non-interactive connection to become active before closing it.  </p>
   </main>
