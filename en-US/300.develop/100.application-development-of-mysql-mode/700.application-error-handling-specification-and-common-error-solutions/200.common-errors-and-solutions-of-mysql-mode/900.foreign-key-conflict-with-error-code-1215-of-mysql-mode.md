...
|slug|error-1215-foreign-key-addition-mysql-mode|

# ERROR 1215 reported in foreign key addition

This topic describes how to handle `ERROR 1215` reported when you add a foreign key to a table in the MySQL-compatible mode of OceanBase Database.
