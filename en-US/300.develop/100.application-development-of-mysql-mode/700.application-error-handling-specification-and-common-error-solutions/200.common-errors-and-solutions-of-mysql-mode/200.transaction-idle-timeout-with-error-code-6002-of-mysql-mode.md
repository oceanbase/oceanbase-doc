...
|slug|idle-transaction-timed-out-error-6002-mysql-mode|

# Idle transaction timed out, with ERROR 6002 reported

This topic describes how to handle `ERROR 6002`, where an idle transaction timed out in the MySQL-compatible mode of OceanBase Database.
