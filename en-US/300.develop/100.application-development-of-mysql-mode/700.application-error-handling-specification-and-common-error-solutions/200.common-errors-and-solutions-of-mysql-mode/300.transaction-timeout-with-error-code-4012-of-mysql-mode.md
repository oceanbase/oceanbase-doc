...
|slug|transaction-timeout-error-4012-mysql-compatible-mode|

# Transaction timed out, with ERROR 4012 reported

This topic describes how to handle `ERROR 4012`, where an uncommitted transaction timed out in the MySQL-compatible mode of OceanBase Database.
