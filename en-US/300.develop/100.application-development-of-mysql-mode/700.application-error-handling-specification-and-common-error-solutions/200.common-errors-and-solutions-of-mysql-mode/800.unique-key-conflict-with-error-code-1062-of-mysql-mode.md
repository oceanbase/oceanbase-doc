...
|slug|duplicate-data-inserted-error-1062-mysql-mode|

# Duplicate data inserted, with ERROR 1062 reported

This topic describes how to handle `ERROR 1062`, where duplicate data is inserted into the MySQL-compatible mode of OceanBase Database.
