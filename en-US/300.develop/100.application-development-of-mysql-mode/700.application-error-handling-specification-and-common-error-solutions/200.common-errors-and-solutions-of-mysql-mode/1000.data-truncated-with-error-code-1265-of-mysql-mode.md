...
|slug|data-truncated-while-being-inserted-error-1265-mysql-mode|

# Data truncated while being inserted, with ERROR 1265 reported

This topic describes how to handle `ERROR 1265`, where data was truncated while being inserted to the MySQL-compatible mode of OceanBase Database.
