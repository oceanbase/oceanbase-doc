...
This topic describes how to use LEFT JOIN queries. For more information about FULL JOIN queries and RIGHT JOIN queries, see [FULL JOIN queries](2.full-join-of-mysql-mode.md) and [RIGHT JOIN queries](4.right-join-of-mysql-mode.md). 
...
* [INNER JOIN queries](1.inner-join-of-mysql-mode.md)

* [FULL JOIN queries](2.full-join-of-mysql-mode.md)

* [RIGHT JOIN queries](4.right-join-of-mysql-mode.md)
