...
Savepoints are marked. For more information, see [Mark a savepoint](1.mark-a-savepoint-of-mysql-mode.md). 
...
For more information about transaction rollback, see [Roll back a transaction](../5.roll-back-transactions-of-mysql-mode.md).

## More information

* [Mark a savepoint](1.mark-a-savepoint-of-mysql-mode.md)
