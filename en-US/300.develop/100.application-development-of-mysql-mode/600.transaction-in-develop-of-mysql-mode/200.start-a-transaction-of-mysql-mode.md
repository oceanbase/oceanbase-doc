...
The transaction control statements in the MySQL-compatible mode of OceanBase Database are compatible with those in MySQL Database. In the MySQL-compatible mode of OceanBase Database, you can start a transaction in the following ways:
