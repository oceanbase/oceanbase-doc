...
The transaction control statements in MySQL mode of OceanBase Database are compatible with those in MySQL. In MySQL mode of OceanBase Database, you can start a transaction in the following ways:
