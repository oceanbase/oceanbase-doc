...
|slug|roll-back-transaction-savepoint-mysql-compatible-mode|
...
Make sure that savepoints are marked. For more information, see [Mark a savepoint](../300.transaction-savepoints-of-mysql-mode/100.mark-a-savepoint-of-mysql-mode.md).
...
For more examples and detailed descriptions of transaction rollback, see [Roll back a transaction](../500.roll-back-transactions-of-mysql-mode.md).
