...
* The database name is limited to 128 bytes in length.
* The database name can only contain letters, numbers, underscores, and dollar signs, and cannot be named purely with numbers.
