...
* Determine whether to define a primary key column for the table based on the requirements in [Primary key column](#define-primary-key-column).

* Determine whether to add other constraints to the column based on the requirements in [Other constraints](#other-constraints).
...
The following examples will help you understand how to create a table with secondary partitions.
