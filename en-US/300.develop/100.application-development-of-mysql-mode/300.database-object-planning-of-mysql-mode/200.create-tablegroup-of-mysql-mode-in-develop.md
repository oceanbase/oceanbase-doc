...
* Avoid using reserved keywords as a table group name. 
...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>You can view information about table groups in the tenant through the oceanbase.CDB_OB_TABLEGROUPS view. </p>
</main>
