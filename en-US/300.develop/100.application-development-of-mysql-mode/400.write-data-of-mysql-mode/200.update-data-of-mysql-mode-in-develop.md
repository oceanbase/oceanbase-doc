...
|slug|update-data-of-mysql-mode-in-develop|

# Update data

After you insert data into a table, you can use the `UPDATE` statement or other statements to update the records in the table. This topic describes how to update data in a table by using statements. 
...
Generally, the [UPDATE](../500.read-data-of-mysql-mode/300.use-operators-and-functions-in-query-of-mysql-mode/1000.lock-query-results-select-for-update-of-mysql-mode.md) statement is used to update data of a table.
...
Increase all values in the `value` column of the `t_insert` table by 1. For example:
