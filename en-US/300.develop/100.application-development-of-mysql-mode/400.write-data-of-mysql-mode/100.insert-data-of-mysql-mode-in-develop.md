...
* This statement writes data using the full direct load method and is subject to its limitations. For more information, see the **Limitations** section in [Import data through direct load by using the INSERT INTO SELECT statement](../../../500.data-migration/1100.bypass-import/200.full-bypass-import.md).
