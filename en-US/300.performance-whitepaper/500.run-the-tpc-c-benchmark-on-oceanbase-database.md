...
* OceanBase Database: We recommend that you deploy ODP separately. For more information, see [Use OBD to deploy OceanBase Database](../200.quick-start/400.use-obd-to-deploy-oceanbase-database.md).
...
* Tenant specifications
  ...
  * The preceding tenant specifications are provided based on the [OceanBase TPC-C benchmark report](../300.performance-whitepaper/600.tpc-c-benchmark-report-of-oceanbase-database.md). You need to adjust the specifications based on your hardware configuration. For more information, see [Modify a tenant](../600.administrator-guide/300.basic-database-management/500.tenant-management/500.modify-a-tenant.md).
...
For more information about the test result, see [OceanBase TPC-C benchmark report](../300.performance-whitepaper/600.tpc-c-benchmark-report-of-oceanbase-database.md).
