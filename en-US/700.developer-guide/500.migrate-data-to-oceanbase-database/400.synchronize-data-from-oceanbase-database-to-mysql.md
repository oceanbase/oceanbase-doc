...
You can install an oblogproxy by using the RPM package or the source code. For more information, see [Build an oblogproxy by using the source code](../../900.supporting-tools/400.cdc/300.oblogproxy/100.install-and-deploy-oblogproxy/100.use-source-code-to-build-an-oblogproxy.md).
...
Deploy the Canal adapter. For more information, see [Deploy the RDB adapter](../500.migrate-data-to-oceanbase-database/300.use-canal-to-perform-incremental-data-migration-to-oceanbase-database.md).
