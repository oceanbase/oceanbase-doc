...
For more information about how to deploy and use liboblog, see [Install and deploy liboblog](/en-US/9.ecological-tools/4.CDC/2.oceanbase-cdc/1.install-cdc/2.rve4im.md) and [liboblog development instructions](/en-US/9.ecological-tools/4.CDC/2.oceanbase-cdc/1.install-cdc/3.uhg86q.md).
...
For more information about how to deploy and use oblogproxy, see [Use the source code to build an oblogproxy](/en-US/9.ecological-tools/4.CDC/3.oblogproxy/1.installation-and-deployment-2/1.installation-and-deployment-1.md) and [Use the installation package to install and deploy an oblogproxy](/en-US/9.ecological-tools/4.CDC/3.oblogproxy/1.installation-and-deployment-2/2.install-and-deploy-logproxy-by-using-the-installation-package.md). 
**Note**

You can use Canal and oblogproxy to synchronize data from OceanBase Database to MySQL in real time. For more information, see [Synchronize data from OceanBase Database to MySQL](/en-US/7.developer-guide-1/5.migrate-data-to-oceanbase/7.qlz77w.md).
...
For more information about how to install and deploy oblogmsg, see [Installation and deployment](/en-US/9.ecological-tools/4.CDC/4.oblogmsg/1.introduction-to-ologmsg.md).
