...
The following demo shows how to use liboblog. For more information, see [oblog_tailf](/en-US/9.ecological-tools/4.CDC/2.oceanbase-cdc/1.install-cdc/4.oblog_tailf.md) and its [source code](https://github.com/oceanbase/oceanbase/tree/master/src/liboblog/tests). 
**Notice**
