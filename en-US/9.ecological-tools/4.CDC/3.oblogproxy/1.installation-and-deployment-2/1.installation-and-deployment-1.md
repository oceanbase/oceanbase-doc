...
1. Get liboblog.so
   ...
   * Compile liboblog
     ...
     To compile the [liboblog](https://github.com/oceanbase/oceanbase#how-to-build), you need to add the `OB_BUILD_LIBOBLOG=ON` parameter when compiling the OceanBase code repository. For more information, see [liboblog compilation instructions](/en-US/9.ecological-tools/4.CDC/2.oceanbase-cdc/1.install-cdc/1.abyu9b.md). 
