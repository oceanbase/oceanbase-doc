...
![TableAPI process chart](../images/p359459.png) As shown in the preceding figure, the working process of TableAPI involves the client, RPC framework, and OBServer. The three parts are described in the following sections. 
...
![TableAPI operation types](../images/p359502.png)
...
![Class diagram for implementation of operation types](../images/p359543.png)
...
The replace and insert_or_update operations can be confusing. For more information, see [Differences between replace and insert_or_update](/en-US/9.ecological-tools/6.TableApi/1.introduction-to-table-api-1/2.differences-between-replace-and-insert_or_update.md).
...
For more information about how to set various query conditions, see [Introduction to the client and instructions of use](/en-US/9.ecological-tools/6.TableApi/2.use-the-client/1.use-the-client-1.md).
