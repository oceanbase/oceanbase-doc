...
The MATERIAL operator materializes the data output of subsequent operators. For more information, see [MATERIAL](../../../../1200.sql-tuning-guide/200.sql-execution-plan/200.execution-plan-operators/1000.material.md).
