...
The `PX PARTITION ITERATO` operator iterates data at the partition level. For more information, see [GI](../../../../1200.sql-tuning-guide/200.sql-execution-plan/200.execution-plan-operators/2400.gi.md).
