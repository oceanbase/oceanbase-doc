...
The `PX PARTITION ITERATO` operator iterates data at the partition level. For more information, see [GI](../../../../12.sql-tuning-guide/2.sql-execution-plan/2.execution-plan-operators/24.gi.md).
