...
This scenario is described in the topic of the `COUNT` operator. For more information, see [COUNT](../../../../1200.sql-tuning-guide/200.sql-execution-plan/200.execution-plan-operators/400.count.md).
