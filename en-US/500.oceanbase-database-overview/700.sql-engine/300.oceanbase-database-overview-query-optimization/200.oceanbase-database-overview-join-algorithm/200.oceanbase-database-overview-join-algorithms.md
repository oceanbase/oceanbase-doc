...
* Index Nested Loop Join
  ...
  *************************** 1. row ***************************
  ...
  In the `Outputs & filters` section, parameter `[t2.c1]` of `nl_param` indicates the execution of conditional pushdown optimization. For more information, see [JOIN](../../../../1200.sql-tuning-guide/200.sql-execution-plan/200.execution-plan-operators/300.join.md).
