...
For more information about variables, see [System variable reference](../../../6.administrator-guide/3.basic-database-management/5.tenant-management/9.tenant-management-variables.md). 
