...
By default, no sample database TPCC exists in OceanBase. You need to create one manually. The sample database must be created in a business tenant. For more information about the sample database, see [About sample database TPCC](/en-US/7.developer-guide/1.foreword/4.about-sample-database-tpcc.md). 
