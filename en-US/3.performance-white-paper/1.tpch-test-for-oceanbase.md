...
* OceanBase Database: For more information, see [Quick Start](/en-US/2.quickstart/1.quick-start-guide-1.md).
...
For more information about the test result, see [OceanBase TPC-H benchmark report](/en-US/3.performance-white-paper/2.wtu4kv.md).
