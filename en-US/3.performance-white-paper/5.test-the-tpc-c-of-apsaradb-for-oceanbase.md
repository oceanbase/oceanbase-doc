...
* Tenant specifications
  ...
  * The preceding tenant specifications are provided based on the [OceanBase TPC-C benchmark report](/en-US/3.performance-white-paper/6.mcso3a.md). You need to adjust the specifications based on your hardware configuration. For more information, see [Modify a tenant](/en-US/6.administrator-guide/3.basic-database-management/5.tenants/5.modify-tenant.md).
...
For more information about the test result, see [OceanBase TPC-C benchmark report](/en-US/3.performance-white-paper/6.mcso3a.md).
