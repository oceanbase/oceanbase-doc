...
### Check the version of your OceanBase Database (MySQL-compatible mode)
...
### View the version of your OceanBase Database (Oracle-compatible mode)
...
For more information about product versions, see [OceanBase Product Version Lifecycle](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000001497334). -->