...
* **Support for complex parameter types in remote stored procedure calls between Oracle tenants**

  OceanBase Database V4.2.4 supports remote stored procedure calls between Oracle tenants but only basic parameters are supported in the calls. OceanBase Database V4.2.5 supports complex parameter types and three nesting methods: `record(basic)`, `array(basic)`, and `array(record(basic))`.
