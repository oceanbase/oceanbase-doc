...
| The syntax for tenant cloning is added. | -  |
| The syntax for parameter resetting is added. | -  |
| The syntaxes related to columnar and columnstore indexes are added. | -  |
| The syntaxes related to materialized views are added. | -  |
| The syntaxes related to partition-level major compactions are added. | -  |
