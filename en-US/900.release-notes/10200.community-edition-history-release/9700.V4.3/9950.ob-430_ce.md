...
* **Adaptive cost model**
   ...
   <!-- For more information about `DBA_OB_AUX_STATISTICS`, see [DBA_OB_AUX_STATISTICS (SYS tenant)](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000641277) and [DBA_OB_AUX_STATISTICS (MySQL-compatible tenant)](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000641735). -->
...
* **Online DDL extension in MySQL-compatible mode**
...
* **Index monitoring**
   ...
   <!-- For more information about index monitoring, see [Index monitoring (MySQL-compatible mode)](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000641899). -->
