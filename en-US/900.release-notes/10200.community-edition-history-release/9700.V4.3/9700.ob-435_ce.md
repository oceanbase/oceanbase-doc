...
* Compatibility with illegal date types in MySQL-compatible mode
...
| Added syntax for subpartition operations | Extended the `RANGE [COLUMNS]`/`LIST [COLUMNS]` syntax for adding and dropping subpartitions in MySQL-compatible mode. |
