...
* **Columnstore engine**
   ...
   You can flexibly set a table in your business system as a rowstore table, columnstore table, or row/column redundant table based on the load type. For more information about columnstore, see [Columnstore](../../../700.reference/100.oceanbase-database-concepts/900.storage-architecture/200.data-storage/320.columnstore-engine.md).
...
* **Adaptive cost model**
   ...
   <!-- For more information about `DBA_OB_AUX_STATISTICS`, see [DBA_OB_AUX_STATISTICS（SYS 租户）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000641277) and [DBA_OB_AUX_STATISTICS（MySQL 租户）](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000641735). -->
