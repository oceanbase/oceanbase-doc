...
* This version addressed several customer and internal testing issues to enhance product stability.
* This version now supports data reads between OceanBase MySQL-compatible tenants by using a DBLink.
...
* **MySQL compatibility**
   * **Function index**: The MySQL-compatible mode of V4.2.x now supports MySQL 8.0-compatible function-based indexes, further enhancing feature stability. 
...
GB18030-2022 character set was released on July 19, 2022, and formally implemented on August 1, 2023, becoming a mandatory standard for full-text execution in information systems. Compared with the GB18030-2005 standard, the new standard supports more rare Chinese characters and minority languages. OceanBase Database V4.2.0 supports the new GB18030_2022 character set, along with the corresponding sorting methods. The character set name in MySQL-compatible mode is GB18030_2022. The corresponding sorting methods are also updated. 
...
| DBA_DB_LINKS | 4.2 | New | Displays all DBLinks created in the current tenant. This view is new for MySQL-compatible tenants.  |
