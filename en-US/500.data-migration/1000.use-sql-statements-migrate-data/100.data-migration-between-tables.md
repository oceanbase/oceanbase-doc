...
This topic mainly describes how to use SQL statements to migrate data between tables.
...
<main id="notice" >
  <h4>Applicability</h4>
  <p>Currently, the <code>MERGE</code> statement is supported only in the Oracle-compatible mode of OceanBase Database.</p>
</main>
...
| source_col_name | The name of a column in the source table. Select the columns to be migrated. To select all data, use an asterisk (`*`).  <main id="notice" type='notice'><h4>Notice</h4><p>The number of columns selected must be the same as the number of columns in the destination table, and the migrated data must conform to the data types of the destination table.</p></main> |
...
* [INSERT (MySQL-compatible mode)](../../700.reference/500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/5700.insert-sql-of-mysql-mode.md)
* [INSERT (Oracle-compatible mode)](../../700.reference/500.sql-reference/100.sql-syntax/300.common-tenant-of-oracle-mode/900.sql-statement-of-oracle-mode/200.dml-of-oracle-mode/200.insert-of-oracle-mode.md)
* [MERGE (Oracle-compatible mode)](../../700.reference/500.sql-reference/100.sql-syntax/300.common-tenant-of-oracle-mode/900.sql-statement-of-oracle-mode/200.dml-of-oracle-mode/300.merge-of-oracle-mode.md) 
