...
* For more information about how to use the `LOAD DATA` statement to import data through direct load, see [Direct load](../1100.bypass-import/100.overview-of-bypass-import.md).
