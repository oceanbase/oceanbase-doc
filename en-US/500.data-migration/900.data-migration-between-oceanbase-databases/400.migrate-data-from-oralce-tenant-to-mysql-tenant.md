...
|dir-name-en||
|tenant-type||
|slug|use-obloader-obdumper-migrate-data-from-oceanbase-oracle-tenant-to-oceanbase-mysql-tenant|

# Use obloader & obdumper to migrate data from an Oracle-compatible tenant to a MySQL-compatible tenant in OceanBase Database

This topic describes how to use obloader & obdumper to migrate data from an Oracle-compatible tenant to a MySQL-compatible tenant in OceanBase Database.
...
| Source tenant name (Oracle-compatible mode) | oracle001 |
...
| Destination tenant name (MySQL-compatible mode) | mysql001 |
...
<main id="notice" type='notice'>
    <h4>Notice</h4>
    <p>DDL files exported from an Oracle-compatible tenant do not meet the syntax requirements of a MySQL-compatible tenant. Therefore, before you import the DDL files to the MySQL-compatible tenant, you must first modify the files so that the files meet the syntax requirements of the MySQL-compatible tenant. </p>
    <p>For example, for a DDL file exported from the <code>oracle001</code> tenant, make the following modifications:</p>
    <ul>
    <li>Convert the data types to those supported in MySQL-compatible mode:
    <ul>
    ...
    <p>For more information about the data types in MySQL-compatible mode, see <a href="https://en.oceanbase.com/docs/common-oceanbase-database-10000000001974954">Overview of data types</a>.</p>
</main>
