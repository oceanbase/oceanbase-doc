...
This topic briefly describes the background information for using OceanBase Migration Service (OMS) to migrate data from an OceanBase tenant to another of the same type.
