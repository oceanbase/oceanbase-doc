...
# Use obloader & obdumper to migrate data between Oracle-compatible tenants in OceanBase Database

This topic describes how to use obloader & obdumper to migrate data from an Oracle-compatible tenant to another Oracle-compatible tenant in OceanBase Database.
...
| Destination tenant name (Oracle-compatible mode) | oracle002 |
| User account of the `oracle002` tenant (with read and write privileges) | obloader_user01 |
| Password of the `obloader_user01` user in the `oracle002` tenant | ****** |
