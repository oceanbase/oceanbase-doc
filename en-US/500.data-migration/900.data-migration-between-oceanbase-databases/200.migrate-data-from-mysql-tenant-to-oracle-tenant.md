...
|dir-name-en||
|tenant-type||
|slug|use-obloader-obdumper-migrate-data-from-oceanbase-mysql-tenant-to-oceanbase-oracle-tenant|

# Use obloader & obdumper to migrate data from a MySQL-compatible tenant to an Oracle-compatible tenant in OceanBase Database

This topic describes how to use obloader & obdumper to migrate data from a MySQL-compatible tenant to an Oracle-compatible tenant in OceanBase Database.
...
| Source tenant name (MySQL-compatible mode) | mysql001 |
...
| Destination tenant name (Oracle-compatible mode) | oracle001 |
| User account of the `oracle001` tenant (with read and write privileges) | obloader_user01 |
| Password of the `obloader_user01` user in the `oracle001` tenant | ****** |
...
<main id="notice" type='notice'>
   <h4>Notice</h4>
   <p>DDL files exported from a MySQL-compatible tenant do not meet the syntax requirements of an Oracle-compatible tenant. Therefore, before you import the DDL files to the Oracle-compatible tenant, you must first modify the files so that the files meet the syntax requirements of the Oracle-compatible tenant. </p>
   ...
   <li>Convert the data types to those supported in Oracle-compatible mode:
   <ul>
   ...
   <p>For more information about the data types in Oracle-compatible mode, see <a href="https://en.oceanbase.com/docs/common-oceanbase-database-10000000001975141">Overview of built-in data types</a>.</p>
</main>
