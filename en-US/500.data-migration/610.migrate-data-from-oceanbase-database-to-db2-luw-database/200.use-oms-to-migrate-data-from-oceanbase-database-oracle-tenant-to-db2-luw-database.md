...
This topic briefly describes the background information for using OceanBase Migration Service (OMS) to migrate data from an Oracle tenant of OceanBase Database to a DB2 LUW database. 
