...
This topic briefly describes the background information for using OceanBase Migration Service (OMS) to migrate data from a DB2 LUW database to an Oracle tenant of OceanBase Database. 
