...
After the table schemas are imported to OceanBase Database, the character types and lengths of table fields may change. For more information about table field conversion, see the data type mappings in [Create a project to migrate data from a DB2 LUW database to an Oracle tenant of OceanBase Database](https://en.oceanbase.com/docs/enterprise-oms-doc-en-10000000000833977).
