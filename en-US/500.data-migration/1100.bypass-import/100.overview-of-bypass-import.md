...
* **Full direct load**
  ...
  * You can use the `LOAD DATA` and `INSERT INTO SELECT` statements for full direct load.
...
* **Incremental direct load**
  ...
  * You can use the `LOAD DATA` and `INSERT INTO SELECT` statements for incremental direct load.
