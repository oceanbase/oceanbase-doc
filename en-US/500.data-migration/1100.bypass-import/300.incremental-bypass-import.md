...
1. Log on to the server where the target OBServer node resides and create a test table named `tbl1` in the `/home/admin` directory.
...
2. Specify the path of the file to import.
    ...
    1. Log on to the server where the target OBServer node resides.
