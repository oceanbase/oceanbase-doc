...
|dir-name-en||
|tenant-type||
|slug|use-insert-into-select-statement-to-import-data-in-direct-load-mode|

# Use the INSERT INTO SELECT statement to import data in direct load mode
...
* Direct load is a DDL operation and cannot be executed in a multi-row transaction that contains multiple operations.
  ...
  * This feature is not supported in a `BEGIN` block.
