...
* JDK 1.8 is installed, and the `JAVA_HOME` environment variable is configured.
* The Binlog service is installed and deployed. For more information, see [Create a Binlog cluster](https://en.oceanbase.com/docs/common-ocp-10000000001899110).

## Procedure

### Step 1: Prepare the ChunJun environment

1. Download the ChunJun package and decompress it.
...
* For more information about the JSON configuration file of the target MySQL database, see [MySQL Sink](https://dtstack.github.io/chunjun/documents/zh/ChunJun%E8%BF%9E%E6%8E%A5%E5%99%A8@mysql@mysql-sink?lang=zh).
