...
* You have installed and deployed oblogproxy. For more information, see [Install oblogproxy](https://en.oceanbase.com/docs/enterprise-oms-doc-en-10000000000834035).
...
Log on to the MySQL mode of OceanBase Database and insert a data record into the `test_tbl1` table.
