...
## Export schemas from a MySQL-compatible tenant of OceanBase Database
...
The following example shows how to migrate the schemas of all objects from the test database in a MySQL-compatible tenant of OceanBase Database V4.0.0 to a MySQL 5.7 database.
...
## Import schemas to the MySQL database

The file exported by using DBCAT is an SQL file. To import the SQL file to the destination database, run the source command as follows:
