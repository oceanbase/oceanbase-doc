...
This topic describes how to use ChunJun in local mode to synchronize data from a MySQL database to OceanBase Database's MySQL-compatible mode.
...
* For more information about how to configure the JSON file for a MySQL database that serves as the source database, see [MySQL Source](https://dtstack.github.io/chunjun/documents/zh/ChunJun%E8%BF%9E%E6%8E%A5%E5%99%A8@mysql@mysql-source?lang=zh). -->
