...
The following example shows how to migrate the schemas of all objects from the test database `mysql57` of MySQL 5.7 to a MySQL-compatible tenant of OceanBase Database V4.0.0. 
