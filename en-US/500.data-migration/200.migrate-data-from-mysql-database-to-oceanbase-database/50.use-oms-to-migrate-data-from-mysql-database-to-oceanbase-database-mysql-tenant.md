...
This topic briefly describes the background information for using OceanBase Migration Service (OMS) to migrate data from a MySQL database to a MySQL tenant of OceanBase Database. 
