...
1. Modify the `my.cnf` configuration file of the MySQL database. 
   ...
   The `my.cnf` configuration file is located at `/etc/my.cnf`. Enable binlog write and set binlog-format to ROW. Then, restart the MySQL database for the configuration to take effect. 
...
1. Download the software package.
   ...
   You can download it from [canal.deployer-1.1.5.tar.gz](https://github.com/alibaba/canal/releases/download/canal-1.1.5/canal.deployer-1.1.5.tar.gz). 
...
1. Download the software package.
    ...
    You can download it from [canal.adapter-1.1.5.tar.gz](https://github.com/alibaba/canal/releases/download/canal-1.1.5/canal.adapter-1.1.5.tar.gz). 
...
5. Start RDB.
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p>If you use the OceanBase driver for the destination database, place the OceanBase driver package in the <code>lib</code> folder.</p>
  </main> 
