...
For more information about fields of system views, see [System views](../../7.reference/5.system-reference/5.system-overview-of-oracle-mode/1.overview-of-oracle-mode.md).
...
For more information about partitioning, see [Partition overview](../../7.reference/2.administrator-guide/4.replica-management/2.manage-partition-table/1.oracle-mode/1.partition-overview-of-oracle-mode.md).
...
For more information about the SQL engine of OceanBase Database, see [SQL tuning](../../7.reference/3.performance-tuning-guide/5.sql-optimization/4.sql-optimization/1.overview-of-sql-optimization.md).
