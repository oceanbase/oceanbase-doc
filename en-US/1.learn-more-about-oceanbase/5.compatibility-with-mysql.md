...
For more information about system views, see [System views](../7.reference/5.system-reference/4.system-overview-of-mysql-mode/1.overview-of-mysql-mode.md).
...
For more information about the optimizer, see [SQL tuning](../7.reference/3.performance-tuning-guide/5.sql-optimization/4.sql-optimization/1.overview-of-sql-optimization.md)
