...
```unknow
# Obtain the CPU utilization of an OBServer
...
![Performance chart of OBServers in a tenant](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8508588361/p365165.png)
...
* CPU
   ...
   The CPU utilization of each OBServer in OceanBase Database. rather than the CPU utilization of your OS. The OceanBase software has a single-process architecture.
...
* IO-R and IO-W
   ...
   The physical read I/O (IO-R) and write I/O (IO-W) of each OBServer. These two metrics provide very useful information.
