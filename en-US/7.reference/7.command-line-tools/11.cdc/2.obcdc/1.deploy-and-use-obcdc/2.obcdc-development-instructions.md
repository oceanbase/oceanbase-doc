...
The following demo shows how to use obcdc. For more information, see [obcdc_tailf](3.obcdc-tailf.md) and [obcdc_tailf source code](https://github.com/oceanbase/oceanbase/tree/master/src/logservice/libobcdc/tests). 
