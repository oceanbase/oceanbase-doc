...
This view displays the information about the partition and subpartitions of an index.
...
| LOGGING | varchar(7) | NO | Indicates whether logs are recorded for changes to the index. At present, this field is not supported and is NULL by default. |
...
| LEAF_BLOCKS | bigint(0) | NO | The number of leaf blocks in the index partition. At present, this field is not supported and is NULL by default. |
...
| NUM_ROWS | bigint(0) | NO | The number of rows returned by the ANALYZE statement. At present, this field is not supported and is NULL by default. |
| SAMPLE_SIZE | bigint(0) | NO | The sample size used in analyzing this partition. At present, this field is not supported and is NULL by default. |
