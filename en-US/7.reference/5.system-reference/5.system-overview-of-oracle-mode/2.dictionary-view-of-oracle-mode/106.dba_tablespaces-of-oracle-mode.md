...
DBA_TABLESPACES lists all the tablespaces in the database.
...
| PLUGGED_IN               | VARCHAR2(3)  | NO           | Indicates whether the free and used segment space in the tablespace is managed using free lists or bitmaps. At present, this field is not supported and is NULL by default.           |
| SEGMENT_SPACE_MANAGEMENT | VARCHAR2(6)  | NO           | Indicates whether the free and used segment space in the tablespace is managed using free lists or bitmaps. At present, this field is not supported and is NULL by default.           |
