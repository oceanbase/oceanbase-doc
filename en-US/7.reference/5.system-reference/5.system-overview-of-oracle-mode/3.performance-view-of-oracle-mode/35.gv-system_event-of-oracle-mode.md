...
This view displays system wait events of tenants on all OBServers, including the number of occurrences, wait time, and number of timeouts of each type of wait event.
