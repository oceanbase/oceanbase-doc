...
This view displays information about the current or last wait events of all sessions on the current OBServer, such as the event name and the amount of time spent on waiting.
