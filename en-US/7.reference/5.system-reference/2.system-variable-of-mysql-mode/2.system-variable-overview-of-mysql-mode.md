...
| [timestamp](128.timestamp-of-mysql-mode.md) | The timestamp in seconds. This variable affects the result of `SELECT NOW(6)`.  |
...
| [version](135.version-of-mysql-mode.md) | The version number of OBServer.  |
