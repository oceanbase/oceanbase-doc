...
2. If you do not specify the value of the `parallel_servers_target` variable, the system automatically specifies a value based on the value of `max_cpu`. To view this value, log on to the tenant and execute the `show variables like 'parallel_servers_target'` statement.
