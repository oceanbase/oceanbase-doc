...
|----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| info_requested | The information to be returned in the `run_info` parameter when the program stops. For more information, see [Information Flags](1.dbms-debug-overview-oracle.md). |
