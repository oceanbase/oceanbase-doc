...
* You can modify block ciphers by using chaining and padding algorithms. The chaining and padding algorithms are added to the block cipher to generate a cipher suite Cipher Block Chaining (CBC) is the most widely used type of chaining. For more information about the block cipher chaining and padding algorithms that this package supports, see [DBMS_CRYPTO overview](1.dbms-crypto-overview-oracle.md).
