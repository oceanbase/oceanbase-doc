...
For more information, see [CREATE FUNCTION](../../11.ddl-operations-on-stored-pl-units-oracle/7.create-function-oracle.md).
...
* A pipelined table function usually has one or more cursor variables. For more information about cursor variables, see [Cursor variables](../../5.pl-static-sql-oracle/2.cursor-oracle/5.cursor-variable-oracle.md).
