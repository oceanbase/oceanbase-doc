...
We recommend that you do not use reserved keywords as ordinary user-defined identifiers. For more information, see [Reserved PL keywords](../15.pl-keywords-oracle.md)

### Predefined identifiers

Predefined identifiers are declared in the predefined `STANDARD` package.

For more information, see [Definition of the PL environment by the STANDARD package](../9.package-oracle/5.package-standard-definition-of-pl-environment-oracle.md).
