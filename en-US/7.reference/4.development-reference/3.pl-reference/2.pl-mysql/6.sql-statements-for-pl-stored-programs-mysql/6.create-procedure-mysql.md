...
To call a stored procedure, use the `CALL` statement. For more information, see [CALL](../5.pl-manipulation-statement-mysql/1.CALL-mysql.md).
...
For examples of creating stored procedures, see [Stored procedures](../2.storage-object-mysql/3.pl-stored-procedure-mysql.md).