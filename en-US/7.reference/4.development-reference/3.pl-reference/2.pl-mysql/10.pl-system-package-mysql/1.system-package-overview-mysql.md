...
|----------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [DBMS_RESOURCE_MANAGER](133.dbms-resource-manager-mysql/1.dbms-resource-manager-overview-mysql.md) | Maintains resource usage plans, consumer groups, and plan directives.                                                                                                         |
| [DBMS_STATS](159.dbms-stats-mysql/1.dbms-stats-overview-mysql.md)                                  | Supports viewing and modifying the statistics collected by the optimizer for database objects.                                                                                |
| [DBMS_UDR](178.dbms-udr-mysql/1.dbms-udr-overview-mysql.md)                                        | Provides the rewrite binding feature, which rewrites an SQL statement received by the database before execution based on the rewrite binding rule that the statement matches. |
| [DBMS_XPLAN](207.dbms-xplan-mysql/1.dbms-xplan-overview-mysql.md)                                  | Provides features for the management of logical plans, such as optimizing and tracing logical plans.                                                                          |
