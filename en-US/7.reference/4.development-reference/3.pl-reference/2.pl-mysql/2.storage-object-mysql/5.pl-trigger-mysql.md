...
* Query the `TRIGGERS` table of `INFORMATION_SCHEMA`. For more information, see [INFORMATION_SCHEMA TRIGGERS](../8.information-schema-dictionary-view-mysql/3.information-schema-triggers-mysql.md).

* Use the `SHOW CREATE TRIGGER` statement. For more information, see [SHOW CREATE TRIGGER](../7.pl-database-management-statements-mysql/3.show-create-trigger-mysql.md).

* Use the `SHOW TRIGGERS` statement. For more information, see [SHOW TRIGGERS](../7.pl-database-management-statements-mysql/6.show-triggers-mysql.md).
