...
For more information about the `unit` argument, see [DATE_ADD](../1.date-and-time-functions-of-mysql-mode/9.date-add-of-mysql-mode.md). When `unit` is `WEEK`, a week starts on Sunday.
