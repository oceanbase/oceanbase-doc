...
You can also use `IS JSON` or `IS NOT JSON` as an SQL condition in an SQL statement to check whether the calculation result of an expression is valid JSON data. For more information, see [Create a JSON data column](../../../../3.basic-elements-of-oracle-mode/1.built-in-data-types-of-oracle-mode/10.json-formatted-data-type-oracle-mode/2.create-json-data-type-columns-of-oracle-mode.md).
