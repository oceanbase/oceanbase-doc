...
You can use this statement to create a savepoint before committing a transaction so that you can roll back the transaction partially.
  ...
  <main id="notice" type='explain'>
    ...
    <li>After you create a savepoint, you can continue to handle and commit jobs, roll back the entire transaction, or roll back the transaction to a specified savepoint. For more information about transaction rollback, see <a href="../3.dcl-of-oracle-mode/30.rollback-of-oracle-mode.md">ROLLBACK</a>. </li>
    </ul>
  </main>
