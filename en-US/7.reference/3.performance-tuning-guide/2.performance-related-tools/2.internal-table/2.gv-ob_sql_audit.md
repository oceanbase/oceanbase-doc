...
| RET_CODE | bigint(20) | NO | The return code of the execution. <li> 0: indicates that the statement is successfully executed without errors.</li>  <li> Other return codes: indicate that OceanBase Database has encountered an error. For more information about the error codes, see [Error codes](../../../../7.reference/5.system-reference/6.error-code-of-mysql-mode/1.use-error-information-of-mysql-mode.md)  </li> |
