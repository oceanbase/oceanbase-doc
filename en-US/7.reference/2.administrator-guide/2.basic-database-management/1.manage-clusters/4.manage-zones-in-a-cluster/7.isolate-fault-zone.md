...
2. Execute the following statement to isolate the failed OBServer node.
   ...
   For more information about the fields in the `oceanbase.DBA_OB_ZONES` view, see [DBA_OB_ZONES](../../../../5.system-reference/4.system-overview-of-mysql-mode/2.dictionary-view-of-mysql-mode/63.oceanbase-dba_ob_zones-of-mysql-mode.md).
