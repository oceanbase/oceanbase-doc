...
2. Query the maximum number of connections allowed for the current tenant in a view.
   ...
   *************************** 1. row ***************************
   ...
   For more information about the `GV$OB_PARAMETERS` view, see [GV$OB_PARAMETERS](../../../5.system-reference/4.system-view-of-mysql-mode/3.performance-view-of-mysql-mode/6.gv-ob_parameters-of-mysql-mode.md).
