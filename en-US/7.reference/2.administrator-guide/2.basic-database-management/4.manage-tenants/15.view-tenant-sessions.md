...
2. Execute the following statement to view tenant sessions:
   ...
   <li>
   <p>For more information about how to view your privileges in MySQL mode, see <a href="9.manage-users-and-permissions/3.mysql-mode/4.view-the-user-permissions-of-mysql-mode.md">View user privileges</a>. If you do not have the required privileges, contact the administrator to obtain the privileges. For more information, see <a href="9.manage-users-and-permissions/3.mysql-mode/5.modify-user-permissions-for-mysql-tenant-of-mysql-mode.md">Modify user privileges</a>. </p>
   </li>
   </ul>
   </main>
