...
2. Write the function corresponding to the `PASSWORD_VERIFY_FUNCTION` parameter and grant privileges.
   ...
   * When you change your password, the new password must be different from the old password by at least three characters.
   ...
   For information about how to create a function, see [Create a function](../../../../../4.development-reference/3.pl-reference/3.pl-oracle/7.stored-procedure-and-functions-oracle/3.create-a-function-oracle.md).
...
3. In the user profile, specify the `PASSWORD_VERIFY_FUNCTION` parameter to enable password complexity verification.
   ...
   For more information about the `ALTER PROFILE` statement, see [ALTER PROFILE](../../../../../4.development-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/1.ddl-of-oracle-mode/4.alter-profile-of-oracle-mode.md).
...
2. Query the `DBA_SOURCE` view to find the corresponding function.
   ...
   For more information about the fields in the `DBA_SOURCE` view, see [DBA_SOURCE](../../../../../5.system-reference/5.system-view-of-oracle-mode/2.dictionary-view-of-oracle-mode/99.dba_source-of-oracle-mode.md).
...
3. Query the `USER_SOURCE` view to obtain the content of the `VERIFY_FUNCTION` function owned by the current user.
   ...
   For more information about the fields in the `USER_SOURCE` view, see [USER_SOURCE](../../../../../5.system-reference/5.system-view-of-oracle-mode/2.dictionary-view-of-oracle-mode/168.user_source-of-oracle-mode.md).
...
For more information about function management, see [Manage stored procedures and functions](../../../../../4.development-reference/3.pl-reference/3.pl-oracle/7.stored-procedure-and-functions-oracle/4.view-and-delete-procedures-and-functions-oracle.md).
