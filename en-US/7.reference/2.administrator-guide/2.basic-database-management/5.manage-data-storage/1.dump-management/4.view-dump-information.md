...
2. View the progress information such as the amount of data that has not been compacted and the estimated completion time.
   ...
   * `ESTIMATED_FINISH_TIME`: the estimated completion time.
   ...
   For more information about fields in the `GV$OB_TABLET_COMPACTION_PROGRESS` view, see [GV$OB_TABLET_COMPACTION_PROGRESS](../../../../5.system-reference/4.system-overview-of-mysql-mode/3.performance-view-of-mysql-mode/11.gv-ob_tablet_compaction_progress-of-mysql-mode.md).
   ...
   For more information about fields in the `GV$OB_COMPACTION_DIAGNOSE_INFO` view, see [GV$OB_COMPACTION_DIAGNOSE_INFO](../../../../5.system-reference/4.system-overview-of-mysql-mode/3.performance-view-of-mysql-mode/2.gv-ob_compaction_diagnose_info-of-mysql-mode.md).
...
2. View the minor compaction history.
   ...
   *************************** 5. row ***************************
   ...
   <!-- For more information about the fields in the `GV$OB_TABLET_COMPACTION_HISTORY` view, see [GV$OB_TABLET_COMPACTION_HISTORY](../../../../5.system-reference/4.system-overview-of-mysql-mode/3.performance-view-of-mysql-mode/10.gv-ob_tablet_compaction_history-of-mysql-mode.md). -->