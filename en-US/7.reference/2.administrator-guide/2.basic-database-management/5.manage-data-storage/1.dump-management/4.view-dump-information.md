...
2. View the minor compaction history.
   ...
   *************************** 5. row ***************************
   ...
   For more information about the fields in the `GV$OB_TABLET_COMPACTION_HISTORY` view, see [GV$OB_TABLET_COMPACTION_HISTORY](../../../../5.system-reference/4.system-view-of-mysql-mode/3.performance-view-of-mysql-mode/10.gv-ob_tablet_compaction_history-of-mysql-mode.md).