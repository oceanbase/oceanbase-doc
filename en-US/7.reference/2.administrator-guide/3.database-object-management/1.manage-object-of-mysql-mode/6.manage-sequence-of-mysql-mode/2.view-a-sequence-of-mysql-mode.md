...
For more information about fields in the `oceanbase.DBA_OB_SEQUENCE_OBJECTS` view, see [oceanbase.DBA_OB_SEQUENCE_OBJECTS](../../../../5.system-reference/4.system-overview-of-mysql-mode/2.dictionary-view-of-mysql-mode/68.oceanbase-dba_ob_sequence_objects-of-mysql-mode.md). 
