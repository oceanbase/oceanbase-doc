...
For more information, see [Table-level character sets and collations](../../../../4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/1.basic-elements-of-mysql-mode/3.character-set-and-collation-of-mysql-mode/5.table-level-character-set-and-collation-of-mysql-mode.md).
...
* You can change the name and data type of a column.
   ...
   For more information about the rules for changing the data types of columns in MySQL mode, see [Column type change rules](../../../../4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/7.ddl-function-of-mysql-mode/9.column-type-change-rule-of-mysql-mode.md).
...
* Modify the collation and character set of a column.
   ...
   For more information, see [Column-level character sets and collations](../../../../4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/1.basic-elements-of-mysql-mode/3.character-set-and-collation-of-mysql-mode/6.column-level-character-set-and-collations-of-mysql-mode.md).
