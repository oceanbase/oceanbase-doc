...
* `FOREIGN KEY` constraint: requires that the constrained column must contain only values from the primary key column of another table.
   ...
   For more information about the `foreign_key_checks` variable, see [foreign_key_checks](../../../../5.system-reference/2.system-variable-of-mysql-mode/27.foreign_key_checks-of-mysql-mode.md).
...
For more information about the syntax for creating constraints, see [CREATE TABLE](../../../../4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/26.create-table-of-mysql-mode.md).
...
For more information about the syntax for modifying constraints, see [ALTER TABLE](../../../../4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/16.alter-table-of-mysql-mode.md).
