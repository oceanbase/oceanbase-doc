...
3. (Optional) If the execution of the replacement command times out, execute the following statement to query the `DBA_OB_ARBITRATION_SERVICE` view for the replacement status:
   ...
   For more information about the `DBA_OB_ARBITRATION_SERVICE` view, see [DBA_OB_ARBITRATION_SERVICE](../../../7.reference/5.system-reference/4.system-view-of-mysql-mode/2.dictionary-view-of-mysql-mode/196.oceanbase-dba_ob_arbitration_service-mysql.md).
