...
2. Query for the zones, OBServer nodes, and log stream replicas of tenants.
   ...
   For more information about the `CDB_OB_LS_LOCATIONS` view, see [CDB_OB_LS_LOCATIONS](../../../7.reference/5.system-reference/4.system-view-of-mysql-mode/2.dictionary-view-of-mysql-mode/93.oceanbase-cdb_ob_ls_locations-of-mysql-mode.md).
