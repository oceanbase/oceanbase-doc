...
<h4>Notice</h4>
<p>When you perform the following steps to execute the upgrade script, the value of the <code>-u</code> parameter must be a user that has the read/write and SUPER privileges in the sys tenant.<code></code><code><code> </p>
</main>
...
* [Start or stop a zone](../../../2.basic-database-management/1.manage-clusters/4.manage-zones-in-a-cluster/4.start-or-stop-a-zone.md)
