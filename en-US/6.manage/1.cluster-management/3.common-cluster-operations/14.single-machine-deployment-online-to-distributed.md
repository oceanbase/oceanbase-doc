...
<main id="notice" type='explain'>
  ...
  <h4>Note</h4>
  <p>You can also add OBServer nodes to scale out a single-node cluster to a multi-node cluster that contains only one replica. For more information, see <a href="2.add-an-observer-node-to-a-zone.md">Add OBServer nodes to zones</a>. </p>
</main>
...
* [ALTER SYSTEM ... ZONE](../../../../../4.development-reference/1.sql-syntax/1.system-tenants/2.alter-system/25.zone.md)
* [ALTER SYSTEM ... SERVER](../../../../../4.development-reference/1.sql-syntax/1.system-tenants/2.alter-system/20.SERVER.md)
* [ALTER RESOURCE POOL](../../../../../4.development-reference/1.sql-syntax/1.system-tenants/3.alter-resource-pool.md)
* [ALTER TENANT](../../../../../4.development-reference/1.sql-syntax/1.system-tenants/5.alter-tenant.md)
