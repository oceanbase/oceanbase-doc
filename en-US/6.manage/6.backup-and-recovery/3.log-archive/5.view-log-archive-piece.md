...
For more information about the `CDB_OB_ARCHIVELOG_PIECE_FILES` view, see [CDB_OB_ARCHIVELOG_PIECE_FILES](../../../7.reference/5.system-reference/4.system-overview-of-mysql-mode/2.dictionary-view-of-mysql-mode/86.oceanbase-cdb_ob_archivelog_piece_files-of-mysql-mode.md).
