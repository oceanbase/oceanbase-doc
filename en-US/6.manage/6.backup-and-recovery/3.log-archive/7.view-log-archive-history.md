...
For more information about the `CDB_OB_ARCHIVELOG_SUMMARY` view, see [CDB_OB_ARCHIVELOG_SUMMARY](../../../7.reference/5.system-reference/4.system-overview-of-mysql-mode/2.dictionary-view-of-mysql-mode/135.oceanbase-cdb_ob_archivelog_summary-of-mysql-mode.md).
