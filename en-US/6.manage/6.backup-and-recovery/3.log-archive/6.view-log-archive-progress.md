...
For more information about the `CDB_OB_ARCHIVELOG` view, see [CDB_OB_ARCHIVELOG](../../../7.reference/5.system-reference/4.system-overview-of-mysql-mode/2.dictionary-view-of-mysql-mode/133.oceanbase-cdb_ob_archivelog-of-mysql-mode.md).
