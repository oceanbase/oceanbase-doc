...
3. Restart the observer process.
   ...
   You must first stop the observer process and then restart it. For more information, see [Stop or start an OBServer node](../../../2.basic-database-management/1.manage-clusters/5.manage-observer/3.stop-or-start-observer.md).
