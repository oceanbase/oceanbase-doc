...
3. Query the `DBA_RSRC_PLANS` view to verify whether the resource management plan is deleted.
   ...
   For more information about the `DBA_RSRC_PLANS` view, see [DBA_RSRC_PLANS](../../../../../7.reference/5.system-reference/5.system-view-of-oracle-mode/2.dictionary-view-of-oracle-mode/124.dba_rsrc_plans-of-oracle-mode.md).
