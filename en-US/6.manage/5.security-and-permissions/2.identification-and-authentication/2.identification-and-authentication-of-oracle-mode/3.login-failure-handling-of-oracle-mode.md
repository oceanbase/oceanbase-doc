...
<main id="notice" >
  <h4>Applicability</h4>
  <p>This topic applies only to OceanBase Database in Oracle mode. OceanBase Database Community Edition only supports MySQL mode. For login failure processing in MySQL mode, see <a href="../1.security-permissions-mysql-mode/3.Login-failure-handling-of-mysql-mode.md">Login failure processing</a>. </p>
</main>
