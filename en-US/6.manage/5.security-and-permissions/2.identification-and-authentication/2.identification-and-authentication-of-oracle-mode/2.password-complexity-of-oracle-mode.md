...
<main id="notice" >
    <h4>Applicability</h4>
    <p>This topic applies only to OceanBase Database in Oracle mode. OceanBase Database Community Edition supports only the MySQL mode. For more information about password complexity in MySQL mode, see <a href="../1.identification-and-authentication-of-mysql-mode/2.password-complexity-of-mysql-mode.md">Password complexity</a>. </p>
</main>
