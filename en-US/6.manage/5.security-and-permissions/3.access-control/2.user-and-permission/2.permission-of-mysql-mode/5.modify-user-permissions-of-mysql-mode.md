...
For more information about the `REVOKE` statement, see [REVOKE](../../../../../7.reference/4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/47.revoke-of-mysql-mode.md).
