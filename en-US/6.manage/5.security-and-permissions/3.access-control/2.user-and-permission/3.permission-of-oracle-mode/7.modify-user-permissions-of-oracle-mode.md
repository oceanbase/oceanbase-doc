...
For more information about the `REVOKE` statement, see [REVOKE](../../../../../7.reference/4.development-reference/1.sql-syntax/3.common-tenant-of-oracle-mode/9.sql-statement-of-oracle-mode/3.dcl-of-oracle-mode/9.revoke-of-oracle-mode.md).
