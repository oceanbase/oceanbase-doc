...
* For more information about how to create and drop a vector index after table creation, see [Dense vector indexes](../200.ob-vector-index/100.ob-vector-index-overview.md).