...
We recommend that you import data before you create a vector index. For more information, see [Vector search indexes](../200.ob-vector-index/100.ob-vector-index-overview.md).
...
* For information about how to create or drop a vector index after you create a table, see [Dense vector indexes](../200.ob-vector-index/100.ob-vector-index-overview.md).