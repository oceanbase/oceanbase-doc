...
The workflow begins with unstructured data (such as videos, documents, and images). These data types are converted into vector data representations through a vector embedding model. This model transforms raw, complex unstructured data into high-dimensional vectors. These vectors capture the semantic information and features of the data and can express the similarity between data points based on their distances in the vector space. For more information, see [Vector embedding](../150.ob-vector-search-generate-vector-embeddings.md).
