...
This topic describes the privileges of the AI function service, including the `AI MODEL` and `ACCESS AI MODEL` privileges, which are used to manage AI models and call AI functions, respectively.

<main id="notice" type='notice'>
    <h4>Notice</h4>
    <p>You do not need to grant the AI model privilege when you use the <code>AI_SPLIT_DOCUMENT</code> function. </p>
</main>

## AI MODEL

The privileges related to AI MODEL are used to manage AI models. They include the `CREATE AI MODEL`, `ALTER AI MODEL`, and `DROP AI MODEL` privileges.
...
The `ACCESS AI MODEL` privilege is used to call AI functions and includes the `AI_COMPLETE`, `AI_EMBED`, `AI_RERANK`, and `AI_PROMPT` functions.
...
1. Call the `AI_COMPLETE` function.
    ...
    ```sql
    SELECT AI_COMPLETE("ob_complete","You are a translator. Please translate the following text into English: {{Hello world.}}, and output only the translation result") as ans;
    ```
