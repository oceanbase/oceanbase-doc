...
* You can create dense indexes and memory-based sparse indexes (hereafter referred to as memory sparse indexes). For details, see [Vector Indexes](../200.ob-vector-index/100.ob-vector-index-overview.md).
...
* [Dense vector indexes](../200.ob-vector-index/100.ob-vector-index-overview.md)
