...
OceanBase Database provides vector data types to support AI vector search applications. You can store and query a floating-point array, such as `[0.1, 0.3, -0.9, ...]`, by using vector data types. Before you use vector data, you must be aware of the following information:
