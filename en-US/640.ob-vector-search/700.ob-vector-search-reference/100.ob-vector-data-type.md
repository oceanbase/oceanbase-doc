...
* Creating dense/sparse vector indexes is supported. For details, see [vector index](../200.ob-vector-index/100.ob-vector-index-overview.md).
...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>Sparse vector data and sparse vector indexes are supported starting from V4.3.5 BP2.</p>
</main>
...
- [Create vector indexes](../200.ob-vector-index/100.ob-vector-index-overview.md)
