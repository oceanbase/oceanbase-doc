...
* For dense vector indexes, you can use L2, inner product, and cosine distance as the index distance algorithms. For more information, see **HNSW series indexes** and **IVF series indexes**.
