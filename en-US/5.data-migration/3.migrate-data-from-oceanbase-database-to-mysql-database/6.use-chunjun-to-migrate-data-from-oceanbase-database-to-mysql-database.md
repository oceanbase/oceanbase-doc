...
* You have installed and deployed oblogproxy. For more information, see [Install oblogproxy](https://www.oceanbase.com/docs/enterprise-oms-doc-cn-0000000001042126).
...
* For more information about how to configure the JSON file for OceanBase Database that serves as the source database, see [OceanBase CDC Source](https://github.com/DTStack/chunjun/blob/master/docs_zh/ChunJun%E8%BF%9E%E6%8E%A5%E5%99%A8/oceanbasecdc/OceanBaseCDC-source.md).
