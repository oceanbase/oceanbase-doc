# Use Fink CDC to migrate data from OceanBase Database to a MySQL database
...
This topic describes how to use Fink CDC to migrate data from OceanBase Database to a MySQL database. 
...
2. Install and deploy oblogproxy. For more information, see [Install oblogproxy](https://www.oceanbase.com/docs/enterprise-oms-doc-cn-0000000001042126). 

### Configure the Flink environment

Download Flink and the required dependency packages.

1. Download [Flink 1.15.3](https://downloads.apache.org/flink/flink-1.15.3/flink-1.15.3-bin-scala_2.12.tgz) and decompress it to the `flink-1.15.3` directory. 
