...
For more information about the SQL syntax requirements of OceanBase Database, see [SQL syntax (MySQL mode)](../7.reference/4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/6.sql-statement-of-mysql-mode/1.general-syntax-of-mysql-mode.md)<!--  and [SQL syntax (Oracle mode)](../7.reference/1.oceanbase-database-concepts/7.user-interface-and-query-language/1.SQL/1.sql-introduction/1.sql-overview.md) -->.
