...
After OBServer is started, if no configuration item is specified, the system uses the default values for the specified configuration items. For more information about how to view and set configuration items, see [Cluster parameter management](../../6.administrator-guide/3.basic-database-management/1.oceanbase-cluster-management/2.cluster-parameter-management/1.overview-of-cluster-parameter-management.md).
