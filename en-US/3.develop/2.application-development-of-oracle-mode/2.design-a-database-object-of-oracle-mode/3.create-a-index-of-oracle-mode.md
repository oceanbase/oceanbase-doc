...
For more information about unique and non-unique indexes, see [Unique and non-unique indexes](../../../7.reference/1.concepts-of-oceanbase-database-system/4.database-objects-1/1.oracle/3.index/3.unique-and-non-unique-indexes.md). 
...
For more information about local and global indexes, see [Local and global indexes](../../../7.reference/1.concepts-of-oceanbase-database-system/4.database-objects-1/1.oracle/3.index/2.local-and-global-indexes.md). 
...
* You have the `INDEX` privilege and the `ALTER` privilege on the table where an index is to be created. For more information about how to view your privileges, see [View user privilege](7.reference/2.manage-guide/2.basic-database-management/4.manage-tenants-1/5.manage-users-and-permissions/2.oracle-3/4.view-user-permissions.md). If you do not have the required privileges, contact the administrator. For more information, see [Modify user privileges](7.reference/2.manage-guide/2.basic-database-management/4.manage-tenants-1/5.manage-users-and-permissions/2.oracle-3/5.modify-user-permissions-1.md). 

* A table has been created. For more information about how to create a table, see [Create a table](3.create-a-table.md). 
...
You can use the [CREATE UNIQUE INDEX](../../../7.reference/4.development-guide-refactoring/1.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/16.create-index-1.md) statement to create a unique index on an existing table based on the following requirements. 
...
You can use the [CREATE INDEX](../../../7.reference/4.development-guide-refactoring/1.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/16.create-index-1.md) statement to create a non-unique index on an existing table based on the following requirements. 
...
Use the [CREATE INDEX](../../../7.reference/4.development-guide-refactoring/1.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/16.create-index-1.md) statement and the `LOCAL` keyword to create a local index on an existing table based on the following requirements. 

Use the [CREATE UNIQUE INDEX](../../../7.reference/4.development-guide-refactoring/1.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/16.create-index-1.md) statement and the `LOCAL` keyword to create a local unique index on an existing table based on the following requirements. 
...
Use the [CREATE INDEX](../../../7.reference/4.development-guide-refactoring/1.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/16.create-index-1.md) statement and the `GLOBAL` keyword to create a global index on an existing table based on the following requirements. 

Use the [CREATE UNIQUE INDEX](../../../7.reference/4.development-guide-refactoring/1.sql-syntax/3.common-tenant-oracle-mode/9.sql-statement-1/1.DDL-1/16.create-index-1.md) statement and the `GLOBAL` keyword to create a global unique index on an existing table based on the following requirements. 
...
* [View indexes](7.reference/2.manage-guide/3.database-object-management-1/1.oracle-4/3.manage-indexes-1/3.view-indexes-1.md)

* [Drop an index](7.reference/2.manage-guide/3.database-object-management-1/1.oracle-4/3.manage-indexes-1/4.delete-an-index-1.md)