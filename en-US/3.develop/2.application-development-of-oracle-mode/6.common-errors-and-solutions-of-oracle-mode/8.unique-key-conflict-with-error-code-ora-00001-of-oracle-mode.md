...
2. To retain existing rows, you can execute the following statement to update the record whose `id` value is 3.
   ...
   > **Note**
   >
   > * You can also use the `MERGE INTO` statement to avoid unique key conflicts. For more information, see [Replace data](../3.write-data-for-oracle-mode/4.replace-data.md). 
   > * If you confirm that the existing row is not needed, you can delete it. For more information, see [Delete data](../3.write-data-for-oracle-mode/3.delete-data.md). 
