...
If savepoints are set for a transaction, you can use the `ROLLBACK TO SAVEPOINT` statement to roll back the transaction to a savepoint. For more information about transaction savepoints, see [Transaction savepoints](3.transaction-savepoints-of-oracle-mode/1.mark-a-savepoint-of-oracle-mode.md). 
...
For more information about how to roll back a transaction to a savepoint, see [Roll back a transaction to a savepoint](3.transaction-savepoints-of-oracle-mode/2.rollback-to-a-savepoint-of-oracle-mode.md). 
