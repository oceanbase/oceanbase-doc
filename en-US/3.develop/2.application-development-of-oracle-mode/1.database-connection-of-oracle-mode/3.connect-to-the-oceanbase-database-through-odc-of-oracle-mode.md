...
You have downloaded and installed the [ODC client](https://help.aliyun.com/document_detail/212816.html). 

## Procedure

This topic takes creating a private connection for a user tenant (mysql@tenant) by using the ODC client as an example. Perform the following steps:

1. Open the ODC client. On the **Private Connection** tab of the homepage of ODC, click **Create Connection** in the upper-right corner to create a private connection. 
...
For more information about other features of ODC, see the [ODC documentation](https://www.oceanbase.com/docs/enterprise-odc-doc-cn-10000000000691059) in the [OceanBase Database documentation center](https://www.oceanbase.com/docs/enterprise-oceanbase-database-cn-10000000000354568). 
