...
In addition, you can use the `WHERE` condition to query specified columns. For more information, see [Conditional queries](4.sort-query-of-oracle-mode.md).
For more information, see [Use operators and functions in queries](9.execution-plan-of-oracle-mode/1.view-query-execution-plan-of-oracle-mode.md). 
