...
* You have the `INSERT` privilege on the target table. For more information about how to view your privileges, see [View user privileges](7.reference\3.user-guide-old\6.basic-database-management\4.manage-tenants-1\5.manage-users-and-permissions\3.mysql-3\4.view-user-permissions-1.md). If you do not have the required privileges, contact the administrator. For more information, see [Modify user privileges](7.reference\3.user-guide-old\6.basic-database-management\4.manage-tenants-1\5.manage-users-and-permissions\3.mysql-3\5.modify-user-permissions-2.md). 

## Use the INSERT statement to insert data

Use the [INSERT](../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/4.functions/2.functions-1/2.string-functions/14.INSERT-1-2-3-4.md) statement to insert data into a table based on the following suggestions. 
...
You can use the `INSERT` statement to insert a single row of data. To insert multiple records, you can execute the statement multiple times. To insert records in batches, see [Insert multiple rows of data in batches](# Insert multiple rows of data in batches). 
...
* If you use [INSERT IGNORE INTO](../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/4.functions/2.functions-1/2.string-functions/14.INSERT-1-2-3-4.md) to avoid constraint conflicts, the `IGNORE` keyword can be used to ignore the impact of an insert failure caused by a constraint conflict. 
...
* If you use [INSERT INTO ON DUPLICATE KEY UPDATE](../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/4.functions/2.functions-1/2.string-functions/14.INSERT-1-2-3-4.md) to avoid constraint conflicts, you can specify the action to take on duplicate primary keys or unique keys. 
