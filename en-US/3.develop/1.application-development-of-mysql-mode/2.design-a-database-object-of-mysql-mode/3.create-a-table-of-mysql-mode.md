...
For more information, see [Overview](7.reference\5.concepts-of-oceanbase-database-system-old\4.database-objects-1\2.mysql\2.table-1\1.table-overview-1.md). 
...
* You have the CREATE privilege. For more information about how to view your privileges, see [View user privileges](7.reference\3.user-guide-old\6.basic-database-management\4.manage-tenants-1\5.manage-users-and-permissions\3.mysql-3\4.view-user-permissions-1.md). If you do not have the required privileges, contact the administrator. For more information, see [Modify user privileges](7.reference\3.user-guide-old\6.basic-database-management\4.manage-tenants-1\5.manage-users-and-permissions\3.mysql-3\5.modify-user-permissions-2.md). 

* A database has been created. For more information, see [Create a database](1.create-a-database.md). 

## Create a table

Use the [CREATE TABLE](../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/16.create-table.md) statement to create a table and complete the table creation based on the content of this topic. 
...
* Select a proper data type for the data to be stored in columns. 
   ...
   For more information about the data types supported in MySQL mode of OceanBase Database, see [Overview](../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/1.basic-elements/1.data-type/1.data-type-overview.md). 
...
To specify a column as a primary key column, add the `PRIMARY KEY` keyword to the definition of this column. To define a PRIMARY KEY constraint on multiple columns, add the definition of the PRIMARY KEY constraint after the list of columns in the [CREATE TABLE](../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/16.create-table.md) statement. 
...
For more information about PRIMARY KEY constraints, see [PRIMARY KEY constraints](../../../7.reference/4.concepts-of-oceanbase-database-system/4.database-objects-1/2.mysql/7.data-integrity-1/2.integrity-constraint-type-1/4.primary-key-constraint-1.md). 
...
After you define primary key columns, you can delete them. For more information about operations related to PRIMARY KEY constraints, see [Define column constraints](7.reference\3.user-guide-old\7.database-object-management-1\2.mysql-4\2.manage-tables-2\4.define-the-constraint-type-for-a-column-2.md). 
...
To constrain a single column, add a constraint keyword to the definition of this column. To constrain multiple columns, add the entire constraint definition after the list of columns in the [CREATE TABLE](../../../7.reference/6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/16.create-table.md) statement. 
...
For more information about how to define other column constraints, see [Define column constraints](7.reference\3.user-guide-old\7.database-object-management-1\2.mysql-4\2.manage-tables-2\4.define-the-constraint-type-for-a-column-2.md). 
...
You can change the values of the three variables as needed. For more information about how to change the values of system variables, see [Overview](../../../7.reference/14.system-reference/2.system-variable-for-mysql/1.overview-of-system-variables-3.md). 
...
For more information about auto-increment columns, see [Define an auto-increment column](7.reference\3.user-guide-old\7.database-object-management-1\2.mysql-4\2.manage-tables-2\3.define-an-auto-increment-column-2.md). 
...
For more information about partitioning, see [Partitioning](../../../7.reference/1.concepts-of-oceanbase-database-system/4.database-objects-1/2.mysql\4.partition-2/1.partition-overview-4.md). 
...
The following examples describe how to create a subpartitioned table. For more examples, see [Create a partitioned table](7.reference\3.user-guide-old\8.distributed-storage-management\2.manage-partition-table\2.mysql-1\2.create-a-partition-table.md). 
...
* [Create an index](4.create-a-index.md)

* [Manage partitions](7.reference\3.user-guide-old\8.distributed-storage-management\2.manage-partition-table\2.mysql-1\1.partition-overview-6.md)
