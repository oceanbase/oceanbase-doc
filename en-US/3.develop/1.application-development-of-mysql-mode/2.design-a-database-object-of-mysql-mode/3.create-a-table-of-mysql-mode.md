...
* [Create a table group](4.create-a-index-of-mysql-mode.md)

* [Create an index](../../../7.reference/2.administrator-guide/4.replica-management/2.manage-partition-table/2.mysql-mode/1.partition-overview-of-mysql-mode.md)
