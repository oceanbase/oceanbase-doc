...
This topic describes how to use RIGHT JOIN queries. For more information about FULL JOIN queries and LEFT JOIN queries, see [FULL JOIN queries](2.full-join-of-mysql-mode.md) and [LEFT JOIN queries](3.left-join-of-mysql-mode.md). 
