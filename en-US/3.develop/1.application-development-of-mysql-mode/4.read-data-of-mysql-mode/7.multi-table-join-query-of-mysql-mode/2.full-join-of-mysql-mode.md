...
This topic describes how to use FULL JOIN queries. For more information about LEFT JOIN queries and RIGHT JOIN queries, see [LEFT JOIN queries](3.left-join-of-mysql-mode.md) and [RIGHT JOIN queries](4.right-join-of-mysql-mode.md). 
...
* [LEFT JOIN queries](3.left-join-of-mysql-mode.md)
