...
This topic provides a Spring JPA connection example and tests the performance of several general Spring JPA features against Oracle. 
...
The test results show that OceanBase Database supports the Alert Table feature of Spring JPA. 
...
The test results show that OceanBase Database supports the Insert feature of Spring JPA. 
...
The test results show that OceanBase Database supports the findOne feature of Spring JPA. 
...
The test results show that OceanBase Database supports the Delete feature of Spring JPA. 
...
The test results show that OceanBase Database supports the data modification feature of Spring JPA. 
...
The test results show that OceanBase Database supports the FindAll feature of Spring JPA.