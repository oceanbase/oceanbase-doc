...
Content of the `dbcp.properties` configuration file:

```perl
#Driver name
driverClassName=com.mysql.cj.jdbc.Driver
#url
url=jdbc:mysql://10.xx.xxx.xxx:18817/test?useSSL=false&useServerPrepStmts=true&serverTimezone=UTC
#Username
...
public class DBConn {
    ...
    public static Connection getConnection() {
        try {
            ...
            DriverManager.registerDriver(new mysql.cj.jdbc.Driver());
