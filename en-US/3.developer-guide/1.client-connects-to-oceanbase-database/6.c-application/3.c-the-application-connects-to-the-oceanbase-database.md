...
Find the required installation packages in the image repository based on your system version and download the installation packages. For more information, see **Software resources** in [Software and hardware requirements](../../../1.users-guide/3.installation-and-deployment/2.download-installation-packages.md). 
