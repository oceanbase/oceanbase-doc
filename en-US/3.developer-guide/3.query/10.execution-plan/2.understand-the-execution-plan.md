...
For more information about SQL optimization, see [SQL optimization](../../../../3.user-guide/9.sql-optimization/4.sql-optimization-1/1.overview-of-sql-optimization.md).
