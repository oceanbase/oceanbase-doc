...
|---------|------------|
| [auto_increment_cache_size](../../../../3.user-guide/14.system-reference/2.system-variable-for-mysql/3.auto_increment_cache_size-1-2-3.md) | The cache size. Value range: [1,100000000]. Default value: `1000000`.  The effective scope is `GLOBAL`.  |
| [auto_increment_increment](../../../../3.user-guide/14.system-reference/2.system-variable-for-mysql/4.auto_increment_increment-1-2-3.md) | The increment step. Value range: [1,65535]. Default value: `1`.  The effective scope is `GLOBAL` or `SESSION`.  |
| [auto_increment_offset](../../../../3.user-guide/14.system-reference/2.system-variable-for-mysql/5.auto_increment_offset-1-2-3.md) | The start value of the `AUTO_INCREMENT` column. Value range: [1,65535]. Default value: `1`.  The effective scope is `GLOBAL` or `SESSION`.  |

> **Note**
>
> For more information about system variables, see [System variables overview](../../../../3.user-guide/14.system-reference/2.system-variable-for-mysql/1.overview-of-system-variables-3.md).
