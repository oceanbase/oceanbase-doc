...
This topic describes how to [rename a table](#Rename a table), [rename a column](#Rename a column), [modify a column type](#Change the type of a column), [rename a column and change the column type](#Rename a column and change the column type at the same time), [change a normal column to an auto-increment column](#Change a normal column to an auto-increment column), [add a column](#Add a column), [delete a column](#Delete a column), [add a primary key](#Add a primary key), [modify a primary key](#Modify a primary key), [delete a primary key](#Delete a primary key), [add a foreign key](#Add a foreign key), [delete a foreign key](#Drop a foreign key), [add a CHECK constraint](#Add a CHECK constraint), and [modify a table partition](#Modify a table partition).

> **Note**
>
> For more information about how to modify the table structure, see [ALTER TABLE](../../../6.sql-syntax/2.common-tenant-mysql-mode/6.sql-statement/6.alter-table.md).
...
> **Note**
>
> For more information about the rules for changing the data types of columns, see [Column type change rules](../../../6.sql-syntax/2.common-tenant-mysql-mode/7.ddl-function/4.column-type-change-rule-1.md).
...
For more information about modifying the partitioning rule of a table, see [Modify partitioning rules](../../../../3.user-guide/8.distributed-storage-management/2.manage-partition-table/2.mysql-1/3.modify-partition-rules.md).
