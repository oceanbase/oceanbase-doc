...
In MySQL mode of OceanBase Database, you can use the `DATE_FORMAT` function to adjust the display format of date and time. Sample SQL statement:
...
In MySQL mode of OceanBase Database, you can use the `EXTRACT()` function to extract the year, month, date, hour, minute, and second from date and time. Sample SQL statement:
...
For information about time types, see **SQL Syntax (MySQL Mode)**.
