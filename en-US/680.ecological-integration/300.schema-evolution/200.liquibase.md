...
We recommend that you use OceanBase Database V4.2.3 or a later version for a better integration experience.
...
### Step 2: Use the Liquibase reference example
...
6. **Perform a rollback.**  
   ...
   After the change succeeds, you can also perform a rollback to restore the database to the previous version:
