...
# Build an MCP server for OceanBase using Google GenAI Toolbox
...
[Google GenAI Toolbox for Databases](https://github.com/googleapis/genai-toolbox), now known as MCP Toolbox for Databases, is an open-source MCP server for databases. It streamlines complex tasks such as connection pooling and authentication, allowing you to develop tools more easily, quickly, and securely.

This guide walks you through setting up an MCP server for OceanBase using Google GenAI Toolbox, all without any programming.
...
## Step 2: Download and use Google GenAI Toolbox
