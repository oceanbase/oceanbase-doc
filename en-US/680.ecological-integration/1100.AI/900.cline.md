...
2. Manually configure OceanBase MCP servers.
...
4. If the configuration is successful, the status will change to `Available`, and the `MCP tools` and `resources` information will be displayed.

    <!-- ![3](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/cloud/integrations/AI/cline-7.png) -->

5. Click the switch button to enable it for Cline.
