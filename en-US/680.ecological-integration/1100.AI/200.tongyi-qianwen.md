...
OceanBase Database provides vector storage, vector indexing, and embedding vector search capabilities. You can leverage the Tongyi Qianwen API to store vectorized data in OceanBase Database and use OceanBase Database's vector search capabilities to query related data.

## Prerequisites

* You have deployed OceanBase Database V4.4.0 or later and created a MySQL-compatible tenant. After you create a tenant, follow the steps below.
* You have a MySQL-compatible tenant, database, and account in your environment, and the database account has been granted read and write privileges.
...
* You have obtained a [Qwen API key](https://www.alibabacloud.com/help/en/model-studio/first-api-call-to-qwen?spm=a2c63.l28256.help-menu-2400256.d_0_0_1.95cf4f2ckCNUt4).
