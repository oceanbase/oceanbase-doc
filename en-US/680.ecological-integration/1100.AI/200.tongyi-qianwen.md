...
By leveraging Qwen's APIs, you can store vectorized data in OceanBase Database and utilize its vector retrieval capabilities to efficiently query related data.
...
* You have set the `ob_vector_memory_limit_percentage` parameter in the instance to enable vector retrieval. We recommend that you set the value to `30`. For more information about this parameter, see [ob_vector_memory_limit_percentage](../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/6150.ob_vector_memory_limit_percentage.md).
