...
# Integrate OceanBase Database with LangChain
...
* Have context-awareness: Connect language models to context sources (such as prompts, a few-shot examples, or specific content to respond to).
* Perform reasoning: Use language models for reasoning (for example, determining how to respond or what actions to take based on the provided context).

This topic describes how to integrate the [vector retrieval functionality](../../640.ob-vector-search/100.ob-vector-search-intro.md) of OceanBase Database, [Qwen](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001579715), and [LangChain](https://python.langchain.com/) to implement document-based question answering.
...
* You have installed [Poetry](https://python-poetry.org/docs/), [Pyobvector](https://github.com/oceanbase/pyobvector), and [DashScope](https://github.com/oceanbase/dashscope):
...
* You have installed [LangChain](https://python.langchain.com/docs/get_started/installation).

    ```shell
    python3 -m pip install langchain
    ```

* You have set the `ob_vector_memory_limit_percentage` parameter in the instance to enable vector-based search. We recommend that you set the value to `30`. For more information about this parameter, see [ob_vector_memory_limit_percentage](../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/6150.ob_vector_memory_limit_percentage.md).
...
### Clone the third-party integration code repository
...
The project contains sample data, which is stored in `./../docs/docs/how_to/state_of_the_union.txt`. The `CharacterTextSplitter` class splits the data into blocks of approximately 1,000 characters.
...
This step demonstrates how to search for `What did the president say about Ketanji Brown Jackson` in the `state_of_the_union.txt` document.
