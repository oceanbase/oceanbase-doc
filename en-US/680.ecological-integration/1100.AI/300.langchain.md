...
This topic describes how to integrate the [vector retrieval functionality](../../640.ob-vector-search/100.ob-vector-search-overview/100.ob-vector-search-intro.md) of OceanBase Database, [Qwen](https://www.alibabacloud.com/en/solutions/generative-ai/qwen?_p_lc=1), and [LangChain](https://python.langchain.com/) to implement document-based question answering.
