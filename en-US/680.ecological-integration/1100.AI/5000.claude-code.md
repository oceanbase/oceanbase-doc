...
<Tabs>
   ...
   * `$password`: The account password.
   ...
   Verify whether you can connect to the database. When prompted with "How many tables are in the test database?", Claude Code will display the SQL statements to be executed and output the query results. If the number of tables in the test database is displayed, you can successfully connect to OceanBase Database.
