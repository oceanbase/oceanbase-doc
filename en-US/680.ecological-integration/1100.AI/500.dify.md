...
OceanBase Database supports vector type storage, vector indexes, and embedding vector search. You can store vectorized data in OceanBase Database for subsequent retrieval.
