...
This topic describes how to use the MyBatis framework and OceanBase Database to build an application that performs basic database operations such as creating tables, inserting data, and querying data.
