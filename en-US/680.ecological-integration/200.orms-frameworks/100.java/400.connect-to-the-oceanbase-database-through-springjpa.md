...
|dir-name-en|SpringDataJPA|
|tenant-type|MySQL Mode|
|slug|connect-to-oceanbase-by-using-spring-data-jpa|

# Connect to OceanBase Database by using Spring Data JPA

This topic describes how to use the Spring Data JPA framework and OceanBase Database to build an application and perform basic database operations such as creating tables, inserting data, and querying data.
