...
This topic describes how to use the Spring JDBC framework, MySQL Connector/J, and OceanBase Database to build an application for basic database operations, such as table creation, data insertion, and data query.
