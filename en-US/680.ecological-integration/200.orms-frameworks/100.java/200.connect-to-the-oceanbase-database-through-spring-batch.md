...
|dir-name-en|SpringBatch|
|tenant-type|MySQL Mode|
|slug|connect-to-oceanbase-by-using-spring-batch|

# Connect to OceanBase Database by using Spring Batch

This topic describes how to use the Spring Batch framework and OceanBase Database to build an application and perform basic database operations such as creating tables, inserting data, and querying data.
