|description|This topic introduces how to use Sequel and OceanBase Database to build an application and perform basic database operations such as creating tables, inserting data, and querying data.|
|---|---|
|keywords|Ruby, Sequel, OceanBase, database connection, ORM framework, Integration|
|dir-name|Sequel|
|dir-name-en|Sequel|
|category|Integration|
|type|Framework and driver|
|tenant-type|MySQL Mode|
|slug|connect-to-oceanbase-by-using-sequel|

# Connect to OceanBase Database by using Sequel

This topic introduces how to build an application by using Sequel and OceanBase Database and perform basic database operations such as creating tables, inserting data, and querying data.
