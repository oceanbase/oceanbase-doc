...
|slug|bytebase-oceanbase-integration|

# Manage OceanBase Database instances by using Bytebase

Bytebase is an open-source database change management and collaboration tool. It provides both SaaS services and a self-hosted version. In this topic, a MySQL-compatible tenant of OceanBase Database is used as an example to demonstrate how to manage OceanBase instances by using Bytebase.
