...
DBeaver is a general-purpose database client. It connects to a database through the Java Database Connectivity (JDBC) driver provided by this database. It supports common relational databases, non-relational databases, and distributed databases.
