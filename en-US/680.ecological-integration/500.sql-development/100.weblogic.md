...
|slug|connect-to-oceanbase-by-using-weblogic|
...
* Ensure that WebLogic Server 14.1.1 or later is installed.
...
* Ensure OceanBase Database (V4.3.5 or later) is installed and a tenant is created.

## Procedure

### Step 1: Download and prepare the installation files

1. Download the Generic Installer (`fmw_14.1.1.0.0_wls.jar`) from [Oracle Fusion Middleware Software Downloads](https://www.oracle.com/technetwork/middleware/weblogic/downloads/index.html).
...
If you encounter any issues while connecting to OceanBase Database through WebLogic, we recommend that you refer to the [Oracle WebLogic official documentation](https://www.oracle.com/java/weblogic/) or contact OceanBase Technical Support.