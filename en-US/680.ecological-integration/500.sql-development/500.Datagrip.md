...
4. In the **Data Sources** dialog box, specify the following parameters based on the connection string obtained in **Step 1: Obtain the OceanBase Database connection string**.
