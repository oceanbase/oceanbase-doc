...
1. Start TablePlus, right-click on the right side of the interface, and choose **New** > **Connection**.

2. In the dialog box that appears, select **MySQL** and then click **Create**.

3. In the **MySQL Connection** dialog box, specify the following parameters based on the connection string obtained in **Step 1: Obtain the OceanBase Database connection string**.
...
5. Click **Test** to verify the connection. If the background colors of the input boxes turn green, the connection is successful.

6. After a successful connection test, click **Connect** to complete the connection.
