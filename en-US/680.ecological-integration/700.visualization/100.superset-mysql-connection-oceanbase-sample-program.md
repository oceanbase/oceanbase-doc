...
|slug|superset-oceanbase-integration|
...
2. On the **New dataset** page, configure the following parameters.
    ...
    |SCHEMA| Select the OceanBase database from the connection string obtained in Step 1. |
...
After you create a dataset, you can select a chart type based on your needs, click **CREATE NEW CHART** to create a chart, and configure the chart as needed. For more information, see [Superset documentation](https://superset.apache.org/docs/creating-charts-dashboards/exploring-data).
