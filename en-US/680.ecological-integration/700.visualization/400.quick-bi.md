...
This topic describes how to connect to a MySQL-compatible tenant of OceanBase Database in Quick BI Enterprise Standard Version for data display.

## Prerequisites

* You have purchased Quick BI Enterprise Standard Version. For more information about the Quick BI versions and billing methods, see [Quick BI Purchases, Upgrades, Renewals, and Overdue Payments](https://www.alibabacloud.com/help/en/quick-bi/product-overview/purchases-upgrades-downgrades-renewals-and-overdue-payments).
...
2. Set related parameters based on the connection string obtained in **Step 1**.
...
4. Click **OK**. If the page shown in the following figure appears, it indicates that you have successfully connected to OceanBase Database and added it as a data source.
...
Quick BI will be ready for use after the data source has been added. For more information about how to use Quick BI, see [Quick BI documentation](https://www.alibabacloud.com/help/en/quick-bi/user-guide).
