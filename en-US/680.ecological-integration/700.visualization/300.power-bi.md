...
|slug|powerbi-oceanbase-integration|
...
This topic describes how to connect to a MySQL-compatible tenant of OceanBase Database in Power BI for data display.
...
Power BI will be ready for use after the MySQL-compatible tenant of OceanBase Database has been added as a data source. For more information about how to use Power BI, see [Power BI documentation](https://learn.microsoft.com/en-us/power-bi/fundamentals/power-bi-overview).
