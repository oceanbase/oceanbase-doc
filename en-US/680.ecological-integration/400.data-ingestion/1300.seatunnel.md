...
This section describes how to execute SQL queries in a MySQL-compatible tenant of OceanBase Database by using MySQL Change Data Capture (CDC) Source Connector for SeaTunnel. `connector-cdc-mysql` is a plug-in of SeaTunnel for real-time capture and streaming of change data in MySQL databases.

## Procedure

Follow the steps below to synchronize data between MySQL-compatible tenants of OceanBase Database:
