...
* Before using dbt, ensure you have installed dbt-oceanbase. If you have not installed it, see **Step 2: Install dbt-oceanbase**.
...
5. Run the following command to automatically detect and execute the files in the `models` directory:
...
The preceding command is successfully executed and a view is created. You can view it in OceanBase Database.
