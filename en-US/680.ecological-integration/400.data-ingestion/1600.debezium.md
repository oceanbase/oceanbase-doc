...
|slug|debezium-oceanbase-integration|
...
Before using Debezium, make sure that you have installed oblogproxy.
...
4. Create a file named `payload.json` and write the following sample configuration to the file:
...
<h4>Notice</h4>
<p><ol>
  <li>The MySQL connector cannot recognize OceanBase Database syntaxes such as <code>PURGE TABLE</code>. You can set <code>schema.history.internal.skip.unparseable.ddl</code> to <code>true</code> to skip these syntaxes. </li>
