...
| CDC data synchronization <main id="notice" type='notice'><h4>Notice</h4><p>Only supported for MySQL mode tenants in OceanBase Database. Oracle mode tenants are not supported. </p></main> | Flink CDC (OceanBase CDC) | Parallel full + incremental read | [OceanBase CDC Documentation](https://nightlies.apache.org/flink/flink-cdc-docs-master/docs/connectors/flink-sources/oceanbase-cdc/) |
