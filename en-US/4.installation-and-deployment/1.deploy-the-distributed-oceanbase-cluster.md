...
* You have completed the following operations in your production environment:
  ...
  * You have viewed the resources. For more information, see [View resources](/en-US/4.installation-and-deployment/4.optional-check-the-operating-system.md).

    
  
  * You have enabled using SSH to log on without a password. For more information, see [Use SSH to log on without a password](/en-US/4.installation-and-deployment/5.optional-set-password-free-ssh-logon.md).

    
  
  * You have configured the clock source. For more information, see [Configure the clock source](/en-US/4.installation-and-deployment/6.optional-configuring-clock-sources.md).

    
  
  * You have planned the disk usage. For more information, see [Plan the disks](/en-US/4.installation-and-deployment/7.disk-planning.md).

    
  
  * You have configured the limits.conf file. For more information, see [Configure the limits.conf file](/en-US/4.installation-and-deployment/8.optional-configure-limits-conf.md).

    
  
  * You have configured the sysctl.conf file. For more information, see [Configure the sysctl.conf file](/en-US/4.installation-and-deployment/9.optional-configure-sysctl-conf.md).

    
  
  * You have disabled the firewall and SELinux. For more information, see [Disable the firewall and SELinux](/en-US/4.installation-and-deployment/10.optional-disable-the-firewall-and-selinux.md).

    
  
  * You have created a user. For more information, see [Create a user](/en-US/4.installation-and-deployment/11.optional-create-a-user.md).
...
If the server does not have Internet access, you can download the OBD installation package from the official website of OceanBase Database. For more information, see [Download installation packages](/en-US/4.installation-and-deployment/2.instructions-for-downloading-the-installation-package.md). After you have downloaded the OBD installation package, copy it to your central control server. 
...
You need to install OBLibs on every target server.

### Install OBLibs online 

Run the following command to install OBLibs online:
...
### Install OBLibs offline 

If the server does not have Internet access, you can download the OBLibs installation package from the official website of OceanBase Database. For more information, see [Download installation packages](/en-US/4.installation-and-deployment/2.instructions-for-downloading-the-installation-package.md). After you have downloaded the OBLibs installation package, copy it to each of your servers. 

In Anolis 7, CentOS 7, or RedHat 7, run the following command to install OBLibs:
...
In Ubuntu or Debian 9, run the following command to install OBLibs:
...
In Anolis 8, CentOS 8, or RedHat 8, run the following command to install OBLibs:
...
In Debian 10, run the following command to install OBLibs:
...
You must first download LibOBClient, the dependencies package of the OBClient. For more information, see [Download installation packages](/en-US/4.installation-and-deployment/2.instructions-for-downloading-the-installation-package.md).
...
If the server does not have Internet access, you can download the OBClient installation package from the official website of OceanBase Database. For more information, see [Download installation packages](/en-US/4.installation-and-deployment/2.instructions-for-downloading-the-installation-package.md). After you have downloaded the OBClient installation package, copy it to your central control server. 
...
To ensure data security, we recommend that you switch to a non-root user before you install OceanBase Database and ODP. To install OceanBase Database and ODP, download the installation packages of OceanBase Database, OBLibs, and ODP from the official website of OceanBase Database. For more information, see [Download installation packages](/en-US/4.installation-and-deployment/2.instructions-for-downloading-the-installation-package.md). After you have downloaded the required installation packages, copy them to your central control server. If you install OceanBase Database and ODP online, skip Steps 1 to 3. 
...
* Create a user tenant by using SQL statements. For more information, see [Create a user tenant](/en-US/6.administrator-guide/3.basic-database-management/5.tenants/2.create-a-user-tenant.md).
