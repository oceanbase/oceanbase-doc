...
After you install OceanBase Database, you need to deploy it. For more information, see [Use OBD to deploy OceanBase Database](/en-US/2.quickstart/5.deploy-the-oceanbase-database-by-using-obd.md).
