...
* Your servers meet the software and hardware requirements. For more information, see [Software and hardware requirements](../../4.installation-and-deployment/2.local-deployment/1.requirements-for-software-and-hardware.md). 

* In the production environment, you have checked the environment and configurations. For more information, see [Check the environment and configurations](../../4.installation-and-deployment/2.local-deployment/2.environment-and-configuration-checks.md).
