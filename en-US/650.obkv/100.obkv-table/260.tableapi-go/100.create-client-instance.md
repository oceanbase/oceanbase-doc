...
* Created an OBKV-Table data table.
<!-- * For detailed instructions on creating an OBKV-Table data table, refer to [OBKV-Table data models](../100.introduction-to-tableapi/300.tableapi-data-models.md). -->
