|description||
|---|---|
|slug|introduction-to-the-client-and-instructions-of-use|
...
Log in to the [obkv-table-client-java repository](https://github.com/oceanbase/obkv-table-client-java), download the latest client, and add it to the pom.xml file.
...
* For more information about how to use the client, see the following views:
    * [GV$OB_KV_CLIENT_INFO](../../../700.reference/700.system-views/300.system-view-of-sys-tenant/300.performance-view-of-sys-tenant/7000.gv-ob_kv_client_info-of-sys-tenant.md) in the SYS tenant
    * [V$OB_KV_CLIENT_INFO](../../../700.reference/700.system-views/300.system-view-of-sys-tenant/300.performance-view-of-sys-tenant/40100.v-ob_kv_client_info-of-sys-tenant.md) in the SYS tenant
    * [GV$OB_KV_CLIENT_INFO](../../../700.reference/700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/6800.gv-ob_kv_client_info-of-mysql-mode.md) in the MySQL tenant
    * [V$OB_KV_CLIENT_INFO](../../../700.reference/700.system-views/400.system-view-of-mysql-mode/300.performance-view-of-mysql-mode/37600.v-ob_kv_client_info-of-mysql-mode.md) in the MySQL tenant