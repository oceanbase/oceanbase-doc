|description||
|---|---|
|slug|connect-cluster-using-obkv-hbase-client|
...
```
-- Create a table group named htable1.
CREATE TABLEGROUP htable1;

-- Create a test table named htable1$family1 and bind it to the table group htable1.
