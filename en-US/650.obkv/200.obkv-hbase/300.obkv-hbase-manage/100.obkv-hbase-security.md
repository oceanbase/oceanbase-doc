...
* After a TCP connection is established, the first message is a login message. This message carries login information such as the cluster name, tenant name, username, password, and salt value.
...
* For more information about the concept of transparent data encryption, see [Overview of database transparent encryption](../../../600.manage/500.security-and-permissions/500.data-storage-encryption/100.datastore-encryption-overview.md).
