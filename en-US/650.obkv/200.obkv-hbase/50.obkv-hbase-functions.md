...
| Filters | <ul><li>CompareFilter, SingleColumnValueFilter, PageFilter, ColumnCountGetFilter, PrefixFilter, SkipFilter, WhileMatchFilter, and ColumnPaginationFilter are supported.</li><li>Multiple filters can be combined based on FilterList.</li></ul> |
