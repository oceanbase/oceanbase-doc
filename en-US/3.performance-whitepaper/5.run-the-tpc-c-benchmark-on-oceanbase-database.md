...
* Tenant specifications
  ...
  * The preceding tenant specifications are provided based on the [OceanBase TPC-C benchmark report](/en-US/3.performance-whitepaper/6.tpc-c-benchmark-report-of-oceanbase-database.md). You need to adjust the specifications based on your hardware configuration. For more information, see [Modify a tenant](/en-US/6.administrator-guide/3.basic-database-management/5.tenant-management/5.modify-a-tenant.md).
...
For more information about the test result, see [OceanBase TPC-C benchmark report](/en-US/3.performance-whitepaper/6.tpc-c-benchmark-report-of-oceanbase-database.md).
