...
* TPC-H tools: Download from the [TPC-H Tools Download](http://tpc.org/tpc_documents_current_versions/download_programs/tools-download-request5.asp?bm_type=TPC-H&bm_vers=3.0.0&mode=CURRENT-ONLY) page
...
* OceanBase Database: For more information, see [Quick Start](/en-US/2.quick-start/1.overview-of-quick-start.md).
...
Download TPC-H tools. For more information, visit the [TPC-H Tools Download](http://tpc.org/tpc_documents_current_versions/download_programs/tools-download-request5.asp?bm_type=TPC-H&bm_vers=3.0.0&mode=CURRENT-ONLY) page. 
...
For more information about the test result, see [OceanBase TPC-H benchmark report](/en-US/3.performance-whitepaper/2.tpc-h-benchmark-report-of-oceanbase-database.md).
