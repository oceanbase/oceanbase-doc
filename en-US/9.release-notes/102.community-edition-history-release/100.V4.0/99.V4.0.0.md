...
<!-- For more information about the views, see [System views (MySQL mode)](../../../7.reference/5.system-reference/4.system-view-of-mysql-mode/1.overview-of-mysql-mode.md) and [System views (Oracle mode）](../../../7.reference/5.system-reference/5.system-view-of-oracle-mode/1.overview-of-oracle-mode.md) -->
