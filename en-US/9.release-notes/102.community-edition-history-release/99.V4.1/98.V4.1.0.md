...
* SQL statement-level resource isolation is supported.
   ...
   <!-- For more information, see [Configure SQL statement-level resource isolation (Oracle mode)](../../../6.manage/2.tenant-management/6.common-tenant-operations/3.resource-isolation/2.resource-isolation-of-oracle-mode/3.resource-isolation-at-sql-level-of-oracle-mode.md) and [Configure SQL statement-level resource isolation (MySQL mode)](../../../7.reference/2.administrator-guide/7.management/1.1.resource-isolation/3.resource-isolation-of-mysql-mode/3.resource-isolation-at-sql-level-of-mysql-mode.md). -->
...
* Tenant-level IOPS isolation is supported.
   ...
   <!-- For more information, see [Resource isolation](../../../6.manage/2.tenant-management/6.common-tenant-operations/3.resource-isolation/1.resource-isolation-overview.md). -->
...
* GIS data types are supported.
   ...
   <!-- For more information, see [Spatial data types](../../../7.reference/4.development-reference/1.sql-syntax/2.common-tenant-of-mysql-mode/1.basic-elements-of-mysql-mode/1.data-type-of-mysql-mode/9.spatial-data-type-of-mysql-mode/1.spatial-data-type-overview-of-mysql-mode.md). -->
...
* The data import performance is improved.
   ...
   <!-- For more information, see [Overview of bypass import](../../../5.data-migration/11.bypass-import/1.overview-of-bypass-import.md). -->
...
* Primary and standby tenants based on archived logs are supported.
   ...
   <!-- For more information, see [Overview of physical standby databases](../../../6.manage/4.high-availability/3.physical-standby-database-disaster-recovery/1.physical-standby-database-overview.md). -->
...
<!-- For more information, see [System views](../../../7.reference/5.system-reference/4.system-overview-of-mysql-mode/1.overview-of-mysql-mode.md). -->
