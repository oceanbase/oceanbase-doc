...
* Tenant-level IOPS isolation is supported.
   ...
   <!-- For more information, see [Resource isolation](../../../7.reference/2.administrator-guide/7.management/1.1.resource-isolation/1.resource-isolation-overview.md). -->
...
<!-- For more information, see [System views](../../../7.reference/5.system-reference/4.system-view-of-mysql-mode/1.overview-of-mysql-mode.md). -->
