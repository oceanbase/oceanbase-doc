...
- Addition of the DBMS_SCHEDULER system package
   ...
   The DBMS_SCHEDULER system package is added for managing scheduled tasks. More functions are supported, such as CREATE_JOB, CREATE_PROGRAM, and DEFINE_PROGRAM_ARGUMENT. <!--For more information, see [Overview](https://www.oceanbase.com/docs/enterprise-oceanbase-database-cn-10000000000945869).中文断链-->
