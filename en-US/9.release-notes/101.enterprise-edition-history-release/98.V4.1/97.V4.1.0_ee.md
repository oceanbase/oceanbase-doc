...
* Optimized tenant-level IOPS isolation
   ...
   <!--and [Configure SQL statement-level resource isolation (MySQL mode)](../../../7.reference/2.administrator-guide/7.management/1.1.resource-isolation/3.resource-isolation-of-mysql-mode/3.resource-isolation-at-sql-level-of-mysql-mode.md).-->
