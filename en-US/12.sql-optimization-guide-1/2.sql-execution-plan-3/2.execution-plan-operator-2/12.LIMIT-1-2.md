...
This scenario is described in the topic of the `COUNT` operator. For more information, see [COUNT](/en-US/12.sql-optimization-guide-1/2.sql-execution-plan-3/2.execution-plan-operator-2/4.COUNT-1-2-3-4.md).
