...
For more information about parameters of views, see [Plan cache-related views](/en-US/12.sql-optimization-guide-1/4.sql-optimization-1/3.monitor-sql-execution-performance-1/3.plan-cache-view.md).
