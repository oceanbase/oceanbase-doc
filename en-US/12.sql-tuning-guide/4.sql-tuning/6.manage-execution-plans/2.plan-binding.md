...
* A hint is specified in the `/*+ xxx */` format. For more information about hints, see [Optimizer hints.](/en-US/12.sql-tuning-guide/4.sql-tuning/6.manage-execution-plans/1.optimizer-hints.md)
...
3. Verify whether the execution plan meets expectations. 
   ...
   [Real-time execution plan display](/en-US/12.sql-tuning-guide/2.sql-execution-plan/5.real-time-execution-plan-display.md). 
