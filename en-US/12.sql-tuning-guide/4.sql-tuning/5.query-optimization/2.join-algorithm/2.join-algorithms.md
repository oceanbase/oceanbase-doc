...
* Index Nested Loop Join
  ...
  *************************** 1. row ***************************
  ...
  In the `Outputs & filters` section, parameter `[t2.c1]` of `nl_param` indicates the execution of conditional pushdown optimization. For more information, see [JOIN](/en-US/12.sql-tuning-guide/2.sql-execution-plan/2.execution-plan-operators/3.join.md). 
