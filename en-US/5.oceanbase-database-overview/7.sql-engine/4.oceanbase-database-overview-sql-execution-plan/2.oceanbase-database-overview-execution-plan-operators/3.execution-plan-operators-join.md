...
The MATERIAL operator materializes the data output of subsequent operators. For more information, see [MATERIAL](../../../../12.sql-tuning-guide/2.sql-execution-plan/2.execution-plan-operators/10.material.md).
