...
This scenario is described in the topic of the `COUNT` operator. For more information, see [COUNT](../../../../12.sql-tuning-guide/2.sql-execution-plan/2.execution-plan-operators/4.count.md).
