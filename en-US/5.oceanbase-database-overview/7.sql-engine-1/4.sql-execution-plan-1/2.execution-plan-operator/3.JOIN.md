...
The MATERIAL operator materializes the data output of subsequent operators. For more information, see [MATERIAL](/en-US/12.sql-optimization-guide-1/2.sql-execution-plan-3/2.execution-plan-operator-2/10.MATERIAL-1-2.md). 
