...
The `PX PARTITION ITERATO` operator iterates data at the partition level. For more information, see [GI](/en-US/12.sql-optimization-guide-1/2.sql-execution-plan-3/2.execution-plan-operator-2/24.GI-1-2.md). 
