...
For more information on the syntax of the `UPDATE` statement, see the "[UPDATE](../../1100.sql-reference-en/500.sql-statements/5900.sql-statements-update.md)" topic in SQL Reference.
