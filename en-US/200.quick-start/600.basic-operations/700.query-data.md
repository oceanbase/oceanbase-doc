...
3. Return the values of the corresponding `id`, `name`, and `num` fields based on the filtering condition `name = 'a'` from Table `a`. 
   ...
   For more information on the syntax of the `SELECT` statement, see the "[SELECT](../../1100.sql-reference-en/500.sql-statements/5200.select.md)" topic in SQL Reference.
