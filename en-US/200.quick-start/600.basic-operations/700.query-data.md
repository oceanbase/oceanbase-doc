...
3. Return the values of the corresponding `id`, `name`, and `num` fields based on the filtering condition `name = 'a'` from Table `a`. 
   ...
   For more information on the syntax of the `SELECT` statement, see the "[SELECT](../../1300.reference-guide/200.system-variables/5900.ob_enable_index_direct_select.md)" topic in SQL Reference.
