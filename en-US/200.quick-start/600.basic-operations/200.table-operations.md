...
For more information on the syntax of the `CREATE TABLE` statement, see the "[CREATE TABLE](../../11.sql-reference-en/5.sql-statements/17.create-table.md)" topic in SQL Reference.
...
For more information on the syntax of the `ALTER TABLE` statement, see the "[ALTER TABLE](../../11.sql-reference-en/5.sql-statements/7.alter-table.md)" topic in SQL Reference.
...
For more information on the syntax of the `DROP TABLE` statement, see the "[DROP TABLE](../../11.sql-reference-en/5.sql-statements/29.drop-table.md)" topic in SQL Reference.
