...
2. If necessary, you can retain the existing row and change the data in the column whose id = 3.
   ...
   > **Note**
   >
   > * You can also use the `MERGE INTO` statement to avoid unique key conflicts. For more information, see [About the MERGE statement](../../500.about-DML-statements-and-transactions/0100.DML-statements/0400.About-MERGE-statements.md)
   > * If you confirm that the existing row is not needed, you can delete it. For more information, see [DELETE](../../500.about-DML-statements-and-transactions/0100.DML-statements/0500.About-DELETE-statements.md).
