...
An aggregate function scans a set of records and then returns a single row. This set of records can be a table or a view, or results of a subquery. For more information about the aggregate functions supported by OceanBase, see SQL Reference (Oracle Mode).
