...
For information about how to create partitioned tables, see [Create a partitioned table](../0700.Create-and-manage-partition-tables/0200.create-a-level-1-partition-table.md).
...
In the preceding examples, two tables are created. Some constraints, including the primary and foreign keys, are defined on different columns. For more information about primary keys and foreign keys, see [About types of column constraints](../0600.Create-and-manage-tables/0400.about-constraint-types-of-columns.md).
