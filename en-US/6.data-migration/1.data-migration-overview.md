...
* Migrate from csv files to OceanBase
  ...
  * [Use the LOAD DATA statement to load CSV data files to OceanBase Database](../4.data-migration/4.%20migrate-data-from-CSV-file-to-OceanBase-database/11.use-the-LOAD-command-to-load-the-CSV-data-file-into-the-OceanBase-database.md)

* [Migrate data from SQL files to OceanBase Database](../4.data-migration/5.%20migrate-data-from-SQL-files-to-OceanBase-database.md)

* [Migrate data and resource units between tables](../4.data-migration/6.%20data-migration-between-tables-and-migration-of-resource-units.md)

* Migrate from OceanBase to MySQL
  
  * [Use Canal to synchronize OceanBase Database data to MySQL in real time](7.migrate-data-from-OceanBase-database-to-MySQL/1.use-Canal-to-migrate-data-from-OceanBase-database-to-MySQL-database.md)
