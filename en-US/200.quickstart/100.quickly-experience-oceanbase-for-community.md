...
* OCP Express
  ...
  OCP Express is a web-based management tool for OceanBase Database V4.x. It is integrated with OceanBase clusters and allows you to view key performance metrics of the clusters and perform basic database management operations on the clusters. For more information, see OCP Express <temp-hide-link>.
