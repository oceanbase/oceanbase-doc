...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>This method is not suitable for production environments. If you want to deploy OceanBase Database in a production environment, follow the steps in <b>Solution 2: Deploy OceanBase Database in a production environment</b>. </p>
</main>
...
Here are three methods you can use to quickly get started with OceanBase Database.
