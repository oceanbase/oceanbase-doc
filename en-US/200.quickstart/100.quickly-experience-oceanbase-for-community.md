...
<main id="notice" type='notice'>
  ...
  <ul>
  <li>
  <p>The deployment solutions outlined in this topic are only suitable for quick hands-on with OceanBase Database and are not intended for use in production environments. To deploy OceanBase Database in a production environment, refer to <a href="../400.deploy/100.deploy-overview.md">Deployment overview</a>. </p>
  </li>
  <li>
...
* Solution 1: Deploy OceanBase Database in a demo environment
   ...
   If you have only one server, you can quickly build a demo environment to deploy OceanBase Database. The demo environment provides basic features for you to quickly learn about OceanBase Database, but does not support distributed capabilities or high availability. Therefore, long-term use is not recommended. For more information, see the **Solution 1: Deploy OceanBase Database in a demo environment** section below.
