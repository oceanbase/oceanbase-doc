...
<main id="notice" type='explain'>
  ...
  <li><p>The following operating systems are supported when installing OceanBase Database using this method:</p><ul><li>Anolis OS 8.X (Linux kernel 4.19 or later)</li><li>CentOS Linux 7.X and 8.X (Linux kernel 4.19 or later)</li><li>Debian 10, 11, and 12 (Linux kernel 4.19 or later)</li><li>openEuler 22.03 and 24.03 (Linux kernel 5.10.0 or later)</li><li>Ubuntu 18.04, 20.04, and 22.04 (Linux kernel 4.19 or later)</li></ul></li>
  </ul>
</main>
...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>On an x86-based Mac server, you can deploy OceanBase Database only in a Docker container running Docker V4.9.0 or earlier. You can click <a href="https://desktop.docker.com/mac/main/amd64/81317/Docker.dmg?_gl=17jelfd_gcl_auOTk5Nzk0MDUwLjE3MTE4ODMyNzM._gaNDQyMjE1MDE5LjE3MTE4ODMyNzQ._ga_XJWPQMJYHQ*MTcxOTIxOTEwMy4xMS4xLjE3MTkyMjEwMTAuNjAuMC4w">here</a> to download Docker.</p>
</main>
