...
* OCP Express
   ...
   <!-- For more information, see [OCP Express](../700.reference/1400.oceanbase-tools/400.1.ocp-express/100.ocp-express.md).  -->
...
* OBAgent
   ...
   For more information, see [OBAgent](../700.reference/1500.command-line-tools/900.ob-agent/100.about-obagent/100.what-is-obagent.md). 
...
2. Run the connection command in the output to connect to the database.
   ...
   * Connect to the database in proxy mode through ODP
   ...
   For detailed instructions on how to connect to an OceanBase cluster using the OBClient client, see [Connect to an OceanBase Database tenant by using OBClient](../300.develop/100.application-development-of-mysql-mode/100.connect-to-oceanbase-database-of-mysql-mode/300.connect-to-an-oceanbase-tenant-by-using-obclient-of-mysql-mode.md). For more information about how to connect to OceanBase Database, see [Overview of connection methods](../300.develop/100.application-development-of-mysql-mode/100.connect-to-oceanbase-database-of-mysql-mode/100.connection-methods-overview-of-mysql-mode.md).
