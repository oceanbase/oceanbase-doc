...
For more information about the `UPDATE` statement, see [UPDATE](../../300.develop/200.application-development-of-oracle-mode/400.read-data-of-oracle-mode/800.use-operators-and-functions-in-query-for-oracle-mode/1000.lock-query-result-select-for-update-of-oracle-mode.md).
