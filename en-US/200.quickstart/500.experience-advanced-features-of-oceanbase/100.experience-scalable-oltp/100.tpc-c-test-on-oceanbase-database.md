...
In this example, the tenant mode is MySQL and the tenant name is test. You can create a tenant. For more information, see [Experience the multitenancy feature](../400.experience-multi-tenant-features.md).
