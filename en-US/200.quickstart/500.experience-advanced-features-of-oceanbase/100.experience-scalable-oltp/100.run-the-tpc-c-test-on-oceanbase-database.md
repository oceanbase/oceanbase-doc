...
For more information about how to use OBD for one-click testing and manually conducting TPC-C tests, see [Run the TPC-C benchmark on OceanBase Database](../../../700.reference/1100.performance-test/500.run-the-tpc-c-benchmark-on-oceanbase-database.md).