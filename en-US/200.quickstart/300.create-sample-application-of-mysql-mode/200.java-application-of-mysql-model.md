...
OceanBase Database supports connection via the official MySQL JDBC driver. This topic describes how to connect to and use OceanBase Database through MySQL Connector/J.
...
* You have installed MySQL Connector/J and configured the operating environment.
   ...
   We recommend that you use MySQL Connector/J 5.1.47. For more information about how to download and install MySQL Connector/J, see [Connector/J Downloads](https://downloads.mysql.com/archives/c-j/) and [Connector/J Installation](https://dev.mysql.com/doc/connector-j/en/connector-j-installing.html).
...
After the compilation is completed, run `Test`:
...
* For a complete sample of creating a Java application in the OceanBase open-source community, see [Java sample application](https://github.com/oceanbase/ob-samples/tree/master/java/mysql-connector-java).
* For a detailed example of connecting to OceanBase Database through Connector/J, see [Connect to OceanBase Database by using MySQL Connector/J](../../300.develop/100.application-development-of-mysql-mode/200.sample-program-of-mysql-mode/100.java-of-mysql-mode/1400.connect-to-the-oceanbase-database-through-mysql-connectorJ-of-mysql-mode.md).
