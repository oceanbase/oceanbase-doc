...
|---|---|
|machine-translation||
|slug|v$ob_kv_group_commit_status-of-mysql-mode|
...
The `V$OB_KV_GROUP_COMMIT_STATUS` view displays the group commit status of client connections in the current OBKV tenant on the current OBServer node. You can query this view from a MySQL tenant.
