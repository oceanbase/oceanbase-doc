...
|machine-translation||
|slug|v$ob_opt_stat_gather_monitor-v_ob_opt_stat_gather_monitor-of-mysql-mode|
...
<!-- * To view the collection status of tenant-level historical statistics, see

* To view the collection status of table-level historical statistics, see  -->
