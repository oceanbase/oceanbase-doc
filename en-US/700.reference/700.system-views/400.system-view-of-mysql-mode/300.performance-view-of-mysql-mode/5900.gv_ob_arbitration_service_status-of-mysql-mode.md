...
The `GV$OB_ARBITRATION_SERVICE_STATUS` view displays the communication status between the arbitration service and nodes in the tenant.
...
* To view the arbitration members of the current tenant, see [GV$OB_ARBITRATION_MEMBER_INFO](5800.gv_ob_arbitration_member_info-of-mysql-mode.md).
