...
Displays information about the dynamic partitioning of the current tenant. The view reads the attributes of dynamic partitioned tables from the memory and has better read performance.
