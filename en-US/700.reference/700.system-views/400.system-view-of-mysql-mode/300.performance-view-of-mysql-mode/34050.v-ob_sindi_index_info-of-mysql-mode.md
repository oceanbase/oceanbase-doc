...
This view displays the basic information and real-time status of SINDI and SINDI_SQ vector indexes on the current OBServer node.
...
Query the real-time status of SINDI and SINDI_SQ vector indexes on the current OBServer node in the user tenant.
