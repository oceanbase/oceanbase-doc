...
| OTHERSTAT_3_VALUE       | bigint(20)           | NO | For the TABLE SCAN operator, the number of rows read from the storage `SSSTORE_READ_ROW_COUNT`, which supports real-time statistics. <main id="notice" type='explain'><h4>Note</h4><ul><li>Starting from V4.3.3 BP1 of V4.3.x, the TABLE SCAN operator supports real-time statistics, instead of statistics after the operator finishes computation. </li><li>Starting from V4.2.4 of V4.2.x, the TABLE SCAN operator supports real-time statistics, instead of statistics after the operator finishes computation. </li></ul></main> |
| OTHERSTAT_4_ID          | bigint(20)           | NO | The ID of the field. |
| OTHERSTAT_4_TYPE        | bigint(0) unsigned   | NO | Reserved. |
| OTHERSTAT_4_VALUE       | bigint(20)           | NO | For the TABLE SCAN operator, the number of rows read from the storage `MEMSTORE_READ_ROW_COUNT`, which supports real-time statistics. |
