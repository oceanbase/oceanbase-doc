...
|machine-translation||
|slug|gv$sql_plan_monitor-gv-sql_plan_monitor-of-mysql-mode|
...
| PHYSICAL_READ_BYTES     | bigint(0) unsigned   | NO | The total number of bytes that the operator requested to read. |
