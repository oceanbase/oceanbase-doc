...
<h4>Note</h4>
<p>For V4.2.x, this view is no longer available starting with V4.2.5. For information about lock diagnostics, see the </p>
</main> -->

## Purpose

This view displays the latch information on all OBServer nodes in the cluster.
...
| MISSES | bigint(20) | NO | The number of times the lock operation entered the waiting state. |
