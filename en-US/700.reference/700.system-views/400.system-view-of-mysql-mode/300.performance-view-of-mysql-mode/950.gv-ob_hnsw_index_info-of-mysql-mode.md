...
| TENANT_ID                    | bigint(20)   | NO             | The tenant ID:<ul><li>1: the ID of the sys tenant</li> <li>Other values: the ID of a user tenant or the ID of a meta tenant</li></ul>                                                    | Basic information |
...
| TABLE_NAME                   | varchar(512) | YES             | The name of the table.                                                    | Basic information |
| INDEX_NAME                   | varchar(512) | YES             | The name of the index.                                                    | Index information |
...
| INDEX_PARAM                  | longtext     | NO             | The parameters of the index.                                                    | Index information |
| MEMORY_USED                  | bigint(20)   | NO             | The memory used.                                                    | Index information |
| MEMORY_HOLD                  | bigint(20)   | NO             | The memory occupied.                                                    | Index information |
| INCR_MEM_HOLD                | bigint(20)   | NO             | The increment in memory occupied.                                                    | Index information |
| SNAP_MEM_HOLD                | bigint(20)   | NO             | The memory occupied by the snapshot.                                                    | Index information |
...
* For more information about HNSW vector indexes, baseline segments, incremental segments, and DML and query processes, see [Vector index principles](../../../100.oceanbase-database-concepts/400.database-objects/200.database-objects-of-mysql-mode/300.index-of-mysql-mode/330.vector-indexes-of-mysql-mode-in-concepts.md).