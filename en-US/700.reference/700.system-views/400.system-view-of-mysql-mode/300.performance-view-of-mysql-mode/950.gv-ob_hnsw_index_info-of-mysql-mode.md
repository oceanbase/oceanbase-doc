...
This view displays the basic information and real-time status of HNSW vector indexes for the current tenant on all OBServer nodes.
...
Query the real-time status of HNSW vector indexes for the current tenant on all OBServer nodes.
