...
| TENANT_ID                    | bigint(20)   | NO             | The tenant ID. <ul><li>1: the system tenant ID.</li> <li>Other values: the ID of a user tenant or a Meta tenant.</li></ul>                                                    | Basic information |
...
| INCR_MEM_HOLD                | bigint(20)   | NO             | The incrementally occupied memory.                                                    | Index information |
| SNAP_MEM_HOLD                | bigint(20)   | NO             | The snapshot memory occupied.                                                    | Index information |
| INCR_VECTOR_CNT               | bigint(20)   | NO             | The number of incrementally added vectors.                                                    | Index information |
