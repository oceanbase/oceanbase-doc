...
The `GV$OB_SQLSTAT` view displays basic performance statistics of SQL statements in the cluster. Each SQL statement corresponds to a row (i.e., each unique combination of `SQL_ID` and `Plan_Hash` is a row). The lists with `_DELTA` in their names indicate the incremental statistics from the last WR snapshot collection to the current time.
...
| PLAN_TYPE                     | bigint(20)          | NO   |    The type of the execution plan. The value is `1` for a local plan, `2` for a remote plan, and `3` for a distributed plan. </br>For PL object caching, the value indicates the type of the PL object. The value is `1` for a procedure, `2` for a function, `3` for a package, and `4` for an anonymous block. |
| QUERY_SQL                     | longtext            | NO   | The full text of the SQL statement. |
| SQL_TYPE                      | bigint(20)          | NO   | The type of the statement. |
| MODULE                        | varchar(64)         | YES  |   The module of the application that first parsed the statement.    |
| ACTION                        | varchar(64)         | YES  |   The action of the application that first parsed the statement.      |
...
| WRITE_THROTTLE_TOTAL          | bigint(20)          | NO   |   The total time during which the write to the MemStore was throttled.    |
| WRITE_THROTTLE_DELTA          | bigint(20)          | NO   |   The incremental time during which the write to the MemStore was throttled.    |
...
| ROUTE_MISS_TOTAL              | bigint(20)          | NO   |   The total number of times that the request partition is not hit since the OBServer started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.2. </li></ul></main>   |
| ROUTE_MISS_DELTA              | bigint(20)          | NO   |   The number of times that the request partition is not hit since the last WR snapshot collection.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.2. </li></ul></main>   |
...
| PLAN_CACHE_HIT_TOTAL          | bigint(20)          | NO   |   The total number of times that the Plan Cache is hit since the OBServer started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.5. </li></ul></main>   |
| PLAN_CACHE_HIT_DELTA          | bigint(20)          | NO   |   The number of times that the Plan Cache is hit since the last WR snapshot collection.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.5. </li></ul></main>  |
...
| MUTI_QUERY_DELTA              | bigint(20)        | NO   | The number of times that the SQL statement is in a Multi Query since the last WR snapshot collection.<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this field is available starting with V4.4.2. </p></main>|
...
| FULL_TABLE_SCAN_TOTAL         | bigint(20)        | NO   | The number of times the SQL has performed a full table scan since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x. </p></main>|
| FULL_TABLE_SCAN_DELTA         | bigint(20)        | NO   | The number of times the SQL has performed a full table scan since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x. </p></main>|
| ERROR_COUNT_TOTAL             | bigint(20)        | NO   | The number of errors that have occurred in the SQL since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x. </p></main>|
| ERROR_COUNT_DELTA             | bigint(20)        | NO   | The number of errors that have occurred in the SQL since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x. </p></main>|
