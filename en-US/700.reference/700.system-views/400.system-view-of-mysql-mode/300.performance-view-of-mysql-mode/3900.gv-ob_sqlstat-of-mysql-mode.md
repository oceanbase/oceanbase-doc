...
The `GV$OB_SQLSTAT` view displays the basic performance statistics of SQL statements in the cluster. Each row in the view corresponds to an SQL statement (i.e., each unique combination of `SQL_ID` and `Plan_Hash`). The columns with `_DELTA` in their names indicate the incremental statistics from the last WR snapshot collection to the current time.
...
| MODULE                        | varchar(64)         | YES  |   The application module that first parsed the statement.    |
| ACTION                        | varchar(64)         | YES  |   The application action that first parsed the statement.      |
| PARSING_DB_ID                 | bigint(20)          | NO   |   The ID of the database in which the statement was parsed.    |
| PARSING_DB_NAME               | varchar(128)        | NO   |   The name of the database in which the statement was parsed.     |
| PARSING_USER_ID               | bigint(20)          | NO   |   The ID of the user who parsed the statement.     |
| EXECUTIONS_TOTAL              | bigint(20)          | NO   |   The total number of times the execution plan was executed in the plan cache.     |
| EXECUTIONS_DELTA              | bigint(20)          | NO   |   The incremental number of times the execution plan was executed in the plan cache.      |
...
| ROUTE_MISS_TOTAL              | bigint(20)          | NO   |   The total number of times that the request partition was not hit since the OBServer started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this column is available starting with V4.3.5. </li> <li>For V4.2.x, this column is available starting with V4.2.2. </li></ul></main>   |
| ROUTE_MISS_DELTA              | bigint(20)          | NO   |   The number of times that the request partition was not hit since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this column is available starting with V4.3.5. </li> <li>For V4.2.x, this column is available starting with V4.2.2. </li></ul></main>   |
...
| PLAN_CACHE_HIT_TOTAL          | bigint(20)          | NO   |   The total number of times that the Plan Cache was hit since the OBServer started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this column is available starting with V4.3.5. </li> <li>For V4.2.x, this column is available starting with V4.2.5. </li></ul></main>   |
...
| MUTI_QUERY_TOTAL              | bigint(20)        | NO   | The number of times that the SQL statement was in a Multi Query since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>For V4.6.x, this column is available starting with V4.6.0. </p></main>|
| MUTI_QUERY_DELTA              | bigint(20)        | NO   | The number of times that the SQL statement was in a Multi Query since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><p>For V4.6.x, this column is available starting with V4.6.0. </p></main>|
| MUTI_QUERY_BATCH_TOTAL        | bigint(20)        | NO   | The number of times that the SQL batch was executed since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>For V4.6.x, this column is available starting with V4.6.0. </p></main>|
| MUTI_QUERY_BATCH_DELTA        | bigint(20)        | NO   | The number of times the SQL batch has been executed since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 in V4.6.x. </p></main>|
| FULL_TABLE_SCAN_TOTAL         | bigint(20)        | NO   | The number of times the SQL has performed a full table scan since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 in V4.6.x. </p></main>|
| FULL_TABLE_SCAN_DELTA         | bigint(20)        | NO   | The number of times the SQL has performed a full table scan since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 in V4.6.x. </p></main>|
| ERROR_COUNT_TOTAL             | bigint(20)        | NO   | The number of times the SQL has reported an error since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 in V4.6.x. </p></main>|
| ERROR_COUNT_DELTA             | bigint(20)        | NO   | The number of times the SQL has reported an error since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 in V4.6.x. </p></main>|
| LATEST_ACTIVE_TIME            | TIMESTAMP(6)      | YES  | The last active time of the plan corresponding to the SQL ID and plan hash on a node.<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 in V4.6.x. </p></main> |

The values in the `SQL_TYPE` column and the corresponding statements are shown in the following table.
...
*************************** 1. row ***************************
 ...
 PHYSICAL_READ_REQUESTS_DELTA: 0
    ...
    PHYSICAL_READ_BYTES_DELTA: 0
         ...
         ROWS_PROCESSED_TOTAL: 1118
         ROWS_PROCESSED_DELTA: 0
     MEMSTORE_READ_ROWS_TOTAL: 1276
...
MAJOR_SSSTORE_READ_ROWS_DELTA: 0
             ...
             ROUTE_MISS_TOTAL: 0
             ROUTE_MISS_DELTA: 0
              FIRST_LOAD_TIME: 2026-02-24 18:12:04.119647
         PLAN_CACHE_HIT_TOTAL: 20
       ...
       MUTI_QUERY_BATCH_DELTA: 0
        ...
        FULL_TABLE_SCAN_DELTA: 0
            ERROR_COUNT_TOTAL: 0
            ERROR_COUNT_DELTA: 0
           LATEST_ACTIVE_TIME: 1970-01-01 08:00:00.000000
