...
The `GV$OB_SQLSTAT` view displays the basic performance statistics of SQL statements in the cluster. Each row corresponds to an SQL statement (i.e., each unique combination of `SQL_ID` and `Plan_Hash`). The columns with `_DELTA` in their names indicate the incremental values from the last WR snapshot collection to the current time.
...
| PLAN_TYPE                     | bigint(20)          | NO   |    For SQL plan caching, this column specifies the plan type:<ul><li>`1`: Local Plan </li> <li>`2`: Remote Plan</li> <li>`3`: Distributed Plan </li></ul> </br>For PL object caching, this column specifies the PL object type:<ul><li>`1`: Procedure</li> <li>`2`: Function</li> <li>`3`: Package</li> <li>`4`: Anonymous Block </li></ul> |
...
| USERIO_WAIT_DELTA             | bigint(20)          | NO   |   Incremental time consumed by I/O waits.      |
...
| ROUTE_MISS_TOTAL              | bigint(20)          | NO   |   The total number of times that the request partition is not hit since the OBServer was started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.2. </li></ul></main>   |
| ROUTE_MISS_DELTA              | bigint(20)          | NO   |   The number of times that the request partition is not hit since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.2. </li></ul></main>   |
...
| PLAN_CACHE_HIT_TOTAL          | bigint(20)          | NO   |   The total number of times that the Plan Cache was hit since the OBServer was started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.5. </li></ul></main>   |
| PLAN_CACHE_HIT_DELTA          | bigint(20)          | NO   |   The number of times that the Plan Cache was hit since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.5. </li></ul></main>  |
| MUTI_QUERY_TOTAL              | bigint(20)        | NO   | The number of times that the SQL statement is in a Multi Query since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this field is available starting with V4.4.2. </p></main>|
| MUTI_QUERY_DELTA              | bigint(20)        | NO   | The number of times that the SQL statement is in a Multi Query since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this field is available starting with V4.4.2. </p></main>|
| MUTI_QUERY_BATCH_TOTAL        | bigint(20)        | NO   | The number of times that the SQL batch is executed since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this field is available starting with V4.4.2. </p></main>|
| MUTI_QUERY_BATCH_DELTA        | bigint(20)        | NO   | The number of times the SQL batch has been executed since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x. </p></main>|
| FULL_TABLE_SCAN_TOTAL         | bigint(20)        | NO   | The number of full table scans performed by the SQL since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x. </p></main>|
| FULL_TABLE_SCAN_DELTA         | bigint(20)        | NO   | The number of full table scans performed by the SQL since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x. </p></main>|
| ERROR_COUNT_TOTAL             | bigint(20)        | NO   | The number of errors reported by the SQL since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x. </p></main>|
| ERROR_COUNT_DELTA             | bigint(20)        | NO   | The number of errors reported by the SQL since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x. </p></main>|
| LATEST_ACTIVE_TIME            | timestamp(6)      | YES  | The last active time of the plan corresponding to the SQL ID + plan hash on a node. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x. </p></main>     |
...
The following example shows how to query the basic performance statistics of SQL statements in a cluster and display the first record.
...
*************************** 1. row ***************************
                     ...
                     SVR_PORT: 2882
                    TENANT_ID: 1002
                       SQL_ID: A365D89FFBC5E1CA7906428B6C8F5893
                      PLAN_ID: 0
                    PLAN_HASH: 16278462444976714640
                    PLAN_TYPE: 0
                    QUERY_SQL:
                     SQL_TYPE: 0
                       MODULE: NULL
 ...
 PHYSICAL_READ_REQUESTS_DELTA: 0
    ...
    PHYSICAL_READ_BYTES_DELTA: 0
         ...
         ROWS_PROCESSED_TOTAL: 1115
         ROWS_PROCESSED_DELTA: 0
     MEMSTORE_READ_ROWS_TOTAL: 2396
...
MAJOR_SSSTORE_READ_ROWS_DELTA: 0
             ...
             ROUTE_MISS_TOTAL: 0
             ROUTE_MISS_DELTA: 0
              FIRST_LOAD_TIME: 2026-01-26 18:28:37.219665
         PLAN_CACHE_HIT_TOTAL: 16
       ...
       MUTI_QUERY_BATCH_DELTA: 0
        ...
        FULL_TABLE_SCAN_DELTA: 0
            ERROR_COUNT_TOTAL: 0
            ERROR_COUNT_DELTA: 0
           LATEST_ACTIVE_TIME: 2026-01-27 04:48:41.872044
