...
| TYPE                  | bigint(20)          | NO         | For SQL plans, this field indicates the plan type:  <ul><li> 1: Local Plan  </li><li> 2: Remote Plan </li><li>3: Distribute Plan  </li></ul>For PL objects, this field indicates the type of the PL object:<ul><li> 1: Procedure    </li><li> 2: Function </li><li>3: Package  </li><li> 4: Anonymous Block   </li></ul>  |
...
| PS_STMT_ID           | bigint(20) | NO | The Prepare ID corresponding to the request. The value can be one of the following: <ul><li> -1: the SQL statement did not use the PS protocol.   </li><li> Other values: the SQL statement used the PS protocol. The value is the unique identifier returned by the PS protocol for the statement.  </li></ul> |
| SESSID               | bigint(20) unsigned | NO | The session ID of the cache object. <br> For V4.3.x: <ul><li> Versions earlier than V4.3.5 BP2: <br> This field indicates the server session ID for all connection modes (direct mode and ODP mode). </li><li> V4.3.5 BP2 and later versions: <ul><li> Direct mode: <br> This field indicates the server session ID. </li> <li> ODP mode: </li><ul><li> If the configuration item <code>client_session_id_version = 2</code> is set in ODP, this field indicates the client session ID. </li> <li> If <code>client_session_id_version = 1</code> is set, this field indicates the server session ID. </li></ul></ul></li></ul> |
...
| CACHE_NODE_ID        | bigint(20) | NO | The ID of the cache node where the object is located. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.6.0. </p></main>|
| PCV_ID               | bigint(20) | NO | The ID of the plan cache value node where the object is located. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.6.0. </p></main>|
| PLAN_SET_ID          | bigint(20) | NO | The ID of the plan set node where the object is located. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.6.0. </p></main>|
