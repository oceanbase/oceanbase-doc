...
| CACHE_NODE_ID           | bigint(20)        | NO         | The ID of the cache node to which the object belongs. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.4.2 BP2 for V4.4.2. </p></main>|
| PCV_ID                  | bigint(20)        | NO         | The ID of the plan cache value node to which the object belongs. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.4.2 BP2 for V4.4.2. </p></main>|
| PLAN_SET_ID             | bigint(20)        | NO         | The ID of the plan set node to which the object belongs. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.4.2 BP2 for V4.4.2. </p></main>|
| CREATE_reason           | varchar(4096)     | NO         | The reason why the current plan was added. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.4.2 BP2 for V4.4.2. </p></main>|
