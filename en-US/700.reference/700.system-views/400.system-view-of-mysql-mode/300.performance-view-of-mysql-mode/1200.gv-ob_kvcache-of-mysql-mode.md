...
This view displays the KVcache information of the current tenant on each OBServer node.
...
Query the KVcache information of the current tenant on each OBServer node.
