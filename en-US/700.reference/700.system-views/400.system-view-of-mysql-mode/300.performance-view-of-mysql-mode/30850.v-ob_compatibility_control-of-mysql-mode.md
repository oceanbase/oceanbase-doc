...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <ul><li>In V4.3.x, this view is available starting with V4.3.2. </li><li>In V4.2.x, this view is available starting with V4.2.3. </li></ul>
</main>
...
<main id="notice">
  <h4>Applicability</h4>
  <p>This view is applicable only to OceanBase Database in MySQL-compatible mode. </p>
</main>
...
| ENABLE_VERSIONS | longtext | NO | The range of versions in which the feature is enabled. This value is a series of intervals, for example: [4.2.3.1, 4.3.0.0), [4.3.1.0, +∞). |
