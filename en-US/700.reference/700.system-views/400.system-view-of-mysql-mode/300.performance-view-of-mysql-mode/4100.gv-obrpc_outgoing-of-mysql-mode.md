...
Displays the RPC sending statistics of the current tenant across all OBServer nodes.
...
In the user tenant, view the RPC requests sent by this tenant across all nodes, displaying the first 10 records.
...
* View statistics of RPCs received by the current tenant on all nodes: [GV$OB_RPC_INCOMING](4000.gv-obrpc_incoming-of-mysql-mode.md)
