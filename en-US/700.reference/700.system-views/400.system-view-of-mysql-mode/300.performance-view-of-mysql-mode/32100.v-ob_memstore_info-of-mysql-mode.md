...
|slug|v-ob_memstore_info-mysql-mode|

# V$OB_MEMSTORE_INFO

<main id="notice" type='explain'>
<h4>Note</h4>
<p>The view <code>V$MEMSTORE_INFO</code> was renamed to <code>V$OB_MEMSTORE_INFO</code> starting from V4.0.0. In V4.0.0 and later, you must use the new view name <code>V$OB_MEMSTORE_INFO</code> to query. Using the original view name <code>V$MEMSTORE_INFO</code> will result in an error. </p>
</main>

## Purpose

This view displays detailed information about the MemTables of all partitions in the current tenant on the current server.
...
Query the detailed information about the MemTables of all partitions in the current tenant on the current server.
...
* Query the detailed information about the MemTables of all partitions on all nodes: [GV$OB_MEMSTORE_INFO](1700.gv-ob_memstore_info-of-mysql-mode.md)

* Query the memory usage of the MemTables of the current tenant on the current node: [V$OB_MEMSTORE](32000.v-ob_memstore-of-mysql-mode.md)