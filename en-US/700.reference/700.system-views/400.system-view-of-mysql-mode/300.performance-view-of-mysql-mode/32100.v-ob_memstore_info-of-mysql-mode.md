...
<h4>Note</h4>
<p>The <code>V$MEMSTORE_INFO</code> view has been renamed as <code>V$OB_MEMSTORE_INFO</code> since OceanBase Database V4.0.0. If you query the <code>V$MEMSTORE_INFO</code> view in OceanBase Database V4.0.0 or later, an error is returned. </p>
</main>

## Purpose

The `V$OB_MEMSTORE_INFO` view displays the details about MemTables of all partitions of all tenants on all OBServer nodes.
