...
<h4>Note</h4>
<p>The <code>V$MERGE_INFO</code> view has been renamed as <code>V$OB_MERGE_INFO</code> since OceanBase Database V4.0.0. If you query the <code>V$MERGE_INFO</code> view in OceanBase Database V4.0.0 or later, an error is returned. </p>
</main>
