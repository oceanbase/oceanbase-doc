...
<h4>Note</h4>
<p>Starting from V4.0.0, the view <code>V$MERGE_INFO</code> is renamed to <code>V$OB_MERGE_INFO</code>. In V4.0.0 and later, you must use the new view name <code>V$OB_MERGE_INFO</code> to query the view. If you use the old view name <code>V$MERGE_INFO</code> to query the view, an error will occur. </p>
</main>
...
* [Observe the progress of a major compaction](../../../200.system-management/500.manage-data-storage/200.merge-management/500.view-merge-process.md)