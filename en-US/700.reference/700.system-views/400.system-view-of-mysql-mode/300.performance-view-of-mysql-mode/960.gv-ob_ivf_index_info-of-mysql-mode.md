...
This view displays the basic information and real-time status of IVF vector indexes in the current tenant on all OBServer nodes.
...
Query the real-time status of IVF vector indexes in the current tenant on all OBServer nodes.
