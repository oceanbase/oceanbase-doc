...
|slug|gv_ob_arbitration_member_info-of-mysql-mode|

# GV$OB_ARBITRATION_MEMBER_INFO

## Purpose

The `GV$OB_ARBITRATION_MEMBER_INFO` view provides information about arbitration members of the current cluster.
