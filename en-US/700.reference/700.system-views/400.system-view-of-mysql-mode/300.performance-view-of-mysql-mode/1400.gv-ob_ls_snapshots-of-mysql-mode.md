...
| REBUILD_SEQ_START | bigint(20) | YES | The REBUILD SEQ (Sequence) of the log stream when the snapshot creation started. |
| REBUILD_SEQ_END | bigint(20) | YES | The REBUILD SEQ (Sequence) of the log stream when the snapshot creation ended. |
| END_INTERVAL_SCN | bigint(20) | YES | The SCN at which the replay was terminated. |
...
Query the information about log stream snapshots stored in all units.
