...
| TYPE                  | bigint(20)          | NO         | For SQL plans, this field indicates the type of the plan:  <ul><li> 1: Local Plan  </li><li> 2: Remote Plan </li><li>3: Distribute Plan  </li></ul>For PL objects, this field indicates the type of the PL object:<ul><li> 1: Procedure    </li><li> 2: Function </li><li>3: Package  </li><li> 4: Anonymous Block   </li></ul>   |
| IS_BIND_SENSITIVE     | bigint(20)          | NO         | Indicates whether the plan needs to be opened with ACS.                                                                    |
| IS_BIND_AWARE         | bigint(20)          | NO         | Indicates whether the plan has been opened with ACS.                                                                     |
...
| PS_STMT_ID            | bigint(20)          | NO         | The Prepare ID corresponding to the request. <ul><li>`-1`: Indicates that the SQL statement does not use the PS protocol. </li><li>Non-`-1`: Indicates that the SQL statement uses the PS protocol. This value is the unique identifier returned by the PS protocol for the statement. </li></ul>   |
...
| IS_USE_JIT            | tinyint(4)          | NO         | Indicates whether the expression compilation is enabled for the SQL plan.                                                               |
