...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <ul><li>For V4.3.x, introduced in V4.3.4.</li> <li>For V4.2.x, introduced in V4.2.5.</li></ul>
</main>

## Overview

In a MySQL-compatible tenant, the `GV$OB_KV_GROUP_COMMIT_STATUS` view provides access to the group commit status information for all nodes in the current OBKV-compatible tenant.
...
Query the group commit status information for all client connections of the current OBKV tenant on all nodes, and display the records from the first day.
