...
| OTHERSTAT_4_VALUE       | bigint(20)           | NO | For the TABLE SCAN operator, the number of rows read from the MEMStore `MEMSTORE_READ_ROW_COUNT`. Real-time statistics are supported. |
