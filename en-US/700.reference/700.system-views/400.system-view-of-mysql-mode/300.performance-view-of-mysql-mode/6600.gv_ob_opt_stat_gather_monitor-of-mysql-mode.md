...
Displays the real-time status of the statistical information collection task for the current tenant across all OBServer nodes.
...
In the user tenant, view the real-time status of statistical information collection tasks for the current tenant across all nodes.
