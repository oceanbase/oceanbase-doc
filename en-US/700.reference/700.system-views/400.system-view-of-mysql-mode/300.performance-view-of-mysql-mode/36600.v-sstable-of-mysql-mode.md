...
|slug|v-ob_sstables-mysql-compatible-mode|
...
Displays the MemTable and SSTable information under each partition of the current tenant on the current OBServer node.
