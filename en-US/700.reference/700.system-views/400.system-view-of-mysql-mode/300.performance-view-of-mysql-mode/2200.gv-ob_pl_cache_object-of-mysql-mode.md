...
|machine-translation||
|slug|gv$ob_pl_cache_object-gv-ob_pl_cache_object-of-mysql-mode|
...
| SYS_VARS          | varchar(4096)       | NO   |  The system variables that affect plan generation in the current session. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>    |
| PARAM_INFOS       | longtext            | NO   |  The parameterized type information of anonymous blocks and call proc info. This information is used to determine whether the match is successful. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>   |
