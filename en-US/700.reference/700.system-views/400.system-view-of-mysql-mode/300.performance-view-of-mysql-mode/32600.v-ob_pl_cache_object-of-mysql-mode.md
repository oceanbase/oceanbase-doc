...
|machine-translation||
|slug|v$ob_pl_cache_object-v-ob_pl_cache_object-of-mysql-mode|
...
| PL_CG_MEM_HOLD    | bigint(20)          | NO   |  The memory held during the PL CG phase. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>    |
| SYS_VARS          | varchar(4096)       | NO   |  The system variables that affect the generation of the plan in the current session. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>    |
| PARAM_INFOS       | longtext            | NO   |  The parameterized type information of the anonymous block and call proc info. It is used to determine whether the match is successful. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>   |
