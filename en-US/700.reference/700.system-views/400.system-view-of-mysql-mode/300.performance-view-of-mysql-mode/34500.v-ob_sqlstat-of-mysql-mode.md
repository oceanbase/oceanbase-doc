...
| PLAN_TYPE                     | bigint(20)          | NO   |    For SQL plan cache, this column indicates the plan type:<ul><li>`1`: Local Plan </li> <li>`2`: Remote Plan</li> <li>`3`: Distributed Plan </li></ul> </br>For PL object cache, this column indicates the type of the PL object:<ul><li>`1`: Procedure</li> <li>`2`: Function</li> <li>`3`: Package</li> <li>`4`: Anonymous Block </li></ul> |
...
| MUTI_QUERY_BATCH_DELTA        | bigint(20)        | NO   | The number of times the SQL batch has been executed since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column is available starting from V4.4.2. </p></main>|
| FULL_TABLE_SCAN_TOTAL         | bigint(20)        | NO   | The number of times a full table scan has occurred since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column is available starting from V4.4.2. </p></main>|
| FULL_TABLE_SCAN_DELTA         | bigint(20)        | NO   | The number of times a full table scan has occurred since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column is available starting from V4.4.2. </p></main>|
| ERROR_COUNT_TOTAL             | bigint(20)        | NO   | The number of errors that have occurred since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column is available starting from V4.4.2. </p></main>|
| ERROR_COUNT_DELTA             | bigint(20)        | NO   | The number of errors that have occurred since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column is available starting from V4.4.2. </p></main>|
| LATEST_ACTIVE_TIME            | timestamp(6)      | NO   | The last active time of the plan corresponding to the SQL ID and plan hash on a node. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column is available starting from V4.4.2. </p></main>     |

The values of the `SQL_TYPE` column in the view and the corresponding statements are as follows:
...
The following sample query displays the basic performance statistics of SQL on the current node, and returns the first record.
