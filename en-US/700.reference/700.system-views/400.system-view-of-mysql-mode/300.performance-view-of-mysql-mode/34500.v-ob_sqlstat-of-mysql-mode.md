...
| PLAN_TYPE                     | bigint(20)          | NO   |    The type of the plan. <ul><li>`1`: Local Plan </li> <li>`2`: Remote Plan</li> <li>`3`: Distributed Plan </li></ul> </br>For PL object cache, this column indicates the type of the PL object. <ul><li>`1`: Procedure</li> <li>`2`: Function</li> <li>`3`: Package</li> <li>`4`: Anonymous Block </li></ul> |
| QUERY_SQL                     | longtext            | NO   | The full SQL text. |
| SQL_TYPE                      | bigint(20)          | NO   | The statement type. |
| MODULE                        | varchar(64)         | NO   |   The Module of the application when the statement is first parsed.    |
| ACTION                        | varchar(64)         | NO   |   The Action of the application when the statement is first parsed.      |
...
| FETCHES_TOTAL                 | bigint(20)          | NO   |   The total number of result sets fetched.   |
| FETCHES_DELTA                 | bigint(20)          | NO   |   The incremental number of result sets fetched.     |
...
| FIRST_LOAD_TIME               | timestamp(6)        | NO   |   The plan generation time<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field was introduced in V4.3.5. </li> <li>For V4.2.x, this field was introduced in V4.2.5. </li></ul></main>   |
...
| FULL_TABLE_SCAN_TOTAL         | bigint(20)        | NO   | The number of full table scans since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x versions. </p></main>|
| FULL_TABLE_SCAN_DELTA         | bigint(20)        | NO   | The number of full table scans since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x versions. </p></main>|
| ERROR_COUNT_TOTAL             | bigint(20)        | NO   | The number of errors since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x versions. </p></main>|
| ERROR_COUNT_DELTA             | bigint(20)        | NO   | The number of errors since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 for V4.4.x versions. </p></main>|
...
The following example displays the basic performance statistics of SQL statements on the current node, and displays the first record.
