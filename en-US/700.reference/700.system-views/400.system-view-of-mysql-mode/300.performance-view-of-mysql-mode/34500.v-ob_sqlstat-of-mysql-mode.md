...
The `V$OB_SQLSTAT` view displays basic performance statistics for SQL statements on the current node. Each row corresponds to a unique combination of `SQL_ID` and `Plan_Hash`. The columns with `_DELTA` in their names show the incremental statistics from the last WR snapshot collection to the current time.
...
| MODULE                        | varchar(64)         | NO   |   The application module when the statement was first parsed    |
| ACTION                        | varchar(64)         | NO   |   The application action when the statement was first parsed      |
...
| PHYSICAL_READ_BYTES_TOTAL     | bigint(20)          | NO   |   Total number of bytes read in physical reads     |
| PHYSICAL_READ_BYTES_DELTA     | bigint(20)          | NO   |   Incremental number of bytes read in physical reads   |
...
| ROUTE_MISS_TOTAL              | bigint(20)          | NO   |   The total number of times that the request partition was not hit since the OBServer started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this column was introduced in V4.3.5. </li> <li>For V4.2.x, this column was introduced in V4.2.2. </li></ul></main>   |
| ROUTE_MISS_DELTA              | bigint(20)          | NO   |   The number of times that the request partition was not hit since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this column was introduced in V4.3.5. </li> <li>For V4.2.x, this column was introduced in V4.2.2. </li></ul></main>   |
| FIRST_LOAD_TIME               | timestamp(6)        | NO   |   The time when the plan was generated.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this column was introduced in V4.3.5. </li> <li>For V4.2.x, this column was introduced in V4.2.5. </li></ul></main>   |
| PLAN_CACHE_HIT_TOTAL          | bigint(20)          | NO   |   The total number of times that the Plan Cache was hit since the OBServer started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this column was introduced in V4.3.5. </li> <li>For V4.2.x, this column was introduced in V4.2.5. </li></ul></main>   |
| PLAN_CACHE_HIT_DELTA          | bigint(20)          | NO   |   The number of times that the Plan Cache was hit since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this column was introduced in V4.3.5. </li> <li>For V4.2.x, this column was introduced in V4.2.5. </li></ul></main>  |
...
| MUTI_QUERY_DELTA              | bigint(20)        | NO   | The number of times that the SQL statement was in a Multi Query since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column was introduced in V4.4.2. </p></main>|
...
| MUTI_QUERY_BATCH_DELTA        | bigint(20)        | NO   | The number of times the SQL batch has executed since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 of V4.4.x. </p></main>|
| FULL_TABLE_SCAN_TOTAL         | bigint(20)        | NO   | The number of times the SQL has performed a full table scan since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 of V4.4.x. </p></main>|
| FULL_TABLE_SCAN_DELTA         | bigint(20)        | NO   | The number of times the SQL has performed a full table scan since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 of V4.4.x. </p></main>|
| ERROR_COUNT_TOTAL             | bigint(20)        | NO   | The number of times the SQL has reported an error since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 of V4.4.x. </p></main>|
| ERROR_COUNT_DELTA             | bigint(20)        | NO   | The number of times the SQL has reported an error since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 of V4.4.x. </p></main>|
| LATEST_ACTIVE_TIME            | timestamp(6)      | NO   | The last active time of the plan corresponding to the SQL ID and plan hash on a node. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 of V4.4.x. </p></main>     |
...
The following example shows how to query the basic performance statistics of SQL statements in the current node and display the first record.
