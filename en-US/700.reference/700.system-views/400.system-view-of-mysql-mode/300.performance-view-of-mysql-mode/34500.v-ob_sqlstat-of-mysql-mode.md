...
The `V$OB_SQLSTAT` view displays the basic performance statistics of SQL statements on the current node. Each SQL statement is represented by a row (a unique value of `SQL_ID` and `Plan_Hash`). The statistics with `_DELTA` in the column name indicate the incremental statistics from the last WR snapshot to the current time.
...
| PLAN_TYPE                   | bigint(20)          | NO              | The type of the plan. For cached SQL plans, the value indicates the type of the plan: <ul><li>`1`: local plan </li> <li>`2`: remote plan</li> <li>`3`: distributed plan </li></ul> </br>For cached PL objects, the value indicates the type of the PL object: <ul><li>`1`: procedure</li> <li>`2`: function</li> <li>`3`: package</li> <li>`4`: anonymous block </li></ul> |
| QUERY_SQL                   | longtext            | NO              | The full SQL text.                            |
| SQL_TYPE                    | bigint(20)          | NO              | The statement type.                           |
| MODULE                      | varchar(64)         | NO              | The application module when the statement was parsed for the first time. |
| ACTION                      | varchar(64)         | NO              | The application action when the statement was parsed for the first time. |
...
| DISK_READS_DELTA            | bigint(20)          | NO              | The increment of the number of disk reads.    |
| BUFFER_GETS_TOTAL           | bigint(20)          | NO              | The total number of logical reads from the cache. |
| BUFFER_GETS_DELTA           | bigint(20)          | NO              | The increment of the number of logical reads from the cache. |
| ELAPSED_TIME_TOTAL          | bigint(20)          | NO              | The total time consumed by the statement. For parallel execution, this value is the accumulated value for each execution thread. |
| ELAPSED_TIME_DELTA          | bigint(20)          | NO              | The increment of the time consumed by the statement. |
| CPU_TIME_TOTAL              | bigint(20)          | NO              | The total CPU time.                           |
| CPU_TIME_DELTA              | bigint(20)          | NO              | The increment of the CPU time.                |
| CCWAIT_TOTAL                | bigint(20)          | NO              | The total time spent waiting for concurrent events. |
| CCWAIT_DELTA                | bigint(20)          | NO              | The increment of the total time spent waiting for concurrent events. |
| USERIO_WAIT_TOTAL           | bigint(20)          | NO              | The total time spent waiting for I/O.         |
| USERIO_WAIT_DELTA           | bigint(20)          | NO              | The increment of the total time spent waiting for I/O. |
| APWAIT_TOTAL                | bigint(20)          | NO              | The total time spent waiting for application events. |
| APWAIT_DELTA                | bigint(20)          | NO              | The increment of the total time spent waiting for application events. |
| PHYSICAL_READ_REQUESTS_TOTAL| bigint(20)          | NO              | The total number of physical read requests.   |
| PHYSICAL_READ_REQUESTS_DELTA| bigint(20)          | NO              | The increment of the number of physical read requests. |
| PHYSICAL_READ_BYTES_TOTAL   | bigint(20)          | NO              | The total number of bytes read physically.    |
| PHYSICAL_READ_BYTES_DELTA   | bigint(20)          | NO              | The increment of the number of bytes read physically. |
| WRITE_THROTTLE_TOTAL        | bigint(20)          | NO              | The total time when write throttling occurred. |
| WRITE_THROTTLE_DELTA        | bigint(20)          | NO              | The increment of the total time when write throttling occurred. |
...
| MEMSTORE_READ_ROWS_DELTA    | bigint(20)          | NO              | The increment of the total number of rows read from the MemStore. |
| MINOR_SSSTORE_READ_ROWS_TOTAL| bigint(20)          | NO              | The total number of rows read from the MINOR SSStore. |
| MINOR_SSSTORE_READ_ROWS_DELTA| bigint(20)          | NO              | The increment of the total number of rows read from the MINOR SSStore. |
| MAJOR_SSSTORE_READ_ROWS_TOTAL| bigint(20)          | NO              | The total number of rows read from the MAJOR SSStore. |
| MAJOR_SSSTORE_READ_ROWS_DELTA| bigint(20)          | NO              | The increment of the total number of rows read from the MAJOR SSStore. |
| RPC_TOTAL                   | bigint(20)          | NO              | The total number of RPCs.                     |
| RPC_DELTA                   | bigint(20)          | NO              | The increment of the number of RPCs.          |
| FETCHES_TOTAL               | bigint(20)          | NO              | The total number of result set fetches.       |
| FETCHES_DELTA               | bigint(20)          | NO              | The increment of the number of result set fetches. |
| RETRY_TOTAL                 | bigint(20)          | NO              | The total number of retries.                  |
| RETRY_DELTA                 | bigint(20)          | NO              | The increment of the number of retries.       |
| PARTITION_TOTAL             | bigint(20)          | NO              | The total number of partitions scanned by the SQL statement. |
| PARTITION_DELTA             | bigint(20)          | NO              | The increment of the number of partitions scanned by the SQL statement. |
| NESTED_SQL_TOTAL            | bigint(20)          | NO              | The total number of nested SQL statements executed. Each time a sub-SQL statement is executed, the value is incremented by 1. |
| NESTED_SQL_DELTA            | bigint(20)          | NO              | The increment of the number of nested SQL statements executed. |
| SOURCE_IP                   | varchar(46)         | NO              | The IP address of the request source.         |
| SOURCE_PORT                 | bigint(20)          | NO              | The port of the request source.               |
| ROUTE_MISS_TOTAL            | bigint(20)          | NO              | The total number of times requests were not routed to the requested partitions since the OBServer node started. <main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field was introduced in V4.3.5. </li> <li>For V4.2.x, this field was introduced in V4.2.2. </li></ul></main>   |
| ROUTE_MISS_DELTA            | bigint(20)          | NO              | The number of times requests were not routed to the requested partitions since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field was introduced in V4.3.5. </li> <li>For V4.2.x, this field was introduced in V4.2.2. </li></ul></main>   |
...
| PLAN_CACHE_HIT_TOTAL        | bigint(20)          | NO              | The total number of times the plan cache was hit since the OBServer node started. <main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field was introduced in V4.3.5. </li> <li>For V4.2.x, this field was introduced in V4.2.5. </li></ul></main>   |
| PLAN_CACHE_HIT_DELTA        | bigint(20)          | NO              | The number of times the plan cache was hit since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field was introduced in V4.3.5. </li> <li>For V4.2.x, this field was introduced in V4.2.5. </li></ul></main>  |
