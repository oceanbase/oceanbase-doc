...
|  Field name     |   Type      | Whether NULL |  Description   |
|--------------|--------------|----------------|--------|
...
| MDS_FILTER_INFO                 | varchar(1024) | NO  | This field is not used. The value is empty. <main id="notice" type='explain'><h4>Note</h4><p>This field is introduced in V4.3.5. </p></main> |
