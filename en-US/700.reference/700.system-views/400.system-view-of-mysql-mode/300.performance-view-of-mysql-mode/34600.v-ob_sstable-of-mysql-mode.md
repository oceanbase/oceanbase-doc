...
This view displays the MemTable and SSTable information of each partition in the current tenant on the current OBServer node.
...
| TABLE_TYPE              | varchar(20)         | NO         | The table type.                                                                                |
...
| REF                     | bigint(20)          | NO         | The reference count of the table, in numbers.     |
...
In the user tenant, view the MemTable and SSTable information of each partition in log stream 1001 of the current OBServer node.
