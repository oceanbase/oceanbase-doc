...
|machine-translation||
|slug|gv$ob_memory-gv-memory-of-mysql-mode|

# GV$OB_MEMORY

<main id="notice" type='explain'>
  <h4>Note</h4>
  <ul><li>This view was renamed from <code>GV$MEMORY</code> to <code>GV$OB_MEMORY</code> starting from V4.0.0. In V4.0.0 and later, you must use the new view name <code>GV$OB_MEMORY</code> to query. Using the old view name <code>GV$MEMORY</code> will result in an error. </li><ul>
</main>
