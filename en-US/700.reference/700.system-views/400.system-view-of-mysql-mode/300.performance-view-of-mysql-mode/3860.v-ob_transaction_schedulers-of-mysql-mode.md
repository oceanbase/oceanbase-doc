...
| SNAPSHOT_VERSION | bigint(20) unsigned  | NO | The snapshot version when the RR or SERIAL isolation level is enabled. -1 is returned if the isolation level is not enabled. |
