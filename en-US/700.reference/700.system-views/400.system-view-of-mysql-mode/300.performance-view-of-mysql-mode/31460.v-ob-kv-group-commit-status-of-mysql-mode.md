...
In a MySQL tenant, the `V$OB_KV_GROUP_COMMIT_STATUS` view can access the group commit status information of the OBKV tenant client connection on the current node.
