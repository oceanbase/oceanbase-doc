...
|machine-translation||
|slug|gv$ob_arbitration_member_info-gv_ob_arbitration_member_info-of-mysql-mode|
...
* Query the communication status between the arbitration service and each node of the current tenant: [GV$OB_ARBITRATION_SERVICE_STATUS](6400.gv_ob_arbitration_service_status-of-mysql-mode.md)
