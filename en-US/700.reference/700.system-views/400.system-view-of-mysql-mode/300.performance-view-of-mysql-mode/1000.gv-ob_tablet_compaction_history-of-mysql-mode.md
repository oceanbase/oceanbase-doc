...
|COMPRESSION_RATIO                |double        |NO   |The compression ratio of new data = (size of compressed new macroblocks/size of uncompressed new macroblocks).    |
...
|COMMENTS                         |varchar(1024) |NO   |Comments that show the issues encountered during scheduling or execution.    |
...
| MERGE_LEVEL                     | varchar(64)  | NO   |  Specifies whether the current compaction is a major compaction or microblock reuse is involved<main id="notice" type='explain'><h4>Note</h4><p>This field is introduced in V4.3.0. </p></main>    |
...
* [V$OB_TABLET_COMPACTION_HISTORY](1000.gv-ob_tablet_compaction_history-of-mysql-mode.md)
