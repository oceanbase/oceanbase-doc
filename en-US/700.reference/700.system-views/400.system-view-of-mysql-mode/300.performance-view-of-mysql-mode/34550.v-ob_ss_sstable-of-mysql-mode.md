...
|slug|v-ob-ss-sstable-mysql-mode|
...
This view displays information about SSTables in the shared storage of the current tenant.
...
In the user tenant, query the SSTable information of a specified tablet in a specified log stream.
