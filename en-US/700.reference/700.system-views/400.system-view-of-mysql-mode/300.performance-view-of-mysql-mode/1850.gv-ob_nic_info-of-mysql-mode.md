...
|dir-name-en||
|tenant-type||
|slug|gv-ob_nic_info-mysql-mode|
...
The `GV$OB_NIC_INFO` view displays the NIC information of all OBServer nodes where the tenant resides. It currently mainly displays the NIC speed.
