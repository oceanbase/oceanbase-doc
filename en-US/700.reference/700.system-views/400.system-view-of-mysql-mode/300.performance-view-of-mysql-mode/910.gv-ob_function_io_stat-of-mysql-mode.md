...
| MODE                         | varchar(32)  | NO             | The I/O read/write mode:<ul><li>`LOCAL READ`: Local read</li> <li>`LOCAL WRITE`: Local write</li> <li>`REMOTE READ`: Remote read</li> <li>`REMOTE WRITE`: Remote write</li></ul>    |
