...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <ul><li>This view was introduced in V4.0.0.</li><li>It is renamed to GV$OB_ACTIVE_SESSION_HISTORY starting from V4.2.2.</li></ul>
</main>
...
| TM_DELTA_CPU_TIME | bigint(20) | YES | The amount of time spent on the CPU during the past `TM_DELTA_TIME` period.<main id="notice" type='explain'><h4>Note</h4><p>This column is introduced in V4.2.2.</p></main> |
| TM_DELTA_DB_TIME | bigint(20) | YES | The amount of time spent in database calls during the past `TM_DELTA_TIME` period.<main id="notice" type='explain'><h4>Note</h4><p>This column is introduced in V4.2.2.</p></main> |
...
| PLSQL_OBJECT_ID | bigint(20) | YES | The object ID of the PL that is being exeucted currently.<main id="notice" type='explain'><h4>Note</h4><p>This column is introduced in V4.2.2.</p></main> |
| PLSQL_SUBPROGRAM_ID | bigint(20) | YES | The subprogram ID of the PL that is being exeucted currently.<main id="notice" type='explain'><h4>Note</h4><p>This column is introduced in V4.2.2.</p></main> |
| PLSQL_SUBPROGRAM_NAME | varchar(32) | YES | The subprogram  name of the PL that is being exeucted currently.<main id="notice" type='explain'><h4>Note</h4><p>This column is introduced in V4.2.2.</p></main> |
