...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>For V4.6.x, this view is available starting from V4.6.0.</p>
</main>
...
| IDLE_CLIENTS | bigint(20) | NO | `TENANT_ID`Under the corresponding tenant`CATALOG_ID`Number of idle clients in the catalog. |
