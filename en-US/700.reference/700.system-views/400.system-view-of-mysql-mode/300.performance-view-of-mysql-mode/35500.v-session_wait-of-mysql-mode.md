...
The `V$SESSION_WAIT` view displays detailed information about the current wait events in all sessions on the current node. Each wait event has three parameters.
