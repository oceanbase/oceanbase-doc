...
Displays the relevant metrics of various types of cache data in the local cache of the current tenant on the current OBServer node in shared storage mode.
