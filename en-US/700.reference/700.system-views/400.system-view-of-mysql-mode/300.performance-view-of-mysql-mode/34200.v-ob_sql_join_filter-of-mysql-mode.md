...
Dynamically displays the join filter execution information of the current tenant on the current OBServer node.
...
Query information related to join filter execution in the user tenant.
