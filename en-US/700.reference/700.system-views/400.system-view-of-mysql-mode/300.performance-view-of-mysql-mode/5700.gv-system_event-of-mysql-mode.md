...
In a user tenant, view all wait events for all nodes in the current tenant and display the first 10 records.
...
* View the definitions of all wait events in the tenant: [V$EVENT_NAME](30200.v-event_name-of-mysql-mode.md)
