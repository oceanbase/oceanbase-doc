...
| CACHE_HIT_COUNT      | bigint(20)    | NO   |  The number of cache hits. This field is not enabled and the value is `-1`.    |
| CACHE_MISS_COUNT     | bigint(20)    | NO   |  The number of cache misses. This field is not enabled and the value is `-1`.    |
| CACHE_HIT_SIZE       | bigint(20)    | NO   |  The size of data cached to the tablet, in bytes. This field is not enabled and the value is `-1`.   |
| CACHE_MISS_SIZE      | bigint(20)    | NO   |  The size of data cached to the tablet, in bytes. This field is not enabled and the value is `-1`.   |
