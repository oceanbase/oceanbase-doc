...
| CACHE_HIT_COUNT      | bigint(20)    | NO   |  The number of cache hits for the tablet. This field is currently not enabled and its value is `-1`.    |
| CACHE_MISS_COUNT     | bigint(20)    | NO   |  The number of cache misses for the tablet. This field is currently not enabled and its value is `-1`.    |
| CACHE_HIT_SIZE       | bigint(20)    | NO   |  The size of data cached for the tablet, in bytes. This field is currently not enabled and its value is `-1`.   |
| CACHE_MISS_SIZE      | bigint(20)    | NO   |  The size of data cached for the tablet, in bytes. This field is currently not enabled and its value is `-1`.   |
