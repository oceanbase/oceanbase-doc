...
This view displays the overall cache usage of the current tenant on all OBServer nodes.
...
| CACHE_HIT_SIZE       | bigint(20)    | NO   | The amount of data, in bytes, cached for hits for the tablet. The value of this field is temporarily -1.   |
| CACHE_MISS_SIZE      | bigint(20)    | NO   | The amount of data, in bytes, cached for misses for the tablet. The value of this field is temporarily -1.   |
| INFO                 | varchar(4096) | NO   | Other information.    |

## Sample query

In SS mode, a user of a tenant queries the overall cache usage of the tenant on all OBServer nodes.
