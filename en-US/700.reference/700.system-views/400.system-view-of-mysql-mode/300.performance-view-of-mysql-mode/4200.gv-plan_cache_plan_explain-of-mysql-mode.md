...
|tenant-type||
|machine-translation||
|slug|gv$ob_plan_cache_plan_explain-gv-plan_cache_plan_explain-of-mysql-mode|
...
The `GV$OB_PLAN_CACHE_PLAN_EXPLAIN` view displays the physical execution plans cached in the plan cache of all OBServer nodes.
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p>This view supports only GET operations. When you query this view, you must specify the IP, PORT, TENANT_ID, and PLAN_ID fields. </p>
  </main>
