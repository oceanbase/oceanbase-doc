...
This view displays the MemTable and SSTable information for all partitions of the current tenant on all OBServer nodes.
...
In the user tenant, view the MemTable and SSTable information for all partitions of log stream 1001 on all OBServer nodes.
