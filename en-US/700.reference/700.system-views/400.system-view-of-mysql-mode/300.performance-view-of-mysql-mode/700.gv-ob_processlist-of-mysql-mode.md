...
| USER_CLIENT_PORT  | bigint(20)          | NO   |   The client address. <main id="notice" type='explain'><h4>Note</h4><p>This column is introduced since OceanBase Database V4.3.0.</p></main>  |

## Sample query

```shell
obclient [oceanbase]> SELECT * FROM oceanbase.GV$OB_PROCESSLIST limit 1;
```
...
+----------------+----------+----------+------------+------+----------------------+------+----------+---------+------+------------+-------+------+--------------+---------------+----------------+-----------+-----------+------------+--------+----------+-----------+------------+----------+-------------+--------+--------+-------------+-------+-------------------+-----------------------+--------+--------+----------+----------+-----------+------------------+
| xx.xx.xx.xx   |     2882 |     2881 | 3221487622 | root | xx.xx.xx.xx:61671 | test | mysql001 | Sleep   |  775 |        775 | SLEEP | NULL |         NULL |          NULL | xx.xx.xx.xx | %         |         0 |          0 |        |        0 |         0 | NULL       | NULL     |             |        |        |             |     1 |                10 | SAMPLE_AND_SLOW_QUERY |   NULL | NULL   |     NULL |     1151 |      2680 |            61671 |
+----------------+----------+----------+------------+------+----------------------+------+----------+---------+------+------------+-------+------+--------------+---------------+----------------+-----------+-----------+------------+--------+----------+-----------+------------+----------+-------------+--------+--------+-------------+-------+-------------------+-----------------------+--------+--------+----------+----------+-----------+------------------+
...
[V$OB_PROCESSLIST](4900.v-ob_processlist-of-mysql-mode.md)