...
| --- | --- | --- | --- |
| ID | bigint(20) unsigned | NO | For V4.2.x:  <ul><li> V4.2.5 BP3 Hotfix5 and earlier versions: <br> This field represents the server session ID in all connection modes (direct mode / ODP mode). </li><li> V4.2.5 BP3 Hotfix5 and later versions: <ul><li> In direct mode: <br> This field represents the server session ID. </li> <li> In ODP mode: </li><ul><li> When <code>client_session_id_version = 2</code> in ODP, this field represents the client session ID. </li> <li> When <code>client_session_id_version = 1</code>, this field represents the server session ID. </li></ul></ul></li></ul> |
