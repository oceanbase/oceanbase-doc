...
|machine-translation||
|slug|v$ob_session-v-ob_session-of-mysql-mode|
...
| --- | --- | --- | --- |
| ID | bigint(20) unsigned | NO | For V4.2.x: <ul><li> Before V4.2.5 BP4: <br>Regardless of the connection mode (direct mode or ODP mode), the field indicates the Server Session ID.</li><li> V4.2.5 BP4 and later: <ul><li> Direct mode: <br> The field indicates the Server Session ID.</li> <li> ODP mode: </li><ul><li> If the ODP parameter <code>client_session_id_version = 2</code>, the field indicates the Client Session ID.</li> <li> If <code>client_session_id_version = 1</code>, the field indicates the Server Session ID.</li></ul></ul></li></ul> |
