...
| REPLICA_TYPE     | varchar(7)   | NO         | The replica type. The default value is `FULL`. <main id="notice" type='explain'><h4>Note</h4><ul><li>The <code>REPLICA_TYPE</code> column was introduced in V4.5.0. </li><li>The <code>REPLICA_TYPE</code> column was introduced in V4.2.5 BP7. </li></ul></main>    |
