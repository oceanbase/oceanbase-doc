...
| DATA_DISK_SIZE   | bigint(20)   | YES        | The value of this column is `NULL`, indicating that this value is undefined. In this case, the unit may compete with other tenants for disk space. <main id="notice" type='explain'><h4>Note</h4><p>This view was introduced in OceanBase Database V4.3.4. </p></main>     |
