...
| MODULE | varchar(64) | YES | The application Module when the statement was first parsed, through`DBMS_APPLICATION_INFO.SET_MODULE`Package settings |
| ACTION | varchar(64) | YES | The application Action when this statement was first parsed, through`DBMS_APPLICATION_INFO.SET_ACTION`Package settings |
