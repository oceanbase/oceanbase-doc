...
| DB_ID                  | bigint(20)   | NO             | The ID of the database to which the connection of the SQL statement belongs. <main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x versions, this column is available starting with V4.3.1. </li> <li>For V4.2.x versions, this column is available starting with V4.2.3. </li></ul></main>  |
