...
|slug|v-ob_kv_client_info-of-mysql-tenant|
...
In a MySQL-compatible tenant, the `V$OB_KV_CLIENT_INFO` view can be used to query the configuration parameters of the OBKV client connected to the current node.
