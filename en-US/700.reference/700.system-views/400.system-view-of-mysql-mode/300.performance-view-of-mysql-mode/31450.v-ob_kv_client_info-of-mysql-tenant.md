...
In a MySQL-compatible tenant, the `V$OB_KV_CLIENT_INFO` view provides access to the configuration parameter information of the client connections for the current node within the OBKV-compatible tenant.
