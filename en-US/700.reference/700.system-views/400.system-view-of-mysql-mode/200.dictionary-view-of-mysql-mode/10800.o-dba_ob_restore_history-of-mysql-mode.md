...
This view displays the tenant-level restore tasks that have been completed in the current tenant.
...
| BACKUP_PIECE_LIST | longtext |  NO | The list of log archive shard paths required for the restore task. Shards are separated with commas (,). Example: `file:///data/nfs/backup/archive/2_1_2,file:///data/nfs/backup/archive/2_1_3`. |
| BACKUP_SET_LIST | longtext |  NO | The list of data backup set paths required for the restore task. Backup sets are separated with commas (,). Example: `file:///data/nfs/backup/data/backup_set_1_full,file:///data/nfs/backup/data/backup_set_2_inc`. |
...
* Query all tenant-level restore tasks completed in all tenants: [CDB_OB_RESTORE_HISTORY](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/10300.o-cdb_ob_restore_history-of-sys-tenant.md)

* Query the execution progress of all tenant-level restore tasks: [CDB_OB_RESTORE_PROGRESS](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/10400.o-cdb_ob_restore_progress-of-sys-tenant.md)
