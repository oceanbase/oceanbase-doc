...
| NUM_ROWS_DL_INS | bigint(1) | NO | The number of rows directly loaded. <main id="notice" type='explain'> <h4>Note</h4><p>This column is compatible only and the default value is 0. </p></main> |
| PMOPS_OCCURRED | varchar(1) | NO | Indicates whether a partition maintenance operation (PMOP) occurred. Valid values: <ul><li>Y  </li><li>N </li><li>NULL </li></ul><main id="notice" type='explain'> <h4>Note</h4><p>This column is compatible only and the default value is N. </p></main> |
| PMOP_DETAILS | text | NO | The details of the PMOP. Valid values: <ul><li>TRUNCATE (low_bound, high_bound)  </li><li>EXECHANGE (low_bound, high_bound) </li></ul><main id="notice" type='explain'> <h4>Note</h4><p>This column is compatible only and the default value is NULL. </p></main> |
