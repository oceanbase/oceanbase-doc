...
|slug|o-dba_part_col_statistics-mysql-mode|
...
| DENSITY | decimal(10,0) | NO | The density of the column. If a histogram is available for the COLUMN_NAME column, this column displays the selectivity of values that span fewer than 2 endpoints in the histogram. It does not represent the selectivity of values that span 2 or more endpoints. If no histogram is available for the COLUMN_NAME column, the value of this column is 1/NUM_DISTINCT. |
...
| SAMPLE_SIZE | decimal(10,0) | NO | The sample size used to analyze the column. |
| GLOBAL_STATS | varchar(3) | NO | Indicates whether statistics have been collected:<ul><li>YES: Statistics have been collected.</li><li>NO: Statistics have been aggregated from subpartitions or have not been collected.</li></ul> |
| NOTES | varchar(80) | NO | Describes some additional properties of the statistics:<ul><li>INCREMENTAL: Indicates that the column has a sketch.</li><li>INCREMENTAL(HLL): Indicates that the column has a sketch in the hyperloglog format.</li><li>INCREMENTAL(SAMPLING): Indicates that the column has a sketch in the adaptive sampling format.</li></ul> <br>This column can be used to determine whether the sketch in the adaptive sampling format has been completely purged and properly cleared. |
| AVG_COL_LEN | decimal(10,0) | NO | The average length of the column in bytes. |
| HISTOGRAM | varchar(15) | NO | Indicates the type of histogram:<ul><li>NONE</li><li>FREQUENCY</li><li>HEIGHT BALANCED</li><li>HYBRID</li><li>TOP-FREQUENCY</li></ul> |
...
* Query column statistics at the table level: [DBA_TAB_STATISTICS](15400.o-dba_tab_statistics-of-mysql-mode.md)

* Query column statistics at the global level: [DBA_TAB_COL_STATISTICS](15000.o-dba_tab_col_statistics-of-mysql-mode.md)

* Query column statistics at the subpartition level: [DBA_SUBPART_COL_STATISTICS](14600.o-dba_subpart_col_statistics-of-mysql-mode.md)

* Query histogram statistics at the table level: [DBA_TAB_HISTOGRAMS](15100.o-dba_tab_histograms-of-mysql-mode.md)

* Query histogram statistics at the partition level: [DBA_PART_HISTOGRAMS](13300.o-dba_part_histograms-of-mysql-mode.md)

* Query histogram statistics at the subpartition level: [DBA_SUBPART_HISTOGRAMS](14700.o-dba_subpart_histograms-of-mysql-mode.md)

* Query index statistics: [DBA_IND_STATISTICS](4600.o-dba_ind_statistics-of-mysql-mode.md)
