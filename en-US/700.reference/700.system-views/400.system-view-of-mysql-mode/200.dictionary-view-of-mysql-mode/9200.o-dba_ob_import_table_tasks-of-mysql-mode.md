...
This view displays the records of table-level import tasks in the current tenant.
...
| TARGET_TABLEGROUP | varchar(128) | YES | The name of the remapped tablegroup. If the tablegroup is not remapped, this column is empty. |
...
| RESULT | varchar(64) | YES | The result of the task. Valid values: `SUCCESS` and `FAIL`. <ul><li>`SUCCESS`: The import task is executed successfully. </li><li>`FAIL`: The import task fails. </li></ul> |
