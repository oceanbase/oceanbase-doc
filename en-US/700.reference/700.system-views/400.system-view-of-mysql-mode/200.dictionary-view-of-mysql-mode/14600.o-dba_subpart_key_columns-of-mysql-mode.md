...
|machine-translation||
|slug|oceanbase.dba_subpart_key_columns-o-dba_subpart_key_columns-of-mysql-mode|
...
This view displays the columns in the subpartition keys of all partitioned objects in the current tenant.
...
Query the columns in the subpartition keys of the partitioned table `tbl2_f_rl` in the current user tenant.
