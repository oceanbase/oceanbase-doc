...
This view displays the log archiving status for each path in the current tenant.
...
| DEST_NO | bigint(20) | NO | The number of the log_archive_dest_n. |
...
| START_SCN_DISPLAY | datetime(6) | NO | The start SCN of the backup, converted to a time unit. |
| CHECKPOINT_SCN | bigint(20) unsigned | NO | The current archiving SCN. |
| CHECKPOINT_SCN_DISPLAY | datetime(6) | NO | The current archiving SCN, converted to a time unit. |
