...
| JOB_LEVEL | varchar(64) | NO | The job initiation level: <ul><li> `USER_TENANT`: a user tenant initiated the job. </li><li> `SYS_TENANT`: a system tenant initiated the job. </li></ul> |
