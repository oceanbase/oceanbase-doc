...
|machine-translation||
|slug|oceanbase.dba_ob_import_table_job_history-o-dba_ob_import_table_job_history-of-mysql-mode|
...
This view displays the results of the import tasks of the current tenant.
...
| IMPORT_ALL | tinyint(4) | NO | Indicates whether to import all tables under the tenant. The value is 1 only when the `RECOVER TABLE *.*` clause is specified. Otherwise, the value is 0. |
...
Query the results of the import tasks of the current tenant.
