...
This view displays the columns in the partitioning key of all partitioned objects in the current tenant.
...
Query the columns in the partitioning key of the partitioned table `tbl1_h` in the current user tenant.
...
To query the columns in the partitioning key of all partitioned objects in all tenants, see [CDB_PART_KEY_COLUMNS](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/12300.o-cdb_part_key_columns-of-sys-tenant.md).