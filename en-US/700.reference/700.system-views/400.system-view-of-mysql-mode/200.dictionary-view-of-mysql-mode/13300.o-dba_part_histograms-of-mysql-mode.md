...
This view displays histogram data (endpoints) for all partitions of all partitioned tables in the current tenant.
...
| ENDPOINT_REPEAT_COUNT | decimal(10,0) | NO | The endpoint frequency (0 for non-hybrid histograms). |
...
* Query table-level histogram statistics: [DBA_TAB_HISTOGRAMS](15100.o-dba_tab_histograms-of-mysql-mode.md)

* Query subpartition-level histogram statistics: [DBA_SUBPART_HISTOGRAMS](14700.o-dba_subpart_histograms-of-mysql-mode.md)
...
* Query column statistics at the partition level: [DBA_PART_COL_STATISTICS](13200.o-dba_part_col_statistics-of-mysql-mode.md)
