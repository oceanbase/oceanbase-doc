...
The `oceanbase.DBA_OB_SYS_VARIABLES` view displays the system variable settings of the current tenant, including hidden variables whose names start with an underscore.
