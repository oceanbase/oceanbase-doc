...
* Query session information of all OBServer nodes where the tenant resides: [GV$OB_PROCESSLIST](../300.performance-view-of-mysql-mode/2500.gv-ob_processlist-of-mysql-mode.md)
