...
|machine-translation||
|slug|oceanbase.dba_objects-o-dba_objects-of-mysql-mode|
...
The `oceanbase.DBA_OBJECTS` view displays all database objects in the current tenant. The definition of this view is the same as that of the `ALL_OBJECTS` view.
