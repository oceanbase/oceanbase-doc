...
|machine-translation||
|slug|oceanbase.dba_scheduler_job_run_details-o-dba_scheduler_job_run_details-of-mysql-mode|
...
The `ceanbase.DBA_SCHEDULER_JOB_RUN_DETAILS` view displays all scheduler jobs in the current tenant.
...
| GMT_MODIFIED      | timestamp(6)                     | YES  | The time when the scheduler job was last modified. The value is a timestamp in seconds. |
