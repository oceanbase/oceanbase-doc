...
This view displays the execution status of historical collection tasks in the current tenant.
...
| TASK_ID | varchar(36) | NO | The ID of the collection task. This value is a UUID and is globally unique. |
...
| TABLE_COUNT | bigint(20) | YES | The number of tables to be collected by the collection task. |
| FAILED_COUNT | bigint(20) | YES | The number of tables that failed to be collected by the collection task. |
| START_TIME | datetime(6) | NO | The start time of the collection task. |
| END_TIME | datetime(6) | NO | The end time of the collection task. |

## Sample query

Query the historical execution status of manual collection tasks in the current tenant.
