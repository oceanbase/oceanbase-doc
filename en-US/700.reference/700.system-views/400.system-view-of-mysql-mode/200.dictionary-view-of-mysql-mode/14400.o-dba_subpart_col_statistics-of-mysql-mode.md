...
|machine-translation||
|slug|oceanbase.dba_subpart_col_statistics-o-dba_subpart_col_statistics-of-mysql-mode|
...
This view displays the column statistics and histogram information of all subpartitions in the current tenant.
...
| SAMPLE_SIZE | decimal(10,0) | NO | The sample size used when the column was analyzed. |
| GLOBAL_STATS | varchar(3) | NO | Indicates whether statistics have been collected:<li>YES<li>NO |
| USER_STATS | varchar(3) | NO | Indicates whether statistics were directly input by the user:<li>YES<li>NO |
| NOTES | varchar(80) | NO | Additional attributes of the statistics. For example, if the value is INCREMENTAL, the global statistics are from a summary, that is, the global statistics are incrementally maintained. |
...
Query the column statistics of the subpartitions of the `t_subpart` partitioned table in the current tenant.
...
<!-- * Query column statistics at the table level: [DBA_TAB_STATISTICS]

* Query column statistics at the global level: [DBA_TAB_COL_STATISTICS]

* Query column statistics at the partition level: [DBA_PART_COL_STATISTICS]

* Query histogram statistics at the table level: [DBA_TAB_HISTOGRAMS]

* Query histogram statistics at the partition level: [DBA_PART_HISTOGRAMS]

* Query histogram statistics at the subpartition level: [DBA_SUBPART_HISTOGRAMS]
