...
| RESULT | varchar(64) | YES | The result of the task. Valid values: <ul><li>`SUCCESS`: The import task is executed successfully. </li><li>`FAIL`: The import task fails. </li></ul>|
