...
This view displays the optimizer statistics of all tables in the database.
...
Query the optimizer statistics for the `t_subpart` table in the current tenant.
...
* View table-level histogram statistics: [DBA_TAB_HISTOGRAMS](15100.o-dba_tab_histograms-of-mysql-mode.md)

* View partition-level histogram statistics: [DBA_PART_HISTOGRAMS](13300.o-dba_part_histograms-of-mysql-mode.md)

* View subpartition-level histogram statistics: [DBA_SUBPART_HISTOGRAMS](14700.o-dba_subpart_histograms-of-mysql-mode.md)
