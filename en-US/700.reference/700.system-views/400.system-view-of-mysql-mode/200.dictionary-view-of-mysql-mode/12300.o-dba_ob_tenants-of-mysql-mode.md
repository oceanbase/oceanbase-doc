...
| FLASHBACK_LOG_SCN | bigint(20) | NO | The log truncation point of the last execution of the tenant. After a failover, you can execute an operation command to truncate the logs of the original primary tenant to a specified point and then add the standby tenant to the new primary tenant. <main id="notice" type='explain'><h4>Note</h4><p>Introduced in V4.4.1. </p></main> |
| COMMENT                    | varchar(4096)       | NO   | Comment information     |
