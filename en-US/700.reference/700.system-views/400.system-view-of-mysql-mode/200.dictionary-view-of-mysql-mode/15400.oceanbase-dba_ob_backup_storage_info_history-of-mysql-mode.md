...
|slug|oceanbase-dba_ob_backup_storage_info_history-of-mysql-mode|
...
| DEST_TYPE | varchar(64) | YES | The type of the backup destination, which can be:<ul><li>`archive_log`: Log archiving</li> <li>`backup_data`: Data backup</li></ul> |
