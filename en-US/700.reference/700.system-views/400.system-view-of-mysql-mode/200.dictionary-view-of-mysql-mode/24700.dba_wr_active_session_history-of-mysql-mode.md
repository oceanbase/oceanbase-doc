...
|machine-translation||
|slug|oceanbase.dba_wr_active_session_history-dba_wr_active_session_history-of-mysql-mode|
...
| IN_SQL_OPTIMIZE | varchar(1) | NO | Indicates whether the current session is performing SQL tuning during sampling. |
