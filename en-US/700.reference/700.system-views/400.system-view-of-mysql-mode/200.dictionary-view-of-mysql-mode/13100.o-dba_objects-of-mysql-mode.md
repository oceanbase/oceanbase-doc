...
The `oceanbase.DBA_OBJECTS` view displays all objects in a database. The definition of this view is the same as that of the `ALL_OBJECTS` view.
...
Query the information about all objects in a database.
