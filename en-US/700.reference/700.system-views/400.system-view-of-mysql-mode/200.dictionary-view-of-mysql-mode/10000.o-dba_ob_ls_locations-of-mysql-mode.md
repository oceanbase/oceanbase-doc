...
|slug|o-dba_ob_ls_locations-of-mysql-mode|
...
|--------------|----------------|------------|----------------------------------------------------------------------|
| CREATE_TIME | datetime(6) | NO | The time when the LS replica was created. |
| MODIFY_TIME | datetime(6) | NO | The time when the LS replica was modified. |
