...
| DB_LIST | longtext | YES | The database to be fully restored. |
| TABLE_LIST | longtext | YES | The table to be restored. |
...
| REMAP_DB_LIST | longtext | YES | The database to be renamed. Format: db1:new_db1, db2:newdb2. |
| REMAP_TABLE_LIST | longtext | YES | The table to be renamed. Format: db1.t1:new_t1, db1.t2:db2.new_t2. |
...
During a table-level restore, query the oceanbase.DBA_OB_RECOVER_TABLE_JOBS view to obtain information about the table-level restore task.
