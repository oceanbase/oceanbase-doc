...
Displays information about table-level restore tasks for the current tenant.
...
During table-level restore, users can view information related to the table-level restore task.
