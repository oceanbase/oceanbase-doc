...
This view displays the columns that are subpartitioning keys in all partitioned objects in the current tenant.
...
Query the columns that are subpartitioning keys in the partitioned table `tbl2_f_rl` in the user tenant.
...
To view the columns that are subpartitioning keys in all partitioned objects in all tenants, see [CDB_SUBPART_KEY_COLUMNS](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/12500.o-cdb_subpart_key_columns-of-sys-tenant.md).