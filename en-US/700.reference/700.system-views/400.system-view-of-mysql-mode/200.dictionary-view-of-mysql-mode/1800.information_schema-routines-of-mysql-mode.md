...
| ROUTINE_TYPE | varchar(9) | NO | The type of the procedure:<ul><li>   PROCEDURE: for stored procedures </li><li>  FUNCTION: for stored functions</li></ul> |
...
| SECURITY_TYPE | varchar(7) | NO | The SQL security type:<ul><li>   DEFINER </li><li>   INVOKER. This column is currently not used.</li></ul>|
