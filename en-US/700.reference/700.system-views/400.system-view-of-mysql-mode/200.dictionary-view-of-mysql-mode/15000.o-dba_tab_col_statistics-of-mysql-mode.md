...
| LAST_ANALYZED | datetime(6) | NO | The time of the last analysis. |
| SAMPLE_SIZE | decimal(10,0) | NO | The sample size during analysis. |
| GLOBAL_STATS | varchar(3) | NO |<ul><li>`YES`: indicates that the statistics are directly collected or incrementally maintained.   </li><li> `NO`: other cases</li></ul> |
