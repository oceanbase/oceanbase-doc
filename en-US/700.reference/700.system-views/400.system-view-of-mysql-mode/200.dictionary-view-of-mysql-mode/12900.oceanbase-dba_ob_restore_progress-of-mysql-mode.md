...
|machine-translation||
|slug|oceanbase.dba_ob_restore_progress-oceanbase-dba_ob_restore_progress-of-mysql-mode|

# oceanbase.DBA_OB_RESTORE_PROGRESS

## Purpose

The `oceanbase.DBA_OB_RESTORE_PROGRESS` view displays ongoing restore tasks.
...
| BACKUP_PIECE_LIST | longtext | NO | The paths of log archive pieces for restore, which are separated with commas (,). For example, `file:///data/nfs/backup/data/backup_set_1_full,file:///data/nfs/backup/data/backup_set_2_inc`. |
