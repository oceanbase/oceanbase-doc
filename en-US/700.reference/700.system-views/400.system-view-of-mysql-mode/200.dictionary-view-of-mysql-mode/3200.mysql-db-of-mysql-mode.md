...
| lock_tables_priv      | varchar(1)   | NO             | Indicates whether the user can execute the `LOCK TABLES` statement. The user also needs SELECT privileges on the table. This column is not used. |
