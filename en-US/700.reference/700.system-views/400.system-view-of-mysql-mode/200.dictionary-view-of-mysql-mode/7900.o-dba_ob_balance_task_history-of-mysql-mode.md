...
| FINISH_TIME | timestamp(6) | NO | The end time of the task. This field indicates the time when the task is completed or canceled. |
...
* Query log stream-level load balancing tasks (Task) in the current tenant: [DBA_OB_BALANCE_TASKS](8000.o-dba_ob_balance_tasks-of-mysql-mode.md)
