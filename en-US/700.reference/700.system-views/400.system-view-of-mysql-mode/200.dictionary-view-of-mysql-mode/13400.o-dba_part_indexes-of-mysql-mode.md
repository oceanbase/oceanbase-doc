...
This view displays information about all partitions of all partitioned indexes in the current tenant.
...
| AUTOLIST                  | varchar(3)    | NO         | Indicates whether the local index is automatically list-partitioned. Valid values: <ul><li>YES</li><li>NO</li></ul>        |
...
Query the partition information of the partitioned index `tbl1_h_idx1` in the current tenant.
...
To view the partition information of all tenants' partition indexes, see [CDB_PART_INDEXES](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/12200.o-cdb_part_indexes-of-sys-tenant.md).