...
| DEF_NEXT_EXTENT | varchar(40) | NO | The default `NEXT` value for a local index when a table partition is added. If no `NEX`T value was specified, the value is `DEFAULT`. |
