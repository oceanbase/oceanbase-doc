...
| INTERVAL                | varchar(3)      | NO         | This column is not supported. The default value of this column is `NO`.    |
| SEGMENT_CREATED         | varchar(3)      | NO         | This column is not supported. The default value of this column is NULL.    |
| DOMIDX_OPSTATUS         | varchar(6)      | NO         | This column is not supported. The default value of this column is NULL.      |
| PARAMETERS              | text            | NO         | This column is not supported. The default value of this column is NULL.   |

## Sample query

Query the `tbl2_f_rl` table in the user tenant to view the subpartitions (subpartition) information of the index.
