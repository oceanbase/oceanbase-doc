...
This view displays the database privileges of the current tenant's users.
...
| PRIV_DELETE | varchar(3) | NO |  Indicates whether the user has the privilege to delete database or table records.   |
...
Query the database privileges of the users in the current tenant.
