...
| PRIV_DELETE       | varchar(3)   | NO   |  Indicates whether the user has the privilege to delete records from databases or tables.   |
...
| PRIV_SELECT       | varchar(3)   | NO   |  Indicates whether the user has the privilege to query records from databases or tables.   |
...
Query the database privileges of the current user in the current user tenant.
