...
| STATUS | varchar(64) | NO | The task status. Valid values: <ul><li> `INIT`: the task initialization stage </li><li> `DOING`: the task execution stage </li><li> `CANCELING`: the task cancellation stage </li><li> `COMPLETED`: the task execution succeeded </li><li> `FAILED`: the task execution failed </li><li> `CANCELED` : the task was successfully canceled </li></ul> |
...
Query the history of backup cleanup tasks executed in the user tenant and display the first 5 records.
...
* View the execution progress of backup cleanup jobs: [DBA_OB_BACKUP_DELETE_JOBS](6500.o-dba_ob_backup_delete_jobs-of-mysql-mode.md)

* View the execution progress of backup cleanup tasks: [DBA_OB_BACKUP_DELETE_TASKS](6800.o-dba_ob_backup_delete_tasks-of-mysql-mode.md)

* View the history of backup cleanup tasks: [DBA_OB_BACKUP_DELETE_TASK_HISTORY](6700.o-dba_ob_backup_delete_task_history-of-mysql-mode.md)

* For more information about how to set up automatic cleanup of obsolete backups, see [Automatically clear obsolete backups](../../../../600.manage/600.backup-and-recovery/500.clear-backup-data/50.automatic-backup-cleanup/100.cleaning-up-backed-up-data-automatically.md).