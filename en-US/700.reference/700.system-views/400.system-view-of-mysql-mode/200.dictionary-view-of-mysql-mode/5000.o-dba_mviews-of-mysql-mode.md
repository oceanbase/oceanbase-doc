...
| REFRESH_DOP          | bigint(20) | NO | The degree of parallelism of background refreshes. The default value is 0. <main id="notice" type='explain'><h4>Note</h4><p><ul><li>When you create a materialized view, you can specify this parameter by using the <code>PARALLEL</code> attribute. You can also modify it by using the <code>ALTER MATERIALIZED VIEW</code> statement later. When you do not explicitly set the <code>PARALLEL</code> attribute (when <code>REFRESH_DOP</code> is the default value 0), the degree of parallelism of background refreshes depends on the value of the global system variable `mview_refresh_dop`. </li><li>For OceanBase Database V4.3.5, this field was introduced in V4.3.5 BP1. </li></ul></p></main>|
