...
| CHARACTER_SET_CLIENT | varchar(64)     | NO         | The value of the character_set_client session variable at the time when the view was created. |
| COLLATION_CONNECTION | varchar(64)    | NO         | The value of the collation_connection session variable at the time when the view was created. |

## Sample query

Query the details of the `v_test_tbl1` view.
