...
| OLD_PASSWORD_START_TIME     | bigint(20)      | NO       | The time when the old password becomes effective. A value of `-1` indicates that no old password is available. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.4.2 BP1. </p></main>                     |
