...
| TASK_TYPE	                | bigint(20)	| NO   | The type of the task. Valid values: <ul><li><code>0</code>: asynchronous construction</li><li><code>1</code>: index partition rebuild</li><li><code>5</code>: freeze dump task</li><li><code>6</code>: segment merge task</li></ul>     | |
...
| index_type | string | The type of the index used to process the vectors of the segment. Valid values: <ul><li>HNSW</li><li>HNSW_SQ</li><li>HNSW_BQ</li><li>HGRAPH</li><li>SINDI</li></ul> |
...
* For more information about the relationship between HNSW vector index dump, segment merge, and task types, see [Vector index principles](../../../100.oceanbase-database-concepts/400.database-objects/200.database-objects-of-mysql-mode/300.index-of-mysql-mode/330.vector-indexes-of-mysql-mode-in-concepts.md).
