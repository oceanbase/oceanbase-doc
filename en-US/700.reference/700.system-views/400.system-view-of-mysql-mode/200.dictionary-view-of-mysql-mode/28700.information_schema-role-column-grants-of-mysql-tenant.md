...
|machine-translation||
|slug|information_schema.role_column_grants-information_schema-role-column-grants-of-mysql-tenant|
...
| PRIVILEGE_TYPE | varchar(31)  | NO   | The privileges granted. The value can be any privileges on a column of a specified table. All privileges on one column are displayed in each row.      |
