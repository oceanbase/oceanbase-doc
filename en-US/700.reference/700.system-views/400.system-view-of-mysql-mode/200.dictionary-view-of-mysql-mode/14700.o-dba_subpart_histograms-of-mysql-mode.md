...
This view displays the histogram data of subpartitions of all partitioned tables in the current tenant (the endpoints of each histogram).
...
Query the histogram information of the subpartitions of the `sales_subpart` partitioned table in the current tenant.
...
* Query the histogram statistics at the table level: [DBA_TAB_HISTOGRAMS](15100.o-dba_tab_histograms-of-mysql-mode.md)

* Query the histogram statistics at the partition level: [DBA_PART_HISTOGRAMS](13300.o-dba_part_histograms-of-mysql-mode.md)

* Query the column statistics at the table level: [DBA_TAB_STATISTICS](15400.o-dba_tab_statistics-of-mysql-mode.md)

* Query the column statistics at the global level: [DBA_TAB_COL_STATISTICS](15000.o-dba_tab_col_statistics-of-mysql-mode.md)

* Query the column statistics at the partition level: [DBA_PART_COL_STATISTICS](13200.o-dba_part_col_statistics-of-mysql-mode.md)

* Query the column statistics at the subpartition level: [DBA_SUBPART_COL_STATISTICS](14600.o-dba_subpart_col_statistics-of-mysql-mode.md)
