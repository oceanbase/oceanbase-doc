...
| RESULT | varchar(64) | YES | Result of the task completion:<ul><li>`SUCCESS`: The import task was executed successfully.</li><li>`FAIL`: Import task failed to execute.</li></ul> |
