...
|slug|oceanbase-dba_tab_stats_history-mysql-compatible-mode|
...
Displays the historical table statistics for all tables in the current tenant.
...
| SUBPARTITION_NAME | varchar(128) | NO | Name of Subpartitioned Table |
| STATS_UPDATE_TIME | datetime(6) | NO | Time of statistics update |

## Sample query

View the modification history of table statistics for the `t_subpart` table in this tenant.
