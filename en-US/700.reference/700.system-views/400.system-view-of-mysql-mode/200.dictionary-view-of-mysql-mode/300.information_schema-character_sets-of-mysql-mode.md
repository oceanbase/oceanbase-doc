...
|slug|information_schema-character_sets-mysql-mode|
...
This view displays the character set information of OceanBase Database.
...
| DEFAULT_COLLATE_NAME | varchar(128) | NO             | The collation method of the character set. |
...
Query the character set information of OceanBase Database.
