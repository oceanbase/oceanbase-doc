...
This view displays information about backup destinations used for backup and restore operations in the tenant.
...
| ENDPOINT | varchar(256) | NO | The HOST address for accessing the object storage. |
