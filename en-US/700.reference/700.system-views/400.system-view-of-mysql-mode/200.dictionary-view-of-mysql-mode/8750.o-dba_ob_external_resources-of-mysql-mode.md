...
| TYPE        | varchar(12)   | NO   |   The type of the resource, which is used to distinguish between Java jar files and Python source code. The value is {'JAVA_JAR', 'PYTHON_PY'}.  |
...
Execute the following SQL statement to query the resource files uploaded in the current tenant.
