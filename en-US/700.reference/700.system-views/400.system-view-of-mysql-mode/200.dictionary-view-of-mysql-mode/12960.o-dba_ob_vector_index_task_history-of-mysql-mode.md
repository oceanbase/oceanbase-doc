...
|slug|oceanbase-dba_ob_vector_index_task_history-mysql-mode|
...
| RET_CODE	                | bigint(20)	| NO   | The status of the task when it ended. Valid values: <ul><li><code>0</code>: succeeded</li><li><code>Non-zero</code>: failed</li></ul> |
