...
| ORDINAL_POSITION              | bigint(20)   | NO         | The sequence number of the column in the primary key constraint, starting from 1. |
| POSITION_IN_UNIQUE_CONSTRAINT | null         | NO         | For unique and primary key constraints, the sequence number of the column in the constraint definition; for foreign key constraints, the sequence number of the key in the referenced table. |
