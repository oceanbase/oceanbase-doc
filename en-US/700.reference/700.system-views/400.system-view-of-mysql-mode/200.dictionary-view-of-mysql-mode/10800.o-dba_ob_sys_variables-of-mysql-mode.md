...
|machine-translation||
|slug|oceanbase.dba_ob_sys_variables-o-dba_ob_sys_variables-of-mysql-mode|
...
| MODIFY_TIME   | timestamp(6) | YES | The time when the system variable was last modified. |
