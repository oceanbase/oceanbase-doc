...
| FINISH_TIME      | timestamp(6) | NO   | The time when the task was completed, including successful and canceled tasks.   |
...
| STATUS           | varchar(64)  | NO   | The status of the task. Valid values: <ul><li>COMPLETED: The task was executed successfully. </li><li>FAILED: The task failed. </li></ul>   |
...
* View the current Transfer Partition tasks being processed in the current tenant: [oceanbase.DBA_OB_TRANSFER_PARTITION_TASKS](12400.o-dba_ob_transfer_partition_tasks-of-mysql-mode.md)
