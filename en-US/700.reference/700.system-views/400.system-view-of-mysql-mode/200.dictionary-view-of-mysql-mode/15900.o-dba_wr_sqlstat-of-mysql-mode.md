...
| ACTION | varchar(64) | YES | The application action when this statement is parsed for the first time. The value of this parameter is specified by the`DBMS_APPLICATION_INFO.SET_ACTION`Package settings |
