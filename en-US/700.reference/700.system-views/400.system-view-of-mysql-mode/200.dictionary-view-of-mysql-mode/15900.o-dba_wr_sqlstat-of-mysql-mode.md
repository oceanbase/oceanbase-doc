...
| MODULE | varchar(64) | YES | The application Module when the statement was parsed for the first time, via`DBMS_APPLICATION_INFO.SET_MODULE`Package settings |
| ACTION | varchar(64) | YES | The application Action when this statement was first parsed, via`DBMS_APPLICATION_INFO.SET_ACTION`Package settings |
