...
This view displays the execution plan and throttling rule outline history of the current tenant.
...
Query the execution plan and throttling rule outline history of the current tenant.
