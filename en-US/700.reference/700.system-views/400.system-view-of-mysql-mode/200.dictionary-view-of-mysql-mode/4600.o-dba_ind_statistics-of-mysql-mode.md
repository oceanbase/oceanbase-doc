...
| GLOBAL_STATS            | varchar(3) | NO | Indicates whether statistics were collected or incrementally maintained. Valid values: <ul><li>YES</li><li>NO</li></ul> |
| USER_STATS              | varchar(3) | NO | Indicates whether the statistics were directly input by the user. Valid values: <ul><li>YES</li><li>NO</li></ul>  |
...
Query the optimizer statistics of the index `tbl2_f_rl_idx1` in the current user tenant.
