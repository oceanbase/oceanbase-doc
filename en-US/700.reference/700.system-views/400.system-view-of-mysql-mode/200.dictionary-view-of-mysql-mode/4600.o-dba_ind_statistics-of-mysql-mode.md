...
| BLEVEL                 | decimal(10,0) | NO | NULL |
| LEAF_BLOCKS            | decimal(10,0) | NO | NULL |
| DISTINCT_KEYS          | decimal(10,0) | NO | NULL |
| AVG_LEAF_BLOCKS_PER_KEY | decimal(10,0) | NO | NULL |
| AVG_DATA_BLOCKS_PER_KEY | decimal(10,0) | NO | NULL |
| CLUSTERING_FACTOR       | decimal(10,0) | NO | NULL |
| NUM_ROWS                | decimal(10,0) | NO | The number of rows in the index. |
| AVG_CACHED_BLOCKS       | decimal(10,0) | NO | NULL |
| AVG_CACHE_HIT_RATIO     | decimal(10,0) | NO | NULL |
| SAMPLE_SIZE             | decimal(10,0) | NO | NULL |
...
| USER_STATS              | varchar(3) | NO | Indicates whether statistics are directly input by a user. Valid values: <ul><li>YES</li><li>NO</li></ul>  |
