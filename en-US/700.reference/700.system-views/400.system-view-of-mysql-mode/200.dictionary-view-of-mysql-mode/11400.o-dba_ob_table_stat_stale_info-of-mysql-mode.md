...
View the number of DDL operations on the `t_subpart` table of this tenant since the last statistics collection and the expiration status of the statistics.
