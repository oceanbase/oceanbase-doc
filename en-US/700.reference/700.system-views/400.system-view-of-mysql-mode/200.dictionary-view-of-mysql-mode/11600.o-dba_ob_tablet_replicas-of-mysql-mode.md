...
|machine-translation||
|slug|oceanbase.dba_ob_tablet_replicas-o-dba_ob_tablet_replicas-of-mysql-mode|
...
This view displays the information of all tablet replicas in the current tenant. Each tablet replica is uniquely identified by the joint key: `<TENANT_ID, TABLET_ID, SVR_IP, SVR_PORT, LS_ID>`.
...
| REQUIRED_SIZE | bigint(20)  | NO         | The size of the space allocated to the data. The data is stored in macroblocks of 2 MB as the minimum unit. Therefore, `REQUIRED_SIZE >= DATA_SIZE` |
