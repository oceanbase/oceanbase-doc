...
<h4>Note</h4>
<p>This view is introduced in OceanBase Database V4.3.5 BP3. </p>
</main>

## Purpose

The `oceanbase.DBA_OB_KV_REDIS_TABLE` view stores the specific commands for various data structures in Redis and the corresponding table names for each command in the current tenant.
