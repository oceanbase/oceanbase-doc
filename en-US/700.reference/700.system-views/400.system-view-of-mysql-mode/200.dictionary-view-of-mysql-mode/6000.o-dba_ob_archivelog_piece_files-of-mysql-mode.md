...
| FILE_STATUS | varchar(64) | NO | The replica status of the backup log piece at the source. Valid values: <ul><li>AVAILABLE: the backup is valid and can be used for recovery. </li><li>COPYING: the log file is being backed up. </li><li>INCOMPLETE: the log file is incomplete. Some log streams are missing. </li><li>DELETING: the log file is being deleted. </li><li>EXPIRED: the backup file is invalid. </li><li>BROKEN: the backup file is incomplete and cannot be used. </li><li>DELETED: the log file is deleted. </li></ul> |
| PATH | varchar(2048) | NO | The archive path. |
| BACKUP_FILE_STATUS | varchar(64) | NO | The file status of the backup log piece at the backup destination (`BACKUP_ARCHIVE_DEST`). The possible values are the same as those of the `FILE_STATUS` column, including the following: <ul><li>AVAILABLE: the backup is valid and can be used for recovery. </li><li>COPYING: the log file is being backed up. </li><li>INCOMPLETE: no archive backup has been performed. This is the initial state. </li><li>DELETING: the log file is being deleted. </li><li>EXPIRED: the backup file is invalid. </li><li>BROKEN: the backup file is incomplete and cannot be used. </li><li>DELETED: the log file is deleted. </li></ul>  <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.4.2 BP3. </p></main> |
