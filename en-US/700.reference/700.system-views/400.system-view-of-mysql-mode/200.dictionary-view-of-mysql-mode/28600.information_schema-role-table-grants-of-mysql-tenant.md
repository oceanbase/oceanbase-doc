...
|machine-translation||
|slug|information_schema.role_table_grants-information_schema-role-table-grants-of-mysql-tenant|
...
| GRANTEE        | varchar(32)  |  NO     | The username of the account corresponding to to the role.      |
| GRANTEE_HOST   | varchar(255) |  NO     | The host name of the account corresponding to to the role.      |
...
| PRIVILEGE_TYPE | varchar(90)  |  NO     | The privileges granted. The value can be any privileges at the table level.  |
