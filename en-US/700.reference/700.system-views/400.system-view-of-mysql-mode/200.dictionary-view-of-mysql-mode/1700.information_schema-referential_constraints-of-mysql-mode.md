...
| MATCH_OPTION              | varchar(64)                             | NO             | The value of the constraint MATCH option. The only valid value is NONE.                                |
| UPDATE_RULE               | varchar(64)                             | NO             | The value of the constraint ON UPDATE option. Valid values: CASCADE, SET NULL, RESTRICT, NO ACTION  |
| DELETE_RULE               | varchar(64)                             | NO             | The value of the constraint ON DELETE option. Valid values: CASCADE, SET NULL, RESTRICT, NO ACTION |
