...
|---------------------------|-----------------------------------------|----------------|--------------------------------------------------------------|
| CONSTRAINT_CATALOG        | varchar(64)                           | NO             | The value is always def.                                                    |
...
| UNIQUE_CONSTRAINT_CATALOG | varchar(64)                           | NO             | The value is always def.                                                    |
| UNIQUE_CONSTRAINT_SCHEMA  |  varchar(128)  | NO             | The name of the schema to which the unique constraint or primary key referenced by the constraint belongs.                                           |
...
| UPDATE_RULE               | varchar(64)                             | NO             | The value of the ON UPDATE attribute of the constraint. Valid values: CASCADE, SET NULL, RESTRICT, NO ACTION  |
| DELETE_RULE               | varchar(64)                             | NO             | The value of the ON DELETE attribute of the constraint. Valid values: CASCADE, SET NULL, RESTRICT, NO ACTION |
