...
The `oceanbase.DBA_OB_BACKUP_DELETE_TASK_HISTORY` view displays the history of the backup set/piece cleanup tasks that have been completed in the tenant.
