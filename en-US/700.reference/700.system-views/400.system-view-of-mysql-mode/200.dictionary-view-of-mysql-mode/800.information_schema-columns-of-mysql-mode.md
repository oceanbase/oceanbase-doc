...
| TABLE_NAME               | varchar(256)        | NO             | The name of the table corresponding to the column.                   |
...
| CHARACTER_SET_NAME       | varchar(128)        | YES            | The name of the character set corresponding to the column.                       |
...
| PRIVILEGES               | varchar(200)        | NO             | Privilege information.                           |
| COLUMN_COMMENT           | varchar(2048)       | NO             | Comments.                             |
| GENERATION_EXPRESSION    | varchar(262144)     | NO             | For generated columns, displays the expression used to calculate the column value. For non-generated columns, it is empty. |
