...
| NUMERIC_PRECISION        | bigint(20) unsigned | YES            | The precision of the column.                     |
...
| COLUMN_KEY               | varchar(3)          | NO             | Indicates whether the column is an index or a primary key.     |
| EXTRA                    | varchar(4096)       | NO             | Additional information.                        |
| PRIVILEGES               | varchar(200)        | NO             | The privileges.                             |
| COLUMN_COMMENT           | varchar(2048)       | NO             | The comment.                                |
| GENERATION_EXPRESSION    | varchar(262144)     | NO             | For generated columns, the expression used to calculate the column value. For non-generated columns, this column is empty. |
