...
|slug|oceanbase-dba_wr_statname-mysql-compatible-mode|
...
Displays the name of the system statistic item for the current tenant.
...
Query the name of the system statistic item for this tenant and display the first record.
