...
The `oceanbase.DBA_OB_TABLET_REPLICAS` view displays information about all tablet replicas in the current tenant. Each tablet replica is uniquely identified by the joint key string of `<TABLET_ID, SVR_IP, SVR_PORT, LS_ID>`.
