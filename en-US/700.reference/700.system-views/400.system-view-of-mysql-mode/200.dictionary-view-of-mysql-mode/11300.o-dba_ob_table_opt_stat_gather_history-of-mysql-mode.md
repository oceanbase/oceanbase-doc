...
| TASK_ID | varchar(36) | NO | The task ID of the table statistics collection. |
...
| MEMORY_USED | bigint(20) | YES | The memory used for the table statistics collection. |
| STAT_REFRESH_FAILED_LIST | text | YES | The list of failed statistics refreshes. |
| PROPERTIES | text | YES | The property settings for the table statistics collection. |
