...
`ALL_PLSQL_TYPE_ATTRS` displays the general information of record types defined in a package.
...
Execute the following statement to query the attributes of all PL/SQL record types and table types.
