...
<main id="notice" >
    <h4>Note</h4>
    <p>This view is available starting with V4.3.5 for V4.3.x versions. <br>It is available starting with V4.2.5 for V4.2.x versions. </p>
  </main>

## Purpose

`DBA_PLSQL_TYPE_ATTRS` displays overall information about record types defined in a package. The types in a package can be displayed in this view only after the package is successfully compiled.
...
* Query overall information about record types defined in a package: [ALL_PLSQL_TYPE_ATTRS](2770.all-plsql-type-attrs-oracle-mode.md).
* Query overall information about record types defined in the current user's package: [USER_PLSQL_TYPE_ATTRS](26870.user-plsql-type-attrs-oracle-mode.md).