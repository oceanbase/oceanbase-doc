...
`DBA_PLSQL_TYPE_ATTRS` displays general information about record types defined in packages. A package type can be displayed in this view only after the package is successfully compiled.
...
| PACKAGE_NAME       | VARCHAR2(128) | YES  | Name of the package containing the PL/SQL type. |
| ATTR_NAME          | VARCHAR2(128) | NO   | The name of the attribute. |
...
| ATTR_TYPE_NAME       | VARCHAR2(136) | NO   | The attribute type name. |
| ATTR_TYPE_PACKAGE  | VARCHAR2(128) | NO   | The name of the package containing the attribute type. |
| LENGTH            | NUMBER(38)    | NO   | The length of the property value. |
| PRECISION          | NUMBER(38)    | NO   | The precision of the attribute value. |
| SCALE              | NUMBER(38)    | NO   | The ratio of attribute value. |
| CHARACTER_SET_NAME | VARCHAR2(44)  | NO   | The name of the character set. |
| ATTR_NO            | NUMBER(38)    | NO   | The number that specifies the order of the attribute. |
| CHAR_USED          | VARCHAR2(1)   | NO   | Specifies whether to use a character data type. |
...
* To query the overall information of the record type defined in the package, see [ALL_PLSQL_TYPE_ATTRS](2770.all-plsql-type-attrs-oracle-mode.md).
* To query the overall information of the record type defined in the current user's package, see [USER_PLSQL_TYPE_ATTRS](26870.user-plsql-type-attrs-oracle-mode.md).