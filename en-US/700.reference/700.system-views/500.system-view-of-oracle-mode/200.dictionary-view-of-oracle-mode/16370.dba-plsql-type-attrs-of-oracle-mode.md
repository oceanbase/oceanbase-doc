...
|machine-translation||
|slug|dba-plsql-type-attrs-oracle-mode|
...
The `DBA_PLSQL_TYPE_ATTRS` view displays the overall information about the RECORD data types defined in packages of the current tenant.
...
View the general information about record types defined in all packages of the current tenant.
...
* View information about record types defined in all packages accessible to the current user: [ALL_PLSQL_TYPE_ATTRS](2770.all-plsql-type-attrs-oracle-mode.md)

* View information about record types defined in all packages owned by the current user: [USER_PLSQL_TYPE_ATTRS](26870.user-plsql-type-attrs-oracle-mode.md)
