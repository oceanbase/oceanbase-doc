...
This view displays the columns in the primary partitioning key of all partitioned objects owned by the current user.
...
* Query the columns in the primary partitioning key of all partitioned objects in the current tenant: [DBA_PART_KEY_COLUMNS](17400.dba_part_key_columns-of-oracle-mode.md)

* Query the columns in the primary partitioning key of all partitioned objects accessible to the current user: [ALL_PART_KEY_COLUMNS](2800.all_part_key_columns-of-oracle-mode.md)