...
|slug|dba_source-oracle-compatible-mode|
...
This view displays the text sources of all stored objects in the current tenant. The columns in this view are the same as those in `ALL_SOURCE`.
...
Query the text sources of all stored objects in the current tenant and display the first two records.
...
* Query the text sources of all stored objects accessible to the current user: [ALL_SOURCE](4000.all_source-of-oracle-mode.md)
