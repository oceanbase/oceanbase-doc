...
This view displays the text sources of all stored objects in the current tenant. The columns of this view are the same as those of `ALL_SOURCE`.
...
* Query the text sources of all stored objects owned by the current user: [USER_SOURCE](29600.user_source-of-oracle-mode.md)