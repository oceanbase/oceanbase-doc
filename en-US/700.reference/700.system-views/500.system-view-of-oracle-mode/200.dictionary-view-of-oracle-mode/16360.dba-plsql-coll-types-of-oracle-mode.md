...
* View information about collection types in packages accessible to the current user: [ALL_PLSQL_COLL_TYPES](2760.all-plsql-coll-type-of-oracle-mode.md)
* View information about collection types in packages owned by the current user: [USER_PLSQL_COLL_TYPES](26860.user-plsql-coll-types-oracle-mode.md)
