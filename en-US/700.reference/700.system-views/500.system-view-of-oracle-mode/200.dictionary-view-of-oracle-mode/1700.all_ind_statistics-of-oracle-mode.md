...
| USER_STATS | VARCHAR2(3) | NO | Indicates whether statistics were directly input by the user. Valid values: <ul><li>YES</li><li>NO</li></ul>  |
...
* To query the statistics of indexes on tables that you own, see [USER_IND_STATISTICS](26600.user_ind_statistics-of-oracle-mode.md).
