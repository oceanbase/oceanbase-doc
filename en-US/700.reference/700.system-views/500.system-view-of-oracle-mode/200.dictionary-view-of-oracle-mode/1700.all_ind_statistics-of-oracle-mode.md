...
* To query the statistics of indexes on tables owned by the current user, see [USER_IND_STATISTICS](26600.user_ind_statistics-of-oracle-mode.md).

* To query the statistics of indexes on tables in the current tenant, see [DBA_IND_STATISTICS](8600.dba_ind_statistics-of-oracle-mode.md).
