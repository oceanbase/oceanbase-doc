...
| USER_STATS | VARCHAR2(3) | NO | Indicates whether statistics are directly input by users. Valid values: <ul><li>YES</li><li>NO</li></ul>  |
...
* To view the statistics of indexes on tables owned by the current user, query the [USER_IND_STATISTICS](26600.user_ind_statistics-of-oracle-mode.md) view.

* To view the statistics of indexes on all tables in the current tenant, query the [DBA_IND_STATISTICS](8600.dba_ind_statistics-of-oracle-mode.md) view.
...
* To view column statistics at the global level, query the following views:
