...
This view lists all user-defined types that the current user can access.
...
Query all user-defined types that the current user can access.
...
* Query all user-defined types owned by the current user: [USER_TYPES](32000.user_types-of-oracle-mode.md)