...
This view lists the user-defined types accessible to the current user.
...
| INCOMPLETE       | CHAR(2)       | NO             | Indicates whether the type is incomplete. An incomplete type has a name but no methods or attributes.     |
...
Query all user-defined types accessible to the current user.
...
* Query user-defined types owned by the current user: [USER_TYPES](32000.user_types-of-oracle-mode.md)