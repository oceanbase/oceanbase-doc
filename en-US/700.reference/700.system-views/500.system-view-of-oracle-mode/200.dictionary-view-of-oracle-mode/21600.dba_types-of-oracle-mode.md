...
This view lists all user-defined types in the database.
...
| PREDEFINED       | CHAR(2)       | NO             | Indicates whether the type is a system predefined type.                |
...
| TYPEID           | NUMBER(38)    | YES            | The type ID.  |
...
* Query all user-defined types accessible to the current user: [ALL_TYPES](6000.all_types-of-oracle-mode.md)

* Query all user-defined types owned by the current user: [USER_TYPES](30500.user_types-of-oracle-mode.md)