...
Query the strategy group information of the views that the current user owns.
...
* Query the strategy group information of the views that the current user can access: [ALL_POLICY_GROUPS](3200.all_policy_groups-oracle.md)
