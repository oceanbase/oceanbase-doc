...
| STATUS                  | VARCHAR2(8)    | NO         | Indicates whether the non-partitioned index is valid or unusable. |
...
Query the index information of the `TBL2` table that is accessible to the current user.
...
* [USER_INDEXES](26100.user_indexes-of-oracle-mode.md)
