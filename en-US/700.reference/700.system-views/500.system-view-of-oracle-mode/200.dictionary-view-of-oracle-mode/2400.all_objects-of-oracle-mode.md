...
|slug|all_objects-of-oracle-mode|
...
| EDITIONABLE | VARCHAR2(1) | NO | Valid values:<li>`Y`: The object is marked as EDITIONABLE.<li>`N`: The object is marked as NONEDITIONABLE.<li>`NULL`: The object type is not editable in the database. |
