...
| PRIV_USED          | VARCHAR2(40)                | NO             | This field is not supported. It is NULL by default.                       |
| CLIENT_ID          | VARCHAR2(40)                | NO             | This field is not supported. It is NULL by default. |
| ECONTEXT_ID        | VARCHAR2(40)                | NO             | This field is not supported. It is NULL by default.                      |
...
| INSTANCE_NUMBER    | VARCHAR2(40)                | NO             | This field is not supported. It is NULL by default.    |
| OS_PROCESS         | VARCHAR2(40)                | NO             | This field is not supported. It is NULL by default.                         |
| TRANSACTIONID      | VARCHAR2(128)               | NO             | The transaction ID of the transaction in which the object is accessed or modified.                                          |
| SCN                | NUMBER(38)                  | NO             | This field is not supported. It is 0 by default.                        |
| SQL_BIND           | VARCHAR2(2000)              | YES            | This field is not supported. It is NULL by default.                         |
| SQL_TEXT           | VARCHAR2(2000)              | YES            | The SQL text of the query.                                                |
| OBJ_EDITION_NAME   | VARCHAR2(128)               | NO             | This field is not supported. It is NULL by default.                     |
...
* Query the action ID and name in the audit records: [AUDIT_ACTIONS](6500.audit_actions-of-oracle-mode.md)
