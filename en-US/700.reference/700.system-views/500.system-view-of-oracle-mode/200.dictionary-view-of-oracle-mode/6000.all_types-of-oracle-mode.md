...
This view lists the user-defined types that are accessible to the current user.
...
| TYPE_OID         | NUMBER(38)    | NO             | The object ID of the type.                    |
| TYPECODE         | VARCHAR2(10)  | NO             | The type of the object, for example, OBJECT or COLLECTION. |
...
* Query all user-defined types in the current tenant: [DBA_TYPES](21600.dba_types-of-oracle-mode.md)
