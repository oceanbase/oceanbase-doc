...
* View the column statistics of all partitions in all partitioned tables in the current tenant: [DBA_PART_COL_STATISTICS](17100.dba_part_col_statistics-of-oracle-mode.md)

* View the column statistics of all partitions in all partitioned tables that you own: [USER_PART_COL_STATISTICS](27900.user_part_col_statistics-of-oracle-mode.md)
