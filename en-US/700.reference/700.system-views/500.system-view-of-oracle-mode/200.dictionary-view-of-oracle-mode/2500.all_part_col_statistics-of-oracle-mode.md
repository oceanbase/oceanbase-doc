...
`ALL_PART_COL_STATISTICS` displays the column statistics and histogram information of partitions in the partitioned tables accessible to the current user.
...
| GLOBAL_STATS   | VARCHAR2(3)   | YES            | <ul><li>`YES`: indicates that the statistics were directly collected.   </li><li> `NO`: indicates that the statistics were derived from subpartition statistics or not collected. </li></ul>    |
| USER_STATS     | VARCHAR2(3)   | YES            | Indicates whether the partition statistics were user-defined.                                                 |
...
Query the column statistics and histogram information of partitions in the partitioned table `T_SUBPART` accessible to the current user.
...
* To query table-level column statistics, execute the following views:
...
* To query global column statistics, execute the following views:
...
* To query subpartition-level column statistics, execute the following views:
...
* To query table-level histogram statistics, execute the following views:
...
* To query partition-level histogram statistics, execute the following views:
...
* To query subpartition-level histogram statistics, execute the following views:
...
* To query index statistics, execute the following views:
