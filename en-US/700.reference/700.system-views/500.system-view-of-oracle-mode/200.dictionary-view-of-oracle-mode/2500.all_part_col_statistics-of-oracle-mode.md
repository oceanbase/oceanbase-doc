...
|slug|all_part_col_statistics-of-oracle-mode|
...
The `ALL_PART_COL_STATISTICS` view displays the column statistics and histograms on the partitions in the partitioned tables accessible to the current user.
