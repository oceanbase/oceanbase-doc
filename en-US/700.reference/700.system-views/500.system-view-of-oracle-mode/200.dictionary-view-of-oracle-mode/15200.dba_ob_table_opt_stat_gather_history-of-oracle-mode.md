...
This view displays the execution status of the historical statistics collection for tables in the current tenant.
...
| STATUS | VARCHAR2(8) | NO | The status of the statistics collection task. Valid values: SUCCESS and FAILED. |
...
| STAT_REFRESH_FAILED_LIST | VARCHAR2(4096) | YES | The list of statistics refresh failures. |
| PROPERTIES | VARCHAR2(4096) | YES | The properties of the statistics collection. |

## Sample query

Query the execution status of the historical statistics collection for the `T2_M_LR` table in the current tenant.
...
* View the status of the historical statistics collection at the tenant level: [DBA_OB_TASK_OPT_STAT_GATHER_HISTORY](../200.dictionary-view-of-oracle-mode/16000.dba_ob_task_opt_stat_gather_history-of-oracle-mode.md)
