...
* To query the column statistics of all tenants, see [CDB_TAB_COL_STATISTICS](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/12700.o-cdb_tab_col_statistics-of-sys-tenant.md).

* To query the column statistics of tables accessible to the current user, see [ALL_TAB_COL_STATISTICS](4600.all_tab_col_statistics-of-oracle-mode.md).

* To query the column statistics of tables owned by the current user, see [USER_TAB_COL_STATISTICS](30300.user_tab_col_statistics-of-oracle-mode.md).
