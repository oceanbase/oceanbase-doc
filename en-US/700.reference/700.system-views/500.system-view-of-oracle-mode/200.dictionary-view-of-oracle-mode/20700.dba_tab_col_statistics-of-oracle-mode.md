...
| SAMPLE_SIZE   | NUMBER        | NO             | The sample size when the statistics were collected.                                    |
...
* View column statistics for all tenants: [CDB_TAB_COL_STATISTICS](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/12700.o-cdb_tab_col_statistics-of-sys-tenant.md)

* View column statistics for tables accessible to the current user: [ALL_TAB_COL_STATISTICS](4600.all_tab_col_statistics-of-oracle-mode.md)

* View column statistics for tables owned by the current user: [USER_TAB_COL_STATISTICS](30300.user_tab_col_statistics-of-oracle-mode.md)

* View column statistics at the table level:
...
* View column statistics at the partition level:
...
* View column statistics at the subpartition level:
...
* View histogram statistics at the table level:
...
* View histogram statistics at the partition level:
...
* View histogram statistics at the subpartition level:
