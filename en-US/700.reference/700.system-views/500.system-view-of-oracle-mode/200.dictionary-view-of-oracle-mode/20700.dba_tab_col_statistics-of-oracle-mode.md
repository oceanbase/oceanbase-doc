...
This view displays the column statistics and histogram information for all tables in the current tenant.
...
| SAMPLE_SIZE   | NUMBER        | NO             | The sample size during the analysis                                    |
...
| USER_STATS    | VARCHAR2(3)   | NO             | Indicates whether the partition statistics were user-defined                              |
| NOTES         | VARCHAR2(80)  | NO             | Records some additional properties                                   |
...
Query the column statistics and histogram information for the `T_SUBPART` table in the current user tenant.
...
* To view column statistics for all tenants, see [CDB_TAB_COL_STATISTICS](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/12700.o-cdb_tab_col_statistics-of-sys-tenant.md).

* To view column statistics for tables accessible to the current user, see [ALL_TAB_COL_STATISTICS](4600.all_tab_col_statistics-of-oracle-mode.md).

* To view column statistics for tables owned by the current user, see [USER_TAB_COL_STATISTICS](30300.user_tab_col_statistics-of-oracle-mode.md).
