...
Displays the partition information of partitions of partitioned indexes accessible to the current user.
...
| DEF_INITIAL_EXTENT        | VARCHAR2(40)   | NO             | This field is not supported. The default value is NULL.             |
| DEF_NEXT_EXTENT           | VARCHAR2(40)   | NO             | This field is not supported. The default value is NULL.          |
| DEF_MIN_EXTENTS           | VARCHAR2(40)   | NO             | This field is not supported. The default value is NULL.            |
| DEF_MAX_EXTENTS           | VARCHAR2(40)   | NO             | This field is not supported. The default value is NULL.       |
| DEF_MAX_SIZE              | VARCHAR2(40)   | NO             | This field is not supported. The default value is NULL.       |
| DEF_PCT_INCREASE          | VARCHAR2(40)   | NO             | This field is not supported. The default value is NULL.       |
...
| DEF_LOGGING               | VARCHAR2(7)    | NO             | This field is not supported. The default value is NULL.          |
