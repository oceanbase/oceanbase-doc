...
| SAMPLE_SIZE   | NUMBER        | YES            | The sampling size during the analysis.                                    |
...
* View the statistics of tables accessible to the current user: [ALL_TAB_COL_STATISTICS](4600.all_tab_col_statistics-of-oracle-mode.md)

* View the statistics of all tables in the current tenant: [DBA_TAB_COL_STATISTICS](20700.dba_tab_col_statistics-of-oracle-mode.md)
...
* To query index statistics, query the following views:
