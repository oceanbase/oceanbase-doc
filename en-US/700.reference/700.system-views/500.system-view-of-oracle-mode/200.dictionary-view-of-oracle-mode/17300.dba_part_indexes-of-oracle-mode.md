...
| DEF_MAX_EXTENTS | VARCHAR2(40) | NO | The default `MAXEXTENTS` value for a local index when a table partition is added. If no `MAXEXTENTS` value was specified, the value is `DEFAULT`. |
