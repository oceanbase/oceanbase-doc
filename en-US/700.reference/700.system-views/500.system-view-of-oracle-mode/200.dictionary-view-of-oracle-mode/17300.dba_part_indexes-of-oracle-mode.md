...
| DEF_SUBPARTITION_COUNT    | NUMBER         | NO         | For a composite partitioned index, the default number of subpartitions (if specified).        |
| PARTITIONING_KEY_COUNT    | NUMBER         | NO         | The number of columns in the partitioning key.                    |
| SUBPARTITIONING_KEY_COUNT | NUMBER         | NO         | For a composite partitioned index, the number of columns in the subpartitioning key.       |
...
| DEF_TABLESPACE_NAME       | VARCHAR2(30)   | NO         | For a local index, the default tablespace when adding or splitting table partitions.           |
...
| AUTOLIST                  | VARCHAR2(3)    | NO         | Indicates whether the local index is automatically list-partitioned. Valid values: <ul><li>YES</li><li>NO</li></ul>        |
...
* To view the partition information of all partition indexes in all tenants: [CDB_PART_INDEXES](../../300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/12200.o-cdb_part_indexes-of-sys-tenant.md)

* To view the partition information of all partition indexes accessible to the current user: [ALL_PART_INDEXES](2700.all_part_indexes-of-oracle-mode.md)

* To view the partition information of all partition indexes owned by the current user: [USER_PART_INDEXES](28100.user_part_indexes-of-oracle-mode.md)