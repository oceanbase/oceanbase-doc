...
This view displays the context information of views accessible to the current user. When accessing a view, the corresponding strategy group is selected based on the context value.
