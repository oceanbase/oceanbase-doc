...
| RESULT | VARCHAR2(64) | YES | The result of the task. Valid values: <ul><li>`SUCCESS`: The import task is completed successfully. </li><li>`FAIL`: The import task failed. </li></ul> |
