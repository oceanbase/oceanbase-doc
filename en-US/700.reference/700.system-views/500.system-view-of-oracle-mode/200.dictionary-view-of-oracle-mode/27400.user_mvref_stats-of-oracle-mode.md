...
| ELAPSED_TIME | NUMBER | NO | The duration of the refresh, in seconds. <ul><li>For versions earlier than V4.4.2 BP2, the unit is seconds.</li><li>For V4.4.2, starting from V4.4.2 BP2, the unit is microseconds.</li></ul> |
