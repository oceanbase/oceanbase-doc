...
Check the access control policies that the current user can access.
...
* [USER_POLICIES](28400.user_policies-oracle.md): View the access control policies that the current user owns.

* [DBA_POLICIES](17600.dba_policies-oracle.md): View all access control policies in the current tenant.