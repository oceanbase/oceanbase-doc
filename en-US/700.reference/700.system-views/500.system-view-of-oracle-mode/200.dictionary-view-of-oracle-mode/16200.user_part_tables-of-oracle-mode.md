...
| PARTITIONING_TYPE        | VARCHAR2(9)    | NO                  | The partitioning type. Valid values: <ul><li>HASH</li><li>RANGE</li><li>LIST</li></ul>           |
| SUBPARTITIONING_TYPE     | VARCHAR2(9)    | NO                  | The subpartitioning type. Valid values: <li>HASH</li><li>RANGE</li><li>LIST</li>                 |
...
| DEF_INDEXING             | VARCHAR2(3)    | NO                  | Indicates indexing properties for the table. Valid values: <li>ON-INDEXING: Explicitly set to ON or not specified.</li><li>OFF-INDEXING: Explicitly set to OFF.</li> |
