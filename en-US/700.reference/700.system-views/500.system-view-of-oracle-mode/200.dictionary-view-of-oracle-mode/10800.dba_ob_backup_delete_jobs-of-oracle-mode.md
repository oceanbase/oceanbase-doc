...
| JOB_LEVEL | VARCHAR2(64) | NO | The job initiation level. Valid values: <ul><li> `USER_TENANT`: a user tenant initiates the task. </li><li> `SYS_TENANT`: a system tenant initiates the task. </li></ul> |
