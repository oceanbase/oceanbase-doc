...
| GLOBAL_STATS              | VARCHAR2(3)   | YES            | <ul><li>`YES`: Indicates that statistics were directly collected or incrementally maintained.   </li><li> `NO`: Other cases </li></ul>   |
...
* Query the optimizer statistics of all tables in the current schema: [DBA_TAB_STATISTICS](21500.dba_tab_statistics-of-oracle-mode.md)
