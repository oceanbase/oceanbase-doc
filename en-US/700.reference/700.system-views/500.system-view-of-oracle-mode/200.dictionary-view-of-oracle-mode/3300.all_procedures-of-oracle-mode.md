...
This view displays all functions and procedures accessible to the current user, along with their related attributes.
...
Query all functions and procedures accessible to the current user, along with their related attributes, and display the first 10 records.
