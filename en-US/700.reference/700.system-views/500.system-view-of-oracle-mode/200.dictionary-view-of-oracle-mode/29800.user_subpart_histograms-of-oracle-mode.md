...
This view displays histogram information of subpartitions of partitioned tables owned by the current user.
...
Query the histogram information of subpartitions of the `T_SUBPART` table in the partitioned tables owned by the current user.
...
* Query the histogram information of subpartitions of partitioned tables accessible to the current user: [ALL_SUBPART_HISTOGRAMS](4200.all_subpart_histograms-of-oracle-mode.md)

* Query the histogram information of subpartitions of all partitioned tables in the current tenant: [DBA_SUBPART_HISTOGRAMS](20200.dba_subpart_histograms-of-oracle-mode.md)

* Query the histogram information of tables at the table level:
...
* Query the histogram information of partitions at the partition level:
...
* Query the column statistics at the table level:
...
* Query the column statistics at the global level:
...
* Query the column statistics at the partition level:
...
* Query the column statistics at the subpartition level:
