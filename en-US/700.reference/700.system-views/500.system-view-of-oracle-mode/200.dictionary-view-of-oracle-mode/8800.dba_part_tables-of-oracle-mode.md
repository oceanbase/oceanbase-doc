...
| PARTITIONING_TYPE        | VARCHAR2(9)    | NO                  | The partition type. Valid values: <li>HASH</li><li>RANGE</li><li>LIST</li>                       |
| SUBPARTITIONING_TYPE     | VARCHAR2(9)    | NO                  | The subpartition type. Valid values: <li>HASH</li><li>RANGE</li><li>LIST</li>                    |
...
| DEF_MIN_EXTENTS          | VARCHAR2(40)   | NO                  | This column is currently not supported and defaults to `NULL`.                   |
| DEF_MAX_EXTENTS          | VARCHAR2(40)   | NO                  | This column is currently not supported and defaults to `NULL`.                   |
...
| INTERVAL                 | VARCHAR2(1000) | YES                 | This column is currently not supported and defaults to `NULL`.                   |
...
| DEF_INDEXING             | VARCHAR2(3)    | NO                  | Indicates the indexing properties for the table. Valid values: <li>ON-INDEXING: Explicitly set to ON or not specified.</li><li>OFF-INDEXING: Explicitly set to OFF.</li> |
