...
|slug|dba_part_tables-of-oracle-mode|
...
| DEF_INMEMORY_SERVICE | VARCHAR2(12) | NO | At present, this column is not supported and is `NULL` by default.                      |
| DEF_INMEMORY_SERVICE_NAME | VARCHAR2(1000) | NO | At present, this column is not supported and is `NULL` by default.          |
