...
| DATA_SIZE     | NUMBER       | NO         | The actual size of the data.                                                     |
| REQUIRED_SIZE | NUMBER       | NO         | The size of the space allocated to the data. The data is stored in macroblocks of 2 MB as the smallest unit, so `REQUIRED_SIZE >= DATA_SIZE` |

## Sample query

Query the tablet replica information of the current tenant and display the first 10 records.
