...
The `USER_ALL_TABLES` view displays object tables and relational tables accessible to the current user. It has the same columns as `ALL_ALL_TABLES` except for the `OWNER` column.
