...
|slug|all_tab_histograms-oracle-compatible-mode|
...
* To view the table-level histogram statistics of all tables in the current tenant, see [DBA_TAB_HISTOGRAMS](20300.dba_tab_histograms-of-oracle-mode.md).

* To view the table-level histogram statistics of all tables owned by the current user, see [USER_TAB_HISTOGRAMS](29200.user_tab_histograms-of-oracle-mode.md).
