...
* Query all columns of all tables and views that the current user can access: [ALL_TAB_COLUMNS](4600.all_tab_columns-of-oracle-mode.md)

* Query all columns of tables and views owned by the current user: [USER_TAB_COLUMNS](29000.user_tab_columns-of-oracle-mode.md)