...
* To view the ordering of all triggers in the current tenant: [DBA_TRIGGER_ORDERING](22000.dba_trigger_ordering-oracle.md)

* To view the ordering of triggers owned by the current user: [USER_TRIGGER_ORDERING](31600.user_trigger_ordering-oracle.md)
