...
| EXECUTE_RESULT | VARCHAR2(2048) | NO | The task execution result and duration, in the format of “[ret:0; elapsed:72160;]”. |
| CREATE_TIME | TIMESTAMP(6) | NO | The task generation time. |
| FINISH_TIME | TIMESTAMP(6) | NO | The task completion time. |
...
| ARBITRATION_SERVICE_TYPE | VARCHAR2(64) | NO | The type of the arbitration service. The only supported value is `ADDR`. |
