...
|slug|dba_subpart_histograms-oracle-compatible-mode|
...
This view displays histogram information of subpartitions in all partitioned tables of the current tenant.

## Columns

|           Column            |       Type       | Nullable |      Description       |
|---------------------------|----------------|------------|---------------|
| OWNER                     | VARCHAR2(128)  | NO         | The user to whom the histogram belongs.      |
...
| ENDPOINT_ACTUAL_VALUE_RAW | VARCHAR2(4000) | NO         | The binary value of the endpoint of the bucket. |
| ENDPOINT_REPEAT_COUNT     | NUMBER         | NO         | The frequency of the endpoint value of the bucket. |

## Sample query

Query histogram information of subpartitions in the partitioned table `T_SUBPART` of the current tenant.
...
* Query histogram information of subpartitions in partitioned tables accessible to the current user: [ALL_SUBPART_HISTOGRAMS](4000.all_subpart_histograms-of-oracle-mode.md)

* Query histogram information of subpartitions in partitioned tables owned by the current user: [USER_SUBPART_HISTOGRAMS](28300.user_subpart_histograms-of-oracle-mode.md)

* Query table-level histogram statistics by using the following views:
...
* Query partition-level histogram statistics by using the following views:
...
* Query table-level column statistics by using the following views:
...
* Query global-level column statistics by using the following views:
...
* Query partition-level column statistics by using the following views:
...
* Query subpartition-level column statistics by using the following views:
...
* Query index statistics by using the following views:
