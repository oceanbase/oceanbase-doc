...
This view displays the subpartition name, table name, partition name, and storage attributes of the subpartitions of tables accessible to the current user.
...
Query the subpartition information of the `TBL2_F_RL` table in the partitioned tables that the current user can access.
...
* Query the subpartition information of all partitioned tables that the current user owns: [USER_TAB_SUBPARTITIONS](31300.user_tab_subpartitions-of-oracle-mode.md)

* Query the partition information of all partitioned tables that the current user can access: [ALL_TAB_PARTITIONS](5200.all_tab_partitions-of-oracle-mode.md)