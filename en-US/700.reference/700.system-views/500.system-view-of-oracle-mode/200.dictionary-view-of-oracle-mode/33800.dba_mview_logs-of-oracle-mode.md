...
| LAST_PURGE_STATUS | NUMBER | NO | The status of the last purge of the materialized view log. Valid values: <ul><li>Error codes  </li><li>`0`: The materialized view log was successfully purged. </li></ul><main id="notice" type='explain'> <h4>Note</h4><p>At present, the value of this column is fixed to `0`. </p></main> |
