...
The `ALL_PLSQL_TYPES` view displays information about all PL/SQL data types accessible to the current user.
...
The following statement queries all PL/SQL data types accessible to the current user.
