...
The `ALL_PLSQL_TYPES` view displays information about all package types.
...
Execute the following command to query information about all package types that you have access to.
