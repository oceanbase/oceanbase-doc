...
<main id="notice" >
    <h4>Note</h4>
    <p>This view is available starting with V4.3.5 for V4.3.x versions. <br> This view is available starting with V4.2.5 for V4.2.x versions. </p>
  </main>

## Purpose

The `ALL_PLSQL_TYPES` view displays general information about package types.
Only when a package is successfully compiled can its types be displayed in this view.
...
Execute the following command to query general information about all package types accessible to the current user.
