...
| AUDIT_OPTION       | VARCHAR2(40)                | NO             | The audit option set by the AUDIT statement.                                 |
...
| LOGOFF_PREAD       | NUMBER                      | NO             | This column is not supported. It is set to NULL by default.                        |
| LOGOFF_LWRITE      | NUMBER                      | NO             | This column is not supported. It is set to NULL by default.                       |
| LOGOFF_DLOCK       | VARCHAR2(40)                | NO             | This column is not supported. It is set to NULL by default.                     |
| COMMENT_TEXT       | VARCHAR2(65536)             | YES            | The text comment on the audit record, providing more information about the audited statement.                          |
...
| ENTRYID            | NUMBER(38)                  | NO             | The numeric ID of each audit tracking entry.                                         |
...
| PRIV_USED          | VARCHAR2(40)                | NO             | This field is not supported and is set to NULL by default.                    |
| CLIENT_ID          | VARCHAR2(40)                | NO             | This field is not supported and is set to NULL by default.                     |
| ECONTEXT_ID        | VARCHAR2(40)                | NO             | This field is not supported and is set to NULL by default.                   |
...
| INSTANCE_NUMBER    | VARCHAR2(40)                | NO             | This field is not supported and is set to NULL by default. |
| OS_PROCESS         | VARCHAR2(40)                | NO             | This field is not supported and is set to NULL by default.                   |
| TRANSACTIONID      | VARCHAR2(128)               | NO             | The transaction identifier in which the object was accessed or modified.                                       |
| SCN                | NUMBER(38)                  | NO             | This field is not supported and is set to 0 by default.                     |
| SQL_BIND           | VARCHAR2(2000)              | YES            | This field is not supported and is set to NULL by default.                      |
| SQL_TEXT           | VARCHAR2(2000)              | YES            | The SQL text of the query.                                             |
| OBJ_EDITION_NAME   | VARCHAR2(128)               | NO             | This field is not supported and is set to NULL by default.                  |
...
* Query all audit trail entries for the current tenant: [DBA_AUDIT_TRAIL](7200.dba_audit_trail-of-oracle-mode.md)
