...
* To view the statistics of tables accessible to the current user, see [ALL_TAB_COL_STATISTICS](4400.all_tab_col_statistics-of-oracle-mode.md).

* To view the statistics of all tables in the current tenant, see [DBA_TAB_COL_STATISTICS](19900.dba_tab_col_statistics-of-oracle-mode.md).
