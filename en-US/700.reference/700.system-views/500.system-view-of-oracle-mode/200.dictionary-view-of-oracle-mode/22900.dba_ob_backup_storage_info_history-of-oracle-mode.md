...
|slug|dba_ob_backup_storage_info_history-of-oracle-mode|
...
| DEST_TYPE | VARCHAR2(64) | YES | The type of the backup destination, which can be:<ul><li>`archive_log`: Log archiving</li> <li>`backup_data`: Data backup</li></ul> |
