...
This view displays the parameters of functions and procedures owned by the current user. It contains the same columns as `ALL_ARGUMENTS`, except for the `OWNER` column.
...
| TYPE_SUBNAME       | VARCHAR2(128) | YES            | If the data type is in a package, this field represents the package name.                                                                                  |
