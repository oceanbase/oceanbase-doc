...
This view displays the parameters of the functions and procedures owned by the current user. The columns in this view are the same as those in the `ALL_ARGUMENTS` view, except that the `OWNER` column is removed.
...
Query the parameters of the functions and procedures owned by the current user and display the first two records.
...
* Query the parameters of all available functions and procedures in the current tenant: [DBA_ARGUMENTS](6700.dba_arguments-of-oracle-mode.md)
