...
This view displays the index column information of all tables that the current user can access.
...
Query the index column information of the index table `TBL2` that the current user can access.
