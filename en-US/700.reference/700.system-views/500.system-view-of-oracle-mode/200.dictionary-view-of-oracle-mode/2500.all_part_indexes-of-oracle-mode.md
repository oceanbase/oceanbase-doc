...
|machine-translation||
|slug|all_part_indexes|

# ALL_PART_INDEXES

<main id="notice" type='explain'>
<h4>Note</h4>
<p>This view has been available since V2.2.77. </p>
</main>
-----------
## Purpose

Displays partition information for partitions accessible to the current user.
The `ALL_PART_INDEXES` view displays the partitioning information of all partitioned indexes accessible to the current user.
