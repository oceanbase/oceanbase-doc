...
This view differs from the [USER_TAB_COLUMNS](30500.user_tab_columns-of-oracle-mode.md) view in that this view displays quickly deleted columns but the `USER_TAB_COLUMNS` view does not.
