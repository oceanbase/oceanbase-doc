...
The `DBA_TAB_STATS_HISTORY` view displays the change history of the table statistics of all tables in the current tenant.
...
* [ALL_TAB_STATS_HISTORY](5500.all_tab_stats_history-of-oracle-mode.md): View the table statistics modification history of all tables that the current user can access.
