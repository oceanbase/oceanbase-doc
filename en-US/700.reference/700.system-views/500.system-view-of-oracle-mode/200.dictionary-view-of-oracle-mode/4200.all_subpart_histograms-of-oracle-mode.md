...
This view displays histogram information for all subpartitions of partitioned tables accessible to the current user.
...
| SUBPARTITION_NAME         | VARCHAR2(128)  | NO         | The name of the subpartition that owns the histogram.    |
...
Query the histogram information of subpartitions of the `T_SUBPART` table accessible to the current user.
...
* Query the histogram information of all subpartitions of partitioned tables in the current tenant: [DBA_SUBPART_HISTOGRAMS](20200.dba_subpart_histograms-of-oracle-mode.md)

* Query the histogram information of subpartitions of partitioned tables owned by the current user: [USER_SUBPART_HISTOGRAMS](29800.user_subpart_histograms-of-oracle-mode.md)
...
* Query table-level column statistics from the following views:
