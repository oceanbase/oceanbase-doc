...
| SAMPLE_SIZE   | NUMBER        | YES            | The sample size during the analysis                                    |
...
* To view the column statistics of all tables in the current tenant, see [DBA_TAB_COL_STATISTICS](20700.dba_tab_col_statistics-of-oracle-mode.md).

* To view the column statistics of tables owned by the current user, see [USER_TAB_COL_STATISTICS](30300.user_tab_col_statistics-of-oracle-mode.md).
