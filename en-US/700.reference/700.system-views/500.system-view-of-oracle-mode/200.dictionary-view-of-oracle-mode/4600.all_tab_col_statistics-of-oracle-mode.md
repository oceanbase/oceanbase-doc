...
| SAMPLE_SIZE   | NUMBER        | YES            | The sample size when the column was analyzed                                    |
...
* To query the column statistics of all tables in the current tenant, see [DBA_TAB_COL_STATISTICS](20700.dba_tab_col_statistics-of-oracle-mode.md).

* To query the column statistics of tables that the current user owns, see [USER_TAB_COL_STATISTICS](30300.user_tab_col_statistics-of-oracle-mode.md).
