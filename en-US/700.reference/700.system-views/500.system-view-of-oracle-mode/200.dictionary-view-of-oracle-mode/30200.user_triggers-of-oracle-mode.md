...
## Purpose
-----------
This operation shows all triggers owned by the current user.
The `USER_TRIGGERS` view displays the triggers owned by the current user.
...
* Query all triggers in the current tenant: [DBA_TRIGGERS](21300.dba_triggers-of-oracle-mode.md)
