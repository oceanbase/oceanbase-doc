...
| RESTORE_TENANT_NAME | VARCHAR2(128) | NO | The name of the tenant to restore. |
...
| FINISH_LS_COUNT        | NUMBER(38)   | NO   | The total number of log streams restored. |
| TABLET_COUNT           | NUMBER(38)   | NO   | The total number of tablets to restore. |
| FINISH_TABLET_COUNT    | NUMBER(38)   | NO   | The number of tablets restored. |
