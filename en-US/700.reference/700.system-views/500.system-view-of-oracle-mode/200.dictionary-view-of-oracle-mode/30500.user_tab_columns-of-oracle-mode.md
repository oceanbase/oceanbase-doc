...
This view displays all columns of tables and views owned by the current user.
...
* Query all columns of all tables or views accessible to the current user: [ALL_TAB_COLUMNS](4800.all_tab_columns-of-oracle-mode.md)

* Query all columns of all tables or views in the current tenant: [DBA_TAB_COLUMNS](20900.dba_tab_columns-of-oracle-mode.md)