...
This view displays the history of task-level backups for the tenant.

## Columns

| Column | Type | Nullable | Description |
|-------------------------------|----------------|-----------------|----------------------------------|
| TASK_ID | NUMBER(38) | NO | The task ID, which corresponds to the backup set. |
| JOB_ID | NUMBER(38) | NO | The job ID of the task. |
...
| ENCRYPTION_MODE | VARCHAR2(4096) | YES | The encryption mode. Valid values: <ul><li>None: indicates no encryption. </li><li>Password: indicates password protection only. </li><li>Password Encryption: indicates encryption and password protection. </li><li>Transparent Encryption: indicates Transparent Data Encryption (TDE). </li><li>Dual mode Encryption: indicates TDE and password protection. </li></ul> </br>Currently, only None and Password are supported. |
...
Query the history of task-level backups for the current user tenant.
...
* Query backup jobs for the current user tenant: [DBA_OB_BACKUP_JOBS](11300.dba_ob_backup_jobs-of-oracle-mode.md)

* Query the progress of task-level backups for the current user tenant: [DBA_OB_BACKUP_TASKS](11900.dba_ob_backup_tasks-of-oracle-mode.md)
