...
| DATA_SCALE           | NUMBER        | NO             | The number of digits to the right of the decimal point for numeric data. |
...
| SAMPLE_SIZE          | NUMBER        | NO             | The sampling size when the column was analyzed.              |
| CHARACTER_SET_NAME   | VARCHAR2(44)  | NO             | The name of the character set:<ul><li>`CHAR_CS`   </li><li> `NCHAR_CS` </li></ul>               |
...
| CHAR_LENGTH          | NUMBER        | NO             | The length of the column for character data.                              |
...
* Query the columns of all tables and views accessible to the current user: [ALL_TAB_COLUMNS](4800.all_tab_columns-of-oracle-mode.md)

* Query the columns of all tables and views owned by the current user: [USER_TAB_COLUMNS](30500.user_tab_columns-of-oracle-mode.md)