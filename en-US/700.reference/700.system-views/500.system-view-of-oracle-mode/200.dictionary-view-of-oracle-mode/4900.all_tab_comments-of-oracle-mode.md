...
* Query the comments of all tables and views in the current tenant: [DBA_TAB_COMMENTS](21000.dba_tab_comments-of-oracle-mode.md)

* Query the comments of all tables and views owned by the current user: [USER_TAB_COMMENTS](30600.user_tab_comments-of-oracle-mode.md)
