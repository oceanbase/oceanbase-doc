...
| ELAPSED_TIME | NUMBER | NO | The duration of the refresh. <ul><li>For versions earlier than V4.4.2 BP2, the unit is seconds.</li><li>For V4.4.2, starting from V4.4.2 BP2, the unit is microseconds.</li></ul> |
...
| LOG_PURGE_TIME | NUMBER | NO | The log purge time for the materialized views. <ul><li>For versions earlier than V4.4.2 BP2, the unit is seconds.</li><li>For V4.4.2, starting from V4.4.2 BP2, the unit is microseconds.</li></ul> |
...
| MVIEW_ID                 | NUMBER         | YES  | The ID of the materialized view. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.2, this column is available starting with V4.4.2 BP2. </p></main>|
...
| DATA_TARGET_SCN          | NUMBER         | YES  | The SCN when the target data was synchronized. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.2, this column is available starting with V4.4.2 BP2. </p></main>|
| TRACE_ID                 | VARCHAR2(64)   | YES  | The trace ID of the refresh task. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.2, this column is available starting with V4.4.2 BP2. </p></main>|
