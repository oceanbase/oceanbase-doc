...
| FLASHBACK_LOG_SCN |  NUMBER | NO | The point in time of the last log truncation operation performed by the tenant. After a failover, you can execute an operation to truncate logs of the original primary tenant to the specified point in time and add the standby tenant of the original primary tenant to the new primary tenant. <main id="notice" type='explain'><h4>Note</h4><p>This column was introduced in V4.4.1. </p></main> |
| COMMENT                    | VARCHAR2(4096)  | NO   | Comment.     |
