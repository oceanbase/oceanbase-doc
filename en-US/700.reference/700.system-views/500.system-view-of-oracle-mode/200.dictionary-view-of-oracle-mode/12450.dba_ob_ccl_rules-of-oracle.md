...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>This view is available starting with OceanBase Database V4.3.5 BP3 for V4.3.X versions. <br>It is available starting with OceanBase Database V4.4.1 for V4.4.X versions. </p>
  </main>
...
| MAX_CONCURRENCY | NUMBER(38) | NO | The maximum concurrency of throttling. |
