...
* Query the histogram information of the partitions of the partitioned tables accessible to the current user: [ALL_PART_HISTOGRAMS](2600.all_part_histograms-of-oracle-mode.md)

* Query the histogram information of the partitions of all partitioned tables in the current tenant: [DBA_PART_HISTOGRAMS](17200.dba_part_histograms-of-oracle-mode.md)
