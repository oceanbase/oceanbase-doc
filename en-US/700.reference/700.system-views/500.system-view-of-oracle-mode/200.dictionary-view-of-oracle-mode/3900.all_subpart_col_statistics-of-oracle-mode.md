...
This view displays the column statistics and histogram information of subpartitions in the partitioned tables accessible to the current user.
...
Query the column statistics of subpartitions in the partitioned table `T_SUBPART` accessible to the current user.
...
* To query the column statistics of subpartitions for all partitioned tables in the current tenant, use [DBA_SUBPART_COL_STATISTICS](19300.dba_subpart_col_statistics-of-oracle-mode.md).

* To query the column statistics of subpartitions for partitioned tables that you own, use [USER_SUBPART_COL_STATISTICS](28200.user_subpart_col_statistics-of-oracle-mode.md).

* To query table-level column statistics, use the following views:
...
* To query global-level column statistics, use the following views:
...
* To query partition-level column statistics, use the following views:
...
* To query table-level histogram statistics, use the following views:
...
* To query partition-level histogram statistics, use the following views:
...
* To query subpartition-level histogram statistics, use the following views:
...
* To query index statistics, use the following views:
