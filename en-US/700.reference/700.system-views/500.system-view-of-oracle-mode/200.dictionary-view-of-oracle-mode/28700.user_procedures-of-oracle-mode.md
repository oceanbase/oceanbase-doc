...
This view displays all functions and procedures owned by the current user and their associated attributes. The columns in this view are the same as those in `ALL_PROCEDURES`, except for the `OWNER` column.
