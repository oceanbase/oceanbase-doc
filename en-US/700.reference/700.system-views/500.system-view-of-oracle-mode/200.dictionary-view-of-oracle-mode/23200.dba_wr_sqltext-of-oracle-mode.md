...
| QUERY_SQL | CLOB         | NO   |  SQL text      |
| SQL_TYPE  | NUMBER(38)   | NO   |  Statement type      |
...
Query the SQL texts collected by the current tenant from the WR module and display the first record.
