...
The `DBA_WR_SQLTEXT` view displays the SQL texts collected by WR in the current tenant.

## Columns
| **Column** | **Type**  | **Nullable?** | **Description**                               |
|------------|-------------|---------------------|----------------------------------------|
| SNAP_ID   | NUMBER(38)   | NO   |  Snapshot ID   |
| SQL_ID    | VARCHAR2(32) | NO   |  ID of an SQL statement      |
| QUERY_SQL | CLOB         | NO   |  SQL statement      |

| SQL_TYPE  | NUMBER(38)   | NO   |  Statement type      |

The following table describes the values in the `SQL_TYPE` column of the view and the corresponding statements.
