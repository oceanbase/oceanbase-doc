...
| BEGIN_INTERVAL_TIME | TIMESTAMP(6) WITH LOCAL TIME ZONE | NO | The snapshot start time, with millisecond precision. |
| END_INTERVAL_TIME | TIMESTAMP(6) WITH LOCAL TIME ZONE | NO | The snapshot end time, with millisecond precision. |
| SNAP_FLAG | NUMBER(38) | YES | The reason for triggering the snapshot. |
| STARTUP_TIME | TIMESTAMP(6) WITH LOCAL TIME ZONE | YES | The process startup time, with millisecond precision. |
