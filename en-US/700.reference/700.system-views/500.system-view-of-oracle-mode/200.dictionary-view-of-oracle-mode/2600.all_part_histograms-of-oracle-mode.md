...
This view displays histogram information of all partitions in the partitioned tables accessible to the current user.
...
* To view histogram information of partitions of all partitioned tables in the current tenant, query [DBA_PART_HISTOGRAMS](17200.dba_part_histograms-of-oracle-mode.md).

* To view histogram information of partitions of all partitioned tables in the current tenant, query [USER_PART_HISTOGRAMS](28000.user_part_histograms-of-oracle-mode.md).
