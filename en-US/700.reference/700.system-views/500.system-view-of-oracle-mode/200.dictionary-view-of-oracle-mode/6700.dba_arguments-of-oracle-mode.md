...
This view displays the parameters of functions and procedures available in the current tenant. The columns are the same as those in the `ALL_ARGUMENTS` view.
...
| SUBPROGRAM_ID      | NUMBER        | YES            | The order in which the procedure or function appears in the package. For a standalone procedure or function, this value is 1.                                                                          |
...
| IN_OUT             | VARCHAR2(5)   | YES            | The input/output attribute of the parameter (NULL indicates that the parameter is the return value).:<ul><li> IN   </li><li> OUT   </li><li> IN OUT</li></ul>    |
