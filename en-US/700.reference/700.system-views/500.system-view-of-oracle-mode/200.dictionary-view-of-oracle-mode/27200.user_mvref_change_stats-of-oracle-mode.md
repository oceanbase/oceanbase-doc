...
| RETRY_ID        | NUMBER         | NO   | The ID of the retry batch to which this change record belongs.  <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.4.2 BP2. </p></main>|
