...
The `USER_TAB_SUBPARTITIONS` view displays, for each subpartition owned by the current user, the subpartition name, the names of the table and partition to which it belongs, and its storage attributes.
