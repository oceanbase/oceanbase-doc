...
|-------------------|---------------|----------------|----------------------------------------------------------------------------------------------------------------------------|
| OWNER             | VARCHAR2(128) | NO             | The user to whom the column belongs.                                  |
...
| SAMPLE_SIZE       | NUMBER        | NO            | The sample size used for analysis.                                |
...
| NOTES             | VARCHAR2(80)  | NO            | Stores additional attributes.                               |
| AVG_COL_LEN       | NUMBER        | NO            | The average length of the column.                                  |
| HISTOGRAM         | VARCHAR2(15)  | NO            | The type of the histogram.                                   |

## Sample query

Query the column statistics of the subpartitions in the `T_SUBPART` partitioned table of the current tenant.
...
* To query the column statistics of subpartitions of all partitioned tables accessible to the current user, query the [ALL_SUBPART_COL_STATISTICS](4100.all_subpart_col_statistics-of-oracle-mode.md) view.

* To query the column statistics of subpartitions of all partitioned tables owned by the current user, query the [USER_SUBPART_COL_STATISTICS](29700.user_subpart_col_statistics-of-oracle-mode.md) view.
...
* To query the column statistics of global tables, query the following views:
