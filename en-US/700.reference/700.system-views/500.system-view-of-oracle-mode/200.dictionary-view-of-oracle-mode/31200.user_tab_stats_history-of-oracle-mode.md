...
* Query the table statistics modification history of all tables accessible to the current user: [ALL_TAB_STATS_HISTORY](5500.all_tab_stats_history-of-oracle-mode.md)
