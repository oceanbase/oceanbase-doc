...
This view displays all functions and procedures available in the current tenant and their related attributes. The columns of this view are the same as those of `ALL_PROCEDURES`.
...
| SUBPROGRAM_ID  | NUMBER        | NO             | The order in which the procedure or function appears in the package. For a standalone procedure or function, this value is 1.                                                                                  |
...
Query all functions and procedures available in the current tenant and their related attributes, and display the first 10 records.
...
* Query all functions and stored procedures accessible to the current user: [ALL_PROCEDURES](3300.all_procedures-of-oracle-mode.md)
