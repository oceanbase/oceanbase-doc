...
| INMEMORY_SERVICE | VARCHAR2(12) | NO | Currently, this field is not supported. The default value is NULL.                       |
| INMEMORY_SERVICE_NAME | VARCHAR2(1000) | NO | Currently, this field is not supported. The default value is NULL.                    |
