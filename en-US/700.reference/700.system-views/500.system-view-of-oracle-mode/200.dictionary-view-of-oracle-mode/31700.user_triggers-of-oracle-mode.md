...
| TRIGGER_TYPE      | VARCHAR2(16)    | NO             | The type of the trigger. Valid values: <ul><li>BEFORE EACH ROW</li> <li>AFTER EACH ROW</li> <li>`INSTEAD OF`</li> <li>`COMPOUND`</li></ul>  |
| TRIGGERING_EVENT  | VARCHAR2(246)   | NO             | The trigger event. OceanBase Database supports only the INSERT, UPDATE, and DELETE events.       |
...
| COLUMN_NAME       | VARCHAR2(4000)  | NO             | The name of the column. This column is valid only when the trigger object is a nested table. Other values are NULL.                          |
...
| STATUS            | VARCHAR2(8)     | NO             | The status. Valid values: <ul><li>ENABLE   </li><li> DISABLE</li></ul>             |
...
* Query all triggers accessible to the current user: [ALL_TRIGGERS](5900.all_triggers-of-oracle-mode.md)
