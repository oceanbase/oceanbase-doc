...
| PCT_THRESHOLD           | NUMBER         | NO         | This column is not supported. The value of this column is NULL by default.     |
| INCLUDE_COLUMN          | NUMBER         | NO         | This column is not supported. The value of this column is NULL by default.    |
...
| AVG_LEAF_BLOCKS_PER_KEY | NUMBER         | NO         | This column is not supported. The value of this column is NULL by default.                        |
| AVG_DATA_BLOCKS_PER_KEY | NUMBER         | NO         | This column is not supported. The value of this column is NULL by default.                        |
| CLUSTERING_FACTOR       | NUMBER         | NO         | This column is not supported. The value of this column is NULL by default.                        |
...
| DEGREE                  | VARCHAR2(40)   | NO         | This column is not supported. It is set to NULL by default.                        |
| INSTANCES               | VARCHAR2(40)   | NO         | This column is not supported. It is set to NULL by default.                        |
| PARTITIONED             | VARCHAR2(3)    | NO         | Indicates whether the index is a partitioned index.                                    |
| TEMPORARY               | VARCHAR2(1)    | NO         | This column is not supported. It is set to NULL by default.                        |
| GENERATED               | VARCHAR2(1)    | NO         | This column is not supported. It is set to NULL by default.                        |
...
| DURATION                | VARCHAR2(15)   | NO         | This column is not supported. It is set to NULL by default.                        |
| PCT_DIRECT_ACCESS       | NUMBER         | NO         | This column is not supported. It is set to NULL by default.                        |
| ITYP_OWNER              | VARCHAR2(128)  | NO         | This column is not supported. It is set to NULL by default.                        |
| ITYP_NAME               | VARCHAR2(128)  | NO         | This column is not supported. It is set to NULL by default.                        |
...
* For more information about indexes, see [View indexes](../../../300.database-object-management/200.manage-object-of-oracle-mode/400.manage-indexes-of-oracle-mode/300.view-indexes-of-oracle-mode.md).