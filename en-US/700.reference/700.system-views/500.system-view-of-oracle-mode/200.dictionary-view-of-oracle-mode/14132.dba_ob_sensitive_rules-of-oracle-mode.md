...
<h4>Note</h4>
<p>This view is available starting with V4.6.0 for V4.6.x versions.</p>
</main>
...
| PROTECTION_POLICY      | varchar(16)    | NO         | The protection strategy. Valid values: `ENCRYPTION` and `INVALID`. `ENCRYPTION` indicates encryption protection. `INVALID` indicates invalid.                                        |
