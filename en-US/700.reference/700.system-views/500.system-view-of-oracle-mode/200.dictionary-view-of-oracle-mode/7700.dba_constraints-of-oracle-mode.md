...
| DELETE_RULE       | VARCHAR2(9)    | NO             | The rule for cascading deletion of foreign key constraints.                                      |
...
| LAST_CHANGE       | DATE           | NO             | The time when the constraint was last changed to ENABLE or DISABLE.                   |
