...
* To query the histograms of the partitions of all partitioned tables in the current tenant, see [DBA_PART_HISTOGRAMS](16400.dba_part_histograms-of-oracle-mode.md).

* To query the histograms of the partitions of all partitioned tables in the current tenant, see [USER_PART_HISTOGRAMS](26500.user_part_histograms-of-oracle-mode.md).
