...
* View the information of all PL/SQL data types accessible to the current user: [ALL_PLSQL_TYPES](2750.all-plsql-types-of-oracle-mode.md).
* View the information of PL/SQL data types accessible to the current user: [USER_PLSQL_TYPES](26850.user-plsql-type-of-oracle-mode.md).