...
This view displays the columns in the subpartition keys of all partitioned objects owned by the current user.
...
Query the columns in the subpartition keys of the partitioned table `TBL2_F_RL` owned by the current user.
...
* Query the columns in the subpartition keys of all partitioned objects accessible to the current user: [ALL_SUBPART_KEY_COLUMNS](4300.all_subpart_key_columns-of-oracle-mode.md)