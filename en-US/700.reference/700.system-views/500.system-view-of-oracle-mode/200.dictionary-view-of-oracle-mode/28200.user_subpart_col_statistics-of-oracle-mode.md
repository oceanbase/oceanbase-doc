...
|slug|user_subpart_col_statistics-oracle-compatible-mode|
...
This view displays the column statistics and histogram information of subpartitions in partitioned tables of the current user.
...
| GLOBAL_STATS      | VARCHAR2(3)   | YES            | <ul><li>`YES`: Indicates that statistics have been collected. </li><li>`NO`: Indicates that statistics have not been collected. </li></ul>   |
...
Query the column statistics of subpartitions in the `T_SUBPART` table of the current user.
...
* View the column statistics of subpartitions for all partitioned tables accessible to the current user: [ALL_SUBPART_COL_STATISTICS](3900.all_subpart_col_statistics-of-oracle-mode.md)

* View the column statistics of subpartitions for all partitioned tables in the current tenant: [DBA_SUBPART_COL_STATISTICS](19300.dba_subpart_col_statistics-of-oracle-mode.md)

* View the column statistics of tables at the table level by querying the following views:
...
* View the column statistics of tables at the global level by querying the following views:
...
* View the column statistics of tables at the partition level by querying the following views:
...
* View the histogram statistics of tables at the table level by querying the following views:
...
* View the histogram statistics of tables at the partition level by querying the following views:
...
* View the histogram statistics of tables at the subpartition level by querying the following views:
