...
The view lists the user-defined types in the database.
...
| INCOMPLETE       | CHAR(2)       | NO             | Whether the type is an incomplete type, which has only a name.     |
| FINAL            | CHAR(3)       | NO             | Whether the type is not inheritable.                   |
| INSTANTIABLE     | CHAR(3)       | NO             | Whether the type can be instantiated.                    |
