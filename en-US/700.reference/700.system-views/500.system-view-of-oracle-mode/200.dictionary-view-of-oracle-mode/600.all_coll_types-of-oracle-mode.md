...
| ELEM_STORAGE       | CHAR(3)       | NO            | This column is not supported. The default value is YES.                                                                         |
| NULLS_STORED       | CHAR(1)       | NO            | This column is not supported. The default value is B.                                                                         |

## Sample query

Query the user-defined collection types available to the current user.
...
* [DBA_COLL_TYPES](7500.dba_coll_types-of-oracle-mode.md) describes all user-defined collection types in the current tenant.

* [USER_COLL_TYPES](25700.user_coll_types-of-oracle-mode.md) describes the user-defined collection types owned by the current user.
