...
* Query the overall information of record types defined in a package: [ALL_PLSQL_TYPE_ATTRS](2770.all-plsql-type-attrs-oracle-mode.md).
* Query the overall information of record types defined in a package: [DBA_PLSQL_TYPE_ATTRS](16370.dba-plsql-type-attrs-of-oracle-mode.md).