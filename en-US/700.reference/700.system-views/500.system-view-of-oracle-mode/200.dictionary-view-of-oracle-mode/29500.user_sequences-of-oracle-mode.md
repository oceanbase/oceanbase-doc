...
| CACHE_SIZE | NUMBER | NO | The number of sequence values stored in the cache. |
| LAST_NUMBER | NUMBER(38) | NO | The value of the last sequence number written to the disk. |

## Sample query

Query the details of all sequences that the current user owns.
...
* View all sequences that the current user owns: [ALL_SEQUENCES](3900.all_sequences-of-oracle-mode.md)
