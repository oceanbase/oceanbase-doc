...
## Purpose
-----------
Displays all functions and procedures available in the current tenant and their related attributes. The columns of this view are the same as those of the `ALL_PROCEDURES` view.
...
* Query all functions and stored procedures that the current user can access: [ALL_PROCEDURES](3100.all_procedures-of-oracle-mode.md)
