...
| ARGUMENT_NAME      | VARCHAR2(128) | YES            | The name of the parameter. If this value is NULL, it indicates that the parameter is the return value of the function.                                                                              |
...
| IN_OUT             | VARCHAR2(5)   | YES            | The input/output attribute of the parameter (NULL indicates that the parameter is a return value): <li> IN   <li> OUT   <li> IN OUT    |
| DATA_PRECISION     | NUMBER(38)    | YES            | The maximum length of the numeric type.        |
| DATA_SCALE         | NUMBER(38)    | YES            | The length of the decimal part of the numeric type.   |
...
* Query the parameters of all functions and procedures owned by the current user: [USER_ARGUMENTS](24300.user_arguments-of-oracle-mode.md)