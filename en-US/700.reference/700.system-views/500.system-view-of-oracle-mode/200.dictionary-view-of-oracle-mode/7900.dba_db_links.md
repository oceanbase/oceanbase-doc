...
| HIDDEN | VARCHAR2(3) | NO | This parameter is for internal use and is for compatibility. |
| SHARD_INTERNAL | VARCHAR2(3) | NO | This parameter is for marking whether the DBLink supports shared connections, which can reduce the number of connections between the local and remote databases. This parameter is for compatibility. |
| VALID | VARCHAR2(3) | NO | This parameter is for marking whether the DBLink is available. This parameter is for compatibility, and the default value is YES. |
| INTRA_CDB | VARCHAR2(3) | NO | This parameter is for internal use and is for compatibility. |
