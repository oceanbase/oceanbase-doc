...
| REVERSE_TENANT_NAME| VARCHAR2(128) | YES | The name of the tenant used to connect to the local database for the reverse DBLink. |
| CLUSTER_NAME| VARCHAR2(128)| YES | The name of the cluster used to connect to the remote database. |
| REVERSE_CLUSTER_NAME| VARCHAR2(128)| YES | The name of the cluster used to connect to the local database for the reverse DBLink. |
| REVERSE_HOST| VARCHAR2(46) | YES | The host name (IP address) used to connect to the local database for the reverse DBLink. |
| REVERSE_PORT| NUMBER(38) | YES | The port number used to connect to the local database for the reverse DBLink. |
| REVERSE_USERNAME| VARCHAR2(128) | YES | The username used to connect to the local database for the reverse DBLink. |
