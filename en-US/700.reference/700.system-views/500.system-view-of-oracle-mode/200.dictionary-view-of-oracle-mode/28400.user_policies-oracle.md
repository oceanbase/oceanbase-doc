...
Check the access control policies that the current user has.
...
* View the access control policies that the current user has: [ALL_POLICIES](3000.all_policies-oracle.md)

* View all access control policies in the current tenant: [DBA_POLICIES](17600.dba_policies-oracle.md)