...
| DEF_TAB_COMPRESSION      | VARCHAR2(8)  | NO             | Indicates whether to enable default table compression. |
...
To query the tablespaces accessible to the current user, query the [USER_TABLESPACES](31500.user_tablespaces-of-oracle-mode.md) view.