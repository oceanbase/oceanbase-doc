...
This view displays the constraint information of all tables accessible to the current user.
...
Query the constraint information of all tables accessible to the current user.
