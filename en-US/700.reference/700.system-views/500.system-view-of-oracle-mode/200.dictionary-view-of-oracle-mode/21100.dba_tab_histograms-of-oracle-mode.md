...
This view displays the table-level histogram information for all tables in the current tenant.
...
* Query the table-level histogram statistics for all tables accessible to the current user: [ALL_TAB_HISTOGRAMS](5000.all_tab_histograms-of-oracle-mode.md)

* Query the table-level histogram statistics for all tables owned by the current user: [USER_TAB_HISTOGRAMS](30700.user_tab_histograms-of-oracle-mode.md)
