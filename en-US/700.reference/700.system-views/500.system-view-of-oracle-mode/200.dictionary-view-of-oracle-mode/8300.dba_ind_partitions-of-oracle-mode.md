...
The `DBA_IND_PARTITIONS` view displays the information about all index partitions in the database.
...
| COMPOSITE               | CHAR(3)      | NO         | Indicates whether the partition belongs to the local index of the composite-partitioned table. Valid values:<li>YES<li>NO        |
