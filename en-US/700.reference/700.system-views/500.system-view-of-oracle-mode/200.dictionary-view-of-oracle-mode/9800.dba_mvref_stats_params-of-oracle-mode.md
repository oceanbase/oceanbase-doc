...
|slug|dba_mvref_stats_params-oracle-compatible-mode|
...
| COLLECTION_LEVEL | VARCHAR2(8) | NO | The refresh statistics collection level<ul><li>NONE: No statistics are collected.  </li><li>TYPICAL: Standard statistics are collected. </li><li>ADVANCED: More detailed statistics are collected. </li></ul>|
