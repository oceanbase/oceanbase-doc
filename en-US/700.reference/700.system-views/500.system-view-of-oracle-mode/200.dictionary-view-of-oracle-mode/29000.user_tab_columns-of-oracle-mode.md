...
| DATA_PRECISION       | NUMBER        | NO             | The decimal precision of a numeric data type; the binary precision of a floating-point data type; NULL for all other data types. |
...
| DEFAULT_ON_NULL      | VARCHAR2(3)   | NO             | This column is not supported. The value of this column is NULL by default. |
|  IDENTITY_COLUMN     |  VARCHAR2(3)  |  NO            | This column is not supported. The value of this column is NULL by default. |
|  EVALUATION_EDITION  |  VARCHAR2(128)    |  NO        | This column is not supported. The value of this column is NULL by default. |
|  UNUSABLE_BEFORE     |  VARCHAR2(128)    |  NO        | This column is not supported. The value of this column is NULL by default. |
| UNUSABLE_BEGINNING   |  VARCHAR2(128)    |  NO        | This column is not supported. The value of this column is NULL by default. |
...
* Query columns of all tables or views accessible to the current user: [ALL_TAB_COLUMNS](4600.all_tab_columns-of-oracle-mode.md)

* Query columns of all tables or views in the current tenant: [DBA_TAB_COLUMNS](20100.dba_tab_columns-of-oracle-mode.md)