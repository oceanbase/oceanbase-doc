...
This view displays the column statistics and histograms of subpartitions in the partitioned tables owned by the current user.
...
| GLOBAL_STATS      | VARCHAR2(3)   | YES            | <li> `YES`: statistics have been collected.   <li> `NO`: statistics have not been collected.    |
...
View the column statistics of the subpartitions of the partitioned table `T_SUBPART` that the current user has access to.
...
* View the column statistics of subpartitions of partitioned tables that the current user can access: [ALL_SUBPART_COL_STATISTICS](4100.all_subpart_col_statistics-of-oracle-mode.md)
...
* For more information about how to collect statistics, see the following topics:
  ...
  * [Collect statistics automatically](../../../1000.performance-tuning-guide/500.sql-optimization/400.sql-optimization/400.optimizer-statistics/200.statistics-collection-methods/400.collect-statistics-automatically.md)