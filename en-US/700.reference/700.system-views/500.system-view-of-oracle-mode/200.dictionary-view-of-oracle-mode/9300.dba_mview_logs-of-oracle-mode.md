...
|slug|dba_mview_logs-of-oracle-mode|
...
| LAST_PURGE_STATUS | NUMBER | NO | The status of the last purge of the materialized view log.<ul><li>An error code  </li><li>`0`: The materialized view log was successfully purged. </li></ul><main id="notice" type='explain'> <h4>Note</h4><p>At present, the value of this column is fixed to `0`. </p></main> |
