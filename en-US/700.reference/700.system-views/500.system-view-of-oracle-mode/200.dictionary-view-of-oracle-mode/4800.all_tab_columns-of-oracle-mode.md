...
* Query columns of tables or views owned by the current user: [USER_TAB_COLUMNS](30500.user_tab_columns-of-oracle-mode.md)

* Query columns of tables or views in the current tenant: [DBA_TAB_COLUMNS](20900.dba_tab_columns-of-oracle-mode.md)