...
This view lists the attributes of user-defined types in the current tenant.
...
| SCALE              | NUMBER(38)    | NO             | The length of the data after the decimal point of the numeric type.          |
