...
This view lists the attribute information of user-defined types available in the current tenant.
...
| SCALE              | NUMBER(38)    | NO             | The length of the data on the right side of the decimal point for the numeric type.          |
...
Query the attribute information of all user-defined types in the current tenant and display the first 10 rows.
...
* Query the attribute information of all custom types accessible to the current user: [ALL_TYPE_ATTRS](6000.all_type_attrs-of-oracle-mode.md)

* Query the attribute information of all custom types owned by the current user: [USER_TYPE_ATTRS](31800.user_type_attrs-of-oracle-mode.md)
