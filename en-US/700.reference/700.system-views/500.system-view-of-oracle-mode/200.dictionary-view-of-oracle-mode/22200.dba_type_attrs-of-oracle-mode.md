...
This view lists the attributes of user-defined types available in the current tenant.
...
| CHAR_USED          | CHAR(1)       | YES            | Indicates whether the attribute is defined by byte length (B) or character length (C). |

## Sample query

Query the attributes of all user-defined types in the current tenant and display the first 10 rows.
