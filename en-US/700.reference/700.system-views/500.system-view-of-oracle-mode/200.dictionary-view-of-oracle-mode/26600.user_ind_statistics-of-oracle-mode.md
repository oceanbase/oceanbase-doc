...
This view displays the optimizer statistics of the indexes of the tables owned by the current user.
...
Query the optimizer statistics of the index `TBL1_H_IDX1` of the tables owned by the current user.
