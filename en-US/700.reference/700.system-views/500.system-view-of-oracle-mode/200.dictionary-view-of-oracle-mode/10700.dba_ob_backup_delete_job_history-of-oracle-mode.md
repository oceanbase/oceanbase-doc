...
| STATUS | VARCHAR2(64) | NO | Task status. Valid values: <ul><li>`COMPLETED`: the task is completed. </li><li>`FAILED`: the task failed. </li><li>`CANCELED`: the task was canceled. </li></ul> |
