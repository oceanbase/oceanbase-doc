...
|slug|all_ind_subpartitions-of-oracle-mode|
...
The `ALL_IND_SUBPARTITIONS` view displays information about all the index subpartitions accessible to the current user in the database.
