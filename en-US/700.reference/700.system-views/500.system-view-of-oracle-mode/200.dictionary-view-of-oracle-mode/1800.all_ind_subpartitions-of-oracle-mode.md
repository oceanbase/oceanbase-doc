...
* Query the information about all index subpartitions (subpartitions) in the current tenant: [DBA_IND_SUBPARTITIONS](8700.dba_ind_subpartitions-of-oracle-mode.md)

* Query the information about all index subpartitions (subpartitions) that the current user owns: [USER_IND_SUBPARTITIONS](26700.user_ind_subpartitions-of-oracle-mode.md)