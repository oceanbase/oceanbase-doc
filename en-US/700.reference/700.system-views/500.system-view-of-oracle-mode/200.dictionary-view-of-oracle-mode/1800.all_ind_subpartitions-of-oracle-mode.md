...
| COMPRESSION               | VARCHAR2(8)    | NO             | Indicates whether the partitioned index is compressed: <li>ENABLE: Compressed <li>DISABLE: Not compressed |
...
* Query all index subpartitions (subpartitions) in the current tenant: [DBA_IND_SUBPARTITIONS](8700.dba_ind_subpartitions-of-oracle-mode.md)
