...
| INDEXING                 | VARCHAR2(4)    | NO           | Indicates the indexing property. Valid values: <li>ON: Indexing is enabled for this subpartition.</li><li>OFF: Indexing is disabled for this subpartition.</li> |
| READ_ONLY                | VARCHAR2(4)    | NO           | Indicates whether the subpartition is read-only. Valid values: <li>YES: The subpartition is read-only by default.</li><li>NO: The subpartition is read/write by default.</li> |
