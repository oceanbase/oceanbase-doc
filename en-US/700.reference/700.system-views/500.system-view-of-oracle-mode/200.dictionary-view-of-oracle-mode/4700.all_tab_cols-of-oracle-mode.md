...
This view differs from the [`ALL_TAB_COLUMNS`](4800.all_tab_columns-of-oracle-mode.md) view in that this view displays quickly deleted columns but the `ALL_TAB_COLUMNS` view does not.
