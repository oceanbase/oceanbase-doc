...
This view displays histogram information for subpartitions of all partitioned tables in the current tenant.
...
Query the histogram information for subpartitions of the `T_SUBPART` partitioned table in the current tenant.
...
* Query the histogram information for subpartitions of partitioned tables accessible to the current user: [ALL_SUBPART_HISTOGRAMS](4200.all_subpart_histograms-of-oracle-mode.md)

* Query the histogram information for subpartitions of partitioned tables owned by the current user: [USER_SUBPART_HISTOGRAMS](29800.user_subpart_histograms-of-oracle-mode.md)
