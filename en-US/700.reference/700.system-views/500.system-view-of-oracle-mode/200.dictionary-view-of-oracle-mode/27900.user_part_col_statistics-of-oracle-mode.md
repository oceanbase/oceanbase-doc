...
This view displays the column statistics and histogram information of the partitions of a partitioned table that belongs to the current user.
...
| GLOBAL_STATS   | VARCHAR2(3)   | YES            | <ul><li>`YES`: indicates that the statistics were directly collected.   </li><li> `NO`: indicates that the statistics were derived from the subpartition statistics or were not collected.</li></ul>    |
...
Query the column statistics and histogram information of the partitions of the `T_SUBPART` table that belongs to the current user.
...
* To view the column statistics of partitions in the partitioned tables accessible to the current user, query the [ALL_PART_COL_STATISTICS](2500.all_part_col_statistics-of-oracle-mode.md) view.

* To view the column statistics of partitions in all partitioned tables of the current tenant, query the [DBA_PART_COL_STATISTICS](17100.dba_part_col_statistics-of-oracle-mode.md) view.
