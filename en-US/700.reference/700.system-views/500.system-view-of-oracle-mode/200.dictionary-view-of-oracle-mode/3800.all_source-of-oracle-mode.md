...
This view displays the text source of the stored objects accessible to the current user.
...
Query the text source of the stored objects accessible to the current user and display the first two records.
...
* Query the text source of all stored objects in the current tenant: [DBA_SOURCE](18900.dba_source-of-oracle-mode.md)
