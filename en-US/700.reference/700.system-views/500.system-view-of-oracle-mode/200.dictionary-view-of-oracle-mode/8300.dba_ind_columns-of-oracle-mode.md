...
This view displays the information about the index columns of all tables in the database.
...
Query the information about the index columns of the index table `TBL2` in the current tenant.
