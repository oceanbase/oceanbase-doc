...
Query the table-level histogram information of the `T_SUBPART` table in all tables owned by the current user.
...
* View the table-level histogram statistics for all tables that the current user can access: [ALL_TAB_HISTOGRAMS](5000.all_tab_histograms-of-oracle-mode.md)

* View the table-level histogram statistics for all tables in the current tenant: [DBA_TAB_HISTOGRAMS](21100.dba_tab_histograms-of-oracle-mode.md)

* View the partition-level histogram statistics. Query the following views:
...
* View the subpartition-level histogram statistics. Query the following views:
...
* View the table-level column statistics. Query the following views:
...
* View the global column statistics. Query the following views:
...
* View the partition-level column statistics. Query the following views:
...
* View the subpartition-level column statistics. Query the following views:
