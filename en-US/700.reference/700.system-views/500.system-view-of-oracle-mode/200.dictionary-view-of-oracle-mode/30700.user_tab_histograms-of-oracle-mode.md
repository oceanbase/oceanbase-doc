...
This view displays table-level histogram information for tables owned by the current user.
...
Query the table-level histogram information of the `T_SUBPART` table in the current user's schema.
...
* Query the table-level histogram statistics of all tables accessible to the current user: [ALL_TAB_HISTOGRAMS](5000.all_tab_histograms-of-oracle-mode.md)

* Query the table-level histogram statistics of all tables in the current tenant: [DBA_TAB_HISTOGRAMS](21100.dba_tab_histograms-of-oracle-mode.md)
