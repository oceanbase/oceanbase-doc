...
* To view the collection status of tenant-level historical statistics, see [DBA_OB_TASK_OPT_STAT_GATHER_HISTORY](../200.dictionary-view-of-oracle-mode/16000.dba_ob_task_opt_stat_gather_history-of-oracle-mode.md).

* To view the collection status of table-level historical statistics, see [DBA_OB_TABLE_OPT_STAT_GATHER_HISTORY](../200.dictionary-view-of-oracle-mode/15200.dba_ob_table_opt_stat_gather_history-of-oracle-mode.md).
