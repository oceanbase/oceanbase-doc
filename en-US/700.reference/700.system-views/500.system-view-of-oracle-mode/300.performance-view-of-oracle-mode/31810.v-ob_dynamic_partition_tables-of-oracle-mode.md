...
Displays the information about the dynamic partitioned tables in the current tenant. The view reads the attributes of dynamic partitioned tables from the memory and thus delivers better read performance.
