...
The `V$OB_TENANT_RESOURCE_LIMIT_DETAIL` view displays the resource limits and their maximum values for the current tenant on the current OBServer.
...
Query the resource limits and their maximum values for the current tenant on the current OBServer.
