...
This view displays information about the session cursors that are in the open state.
...
Query information about the session cursors that are in the open state on the current node.
