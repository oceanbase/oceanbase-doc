...
| PARTICIPANT_TABLE                    | VARCHAR2(512) | NO         | The information about the tables that participated in the current compaction.  |
...
| EXECUTE_TIME                    | NUMBER(38)     | NO | The time consumed by the major compaction task for CPU, in microseconds. <main id="notice" type='explain'><h4>Note</h4><p>This field is introduced in V4.3.5 BP3. </p></main> |
| FILTER_ROW_COUNT                | NUMBER(38)     | NO | The number of rows that are recovered by major compaction. <main id="notice" type='explain'><h4>Note</h4><ul><p>This field is introduced in V4.6.0.</p></main>  |
