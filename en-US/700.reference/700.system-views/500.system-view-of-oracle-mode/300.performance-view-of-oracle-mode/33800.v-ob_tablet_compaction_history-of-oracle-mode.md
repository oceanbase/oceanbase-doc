...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>Available only in V4.0.0 and later. </p>
</main>
...
| MDS_FILTER_INFO                 | VARCHAR2(1024) | NO | This field is currently unused and its value is `Null`.<main id="notice" type='explain'><h4>Note</h4><p>This field is introduced in V4.3.5. </p></main> |
