...
| VERSION                      | NUMBER(38)   | NO         | The number of times the statistics collection has been restarted.         |
...
In the user tenant, query the PX thread usage on all OBServer nodes of the tenant.
