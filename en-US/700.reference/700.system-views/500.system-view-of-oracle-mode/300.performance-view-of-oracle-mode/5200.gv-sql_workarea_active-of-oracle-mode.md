...
| QCSID            | NUMBER       | NO             | The session ID of the query coordinator. This column is not supported and is NULL by default.  |
| ACTIVE_TIME      | NUMBER   | NO             | The average time that the workarea is active, in milliseconds.                       |
...
| TABLESPACE       | VARCHAR2(128) | NO             | The tablespace in which the temporary file was written. If this column is NULL, no temporary file was written. This column is not supported and is NULL by default.                                                                        |
