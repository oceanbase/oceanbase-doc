...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>This view is introduced since V1.4. </p>
</main>

## Purpose

The `GV$SESSION_WAIT` view displays information about the current or last wait events of all sessions on all nodes, such as the event name and the amount of time spent on waiting.
...
Query information about the current or most recent wait event for all sessions on all nodes.
