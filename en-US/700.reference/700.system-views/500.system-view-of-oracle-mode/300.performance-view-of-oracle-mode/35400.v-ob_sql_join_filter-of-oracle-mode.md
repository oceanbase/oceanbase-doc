...
This view displays the join filter execution information for the current tenant on the current OBServer node.
...
Query execution-related information about join filters in the current node of the user tenant.
