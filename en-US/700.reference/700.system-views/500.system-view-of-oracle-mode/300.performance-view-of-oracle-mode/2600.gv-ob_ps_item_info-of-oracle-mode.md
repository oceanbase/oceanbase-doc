...
|slug|gv-ob_ps_item_info-oracle-mode|
...
| STMT_ID             | NUMBER(38)   | NO         | The stmt_id of the statement in the PS cache. |
| DB_ID               | NUMBER(38)   | NO         | The database ID involved in the prepare statement.       |
| PS_SQL              | CLOB         | NO         | The SQL statement for the prepare operation.           |
| PARAM_COUNT         | NUMBER(38)   | NO         | The number of parameters in the prepare operation.            |
