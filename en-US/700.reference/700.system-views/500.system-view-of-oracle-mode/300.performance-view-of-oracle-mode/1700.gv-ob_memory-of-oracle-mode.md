...
<h4>Note</h4>
<ul><li>The view name is changed from <code>GV$MEMORY</code> to <code>GV$OB_MEMORY</code> since OceanBase Database V4.0.0. </li>
<li> This view is supported only in MySQL-compatible mode. The query result is empty in Oracle-compatible mode. </li></ul>
</main>

## Purpose

This view displays the memory usage on all OBServer nodes of the current tenant.
