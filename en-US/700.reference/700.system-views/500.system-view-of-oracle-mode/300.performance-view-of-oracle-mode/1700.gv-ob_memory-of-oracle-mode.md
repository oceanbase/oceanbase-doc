...
<li> This view is supported only in MySQL mode. The query result is empty in Oracle mode. </li></ul>
</main>

## Purpose

The `GV$OB_MEMORY` view displays the memory usage on all OBServer nodes of the current tenant.
