...
|machine-translation||
|slug|gv$ob_transaction_schedulers-gv-ob_transaction_schedulers-of-oracle-mode|
...
| SNAPSHOT_VERSION | NUMBER(38)  | YES | The snapshot version when the RR or SERIAL isolation level is enabled. -1 is returned if the RR or SERIAL isolation level is not enabled. |
