...
This view displays information about open cursors on all nodes.
...
| ADDRESS              | VARCHAR2(8)  | NO   | The SQL address. Together with the SQL hash, it uniquely identifies an SQL statement. This field is always `NULL`. |
| HASH_VALUE           | NUMBER       | NO   | The SQL hash. This field is always `NULL`. |
...
| SQL_EXEC_ID          | NUMBER       | NO   | This field is always `NULL`. |
...
Query information about open cursors on all nodes.
