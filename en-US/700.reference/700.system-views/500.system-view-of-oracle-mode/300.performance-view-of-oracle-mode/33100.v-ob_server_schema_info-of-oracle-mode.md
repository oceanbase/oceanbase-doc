...
| SCHEMA_COUNT               | NUMBER(38)   | NO         | The total number of schema objects for the corresponding schema version.                    |
| SCHEMA_SIZE                | NUMBER(38)   | NO         | The total memory size occupied by schema objects for the corresponding schema version, in bytes.                   |
| MIN_SSTABLE_SCHEMA_VERSION | NUMBER(38)   | NO         | The minimum schema_version recorded in the SSTable of the tenant. |
