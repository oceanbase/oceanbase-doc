...
| CCWAIT_TOTAL | NUMBER | NO | The total amount of time spent on wait events of the concurrency class. |
| CCWAIT_DELTA | NUMBER | NO | The incremental amount of time spent on wait events of the concurrency class. |
| USERIO_WAIT_TOTAL | NUMBER | NO | The total amount of time spent on wait events of the user I/O class. |
| USERIO_WAIT_DELTA | NUMBER | NO | The incremental amount of time spent on wait events of the user I/O class. |
| APWAIT_TOTAL | NUMBER | NO | The total amount of time spent on wait events of the application class. |
| APWAIT_DELTA | NUMBER | NO | The incremental amount of time spent on wait events of the application class. |
...
| RPC_TOTAL | NUMBER | NO | The total number of RPC requests. |
