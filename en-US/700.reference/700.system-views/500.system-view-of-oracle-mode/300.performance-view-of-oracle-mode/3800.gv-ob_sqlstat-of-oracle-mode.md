...
The `GV$OB_SQLSTAT` view displays basic performance statistics for SQL statements in the cluster. Each SQL statement is represented by a row, identified by the unique combination of `SQL_ID` and `Plan_Hash`. The columns with `_DELTA` in their names show the incremental values from the last WR snapshot collection to the current time.
...
| USERIO_WAIT_TOTAL             | NUMBER          | NO   |   The total I/O wait time.      |
| USERIO_WAIT_DELTA             | NUMBER          | NO   |   The incremental I/O wait time.      |
...
| ROUTE_MISS_TOTAL              | NUMBER          | NO   |   The total number of times that the request partition was not hit since the OBServer started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field was introduced in V4.3.5. </li> <li>For V4.2.x, this field was introduced in V4.2.2. </li></ul></main>   |
| ROUTE_MISS_DELTA              | NUMBER          | NO   |   The number of times that the request partition was not hit since the last WR snapshot collection started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field was introduced in V4.3.5. </li> <li>For V4.2.x, this field was introduced in V4.2.2. </li></ul></main>   |
...
| PLAN_CACHE_HIT_TOTAL          | NUMBER          | NO   |   The total number of times that the Plan Cache was hit since the OBServer started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field was introduced in V4.3.5. </li> <li>For V4.2.x, this field was introduced in V4.2.5. </li></ul></main>   |
| PLAN_CACHE_HIT_DELTA          | NUMBER          | NO   |   The number of times that the Plan Cache was hit since the last WR snapshot collection started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field was introduced in V4.3.5. </li> <li>For V4.2.x, this field was introduced in V4.2.5. </li></ul></main>  |
| MUTI_QUERY_TOTAL              | NUMBER        | NO   | The number of times that the SQL statement was in a Multi Query since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>For V4.6.x, this field was introduced in V4.6.0. </p></main>|
| MUTI_QUERY_DELTA              | NUMBER        | NO   | The number of times that the SQL statement was in a Multi Query since the last WR snapshot collection.<main id="notice" type='explain'><h4>Note</h4><p>For V4.6.x, this field was introduced in V4.6.0. </p></main>|
| MUTI_QUERY_BATCH_TOTAL        | NUMBER        | NO   | The number of times that the SQL batch was executed since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>For V4.6.x, this field was introduced in V4.6.0. </p></main>|
| MUTI_QUERY_BATCH_DELTA        | NUMBER        | NO   | The number of times that the SQL batch was executed since the last WR snapshot collection.<main id="notice" type='explain'><h4>Note</h4><p>For V4.6.x, this field was introduced in V4.6.0. </p></main>|
| FULL_TABLE_SCAN_TOTAL         | NUMBER        | NO   | The number of full table scans performed by the SQL statement since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column was introduced in V4.6.0 for V4.6.x. </p></main>|
| FULL_TABLE_SCAN_DELTA         | NUMBER        | NO   | The number of full table scans performed by the SQL statement since the last WR snapshot was captured. <main id="notice" type='explain'><h4>Note</h4><p>This column was introduced in V4.6.0 for V4.6.x. </p></main>|
| ERROR_COUNT_TOTAL             | NUMBER        | NO   | The number of errors reported by the SQL statement since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column was introduced in V4.6.0 for V4.6.x. </p></main>|
| ERROR_COUNT_DELTA             | NUMBER        | NO   | The number of errors reported by the SQL statement since the last WR snapshot was captured. <main id="notice" type='explain'><h4>Note</h4><p>This column was introduced in V4.6.0 for V4.6.x. </p></main>|
| LATEST_ACTIVE_TIME            | TIMESTAMP(6)  | YES  | The last active time of the plan corresponding to the SQL ID and plan hash on a node. <main id="notice" type='explain'><h4>Note</h4><p>This column was introduced in V4.4.2 for V4.4.x. </p></main> |
