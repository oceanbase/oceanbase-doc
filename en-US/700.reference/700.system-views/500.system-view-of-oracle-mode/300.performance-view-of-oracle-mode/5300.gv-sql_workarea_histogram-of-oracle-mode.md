...
This view displays statistics for all work areas executed on all nodes of the current tenant, such as the number of times full in-memory processing occurred within the 1M to 2M range, the number of one-pass executions, and so on.
...
Query the statistics for all work areas executed on all nodes of the current tenant and display the first 10 records.
