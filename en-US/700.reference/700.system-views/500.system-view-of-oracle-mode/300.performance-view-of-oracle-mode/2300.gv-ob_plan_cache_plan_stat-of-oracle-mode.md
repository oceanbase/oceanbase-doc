...
| TYPE                  | NUMBER(38)                        | NO             | For SQL plan caching, this field indicates the type of the plan:  <ul><li> 1: local plan.    </li><li> 2: remote plan. </li><li>3: distributed plan.  </li></ul>For PL object caching, this field indicates the type of the PL object:<ul><li> 1: procedure.    </li><li> 2: function. </li><li>3: package.  </li><li> 4: anonymous block.   </li></ul>    |
...
| PS_STMT_ID            | NUMBER(38)                        | NO             | The Prepare ID corresponding to the request:<ul><li>`-1`: Indicates that the PS protocol is not used. </li><li>Non-`-1`: Indicates that the PS protocol is used, and the value is the unique identifier returned by the PS protocol for the statement.  </li></ul>     |
...
| CREATE_REASON           | VARCHAR2(16384)                 | NO             | The reason why the current plan was added.<main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.6.0. </p></main>|
