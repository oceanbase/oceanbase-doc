...
| WEIGHT                      | NUMBER                            | NO   | The number of times the same tenant and action occur in the time period corresponding to this WR record.<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this field was introduced in V4.4.2.</p></main> |
| IS_WR_WEIGHT_SAMPLE         | CHAR(1)                           | NO   | Indicates whether this column is an "aggregation" column for queue backlog waiting events.<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this field was introduced in V4.4.2.</p></main> |
