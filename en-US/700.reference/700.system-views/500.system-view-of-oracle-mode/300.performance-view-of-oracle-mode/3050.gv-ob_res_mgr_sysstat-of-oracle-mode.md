...
| STATISTIC# | NUMBER       | NO   | The index of the statistic. |
...
| VALUE_TYPE | VARCHAR2(16) | NO   | The value type: cumulative or assigned. |
| STAT_ID    | NUMBER       | NO   | The ID of the statistic. |

## Sample query

Query the statistics of resource groups in all OBServer nodes of the current tenant.
