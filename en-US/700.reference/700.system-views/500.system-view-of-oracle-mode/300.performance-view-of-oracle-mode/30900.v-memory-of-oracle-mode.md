...
<h4>Note</h4>
<ul><li>The view name has been changed from V$MEMORY to V$OB_MEMORY since V4.0.0.</li>
<li>This view is currently supported only in MySQL-compatible mode. In Oracle-compatible mode, the query result will be empty.</li></ul>
</main>
...
| PS_CACHE_CTX_ID | denotes`PREPARE stmt_name FROM preparable_stmt`Cache ID of the statement. |
...
<table>
  ...
  <tr>
    ...
    <li>SeArray: a sortable array module. </li>
  ...
  <tr>
    ...
    <td>
    <ul>
    <li>SqlAggrFuncRow: row object of SQL aggregate functions.  </li>
  ...
  <tr>
    ...
    <td>
    <ul>
    <li>OB_SQL PHY_PLAN: the query plan module.  </li>
...
In OceanBase Database, each SQL execution or operation corresponds to a specific CTX. Due to differences in data volume and operation complexity, the memory used by the CTX may lead to increased memory consumption.
