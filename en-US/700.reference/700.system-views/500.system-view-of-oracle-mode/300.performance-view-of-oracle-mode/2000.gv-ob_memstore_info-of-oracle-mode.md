...
|machine-translation||
|slug|gv$ob_memstore_info-gv-ob_memstore_info-of-oracle-mode|
...
The `GV$OB_MEMSTORE_INFO` view displays the details about MemTables in all partitions of the current tenant on all OBServer nodes.
