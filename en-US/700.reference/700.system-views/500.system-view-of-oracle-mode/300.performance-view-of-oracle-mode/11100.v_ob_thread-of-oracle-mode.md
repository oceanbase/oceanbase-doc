...
|machine-translation||
|slug|v$ob_thread-v_ob_thread-of-oracle-mode|
...
| CGROUP_PATH |  | NO  | The path of the cgroup to which the thread belongs. The information in this column comes from the CPU line under the `/proc/observer-pid/task/tid/cgroup` path.<main id="notice" type='explain'><h4>Note</h4><p>This column is introduced in V4.2.2.</p></main>  |
