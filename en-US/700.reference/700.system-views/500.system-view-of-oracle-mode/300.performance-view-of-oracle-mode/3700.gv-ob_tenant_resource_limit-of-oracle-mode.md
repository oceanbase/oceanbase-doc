...
|machine-translation||
|slug|gv$ob_tenant_resource_limit-gv-ob_tenant_resource_limit-of-oracle-mode|
...
| MAX_UTILIZATION      | NUMBER(38)    | NO   | The maximum usage of the resource after the server starts. |
| RESERVED_VALUE       | NUMBER(38)    | NO   | The amount of reserved resources. It ensures the stable operation of the server. |
| LIMIT_VALUE          | NUMBER(38)    | NO   | The maximum usage of the resource allowed. |
| EFFECTIVE_LIMIT_TYPE | VARCHAR2(128) | NO   | The effective limit type, such as parameter, memory, CPU, or disk. |
