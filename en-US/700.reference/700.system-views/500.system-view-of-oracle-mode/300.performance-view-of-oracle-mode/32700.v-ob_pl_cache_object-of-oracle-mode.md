...
|machine-translation||
|slug|v$ob_pl_cache_object-v-ob_pl_cache_object-of-oracle-mode|
...
| PL_CG_MEM_HOLD    | NUMBER(38)          | NO   | The memory held during the PL CG phase. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>    |
| SYS_VARS          | VARCHAR2(4096)       | NO   | The system variables affecting plan generation in the current session. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>    |
| PARAM_INFOS       | CLOB            | NO   | The type information of the anonymous block and call proc info, which is used to determine whether the match is successful. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>   |
