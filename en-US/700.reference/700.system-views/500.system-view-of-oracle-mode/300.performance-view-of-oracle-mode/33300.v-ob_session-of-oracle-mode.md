...
| --- | --- | --- | --- |
| ID | NUMBER(38) | NO | For versions V4.2.x: <ul><li> For versions earlier than V4.2.5 BP3 Hotfix5: <br>In all connection modes (Direct Mode/ODP Mode), this field represents the Server Session ID. </li><li> For V4.2.5 BP3 Hotfix5 and later: <ul><li> In Direct Mode: <br>This field represents the Server Session ID. </li> <li> In ODP Mode: </li> <ul><li> If the setting <code>client_session_id_version = 2</code> is configured in ODP, this field represents the Client Session ID. </li> <li> If the setting <code>client_session_id_version = 1</code> is configured, this field represents the Server Session ID. </li></ul></ul></li></ul> |
