...
| INFO       | VARCHAR2(262143) | YES | Displays the current command being executed. |
...
| TOP_INFO         | VARCHAR2(262143) | YES      | Displays the information of the top-level PL statement where the executing SQL statement is located. <main id="notice" type='explain'><h4>Note</h4><ul><li>In V4.3.x, this field was introduced in V4.3.3. </li> <li>In V4.2.1, this column displays NULL. </li></ul></main> |
