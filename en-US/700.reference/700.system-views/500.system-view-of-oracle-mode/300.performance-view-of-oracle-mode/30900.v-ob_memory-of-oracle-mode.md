...
<h4>Note</h4>
<ul><li>The view name is changed from <code>V$MEMORY</code> to <code>V$OB_MEMORY</code> since OceanBase Database V4.0.0. </li>
<li>The view is supported only in MySQL-compatible mode. The query result is empty in Oracle-compatible mode. </li></ul>
</main>
