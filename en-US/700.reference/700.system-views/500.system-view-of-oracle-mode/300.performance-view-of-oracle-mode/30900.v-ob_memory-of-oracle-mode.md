...
<h4>Note</h4>
<ul><li>The name of this view is changed from <code>V$MEMORY</code> to <code>V$OB_MEMORY</code> since OceanBase Database V4.0.0. </li>
<li>Only MySQL compatible mode is supported. The query result is empty in Oracle compatible mode. </li></ul>
</main>
