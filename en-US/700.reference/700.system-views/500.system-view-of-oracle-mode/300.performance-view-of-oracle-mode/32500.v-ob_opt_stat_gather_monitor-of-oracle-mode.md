...
<!-- * To query the statistics collection status at the tenant level, see DBA_OB_TASK_OPT_STAT_GATHER_HISTORY. -->

<!-- * To query the statistics collection status at the table level, see DBA_OB_TABLE_OPT_STAT_GATHER_HISTORY. -->
