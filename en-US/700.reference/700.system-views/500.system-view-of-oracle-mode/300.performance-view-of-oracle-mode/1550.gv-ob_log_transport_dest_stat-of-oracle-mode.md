...
| CLIENT_TYPE                 | VARCHAR2(7)                       | NO   | Type of the client node requesting the logs:<ul><li>STANDBY: network standby </li><li>CDC: OBCDC </li><li>UNKNOWN: unknown client type </li></ul>    |
...
| LAST_READ_SOURCE            | VARCHAR2(7)          | NO   | Source of the logs read when the last request was processed:<ul><li>ONLINE: online logs </li><li>ARCHIVE: archived logs </li><li>UNKNOWN: unknown source </li></ul>     |
| LAST_REQUEST_TYPE           | VARCHAR2(24)         | NO   | RPC type of the last request:<ul><li>0: SEQUENTIAL_READ_SERIAL, which indicates that the serial log transfer protocol is used to read logs sequentially. </li><li>1: SEQUENTIAL_READ_PARALLEL, which indicates that the parallel log transfer protocol is used to read logs sequentially. </li><li>2: SCATTERED_READ, which indicates that the last request was for reading scattered logs. </li><li>Other values: indicates an unknown RPC type. </li></ul>     |
