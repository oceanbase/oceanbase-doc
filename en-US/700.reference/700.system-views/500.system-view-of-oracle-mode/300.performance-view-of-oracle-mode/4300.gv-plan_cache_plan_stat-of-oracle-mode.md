...
| TYPE                  | NUMBER(38)                        | NO             | For SQL plan caching, this field indicates the type of the plan:  <ul><li> 1: indicates a local plan.  </li><li> 2: indicates a remote plan. </li><li>3: indicates a distributed plan.  </li></ul>For PL object caching, this field indicates the type of the PL object:<ul><li> 1: indicates a procedure.    </li><li> 2: indicates a function. </li><li>3: indicates a package.  </li><li> 4: indicates an anonymous block.   </li></ul>    |
...
| SPECIAL_PARAMS        | VARCHAR2(4096)                    | NO             | The values of the parameters that cannot be parameterized.         |
...
| PLAN_SIZE             | NUMBER(38)                        | NO             | The size of the cached object in memory.         |
...
| DIRECT_WRITES         | NUMBER(38)                        | NO             | The number of writes to the disk.           |
| BUFFERS_GETS          | NUMBER(38)                        | NO             | The number of logical reads.          |
| APPLICATION_WAIT_TIME | NUMBER(38)                        | NO             | The total time for all application events during the execution of the request, in microseconds.                                                                             |
| CONCURRENCY_WAIT_TIME | NUMBER(38)                        | NO             | The total time for all concurrency events during the execution of the request, in microseconds.                                                                             |
| USER_IO_WAIT_TIME     | NUMBER(38)                        | NO             | The total time for all user_io events during the execution of the request, in microseconds.                                                                                 |
| ROWS_PROCESSED        | NUMBER(38)                        | NO             | The number of rows processed by the query or the number of rows changed in the table.                                                                                  |
...
| DELAYED_LARGE_QUERYS  | NUMBER(38)                        | NO             | The number of large queries that were identified and queued. |
| DELAYED_PX_QUERYS     | NUMBER(38)                        | NO             | The number of parallel queries that were returned to the queue for retry.      |
| OUTLINE_VERSION       | NUMBER(38)                        | NO             | The outline version number.         |
| OUTLINE_ID            | NUMBER(38)                        | NO             | The ID of the outline. `-1` indicates that the plan was not generated by using an outline.                                                             |
...
| PS_STMT_ID            | NUMBER(38)                        | NO             | The Prepare ID corresponding to the request: <li>`-1`: The SQL statement does not use the PS protocol. <li>Non-`-1`: The SQL statement uses the PS protocol. The PS protocol returns a unique identifier for the statement.                                                                            |
| SESSID                | NUMBER(38)                        | NO             | The session ID of the cache object.<br>For V4.2.x: <ul><li> V4.2.5 BP4 and earlier: <br>In all connection modes (direct mode/ODP mode), this field indicates the server session ID. </li><li> V4.2.5 BP4 and later: <ul><li> In direct mode: <br>This field indicates the server session ID. </li> <li> In ODP mode: </li><ul><li> If the configuration item <code>client_session_id_version = 2</code> is set in ODP, this field indicates the client session ID. </li> <li> If <code>client_session_id_version = 1</code>, this field indicates the server session ID. </li></ul></ul></li></ul>   |
| TEMP_TABLES           | CLOB                              | NO             | The name of the temporary table in the SQL plan. If no temporary table is included, this field is empty.                                                                           |
| IS_USE_JIT            | NUMBER(38)                        | NO             | Indicates whether the SQL plan is enabled for expression compilation execution.  |
| OBJECT_TYPE           | CLOB                              | NO             | The type of the cache object: <li>SQL_PLAN<li> PROCEDURE   <li>FUNCTION<li> PACKAGE   <li> ANONYMOUS                                                                                  |
| PL_SCHEMA_ID          | NUMBER(38)                        | NO             | For non-anonymous blocks, this field indicates the schema ID of the cache object. For anonymous blocks, this field is the same as ps_stmt_id. For SQL plans, this field is irrelevant.                              |
