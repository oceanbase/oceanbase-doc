...
| STATUS | VARCHAR2(32) | NO | The thread status: <ul><li> Run indicates that the thread is running.  </li><li> Wait indicates that the thread is waiting. </li><li> Sleep indicates that the thread is sleeping. </li><li> Join indicates that the thread is waiting for another thread to end. </li></ul>|
