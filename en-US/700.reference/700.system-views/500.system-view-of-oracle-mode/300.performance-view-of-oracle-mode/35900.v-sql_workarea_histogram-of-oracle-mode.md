...
This view displays the statistics of all previous workarea executions on the current node of the current tenant, including the number of times full in-memory processing occurred between 1M and 2M, the number of one-pass executions, and so on.
