...
This view `GV$OB_TENANT_RESOURCE_LIMIT_DETAIL` displays the resource limits and their upper limits for the current tenant on all OBServer nodes.
...
Query the resource limits and their upper limits for the current tenant on all OBServer nodes.
