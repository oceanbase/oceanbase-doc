...
| ADDRESS              | VARCHAR2(8)  | NO   | The SQL address. Together with the SQL hash, it uniquely identifies an SQL statement. This column is always NULL. |
| HASH_VALUE           | NUMBER       | NO   | The SQL hash. This column is always NULL. |
...
| SQL_EXEC_ID          | NUMBER       | NO   | This column is always NULL. |
