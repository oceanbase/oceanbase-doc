...
| TYPE                  | NUMBER(38)                        | NO             | For SQL plan caching, this field indicates the plan type:  <ul><li> 1: Local Plan  </li><li> 2: Remote Plan </li><li>3: Distribute Plan  </li></ul>For PL object caching, this field indicates the type of the PL object:<ul><li> 1: Procedure    </li><li> 2: Function </li><li>3: Package  </li><li> 4: Anonymous Block   </li></ul>     |
...
| OBJECT_TYPE           | CLOB                              | NO             | The type of the cached object: <li> SQL_PLAN   <li> PROCEDURE   <li> FUNCTION   <li> PACKAGE   <li> ANONYMOUS                                                                                  |
