...
The `V$OB_SQLSTAT` view displays basic performance statistics for SQL statements on the current node. Each SQL statement is represented by a row (i.e., each unique combination of `SQL_ID` and `Plan_Hash` corresponds to a row). The columns with `_DELTA` in their names indicate the incremental values from the last WR snapshot collection to the current time.
...
| ELAPSED_TIME_TOTAL            | NUMBER          | NO   |   The total time consumed by the statement. For parallel execution scenarios, this value is the sum of the elapsed times for each execution thread.          |
...
| WRITE_THROTTLE_TOTAL          | NUMBER          | NO   |   The total time when write throttling occurred during MemStore writes.    |
| WRITE_THROTTLE_DELTA          | NUMBER          | NO   |   The incremental time when write throttling occurred during MemStore writes.    |
...
| ROUTE_MISS_DELTA              | NUMBER          | NO   |   The number of times the request partition is not hit since the last WR snapshot collection began<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.2. </li></ul></main>   |
| FIRST_LOAD_TIME               | TIMESTAMP(6)    | NO   |   The plan generation time<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.5. </li></ul></main>   |
| PLAN_CACHE_HIT_TOTAL          | NUMBER          | NO   |   The total number of times the Plan Cache is hit since the OBServer started<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.5. </li></ul></main>   |
| PLAN_CACHE_HIT_DELTA          | NUMBER          | NO   |   The number of times the Plan Cache is hit since the last WR snapshot collection began<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.5. </li></ul></main>  |
| MUTI_QUERY_TOTAL              | NUMBER        | NO   | The number of times the SQL statement is in a multi-query since the execution plan was generated<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this field is available starting with V4.4.2. </p></main>|
| MUTI_QUERY_DELTA              | NUMBER        | NO   | The number of times the SQL statement is in a multi-query since the last WR snapshot collection<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this field is available starting with V4.4.2. </p></main>|
| MUTI_QUERY_BATCH_TOTAL        | NUMBER        | NO   | The number of times the SQL batch has been executed since the execution plan was generated<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this field is available starting with V4.4.2. </p></main>|
| MUTI_QUERY_BATCH_DELTA        | NUMBER        | NO   | The number of times the SQL batch has been executed since the last WR snapshot collection<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this field is available starting with V4.4.2. </p></main>|
| FULL_TABLE_SCAN_TOTAL         | NUMBER        | NO   | The number of full table scans for the SQL statement since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column is available starting from V4.4.2. </p></main>|
| FULL_TABLE_SCAN_DELTA         | NUMBER        | NO   | The number of full table scans for the SQL statement since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column is available starting from V4.4.2. </p></main>|
| ERROR_COUNT_TOTAL             | NUMBER        | NO   | The number of errors for the SQL statement since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column is available starting from V4.4.2. </p></main>|
| ERROR_COUNT_DELTA             | NUMBER        | NO   | The number of errors for the SQL statement since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column is available starting from V4.4.2. </p></main>|
| LATEST_ACTIVE_TIME            | TIMESTAMP(6)  | NO   | The last active time of the SQL ID + Plan Hash pair on a node. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column is available starting from V4.4.2. </p></main> |
...
The following sample query displays the basic performance statistics of SQL on the current node, and displays the first record.
