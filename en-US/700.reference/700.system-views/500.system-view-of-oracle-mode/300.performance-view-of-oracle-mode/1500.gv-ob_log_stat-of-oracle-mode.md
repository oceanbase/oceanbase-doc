...
| SYNC_MODE         | VARCHAR2(128)  | NO | The synchronization mode of a log stream. Valid values: <li>`ASYNC`: asynchronous synchronization mode</li> <li>`SYNC`: strong synchronization mode</li> <li>`PRE_ASYNC`: the synchronization mode is being switched from strong synchronization to asynchronous synchronization. |
