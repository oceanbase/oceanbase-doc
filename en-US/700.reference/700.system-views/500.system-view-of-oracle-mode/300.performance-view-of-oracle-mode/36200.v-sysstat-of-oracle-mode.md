...
* `STATISTIC#`: the index of the statistical event. The index of the same statistical event may vary across different OBServer node versions.

* `STAT_ID`: the ID of the statistical event. The ID of the same statistical event is guaranteed to be consistent across different OBServer node versions.
...
* Query the definitions of all statistical events of the tenant: [V$STATNAME](36100.v-statname-of-oracle-mode.md)
