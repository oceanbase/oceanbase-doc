...
| PARTICIPANT_TABLE                    | VARCHAR2(512) | NO         | The information about the table involved in the current compaction.  |
...
| EXECUTE_TIME                    | NUMBER(38)     | NO | The time consumed by the major compaction task for CPU, in microseconds. <main id="notice" type='explain'><h4>Note</h4><p>This field was introduced in V4.3.5 BP3.</p></main> |
| FILTER_ROW_COUNT                | NUMBER(38)     | NO | The number of rows recovered by the compaction. <main id="notice" type='explain'><h4>Note</h4><p>This field was introduced in V4.6.0.</p></main>  |
