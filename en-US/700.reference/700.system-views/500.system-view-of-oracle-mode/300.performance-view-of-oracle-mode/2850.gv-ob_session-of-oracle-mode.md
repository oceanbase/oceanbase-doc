...
|machine-translation||
|slug|gv$ob_session-gv-ob_session-of-oracle-mode|
...
| --- | --- | --- | --- |
| ID | NUMBER(38) | NO | For V4.2.x: <ul><li>V4.2.5 BP4 or earlier: <br>In all connection modes (direct mode/ODP mode), this field represents the server session ID.</li><li>V4.2.5 BP4 or later: <ul><li>In direct mode: <br>This field represents the server session ID.</li><li>In ODP mode: <ul><li>If the <code>client_session_id_version = 2</code> parameter is specified in the ODP parameter list, this field represents the client session ID. </li><li>If the <code>client_session_id_version = 1</code> parameter is specified, this field represents the server session ID.</li></ul></li></ul></li></ul>   |
