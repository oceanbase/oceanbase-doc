...
|machine-translation||
|slug|gv$ob_pl_cache_object-gv-ob_pl_cache_object-of-oracle-mode|
...
| SYS_VARS          | VARCHAR2(4096)       | NO   | The system variables that affect the plan generation in the current session. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>    |
| PARAM_INFOS       | CLOB            | NO   | The parameterized type information for anonymous blocks and call proc info, used to determine if the match is successful. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>   |
