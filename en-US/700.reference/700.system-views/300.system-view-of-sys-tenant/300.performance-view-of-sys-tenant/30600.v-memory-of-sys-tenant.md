...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>The view name has been changed from V$MEMORY to V$OB_MEMORY since V4.0.0.</p>
</main>
...
<table>
  ...
  <tr>
    ...
    <li>CsSstableReader: a reader for compressed tables. </li>
  ...
  <tr>
    ...
    <li>SortOpRows: the set of row objects to be sorted. </li>
  ...
  <tr>
    ...
    <li>TenantCtxAlloca: Allocate context for the tenant.  </li>
    </ul>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>ReplayStatus: the status of the replay module.</td>
  </tr>
  <tr>
    <td>CO_STACK</td>
  ...
  <tr>
    ...
    <li>MemtableObject: in-memory table object. </li>
    </ul>
    </td>
  </tr>
  <tr>
...
The following are some common SQL executions or operations that may cause the usage of memory for certain CTXs to increase:
