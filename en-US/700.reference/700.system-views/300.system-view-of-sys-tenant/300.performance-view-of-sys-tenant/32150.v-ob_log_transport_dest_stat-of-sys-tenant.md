...
| LAST_READ_SOURCE            | varchar(7)          | NO   | The source where logs are read during the last request processing. Valid values: <ul><li>`ONLINE`: indicates online logs. </li><li>`ARCHIVE`: indicates archive logs. </li><li>`UNKNOWN`: indicates an unknown source. </li></ul>     |
