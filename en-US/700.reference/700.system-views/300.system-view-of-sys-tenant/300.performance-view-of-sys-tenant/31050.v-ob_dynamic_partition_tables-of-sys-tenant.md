...
Displays information about the dynamic partitioning of all tenants. The view reads the attributes of dynamic partitioned tables from the memory and has better read performance.
