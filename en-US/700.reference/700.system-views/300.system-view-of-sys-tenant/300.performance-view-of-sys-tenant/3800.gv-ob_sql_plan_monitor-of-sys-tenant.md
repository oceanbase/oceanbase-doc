...
|dir-name-en||
|tenant-type||
|slug|gv-ob-sql_plan_monitor-sys-tenant|
...
The `GV$SQL_PLAN_MONITOR` view displays the operation-level statistics for slow queries across all tenants and OBServer nodes. Each operation of a slow query provides statistics.
...
| USER_IO_WAIT_TIME       | bigint(20)           | NO | The I/O wait time for accessing the intermediate index and data microblocks.|
...
| FIRST_CHANGE_TIME       | timestamp(6)         | YES | The time when the operator returned the first row. |
| LAST_CHANGE_TIME        | timestamp(6)         | YES | The time when the operator returned the last row. |
...
| PLAN_TEMP_SPACE         | bigint(0) unsigned   | NO | The size of space occupied by the operator calculated by the optimizer. |
...
| PHYSICAL_READ_BYTES     | bigint(0) unsigned   | NO | The size of I/O read requests issued by the operator. |
| PHYSICAL_WRITE_REQUESTS | bigint(0) unsigned   | NO | The number of I/O write requests issued by the operator. |
| PHYSICAL_WRITE_BYTES    | bigint(0) unsigned   | NO | The number of bytes in I/O write requests issued by the operator. |
...
| OTHERSTAT_1_VALUE       | bigint(20)           | NO | The number of bytes read from the storage engine by the TABLE SCAN operator. `IO_READ_BYTES`<main id="notice" type='explain'><h4>Note</h4><ul><li>Starting from V4.3.3 BP1 of V4.3.x, the TABLE SCAN operator supports real-time statistics, instead of statistics at the end of the operator's calculation. </li><li>Starting from V4.2.4 of V4.2.x, the TABLE SCAN operator supports real-time statistics, instead of statistics at the end of the operator's calculation. </li></ul></main> |
| OTHERSTAT_2_ID          | bigint(20)           | NO | The ID of the field. |
| OTHERSTAT_2_TYPE        | bigint(0) unsigned   | NO | Reserved. |
| OTHERSTAT_2_VALUE       | bigint(20)           | NO | The number of bytes read from the SSStore by the TABLE SCAN operator. `SSSTORE_READ_BYTES`<main id="notice" type='explain'><h4>Note</h4><ul><li>Starting from V4.3.3 BP1 of V4.3.x, the TABLE SCAN operator supports real-time statistics, instead of statistics at the end of the operator's calculation. </li><li>Starting from V4.2.4 of V4.2.x, the TABLE SCAN operator supports real-time statistics, instead of statistics at the end of the operator's calculation. </li></ul></main> |
| OTHERSTAT_3_ID          | bigint(20)           | NO | The ID of the field. |
| OTHERSTAT_3_TYPE        | bigint(0) unsigned   | NO | Reserved. |
| OTHERSTAT_3_VALUE       | bigint(20)           | NO | The total number of major SSTables read in the range by the operator in the push-down and non-push-down paths. |
| OTHERSTAT_4_ID          | bigint(20)           | NO | The ID of the field. |
| OTHERSTAT_4_TYPE        | bigint(0) unsigned   | NO | Reserved. |
| OTHERSTAT_4_VALUE       | bigint(20)           | NO | The number of minor SSTables, mini SSTables, and MemTables read in the range by the operator in the push-down and non-push-down paths. |
| OTHERSTAT_5_ID          | bigint(20)           | NO | Reserved. |
| OTHERSTAT_5_TYPE        | bigint(0) unsigned   | NO | Reserved. |
| OTHERSTAT_5_VALUE       | bigint(20)           | NO | The number of microblocks opened in the push-down path. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting from V4.5.0 of V4.5.x. </p></main>|
| OTHERSTAT_6_ID          | bigint(20)           | NO | Reserved. |
| OTHERSTAT_6_TYPE        | bigint(0) unsigned   | NO | Reserved. |
| OTHERSTAT_6_VALUE       | bigint(20)           | NO | The total number of microblocks opened in the push-down path in the range. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting from V4.5.0 of V4.5.x. </p></main>|
...
| SKIPPED_ROWS_COUNT      | bigint(20)           | NO | The total number of rows that do not need to be computed during the calculation process of the operator in vectorized mode (i.e., the total number of filtered rows). |
| PROFILE                 | varchar(65535)       | NO | Displays the PROFILE monitoring metrics of the SQL PLAN MONITOR. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.1. </p></main>|
