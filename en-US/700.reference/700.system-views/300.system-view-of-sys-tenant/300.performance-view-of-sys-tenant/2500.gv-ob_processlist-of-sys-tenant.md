...
The `GV$OB_PROCESSLIST` view displays information about sessions on all OBServer nodes of all tenants.
...
Query information about sessions on all OBServer nodes of all tenants.
