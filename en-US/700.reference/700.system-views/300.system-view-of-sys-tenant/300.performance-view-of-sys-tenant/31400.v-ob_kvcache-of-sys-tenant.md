...
This view displays the KVcache information of all tenants on the current OBServer node.
...
| CACHE_SIZE     | bigint(20)    | NO         | The size of the cache.  |
| HIT_RATIO      | decimal(38,3) | NO         | The hit ratio.       |
| TOTAL_PUT_CNT  | bigint(20)    | NO         | The number of PUT operations.    |
| TOTAL_HIT_CNT  | bigint(20)    | NO         | The number of hits.      |
| TOTAL_MISS_CNT | bigint(20)    | NO         | The number of misses.     |

## Sample query

In the sys tenant, query the KVcache information of the tenant with ID 1002 on the current OBServer node.
