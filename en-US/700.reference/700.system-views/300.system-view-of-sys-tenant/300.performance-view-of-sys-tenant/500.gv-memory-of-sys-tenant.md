...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <ul><li>This view was renamed from <code>GV$MEMORY</code> to <code>GV$OB_MEMORY</code> starting from V4.0.0. In V4.0.0 and later versions, you must use the new view name <code>GV$OB_MEMORY</code> to query. Using the old view name <code>GV$MEMORY</code> will result in an error. </li><ul>
</main>
...
<table>
  ...
  <tr>
    ...
    <li>SstaMicrBlocAll: statistics and microblock module </li>
    <li>CsSstableReader: compressed SSTable reader </li>
  ...
  <tr>
    ...
    <li>ArenaHashJoin: hash join memory management module </li>
...
In OceanBase Database, each SQL execution or operation corresponds to a specific CTX. Due to variations in data volume and operation complexity, the use of memory CTX can lead to an increase in memory usage.
