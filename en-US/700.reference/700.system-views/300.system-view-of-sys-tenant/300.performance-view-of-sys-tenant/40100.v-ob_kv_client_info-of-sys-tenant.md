...
The `V$OB_KV_CLIENT_INFO` view displays the parameters of client connections in all OBKV tenants on the current OBServer node. You can query this view from the `sys` tenant.
