...
The `GV$OB_SQLSTAT` view displays basic performance statistics for SQL statements in the cluster. Each row corresponds to an SQL statement (i.e., each unique combination of `SQL_ID` and `Plan_Hash`). Columns with `_DELTA` in their names indicate the incremental statistics from the last WR snapshot collection to the current time.
...
| QUERY_SQL                     | longtext            | NO   | The full SQL text. |
...
| ELAPSED_TIME_TOTAL            | bigint(20)          | NO   |   The total time consumed by the statement. For parallel execution, this value is the sum of the elapsed times of each execution thread.          |
...
| WRITE_THROTTLE_TOTAL          | bigint(20)          | NO   |   The total time consumed by throttling during write operations to the MemStore.    |
| WRITE_THROTTLE_DELTA          | bigint(20)          | NO   |   The incremental time consumed by throttling during write operations to the MemStore.    |
...
| FIRST_LOAD_TIME               | timestamp(6)        | YES  |   The plan generation time.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.5. </li></ul></main>   |
| PLAN_CACHE_HIT_TOTAL          | bigint(20)          | NO   |   The total number of times that the Plan Cache is hit since the OBServer was started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.5. </li></ul></main>   |
| PLAN_CACHE_HIT_DELTA          | bigint(20)          | NO   |   The number of times that the Plan Cache is hit since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.5. </li></ul></main>  |
...
| MUTI_QUERY_BATCH_DELTA        | bigint(20)        | NO   | The number of times the SQL batch has been executed since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 in V4.4.x. </p></main>|
| FULL_TABLE_SCAN_TOTAL         | bigint(20)        | NO   | The number of full table scans executed since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 in V4.4.x. </p></main>|
| FULL_TABLE_SCAN_DELTA         | bigint(20)        | NO   | The number of full table scans executed since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 in V4.4.x. </p></main>|
| ERROR_COUNT_TOTAL             | bigint(20)        | NO   | The number of errors reported since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 in V4.4.x. </p></main>|
| ERROR_COUNT_DELTA             | bigint(20)        | NO   | The number of errors reported since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 in V4.4.x. </p></main>|
| LATEST_ACTIVE_TIME            | timestamp(6)      | YES  | The last active time of the plan corresponding to the SQL ID + Plan Hash on a node. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 in V4.4.x. </p></main>     |
