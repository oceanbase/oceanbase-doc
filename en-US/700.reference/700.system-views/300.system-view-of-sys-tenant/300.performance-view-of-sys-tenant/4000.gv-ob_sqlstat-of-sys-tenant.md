...
The `GV$OB_SQLSTAT` view displays basic performance statistics for SQL statements in the cluster. Each SQL statement is represented by a row (i.e., each unique combination of `SQL_ID` and `Plan_Hash` is a row). The lists with `_DELTA` indicate the incremental values from the last WR snapshot collection to the current time.
...
| PHYSICAL_READ_BYTES_TOTAL     | bigint(20)          | NO   |   The total number of bytes read in physical reads.     |
| PHYSICAL_READ_BYTES_DELTA     | bigint(20)          | NO   |   The incremental number of bytes read in physical reads.   |
...
| NESTED_SQL_TOTAL              | bigint(20)          | NO   |   The total number of nested SQL statements executed. Each time a nested SQL statement is executed, the value increases by 1.     |
...
| ROUTE_MISS_DELTA              | bigint(20)          | NO   |   The number of times that the request partition was not hit since the last WR snapshot collection started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this column was introduced in V4.3.5. </li> <li>For V4.2.x, this column was introduced in V4.2.2. </li></ul></main>   |
| FIRST_LOAD_TIME               | timestamp(6)        | YES  |   The time when the plan was generated.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this column was introduced in V4.3.5. </li> <li>For V4.2.x, this column was introduced in V4.2.5. </li></ul></main>   |
...
| PLAN_CACHE_HIT_DELTA          | bigint(20)          | NO   |   The number of times that the Plan Cache was hit since the last WR snapshot collection started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this column was introduced in V4.3.5. </li> <li>For V4.2.x, this column was introduced in V4.2.5. </li></ul></main>  |
| MUTI_QUERY_TOTAL              | bigint(20)        | NO   | The number of times that the SQL statement was in a Multi Query since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column was introduced in V4.4.2. </p></main>|
| MUTI_QUERY_DELTA              | bigint(20)        | NO   | The number of times that the SQL statement was in a Multi Query since the last WR snapshot collection.<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column was introduced in V4.4.2. </p></main>|
| MUTI_QUERY_BATCH_TOTAL        | bigint(20)        | NO   | The number of times that the SQL batch was executed since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this column was introduced in V4.4.2. </p></main>|
...
| FULL_TABLE_SCAN_TOTAL         | bigint(20)        | NO   | The number of times the SQL has performed a full table scan since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 in V4.4.x. </p></main>|
| FULL_TABLE_SCAN_DELTA         | bigint(20)        | NO   | The number of times the SQL has performed a full table scan since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 in V4.4.x. </p></main>|
| ERROR_COUNT_TOTAL             | bigint(20)        | NO   | The number of errors that occurred in the SQL since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 in V4.4.x. </p></main>|
| ERROR_COUNT_DELTA             | bigint(20)        | NO   | The number of errors that occurred in the SQL since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.4.2 in V4.4.x. </p></main>|
