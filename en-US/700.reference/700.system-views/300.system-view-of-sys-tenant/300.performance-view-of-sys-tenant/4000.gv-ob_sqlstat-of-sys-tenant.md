...
The `GV$OB_SQLSTAT` view displays basic performance statistics for SQL statements in the cluster. Each SQL statement is represented by a row (i.e., each unique combination of `SQL_ID` and `Plan_Hash`). The columns with `_DELTA` in their names show the incremental values from the last WR snapshot collection to the current time.
...
| PLAN_TYPE                     | bigint(20)          | NO   |    For SQL plan caching, the value of this column indicates the type of the plan:<ul><li>`1`: Local Plan </li> <li>`2`: Remote Plan</li> <li>`3`: Distributed Plan </li></ul> </br>For PL/SQL object caching, the value of this column indicates the type of the PL/SQL object:<ul><li>`1`: Procedure</li> <li>`2`: Function</li> <li>`3`: Package</li> <li>`4`: Anonymous Block </li></ul> |
...
| ROUTE_MISS_DELTA              | bigint(20)          | NO   |   The number of times that the request partition is not hit since the last WR snapshot collection began.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.2. </li></ul></main>   |
...
| PLAN_CACHE_HIT_TOTAL          | bigint(20)          | NO   |   The total number of times that the Plan Cache was hit since the OBServer started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.5. </li></ul></main>   |
| PLAN_CACHE_HIT_DELTA          | bigint(20)          | NO   |   The number of times that the Plan Cache was hit since the last WR snapshot collection began.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.5. </li></ul></main>  |
| MUTI_QUERY_TOTAL              | bigint(20)        | NO   | The number of times the SQL statement is in a multi-query since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>For V4.6.x, this field is available starting with V4.6.0. </p></main>|
| MUTI_QUERY_DELTA              | bigint(20)        | NO   | The number of times the SQL statement is in a multi-query since the last WR snapshot collection began.<main id="notice" type='explain'><h4>Note</h4><p>For V4.6.x, this field is available starting with V4.6.0. </p></main>|
| MUTI_QUERY_BATCH_TOTAL        | bigint(20)        | NO   | The number of times the SQL batch is executed since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>For V4.6.x, this field is available starting with V4.6.0. </p></main>|
...
View the basic performance statistics of SQL in the cluster, and display the first record.
