...
|tenant-type||
|machine-translation||
|slug|gv$ob_tenant_resource_limit|
...
The `GV$OB_TENANT_RESOURCE_LIMIT` view displays the usage, upper limits, and effective limits of the logical resources on all OBServer nodes in all tenants, as well as the maximum historical usage of the logical resources after a restart upon downtime.
...
Query the usage, upper limits, and effective limits of the logical resources on all OBServer nodes in all tenants, as well as the maximum historical usage of the logical resources after a restart upon downtime.
