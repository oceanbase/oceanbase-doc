...
This view displays the information about the most recent 10 wait events for all sessions on all OBServer nodes.
...
In the sys tenant, query the information about the most recent 10 wait events for all sessions on all OBServer nodes.
