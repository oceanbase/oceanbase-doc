...
| MODE                         | varchar(32)  | NO             | The read/write mode of the I/O operation (remote request for shared storage requests, local request for other types of requests):<ul><li>`LOCAL READ`: Local read</li> <li>`LOCAL WRITE`: Local write</li> <li>`REMOTE READ`: Remote read</li> <li>`REMOTE WRITE`: Remote write</li></ul>    |
