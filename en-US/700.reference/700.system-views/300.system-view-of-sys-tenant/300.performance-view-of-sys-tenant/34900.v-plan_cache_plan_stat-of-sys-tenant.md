...
| TYPE                  | bigint(20)          | NO         | The type of the cached object. For SQL plans, the value indicates the type of the plan:  <ul><li> 1: local plan  </li><li> 2: remote plan </li><li>3: distributed plan  </li></ul>For PL objects, the value indicates the type of the PL object:<ul><li> 1: procedure    </li><li> 2: function </li><li>3: package  </li><li> 4: anonymous block  </li></ul>  |
