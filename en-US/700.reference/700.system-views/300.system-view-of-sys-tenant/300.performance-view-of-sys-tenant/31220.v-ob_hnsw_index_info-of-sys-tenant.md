...
This view displays the basic information and real-time status of HNSW vector indexes on all tenants in the current OBServer node.
...
Query the real-time status of HNSW vector indexes on all tenants across all OBServer nodes.
