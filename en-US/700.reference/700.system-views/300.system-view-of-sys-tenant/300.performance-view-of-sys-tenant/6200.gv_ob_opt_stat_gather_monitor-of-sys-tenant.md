...
Query the real-time status of statistics collection tasks for tenant 1006 in all nodes in the sys tenant.
...
* [DBA_OB_TASK_OPT_STAT_GATHER_HISTORY](../200.dictionary-view-of-sys-tenant/22800.o-dba_ob_task_opt_stat_gather_history-of-sys-tenant.md): View the collection status of tenant-level historical statistics.

* [DBA_OB_TABLE_OPT_STAT_GATHER_HISTORY](../200.dictionary-view-of-sys-tenant/22000.o-dba_ob_table_opt_stat_gather_history-of-sys-tenant.md): View the collection status of table-level historical statistics.
