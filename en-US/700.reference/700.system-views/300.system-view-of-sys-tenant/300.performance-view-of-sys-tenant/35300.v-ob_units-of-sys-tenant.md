...
| DATA_DISK_SIZE   | bigint(20)   | YES        | The value of this field is `NULL`, indicating that the value is undefined. In this case, the system allows the Unit to compete for disk space from other tenants. <main id="notice" type='explain'><h4>Note</h4><p>This field was introduced in V4.3.4. </p></main>     |
...
The following example shows how to query the Unit information of all user tenants in the current OBServer node in shared storage (Shared-Storage, SS) mode.
