...
| REPLICA_TYPE     | varchar(7)   | NO         | The replica type. The default value is `FULL`. <main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.5.x, the <code>REPLICA_TYPE</code> column is available starting from V4.5.0. </li><li>For V4.2.5, the <code>REPLICA_TYPE</code> column is available starting from V4.2.5 BP7. </li></ul></main>    |
