...
|slug|gv-ob_tenant_resource_limit-of-sys-tenant|
...
| EFFECTIVE_LIMIT_TYPE | varchar(128) | NO   |  The type of the effective limit, such as configuration parameters, memory, CPU, and disk.    |
