...
<li>In OceanBase Database V4.x, you can query the <a href="30700.v-memstore-of-sys-tenant.md">V$OB_MEMSTORE</a> or <a href="32400.v-ob_memstore_info-of-sys-tenant.md">V$OB_MEMSTORE_INFO</a> view for MemTables. </li></ul>
</main>

## Purpose

The `v$tenant_memstore_allocator_info` view displays some information about the MemTables on the connected OBServer nodes. You can use this view to troubleshoot the issue where the MemStore memory of a tenant no longer in use is not released. Each row contains the information about one MemTable.
