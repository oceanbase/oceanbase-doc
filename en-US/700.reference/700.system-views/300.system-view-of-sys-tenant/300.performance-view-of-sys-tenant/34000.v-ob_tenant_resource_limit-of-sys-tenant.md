...
The `V$OB_TENANT_RESOURCE_LIMIT` view displays the usage, upper limits, and effective limits of the logical resources on the current OBServer node in all tenants, as well as the maximum historical usage of the logical resources after a restart upon downtime.
...
Query the usage, upper limits, and effective limits of the logical resources on the current OBServer node in all tenants, as well as the maximum historical usage of the logical resources after a restart upon downtime.
