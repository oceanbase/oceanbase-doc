...
This view displays the basic information and real-time status of IVF vector indexes on all OBServer nodes for all tenants.
...
| CACHE_TYPE                   | varchar(29)   | NO             | The cache type of the IVF index. <ul><li>IVF_CENTROID_CACHE: the cache of the centroids of the IVF index. </li> <li>IVF_PQ_CENTROID_CACHE: the cache of the centroids of the IVF_PQ index. </li> <li>IVF_PQ_PRECOMPUTE_TABLE_CACHE: the cache of the precomputed table of the IVF_PQ index. </li></ul>                                                    | Cache information |
...
Query the real-time status of IVF vector indexes on all OBServer nodes for all tenants as the sys tenant.
