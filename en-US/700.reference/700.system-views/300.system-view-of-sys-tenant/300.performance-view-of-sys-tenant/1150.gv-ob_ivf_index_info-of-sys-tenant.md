...
| IS_INIT                      | varchar(5)   | NO             | Indicates whether the index is initialized:<ul><li>TRUE: the index is initialized</li> <li>FALSE: the index is not initialized</li></ul>                                                    | Cache information |
...
Query the real-time status of IVF vector indexes for all tenants on all OBServer nodes.
