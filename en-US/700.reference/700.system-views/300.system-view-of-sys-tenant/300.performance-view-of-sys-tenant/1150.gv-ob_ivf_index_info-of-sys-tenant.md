...
| CACHE_TYPE                   | varchar(29)   | NO             | The type of the IVF index cache. <ul><li>IVF_CENTROID_CACHE: the centroid cache of the IVF index. </li> <li>IVF_PQ_CENTROID_CACHE: the centroid cache of the IVF_PQ index. </li> <li>IVF_PQ_PRECOMPUTE_TABLE_CACHE: the precomputed table cache of the IVF_PQ index. </li></ul>                                                    | Cache information |
...
Query the real-time status of IVF vector indexes for all tenants on all OBServer nodes in the sys tenant.
