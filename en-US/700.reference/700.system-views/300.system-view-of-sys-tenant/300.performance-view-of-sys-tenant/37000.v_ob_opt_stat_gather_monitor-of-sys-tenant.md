...
This view displays the real-time status of all statistics collection tasks on the current OBServer node.
...
Query the real-time status of statistics collection tasks for tenant 1006 in the system tenant.
...
* To view the status of historical statistics collection for tenants, see [DBA_OB_TASK_OPT_STAT_GATHER_HISTORY](../200.dictionary-view-of-sys-tenant/22800.o-dba_ob_task_opt_stat_gather_history-of-sys-tenant.md).

* To view the status of historical statistics collection for tables, see [DBA_OB_TABLE_OPT_STAT_GATHER_HISTORY](../200.dictionary-view-of-sys-tenant/22000.o-dba_ob_table_opt_stat_gather_history-of-sys-tenant.md).
