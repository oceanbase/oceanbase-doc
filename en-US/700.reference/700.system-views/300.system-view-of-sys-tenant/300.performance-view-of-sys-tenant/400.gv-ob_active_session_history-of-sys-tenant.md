...
| WEIGHT                      | bigint(20)          | NO   | The number of times the same tenant and action occur within the time range corresponding to this WR record. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this field is introduced in V4.4.2. </p></main>     |
| IS_WR_WEIGHT_SAMPLE         | varchar(1)          | NO   | Indicates whether the column is an aggregated column for queue backlog waiting events. <main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this field is introduced in V4.4.2. </p></main>     |
