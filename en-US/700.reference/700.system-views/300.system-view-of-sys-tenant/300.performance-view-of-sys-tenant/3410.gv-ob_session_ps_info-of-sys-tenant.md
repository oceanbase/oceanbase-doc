...
| STMT_TYPE | varchar(256) | NO | The statement type of the prepared statement. Valid values:`T_SELECT`,`T_INSERT`,`T_REPLACE`,`T_DELETE`,`T_UPDATE`,`T_MERGE`,`T_EXPLAIN`,`T_CREATE_TABLE`,`T_DROP_TABLE`etc. |
