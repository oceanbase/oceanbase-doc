...
The `GV$OB_RES_MGR_SYSSTAT` view displays the statistics of resource groups in all OBServer nodes for all tenants.
...
| VALUE_TYPE | varchar(16) | NO   | The value type: cumulative or assigned.     |
| STAT_ID    | bigint(20)  | NO   | The ID of the statistic.     |

## Sample query

Query the statistics of resource groups in all OBServer nodes for all tenants.
