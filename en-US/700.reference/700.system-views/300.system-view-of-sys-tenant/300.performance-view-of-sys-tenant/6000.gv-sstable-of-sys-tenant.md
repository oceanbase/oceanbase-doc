...
Displays the information about the MemTable and SSTable under each partition of all tenants on all OBServer nodes.
...
In the sys tenant, view the MemTable and SSTable information of partition 1001 for log stream 1001 of the tenant with ID 1002 on all OBServer nodes.
