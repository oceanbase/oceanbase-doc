...
| PL_CG_MEM_HOLD    | bigint(20)          | NO   |  The amount of memory held during the PL CG phase. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>    |
| SYS_VARS          | varchar(4096)       | NO   |  The system variables that affect the plan generation in the current session. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>    |
| PARAM_INFOS       | longtext            | NO   |  The parameterized type information of anonymous blocks and call proc info. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>   |

## Sample query

Query the basic information about cached PL objects of all tenants.
