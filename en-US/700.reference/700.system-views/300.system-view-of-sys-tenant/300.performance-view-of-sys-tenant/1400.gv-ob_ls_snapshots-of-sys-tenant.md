...
|slug|gv-ob_ls_snapshots-of-sys-tenant|
...
| META_EXISTED | varchar(3) | NO | Indicates whether the metadata of the snapshot is stored in the unit (YES/NO). |
| BUILD_STATUS | varchar(10) | NO | The creation status of the snapshot. |
| REBUILD_SEQ_START | bigint(20) | YES | The REBUILD SEQ of the log stream when the snapshot creation starts. |
| REBUILD_SEQ_END | bigint(20) | YES | The REBUILD SEQ of the log stream when the snapshot creation ends. |
| END_INTERVAL_SCN | bigint(20) | YES | The SCN at which the replay ends. |
| LS_META_PACKAGE | longtext | YES | The log stream metadata corresponding to the start replay SCN. |
...
| TSNAP_CLONE_REF | bigint(20) | YES | The number of clone tasks for the snapshot of the corresponding tenant. |
| TSNAP_META_EXISTED | varchar(3) | NO | Indicates whether the metadata of the snapshot of the corresponding tenant is stored in the unit (YES/NO). |
