...
|---|---|
|machine-translation||
|slug|gv$ob_kv_group_commit_status|
...
The `GV$OB_KV_GROUP_COMMIT_STATUS` view displays the group commit status of client connections in all OBKV tenants. You can query this view from the `sys` tenant.
