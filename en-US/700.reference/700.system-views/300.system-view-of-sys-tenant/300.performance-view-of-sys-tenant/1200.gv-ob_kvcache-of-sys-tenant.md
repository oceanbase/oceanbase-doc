...
This view displays the KVcache information of all tenants on each OBServer node.
...
In the sys tenant, query the KVcache information of tenant 1002 on each OBServer node.
