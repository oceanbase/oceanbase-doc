...
<li>In OceanBase Database V4.x, you can query the <a href="600.gv-memstore-of-sys-tenant.md">GV$OB_MEMSTORE</a> or <a href="2000.gv-ob_memstore_info-of-sys-tenant.md">GV$OB_MEMSTORE_INFO</a> view for MemTables. </li></ul>
</main>

## Purpose

The `gv$tenant_memstore_allocator_info` view displays information about the MemTables on the connected OBServer nodes. You can use this view to troubleshoot the issue where the MemStore memory of a tenant no longer in use is not released. Each row contains the information about one MemTable.
