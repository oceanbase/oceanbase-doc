...
* To view the communication status between nodes in the cluster and the arbitration service, see [GV$OB_ARBITRATION_SERVICE_STATUS](6000.gv_ob_arbitration_service_status-of-sys-tenant.md).

* For information about arbitration service operations, see the following topics:
