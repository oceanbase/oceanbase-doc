...
Displays the unit information of the OBServer node where the tenant resides. The system tenant can view the unit information of all OBServer nodes in the cluster.
