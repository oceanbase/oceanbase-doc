...
The `GV$OB_UNITS` view displays the information about the units on the OBServer nodes where a tenant resides. You can view the units of all OBServer nodes in the current cluster from the `sys` tenant.
