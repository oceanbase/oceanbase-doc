...
| REPLICA_TYPE     | varchar(7)   | NO         | The type of the replica. The default value is `FULL`. <main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.5.x, this column is available starting with V4.5.0. </li><li>For V4.2.5, this column is available starting with V4.2.5 BP7. </li></ul></main>    |
