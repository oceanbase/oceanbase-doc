...
This view displays the basic information and real-time status of HNSW vector indexes across all tenants on all OBServer nodes.
...
Query the real-time status of HNSW vector indexes across all tenants on all OBServer nodes.
