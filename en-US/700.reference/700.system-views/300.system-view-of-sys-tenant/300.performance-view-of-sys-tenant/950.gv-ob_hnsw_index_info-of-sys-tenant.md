...
<<<<<<< HEAD
This view displays the basic information and real-time status of HNSW vector indexes in all tenants on all OBServer nodes.
=======
...
<<<<<<< HEAD
Query the real-time status of HNSW vector indexes in all tenants on all OBServer nodes as the sys tenant.
=======
...
=======
* For information about the baseline and incremental segments of HNSW vector indexes and the DML/query process, see [Vector index principles](../../../../100.oceanbase-database-concepts/400.database-objects/200.database-objects-of-mysql-mode/300.index-of-mysql-mode/330.vector-indexes-of-mysql-mode-in-concepts.md)
>>>>>>> V4.6.0
