...
The `GV$OB_RES_MGR_SYSSTAT` view displays the statistical items of resource groups on all OBServer nodes in all tenants.
...
Query the statistical items of resource groups on all OBServer nodes in all tenants.
