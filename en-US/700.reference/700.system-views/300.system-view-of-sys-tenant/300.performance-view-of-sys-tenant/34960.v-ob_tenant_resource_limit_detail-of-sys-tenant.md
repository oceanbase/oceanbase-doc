...
The `V$OB_TENANT_RESOURCE_LIMIT_DETAIL` view displays the resource limits and their upper limits for all tenants on the current OBServer.
...
Query the resource limits and their upper limits for all tenants on the current OBServer.
