...
<h4>Note</h4>
<ul>
<li>Due to the architectural optimization of the resource management feature in V4.x, this view is no longer applicable to V4.x. It has been removed starting from V4.0.0. </li>
