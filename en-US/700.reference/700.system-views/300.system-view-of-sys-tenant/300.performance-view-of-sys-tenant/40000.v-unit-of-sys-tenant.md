...
<li>In OceanBase Database V4.x, you can query the DBA_OB_UNITS or <a href="34500.v-ob_units-of-sys-tenant.md">V$OB_UNITS</a> view for the units of OBServer nodes. </li>
</ul>
</main>
...
Query the metadata of the units on the current OBServer node.
