...
The `GV$OB_SS_OBJECT_TYPE_IO_STAT` view displays the read, write, and delete usage of different types of objects on each node for a tenant.
...
Query the read, write, and delete usage of different types of objects on all nodes for tenant 1002 in the sys tenant.
