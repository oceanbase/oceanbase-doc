...
The `GV$OB_SS_OBJECT_TYPE_IO_STAT` view displays the statistics of read, write, and delete operations on different types of objects for a tenant across all nodes.
...
| MODE            | varchar(32)  | NO   | The type of data source:<ul><li>`local`: local</li><li>`remote`: object storage</li></ul>     |
...
Query the usage of read, write, and delete operations on different types of objects for tenant 1002 across all nodes.
