...
<li>In OceanBase Database V4.x, you can query the DBA_OB_UNITS or <a href="4000.gv-ob_units-of-sys-tenant.md">GV$OB_UNITS</a> view for the units of OBServer nodes in a cluster. </li>
</ul>
</ul>
</main>
...
Query the metadata of the units on all OBServer nodes in the current cluster.
