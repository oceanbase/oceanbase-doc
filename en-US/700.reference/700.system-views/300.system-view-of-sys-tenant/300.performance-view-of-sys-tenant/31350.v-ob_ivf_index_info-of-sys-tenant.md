...
This view displays the basic information and real-time status of IVF vector indexes for all tenants on the current OBServer node.
...
Query the real-time status of IVF vector indexes for all tenants on the current OBServer node as the sys tenant.
