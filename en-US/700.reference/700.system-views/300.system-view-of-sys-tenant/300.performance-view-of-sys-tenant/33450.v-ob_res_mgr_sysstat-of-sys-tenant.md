...
<main id="notice" type='explain'>
 <h4>Note</h4>
 <ul><li>This view was introduced in OceanBase Database V4.3.5. </li> <li>This view was introduced in OceanBase Database V4.2.5. </li></ul>
</main>

## Purpose

The `V$OB_RES_MGR_SYSSTAT` view displays the statistics of resource groups in all tenants on this OBServer node.
...
| CLASS      | bigint(20)  | NO   | Statistics class     |
...
The following example queries the statistics of resource groups in all tenants on this OBServer node.
