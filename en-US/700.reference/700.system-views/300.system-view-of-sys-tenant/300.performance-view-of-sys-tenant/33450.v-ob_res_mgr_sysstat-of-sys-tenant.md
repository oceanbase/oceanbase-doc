...
The `V$OB_RES_MGR_SYSSTAT` view displays statistics of resource groups on this OBServer node for all tenants.
...
| STATISTIC# | bigint(20)  | NO   | The sequence number of the statistic.     |
...
Query statistics of resource groups on this OBServer node for all tenants.
