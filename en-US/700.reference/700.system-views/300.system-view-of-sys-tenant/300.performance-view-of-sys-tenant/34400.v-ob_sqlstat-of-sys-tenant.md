...
The `V$OB_SQLSTAT` view displays basic performance statistics for SQL statements on the current node. Each SQL statement is represented as a row (i.e., each unique combination of `SQL_ID` and `Plan_Hash` is a row). Columns with `_DELTA` in their names indicate the incremental statistics from the last WR snapshot collection to the current time.
...
| PLAN_TYPE                     | bigint(20)          | NO   |    For SQL plan cache, this column indicates the type of the plan:<ul><li>`1`: Local Plan</li> <li>`2`: Remote Plan</li> <li>`3`: Distributed Plan</li></ul> </br>For PL object cache, this column indicates the type of the PL object:<ul><li>`1`: Procedure</li> <li>`2`: Function</li> <li>`3`: Package</li> <li>`4`: Anonymous Block</li></ul> |
...
| NESTED_SQL_TOTAL              | bigint(20)          | NO   |   The total number of nested SQL statements executed. Each execution of a sub-SQL statement increases the value by 1.     |
...
| ROUTE_MISS_TOTAL              | bigint(20)          | NO   |   The total number of times that no partition of the request was hit since the OBServer started.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.2. </li></ul></main>   |
| ROUTE_MISS_DELTA              | bigint(20)          | NO   |   The number of times that no partition of the request was hit since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field is available starting with V4.3.5. </li> <li>For V4.2.x, this field is available starting with V4.2.2. </li></ul></main>   |
...
| MUTI_QUERY_TOTAL              | bigint(20)        | NO   | The number of times that the SQL statement was located in a Multi Query since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>For V4.6.x, this field is available starting with V4.6.0. </p></main>|
| MUTI_QUERY_DELTA              | bigint(20)        | NO   | The number of times that the SQL statement was located in a Multi Query since the last WR snapshot was collected.<main id="notice" type='explain'><h4>Note</h4><p>For V4.6.x, this field is available starting with V4.6.0. </p></main>|
| MUTI_QUERY_BATCH_TOTAL        | bigint(20)        | NO   | The number of times that the SQL batch was executed since the execution plan was generated.<main id="notice" type='explain'><h4>Note</h4><p>For V4.6.x, this field is available starting with V4.6.0. </p></main>|
...
| FULL_TABLE_SCAN_TOTAL         | bigint(20)        | NO   | The number of full table scans executed since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 for V4.6.x. </p></main>|
| FULL_TABLE_SCAN_DELTA         | bigint(20)        | NO   | The number of full table scans executed since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 for V4.6.x. </p></main>|
| ERROR_COUNT_TOTAL             | bigint(20)        | NO   | The number of errors reported by the SQL since the execution plan was generated. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 for V4.6.x. </p></main>|
| ERROR_COUNT_DELTA             | bigint(20)        | NO   | The number of errors reported by the SQL since the last WR snapshot was collected. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 for V4.6.x. </p></main>|
