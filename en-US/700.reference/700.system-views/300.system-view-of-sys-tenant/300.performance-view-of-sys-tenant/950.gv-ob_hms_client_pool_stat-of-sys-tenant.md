...
|slug|gv-ob_hms_client_pool_stat-of-sys-tenant|
...
| TENANT_ID      | bigint(20)  | NO             | The ID of the tenant. Valid values:<ul><li>1: the ID of the sys tenant. </li><li>Other values: the ID of a user tenant or the ID of a Meta tenant.</li></ul>|
