...
|dir-name-en||
|tenant-type||
|slug|v-ob_ss_object_type_io_stat-sys-tenant|
...
The `V$OB_SS_OBJECT_TYPE_IO_STAT` view displays the statistics of read, write, and delete operations on different types of objects in a tenant on the current node.
...
| READ_FAIL_CNT   | bigint(20)   | NO   | The total number of I/O read failures.     |
...
| WRITE_FAIL_CNT  | bigint(20)   | NO   | The total number of I/O write failures.     |
...
| DELETE_FAIL_CNT | bigint(20)   | NO   | The total number of object deletion failures.    |
...
| READ_BANDWIDTH_DISPLAY  | varchar(29)  | NO   | The bandwidth in Human Readable format, for example, 10GB/s or 10MB/s<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 in V4.6.x. </p></main>     |
| READ_DELAY_US           | bigint(20)   | NO   | The average I/O read delay, in us<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 in V4.6.x. </p></main>     |
...
| WRITE_BANDWIDTH_DISPLAY | varchar(29)  | NO   | The bandwidth in Human Readable format, for example, 10GB/s or 10MB/s<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 in V4.6.x. </p></main>     |
| WRITE_DELAY_US          | bigint(20)   | NO   | The average I/O write delay, in us<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0 in V4.6.x. </p></main>     |

## Sample query

Query the statistics of read, write, and delete operations on different types of objects in tenant 1002 on the current node.
