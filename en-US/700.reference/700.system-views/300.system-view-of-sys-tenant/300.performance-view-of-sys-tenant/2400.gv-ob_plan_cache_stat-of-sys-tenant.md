...
This view displays the overall status of each plan cache on all OBServer nodes for all tenants.
...
In the sys tenant, query the overall status of plan caches on all nodes for all tenants.
