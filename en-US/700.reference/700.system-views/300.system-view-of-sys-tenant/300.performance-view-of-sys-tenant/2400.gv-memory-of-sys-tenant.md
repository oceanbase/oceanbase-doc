...
The `GV$OB_MEMORY` view displays the memory statistics for all tenants across all nodes.
...
* [FAQ](../../../200.system-management/700.memory-management/900.common-memory-problems.md)