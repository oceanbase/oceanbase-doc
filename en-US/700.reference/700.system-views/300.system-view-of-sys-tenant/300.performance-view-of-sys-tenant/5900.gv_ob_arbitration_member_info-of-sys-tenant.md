...
* Query the communication status between the current tenant and the arbitration service on each node: [GV$OB_ARBITRATION_SERVICE_STATUS](6000.gv_ob_arbitration_service_status-of-sys-tenant.md)
