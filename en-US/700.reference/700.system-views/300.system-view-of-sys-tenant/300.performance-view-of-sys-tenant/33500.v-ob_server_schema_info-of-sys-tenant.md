...
|dir-name-en||
|tenant-type||
|slug|v-ob_server_schema_info-sys-tenant|
...
This view displays the schema information of the current node.
...
Query the schema information of the current OBServer node in the sys tenant.
