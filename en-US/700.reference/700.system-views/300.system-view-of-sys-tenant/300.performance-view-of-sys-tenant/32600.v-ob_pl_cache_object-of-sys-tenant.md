...
| SYS_VARS          | varchar(4096)       | NO   |  The system variables affecting the plan generation for the current session. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>    |
| PARAM_INFOS       | longtext            | NO   |  The parameterized type information for anonymous blocks and call proc info, used to determine if a match is successful. <main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.2.5 BP2. </p></main>   |
