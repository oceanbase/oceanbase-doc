...
The `V$EVENT_NAME` view displays the definitions of all wait events.
...
In the system tenant, view the definitions of all wait events and display the first 10 records.
