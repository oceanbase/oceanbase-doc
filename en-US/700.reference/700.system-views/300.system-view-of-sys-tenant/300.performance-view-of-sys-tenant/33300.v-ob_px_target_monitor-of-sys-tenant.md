...
This view displays the PX thread usage of each tenant on the current OBServer node.
...
In the sys tenant, query the PX thread usage of all tenants on the current OBServer node.
