...
Displays the real-time status of statistical collection tasks for all tenants on all OBServer nodes.
...
In the sys tenant, view the real-time status of the statistics collection task for the tenant with ID 1006 across all nodes.
