...
|slug|v-ob_sstable-of-sys-tenant|
...
Query the MemTable and SSTable information of partition 1001 of the log stream in the user's tenant on the current OBServer node.
