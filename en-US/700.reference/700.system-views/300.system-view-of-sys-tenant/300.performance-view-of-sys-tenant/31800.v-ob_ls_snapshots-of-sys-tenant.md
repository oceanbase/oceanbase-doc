...
|slug|v-ob_ls_snapshots-of-sys-tenant|
...
| END_INTERVAL_SCN | bigint(20) | NO | The SCN at which the replay ended. |
| LS_META_PACKAGE | longtext | NO | The log stream metadata corresponding to the start replay point. |
