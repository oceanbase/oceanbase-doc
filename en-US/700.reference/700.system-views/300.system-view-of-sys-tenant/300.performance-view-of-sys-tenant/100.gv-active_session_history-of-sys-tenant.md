...
| WEIGHT                      | bigint(20)          | NO   | The number of occurrences of the same tenant and action within the time range corresponding to this WR record. <main id="notice" type='explain'><h4>Notice</h4><p>For V4.4.x, this field was introduced starting from V4.4.2. </p></main>     |
| IS_WR_WEIGHT_SAMPLE         | varchar(1)          | NO   | Indicates whether this column is an aggregated column for queue backlog waiting events. <main id="notice" type='explain'><h4>Notice</h4><p>For V4.4.x, this field was introduced starting from V4.4.2. </p></main>     |
