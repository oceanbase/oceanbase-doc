...
|slug|v-ob_storage_cache_tasks-of-sys-tenant|
...
| STATUS          | varchar(64)           | NO             |  The status of the cache task. Valid values: <ul><li>`WAITING`: The task is initializing. </li> <li>`DONIG`: The task is being executed. </li> <li>`FINISHED`: The task has been completed. </li> <li>`SUSPENDED`: The task is suspended. </li> <li>`CANCELED`: The task is canceled. </li> <li>`FAILED`: The task has failed. </li></ul>    |
