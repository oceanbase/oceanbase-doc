...
|tenant-type||
|machine-translation||
|slug|v-ob_storage_cache_tasks-sys-tenant|
...
This view displays the cache tasks of each tenant on the current OBServer node.
...
| SPEED           | varchar(29)           | NO                     | The data pull speed of the tablet.    |
...
In SS mode, the sys tenant queries the cache tasks of the tenant with ID `1002` on the current OBServer node.
