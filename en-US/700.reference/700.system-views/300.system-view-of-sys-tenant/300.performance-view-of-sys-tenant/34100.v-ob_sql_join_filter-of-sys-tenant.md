...
|slug|v-ob_sql_join_filter-of-sys-tenant|
...
This view displays the join filter execution information of each tenant on the current OBServer node.
...
The following example shows how to query the execution information about a join filter in the system tenant.
