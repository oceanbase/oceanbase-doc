...
| IS_BIND_AWARE         | bigint(20)          | NO         | Indicates whether the plan is opened in ACS mode.                                                                     |
| DB_ID                 | bigint(20) unsigned | NO         | The database ID.                                                                           |
| STATEMENT             | longtext            | NO         | For SQL plan caching, this column stores the parameterized SQL statement. For anonymous block caching, this column stores the parameterized anonymous block statement. This column is invalid for other object types.                     |
...
| SLOWEST_EXE_TIME      | timestamp(6)        | NO         | The timestamp of the longest execution.                                                                          |
| SLOWEST_EXE_USEC      | bigint(20)          | NO         | The longest execution time of a single execution.                                                                        |
...
| ELAPSED_TIME          | bigint(20) unsigned | NO         | The time consumed from receiving the request to the end of the execution, in microseconds.                                                                 |
...
| PS_STMT_ID            | bigint(20)          | NO         | The Prepare ID corresponding to the request:<ul><li>`-1`: indicates that the PS protocol is not used for the SQL statement.   </li><li>Non-`-1`: indicates that the PS protocol is used for the SQL statement, and this value is the unique identifier returned by the PS protocol for the statement.  </li></ul>      |
| SESSID                | bigint(20) unsigned | NO         | The session ID where the cached object is located.<br>For V4.3.x: <ul><li>For versions earlier than V4.3.5 BP2:<br>This field indicates the server session ID in all connection modes (direct mode and ODP mode). </li><li>For V4.3.5 BP2 and later: <ul><li>In direct mode:<br>This field indicates the server session ID. </li> <li>In ODP mode: </li><ul><li>If the <code>client_session_id_version = 2</code> parameter is set in ODP, this field indicates the client session ID. </li> <li>If <code>client_session_id_version = 1</code>, this field indicates the server session ID. </li></ul></ul></li></ul>                                                               |
