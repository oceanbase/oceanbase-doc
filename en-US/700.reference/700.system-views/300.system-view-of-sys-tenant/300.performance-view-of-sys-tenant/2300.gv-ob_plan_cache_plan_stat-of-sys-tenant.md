...
| SPECIAL_PARAMS        | varchar(4096)       | NO         | The values of non-parameterized parameters.                                                                      |
...
| EVO_CPU_TIME          | bigint(20) unsigned | NO         | The total execution CPU time during evolution, in microseconds.                                                                 |
...
| PL_SCHEMA_ID          | bigint(20) unsigned | NO         | For non-anonymous PL objects, this field is the Schema ID of the cache object. For anonymous blocks, this field is the same as ps_stmt_id. For SQL plans, this field is irrelevant.       |
