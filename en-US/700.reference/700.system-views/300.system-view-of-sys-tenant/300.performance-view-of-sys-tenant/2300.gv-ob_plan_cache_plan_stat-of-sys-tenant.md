...
| TYPE                  | bigint(20)          | NO         | The type of the cached object. For SQL plans, the value indicates the type of the plan:  <ul><li> 1: Local Plan  </li><li> 2: Remote Plan </li><li>3: Distribute Plan  </li></ul>For PL objects, the value indicates the type of the PL object:<ul><li> 1: Procedure    </li><li> 2: Function </li><li>3: Package  </li><li> 4: Anonymous Block   </li></ul> |
