...
This view displays the MemTable and SSTable information of each partition in all tenants on all OBServer nodes.
...
| START_LOG_SCN            | bigint(20) unsigned | NO         | The left boundary of the log timestamp range of the data in the table.      |
| END_LOG_SCN              | bigint(20) unsigned | NO         | The right boundary of the log timestamp range of the data in the table.     |
| SIZE                    | bigint(20)          | NO         | The disk space occupied, in bytes.      |
| REF                     | bigint(20)          | NO         | The reference count of the table. The unit is the number of references.   |
| UPPER_TRANS_VERSION     | bigint(20) unsigned         | NO         | The maximum transaction version number of the committed transactions.           |
| IS_ACTIVE               | varchar(3)          | NO         | Indicates whether the MemTable is active.   |
| CONTAIN_UNCOMMITTED_ROW | varchar(3)          | NO         | Indicates whether the table contains uncommitted transaction rows:<ul><li>`NO`: The table does not contain uncommitted transaction rows. </li><li> `YES`: The table contains uncommitted transaction rows. </li></ul>   |

## Sample query

In the sys tenant, query the MemTable and SSTable information of each partition in the log stream with ID 1001 of the tenant with ID 1002 on all OBServer nodes.
