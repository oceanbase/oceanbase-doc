...
|slug|gv-ob_sstable-of-sys-tenant|
...
In the sys tenant, query the MemTable and SSTable information of the 1001 log stream of the tenant with ID 1002 on all OBServer nodes.
