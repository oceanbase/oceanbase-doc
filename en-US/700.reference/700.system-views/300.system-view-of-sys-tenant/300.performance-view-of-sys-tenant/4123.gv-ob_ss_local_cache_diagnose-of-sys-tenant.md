...
| STATUS        | varchar(7)    | NO   | The running status of the corresponding submodule:<ul><li>NORMAL/1: Normal</li><li>WARN/2: Minor exception</li><li>ERROR/3: Critical exception</li></ul>     |
