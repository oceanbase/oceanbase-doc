...
| FILE_STATUS | varchar(64) | NO | The replica status of the backup log piece at the source. Valid values: <ul><li>AVAILABLE: the backup is valid and can be used for recovery.</li><li>COPYING: the log file is being backed up.</li><li>INCOMPLETE: the logs of the piece are incomplete. Some log streams are missing.</li><li>DELETING: the log file is being deleted.</li><li>EXPIRED: the backup file has expired.</li><li>BROKEN: the backup file is incomplete and cannot be used.</li><li>DELETED: the log file has been deleted. </li></ul> |
| PATH | varchar(2048) | NO | The archive path. |
| BACKUP_FILE_STATUS | varchar(64) | NO | The file status of the backup log piece at the backup destination (`BACKUP_ARCHIVE_DEST`). This status is consistent with the existing `FILE_STATUS` column and includes the following values: <ul><li>AVAILABLE: the backup is valid and can be used for recovery.</li><li>COPYING: the log file is being backed up.</li><li>INCOMPLETE: no archive backup has been performed; this is the initial state.</li><li>DELETING: the log file is being deleted.</li><li>EXPIRED: the backup file has expired.</li><li>BROKEN: the backup file is incomplete and cannot be used.</li><li>DELETED: the log file has been deleted.</li></ul> |
