...
| PRIV_DELETE | varchar(3) | NO | Indicates whether the user has the privilege to delete records of databases or tables. |
...
Query the database privileges of users in the sys tenant.
