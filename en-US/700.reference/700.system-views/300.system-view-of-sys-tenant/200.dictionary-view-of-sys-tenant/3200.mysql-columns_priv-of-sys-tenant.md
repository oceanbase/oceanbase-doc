...
<main id="notice" type='explain'>
 <h4>Note</h4>
 <ul><li>For OceanBase Database V4.3.x, this view was introduced in OceanBase Database V4.3.1. </li><li>For OceanBase Database V4.2.x, this view was introduced in OceanBase Database V4.2.3. </li></ul>
</main>
...
| User        | varchar(128) | NO   | The username of the user to whom the privilege is granted. |
| Table_name  | varchar(128) | NO   | The name of the table. |
| Column_name | varchar(128) | NO   | The name of the column. |
| Column_priv | varchar(31)  | NO   | The column privilege, such as `SELECT`, `INSERT`, or `UPDATE`.     |
| Timestamp   | datetime     | YES  | The timestamp when the privilege was last modified.     |
