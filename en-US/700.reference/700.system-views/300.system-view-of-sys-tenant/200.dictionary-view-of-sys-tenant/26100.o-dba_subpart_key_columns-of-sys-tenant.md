...
This view displays the columns contained in the subpartitioning keys of all partitioned objects in the current tenant.
...
Query the columns contained in the subpartitioning keys of the partitioned table `tbl2_f_rl` in the sys tenant.
...
To query the columns contained in the subpartitioning keys of all partitioned objects in all tenants, see [CDB_SUBPART_KEY_COLUMNS](12500.o-cdb_subpart_key_columns-of-sys-tenant.md).