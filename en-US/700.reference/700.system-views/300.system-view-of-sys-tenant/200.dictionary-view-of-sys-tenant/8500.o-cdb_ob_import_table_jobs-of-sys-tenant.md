...
|tenant-type||
|machine-translation||
|slug|oceanbase.cdb_ob_import_table_jobs-o-cdb_ob_import_table_jobs-of-sys-tenant|
...
| STATUS | varchar(64) | NO | The status of the task. Valid values: <ul><li> INIT: the task is initializing. </li><li>IMPORT_TABLE: importing tables. </li><li>RECONSTRUCT_REF_CONSTRAINT: reconstructing reference constraints.  </li><li>CANCELING: canceling. </li><li>IMPORT_FINISH: the import is finished.  </li></ul> |
