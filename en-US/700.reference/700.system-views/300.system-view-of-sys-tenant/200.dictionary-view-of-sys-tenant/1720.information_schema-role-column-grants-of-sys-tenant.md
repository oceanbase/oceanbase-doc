...
The `role_column_grants` view displays column privileges granted to the roles activated in the current session and to other roles granted to these roles.
...
| PRIVILEGE_TYPE | varchar(31)  | NO   | The privilege granted. This value can be any privilege granted at the column level of a table. Each row displays all privileges of a column.      |
...
6. View the column privileges granted to the activated roles in the current session.
