...
This view displays users and roles that have access to plain data of columns associated with a sensitive rule in all tenants.
...
Query users and roles that have access to plain data of columns associated with a sensitive rule in all tenants.
