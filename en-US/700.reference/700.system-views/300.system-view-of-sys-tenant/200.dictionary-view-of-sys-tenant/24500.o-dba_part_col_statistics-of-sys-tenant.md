...
* Query column statistics at the table level: [DBA_TAB_STATISTICS](26700.o-dba_tab_statistics-of-sys-tenant.md)

* Query column statistics at the global level: [DBA_TAB_COL_STATISTICS](26300.o-dba_tab_col_statistics-of-sys-tenant.md)

* Query column statistics at the subpartition level: [DBA_SUBPART_COL_STATISTICS](25900.o-dba_subpart_col_statistics-of-sys-tenant.md)

* Query histogram statistics at the table level: [DBA_TAB_HISTOGRAMS](26400.o-dba_tab_histograms-of-sys-tenant.md)

* Query histogram statistics at the partition level: [DBA_PART_HISTOGRAMS](24600.o-dba_part_histograms-of-sys-tenant.md)

* Query histogram statistics at the subpartition level: [DBA_SUBPART_HISTOGRAMS](26000.o-dba_subpart_histograms-of-sys-tenant.md)
