...
| QUERY_SQL | longtext    | NO   |  The SQL statement.      |
| SQL_TYPE  | bigint(20)  | NO   |  The type of the statement.      |

The following table describes the values of the `SQL_TYPE` column in the view and the corresponding statement types.
