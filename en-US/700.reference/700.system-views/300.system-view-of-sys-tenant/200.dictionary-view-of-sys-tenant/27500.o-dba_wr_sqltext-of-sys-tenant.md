...
The `DBA_WR_SQLTEXT` view displays the SQL text collected by the WR module of the current tenant.
...
The values of the `SQL_TYPE` column in the view and their corresponding statement types are described in the table below.
