...
This view displays records of table-level cross-tenant import tasks.
...
| RESULT | varchar(64) | YES | The result of the task. Valid values: <ul><li>`SUCCESS`: The import task is completed successfully. </li><li>`FAIL`: The import task fails. </li></ul> |
| COMMENT | longtext | YES | The remarks. |

## Sample query

During table restore, view the information about table-level cross-tenant import tasks in the sys tenant.
