...
Displays the column statistics and histogram information for all tables in the tenant.
...
In the sys tenant, query the column statistics and histogram information of the table `t_subpart` in the current tenant.
