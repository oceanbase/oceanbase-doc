...
| EXTERNAL_KMS_INFO | varchar(4096) | YES | If the source tenant has set up key management, configure this parameter in the session. |
...
After a table-level restore task is completed, the sys tenant queries the history of the table-level restore task.
...
For more information about how to view the results of a table-level restore task, see [View the results of a table-level restore task](../../../../600.manage/600.backup-and-recovery/700.recover-table/500.view-the-table-recovery-history.md).