...
| AVAILABLE                 | varchar(5)    | NO   | Whether the log stream is completely available: <ul><li>`TRUE`: Yes. The log stream is completely available only when all tablets in the log stream are available.</li> <li>`FALSE`: No</li></ul>  |
