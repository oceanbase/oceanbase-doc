...
|tenant-type||
|machine-translation||
|slug|oceanbase.dba_ob_ls_arb_replica_tasks-oceanbase-dba_ob_ls_arb_replica_tasks-of-sys-tenant|

# oceanbase.DBA_OB_LS_ARB_REPLICA_TASKS

## Purpose

The `oceanbase.DBA_OB_LS_ARB_REPLICA_TASKS` view provides information about the current tenant and the ongoing arbitration tasks in the current tenant.
