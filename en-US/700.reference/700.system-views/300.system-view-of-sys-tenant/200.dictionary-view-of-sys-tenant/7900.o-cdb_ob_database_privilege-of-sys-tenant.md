...
Displays the database privileges owned by users of each tenant.
...
The system tenant queries the database privileges of users belonging to the tenant with ID 1002.
