...
|tenant-type||
|machine-translation||
|slug|oceanbase.cdb_tab_subpartitions|
...
| INDEXING              | varchar(3)      | NO         | At present, the value of this column is `NULL` by default. |
| READ_ONLY             | varchar(3)      | NO         | At present, the value of this column is `NULL` by default. |
...
| MEMOPTIMIZE_WRITE     | varchar(8)      | NO         | At present, the value of this column is `NULL` by default. |