...
This view displays the arbitration service tasks that are running for the current tenant.
...
Query the arbitration service tasks that are running for the current tenant.
