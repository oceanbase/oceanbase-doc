...
|slug|information_schema-referential_constraints-of-sys-tenant|
...
| UPDATE_RULE               | varchar(64)                             | NO             | The value of the constraint ON UPDATE attribute. Possible values: CASCADE, SET NULL, RESTRICT, NO ACTION  |
| DELETE_RULE               | varchar(64)                             | NO             | The value of the constraint ON DELETE attribute. Possible values: CASCADE, SET NULL, RESTRICT, NO ACTION |
| TABLE_NAME                | varchar(256)                            | NO             | The name of the child table to which the constraint belongs.                                                    |
| REFERENCED_TABLE_NAME     | varchar(256)                            | NO             | The name of the parent table referenced by the constraint.                                                   |

## Sample query

Query the metadata information of foreign key constraints in the `tbl4` table.
