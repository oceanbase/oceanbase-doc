...
This view displays the information of all tablet replicas in the current tenant. Each tablet replica is uniquely identified by the joint key: `<TABLET_ID, SVR_IP, SVR_PORT, LS_ID>`.
...
| REQUIRED_SIZE | bigint(20)  | NO         | The size of the space allocated for the data, in bytes. The minimum unit of data storage is a macroblock (2 MB). Therefore, `REQUIRED_SIZE >= DATA_SIZE` |
