...
| INDEX_LENGTH    | bigint(0) unsigned  | NO | The index length, which is the storage space occupied by non-primary key indexes, calculated in macroblock size. Unit: Byte.<main id="notice" type='explain'><h4>Note</h4><p>This column is no longer displayed as `NULL` starting from V4.2.4. </p></main> |
...
For more information about tables, see [View a table](../../../../700.reference/300.database-object-management/100.manage-object-of-mysql-mode/200.manage-tables-of-mysql-mode/500.view-the-definition-of-a-table-of-mysql-mode.md).