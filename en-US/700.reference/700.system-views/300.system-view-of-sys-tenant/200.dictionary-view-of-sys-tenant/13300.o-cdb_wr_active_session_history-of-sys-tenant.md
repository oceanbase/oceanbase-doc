...
| SESSION_STATE | varchar(7) | NO | The status of the session when being sampled. Valid values:<ul><li>`EVENT_NO == 0`: `ON CPU` indicates that the SQL logic is being executed without waiting.</li><li>`EVENT_NO ≠ 0`: `WAITTING` indicates that the session is waiting. The wait details are provided in the `EVENT` column.</li></ul> |
...
| TM_DELTA_TIME | bigint(20) | YES | The interval for calculating the time model, in μs.<main id="notice" type='explain'><h4>Note</h4><p>This column is available in OceanBase Database V4.2.2 and later. </p></main> |
| TM_DELTA_CPU_TIME | bigint(20) | YES | The amount of CPU time consumed during the previous interval specified by `TM_DELTA_TIME`.<main id="notice" type='explain'><h4>Note</h4><p>This column is available in OceanBase Database V4.2.2 and later. </p></main> |
| TM_DELTA_DB_TIME | bigint(20) | YES | The amount of time spent on database calls during the previous interval specified by `TM_DELTA_TIME`.<main id="notice" type='explain'><h4>Note</h4><p>This column is available in OceanBase Database V4.2.2 and later. </p></main> |
| TOP_LEVEL_SQL_ID | varchar(32) | YES | The top-level SQL ID.<main id="notice" type='explain'><h4>Note</h4><p>This column is available in OceanBase Database V4.2.2 and later. </p></main> |
| IN_PLSQL_COMPILATION | varchar(1) | NO | Indicates whether PL compilation is in progress. Valid values are `Y` and `N`.<main id="notice" type='explain'><h4>Note</h4><p>This column is available in OceanBase Database V4.2.2 and later. </p></main> |
| IN_PLSQL_EXECUTION | varchar(1) | NO | Indicates whether PL execution is in progress. Valid values are `Y` and `N`.<main id="notice" type='explain'><h4>Note</h4><p>This column is available in OceanBase Database V4.2.2 and later. </p></main> |
| PLSQL_ENTRY_OBJECT_ID | bigint(20) | YES | The ID of the top-level PL object.<main id="notice" type='explain'><h4>Note</h4><p>This column is available in OceanBase Database V4.2.2 and later. </p></main> |
| PLSQL_ENTRY_SUBPROGRAM_ID | bigint(20) | YES | The ID of the top-level PL subprogram.<main id="notice" type='explain'><h4>Note</h4><p>This column is available in OceanBase Database V4.2.2 and later. </p></main> |
| PLSQL_ENTRY_SUBPROGRAM_NAME | varchar(32) | YES | The name of the top-level PL subprogram.<main id="notice" type='explain'><h4>Note</h4><p>This column is available in OceanBase Database V4.2.2 and later. </p></main> |
| PLSQL_OBJECT_ID | bigint(20) | YES | The ID of the PL object being executed.<main id="notice" type='explain'><h4>Note</h4><p>This column is available in OceanBase Database V4.2.2 and later. </p></main> |
| PLSQL_SUBPROGRAM_ID | bigint(20) | YES | The ID of the PL subprogram being executed.<main id="notice" type='explain'><h4>Note</h4><p>This column is available in OceanBase Database V4.2.2 and later. </p></main> |
| PLSQL_SUBPROGRAM_NAME | varchar(32) | YES | The name of the PL subprogram being executed.<main id="notice" type='explain'><h4>Note</h4><p>This column is available in OceanBase Database V4.2.2 and later. </p></main> |
