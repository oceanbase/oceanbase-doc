...
| IMPORT_ALL | tinyint(4) | NO | Indicates whether to import all tables in the tenant. This value is 1 only when the `RECOVER TABLE *.*` option is specified. Otherwise, this value is 0. |
