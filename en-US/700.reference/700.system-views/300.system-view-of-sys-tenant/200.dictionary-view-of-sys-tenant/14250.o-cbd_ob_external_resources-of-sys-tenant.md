...
| TYPE        | varchar   | NO   |   The type of the resource. This field is used to distinguish between resources such as Java jar files and Python source code. The value of this field can be either 'JAVA_JAR' or 'PYTHON_PY'.  |
