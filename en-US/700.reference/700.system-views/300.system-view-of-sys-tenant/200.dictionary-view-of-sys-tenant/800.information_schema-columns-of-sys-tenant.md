...
This view records column information.
...
| GENERATION_EXPRESSION    | varchar(262144)     | NO             | For generated columns, the expression used to calculate the column value is displayed. For non-generated columns, this column is empty. |
| SRS_ID                   | bigint(20) unsigned | YES            | The ID of the spatial coordinate system.     |

## Sample query

Query the information of each column in the `tbl1` table.
