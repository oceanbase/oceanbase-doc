...
Query the column privilege information for users.
...
* Query the column privileges granted to users: [mysql.columns_priv](2990.mysql-columns_priv-of-sys-tenant.md)
