...
| OLD_PASSWORD                | varchar(128)    | NO       | The hash value (ciphertext) of the old password. This field is valid when the dual password feature is enabled or during password rotation. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.4.2 BP1. </p></main>            |
