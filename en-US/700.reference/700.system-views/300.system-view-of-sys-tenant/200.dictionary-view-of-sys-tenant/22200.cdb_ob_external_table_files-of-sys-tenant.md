...
|tenant-type||
|machine-translation||
|slug|oceanbase-cdb_ob_external_table_files-sys-tenant-tmp|

# oceanbase.CDB_OB_EXTERNAL_TABLE_FILES

## Purpose

The `oceanbase.CDB_OB_EXTERNAL_TABLE_FILES` view displays the file lists of external tables created in all tenants.
