...
Displays the status of a physical restore task when it is completed. It is a snapshot of the corresponding record in the `oceanbase.CDB_OB_RESTORE_PROGRESS` table when the restore task is completed.
