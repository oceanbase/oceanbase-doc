...
| CONSTRAINT_NAME               | varchar(7)   | NO         | The constraint name, which can be PRIMARY, a column name, or a foreign key name.                                                                   |
...
| POSITION_IN_UNIQUE_CONSTRAINT | null         | NO         | For unique and primary key constraints, the order of the column in the constraint definition; for foreign key constraints, the order of the key in the referenced table. |
