...
|tenant-type||
|machine-translation||
|slug|oceanbase.cdb_ind_subpartitions-oceanbase-cdb_ind_subpartitions-of-sys-tenant|

# oceanbase.CDB_IND_SUBPARTITIONS

## Purpose

The `oceanbase.CDB_IND_SUBPARTITIONS` view provides information about all index subpartitions in the database.
