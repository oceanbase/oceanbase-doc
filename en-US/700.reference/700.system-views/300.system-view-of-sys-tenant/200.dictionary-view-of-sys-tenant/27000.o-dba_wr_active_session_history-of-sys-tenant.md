...
| TX_ID                       | bigint(20)          | YES  | The ID of the current transaction<main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.3.x, this field was introduced in V4.3.5. </li> <li>For V4.2.x, this field was introduced in V4.2.3. </li></ul></main>     |
| WEIGHT                      | double              | YES  | The number of times the same action of the same tenant occurs in the corresponding time period of the WR record.<main id="notice" type='explain'><h4>Note</h4><p>For V4.4.x, this field was introduced in V4.4.2. </p></main>     |
...
Query the ASH data of all tenants after persistence: [oceanbase.CDB_WR_ACTIVE_SESSION_HISTORY](13300.o-cdb_wr_active_session_history-of-sys-tenant.md)