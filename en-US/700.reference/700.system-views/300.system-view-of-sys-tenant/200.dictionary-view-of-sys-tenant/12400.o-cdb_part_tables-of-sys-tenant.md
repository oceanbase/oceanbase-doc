...
| DEF_INMEMORY_COMPRESSION  | varchar(17)   | NO         | The default compression level for in-memory column store. Valid values: <ul><li>NO MEMCOMPRESS</li> <li>FOR DML</li> <li>FOR QUERY \[ LOW \| HIGH \]</li> <li>FOR CAPACITY \[ LOW \| HIGH \]</li><li>AUTO</li> <li>NULL </li></ul> |
...
| DEF_CELLMEMORY            | varchar(24)   | NO         | Indicates that new partitions in the parent table will inherit the default value of the `CELLMEMORY` attribute unless it is explicitly overridden. |
