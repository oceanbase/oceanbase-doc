...
The `oceanbase.CDB_OB_LS_REPLICA_TASKS` view displays information about replica-level disaster recovery tasks that are running. You can query this view only from the sys tenant.
