...
|tenant-type||
|machine-translation||
|slug|oceanbase-dba_ob_backup_storage_info_history-sys-tenant-tmp|

# oceanbase.DBA_OB_BACKUP_STORAGE_INFO_HISTORY

## Purpose

The `oceanbase.DBA_OB_BACKUP_STORAGE_INFO_HISTORY` view displays the history of backup destinations of backup and restore in a tenant.
