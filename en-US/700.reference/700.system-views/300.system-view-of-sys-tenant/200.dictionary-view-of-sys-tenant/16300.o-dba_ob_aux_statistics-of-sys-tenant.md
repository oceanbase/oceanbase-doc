...
|---------------------------|--------------|----------------------|-----------|
| LAST_ANALYZED             | timestamp(6) | NO   | The timestamp of the last time statistics were collected.     |
| CPU_SPEED(MHZ)            | bigint(20)   | YES  | The current CPU frequency in MHz.     |
...
| NETWORK_SPEED(MB/S)       | bigint(20)   | YES  | The network transmission rate in MB/s.     |
