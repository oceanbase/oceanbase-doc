...
|tenant-type||
|machine-translation||
|slug|oceanbase.dba_ob_import_table_tasks-dba_ob_import_table_tasks-of-sys-tenant|
...
The `oceanbase.DBA_OB_IMPORT_TABLE_TASKS` view displays records of table-level import tasks.
