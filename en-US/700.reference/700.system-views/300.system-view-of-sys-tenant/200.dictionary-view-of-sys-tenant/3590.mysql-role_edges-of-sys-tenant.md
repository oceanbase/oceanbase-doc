...
5. Query the grant relationship between the `role1` role and the `user001` user.
...
* For information about the default roles enabled for a user, see [mysql.default_roles](3090.mysql-default_roles-of-sys-tenant.md).
