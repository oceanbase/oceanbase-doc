...
| REPLACEMENT | longtext | NO | The template that specifies how to rewrite the statement that matches the pattern. |
| NORMALIZED_PATTERN | longtext | NO | The parameterized pattern. |
| STATUS | varchar(10) | NO |<ul><li> ENABLE indicates that the rule is effective. </li><li> DISABLE indicates that the rule is not effective. </li></ul>|
| VERSION | bigint(20) | NO | The version number of the rule. |
| PATTERN_DIGEST | bigint(20) unsigned | NO | The hash value of the normalized pattern. |
