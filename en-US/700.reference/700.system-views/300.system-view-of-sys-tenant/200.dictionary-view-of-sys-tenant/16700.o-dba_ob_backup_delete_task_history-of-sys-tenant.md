...
| STATUS | varchar(64) | NO | The task status. Valid values: <ul><li>`COMPLETED`: the task is executed successfully. </li><li>`FAILED`: the task fails. </li><li>`CANCELED`: the task is canceled successfully. </li></ul> |
