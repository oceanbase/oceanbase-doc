...
| INTERVAL                | varchar(3)      | NO         | This column is not supported. It is set to NULL by default. |
| SEGMENT_CREATED         | varchar(3)      | NO         | This column is not supported. It is set to NULL by default. |
| DOMIDX_OPSTATUS         | varchar(6)      | NO         | This column is not supported. It is set to NULL by default. |
| PARAMETERS              | text            | NO         | This column is not supported. It is set to NULL by default. |

## Sample query

In the sys tenant, query the subpartitions (subpartition) information of the index table `tbl2_f_rl` of the tenant with the tenant ID 1002.
