...
| IMPORT_ALL | tinyint(4) | NO | Whether to import all tables under the entire tenant. Only when the user specifies`RECOVER TABLE *.*`When it is, the value is 1; in other scenarios, the value is 0. |
