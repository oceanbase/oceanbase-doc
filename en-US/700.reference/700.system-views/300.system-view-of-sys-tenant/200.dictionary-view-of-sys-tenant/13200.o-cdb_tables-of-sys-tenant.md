...
| INMEMORY_SERVICE          | varchar(12)   | NO         | The current value is `NULL`. |
| INMEMORY_SERVICE_NAME     | varchar(1000) | NO         | The current value is `NULL`. |
| CONTAINER_MAP_OBJECT      | varchar(3)    | NO         | The current value is `NULL`. |
| MEMOPTIMIZE_READ          | varchar(8)    | NO         | The current value is `NULL`. |
| MEMOPTIMIZE_WRITE | varchar(8) | NO | For internal use only. |
| HAS_SENSITIVE_COLUMN      | varchar(3)    | NO         | The current value is `NULL`. |
| ADMIT_NULL                | varchar(3)    | NO         | The current value is `NULL`. |
| DATA_LINK_DML_ENABLED     | varchar(3)    | NO         | The current value is `NULL`. |
| LOGICAL_REPLICATION       | varchar(8)    | NO         | The current value is `NULL`. |
