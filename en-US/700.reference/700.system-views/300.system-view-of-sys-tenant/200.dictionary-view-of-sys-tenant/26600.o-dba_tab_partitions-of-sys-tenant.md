...
| INTERVAL               | varchar(3)      | NO         | This column is not supported. The value of this column is `NO` by default. |
| SEGMENT_CREATED        | varchar(4)      | NO         | This column is not supported. The value of this column is NULL by default. |
| INDEXING              | varchar(4)      | NO          | This column is not supported. The value of this column is NULL by default.                       |
| READ_ONLY             | varchar(4)      | NO          | This column is not supported. The value of this column is NULL by default.                        |
| INMEMORY              | varchar(8)      | NO          | This column is not supported. The value of this column is NULL by default.                   |
| INMEMORY_PRIORITY     | varchar(8)      | NO          | This column is not supported. The value of this column is NULL by default.                     |
| INMEMORY_DISTRIBUTE   | varchar(15)     | NO          | This column is not supported. The value of this column is NULL by default.                        |
| INMEMORY_COMPRESSION  | varchar(17)     | NO          | This column is not supported. The value of this column is NULL by default.        |
| INMEMORY_DUPLICATE    | varchar(13)     | NO          | This column is not supported. The value of this column is NULL by default.         |
| CELLMEMORY            | varchar(24)     | NO          | This column is not supported. The value of this column is NULL by default.                         |
| INMEMORY_SERVICE      | varchar(12)     | NO          | This column is not supported. The value of this column is NULL by default.                        |
| INMEMORY_SERVICE_NAME | varchar(100)   | NO           | This column is not supported. The value of this column is NULL by default.    |
| MEMOPTIMIZE_READ      | varchar(8)      | NO          | This column is not supported. The value of this column is NULL by default.              |
| MEMOPTIMIZE_WRITE     | varchar(8)      | NO          | This column is not supported. The value of this column is NULL by default.            |

## Sample query

In the sys tenant, query the primary partitions of the `t_m_rclc` partitioned table in the current tenant.
...
* Query the primary partitions of all partitioned tables in all tenants: [CDB_TAB_PARTITIONS](13000.o-cdb_tab_partitions-of-sys-tenant.md)

* Query the subpartitions of the partitioned tables in the current tenant: [DBA_TAB_SUBPARTITIONS](26900.o-dba_tab_subpartitions-of-sys-tenant.md)