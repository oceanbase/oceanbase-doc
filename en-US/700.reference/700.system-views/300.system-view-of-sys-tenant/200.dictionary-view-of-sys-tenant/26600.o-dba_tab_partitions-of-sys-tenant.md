...
| STORAGE_CACHE_POLICY  | varchar(256)    | NO          | Indicates the data caching strategy.<main id="notice" type='explain'><h4>Note</h4><p>This column is available starting with V4.6.0. </p></main>|

## Sample query

In the sys tenant, query the primary partitions of the partitioned table `t_m_rclc` in the current tenant.
...
* Query the primary partitions of all partitioned tables: [CDB_TAB_PARTITIONS](13000.o-cdb_tab_partitions-of-sys-tenant.md)

* Query the secondary partitions of all partitioned tables in the current tenant: [DBA_TAB_SUBPARTITIONS](26900.o-dba_tab_subpartitions-of-sys-tenant.md)