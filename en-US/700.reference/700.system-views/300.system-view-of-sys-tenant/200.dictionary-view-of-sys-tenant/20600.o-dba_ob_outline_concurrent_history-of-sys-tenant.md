...
This view displays the outline history of the current tenant.
...
| OUTLINE_PARAMS | varbinary(65536) | YES | The throttling rules parameters specified when the outline was created. |
...
Query the outline history of the current tenant.
