...
This view displays the history of table-level cross-tenant import tasks in the current tenant.
...
| TABLE_COLUMN | bigint(20) | NO | The number of table columns. |
...
| RESULT | varchar(64) | YES | The result of the task completion. Valid values: <ul><li>`SUCCESS`: The import task is completed successfully.</li><li>`FAIL`: The import task fails to be completed.</li></ul>|
