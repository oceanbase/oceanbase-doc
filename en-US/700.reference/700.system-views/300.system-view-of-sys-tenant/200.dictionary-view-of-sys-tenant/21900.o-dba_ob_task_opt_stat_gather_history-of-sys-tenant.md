...
* View the collection status of table-level historical statistics: [DBA_OB_TABLE_OPT_STAT_GATHER_HISTORY](../200.dictionary-view-of-sys-tenant/21100.o-dba_ob_table_opt_stat_gather_history-of-sys-tenant.md)
