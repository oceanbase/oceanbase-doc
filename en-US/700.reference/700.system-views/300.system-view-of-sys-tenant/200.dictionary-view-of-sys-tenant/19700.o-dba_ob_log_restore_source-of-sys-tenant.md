...
| RECOVERY_DELAY      | bigint(20) | NO | The synchronization delay of the tenant, in microseconds. The default value is 0, which indicates no delay. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.4.2 BP2. </p></main> |