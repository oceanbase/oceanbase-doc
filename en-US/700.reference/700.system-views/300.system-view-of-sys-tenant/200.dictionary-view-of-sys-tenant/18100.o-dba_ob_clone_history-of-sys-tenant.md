...
The `DBA_OB_CLONE_HISTORY` view displays the information of completed clone tasks.
...
| RESTORE_SCN | bigint(20) unsigned | NO | The target SCN of the clone tenant. |
...
Query the information of completed clone tasks.
