...
This view is accessible only to the sys tenant. The `DBA_OB_CLUSTER_EVENT_HISTORY` view displays important events at the cluster level. Currently, it only supports displaying events related to cluster upgrades.
