...
This view displays the primary/secondary partition information of all indexes in the current tenant.
...
| LOGGING                 | varchar(7)      | NO         | This column is not supported. It is set to NULL by default.               |
...
| FLASH_CACHE             | varchar(7)      | NO         | This column is unavailable at present. Its default value is NULL.         |
| CELL_FLASH_CACHE        | varchar(7)      | NO         | This column is not supported. The column will be set to NULL by default.   |
| USER_STATS              | varchar(3)      | NO         | The column is not supported yet, and the default value is NULL. |
| PCT_DIRECT_ACCESS       | bigint(0)       | NO         | This column is available starting with xxx. The column is NULL by default.       |
| COLUMN                  | VARCHAR         | NO         | This column is not supported. The default value of this column is NULL.  |
| DOMIDX_OPSTATUS         | varchar(6)      | NO         | Currently, this column is not supported and will be NULL by default. |
| PARAMETERS              | text            | NO         | This column is not supported. The value is null.         |
| INTERVAL                | varchar(3)      | NO         | The value is always `NO` for this column.          |
| SEGMENT_CREATED         | varchar(3)      | NO         | This field is not supported at the moment. The default value is NULL.     |
| ORPHANED_ENTRIES | varchar(3) | NO | This field is temporarily not supported, and its default value is NULL. |

## Sample query

In the sys tenant, query the primary partitions of the index in the `tbl2_f_rl` table of the current tenant.
