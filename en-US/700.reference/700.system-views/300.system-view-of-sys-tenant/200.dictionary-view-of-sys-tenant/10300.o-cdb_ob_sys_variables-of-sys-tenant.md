...
The `oceanbase.CDB_OB_SYS_VARIABLES` view displays the information about system variables of all tenants in the `sys` tenant, including hidden variables that start with an underscore.
...
| MODIFY_TIME | timestamp(6)   | NO | The time when the system variable was last modified. |
...
| DEFAULT_VALUE | varchar(65536) | YES | The default value of the system variable.<main id="notice" type='explain'><h4>Note</h4><ul><li>For OceanBase Database V4.2.x, this column was introduced in OceanBase Database V4.2.2. </li> <li>For OceanBase Database V4.3.x, this column was introduced in OceanBase Database V4.3.1. </li></ul> </main> |
| ISDEFAULT   | varchar(3)       | NO  | Indicates whether the current value is the default value.<main id="notice" type='explain'><h4>Note</h4><ul><li>For OceanBase Database V4.2.x, this column was introduced in OceanBase Database V4.2.2. </li> <li>For OceanBase Database V4.3.x, this column was introduced in OceanBase Database V4.3.1. </li></ul> </main> |
