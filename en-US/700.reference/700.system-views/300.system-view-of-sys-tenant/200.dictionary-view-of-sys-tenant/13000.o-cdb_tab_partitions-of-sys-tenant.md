...
| COMPOSITE              | varchar(3)      | NO         | Indicates whether the partitioning is composite.                 |
...
| PARENT_TABLE_PARTITION | varchar(128)    | NO         | This column is not supported and is set to NULL by default. |
| INTERVAL               | varchar(3)      | NO         | This column is not supported and is set to `NO` by default. |
| SEGMENT_CREATED        | varchar(4)      | NO         | This column is not supported and is set to NULL by default. |
| INDEXING              | varchar(4)      | NO          | This column is not supported and is set to NULL by default.                       |
| READ_ONLY             | varchar(4)      | NO          | This column is not supported and is set to NULL by default.                        |
| INMEMORY              | varchar(8)      | NO          | This column is not supported and is set to NULL by default.                   |
| INMEMORY_PRIORITY     | varchar(8)      | NO          | This column is not supported and is set to NULL by default.                     |
| INMEMORY_DISTRIBUTE   | varchar(15)     | NO          | This column is not supported and is set to NULL by default.                        |
| INMEMORY_COMPRESSION  | varchar(17)     | NO          | This column is not supported and is set to NULL by default.        |
| INMEMORY_DUPLICATE    | varchar(13)     | NO          | This column is not supported and is set to NULL by default.         |
| CELLMEMORY            | varchar(24)     | NO          | This column is not supported and is set to NULL by default.                         |
| INMEMORY_SERVICE      | varchar(12)     | NO          | This column is not supported and is set to NULL by default.                        |
| INMEMORY_SERVICE_NAME | varchar(100)   | NO           | This column is not supported and is set to NULL by default.    |
| MEMOPTIMIZE_READ      | varchar(8)      | NO          | This column is not supported and is set to NULL by default.              |
| MEMOPTIMIZE_WRITE     | varchar(8)      | NO          | This column is not supported and is set to NULL by default.            |
...
In the sys tenant, query the primary partitions of the tenant with the tenant ID 1002 in the partitioned table `tbl2_f_rl`.
...
* Query the primary partitions of the partitioned tables in the current tenant: [DBA_TAB_PARTITIONS](26600.o-dba_tab_partitions-of-sys-tenant.md)

* Query the subpartitions of the partitioned tables in all tenants: [CDB_TAB_SUBPARTITIONS](13100.o-cdb_tab_subpartitions-of-sys-tenant.md)