...
| ACTION_ORDER | bigint(20) | NO | In instances with the same`EVENT_MANIPULATION`and`ACTION_TIMING`The order and position of trigger operations in the list of triggers on the same table. |
