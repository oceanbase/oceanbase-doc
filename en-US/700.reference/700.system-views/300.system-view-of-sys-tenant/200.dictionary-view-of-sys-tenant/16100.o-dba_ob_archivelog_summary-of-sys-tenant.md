...
| UNIT_SIZE   | bigint(20)   | NO   | The size of the log block into which the archived log data is compressed or encrypted. At present, OceanBase Database does not support this column. |
