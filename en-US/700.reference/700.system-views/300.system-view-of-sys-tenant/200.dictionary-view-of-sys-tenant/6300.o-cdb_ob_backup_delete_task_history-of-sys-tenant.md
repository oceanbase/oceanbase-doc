...
|tenant-type||
|machine-translation||
|slug|oceanbase.cdb_ob_backup_delete_task_history-o-cdb_ob_backup_delete_task_history-of-sys-tenant|
...
This view displays the historical information of completed `backup_set`/`backup_piece` cleanup tasks under a tenant.
...
Query the historical information of completed `backup_set` or `backup_piece` cleanup tasks under all tenants in the sys tenant.
