...
|tenant-type||
|machine-translation||
|slug|oceanbase.dba_ob_import_table_jobs|
...
| STATUS | varchar(64) | NO | The task status. Valid values: <ul><li>INIT: the task is initializing. </li><li>IMPORT_TABLE: importing tables. </li><li>RECONSTRUCT_REF_CONSTRAINT: reconstructing reference constraints.  </li><li>CANCELING: canceling. </li><li>IMPORT_FINISH: importing tables is completed.  </li></ul> |
