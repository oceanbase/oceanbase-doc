...
The `DBA_OB_ROOTSERVICE_EVENT_HISTORY` view displays the event history of the Root Service.

By default, this view retains data for 7 days. To adjust the data retention period, you can configure the [ob_event_history_recycle_interval](../../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/300.cluster-level-configuration-items/16200.ob_event_history_recycle_interval.md) parameter.
...
Query the event history of the Root Service in the cluster as the sys tenant.
