...
This view displays the arbitration service tasks that are running in the current tenant.
...
Query the arbitration service tasks that are running in the current tenant.
