...
|tenant-type||
|machine-translation||
|slug|oceanbase-cdb_ob_backup_storage_info-sys-tenant-tmp|

# oceanbase.CDB_OB_BACKUP_STORAGE_INFO

## Purpose

The `oceanbase.CDB_OB_BACKUP_STORAGE_INFO` view provides information about backup destinations of backup and restore in the current tenant.
