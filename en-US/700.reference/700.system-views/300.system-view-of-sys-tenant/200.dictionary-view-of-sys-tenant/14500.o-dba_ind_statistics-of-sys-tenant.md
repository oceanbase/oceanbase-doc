...
This view displays the optimizer statistics of all indexes in the database.
...
| USER_STATS              | varchar(3) | NO | Indicates whether statistics are directly entered by users:<li>YES<li>NO |
