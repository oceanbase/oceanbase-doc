...
|slug|o-dba_ind_statistics-of-sys-tenant|
...
| OBJECT_TYPE           | varchar(12) | NO | The object type. Valid values: <ul><li>INDEX</li><li>PARTITION</li><li>SUBPARTITION </li></ul> |
...
| STALE_STATS             | varchar(3) | NO | Indicates whether the object statistics are outdated. |
