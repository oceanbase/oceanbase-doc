...
Query the optimizer statistics of the `tbl2_f_rl_idx1` index in the current tenant.
...
* View column statistics at the Global level: [DBA_TAB_COL_STATISTICS](26300.o-dba_tab_col_statistics-of-sys-tenant.md)
