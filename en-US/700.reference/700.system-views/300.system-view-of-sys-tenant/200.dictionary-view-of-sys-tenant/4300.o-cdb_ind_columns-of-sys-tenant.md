...
This view displays the index column information of the index tables of all tenants.
...
| COLLATED_COLUMN_ID | bigint(0)     | NO         | This column is not supported and is NULL by default.                            |

## Sample query

In the sys tenant, query the index column information of the index table `tbl9` of the tenant with ID 1002.
