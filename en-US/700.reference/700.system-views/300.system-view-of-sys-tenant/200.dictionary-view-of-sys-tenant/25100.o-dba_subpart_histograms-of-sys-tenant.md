...
Displays the histogram data (endpoints of each histogram) for all subpartitioned tables of the tenant.
...
The system tenant queries the histogram information of the subpartitions in the partitioned table `sales_subpart` for itself.
