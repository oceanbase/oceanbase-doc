...
| OLD_PASSWORD               | varchar(128)    | NO       | The hash value (ciphertext) of the old password. This field is valid only when the dual password feature is enabled or during password rotation. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.4.2 BP1. </p></main>          |
| OLD_PASSWORD_START_TIME    | bigint(20)      | NO       | The time when the old password becomes effective. A value of `-1` indicates that no valid old password is available. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.4.2 BP1. </p></main>                     |
