...
|slug|information_schema-session_variables-of-sys-tenant|
...
Records information about all session variables, including hidden variables that start with an underscore.
