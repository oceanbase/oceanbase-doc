...
| --- | --- | --- | --- |
| CREATE_TIME | timestamp(6) | YES | The timestamp when the throttling rule was created. |
| MODIFY_TIME | timestamp(6) | YES | The timestamp when the throttling rule was last modified. |
| TENANT_ID | bigint(20) | NO | The tenant ID. |
| DATABASE_ID | bigint(20) | NO | The database ID. |
| OUTLINE_ID | bigint(20) | NO | The ID of the throttling rule. |
| DATABASE_NAME | varchar(128) | NO | The name of the database. |
| OUTLINE_NAME | varchar(128) | NO | The name of the throttling rule. |
| OUTLINE_CONTENT | longtext | NO | The content of the throttling rule. This column can be empty. |
| VISIBLE_SIGNATURE | longtext | NO | The deserialized result of the signature. |
| SQL_TEXT | longtext | NO | The SQL statement specified in the ON clause when the throttling rule was created. |
...
Query the throttling rules of the sys tenant.
