...
| RET_CODE	                | bigint(20)	| NO   | The status of the task. Valid values: <ul><li><code>0</code>: succeeded</li><li><code>Non-zero</code>: failed</li></ul> |
...
| index_type | string | The index type used for vector processing. Valid values: <ul><li>HNSW</li><li>HNSW_SQ</li><li>HNSW_BQ</li><li>HGRAPH</li><li>SINDI</li></ul> |
...
* For the relationship between vector index dump, major compaction, and task types, see [Vector index principles](../../../100.oceanbase-database-concepts/400.database-objects/200.database-objects-of-mysql-mode/300.index-of-mysql-mode/330.vector-indexes-of-mysql-mode-in-concepts.md).
* For O&M and manual trigger information, see [Monitor and maintain vector indexes](../../../../640.ob-vector-search/200.ob-vector-index/600.vector-index-monitor-and-maintain.md).