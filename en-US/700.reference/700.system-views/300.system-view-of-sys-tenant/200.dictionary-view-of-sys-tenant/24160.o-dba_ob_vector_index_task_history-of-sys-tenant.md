...
The `DBA_OB_VECTOR_INDEX_TASK_HISTORY` view displays the historical information of all vector index partition rebuild tasks in the current tenant.
...
| RET_CODE	                | bigint(20)	| NO   | The status of the task at the end of the task. Valid values: <ul><li><code>0</code>: succeeded</li><li><code>Non-zero</code>: failed</li></ul> |
| TRACE_ID	                | varchar(512)	| NO   | The trace ID of the task. |

## Sample query

Query the historical information of all vector index partition rebuild tasks in all tenants under the sys tenant.
