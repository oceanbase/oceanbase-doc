...
* Query the file list of external tables created by all tenants: [CDB_OB_EXTERNAL_TABLE_FILES](8500.o-cdb_ob_external_table_files-of-sys-tenant.md)

* Query the file list of external tables created by the current tenant: [DBA_OB_EXTERNAL_TABLE_FILES](18900.o-dba_ob_external_table_files-of-sys-tenant.md)
