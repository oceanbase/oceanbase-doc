...
* Query the list of files corresponding to all external tables created in all tenants: [CDB_OB_EXTERNAL_TABLE_FILES](8500.o-cdb_ob_external_table_files-of-sys-tenant.md)

* Query the list of files corresponding to all external tables that you have access to: [ALL_OB_EXTERNAL_TABLE_FILES](4100.o-all_ob_external_table_files-of-sys-tenant.md)
