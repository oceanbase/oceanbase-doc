...
|tenant-type||
|machine-translation||
|slug|oceanbase-cdb_ob_ls_arb_replica_task_history-sys-tenant-tmp|

# oceanbase.CDB_OB_LS_ARB_REPLICA_TASK_HISTORY

## Purpose

The `oceanbase.CDB_OB_LS_ARB_REPLICA_TASK_HISTORY` view provides information about the current tenant and the history of arbitration tasks executed in the current tenant. You can query this view only from the sys tenant.
