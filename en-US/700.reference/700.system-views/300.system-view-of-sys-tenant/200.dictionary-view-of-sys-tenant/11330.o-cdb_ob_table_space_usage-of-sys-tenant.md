...
The following example shows how to query the sizes of all user tables in all tenants and the sizes of the leader replicas in a multi-replica environment in the sys tenant in SN mode.
