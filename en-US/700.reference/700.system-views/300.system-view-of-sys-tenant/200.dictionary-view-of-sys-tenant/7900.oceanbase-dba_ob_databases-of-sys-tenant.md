...
|tenant-type||
|machine-translation||
|slug|oceanbase-dba_ob_databases-sys-tenant-tmp|
...
| IN_RECYCLEBIN | varchar(3) | NO | Indicates whether the database has been dropped and is in the recycle bin. Valid values: <ul><li>YES</li><li>NO</li></ul> |
