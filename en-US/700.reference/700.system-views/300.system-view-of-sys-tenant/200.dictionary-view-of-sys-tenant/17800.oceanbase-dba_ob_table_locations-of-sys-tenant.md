...
|tenant-type||
|machine-translation||
|slug|oceanbase-dba_ob_table_locations-sys-tenant-tmp|
...
| DUPLICATE_SCOPE | varchar(7) | NO | Indicates whether the table is a replication table. Valid values:<ul><li>`CLUSTER`: a replication table.  </li><li>`NONE`: a normal table. </li></ul><main id="notice" type='explain'><h4>Note</h4><p>This column is introduced since OceanBase Database V4.2.0.</p></main> |
