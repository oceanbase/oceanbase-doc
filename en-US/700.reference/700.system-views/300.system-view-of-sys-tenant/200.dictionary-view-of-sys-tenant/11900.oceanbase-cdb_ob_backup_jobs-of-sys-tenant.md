...
|dir-name-en||
|tenant-type||
|slug|oceanbase-cdb_ob_backup_jobs-of-sys-tenant|

# oceanbase.CDB_OB_BACKUP_JOBS

## Purpose

The `oceanbase.CDB_OB_BACKUP_JOBS` view displays the backup jobs of all tenants in the cluster. Each time a user initiates a backup job, a job record is generated.
