...
| JOB_LEVEL | varchar(64) | NO | The job initiation level: <ul><li> `USER_TENANT`: A job initiated by a user tenant. </li><li> `SYS_TENANT`: A job initiated by a system tenant. </li></ul> |
