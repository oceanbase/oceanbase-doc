...
|slug|o-cdb_mvref_stats_sys_defaults-of-sys-tenant|
...
| PARAMETER_NAME | varchar(16) | NO | The name of the parameter. Valid values: <ul><li>COLLECTION_LEVEL: the level of data collection.</li><li>RETENTION_PERIOD: the data retention period.</li></ul>|
