...
The `oceanbase.DBA_PART_TABLES` view displays information about partitioned tables.
...
| DEF_INMEMORY_DISTRIBUTE | varchar(15) | NO | At present, this column is not supported and is `NULL` by default. |
...
| DEF_INMEMORY_DUPLICATE | varchar(13) | NO | At present, this column is not supported and is `NULL` by default. |
...
| DEF_CELLMEMORY | varchar(24) | NO | At present, this column is not supported and is `NULL` by default. |
