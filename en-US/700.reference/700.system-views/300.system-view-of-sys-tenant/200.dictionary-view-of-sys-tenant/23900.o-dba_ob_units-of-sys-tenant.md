...
| NET_BANDWIDTH_WEIGHT  | bigint(20)   | NO         | Weight of the network bandwidth of the unit. <main id="notice" type='explain'><h4>Note</h4><p>This field was introduced in V4.3.4. </p></main>     |
| REPLICA_TYPE          | varchar(7)   | NO         | Replica type. The default value is `FULL`. <main id="notice" type='explain'><h4>Note</h4><ul><li>For V4.5.x, the <code>REPLICA_TYPE</code> field was introduced in V4.5.0. </li><li>For V4.4.x, the <code>REPLICA_TYPE</code> field was introduced in V4.4.0 BP1. </li><li>For V4.2.5, the <code>REPLICA_TYPE</code> field was introduced in V4.2.5 BP7. </li></ul></main>   |
