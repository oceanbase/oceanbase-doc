...
In the sys tenant, query the partition information of the partitioned index `tbl2_f_rl_idx1` in the current tenant.
...
To view the partition information of all tenants, see [CDB_PART_INDEXES](12200.o-cdb_part_indexes-of-sys-tenant.md).