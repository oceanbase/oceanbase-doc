...
|tenant-type||
|machine-translation||
|slug|oceanbase.cdb_ob_import_table_tasks-o-cdb_ob_import_table_tasks-of-sys-tenant|
...
This view displays information about table-level cross-tenant import tasks.
...
| STATUS | varchar(64) | NO | The status of the task. Valid values: <ul><li>INIT: The table-level import task is being initialized.  </li><li>DOING: The table-level import task is being executed. </li><li>FINISH: The import task is completed. </li></ul> |
...
During table-level cross-tenant import, the sys tenant queries the information about the table-level cross-tenant import task.
