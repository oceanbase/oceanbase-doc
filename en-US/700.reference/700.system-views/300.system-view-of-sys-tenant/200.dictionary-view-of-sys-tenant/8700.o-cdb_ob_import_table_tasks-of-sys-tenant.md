...
Displays information about table-level cross-tenant import tasks.
...
| RESULT | varchar(64) | YES | Result of task completion:<ul><li>`SUCCESS`: The import task was executed successfully.</li><li>`FAIL`: Import task execution failed.</li></ul> |
| COMMENT | longtext | YES | Remarks |

## Sample query

During table-level restore, the system tenant can view information about cross-tenant import tasks at the table level.
