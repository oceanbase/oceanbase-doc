...
| RETRY_ID | bigint(20) | NO | The retry batch ID to which this change record belongs. <main id="notice" type='explain'><h4>Note</h4><p>This field is available starting with V4.4.2 BP2. </p></main>|
