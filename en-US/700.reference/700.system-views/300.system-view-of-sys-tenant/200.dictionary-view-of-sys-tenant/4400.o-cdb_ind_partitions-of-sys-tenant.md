...
This view displays the primary partition information of the index tables for all tenants.
...
| PCT_DIRECT_ACCESS       | bigint(0)       | NO         | This column is not supported. The value of this column is NULL by default. |
| GLOBAL_STATS            | varchar(3)      | NO         | This column is not supported. The value of this column is NULL by default. |
| DOMIDX_OPSTATUS         | varchar(6)      | NO         | This column is not supported. The value of this column is NULL by default. |
| PARAMETERS              | text            | NO         | This column is not supported. The value of this column is NULL by default. |
...
| ORPHANED_ENTRIES        | varchar(3)      | NO         | This column is not supported. The value of this column is NULL by default. |

## Sample query

In the sys tenant, query the primary partition information of the index `tbl2_f_rl` of the tenant with ID 1002.
