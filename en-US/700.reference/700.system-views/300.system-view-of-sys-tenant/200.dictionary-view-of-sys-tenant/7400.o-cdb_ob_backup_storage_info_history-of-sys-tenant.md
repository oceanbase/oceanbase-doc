...
The `oceanbase.CDB_OB_BACKUP_STORAGE_INFO_HISTORY` view displays the history of backup destinations of backup and restore in the current tenant.
...
| DEST_TYPE | varchar(64) | YES | The type of the backup destination, such as log archiving. <ul><li>`archive_log`: Log archiving</li> <li>`backup_data`: Data backup</li></ul> |
