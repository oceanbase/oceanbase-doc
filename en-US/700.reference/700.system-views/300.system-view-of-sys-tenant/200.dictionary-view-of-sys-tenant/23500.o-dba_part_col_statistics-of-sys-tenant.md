...
|tenant-type||
|machine-translation||
|slug|oceanbase.dba_part_col_statistics-o-dba_part_col_statistics-of-sys-tenant|
...
<!-- * Query the column statistics of a table: [DBA_TAB_STATISTICS]
...
* Query the histogram statistics of a table: [DBA_TAB_HISTOGRAMS]
