...
## Sample query
<<<<<<< llm_translation_of_commit_909fe814_250306111745

The following example shows how to query the disk usage of each node in the sys tenant in SN mode.

=======

The following example shows how to query the disk usage by each tenant across all nodes in the sys tenant in SN mode.
