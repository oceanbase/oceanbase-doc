...
Query the history of executed Transfer Partition tasks for the tenant whose ID is 1006.
...
* Query the Transfer Partition tasks that are being processed for all tenants: [oceanbase.CDB_OB_TRANSFER_PARTITION_TASKS](11500.o-cdb_ob_transfer_partition_tasks-of-sys-tenant.md)

* Query the history of executed Transfer Partition tasks for the current tenant: [oceanbase.DBA_OB_TRANSFER_PARTITION_TASK_HISTORY](23300.o-dba_ob_transfer_partition_tasks_history-of-sys-tenant.md)
