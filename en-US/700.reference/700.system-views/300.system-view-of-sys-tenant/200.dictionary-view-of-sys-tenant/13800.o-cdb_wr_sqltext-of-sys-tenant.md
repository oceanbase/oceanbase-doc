...
The `CDB_WR_SQLTEXT` view displays the SQL texts collected by the WR module for all tenants.
...
| QUERY_SQL | longtext    | NO   |  The SQL text.      |
...
Query the SQL texts collected by all tenants and display the first record.
