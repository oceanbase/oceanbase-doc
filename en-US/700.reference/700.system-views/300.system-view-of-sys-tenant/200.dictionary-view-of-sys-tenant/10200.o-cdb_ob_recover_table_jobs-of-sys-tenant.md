...
* The record for the `sys` tenant displays the progress of the table-level restore task for the target user tenant. The task is considered completed when the table-level restore task for the target user tenant is completed.

* The record for the target user tenant displays the progress of the restore operations of the auxiliary tenant and the progress of the table import task. The task is considered completed when the restore operations of the auxiliary tenant and the table import task are completed.
...
| INITIATOR_TENANT_ID | bigint(20) | NO | The ID of the parent tenant. |
...
| STATUS | varchar(64) | NO | The status of the task. Valid values: <ul><li>PREPARE: The task is being initialized.  </li><li>RECOVERING: The task is being restored. </li><li>RESTORE_AUX_TENANT: The auxiliary tenant is being restored. </li><li>PRECHECK_IMPORT: The import is being prechecked. </li><li>GEN_IMPORT_JOB: The import task is being initialized. </li><li>IMPORTING: The table is being imported. </li><li> CANCELING: The task is being canceled.</li><li>COMPLETED: The task is completed. </li><li>FAILED: The task failed. </li></ul> |
...
Query the information about the table-level restore task in the `sys` tenant.
