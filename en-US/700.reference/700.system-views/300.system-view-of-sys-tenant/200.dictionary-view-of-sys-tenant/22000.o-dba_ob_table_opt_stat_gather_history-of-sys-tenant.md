...
| PROPERTIES | text | YES | The properties set for the statistics collection. |
...
* View the status of historical statistics collection at the tenant level: [DBA_OB_TASK_OPT_STAT_GATHER_HISTORY](../200.dictionary-view-of-sys-tenant/22800.o-dba_ob_task_opt_stat_gather_history-of-sys-tenant.md)
...
* For more information about monitoring and diagnosing statistics collection, see [Monitor and diagnose statistics collection](../../../1000.performance-tuning-guide/500.sql-optimization/400.sql-optimization/400.optimizer-statistics/400.statistics-monitoring-diagnosis.md).