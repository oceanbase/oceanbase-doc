...
The `oceanbase.CDB_OB_BACKUP_DELETE_TASK_HISTORY` view displays the history of backup set and backup piece cleanup tasks that have been completed in the tenant.
