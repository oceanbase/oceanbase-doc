...
|tenant-type||
|machine-translation||
|slug|oceanbase-cdb_ob_backup_delete_task_history-sys-tenant-tmp|

# oceanbase.CDB_OB_BACKUP_DELETE_TASK_HISTORY

## Purpose

The `oceanbase.CDB_OB_BACKUP_DELETE_TASK_HISTORY` view displays the history of the backup_set/backup_piece cleanup tasks that have been completed in the tenant.
