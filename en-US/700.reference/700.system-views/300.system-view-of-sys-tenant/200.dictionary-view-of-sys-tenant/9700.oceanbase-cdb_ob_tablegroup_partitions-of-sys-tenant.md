...
|tenant-type||
|machine-translation||
|slug|oceanbase.cdb_ob_tablegroup_partitions-oceanbase-cdb_ob_tablegroup_partitions-of-sys-tenant|

# oceanbase.CDB_OB_TABLEGROUP_PARTITIONS

## Purpose

The `oceanbase.CDB_OB_TABLEGROUP_PARTITIONS` view provides the partitioning information about the partitioned table groups of all tenants in the sys tenant.
