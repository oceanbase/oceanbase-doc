...
<li>In OceanBase Database V4.2.0 and later, you can query the <a href="11000.o-cdb_ob_tablegroups-of-sys-tenant.md">CDB_OB_TABLEGROUPS</a> view for table groups. For more information about table groups, see <a href="../../../300.database-object-management/100.manage-object-of-mysql-mode/400.manage-table-groups-of-mysql-mode/100.about-table-groups-of-mysql-mode.md">Overview</a>. </li>
</ul>
</main>
