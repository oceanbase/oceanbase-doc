...
| COMPOSITE              | varchar(3)     | NO         | Indicates whether it is a multi-level partition. |
...
| INDEXING               | varchar(4)     | NO         | At present, this column is not supported and is `NULL` by default. |
| READ_ONLY              | varchar(4)     | NO         | At present, this column is not supported and is `NULL` by default. |
| INMEMORY               | varchar(8)     | NO         | At present, this column is not supported and is `NULL` by default. |
| INMEMORY_PRIORITY      | varchar(8)     | NO         | At present, this column is not supported and is `NULL` by default. |
| INMEMORY_DISTRIBUTE    | varchar(15)    | NO         | At present, this column is not supported and is `NULL` by default. |
| INMEMORY_COMPRESSION   | varchar(17)    | NO         | At present, this column is not supported and is `NULL` by default. |
...
| INMEMORY_SERVICE       | varchar(12)    | NO         | At present, this column is not supported and is `NULL` by default. |
| INMEMORY_SERVICE_NAME  | varchar(100)   | NO         | At present, this column is not supported and is `NULL` by default. |
| MEMOPTIMIZE_READ       | varchar(8)     | NO         | At present, this column is not supported and is `NULL` by default. |
| MEMOPTIMIZE_WRITE      | varchar(8)     | NO         | At present, this column is not supported and is `NULL` by default. |
