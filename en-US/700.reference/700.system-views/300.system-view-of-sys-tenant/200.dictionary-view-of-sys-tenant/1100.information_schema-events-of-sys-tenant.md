...
| ON_COMPLETION        | varchar(12)        | NO   | Indicates whether the event definition is preserved after the event is completed. Valid values:<ul><li>`PRESERVE` </li><li>`NOT PRESERVE` </li></ul> |
