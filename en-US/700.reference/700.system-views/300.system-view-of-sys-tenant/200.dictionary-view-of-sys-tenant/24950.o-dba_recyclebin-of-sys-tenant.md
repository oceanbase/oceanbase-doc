...
This view displays information about all recyclebin objects in the current tenant.
...
| DROPTIME       | date         | YES  | The time when the object was moved to the recyclebin.     |
...
| CAN_UNDROP     | varchar(3)   | NO   | Indicates whether the object can be recovered from the recyclebin:<ul><li>YES </li><li>NO </li></ul>      |
| CAN_PURGE      | varchar(3)   | NO   | Indicates whether the object can be purged:<ul><li>YES </li><li>NO </li></ul>      |
...
For more information about how to view recyclebin objects, see [View recyclebin objects](../../../../600.manage/400.high-availability/500.recyclebin-management/300.view-the-recyclebin-objects.md).