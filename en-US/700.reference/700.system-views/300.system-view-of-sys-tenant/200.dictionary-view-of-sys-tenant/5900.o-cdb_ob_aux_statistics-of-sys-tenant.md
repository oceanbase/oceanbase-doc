...
<h4>Note</h4>
<ul><li>For OceanBase Database V4.2.x, this view was introduced in OceanBase Database V4.2.3. </li>
<li>For OceanBase Database V4.3.x, this view was introduced in OceanBase Database V4.3.0. </li></ul>
</main>
