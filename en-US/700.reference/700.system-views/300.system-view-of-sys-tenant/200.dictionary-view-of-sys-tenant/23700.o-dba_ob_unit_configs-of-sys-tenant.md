...
| DATA_DISK_SIZE        | bigint(20)   | NO         | The value of this field is `NULL`, indicating that the value is undefined and the unit is allowed to compete for disk space with other tenants. <main id="notice" type='explain'><h4>Note</h4><p>This field was introduced in V4.3.4. </p></main>   |
