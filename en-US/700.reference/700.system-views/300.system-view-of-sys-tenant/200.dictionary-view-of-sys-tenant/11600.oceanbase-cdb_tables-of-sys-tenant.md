...
|dir-name-en||
|tenant-type||
|slug|oceanbase-cdb_tables-of-sys-tenant|
...
| INMEMORY_DUPLICATE | varchar(13) | NO | At present, this column is not supported and is `NULL` by default. |
...
| INMEMORY_SERVICE | varchar(12) | NO | Currently not supported. The default value is NULL.                        |
| INMEMORY_SERVICE_NAME | varchar(1000) | NO | Currently not supported. The default value is NULL.                     |
