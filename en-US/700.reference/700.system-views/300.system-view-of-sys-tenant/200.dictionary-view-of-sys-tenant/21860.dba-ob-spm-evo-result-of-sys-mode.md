...
| STATUS | varchar(7) | YES | Status of the evolution task: <ul><li>`success`: The evolution task has ended normally. </li><li>`timeout`: The evolution task timed out. In this case, the plan that executed better during the evolution period is selected. |
