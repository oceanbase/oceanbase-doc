...
|tenant-type||
|machine-translation||
|slug|oceanbase.dba_objects-oceanbase-dba_objects-of-sys-tenant|
...
| STATUS | varchar(7) | NO | The status of the object. Valid values: <li>`VALID`: valid. <li>`INVALID`: invalid. |
