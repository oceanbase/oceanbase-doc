...
| EXTERNAL_KMS_INFO | varchar(4096) | YES | If the source tenant has configured key management, set this parameter in the session. |
...
For more information about how to query the results of table-level restore tasks, see [View the table recovery history](../../../../600.manage/600.backup-and-recovery/700.recover-table/500.view-the-table-recovery-history.md).