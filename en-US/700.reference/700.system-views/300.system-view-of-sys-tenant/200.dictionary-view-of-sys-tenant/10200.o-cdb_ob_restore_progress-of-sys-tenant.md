...
| FINISH_BYTES                     | bigint(20)          |  NO   | The total number of bytes restored. In the current version, this value is always 0. |
| FINISH_BYTES_DISPLAY             | varchar(27)         |  NO   | The total number of bytes restored, in a storage capacity unit. In the current version, this value is always 0. |
