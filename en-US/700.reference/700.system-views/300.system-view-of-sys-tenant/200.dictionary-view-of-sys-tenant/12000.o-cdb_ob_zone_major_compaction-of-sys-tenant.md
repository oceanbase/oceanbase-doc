...
This view displays the major compaction information of all zones for all tenants under the sys tenant.
...
Query the major compaction information of all zones for all tenants under the sys tenant.
...
* Query the major compaction information of all tenants: [CDB_OB_MAJOR_COMPACTION](10000.o-cdb_ob_major_compaction-of-sys-tenant.md)
