...
The `oceanbase.CDB_OB_SYS_VARIABLES` view displays the information about the system variables of all tenants, including hidden variables whose names start with an underscore.
