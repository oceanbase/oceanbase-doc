...
To view the binding relationships between users and resource groups, see [oceanbase.DBA_RSRC_GROUP_MAPPINGS](25100.o-dba_rsrc_group_mappings-of-sys-tenant.md).