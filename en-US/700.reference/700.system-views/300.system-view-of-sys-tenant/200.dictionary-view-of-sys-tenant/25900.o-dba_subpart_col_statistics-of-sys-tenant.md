...
* Query the column statistics of the table level: [DBA_TAB_STATISTICS](26700.o-dba_tab_statistics-of-sys-tenant.md)

* Query the column statistics of the global level: [DBA_TAB_COL_STATISTICS](26300.o-dba_tab_col_statistics-of-sys-tenant.md)

* Query the column statistics of the partition level: [DBA_PART_COL_STATISTICS](24500.o-dba_part_col_statistics-of-sys-tenant.md)

* Query the histogram statistics of the table level: [DBA_TAB_HISTOGRAMS](26400.o-dba_tab_histograms-of-sys-tenant.md)

* Query the histogram statistics of the partition level: [DBA_PART_HISTOGRAMS](24600.o-dba_part_histograms-of-sys-tenant.md)

* Query the histogram statistics of the subpartition level: [DBA_SUBPART_HISTOGRAMS](26000.o-dba_subpart_histograms-of-sys-tenant.md)
