...
<table>
  ...
  <tr>
    ...
    <td>Displays the basic information of tenants.</td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <td>Displays the information about RootService jobs. The information is split and recorded in multiple views by type to facilitate structured queries.</td>
  </tr>
    <tr>
    ...
    <td>Displays the information about tables and indexes in a MySQL tenant.</td>
  </tr>
    <tr>
...
| <ul><li>  </li><li> </li><li> </li></ul>ALL_DB_LINKS| V4.1.0 | Displays all DBLinks accessible to the current user. |
...
| <ul><li>  information_schema.tables </li><li> information_schema.statistics </li></ul> | V4.0.0 | Displays the information about tables and indexes in the current tenant. |
| <ul><li> SYS.DBA_TABLES  </li><li> SYS.DBA_INDEXES  </li></ul>| V4.0.0 | Displays the information about tables and indexes in the current tenant. |
| <ul><li> SYS.DBA_PART_INDEXES  </li><li>SYS.DBA_PART_TABLES  </li></ul> | V4.0.0 | Displays the information about partitioned tables in the current tenant. |
| <ul><li> oceanbase.DBA_PART_TABLES  </li><li> oceanbase.DBA_PART_INDEXES </li></ul> | V4.0.0 | Displays the information about partitioned tables in the current tenant. |
...
| <ul><li>  oceanbase.DBA_OB_TABLEGROUP_TABLES </li><li> SYS.DBA_OB_TABLEGROUP_TABLES </li></ul> | V4.0.0 | Displays the associations between table groups and tables. |
...
| <ul><li>  SYS.DBA_TAB_PARTITIONS </li><li> SYS.DBA_TAB_SUBPARTITIONS</li><li>SYS.DBA_IND_PARTITIONS</li><li> SYS.DBA_IND_SUBPARTITIONS</li><li> SYS.DBA_SUBPARTITION_TEMPLATES </li></ul> | V4.0.0 | Displays the information about partitions in the current tenant. |
...
| <ul><li> SYS.DBA_TAB_COLUMNS  </li><li> SYS.DBA_TAB_COLS </li></ul> | V4.0.0 | Displays the information about columns. |
...
| <ul><li>  SYS.DBA_RECYCLEBIN </li><li> oceanbase.DBA_RECYCLEBIN </li></ul> | V4.0.0 | Displays the information about all recycle bins. |
