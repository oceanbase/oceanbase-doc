...
You can log in to a MySQL-compatible tenant and execute the `SHOW` statement to query views of a specific type.
...
The following table describes different types of dictionary views in an Oracle-compatible tenant.
