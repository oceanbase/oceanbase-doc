...
| Type           | String     |
| Default value             | NONE        |
| Value range           | <ul><li>NONE: disables auditing.</li><li>OS: writes audit records to local files.</li><li>DB: writes audit records to internal tables.</li><li>DB,EXTENDED: writes audit records to internal tables and includes executed SQL statements in the records.</li><li>DB_EXTENDED: writes audit records to internal tables and includes executed SQL statements in the records.</li></ul>  |
