...
| Type           | String     |
| Default value             | NONE        |
| Value range           | <ul><li>NONE: Disable audit. </li><li>OS: Write audit records to local files. </li><li>DB: Write audit records to internal tables. </li><li>DB,EXTENDED: Write audit records to internal tables and record executed SQL statements. </li><li>DB_EXTENDED: Write audit records to internal tables and record executed SQL statements. </li></ul>  |
