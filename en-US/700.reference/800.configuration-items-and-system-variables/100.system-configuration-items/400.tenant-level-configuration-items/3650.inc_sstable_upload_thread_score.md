...
For information about how to configure the number of threads that can be used to handle shared data references on a compute node in shared-storage mode, see [attach_shared_sstable_thread_score](230.attach_shared_sstable_thread_score.md).