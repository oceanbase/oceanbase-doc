...
When you use an external KMS, you can store some key management information in the `external_kms_info` parameter. The following example shows the format of this parameter:
...
```json
{
    ...
    "PRIVATE_KEY_PHRASE": "TEST_PHRASE",            // Private key password of the certificate
