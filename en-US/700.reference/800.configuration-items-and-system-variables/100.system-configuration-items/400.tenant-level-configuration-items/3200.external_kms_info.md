...
When you use an external key management service (KMS), you can store some key management information in the `external_kms_info` parameter. The following example shows the format of the parameter:
