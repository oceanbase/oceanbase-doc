...
`writing_throttling_trigger_percentage` specifies the percentage of used memory in a MemStore that triggers write throttling. When the memory usage of a MemStore reaches this threshold, write throttling is triggered.
