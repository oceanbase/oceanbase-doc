...
The `default_table_store_format` parameter specifies the default format for a table created in a user tenant, which can be a rowstore table, columnstore table, or hybrid rowstore-columnstore table.
...
* When you create a table in a user tenant, you can directly specify the default format of the table as rowstore, columnstore, or hybrid rowstore-columnstore without modifying the original table creation statement.
