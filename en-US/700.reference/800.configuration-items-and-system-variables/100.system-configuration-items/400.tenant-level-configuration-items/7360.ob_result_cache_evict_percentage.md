...
`ob_result_cache_evict_percentage` specifies the eviction threshold of the `result cache`.
...
Run the following command to set the eviction threshold of the `result cache` to 80.
