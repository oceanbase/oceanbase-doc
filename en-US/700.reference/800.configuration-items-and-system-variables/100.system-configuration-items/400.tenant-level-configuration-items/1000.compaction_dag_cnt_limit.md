...
## Description
 ...
 `compaction_dag_cnt_limit` specifies the maximum number of DAGs in a Compaction DAG queue.
...
Set the maximum number of DAGs in a Compaction DAG queue to 15000.
