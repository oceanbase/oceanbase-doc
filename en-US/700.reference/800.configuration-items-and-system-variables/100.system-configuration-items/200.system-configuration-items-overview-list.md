...
| Parameter | Description |
|---------|---------|
| [enable_kv_ttl](400.tenant-level-configuration-items/2600.enable_kv_ttl.md) | Controls whether to enable TTL background tasks. This parameter is effective for periodic TTL tasks, but user management commands are not affected by this setting. |
