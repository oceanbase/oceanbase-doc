...
| [enable_syslog_recycle](300.cluster-level-configuration-items/9000.enable_syslog_recycle.md)                | Specifies whether to record the logs generated before the startup of the OBServer node.                                   |
...
| Parameter | Description |
|---------------------------------------------------------------------------|-------------------------------------|
| [ddl_thread_score](400.tenant-level-configuration-items/1850.ddl_thread_score.md)      | The weight of the CPU time slice occupied by the worker threads for DDL tasks. |
