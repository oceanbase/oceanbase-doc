...
|---------|---------|
| [mysql_port](300.cluster-level-configuration-items/15400.mysql_port.md) | The SQL port. |
...
| [backup_recovery_window](300.cluster-level-configuration-items/1400.backup_recovery_window.md) | The time window in which backups can be restored. |
...
| [restore_concurrency](300.cluster-level-configuration-items/18100.restore_concurrency.md) | The maximum concurrency of tenant data restore from backups. |
...
| Parameter | Description |
|-----------------------------------------------------------------------------------------|-----------------------------------------------|
| [cpu_count](300.cluster-level-configuration-items/3700.cpu_count.md) | The total number of CPU cores in the system. If the parameter is set to `0`, the system automatically detects the number of CPU cores.         |
...
| [cpu_reserved](300.cluster-level-configuration-items/3800.cpu_reserved.md) | The number of CPU cores reserved in the system. The remaining CPU cores are exclusively occupied by OceanBase Database. |
| [sys_cpu_limit_trigger](300.cluster-level-configuration-items/22000.sys_cpu_limit_trigger.md) | The CPU utilization threshold. When CPU utilization reaches the threshold, background tasks in the system are suspended. |
...
| Parameter | Description |
|----------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| [balancer_log_interval](300.cluster-level-configuration-items/2000.balancer_log_interval.md)                   | The interval for printing statistical logs generated by the threads of disaster recovery tasks.                                           |
| [balancer_task_timeout](300.cluster-level-configuration-items/2100.balancer_task_timeout.md)                   | The timeout period of background tasks such as load balancing.                                                 |
...
| [resource_hard_limit](300.cluster-level-configuration-items/17900.resource_hard_limit.md)                     | The overprovisioning percentage of CPU resources.                                                         |
...
| [balancer_timeout_check_interval](300.cluster-level-configuration-items/2200.balancer_timeout_check_interval.md) | The interval for checking whether background tasks such as load balancing time out. |
| [data_copy_concurrency](300.cluster-level-configuration-items/3900.data_copy_concurrency.md) | The maximum number of concurrent data migration and replication tasks allowed in the system.  |
...
| [unit_balance_resource_weight](300.cluster-level-configuration-items/24300.unit_balance_resource_weight.md) | The weights of resources in unit load balancing strategies. Usually, you do not need to set this parameter. |
...
| Parameter | Description |
|----------------------------------------------------------------------------------------------|----------------------------------------|
| [unit_gc_wait_time](300.cluster-level-configuration-items/24320.unit_gc_wait_time.md)                               | Specifies the maximum wait time for unit GC. If the maximum wait time is exceeded, GC will be forced.|
...
| [balance_blacklist_failure_threshold](300.cluster-level-configuration-items/1700.balance_blacklist_failure_threshold.md) | The maximum number of consecutive failures of a background task such as replica migration upon which the task is added to the blocklist. |
| [balance_blacklist_retry_interval](300.cluster-level-configuration-items/1800.balance_blacklist_retry_interval.md) | The retry interval for a background task such as replica migration that is added to the blocklist. |
| [election_cpu_quota](300.cluster-level-configuration-items/5900.election_cpu_quota.md) | The CPU quota allocated to background tasks related to replica election. |
...
| [enable_smooth_leader_switch](300.cluster-level-configuration-items/8500.enable_smooth_leader_switch.md) | Specifies whether to enable smooth leader switchover. |
...
| [index_info_block_cache_priority](300.cluster-level-configuration-items/10900.index_info_block_cache_priority.md) | The priority of the block index cache in the cache system. |
...
| [auto_broadcast_location_cache_rate_limit](300.cluster-level-configuration-items/300.auto_broadcast_location_cache_rate_limit.md) | The maximum number of partitions whose location changes can be broadcast on each OBServer node per second. |
| [auto_refresh_location_cache_rate_limit](300.cluster-level-configuration-items/500.auto_refresh_location_cache_rate_limit.md) | The maximum number of partitions for which automatic refresh can be triggered per second on each OBServer node. |
...
| [partition_table_check_interval](300.cluster-level-configuration-items/16900.partition_table_check_interval.md) | The interval at which the OBServer node deletes non-existent replicas from a partitioned table. |

### Background execution thread parameters

| Parameter | Description |
|-------------|-----------|
| [sql_net_thread_count](300.cluster-level-configuration-items/20600.sql_net_thread_count.md)            | The number of I/O threads for the MySQL cluster, namely the number of `global_sql_nio_server` threads. The default value `0` indicates that the value of the parameter is the same as that of `net_thread_count`.                                    |
| [auto_leader_switch_interval](300.cluster-level-configuration-items/400.auto_leader_switch_interval.md) | The working interval of the background thread for automatic leader switchover. |
| [switchover_process_thread_count](300.cluster-level-configuration-items/21400.switchover_process_thread_count.md) | The size of the thread pool for primary/standby database switchover. |
...
| [sys_bkgd_io_high_percentage](300.cluster-level-configuration-items/21500.sys_bkgd_io_high_percentage.md) | The highest percentage of I/O resources that can be occupied by background tasks |
| [sys_bkgd_io_low_percentage](300.cluster-level-configuration-items/21600.sys_bkgd_io_low_percentage.md) | The lowest percentage of I/O resources that can be occupied by background tasks |
| [user_iort_up_percentage](300.cluster-level-configuration-items/24600.user_iort_up_percentage.md) | The I/O latency threshold for the user disk. When the I/O latency of the user disk reaches this threshold, the traffic of background I/O operations is throttled. |
...
| [ob_esi_session_timeout](300.cluster-level-configuration-items/16000.ob_esi_session_timeout.md) | The timeout period of the active session resources for the obesi process. |
...
| Parameter | Description |
|----------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| [datafile_disk_percentage](300.cluster-level-configuration-items/4400.datafile_disk_percentage.md)          | The percentage of used space to the total space of the disk where the `data_dir` directory is located. This disk is initialized for data storage by the OceanBase Database system. |
...
| [memory_reserved](300.cluster-level-configuration-items/13700.memory_reserved.md)                   | The memory size reserved by the system for KVCache.                                           |
...
| [enable_upgrade_mode](300.cluster-level-configuration-items/9300.enable_upgrade_mode.md) | Specifies whether to enable the upgrade mode. In upgrade mode, some background system features are suspended.            |
...
| [rootservice_list](300.cluster-level-configuration-items/18400.rootservice_list.md)                    | The list of servers where RootService and its replicas are deployed.                            |
| [rootservice_ready_check_interval](300.cluster-level-configuration-items/18600.rootservice_ready_check_interval.md)    | The wait time after RootService is started, during which the cluster status is checked.                      |
...
| [fast_recovery_concurrency](300.cluster-level-configuration-items/9400.fast_recovery_concurrency.md) | The maximum concurrency for executing quick restore tasks scheduled by RootService on an OBServer node. |
...
| Parameter | Description |
|---------------------------------------------------------------------------------|--------------------------------------------------|
| [log_disk_size](300.cluster-level-configuration-items/12700.log_disk_size.md) | The size of the log disk where redo logs are stored. |
...
| [clog_disk_utilization_threshold](300.cluster-level-configuration-items/3000.clog_disk_utilization_threshold.md) | The usage of the clog or ilog disk space that triggers disk space reuse. |
| [clog_expire_days](300.cluster-level-configuration-items/3100.clog_expire_days.md) | The retention period of clog files. When the retention period of a clog file expires, the file is deleted. |
| [clog_cache_priority](300.cluster-level-configuration-items/2800.clog_cache_priority.md) | The priority of the transaction log cache. |
...
| [ignore_replay_checksum_error](300.cluster-level-configuration-items/10300.ignore_replay_checksum_error.md) | Specifies whether to ignore checksum errors that occur during transaction log replay. |
| [index_clog_cache_priority](300.cluster-level-configuration-items/10800.index_clog_cache_priority.md) | The priority of the transaction log index cache in the cache system. |
| [ilog_index_expire_time](300.cluster-level-configuration-items/10500.ilog_index_expire_time.md) | The validity period of ilog files on OBServer nodes. Expired files can no longer be read. |
...
| Parameter | Description |
|-------------------------------------------------------------------------------------|------------------------------------------------------|
| [alert_log_level](300.cluster-level-configuration-items/50.alert_log_level.md) | The level of alert logs. |
...
| [enable_syslog_recycle](300.cluster-level-configuration-items/9000.enable_syslog_recycle.md)                | Specifies whether to enable the switch for recycling old logs before the OBServer node starts, in conjunction with `max_syslog_file_count`, to determine whether the recycling logic considers old log files.   |
| [enable_syslog_wf](300.cluster-level-configuration-items/9100.enable_syslog_wf.md)                     | Specifies whether to print system logs at the WARN level or above to a separate log file.                 |
...
| [syslog_level](300.cluster-level-configuration-items/22200.syslog_level.md)                         | The level of system logs.                                          |
...
| [diag_syslog_per_error_limit](300.cluster-level-configuration-items/5500.diag_syslog_per_error_limit.md)          | The number of DIAG system logs allowed for each error code per second. When this threshold is reached, no more logs are printed.                                   |
...
| [tableapi_transport_compress_func](300.cluster-level-configuration-items/22600.tableapi_transport_compress_func.md) | The algorithm for compressing OBKV-Table query results for transmission.      |
...
| [enable_merge_by_turn](300.cluster-level-configuration-items/7200.enable_merge_by_turn.md) | Specifies whether to enable the rotating compaction strategy. |
...
| [zone_merge_order](300.cluster-level-configuration-items/25500.zone_merge_order.md) | The order of zones in a rotating compaction. If you do not specify a value, the system determines the parameter value. |
...
| [minor_freeze_times](300.cluster-level-configuration-items/14900.minor_freeze_times.md) | The number of freezes that triggers a major compaction. |
...
|[ob_startup_mode](300.cluster-level-configuration-items/16400.ob_startup_mode.md)           | Specifies the startup mode of an OBServer node. This parameter can be modified only when the OBServer node is started for the first time. |
...
| Parameter | Description |
|------------------------------------------------------------------|-----------------|
| [sts_credential](400.tenant-level-configuration-items/7730.sts_credential.md)            | Specifies the credentials to access the STS service provided by OCP. |
...
| Parameter | Description |
|----------------------------------------------------------------------------------------------|----------------------------------------|
|[replica_parallel_migration_mode](400.tenant-level-configuration-items/7330.replica_parallel_migration_mode.md)                        | Specifies the mode of the parallel log stream replica migration feature. |
| [choose_migration_source_policy](400.tenant-level-configuration-items/650.choose_migration_source_policy.md)                          | The prioritizing strategy for selecting the source replica for migration.                      |
...
| Parameter | Description |
|----------------------------------------------------------------------------------------|----------------------------------|
| [recover_table_concurrency](400.tenant-level-configuration-items/7320.recover_table_concurrency.md)                 | Sets the maximum number of tables that can be restored in parallel during the cross-tenant import phase of table-level recovery. |
| [recover_table_dop](400.tenant-level-configuration-items/7325.recover_table_dop.md)                                 | Sets the maximum number of parallel tasks allowed for restoring a single table during the cross-tenant import phase of table-level recovery. |
| [log_restore_concurrency](400.tenant-level-configuration-items/4800.log_restore_concurrency.md)                     | The concurrency of log restore.            |
...
| [backup_data_file_size](400.tenant-level-configuration-items/500.backup_data_file_size.md)                   | Controls the maximum file size limit for a single data backup file.                   |
...
| Parameter | Description |
|---------------------------------------------------------------------------------|-----------------------------------|
| [spill_compression_codec](400.tenant-level-configuration-items/7450.spill_compression_codec.md)            | The algorithm for compressing data for storage during SQL statement execution. |
| [ob_encoding_granularity](400.tenant-level-configuration-items/5850.ob_encoding_granularity.md)            | Sets the maximum number of rows for encoding in a single microblock. |
