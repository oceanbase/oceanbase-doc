...
| Parameter | Description |
|-----------------------|-----------------------------|
| [enable_logservice](300.cluster-level-configuration-items/6950.enable_logservice.md)   | Specifies whether to enable the log service mode. |
| [logservice_access_point](300.cluster-level-configuration-items/12750.logservice_access_point.md)   | Persists the access points of the log service. |
