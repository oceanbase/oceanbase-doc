...
| -------- | -------- |
| Type    | Capacity |
| Default value      | 0 MB, which indicates that no traffic limit is set. |
...
[Set the log synchronization speed limit](../../../../600.manage/400.high-availability/300.physical-standby-database-disaster-recovery/300.log-transport-service/700.set-log-synchronization-speed-limit.md)