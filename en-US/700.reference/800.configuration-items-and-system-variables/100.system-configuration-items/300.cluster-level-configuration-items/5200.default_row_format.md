...
`default_row_format` specifies the default row format used when creating tables in MySQL-compatible mode.
...
Set the default row format to `DYNAMIC` when creating tables in MySQL-compatible mode.
