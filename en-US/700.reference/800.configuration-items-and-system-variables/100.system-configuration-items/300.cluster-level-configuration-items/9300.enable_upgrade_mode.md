...
Before an upgrade, you can use this system parameter to disable features that need to be disabled (such as DDL operations) to simplify the upgrade process. Set `enable_upgrade_mode` to True before the upgrade and to False after the upgrade.
