...
`enable_sql_operator_dump` specifies whether to write the intermediate results of SQL processing to disk to release memory.
...
Set the parameter to allow the intermediate results of SQL processing to be written to disk to release memory.
