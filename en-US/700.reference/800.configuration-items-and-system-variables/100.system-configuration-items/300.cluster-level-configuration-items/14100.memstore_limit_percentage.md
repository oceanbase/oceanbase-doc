...
|------------------|-----------|
| Type | Integer |
| Default value | `0`, which specifies to automatically adapt the value. <main id="notice" type='explain'><h4>Note</h4><p>The default value has been changed from `50` to `0` since OceanBase Database V4.2.3.</p></main> |
| Value range | [0, 100) <main id="notice" type='explain'><h4>Note</h4><p>The value range has been changed from (0, 100) to [0, 100) since OceanBase Database V4.3.0. </p></main>|
