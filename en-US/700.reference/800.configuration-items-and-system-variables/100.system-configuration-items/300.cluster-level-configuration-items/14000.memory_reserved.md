...
`memory_reserved` specifies the size of memory reserved for the system's underlying modules.
...
Set the size of memory reserved for the system's underlying modules to 500M.
