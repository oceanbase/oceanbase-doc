...
| Value range             | [0s, +∞)<main id="notice" type='explain'><h4>Note</h4><ul><li>When the value is 0, the schema multi-version record recycling task is disabled. </li> <li>When the value is not 0, it specifies the interval at which the schema multi-version record recycling task is executed. </li></ul></main> |
