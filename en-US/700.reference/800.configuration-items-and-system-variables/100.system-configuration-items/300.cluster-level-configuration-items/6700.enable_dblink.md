...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>This parameter was introduced in OceanBase Database V4.2.1 BP4. </p>
</main>
...
| Type | Boolean |
| Default value | true |
| Value range | </li><li>`true`: enables the DBLink feature. </li><li>`false`: disables the DBLink feature, with the `OB_OP_NOT_ALLOW` error returned. </li></ul>|
