...
`ob_java_connector_path` specifies the path of executable dependency JAR packages that can be loaded by the JVM started by the OBServer.
...
Set the path of executable dependency JAR packages to `/home/admin/jni_packages/`.
