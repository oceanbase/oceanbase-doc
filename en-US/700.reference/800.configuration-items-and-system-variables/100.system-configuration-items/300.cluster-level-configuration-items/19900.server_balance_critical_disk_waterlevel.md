...
`server_balance_critical_disk_waterlevel` specifies the threshold for disk space load balancing. When the disk usage exceeds the threshold, the load balancing strategy will prioritize disk balancing.
