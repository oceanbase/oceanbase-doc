...
This parameter is used to access COS through the S3 protocol. For more information about the operation and example, see [Prepare for log archiving](../../../../600.manage/600.backup-and-recovery/300.log-archive/200.preparation-before-log-archive.md).
