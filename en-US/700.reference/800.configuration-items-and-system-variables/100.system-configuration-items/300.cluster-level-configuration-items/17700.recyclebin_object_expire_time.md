...
If the value is not 0s, schema objects that entered the recycle bin more than the specified time ago are automatically purged.
...
* Enable the automatic purge feature and purge schema objects that entered the recycle bin more than 7 days ago.
