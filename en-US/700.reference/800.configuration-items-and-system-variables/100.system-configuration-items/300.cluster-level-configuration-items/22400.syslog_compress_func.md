...
`syslog_compress_func` specifies the algorithm for compressing system logs.
...
* **The relationships between the `syslog_compress_func` parameter and the [syslog_file_uncompressed_count](22600.syslog_file_uncompressed_count.md), [syslog_disk_size](22500.syslog_disk_size.md), and [max_syslog_file_count](13600.max_syslog_file_count.md) parameters are as follows:**
...
Set the algorithm for compressing system logs to `zstd_1.3.8`.
