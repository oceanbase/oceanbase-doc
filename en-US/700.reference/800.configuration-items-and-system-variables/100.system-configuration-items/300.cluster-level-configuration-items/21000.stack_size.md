...
| -------- | -------- |
| Type             | Capacity        |
| Default value               | 512K. The default unit is MB. You must specify the unit when you configure this parameter.<main id="notice" type='explain'><h4>Note</h4><p>Starting from V4.0.0, the default value of this parameter is changed from 1M to 512K. </p></main>            |
