...
| Valid values |<ul><li> NORMAL: specifies to start in normal mode.  </li><li>ARBITRATION: specifies to start in arbitration mode. </li><li>SHARED_STORAGE: specifies to start in shared storage (SS) mode. This mode is not supported. </li></ul><main id="notice" type='explain'><h4>Note</h4><p>The `SHARED_STORAGE` value was introduced in V4.3.4. </p></main>|
