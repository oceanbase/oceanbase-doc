...
This feature takes effect only when the value of the [max_syslog_file_count](13300.max_syslog_file_count.md) parameter is a non-zero positive integer.

## Examples

Set the system to print system logs of WARN level and above to a separate log file.
