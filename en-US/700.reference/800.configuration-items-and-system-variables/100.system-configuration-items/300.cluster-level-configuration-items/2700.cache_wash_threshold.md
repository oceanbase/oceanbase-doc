...
`cache_wash_threshold` specifies the capacity threshold for triggering cache cleaning. When the memory space is less than the specified value, the memory space will be cleaned.
...
Set the capacity threshold for triggering cache cleaning to 4GB.
