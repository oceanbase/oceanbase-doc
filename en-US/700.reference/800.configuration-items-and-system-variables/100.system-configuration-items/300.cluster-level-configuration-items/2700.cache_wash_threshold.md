...
`cache_wash_threshold` specifies the capacity threshold that triggers cache cleaning. When the memory space is less than the specified value, the memory space will be cleaned.
