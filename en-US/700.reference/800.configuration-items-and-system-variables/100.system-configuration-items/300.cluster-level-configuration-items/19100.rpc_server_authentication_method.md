...
`rpc_server_authentication_method` specifies the security authentication method of the RPC server. You only need to log in to the sys tenant and set the authentication method for the client and server by running corresponding commands.
