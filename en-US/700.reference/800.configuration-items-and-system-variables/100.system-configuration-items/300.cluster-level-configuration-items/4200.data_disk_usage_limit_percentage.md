...
`data_disk_usage_limit_percentage` specifies the maximum percentage of data files that can be written to. Data migration is prohibited when this threshold is exceeded.
...
* Set the maximum percentage of data files that can be written to: [data_disk_write_limit_percentage](4300.data_disk_write_limit_percentage.md)
