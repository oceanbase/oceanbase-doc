...
|tenant-type||
|machine-translation||
|slug|sql_auto_is_null-session|

# sql_auto_is_null

`sql_auto_is_null` specifies whether to obtain the auto-increment column value of the last inserted row. This parameter is used by some special drivers, such as Open Database Connectivity (ODBC).
