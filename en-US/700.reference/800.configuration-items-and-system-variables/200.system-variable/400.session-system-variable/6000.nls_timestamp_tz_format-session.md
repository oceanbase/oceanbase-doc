...
|machine-translation||
|slug|nls_timestamp_tz_format-session|
...
`nls_timestamp_tz_format` specifies the format to use when you convert a TZ timestamp to a string, or when you implicitly convert a string to a TZ timestamp.
