...
| Type | ENUM |
| Default value | FORCE |
| Value range | <li>`FORCE`: Parameterization is required for processing an SQL statement.<li>`EXACT`: Parameterization is not required for processing an SQL statement. |
