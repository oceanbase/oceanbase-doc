...
|tenant-type||
|machine-translation||
|slug|nls_nchar_conv_excp-session|
...
| Type | Boolean |
| Default value | FALSE |
| Value range | <li> `TRUE`: specifies to report an error in case of data loss. <li> `FALSE`: speicifies not to report an error in case of data loss. |
