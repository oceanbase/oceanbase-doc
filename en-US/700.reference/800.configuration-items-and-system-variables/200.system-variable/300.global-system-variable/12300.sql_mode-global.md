...
|--------|----------|
| Type | Uint |
| Default value | STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_AUTO_CREATE_USER  <main id="notice" type='explain'><h4>Note</h4><ul><li>In OceanBase Database V4.3.0 and later V4.3.x versions, the default value is changed from <code>STRICT_ALL_TABLES,NO_ZERO_IN_DATE</code> to <code>STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_AUTO_CREATE_USER</code>. </li><li>In OceanBase Database V4.2.1 BP1 and later V4.2.x versions, the default value is changed from <code>STRICT_ALL_TABLES,NO_ZERO_IN_DATE</code> to <code>STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_AUTO_CREATE_USER</code>. </li></ul></main>|
