...
|-----------|--------------------------|
| Type | Integer |
| Default value | `86400000000`, in μs. <main id="notice" type='explain'><h4>Note</h4><p>In OceanBase Database V4.0.0 and later, the default value of this variable is changed from `120000000` to `86400000000`.</p></main> |
