...
`character_set_connection` specifies the character set to be converted after a statement is received.
...
Set the character set to be converted after a statement is received to `utf8mb4`.
