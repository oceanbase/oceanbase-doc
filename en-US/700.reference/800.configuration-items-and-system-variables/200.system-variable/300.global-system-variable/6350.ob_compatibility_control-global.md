...
* Modify variables
  ...
  This parameter is not supported for modification by using SQL statements after a tenant is created.
...
* When you upgrade a tenant without this variable to a version with this variable, the default value `MYSQL5.7` is used for this variable. When you create a tenant, you can specify a value for this variable.
