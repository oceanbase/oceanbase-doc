...
This topic describes the TPC-H test environment, test approach, and details of the test results.

## Test environment

The example below uses an Elastic Compute Service (ECS) instance on Alibaba Cloud as the deployment environment.
...
* Tenant specifications
    ...
    <main id="notice" type='explain'>
      <h4>Note</h4>
      <p>In this example, <code>--optimize=htap</code> specifies the default workload type. In a production environment, select an appropriate workload type based on the cluster type. </p>
    </main>
...
* For more information, see [Run the TPC-H benchmark on OceanBase Database](../500.tpc-h-benchmark-testing-on-oceanbase-database/100.run-the-tpc-h-benchmark-on-oceanbase-database.md).
