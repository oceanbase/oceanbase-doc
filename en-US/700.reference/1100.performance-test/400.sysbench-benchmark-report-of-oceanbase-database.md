...
* Hardware configurations
    ...
    | Sysbench | ecs.c7.4xlarge | 1 | 16 cores | 32 GB |
    | OceanBase Database Proxy (ODP) | ecs.c7.16xlarge | 1 | 64 cores | 128 GB |
