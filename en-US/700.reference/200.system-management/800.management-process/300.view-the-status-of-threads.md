...
1. Log in to a MySQL or Oracle-compatible tenant of the cluster as an administrator user.

2. Execute the following command to view the status of threads.
   ...
   * Oracle-compatible mode
   ...
   The following table describes some of the fields in the query result.
