...
<!-- OceanBase Database multi-tenant thread processing of local OLTP SQL requests is shown in the following figure.
...
<!-- OceanBase Database multi-tenant thread processing of distributed SQL RPC requests is shown in the following figure.
...
<!-- OceanBase Database multi-tenant thread processing of local PX SQL requests is shown in the following figure.
