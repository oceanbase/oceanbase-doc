...
1. Log in to the database as the tenant administrator of the `sys` tenant or a user tenant.
   ...
   <h4>Note</h4>
   <p>The administrator of a MySQL tenant is the <code>root</code> user, and that of an Oracle tenant is the <code>SYS</code> user.</p>
   </main>
...
2. Execute the following statement to view the disk space occupied by table data.
   ...
   * User tenant
      ...
      The following statement is used to view the disk space occupied by tables in the current MySQL tenant:
      ...
      The following statement is used to view the disk space occupied by tables in the current Oracle tenant:
