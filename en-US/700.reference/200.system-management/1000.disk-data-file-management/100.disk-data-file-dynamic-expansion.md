...
| dir-name-en ||
| tenant-type ||
|slug|configure-automatic-expansion-of-disk-data-files|

# Configure dynamic expansion of disk data files

OceanBase Database supports automatic expansion based on the actual usage of disk data files.
...
2. Execute the following command to view the parameter values:
