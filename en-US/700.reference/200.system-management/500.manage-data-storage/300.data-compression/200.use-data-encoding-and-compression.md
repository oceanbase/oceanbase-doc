...
## Configure data compression and encoding in MySQL-compatible mode

When you create or modify a table in MySQL-compatible mode, you can set the `row_format` and `compression` parameters to specify the encoding format and compression algorithm.
...
## Configure data compression and encoding in Oracle-compatible mode

When you create or modify a table in Oracle-compatible mode, you can specify the data encoding format and compression algorithm.
...
3. Change the compression algorithm.
   ...
   For more information about how to change the compression algorithm in MySQL-compatible mode, see **Configure data compression and encoding in MySQL-compatible mode** in this topic.

   For more information about how to change the compression algorithm in Oracle-compatible mode, see **Configure data compression and encoding in Oracle-compatible mode** in this topic.
