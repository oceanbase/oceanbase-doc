...
|slug|partition-splitting-overview-oracle-compatible-mode|

# Partition splitting overview
...
OceanBase Database in Oracle-compatible mode supports the following types of partition splitting:
