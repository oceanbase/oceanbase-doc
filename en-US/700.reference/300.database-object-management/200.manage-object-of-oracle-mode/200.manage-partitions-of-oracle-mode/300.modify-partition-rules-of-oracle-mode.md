...
* `table_name`: the name of the non-partitioned table to be modified.
...
The Oracle mode of OceanBase Database currently does not support modifying the partitioning key of a partitioned table.
