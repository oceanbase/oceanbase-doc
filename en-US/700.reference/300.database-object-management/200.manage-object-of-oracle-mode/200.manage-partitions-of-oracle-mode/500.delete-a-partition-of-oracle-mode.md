...
* In Oracle mode, when you drop a partition in a partitioned table that has global indexes, you must specify the `UPDATE GLOBAL INDEXES` clause in the `ALTER TABLE` statement. If you do not specify this clause, the global indexes on the partitioned table will be unavailable after the partition is dropped.
...
```
  ...
  <main id="notice" type='explain'>
    ...
    <ul>
    <li>
    <p>You can drop one or more partitions, but not all partitions, in a partitioned table. </p>
    </li>
    <li>
...
You can drop a subpartition in a subpartitioned table as needed. When you drop a subpartition, the definition and data in the subpartition are also dropped.
