...
```
  ...
  <main id="notice" type='explain'>
    ...
    <li>
    <p>When adding a partition to a LIST-partitioned table, the new partition must not conflict with existing partitions. If a LIST partition has a default partition (<code>DEFAULT</code>), you cannot add any new partitions. </p>
    </li>
    <li>
