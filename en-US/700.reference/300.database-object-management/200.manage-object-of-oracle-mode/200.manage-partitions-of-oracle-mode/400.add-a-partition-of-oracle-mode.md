...
Take note of the following points in Oracle mode of OceanBase Database:
...
```
  ...
  <main id="notice" type='explain'>
    ...
    <li>
    <p>For a LIST-partitioned table, you must add a partition that does not conflict with existing partitions. If a LIST-partitioned table has a <code>DEFAULT</code> partition, you cannot add new partitions to the table. </p>
    </li>
    <li>
...
In OceanBase Database in Oracle mode, you can add a subpartition only to a non-template-based subpartitioned table.
