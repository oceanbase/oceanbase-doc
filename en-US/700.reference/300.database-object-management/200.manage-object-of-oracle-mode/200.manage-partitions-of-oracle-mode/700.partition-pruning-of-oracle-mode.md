...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>In this example, the physical partition identifier to access is <code>p0sp0</code>. This identifier is not the name of a subpartition. For a table with template-based subpartitions, the subpartition naming rule is <code>($part_name)s($subpart_name)</code>. For example, <code>p0ssp0</code>.</p>
</main>
