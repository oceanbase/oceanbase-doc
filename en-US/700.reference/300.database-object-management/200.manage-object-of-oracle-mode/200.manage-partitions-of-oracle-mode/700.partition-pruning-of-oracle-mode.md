...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>In this example, the physical partition identifier to access is <code>p0sp0</code>. This identifier is not the name of a subpartition. For a table that contains subpartitions, the subpartition name is in the format of <code>($part_name)s($subpart_name)</code>. For example, <code>p0ssp0</code> is a subpartition name.</p>
</main>
