...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>In this example, the physical partition identifier to be accessed is <code>p0sp0</code>. This identifier is not the name of the subpartition. For a table that uses template-based subpartitioning, the naming convention for subpartitions is <code>($part_name)s($subpart_name)</code>, for example, <code>p0ssp0</code>.</p>
</main>
