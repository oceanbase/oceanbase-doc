...
Take note of the following considerations before you truncate a partition:
...
Drop the `sp3` and `sp4` subpartitions from the `p1` partition of the `t2_f_lr` subpartitioned table, and then update the global indexes.
