...
<main id="notice" type='notice'>
    ...
    <ul>
    <li>
    <p>In the Oracle-compatible mode of OceanBase Database, if the keyword of an index is not specified, <code>GLOBAL</code> is used as the keyword by default. In this case, the index is created as a global index, and the index table has only one partition. </p>
    </li>
    <li>
