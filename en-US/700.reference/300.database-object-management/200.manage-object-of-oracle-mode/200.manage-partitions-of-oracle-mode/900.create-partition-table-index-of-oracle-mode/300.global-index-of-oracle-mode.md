...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>If you create a global index on a table that belongs to a table group whose <code>SHARDING</code> attribute is set to `NONE`, the created global index is also bound with the table group. For more information about the table group attribute, see <a href="../../300.manage-table-groups-of-oracle-mode/500.modify-the-sharding-attribute-ot-a-table-group-of-oracle-mode.md">Modify the SHARDING attribute of a table group</a>. </p>
</main>

In Oracle mode, if the keyword of an index is not specified, GLOBAL is used as the keyword by default. In this case, the index is created as a global index, and the index table has only one partition. Here is an example:
