...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>When you create a global index for a table in a table group whose SHARDING attribute is <code>SHARDING = 'NONE'</code>, the global index is also bound to the table group. For more information about table group attributes, see <a href="../../300.manage-table-groups-of-oracle-mode/500.modify-the-sharding-attribute-ot-a-table-group-of-oracle-mode.md">Modify the SHARDING attribute of a table group</a>. </p>
</main>

In the Oracle-compatible mode of OceanBase Database, if the keyword of an index is not specified, `GLOBAL` is used as the keyword by default. In this case, the index is created as a global index, and the index table has only one partition. Here is an example:
