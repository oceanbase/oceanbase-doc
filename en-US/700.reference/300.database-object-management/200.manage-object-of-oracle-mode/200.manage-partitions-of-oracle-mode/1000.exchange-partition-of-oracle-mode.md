...
* This feature supports only operations with the `INCLUDING INDEXES` clause. Data of partitions corresponding to local indexes is also exchanged. The local indexes remain in the usable state after the partition exchange is successful.
