...
### Primary partitioned tables

The Oracle mode of OceanBase Database supports the following partitioned tables:
...
* [Modify a partition rule](300.modify-partition-rules-of-oracle-mode.md)
