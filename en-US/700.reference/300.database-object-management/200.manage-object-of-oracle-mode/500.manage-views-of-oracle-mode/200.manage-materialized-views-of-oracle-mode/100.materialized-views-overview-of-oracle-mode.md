...
* When you delete a materialized view, it does not go to the recycle bin. However, when you execute the `drop database` statement, the database goes to the recycle bin.
