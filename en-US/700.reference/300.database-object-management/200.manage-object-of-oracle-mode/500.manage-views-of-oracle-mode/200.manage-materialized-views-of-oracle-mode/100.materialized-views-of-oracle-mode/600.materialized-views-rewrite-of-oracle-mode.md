...
* A materialized view eligible for query rewriting must meet the following requirements:
  ...
  * The `ENABLE QUERY REWRITE` clause was specified for the materialized view when it was created.
    ...
    <main id="notice" type='notice'>
      <h4>Notice</h4>
      <p>In the Oracle mode of OceanBase Database, you must specify the refresh method by using the <code>refresh_clause</code> clause for a materialized view to support automatic SQL query rewrite. </p>
    </main>
