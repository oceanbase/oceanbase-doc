...
|-------------|----------|----------|
| sequence$$  | in64_t   | An auto-increment column that serves as the primary key of the materialized view log (mlog).<main id="notice" type='explain'><h4>Note</h4><p>The primary key of mlog consists of the primary key of the regular table, all partition keys (if any), and the auto-increment column <code>sequence$$</code>. These columns together form a composite primary key. </p></main>|
