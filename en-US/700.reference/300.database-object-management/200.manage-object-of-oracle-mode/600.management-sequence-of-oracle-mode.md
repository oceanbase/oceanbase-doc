...
In OceanBase Database, a sequence is a database object of Oracle tenants. You can use it to generate unique values. It is useful when a table needs a unique column as the primary key.
