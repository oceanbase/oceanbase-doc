...
Manual partition splitting involves splitting partitions in an existing partitioned table. OceanBase Database supports manual execution of partition splitting commands using Oracle-compatible syntax, enabling you to divide an existing partition into multiple partitions.
