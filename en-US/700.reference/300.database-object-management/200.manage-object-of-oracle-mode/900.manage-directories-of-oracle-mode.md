...
The Oracle mode of OceanBase Database supports mapping a folder on a shared file system (NFS) to a database directory object. Directory objects are mainly used in the `UTL_FILE` system package.
