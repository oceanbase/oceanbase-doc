...
* To create a private synonym in the current database or schema, you must have the `CREATE SYNONYM` privilege.

* To create a private synonym in a non-current database or schema, you must have the `CREATE ANY SYNONYM` privilege.
...
For more information about the `CREATE SYNONYM` statement, see SQL reference (Oracle-compatible mode).
...
For more information about the `DROP SYNONYM` statement, see SQL reference (Oracle-compatible mode).
