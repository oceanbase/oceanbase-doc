...
* `append_only`: specifies that `INSERT` operations are the only allowed operations for the table. No other DML or DDL operations that would modify existing data storage can be performed. For more information, see [Limitations](#limitations) at the end of this topic.
