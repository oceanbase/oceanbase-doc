...
* `append_only`：This value specifies that `INSERT` operations are the only allowed operations for the table. No other DML or DDL operations that would modify existing data storage can be performed. For more information, see **Update model limitations** at the end of this topic.
