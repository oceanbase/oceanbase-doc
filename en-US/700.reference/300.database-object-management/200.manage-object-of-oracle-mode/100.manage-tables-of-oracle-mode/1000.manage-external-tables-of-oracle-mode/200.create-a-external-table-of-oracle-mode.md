...
1. On the OBServer node, the tenant administrator connects to the Oracle-compatible tenant of the database cluster by using a local Unix socket.
...
* [About external tables](../1000.manage-external-tables-of-oracle-mode/100.about-external-tables-of-oracle-mode.md)
