...
|Parquet physical type| Parquet logical type| Hive data type| Data type under Oracle-compatible tenant| Remarks|
|--------------|-----------------|------------|----------------|------------------|
...
|ORC type|Hive data type|Data type under Oracle-compatible tenant|
|----|-----|-----|
