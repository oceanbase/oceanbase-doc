...
After a table is created, OceanBase Database allows you to add or drop the primary key and foreign key of the table. For more information about how to change the primary key and foreign key, see [Define the constraint type for a column](../100.manage-tables-of-oracle-mode/400.define-the-constraint-type-for-a-column-of-oracle-mode.md).
