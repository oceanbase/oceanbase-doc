...
A table group is a logical concept that represents a collection of tables. By default, data in different tables is randomly distributed with no relationship between them. By defining a table group, you can control the physical proximity of a group of tables.
