...
* `OBJECT_ID`: the object ID. If the table is a non-partitioned table, the value is the ID of the table. If the table is a partitioned table, this column shows the ID of each partition in the table.
