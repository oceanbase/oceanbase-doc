...
|slug|partition-splitting-overview-mysql-compatible-mode|
...
OceanBase Database in MySQL-compatible mode supports the following types of partition splitting:
