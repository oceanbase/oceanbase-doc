...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>Columnstore tables in OceanBase Database support automatic partition splitting starting from V4.6.0. </p>
</main>
...
#### Create an automatic partitioned columnstore table

1. Create an automatic partitioned columnstore table `test1_cg1` without specifying a pre-partitioning key and with a split threshold of 10 GB.
...
2. Create an automatic partitioned columnstore table `test1_cg2` without specifying a pre-partitioning key and with a split threshold of 10 GB.
