...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>In this example, the physical partition identifier to access is <code>p0sp0</code>, which is not the name of the sub-partition. For template-based sub-partitioned tables, the naming convention for sub-partitions is <code>($part_name)s($subpart_name)</code>, such as <code>p0ssp0</code>.</p>
</main>
