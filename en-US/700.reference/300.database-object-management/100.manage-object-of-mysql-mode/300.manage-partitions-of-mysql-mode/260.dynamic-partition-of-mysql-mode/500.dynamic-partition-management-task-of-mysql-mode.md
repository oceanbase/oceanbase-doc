...
`MANAGE_DYNAMIC_PARTITION` has two parameters: `precreate_time` and `time_unit`. For more information, see [MANAGE_DYNAMIC_PARTITION](../../../../600.pl-reference/200.pl-mysql/1000.pl-system-package-mysql/13200.dbms_partition-mysql/200.manage_dynamic_partition-of-mysql-mode.md).
...
The [oceanbase.DBA_OB_TENANT_EVENT_HISTORY](../../../../700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/12200.o-dba_ob_tenant_event_history-of-mysql-mode.md) view records the execution history of dynamic partition management tasks for the current tenant, including both successful and failed executions with their table IDs:
