...
The MySQL-compatible mode of OceanBase Database allows you to change the partitioning type of a partitioned table. You can change the partitioning type of a partitioned table to any other type.

In the MySQL-compatible mode of OceanBase Database, you can also change the partitioning method of a table. The following table describes the support for the change of the partitioning method.
