...
<main id="notice" type='notice'>
    ...
    <ul>
    <li>
    <p>In the MySQL-compatible mode of OceanBase Database, if the keyword of an index is not specified, <code>LOCAL</code> is used as the keyword by default. In this case, the index is created as a local index. </p>
    </li>
    <li>
