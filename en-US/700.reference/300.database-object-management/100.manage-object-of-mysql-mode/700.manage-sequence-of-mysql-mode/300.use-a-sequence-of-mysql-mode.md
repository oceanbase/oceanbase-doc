...
To prevent sequence cache expiration issues, OceanBase Database introduced the `ALTER SYSTEM FLUSH SEQUENCE CACHE` statement in V4.4.1 to proactively clear the sequence cache for quick recovery when issues occur. For more information, see [ALTER SYSTEM FLUSH SEQUENCE CACHE](../../../500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/1450.alter-system-flush-sequence-cache-of-mysql-mode.md).
