...
* You can use a DBLink to access the following types of data in the MySQL mode of OceanBase Database:
  ...
  * Other data types: ENUM and SET
  ...
  For more information about the data types, see [Overview](../../../500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/100.basic-elements-of-mysql-mode/100.data-type-of-mysql-mode/100.data-type-overview-of-mysql-mode.md).
