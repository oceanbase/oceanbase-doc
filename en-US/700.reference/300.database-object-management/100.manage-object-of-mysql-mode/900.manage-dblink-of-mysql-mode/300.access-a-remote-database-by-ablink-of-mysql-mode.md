...
* Currently, MySQL-compatible tenants of OceanBase Database cannot read data from a MySQL database through DBLink. Similarly, MySQL databases cannot read data from MySQL-compatible tenants of OceanBase Database through DBLink.

* You can use a DBLink to access the following types of data in the MySQL-compatible mode of OceanBase Database:
