...
In OceanBase Database in MySQL-compatible mode, you can create a DBLink between two MySQL-compatible tenants in the same cluster or in different clusters.

## Limitations

* You cannot create a DBLink between a MySQL-compatible tenant of OceanBase Database and a MySQL database.
* At present, the DBLink write and reverse link features are not supported in MySQL-compatible mode.
...
To access a remote OceanBase database, you can create a DBLink from a MySQL-compatible tenant in your local OceanBase database to a MySQL-compatible tenant in the remote OceanBase database.
...
The SQL syntax for creating a DBLink between two MySQL-compatible tenants of OceanBase Database is as follows:
...
* `database_name`: the database name of the remote MySQL-compatible tenant. When you use the DBLink to read data, this database is accessed by default. To use the DBLink to access another database, specify the database in the SQL statement.
