...
|slug|delete-indexes-mysql-compatible-mode|
...
For more information about indexes supported by the MySQL-compatible mode of OceanBase Database, see the following topics:
