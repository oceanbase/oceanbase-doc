...
5. Query the `DBA_INDEX_USAGE` view.
    ...
    3. Query the `DBA_INDEX_USAGE` view again.
       ...
       **The query result shows the following information:**
       ...
       The `TOTAL_ACCESS_COUNT` column indicates that during the `SELECT` operation, the `idx1_test_tbl1` index in the `test_db` database was accessed 1 time at `2024-01-24 11:09:30.928232`.
       ...
       For more information about the columns in the `DBA_INDEX_USAGE` view, see [DBA_INDEX_USAGE](../../../700.system-views/400.system-view-of-mysql-mode/200.dictionary-view-of-mysql-mode/5300.o-dba_index_usage-of-mysql-mode.md).
