...
7. Drop the `mv_test_tbl1` materialized view.
    ...
    <main id="notice" type='notice'>
      <h4>Notice</h4>
      <p>If materialized view logs are created on the base table (ordinary table or materialized view) of the materialized view, you must drop the materialized view logs on the base table before you drop the base table. Otherwise, an error is returned. </p>
    </main>
