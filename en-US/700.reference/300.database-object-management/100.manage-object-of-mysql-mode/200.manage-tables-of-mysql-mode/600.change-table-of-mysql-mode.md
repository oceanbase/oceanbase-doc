...
After a table is successfully created, you can use the `ALTER TABLE` statement to change the table.
...
For more information about the conversion rules of column types in MySQL-compatible mode of OceanBase Database, see [Change the column type](../../../500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/700.ddl-function-of-mysql-mode/900.column-type-change-rule-of-mysql-mode.md).
