...
You can create unique, normal, and full-text indexes on a table and modify index attributes.
...
* Add a full-text index
  ...
  2. Add a full-text index named `ft_idx1_test` to the `test` table and specify the tokenizer as `BENG`.
