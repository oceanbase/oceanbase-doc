...
* `col_name col_type [AS (metadata$filecol{N})]`: defines a column. `AS (metadata$filecol{N})` specifies a column mapping.
  ...
  The column types supported by an external table are the same as those supported by a normal table. For more information about the data types supported in MySQL mode of OceanBase Database, see [Overview of data types](../../../../500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/100.basic-elements-of-mysql-mode/100.data-type-of-mysql-mode/100.data-type-overview-of-mysql-mode.md).
