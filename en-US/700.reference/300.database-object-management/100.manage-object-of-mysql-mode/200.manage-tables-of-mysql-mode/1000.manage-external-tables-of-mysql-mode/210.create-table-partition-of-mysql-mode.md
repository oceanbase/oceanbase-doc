...
## Automatically create external table partitions
...
## Manually create external table partitions

The syntax for creating an external table with manually specified partitions is as follows:
...
You can execute the following statement to create a CSV-type external table partition:
...
You can execute the following statement to create a PARQUET-type external table partition:
...
You can execute the following statement to create an ORC-type external table partition:
