...
Currently, heap-organized tables in OceanBase Database do not support the following DDL operations:

* Primary key constraint operations
* Modifying a column to become a primary key
* Reducing the length of a primary key column
* Adding primary key columns
* Modifying a primary key to an auto-increment column
* Deleting primary key columns
* Partition splitting
