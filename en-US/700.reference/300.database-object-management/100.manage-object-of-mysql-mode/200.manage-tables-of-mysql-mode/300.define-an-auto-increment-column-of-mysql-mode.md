...
|---------------------------|----------------------------------------------------------|
| auto_increment_cache_size | The cache size. Value range: \[1, 100000000\]. Default value: `1000000`. This variable takes effect globally. <main id="notice" type='explain'><h4>Note</h4><p>OceanBase Database also supports the <code>auto_increment_cache_size</code> variable at the table level.</p></main>|
