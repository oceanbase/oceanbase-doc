...
* The OCP-Agent service is deployed on each OBServer node. It interacts with the OCP Express server and performs O&M operations sent by the OCP Express server. 
