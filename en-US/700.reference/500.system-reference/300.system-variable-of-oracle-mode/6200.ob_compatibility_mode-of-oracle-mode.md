...
For information about the `CREATE TENANT` statement, see [CREATE TENANT](../../../600.manage/200.tenant-management/600.common-tenant-operations/200.manage-create-tenant.md).
