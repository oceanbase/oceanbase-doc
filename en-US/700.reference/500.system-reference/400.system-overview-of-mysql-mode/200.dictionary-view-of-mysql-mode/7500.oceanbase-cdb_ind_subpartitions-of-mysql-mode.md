...
| GLOBAL_STATS | varchar(3) | NO | <li> Indicates whether statistics for the partition were collected. If yes, the value is YES.   <li> If no, the value is NO. <br>At present, this field is not supported and is NULL by default. |
