...
<main id="notice" type='explain'>
    <h4>Note</h4>
    <p>This error code is modified since OceanBase Database V4.0.0. Specifically, the error message is changed from <code>ERROR 5307 (HY000): Scheduler thread number is not enough</code> to <code>ERROR 5307 (HY000): Not enough thread resource to execute the query. Require setting parallel_servers_target to a value no less than %ld for this query</code>. </p>
  </main>
