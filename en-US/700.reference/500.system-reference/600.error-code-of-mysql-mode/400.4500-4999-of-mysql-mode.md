...
[Table creation failure (error code 4624)](https://www.oceanbase.com/knowledge-base/oceanbase-database-20000000181?back=kb) -->
...
[Column deletion failure (error code 4694)](https://www.oceanbase.com/knowledge-base/oceanbase-database-20000000117?back=kb) -->
...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>This error code is modified since OceanBase Database V4.0.0. Specifically, this error message is changed from <code>ERROR 4719 (HY000) : partition has been dropped</code> to <code>ERROR 4719 (HY000): log stream does not exist</code>. </p>
</main>
