...
A tenant is a logical concept that represents a resource allocation unit in OceanBase Database. It is the basis for the management of database objects and resources. It is critical for system O&M, especially for the O&M of cloud databases. Log in to OceanBase Cloud Platform (OCP) Express. In the left-side navigation pane, click **Tenant Management** to go to the tenant list page. By default, the information about tenants that you have the privilege to view is displayed.
