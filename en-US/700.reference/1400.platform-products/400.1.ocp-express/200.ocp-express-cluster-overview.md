...
After you log in to the OceanBase Cloud Platform (OCP) console, the **Cluster Overview** page automatically appears. To view the overview data of a cluster, you must have the management permission or read-only permission on the cluster.
