...
* For more information about how to call the API operation by using obshell-sdk-python, see [Obtain the information about a task](../100.python/2000.get-dag-detail-of-python.md).
