...
* For more information about how to call the API operation by using obshell-sdk-python, see [Query unfinished OceanBase cluster tasks](../100.python/2500.get-oceanbase-unfinish-task-of-python.md).
