...
* For more information about how to call the API operation by using obshell-sdk-python, see [Perform an agent upgrade check](../100.python/1000.agent-upgrade-check-of-python.md).
