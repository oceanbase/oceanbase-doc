...
* For more information about how to call the API operation by using obshell-sdk-python, see [Query the last O&M task of an obshell node](../100.python/2700.get-agent-last-o-m-task-of-python.md).
