...
* For more information about how to call the API operation by using obshell-sdk-python, see [Initialize a cluster](../100.python/600.init-cluster-of-python.md).
