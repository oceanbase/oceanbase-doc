...
* For more information about how to call the API operation by using obshell-sdk-python, see [Query the status of a node](../100.python/1600.get-status-of-python.md).
