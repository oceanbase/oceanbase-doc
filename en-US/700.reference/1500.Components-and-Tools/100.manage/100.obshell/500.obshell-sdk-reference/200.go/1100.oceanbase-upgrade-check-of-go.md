...
* For more information about how to call the API operation by using obshell-sdk-python, see [Perform an OceanBase Database upgrade check](../100.python/1100.oceanbase-upgrade-check-of-python.md).
