...
* For more information about how to call the API operation by using obshell-sdk-python, see [Remove a node before cluster initialization](../100.python/400.delete-node-of-python.md).
