...
* For more information about how to call the API operation by using obshell-sdk-python, see [Upgrade OceanBase Database](../100.python/1300.upgrade-oceanbase-of-python.md).
