...
* For more information about how to call the API operation by using obshell-sdk-python, see [Set server-level configurations](../100.python/500.set-server-level-of-python.md).
