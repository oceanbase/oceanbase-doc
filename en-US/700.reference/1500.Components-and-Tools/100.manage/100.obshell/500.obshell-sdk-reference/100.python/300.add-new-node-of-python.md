...
* For more information about how to call the API operation by using obshell-sdk-go, see [Add a node before cluster initialization](../200.go/300.add-new-node-of-go.md).
