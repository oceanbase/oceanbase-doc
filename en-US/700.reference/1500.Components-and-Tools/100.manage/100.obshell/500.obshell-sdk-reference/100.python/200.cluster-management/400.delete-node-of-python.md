...
* For more information about how to call the API operation by using obshell-sdk-go, see [Remove a node before cluster initialization](../200.go/400.delete-node-of-go.md).
