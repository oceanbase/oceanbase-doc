...
* For more information about how to call the API operation by using obshell-sdk-go, see [Obtain the information about a task](../200.go/2000.get-dag-detail-of-go.md).
