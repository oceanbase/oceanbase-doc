...
For more information about the API for setting the password of a node, see [Set the password of a node](../../../400.obshell-api-reference/100.obshell-management/1500.set-node-password.md).