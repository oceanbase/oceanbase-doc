...
* For more information about how to call the API method by using obshell-sdk-go, see [Delete a tenant replica](../../200.go/500.tenant-management/1200.delete-tenant-replica-of-go.md).