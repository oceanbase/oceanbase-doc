...
* For more information about how to call the API operation by using obshell-sdk-go, see [Query the last O&M task in an OceanBase cluster](../200.go/2600.get-oceanbase-last-o-m-task-of-go.md).
