...
For more information about how to call the API in the CLI, see [Create a tenant](../../400.obshell-api-reference/500.tenant-management/100.create-tenant-of-api.md). This API creates an asynchronous O&M task. For more information about how to query the task progress, see [Get task details](../../400.obshell-api-reference/1000.task-management/2000.get-dag-detail.md). Wait for the task to complete, and then the tenant is created.
