...
For more information about how to call the corresponding API operation by using obshell-sdk-python, see [Upload an RPM package](../../500.obshell-sdk-reference/100.python/900.upload-rpm-of-python.md).
...
For more information about how to call the corresponding API operation by using obshell-sdk-go, see [Upload an RPM package](../../500.obshell-sdk-reference/200.go/900.upload-rpm-of-go.md).
...
For more information about how to call the corresponding API operation by using obshell-sdk-python, see [Perform an agent upgrade check](../../500.obshell-sdk-reference/100.python/1000.agent-upgrade-check-of-python.md).
...
For more information about how to call the corresponding API operation by using obshell-sdk-go, see [Perform an agent upgrade check](../../500.obshell-sdk-reference/200.go/1000.agent-upgrade-check-of-go.md).
...
For more information about how to call the corresponding API operation by using obshell-sdk-python, see [Upgrade agents](../../500.obshell-sdk-reference/100.python/1200.upgrade-agent-of-python.md).
...
For more information about how to call the corresponding API operation by using obshell-sdk-go, see [Upgrade agents](../../500.obshell-sdk-reference/200.go/1200.upgrade-agent-of-go.md).
