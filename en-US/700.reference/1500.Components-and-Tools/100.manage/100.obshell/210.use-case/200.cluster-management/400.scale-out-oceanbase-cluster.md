...
For more information about how to call the corresponding API operation by using obshell-sdk-python, see [Scale out a cluster](../../500.obshell-sdk-reference/100.python/1400.scale-out-of-python.md).
...
For more information about how to call the corresponding API operation by using obshell-sdk-go, see [Scale out a cluster](../../500.obshell-sdk-reference/200.go/1400.scale-out-of-go.md).
