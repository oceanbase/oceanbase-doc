...
| -P/--plus_archive   | No  | 无 | 无 | Specifies whether to back up archive logs during data backup. No value needs to be specified. If this option is specified, a complete data set containing archive logs will be generated in the final backup directory. |
