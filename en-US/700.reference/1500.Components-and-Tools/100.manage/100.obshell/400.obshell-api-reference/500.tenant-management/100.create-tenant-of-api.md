...
| charset | string | No | 无 | The character set of the tenant. |
| cllation | string | No | 无 | The character sequence of the tenant. |
| read_only | bool | No | false | Specifies whether the tenant is read-only. |
| comment | string | No | 无 | Information about the tenant. |
