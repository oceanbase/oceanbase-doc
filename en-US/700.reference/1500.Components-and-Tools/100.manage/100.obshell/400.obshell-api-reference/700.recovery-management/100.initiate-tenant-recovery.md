...
| kms_encrypt_info | string | No | 无 | The key management information. If the data is not encrypted or the key management service can be accessed when the data is restored, this parameter can be omitted. |
