...
| error | ApiError | The error generated during the request, which contains the following information:<ul><li>`code`: the error code. </li><li>`message`: the error message. </li><li>`subErrors`: the sub-errors. </li></ul> |
