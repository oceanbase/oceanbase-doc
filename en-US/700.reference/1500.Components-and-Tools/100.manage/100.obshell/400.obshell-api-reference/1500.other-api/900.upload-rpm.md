...
* For more information about how to call the API operation by using obshell-sdk-python, see [Upload an RPM package](../../500.obshell-sdk-reference/100.python/900.upload-rpm-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Upload an RPM package](../../500.obshell-sdk-reference/200.go/900.upload-rpm-of-go.md).
