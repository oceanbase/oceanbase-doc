...
| rootPwd | String | No |  | The password of the cluster. You must encrypt the password. For more information, see [Authentication based on public-key encryption](../../../../1500.command-line-tools/100.manage/100.obshell/400.obshell-api-reference/200.public-key-encryption-authentication.md).  |
