...
* For more information about how to call the API operation by using obshell-sdk-python, see [Set server-level configurations](../../500.obshell-sdk-reference/100.python/500.set-server-level-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Set server-level configurations](../../500.obshell-sdk-reference/200.go/500.set-server-level-of-go.md).
