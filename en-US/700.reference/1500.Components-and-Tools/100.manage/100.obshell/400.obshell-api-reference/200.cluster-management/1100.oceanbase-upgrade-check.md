...
* For more information about how to call the API operation by using obshell-sdk-python, see [Perform an OceanBase Database upgrade check](../../500.obshell-sdk-reference/100.python/1100.oceanbase-upgrade-check-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Perform an OceanBase Database upgrade check](../../500.obshell-sdk-reference/200.go/1100.oceanbase-upgrade-check-of-go.md).
