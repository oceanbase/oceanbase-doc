...
* For more information about how to call the API operation by using obshell-sdk-python, see [Upgrade OceanBase Database](../../500.obshell-sdk-reference/100.python/1300.upgrade-oceanbase-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Upgrade OceanBase Database](../../500.obshell-sdk-reference/200.go/1300.upgrade-oceanbase-of-go.md).
