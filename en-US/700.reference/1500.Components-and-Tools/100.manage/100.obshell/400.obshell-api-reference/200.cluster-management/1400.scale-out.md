...
| --- | --- | --- | --- | --- |
| agentInfo | AgentInfo | Yes | {<br>"ip": "10.10.10.4",<br>"port": 2886<br>}  | The agent information of the OBServer node that you want to add to the cluster. <ul><li>`ip`: the IP address of obshell. </li><li>`port`: the port number of obshell. </li></ul> |
| obConfigs | map[string]string | Yes | {<br>"mysql_port": "2881",<br>"rpc_port": "2882",<br>"memory_limit": "16G",<br>"system_memory": "8G"<br>} | The configuration of the OBServer node that you want to add to the cluster. |
...
* For more information about how to call the API operation by using obshell-sdk-python, see [Scale out a cluster](../../500.obshell-sdk-reference/100.python/200.cluster-management/1400.scale-out-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Scale out a cluster](../../500.obshell-sdk-reference/200.go/200.cluster-management/1400.scale-out-of-go.md).
