...
* For more information about how to call the API operation by using obshell-sdk-python, see [Remove a node before cluster initialization](../../500.obshell-sdk-reference/100.python/400.delete-node-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Remove a node before cluster initialization](../../500.obshell-sdk-reference/200.go/400.delete-node-of-go.md).
