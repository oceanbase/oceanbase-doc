...
* For more information about how to call the API operation by using obshell-sdk-python, see [Stop a cluster](../../500.obshell-sdk-reference/100.python/800.stop-cluster-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Stop a cluster](../../500.obshell-sdk-reference/200.go/800.stop-cluster-of-go.md).
