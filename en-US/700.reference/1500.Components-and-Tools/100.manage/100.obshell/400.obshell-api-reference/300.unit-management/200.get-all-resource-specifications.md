...
| error | ApiError | The error information generated during the request, which contains the following fields:<ul><li><code>code</code>: the error code.</li><li><code>message</code>: the error message.</li><li><code>subErrors</code>: the sub-error information.</li></ul> |
