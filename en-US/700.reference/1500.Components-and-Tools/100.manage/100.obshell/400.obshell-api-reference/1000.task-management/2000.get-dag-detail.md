...
* For more information about how to call the API operation by using obshell-sdk-python, see [Obtain the information about a task](../../500.obshell-sdk-reference/100.python/2000.get-dag-detail-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see Obtain the information about a task](../500.obshell-sdk-reference/200.go/2000.get-dag-detail-of-go.md).
