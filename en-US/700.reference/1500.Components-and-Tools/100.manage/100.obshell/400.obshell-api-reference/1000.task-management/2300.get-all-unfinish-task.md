...
* For more information about how to call the API operation by using obshell-sdk-python, see [Query all unfinished tasks](../../500.obshell-sdk-reference/100.python/2300.get-all-unfinish-task-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Query all unfinished tasks](../../500.obshell-sdk-reference/200.go/2300.get-all-unfinish-task-of-go.md).
