...
* For more information about how to call the API operation by using obshell-sdk-python, see [Query unfinished agent tasks](../../500.obshell-sdk-reference/100.python/2400.get-agent-unfinish-task-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Query unfinished agent tasks](../../500.obshell-sdk-reference/200.go/2400.get-agent-unfinish-task-of-go.md).
