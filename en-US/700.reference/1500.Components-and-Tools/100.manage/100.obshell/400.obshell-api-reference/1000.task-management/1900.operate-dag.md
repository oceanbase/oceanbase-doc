...
* For more information about how to call the API operation by using obshell-sdk-python, see [Operate a task](../../500.obshell-sdk-reference/100.python/1900.operate-dag-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Operate a task](../../500.obshell-sdk-reference/200.go/1900.operate-dag-of-go.md).
