...
* For more information about how to call the API operation by using obshell-sdk-python, see [Obtain the information about a node](../../500.obshell-sdk-reference/100.python/2100.get-node-detail-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Obtain the information about a node](../../500.obshell-sdk-reference/200.go/2100.get-node-detail-of-go.md).
