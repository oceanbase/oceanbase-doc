...
* For more information about how to call the API operation by using obshell-sdk-python, see [Upgrade agents](../../500.obshell-sdk-reference/100.python/1200.upgrade-agent-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Upgrade agents](../../500.obshell-sdk-reference/200.go/1200.upgrade-agent-of-go.md).
