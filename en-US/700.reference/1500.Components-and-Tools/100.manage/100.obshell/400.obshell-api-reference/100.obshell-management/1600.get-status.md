...
* For more information about how to call the API operation by using obshell-sdk-python, see [Query the status of a node](../../500.obshell-sdk-reference/100.python/1600.get-status-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Query the status of a node](../../500.obshell-sdk-reference/200.go/1600.get-status-of-go.md).
