...
* For more information about how to call the API operation by using obshell-sdk-python, see [Perform an agent upgrade check](../../500.obshell-sdk-reference/100.python/1000.agent-upgrade-check-of-python.md).

* For more information about how to call the API operation by using obshell-sdk-go, see [Perform an agent upgrade check](../../500.obshell-sdk-reference/200.go/1000.agent-upgrade-check-of-go.md).
