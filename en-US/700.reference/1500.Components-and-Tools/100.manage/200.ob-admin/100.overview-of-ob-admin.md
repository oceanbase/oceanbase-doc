...
2. Compile ob_admin in the following modes:
    ...
    * Release mode
      ...
      By default, after you compile `ob_admin`, you can find the compiled files in the `RELEASE_BUILD_DIR/tools/ob_admin/src/ob_admin` directory. `RELEASE_BUILD_DIR` indicates the compilation directory, which is `build_release` in this example.
