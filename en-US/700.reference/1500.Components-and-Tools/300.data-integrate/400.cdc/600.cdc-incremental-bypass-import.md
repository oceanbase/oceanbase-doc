...
3. Log in to OceanBase Database, and import data in incremental direct load mode.
   ...
   For more information, see [Import data in direct load mode by using the INSERT INTO SELECT statement](../../../../620.obap/300.obap-data-collection/300.obap-import-data/20.bypass-import/200.full-bypass-import.md).
