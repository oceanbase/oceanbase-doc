...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>obcdc does not support outputting virtual generated columns before V4.2.5.0.</p>
</main>
...
* The generated column rule involves system functions, such as `FROM_TZ` and `NULLIF`.

* The generated column uses JSON functions and the `JSON PARTIAL UPDATE` feature.
...
* **Incremental baseline import**: obcdc does not support output.
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p>Starting from OceanBase Database V4.5.0, incremental import uses the incremental baseline import mode by default.</p>
  </main>
