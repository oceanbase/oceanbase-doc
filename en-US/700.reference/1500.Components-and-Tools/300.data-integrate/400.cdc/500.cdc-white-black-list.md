...
<main id="notice" type='explain'>
  ...
  <li>Regular expressions based on fnmatch are supported. By default, matching rules are case-insensitive. If you specify <code>enable_oracle_mode_match_case_sensitive=1</code>, matching rules for tenants in Oracle-compatible mode are case-sensitive. </li>
  </ul>
</main>
