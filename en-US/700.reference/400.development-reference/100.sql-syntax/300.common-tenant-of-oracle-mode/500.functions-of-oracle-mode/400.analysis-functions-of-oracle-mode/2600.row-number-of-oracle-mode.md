...
You can use the `OVER` clause to define a window over the data on which the function operates. For more information, see [Analytic functions](1.window-function-description-of-oracle-mode.md).
