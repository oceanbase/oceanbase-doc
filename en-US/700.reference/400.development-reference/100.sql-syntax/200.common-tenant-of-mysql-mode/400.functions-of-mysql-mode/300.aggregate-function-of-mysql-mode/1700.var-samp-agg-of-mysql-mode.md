...
`VAR_SAMP()` returns the sample variance of the `expr` expression. When the function calculates the sample variance of an expression that contains a value, it returns `NULL`.
