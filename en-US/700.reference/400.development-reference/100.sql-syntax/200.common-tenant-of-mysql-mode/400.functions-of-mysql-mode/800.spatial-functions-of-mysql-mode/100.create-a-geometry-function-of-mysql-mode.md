...
The `ST_GeomFromText()` and `ST_GeometryFromText()` functions take WKT representations and optional spatial reference system identifiers (SRIDs) as arguments and return the corresponding geometric objects. For more information about the WKT format, see [Spatial data formats](../../1.basic-elements-of-mysql-mode/1.data-type-of-mysql-mode/9.spatial-data-type-of-mysql-mode/5.spatial-data-format-of-mysql-mode.md). 
...
The `SST_GeomFromWKB()` and `ST_GeometryCollectionFromWKB()` functions take, as arguments, BLOBs that contains WKB representations and optional SRIDs, and return the corresponding geometric objects. For more information about the WKB format, see [Spatial data formats](../../1.basic-elements-of-mysql-mode/1.data-type-of-mysql-mode/9.spatial-data-type-of-mysql-mode/5.spatial-data-format-of-mysql-mode.md). 
