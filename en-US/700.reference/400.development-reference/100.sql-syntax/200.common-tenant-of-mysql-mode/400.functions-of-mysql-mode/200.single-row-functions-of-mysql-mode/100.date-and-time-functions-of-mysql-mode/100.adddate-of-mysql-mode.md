...
When the first syntax is used, `ADDDATE()` is a synonym of the `DATE_ADD()` function. For more information about the `unit` argument, see [DATE_ADD](../1.date-and-time-functions-of-mysql-mode/9.date-add-of-mysql-mode.md).
