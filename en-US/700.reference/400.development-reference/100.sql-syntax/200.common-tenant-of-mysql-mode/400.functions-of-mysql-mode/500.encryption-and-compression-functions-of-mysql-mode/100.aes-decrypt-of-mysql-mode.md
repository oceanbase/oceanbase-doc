...
For more information about the `init_vector` argument, see [AES_ENCRYPT](../5.encryption-and-compression-functions-of-mysql-mode/2.aes-encrypt-of-mysql-mode.md).
