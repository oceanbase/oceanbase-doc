...
You can also obtain the information about a stored procedure from the `INFORMATION_SCHEMA ROUTINES` table. For more information, see [INFORMATION_SCHEMA PARAMETERS](../8.information-schema-dictionary-view-mysql/1.information-schema-parameters-mysql.md).
