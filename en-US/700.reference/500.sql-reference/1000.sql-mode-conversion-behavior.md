|description|Describes the differences in data type conversion behavior in MySQL-compatible tenants in strict mode.|
|---|---|
...
# Data type conversion behavior in MySQL-compatible tenants in strict mode
