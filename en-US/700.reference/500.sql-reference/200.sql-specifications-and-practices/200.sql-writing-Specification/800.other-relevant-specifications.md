...
* It is not recommended to write SQL statements with multiple layers of subquery nesting; it is recommended to rewrite them in the format of table sequential joins.
