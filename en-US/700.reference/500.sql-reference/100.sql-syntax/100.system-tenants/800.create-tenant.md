...
| COLLATE                  | The collation for the tenant. For more information about collations, see [Collations](../200.common-tenant-of-mysql-mode/100.basic-elements-of-mysql-mode/300.character-set-and-collation-of-mysql-mode/300.collation-of-mysql-mode.md) in the "User tenants (MySQL mode)" chapter and **Character sets and collations** in the "User tenants (Oracle mode)" chapter.  |
