...
* You must create an empty standby tenant from the sys tenant of the cluster where the standby tenant resides, and the standby tenant must be in read-only mode.
