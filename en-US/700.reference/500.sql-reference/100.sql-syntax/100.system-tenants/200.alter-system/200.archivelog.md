...
You can use the `ALTER SYSTEM NOARCHIVELOG` statement to disable the archive mode. For more information about this statement, see [NOARCHIVELOG](1600.noarchivelog.md).
