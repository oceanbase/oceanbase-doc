...
You can use the `ALTER SYSTEM NOARCHIVELOG` statement to disable the archive mode. For more information about this statement, see NOARCHIVELOG <temp-hide-link>.
...
* SET LOG_ARCHIVE_DEST <temp-hide-link>

* NOARCHIVELOG <temp-hide-link>
