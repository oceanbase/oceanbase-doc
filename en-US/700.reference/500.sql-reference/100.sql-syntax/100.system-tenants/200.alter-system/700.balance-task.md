...
| opt_balance_task_type | The type of task to be cleared: <ul><li> `ALL`: all tasks. </li>   <li> `AUTO`: automatically generated tasks.</li>   <li> `MANUAL`: tasks initiated manually by users.</li></ul>    |
