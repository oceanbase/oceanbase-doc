...
You can use this statement to cancel a balance job being executed. For example, you can cancel a balance job that does not meet your requirements. You can also cancel an ongoing balance job that has delayed a partition transfer task that you have initiated.
