...
|--------------|------------|
| tenant_name  | The name of the tenant for which you want to pause, resume, or cancel the task. This parameter is optional but required when executed under the system tenant.|
