...
| tenant_name | The tenant on which the compaction is to be performed.  |
| TABLET_ID | The partition on which the compaction is to be performed.  |
| SERVER | The server on which the compaction is to be performed.  |
