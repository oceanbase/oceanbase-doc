...
* Although you can use this statement to cancel all ongoing partition transfer tasks in a tenant, this operation is not atomic. In other words, the tasks in the `DOING` state cannot be canceled.
