...
| piece_switch_interval | The interval for generating a new log piece. Value range: \[1d, 7d\]. If you do not specify this parameter, the default value `1d` is used. For more information about pieces, see [Overview of log archiving](../../../../../600.manage/600.backup-and-recovery/300.log-archive/100.overview-of-log-archive.md).                                                                        |
