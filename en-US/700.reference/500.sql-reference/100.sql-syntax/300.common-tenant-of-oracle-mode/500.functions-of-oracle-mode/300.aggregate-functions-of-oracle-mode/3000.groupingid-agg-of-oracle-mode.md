...
- When an expression is included in the grouping set, the value returned by `GROUPING_ID` increases; if not included, it remains unchanged.
...
|-----------------|----------------------|
|`attributeList`  | The list of expressions for which to calculate the combination value.|
