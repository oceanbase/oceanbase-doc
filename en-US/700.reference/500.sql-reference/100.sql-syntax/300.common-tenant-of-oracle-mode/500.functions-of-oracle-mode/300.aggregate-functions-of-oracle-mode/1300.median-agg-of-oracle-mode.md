...
|------|-----------------------------------------------------------------------------------------|
| expr | The name of the array in which the median is required. The argument is of a numeric data type or a data type that can be implicitly converted to a numeric data type.  |
