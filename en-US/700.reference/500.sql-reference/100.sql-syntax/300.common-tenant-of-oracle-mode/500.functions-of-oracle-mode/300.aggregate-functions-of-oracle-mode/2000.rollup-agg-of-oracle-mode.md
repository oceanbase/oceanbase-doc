...
1. Group the data from right to left based on the specified columns.

2. Calculate subtotals for each group and then calculate the grand total for all groups.

3. Sort the results according to `ORDER BY col1 (, col2, col3, col4 ...)`.
