...
This function is used to convert columns into rows and concatenate the values of the metric columns. It can be used as an aggregate or analytic function.
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <ul>
    <li>When used as an analytic function, the <code>OVER</code> clause must be used to define the window for calculation. This function partitions the query result set into groups based on one or more expressions in the <code>query_partition_clause</code>.</li>
    <li>When used as an aggregate function, the <code>OVER</code> keyword is not required.
    <ul>
...
| OVER         | Use the <code>OVER</code> clause to define the window for calculation. For more information, see [Analytic Function Description](../400.analysis-functions-of-oracle-mode/100.window-function-description-of-oracle-mode.md). |
