...
|slug|regr-linear-regression-functions-oracle-mode|
...
This is a linear regression function that fits a regression line using the ordinary least squares method to a set of pairs of numbers. It can be used as either an aggregate or an analytic function.
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <ul>
    <li>When used as an analytic function, the <code>OVER</code> clause must be used to define the window for the calculation. It performs the calculation on a set of rows and returns multiple values.</li>
    <li>When used as an aggregate function, it performs the calculation on a set of rows and returns a single value. In this case, the <code>OVER</code> clause is not needed.</li>
    </ul>
  </main>
...
| OVER           | Use the `OVER` clause to define the window for calculation. For more information, see [Window Function Description](../400.analysis-functions-of-oracle-mode/100.window-function-description-of-oracle-mode.md).                                                                                                                                                                                                                                         |

  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p><code>REGR_SXX</code>, <code>REGR_SYY</code>, and <code>REGR_SXY</code> are auxiliary functions used to calculate various diagnostic statistics.</p>
  </main>
