...
This function returns the date value of the next occurrence of the specified `week` (weekday) value in the week of the `date` value.
...
The following example returns the date values for each weekday in the next week.
