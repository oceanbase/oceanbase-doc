...
|-------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| \[+\|-\] years-months                                                                           | A string of `CHAR`, `VARCHAR2`, `NCHAR`, or `NVARCHAR2` data type that conforms to this parameter format. <ul><li> `years` specifies the number of years, which is an integer in the range of \[0,999999999\].   </li><li> `months` specifies the number of months, which is an integer in the range of \[0,11\].</li></ul>    |
