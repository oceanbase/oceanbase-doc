...
|slug|xmlcast-function-oracle-mode|
...
| Field | Description |
| --- | --- |
| value_expression | Specifies the content to be parsed must be a valid XML fragment. |
...
Returns a `CHAR`, `VARCHAR`, `VARCHAR2`, `NUMBER`, `FLOAT`, `BLOB`, or `CLOB` data type, or any datetime data type.
