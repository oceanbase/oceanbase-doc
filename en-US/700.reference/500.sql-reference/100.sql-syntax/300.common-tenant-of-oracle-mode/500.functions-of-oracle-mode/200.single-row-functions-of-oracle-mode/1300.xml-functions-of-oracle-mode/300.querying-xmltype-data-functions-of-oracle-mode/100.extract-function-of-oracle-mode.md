...
This function extracts an XML fragment based on an XPath, and returns a concatenated string of all nodes matched by the XPath.
...
| XPath_string | The XPath to search for nodes. |
