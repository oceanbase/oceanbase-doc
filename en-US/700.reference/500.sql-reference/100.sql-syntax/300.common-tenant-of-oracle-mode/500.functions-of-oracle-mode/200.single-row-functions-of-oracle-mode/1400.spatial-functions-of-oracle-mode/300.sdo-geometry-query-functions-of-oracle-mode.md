...
```sql
-- Create the test table test_spatial_index.
...
```shell
# X, Y, Z, and W are vertex coordinates. V1..V11 are reserved columns for future expansion.

# The ID is the vertex ID, which starts from 1 and increments by 1.
