...
Additionally, `IS JSON` and `IS NOT JSON` are used as SQL conditions in SQL statements to check whether the result of an expression is valid JSON data. For more information, see [Create columns of the JSON data type](../../../../300.basic-elements-of-oracle-mode/100.built-in-data-types-of-oracle-mode/1000.json-formatted-data-type-oracle-mode/200.create-json-data-type-columns-of-oracle-mode.md).
