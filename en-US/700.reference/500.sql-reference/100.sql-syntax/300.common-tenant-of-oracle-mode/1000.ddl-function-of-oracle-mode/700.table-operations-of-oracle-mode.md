...
|slug|table-operations-oracle-compatible-mode|

# Table operations

In the Oracle-compatible mode of OceanBase Database, you can change the row format, block size, and name of a table.
