...
This topic describes how to perform simple index operations in Oracle-compatible mode of OceanBase Database, including creating an index, querying indexes, dropping an index, and renaming an index.
