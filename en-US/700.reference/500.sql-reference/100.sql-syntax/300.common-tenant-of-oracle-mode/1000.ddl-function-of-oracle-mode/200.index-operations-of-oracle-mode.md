...
* USER_INDEXES: displays indexes on all tables owned by the current user. For more information, see [USER_INDEXES](../../../../700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/26100.user_indexes-of-oracle-mode.md).
...
* DBA_INDEXES: displays indexes on all tables in the database. For more information, see [DBA_INDEXES](../../../../700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/8700.dba_indexes-of-oracle-mode.md).
...
* `index_name`: the original name of the index to be renamed.
