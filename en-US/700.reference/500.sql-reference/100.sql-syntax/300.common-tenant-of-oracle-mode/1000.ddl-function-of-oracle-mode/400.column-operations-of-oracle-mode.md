...
In OceanBase Database's Oracle-compatible mode, column operations include adding columns at the end, dropping columns, renaming columns, modifying column types, managing default values, managing constraints, and setting auto-increment values.
...
For more information about column type change rules in Oracle-compatible mode of OceanBase Database, see [Column type change rules](900.column-type-change-rule-of-oracle-mode.md).
...
In Oracle-compatible mode of OceanBase Database, you can add constraints to columns, such as modifying an existing column to an auto-increment column, allowing or disallowing null values in a column, and specifying the uniqueness of a column. This section will guide you through the process.
