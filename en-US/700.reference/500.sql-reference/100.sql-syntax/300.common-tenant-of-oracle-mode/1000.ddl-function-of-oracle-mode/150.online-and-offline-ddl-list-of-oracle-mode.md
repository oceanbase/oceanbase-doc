...
|  Column operation | Drop a column <main id="notice" type='explain'><h4>Note</h4><p>In OceanBase Database V4.3.5 and later, the <code>DROP COLUMN</code> operation is an online DDL operation introduced in BP1 of these versions. </p></main>| Only for metadata modification | N/A | Not supported |
...
| Column operation | Drop a deprecated column | Data volume-related, requires data reorganization  |N/A| Not supported |
|  Columns | Drop a `VIRTUAL` column | Data volume-related, requires data reorganization  |N/A| Not supported |
