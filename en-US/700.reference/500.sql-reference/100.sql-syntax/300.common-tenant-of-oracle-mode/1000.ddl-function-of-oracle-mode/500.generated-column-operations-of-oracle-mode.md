...
|slug|generated-column-operations-oracle-mode|

# Generated column operations

In the Oracle-compatible mode of OceanBase Database, you can add a `VIRTUAL` column and drop a `VIRTUAL` column.
