...
If a query statement contains multiple identical subqueries, you can place the identical subquery in the `WITH CLAUSE` as a common expression and directly reference it in the main query.
...
/*Directly assign column names to w_tbl1*/
