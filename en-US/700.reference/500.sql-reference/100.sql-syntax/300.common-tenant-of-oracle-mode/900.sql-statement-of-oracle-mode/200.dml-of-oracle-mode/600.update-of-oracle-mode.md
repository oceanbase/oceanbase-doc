...
| ref_name         | The variable name.                                                                                                        |
  ...
  <main id="notice" type='notice'>
    <h4>Notice</h4>
    <p>A special subquery refers to a subquery similar to that corresponding to an updatable view. Such subqueries should not contain complex operators (such as <code>GROUP BY</code>, <code>DISTINCT</code>, and <code>WINDOW FUNCTION</code>). </p>
  </main>
