...
You must have the `CREATE USER` system privilege to use the `CREATE USER` statement. For more information about OceanBase Database privileges, see [Privilege types in Oracle-compatible mode](../../../../../../600.manage/500.security-and-permissions/300.access-control/200.user-and-permission/300.permission-of-oracle-mode/000.permission-classification-of-oracle-mode.md).
