...
You can use a proxy user to connect to OceanBase Database on behalf of the target user through OceanBase Command-Line Client (OBClient). The version of OBClient must be V2.2.6 or later. At present, you cannot connect to OceanBase Database by using a Java driver or a C driver.
