...
| OB \| OCI | `OB` indicates that the remote database is an OceanBase database. `OCI` indicates that the remote database is an Oracle database. If neither of the keywords is specified, the remote database is an OceanBase database by default. |
