...
| `EXCHANGE PARTITION partition_name WITH TABLE non_partition_table_name INCLUDING INDEXES WITHOUT VALIDATION` | Specifies a partition to exchange with another table. The `partition_name` parameter specifies the name of the partition in the partitioned table. The `non_partition_table_name` parameter specifies the name of the non-partitioned table. For more information, see [Exchange partitions](../../../../../300.database-object-management/200.manage-object-of-oracle-mode/200.manage-partitions-of-oracle-mode/1000.exchange-partition-of-oracle-mode.md). |
