...
You can use this statement to configure or delete an audit rule for an SQL statement.
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <ul>
    <li>To configure an audit rule for an SQL statement, you must have the <code>AUDIT SYSTEM</code> privilege and log in as the ORAAUDITOR user, whose password is always ORAAUDITOR. </li>
