...
* You can create only a DBLink that connects two Oracle-compatible tenants of OceanBase Database. In OceanBase Database, you cannot create a DBLink that points to an Oracle database.
