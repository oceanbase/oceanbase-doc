...
The `PX_NODE_POLICY` hint affects the candidate node pool for a pure-compute DFO. You can also set this hint by using the tenant parameter [PX_NODE_POLICY](../../../../../../../../700.reference/800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/6850.px_node_policy.md).
