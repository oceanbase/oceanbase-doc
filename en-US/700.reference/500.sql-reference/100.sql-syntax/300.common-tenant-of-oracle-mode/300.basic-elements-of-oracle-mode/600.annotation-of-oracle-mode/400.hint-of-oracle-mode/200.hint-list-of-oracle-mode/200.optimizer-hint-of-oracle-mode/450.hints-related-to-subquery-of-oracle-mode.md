...
# Subquery hints in optimized hint types
...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>The <code>PUSH_SUBQ</code> hint is supported in OceanBase Database V4.3.5 and later, starting from V4.3.5 BP2. </p>
</main>
...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>The <code>NO_PUSH_SUBQ</code> hint is supported in OceanBase Database V4.3.5 and later, starting from V4.3.5 BP2. </p>
</main>
