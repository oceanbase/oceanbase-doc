...
|slug|date-and-time-formatting-of-oracle-mode|
...
| HH12 | No | The hour of the day. Value range: [1,12]. It is used in 12-hour clock.  |
| HH24 | Yes | The hour of the day. Value range: [0,23]. It is used in 24-hour clock.  |
