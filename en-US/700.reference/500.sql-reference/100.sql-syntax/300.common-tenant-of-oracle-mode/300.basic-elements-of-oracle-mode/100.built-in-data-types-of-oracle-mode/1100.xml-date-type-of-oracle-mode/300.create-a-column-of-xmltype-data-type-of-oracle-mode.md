...
* XMLType columns do not support XMLIndex for key columns. You can create generated column indexes based on XMLType columns, but the index type must be a base type. It cannot be `LOB`, `JSON`, `SPATIAL`, or `XMLType`.
...
- Creating generated column indexes on XMLType columns.
