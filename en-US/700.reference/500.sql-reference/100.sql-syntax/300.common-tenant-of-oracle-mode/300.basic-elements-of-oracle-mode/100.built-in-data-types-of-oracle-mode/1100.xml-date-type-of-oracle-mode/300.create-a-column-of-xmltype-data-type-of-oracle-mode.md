...
- XMLType columns do not support XMLIndex for key columns. You can create a generated column index based on an XMLType column, but the index type must be a base type. It cannot be `LOB`, `JSON`, `GIS`, or `XMLType`.
