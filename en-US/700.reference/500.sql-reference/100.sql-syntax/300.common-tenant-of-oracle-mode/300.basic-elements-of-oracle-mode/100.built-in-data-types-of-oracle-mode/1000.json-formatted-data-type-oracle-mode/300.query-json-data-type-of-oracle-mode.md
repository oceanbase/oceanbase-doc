...
| floor() | Rounds down the target JSON number to the nearest integer. This method applies to JSON data of the NUMBER type and corresponds to the SQL function `FLOOR()`.  |
