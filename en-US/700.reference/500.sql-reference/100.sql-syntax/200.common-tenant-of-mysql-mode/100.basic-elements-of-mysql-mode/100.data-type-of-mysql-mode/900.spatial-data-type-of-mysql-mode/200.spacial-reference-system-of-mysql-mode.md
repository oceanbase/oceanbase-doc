...
* The `SRS_ID` value can be directly used as the SRID value for spatial data or as a parameter in spatial functions.
* When performing spatial operations, all participating geometric objects must have the same SRID. Otherwise, an error will occur.
