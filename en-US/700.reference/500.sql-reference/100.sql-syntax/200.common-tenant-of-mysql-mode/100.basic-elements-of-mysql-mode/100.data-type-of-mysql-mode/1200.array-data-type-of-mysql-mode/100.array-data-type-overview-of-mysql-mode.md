...
* Large object data types: `LOB` (`TINYTEXT`, `TEXT`, `MEDIUMTEXT`, or `LONGTEXT`).

    <main id="notice" type='explain'>
      <h4>Note</h4>
      <p>For V4.4.2, the <code>ARRAY</code> data type supports <code>LOB</code> element types starting from V4.4.2 BP2.</p>
    </main>
