...
OceanBase Database V4.3.3 also provides functions for the ARRAY data type. For more information, see [Overview](../../../400.functions-of-mysql-mode/950.array-functions-of-mysql-mode/100.array-functions-overview-of-mysql-mode.md).