...
| `STRING` <main id="notice" type='explain'><h4>Note</h4><p>The <code>STRING</code> data type is supported in OceanBase Database V4.3.5 and later, starting from V4.3.5 BP1. </p></main>| Variable | 16777216 | `UTF8MB4` |
