...
* The maximum nesting depth for arrays in map values is 5 levels. Since a map itself counts as 1 level, the total depth limit is 6 levels, so arrays within a map can be nested up to 5 levels.  
