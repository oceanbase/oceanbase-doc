...
* The maximum nesting depth for arrays in map values is 5 levels. Since a map itself counts as one level, the total nesting depth is limited to 6 levels. Therefore, arrays within a map can be nested up to 5 levels.
