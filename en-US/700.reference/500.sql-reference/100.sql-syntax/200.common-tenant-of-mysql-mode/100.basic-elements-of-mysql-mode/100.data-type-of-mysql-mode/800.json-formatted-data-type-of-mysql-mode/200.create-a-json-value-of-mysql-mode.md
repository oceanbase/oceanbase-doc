...
OceanBase Database allows you to enable semi-structured encoding when you create a table in a MySQL tenant. This feature is controlled by the table-level parameter `SEMISTRUCT_PROPERTIES`. You must also set the `ROW_FORMAT=COMPRESSED` parameter for the table. Otherwise, an error will be returned:
