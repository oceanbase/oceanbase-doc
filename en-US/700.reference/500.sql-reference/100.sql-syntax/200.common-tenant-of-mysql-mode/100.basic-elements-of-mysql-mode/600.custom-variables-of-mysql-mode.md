...
OceanBase Database allows the use of user variables `:=` in MySQL mode to extract new and old values during DML execution, reducing client-server interactions and simulating the DML RETURNING INTO feature of Oracle mode. However, there are some limitations:
