...
| gb2312_chinese_ci   | gb2312       | Uses the GB2312 character set. It sorts data regardless of case according to the Chinese collation rules. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| gb2312_bin          | gb2312       | Uses the GB2312 character set. It sorts data in binary order and distinguishes between uppercase and lowercase letters. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| ujis_japanese_ci    | ujis         | Uses the UJIS character set. It sorts data regardless of case according to the Japanese collation rules. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| ujis_bin            | ujis         | Uses the UJIS character set. It sorts data in binary order and distinguishes between uppercase and lowercase letters. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| euckr_korean_ci     | euckr        | Uses the EUCKR character set. It sorts data regardless of case according to the Korean collation rules. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| euckr_bin           | euckr        | Uses the EUCKR character set. It sorts data in binary order and distinguishes between uppercase and lowercase letters. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| eucjpms_japanese_ci | eucjpms      | Uses the EUCJPMS character set. It sorts data regardless of case according to the Japanese collation rules. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| eucjpms_bin         | eucjpms      | Uses the EUCJPMS character set. It sorts data in binary order and distinguishes between uppercase and lowercase letters. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| cp932_japanese_ci   | cp932        | Uses the CP932 character set. It sorts data regardless of case according to the Japanese collation rules. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| cp932_bin           | cp932        | Uses the CP932 character set. It sorts data in binary order and distinguishes between uppercase and lowercase letters. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| cp850_general_ci    | cp850        | Uses the CP850 character set. It sorts data regardless of case according to general collation rules. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| cp850_bin           | cp850        | Uses the CP850 character set. It sorts data in binary order and distinguishes between uppercase and lowercase letters. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| hp8_english_ci      | hp8          | Uses the HP8 character set. It sorts data regardless of case according to the English collation rules. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| hp8_bin             | hp8          | Uses the HP8 character set. It sorts data in binary order and distinguishes between uppercase and lowercase letters. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| macroman_general_ci | macroman     | Uses the MacRoman character set. It sorts data regardless of case according to general collation rules. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| macroman_bin        | macroman     | Uses the MacRoman character set. It sorts data in binary order and distinguishes between uppercase and lowercase letters. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| swe7_swedish_ci     | swe7         | Uses the SWE7 character set. It sorts data regardless of case according to the Swedish collation rules. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
| swe7_bin            | swe7         | Uses the SWE7 character set. It sorts data in binary order and distinguishes between uppercase and lowercase letters. <main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5, this collation is supported in V4.3.5 BP1 and later. </p></main>|
