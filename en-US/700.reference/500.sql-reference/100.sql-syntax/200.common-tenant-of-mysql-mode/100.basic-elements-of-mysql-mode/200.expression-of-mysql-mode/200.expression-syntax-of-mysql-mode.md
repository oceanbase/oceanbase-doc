...
|slug|expression-syntax-mysql-mode|

# Expression syntax

This topic describes the syntax rules that must be followed when you create expressions.

The following syntax rules define the expression syntax of OceanBase Database:
...
For more information about operator precedence, see [Operator precedence](../../200.operator-of-mysql-mode/200.operator-precedence-of-mysql-mode.md).