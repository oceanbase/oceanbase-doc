...
This topic describes simple primary key operations in the MySQL-compatible mode of OceanBase Database, including adding, modifying, and dropping primary keys.
