...
The following table describes the online DDL operations supported by OceanBase Database V4.x in MySQL-compatible mode.
...
|  Column operations | Add a column in the middle (`BEFORE`, `AFTER`, or `FIRST`) | Data volume related. Data needs to be reorganized (that is, the original data needs to be rewritten). | N/A | Supported <main id="notice" type='notice'> <h4>Note</h4> <p>For OceanBase Database V4.3.5, support for adding columns to the base table of materialized view logs is available starting from V4.3.5 BP1.</p> </main> |
...
The following table describes the offline DDL operations supported by OceanBase Database V4.x in MySQL-compatible mode.

<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>The DDL support information for creating full-text, multi-valued, and vector indexes applies only to V4.3.5 BP2 and later versions.</p>
</main>
...
|-------------|--------------------------|--------------------------|--------------------|--------------------|--------------------|
| Column operation | Rearrange (`BEFORE`/`AFTER`/`FIRST`)   | Data volume-dependent, requires data reorganization | None | No | Yes |
...
| Column operation | Modify column type | Data volume-dependent, requires data reorganization | None | Not supported | Supported |
...
| Column operation | Modify the precision of a `DECIMAL` type column | Data volume; requires data reorganization | None | No | Yes |
...
| Table operation | Convert character set | Data volume-dependent, requires data reorganization | None | No | Yes |
