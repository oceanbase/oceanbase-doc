...
## Supported online DDL operations (MySQL mode)
...
## Supported offline DDL operations (MySQL mode)

OceanBase Database V4.x in MySQL mode supports the following offline DDL operations.
