...
In MySQL mode of OceanBase Database, you can add a column to the end of a table or to a specific position in the table. This topic describes how to add a column to the end of a table or to a specific position in the table.
...
* Rename a column and modify its data type.
  ...
  * `data_type`: the data type of the column to be renamed. You can set the parameter to the current data type of the column or specify a new data type, which is specified in [Change a column type](#modify-a-column-type).
...
* `data_type`: the data type of the column to be relocated. You can set the parameter to the current data type of the column or specify a new data type, which is specified in [Change a column type](#modify-a-column-type).
...
OceanBase Database allows you to modify or delete the default value of a column in MySQL mode. This topic describes how to perform these operations.
...
OceanBase Database allows you to add constraints to a table in MySQL mode, such as modifying an existing column to an auto-increment column, setting whether a column can be `NULL`, and specifying the uniqueness of a column. This topic describes how to perform these operations.
...
* `data_type`: the data type of the column to be modified. You can specify the current data type or another data type. For more information about the supported data types, see [Modify the column type](#modify-column-type).
