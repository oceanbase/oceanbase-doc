...
* `FIRST | BEFORE | AFTER`: the position where the column is to be added. `FIRST` indicates the beginning of the table, and `BEFORE` or `AFTER` indicates the position before or after the specified column.
...
* `column_name`: the name of the column in the specified relative position to the column to be added.
...
* Rename a column while changing the type of the column
  ...
  * `data_type`: the new data type of the column to be renamed. You can specify the current data type or another data type. For more information, see the **Change the data type of a column** section.
...
3. Execute `DESCRIBE tbl1;` again to view the table schema of `tbl1`.
...
* `table_name`: the name of the table for which the column is to be relocated.

* `column_name`: the name of the column to be relocated.

* `data_type`: the new data type of the column to be relocated. You can specify the current data type or another data type. For more information, see the **Change the data type of a column** section
...
* `column_name`: the name of the column in the specified relative position to the position where the column is to be relocated.
...
* `data_type`: the data type of the column. You can specify the current data type or another data type. For more information, see the **Change the data type of a column** section.
...
* `UNIQUE [KEY]`: sets the UNIQUE constraint for the column.
...
5. Execute `DESCRIBE tbl1;` again to view the table schema of `tbl1`.
