...
When you change the data type of a column in the MySQL-compatible mode of OceanBase Database, you must first consider the table-level column type change rules, especially in scenarios where some data types are forbidden, and then consider the change rules concerning the source data type and target data type.
...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p><ul><li>In Oracle-compatible mode, the maximum value of <code>precision</code> is 38. </li><li>In MySQL-compatible mode, the maximum value of <code>precision</code> is 65. </li></ul></p>
</main>
