...
This topic describes how to perform simple index operations in the MySQL-compatible mode of OceanBase Database, including creating an index, querying indexes, adding an index, dropping an index, and renaming an index.
