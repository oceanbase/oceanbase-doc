...
The return value is an array of INT values. If the element does not exist, the function returns `0`.
...
```sql
-- length is -2, indicating the extraction of 2 elements from the right, i.e., excluding 8 and 9.
SELECT array_slice([1,2,3,4,5,6,7,8,9],2,-2);
+---------------------------------------+
| array_slice([1,2,3,4,5,6,7,8,9],2,-2) |
+---------------------------------------+
...
```sql
-- length is -10, indicating the extraction of 10 elements from the right. This exceeds the left boundary, returning an empty array.
SELECT array_slice([1,2,3,4,5,6,7,8,9],2,-10);
+----------------------------------------+
| array_slice([1,2,3,4,5,6,7,8,9],2,-10) |
+----------------------------------------+
