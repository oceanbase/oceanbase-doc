...
|slug|approx_count_distinct-agg-mysql-mode|
...
The `APPROX_COUNT_DISTINCT` function calculates the number of distinct rows in the expression `expr`. The result is a single approximate value. This function can be used to calculate the selectivity of the referenced column.
