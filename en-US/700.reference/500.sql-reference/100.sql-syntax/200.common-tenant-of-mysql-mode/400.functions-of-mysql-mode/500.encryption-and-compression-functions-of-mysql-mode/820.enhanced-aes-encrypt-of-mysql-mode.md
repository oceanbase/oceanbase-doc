...
* The function uses the current primary key of the tenant for encryption. The default encryption algorithm is AES-128-ECB. You can change the encryption algorithm by using the [block_encryption_mode](../../../../../800.configuration-items-and-system-variables/200.system-variable/300.global-system-variable/600.block_encryption_mode-global.md) parameter. Currently, only encryption algorithms of the AES type are supported.
