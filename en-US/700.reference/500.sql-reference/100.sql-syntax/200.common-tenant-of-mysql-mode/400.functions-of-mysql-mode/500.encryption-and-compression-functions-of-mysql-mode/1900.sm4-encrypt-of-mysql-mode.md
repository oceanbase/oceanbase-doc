...
1. In `sm4-ecb` mode, `SM4_ENCRYPT()` accepts two arguments in the format of `{str, key_str}`. If three values are passed in, the third value is ignored. Here is an example:
