...
| parser        | The tokenizer name. Valid values include `BENG` (base English), `NGRAM` (Chinese), `SPACE` (space), and `IK` (Chinese).<main id="notice" type='explain'><h4>Note</h4><p>Starting from V4.3.5 BP1, OceanBase Database V4.3.5 supports the <code>IK</code> tokenizer. </p></main></li></ul> |
