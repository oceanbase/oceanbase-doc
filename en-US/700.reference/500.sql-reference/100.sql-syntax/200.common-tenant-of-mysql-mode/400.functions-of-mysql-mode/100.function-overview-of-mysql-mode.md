...
GTID functions are used to manipulate and check global transaction identifiers.
At present, only the syntaxes of GTID functions are supported, and the functionality is not implemented.
