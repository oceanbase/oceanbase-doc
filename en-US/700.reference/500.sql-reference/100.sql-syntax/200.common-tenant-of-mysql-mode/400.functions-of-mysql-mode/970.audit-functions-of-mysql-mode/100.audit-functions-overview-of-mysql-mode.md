...
| [AUDIT_LOG_ENCRYPTION_PASSWORD_SET](600.audit-log-encryption-password-set-of-mysql-mode.md) | Triggers the archiving of currently writing audit logs and generates a new encryption key. |
| [AUDIT_LOG_ENCRYPTION_PASSWORD_GET](700.audit-log-encryption-password-get-of-mysql-mode.md) | Returns the encryption password (or key material) for the corresponding archived log file based on the `pwd_id` in the archive filename. |
