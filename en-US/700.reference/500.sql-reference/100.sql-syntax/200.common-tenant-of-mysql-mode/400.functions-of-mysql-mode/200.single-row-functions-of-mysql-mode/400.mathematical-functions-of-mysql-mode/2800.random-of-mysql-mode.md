...
* `seed` is an integer. The generated array of random numbers varies based on the value of `seed`.
* `RANDOM()` uses the MT19937 algorithm to generate pseudo-random numbers. This algorithm ensures a wide range for random numbers and generates identical sequences only after generating 2<sup>19937</sup> - 1 random elements.
