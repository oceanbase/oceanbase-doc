...
This function returns a string in the specified format. You can use it with the `DATE_FORMAT` or `STR_TO_DATE` function. The following table shows the string formats that can be generated based on the combinations of the values of the first and second parameters. For more information about the format specifiers used in the results, see the [DATE_FORMAT](../100.date-and-time-functions-of-mysql-mode/1000.date-format-of-mysql-mode.md) function.
