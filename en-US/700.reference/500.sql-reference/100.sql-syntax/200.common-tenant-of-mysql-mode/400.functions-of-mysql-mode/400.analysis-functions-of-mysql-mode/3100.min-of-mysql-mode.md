...
|slug|min-mysql-compatible-mode|
...
* The `DISTINCT` keyword can be used to retrieve the minimum of the distinct values of `expr`. However, the result is the same as omitting `DISTINCT`.
