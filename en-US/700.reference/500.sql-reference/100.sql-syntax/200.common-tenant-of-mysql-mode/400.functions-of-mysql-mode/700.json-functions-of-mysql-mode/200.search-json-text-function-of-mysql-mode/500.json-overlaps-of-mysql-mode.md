...
This function compares two JSON documents. It returns 1 if the two documents share one or more key-value pairs or array elements, otherwise 0.
...
When comparing two arrays, JSON_OVERLAPS() returns `1` if they share one or more array elements, otherwise `0`.
