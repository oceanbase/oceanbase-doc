...
With a path specified, `JSON_TABLE()` can extract required information from nested JSON data based on the path.
...
[Overview](../../100.basic-elements-of-mysql-mode/100.data-type-of-mysql-mode/800.json-formatted-data-type-of-mysql-mode/100.json-formatted-data-types-of-mysql-mode.md)
