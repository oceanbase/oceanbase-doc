...
The following table describes the JSON functions supported by OceanBase Database in MySQL mode.
...
| [JSON_REPLACE](300.modify-json-text-function-of-mysql-mode/800.json-replace-of-mysql-mode.md)| Replaces existing values in a JSON document. |
...
| [JSON_SCHEMA_VALID](700.json-schema-function-of-mysql-mode/100.json-schema-valid-of-mysql-mode.md)          | Returns 1 if a JSON document validates against the specified JSON schema and 0 if the JSON document fails the validation.    |
