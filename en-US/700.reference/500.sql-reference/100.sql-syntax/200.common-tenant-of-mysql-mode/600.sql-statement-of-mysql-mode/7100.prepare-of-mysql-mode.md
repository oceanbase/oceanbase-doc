...
You can use this statement to prepare and name a statement for future reference. You can use `EXECUTE` to execute the prepared statement and use `DEALLOCATE PREPARE` or `DROP PREPARE` to release the statement.
