...
1. Replace the values in Row 1 and Row 2 of the `test` table with `'hello alibaba'` and `'hello ob'`, respectively.
...
2. Query the data in Row 1 and Row 2 of the `test` table.
...
3. Replace the values in Row 3 and Row 2 of the `test` table with `'hello alibaba'` and `'hello oceanbase'`, respectively.
...
4. Query the data in Row 1, Row 2, and Row 3 of the `test` table.
