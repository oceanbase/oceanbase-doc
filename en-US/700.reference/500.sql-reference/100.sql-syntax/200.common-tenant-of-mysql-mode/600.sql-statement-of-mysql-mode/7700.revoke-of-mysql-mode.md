...
| priv_type                | The type of privilege. For more information, see [Privilege types in MySQL mode](../../../../../600.manage/500.security-and-permissions/300.access-control/200.user-and-permission/200.permission-of-mysql-mode/100.permission-classification-of-mysql.md). Notice: The PROXY parameter is currently recorded but does not take effect in this version.  |
| column_name_list         | A list of columns from which to revoke column-level privileges. If this parameter is not specified, privileges on the entire table or object are revoked. |
...
| proxy  | This keyword is recorded for future use. The feature is under development. |
