...
* Character data types: `CHAR`, `VARCHAR`, `TINYBLOB`, `TINYTEXT`, `BLOB`, `TEXT`, `MEDIUMTEXT`, `LONGBLOB`, and `LONGTEXT`
...
You can query the `oceanbase.DBA_DB_LINKS` view for information about the created DBLink.
