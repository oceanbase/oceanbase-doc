...
OceanBase Database supports two isolation levels in MySQL-compatible mode: read committed and repeatable read. The default isolation level is read committed.
