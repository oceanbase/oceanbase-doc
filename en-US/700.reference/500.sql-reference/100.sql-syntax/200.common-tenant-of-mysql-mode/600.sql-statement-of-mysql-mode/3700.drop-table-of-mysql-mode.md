...
| TEMPORARY | This parameter specifies whether to drop a temporary table. <main id="notice" type='explain'><h4>Note</h4><p><ul><li>Temporary tables are disabled in MySQL mode of OceanBase Database V4.1.0 BP4 and later. </li><li>Temporary tables are enabled in MySQL mode of OceanBase Database V4.3.5 BP4 and later. </li></p></main> |
