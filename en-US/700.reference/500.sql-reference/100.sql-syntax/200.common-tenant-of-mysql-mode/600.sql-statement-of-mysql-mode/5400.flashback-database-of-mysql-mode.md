...
* Restore the deleted table `product_info` from the recycle bin and rename it to `product_backup`. Then, check the restoration status of the indexes.
  ...
  Delete the indexes and check the recycle bin:
