...
You can use this statement to drop a restore point.
  ...
  <main id="notice" type='notice'>
    <h4>Notice</h4>
    <p><ul><li>OceanBase Database V4.x does not support the DROP RESTORE POINT statement. </li><li>You cannot create or drop restore points in the sys tenant. </li></ul></p>
  </main>
