...
| PARTITION BY RANGE [COLUMNS](\[column_name_list\]) [SIZE('size_value')] | Specifies the creation of an automatic partition table. For detailed information, refer to [Automatic Partition Splitting](../../../../300.database-object-management/100.manage-object-of-mysql-mode/300.manage-partitions-of-mysql-mode/250.partition-splitting-of-mysql-mode/300.automatic-partition-splitting-of-mysql-mode.md) under the syntax for automatic partitioning when creating tables. |
