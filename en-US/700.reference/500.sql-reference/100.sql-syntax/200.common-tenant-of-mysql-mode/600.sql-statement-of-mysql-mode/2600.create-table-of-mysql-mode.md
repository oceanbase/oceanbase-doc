...
* `HOT_RETENTION = intnum retention_time_unit`: specifies the time range for hot data.
  ...
  * `retention_time_unit`: specifies the time unit. Valid values:
  ...
  <main id="notice" type='notice'>
    <h4>Notice</h4>
    <p>In the time-axis strategy, at least one of the <code>HOT_RETENTION</code> and <code>MIXED_RETENTION</code> parameters must be specified.</p>
  </main>
