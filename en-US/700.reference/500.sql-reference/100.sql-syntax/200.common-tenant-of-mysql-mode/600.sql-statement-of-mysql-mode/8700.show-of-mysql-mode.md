...
|--------------------------------------------------|-------------------------------------------------------------------|
| \[EXTENDED\] \[FULL\] TABLES \{FROM \| IN} database_name | Queries all tables in `database_name`.  <ul><li>The `EXTENDED` keyword specifies to query hidden tables. Because the current version of OceanBase Database does not generate hidden tables, this keyword does not take effect. </li><li>The `FULL` keyword specifies to query the table type. </li></ul> |
...
| \[EXTENDED\] \[FULL\] {COLUMNS \| FIELDS} {FROM \| IN} rel_name | Queries columns of the `rel_name` relationship.  <ul><li>The `EXTENDED` keyword specifies to query information about hidden columns in the database. </li><li>The `FULL` keyword specifies to query the collation, privileges, and comments of the column. </li></ul> |
...
| \[EXTENDED\] {INDEX \| INDEXES \| KEYS} {FROM \| IN} rel_name \[{FROM \| IN} database_name\] | Queries indexes or keys of the `rel_name` relationship. The `EXTENDED` keyword specifies to query information about hidden indexes in the database.  |
...
* Execute `SHOW COLUMNS` to query information about columns in table `tbl2`.
...
* Execute `SHOW EXTENDED INDEX` to query information about hidden indexes in table `tbl2`.
