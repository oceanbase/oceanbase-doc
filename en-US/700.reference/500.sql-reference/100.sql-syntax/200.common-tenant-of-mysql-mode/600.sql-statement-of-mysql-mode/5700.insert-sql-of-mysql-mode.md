...
|-------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| LOW_PRIORITY \| HIGH_PRIORITY | Optional. <ul><li><code>LOW_PRIORITY</code>: specifies to defer the execution of the <code>INSERT</code> statement until no other clients read data from the table. In the current version, only the keyword syntax is supported. The functionality does not actually take effect. </li><li><code>HIGH_PRIORITY</code>: specifies that the <code>INSERT</code> statement has a higher priority. In the current version, only the keyword syntax is supported. The functionality does not actually take effect. </li></ul>|
