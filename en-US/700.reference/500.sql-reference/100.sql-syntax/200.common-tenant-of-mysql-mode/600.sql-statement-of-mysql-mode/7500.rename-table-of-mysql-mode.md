...
* Before you execute the `RENAME TABLE` statement, make sure that no target table is locked and no transaction is active on any target table.
   ...
   <main id="notice" type='explain'>
     <h4>Note</h4>
     <p>After the tenant-level parameter <a href="../../../../800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/2750.enable_lock_priority.md">enable_lock_priority</a> is enabled, the <code>RENAME TABLE</code> statement has the highest priority in obtaining a table lock. </p>
   </main>
