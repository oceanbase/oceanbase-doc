...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>Starting from OceanBase Database V4.2.5 BP2, the EVENT feature is enhanced to support the <code>CALL</code> statement for calling stored procedures and time expressions and functions when you set the start or end time. </p>
</main>
