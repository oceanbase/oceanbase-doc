...
This statement changes the `access_id` and `access_key` and other key information of the backup or log archive path in the current tenant.

## Limitations and considerations

* From V4.3.5 BP2, this statement is supported in V4.3.5.

* Only user tenants are allowed to execute this statement. The sys tenant cannot execute it.
