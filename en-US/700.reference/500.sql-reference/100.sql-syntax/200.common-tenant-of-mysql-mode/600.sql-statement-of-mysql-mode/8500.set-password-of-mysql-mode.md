...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>The optional <code>RETAIN CURRENT PASSWORD</code> clause is used to retain the old password while setting a new one. This clause is supported starting from V4.6.1 for dual-password scenarios.</p>
</main>
