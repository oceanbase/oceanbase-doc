...
| MODIFY PARTITION partition_name ADD SUBPARTITION (add_subpartition_option) | Indicates that new subpartitions are added. <main id="notice" type='notice'><h4>Notice</h4><p><ul><li>Adding new subpartitions is not supported for scenarios where the subpartition type is Hash or Key.</li><li>In OceanBase Database V4.3.5, adding subpartitions is supported in V4.3.5 BP1. </li></ul></p></main>|
| add_subpartition_option | Specifies the definition of the new subpartitions.|
