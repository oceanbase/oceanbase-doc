...
| MODIFY PARTITION partition_name ADD SUBPARTITION (add_subpartition_option) | Indicates that new subpartitions are added. <main id="notice" type='notice'><h4>Notice</h4><p><ul><li>Subpartitioning of HASH or KEY type is not supported. </li><li>In OceanBase Database V4.3.5, subpartitioning was introduced in V4.3.5 BP1. </li></ul></p></main>|
