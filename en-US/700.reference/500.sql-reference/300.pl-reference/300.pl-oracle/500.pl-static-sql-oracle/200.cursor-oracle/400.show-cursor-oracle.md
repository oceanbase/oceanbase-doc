...
1. Declare a cursor in the declaration section using one of the following methods.
...
3. Open the cursor in the execution section using one of the following methods.
...
4. Fetch row data from the cursor in the execution section. Each row is fetched one at a time, and you can use the following format of the `LOOP` statement to fetch multiple rows at once.
