...
|slug|statement-oracle-compatible-mode|
...
You can apply the `NOT NULL` constraint to a scalar of a variable or constant or to a scalar component of a composite variable or constant.
