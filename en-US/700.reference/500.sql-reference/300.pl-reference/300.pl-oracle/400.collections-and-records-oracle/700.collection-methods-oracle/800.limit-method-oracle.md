...
The `LIMIT` method returns the maximum number of elements that a collection can have. If a collection does not have a maximum number of elements, the `LIMIT` method returns `NULL`.
