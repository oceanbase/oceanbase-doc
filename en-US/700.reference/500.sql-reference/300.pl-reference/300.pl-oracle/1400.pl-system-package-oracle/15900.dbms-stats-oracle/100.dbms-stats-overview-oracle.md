...
| [DELETE_SYSTEM_STATS](850.delete-system-stats-oracle.md)                                      | Deletes system statistics. |
...
| [GATHER_SYSTEM_STATS](1850.gather-system-stats-oracle.md)           | Collect system statistics. |
...
| [RESTORE_TABLE_STATS](../15900.dbms-stats-oracle/3000.restore-table-stats-oracle.md)            | Restores the table-level historical statistics as of the specified point in time.                         |
| [RESTORE_SCHEMA_STATS](../15900.dbms-stats-oracle/3100.restore-schema-stats-oracle.md)           | Restores the user-level historical statistics as of the specified point in time.                  |
...
| [SET_SYSTEM_STATS](4050.set-system-stats-oracle.md)           | Sets system statistics. |
