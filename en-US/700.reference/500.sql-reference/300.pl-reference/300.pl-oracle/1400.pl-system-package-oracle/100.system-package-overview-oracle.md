...
|slug|overview-system-package-overview-oracle-mode|
...
| [DBMS_PROFILER](19800.dbms-profiler-oracle/100.dbms-profiler-oracle-package-overview-oracle.md)| Records the number of executions and execution duration of each code line in PL executions, and summarizes the information.    |
