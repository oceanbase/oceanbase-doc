...
The `DBMS_UTILITY` package provides utility subprograms.
  ...
  <main id="notice" type='notice'>
    <h4>Notice</h4>
    <p>In the current OceanBase Database version, the <code>DBMS_UTILITY</code> package does not support passing parameters in the UTF-16 format.
  </main>
...
| [TABLE_TO_COMMA](../17900.dbms-utility-oracle/2100.table-to-comma-oracle.md)         | Converts a PL table of names into a list of names separated with commas (,).   |
