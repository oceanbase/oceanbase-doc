...
|----------------------------|--------------------------|
| audit_trail_type           | The audit trail type of the purge job to be created. For more information, see [Audit trail types of DBMS_AUDIT_MGMT](../2600.dbms-audit-mgmt-oracle/100.dbms-audit-mgmt-overview-oracle.md).     |
