...
|machine-translation||
|slug|dbms-job-overview-oracle-compatible-mode|
...
The `DBMS_JOB` package schedules and manages jobs in the job queue.
  ...
  <main id="notice" >
  <h4>Note</h4>
  <p>The <code>DBMS_JOB</code> package is not recommended for OceanBase Database V4.x in a production environment. </p>
</main>
...
|------------------------------------------------------------|----------------------|
| [BROKEN](../8800.dbms-job-oracle/200.broken-oracle.md)      | Disables job execution.            |
