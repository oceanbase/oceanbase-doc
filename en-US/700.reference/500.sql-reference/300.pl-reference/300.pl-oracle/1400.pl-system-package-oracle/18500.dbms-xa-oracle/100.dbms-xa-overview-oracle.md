...
|--------------------------------------------------------------|-----------------------------------------------|
| [DIST_TXN_SYNC](../18500.dbms-xa-oracle/400.dist-txn-sync-oracle.md) | Used for synchronization recovery. OceanBase Database supports this procedure for compatibility only, with no actual operations involved. |
