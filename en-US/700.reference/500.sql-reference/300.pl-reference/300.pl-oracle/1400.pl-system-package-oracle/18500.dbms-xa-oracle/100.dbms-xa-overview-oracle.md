...
|--------------------------------------------------------------|-----------------------------------------------|
| [DIST_TXN_SYNC](../18500.dbms-xa-oracle/400.dist-txn-sync-oracle.md) | Used in synchronization recovery. OceanBase Database supports this procedure only for Oracle compatibility and it does not perform any substantive operations. |
