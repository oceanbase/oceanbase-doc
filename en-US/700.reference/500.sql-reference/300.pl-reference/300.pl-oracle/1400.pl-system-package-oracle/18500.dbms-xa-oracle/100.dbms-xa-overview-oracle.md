...
|--------------------------------------------------------------|-----------------------------------------------|
| [DIST_TXN_SYNC](../18500.dbms-xa-oracle/400.dist-txn-sync-oracle.md) | Used for synchronization recovery. <main id="notice" type='explain'><h4>Note</h4><p>OceanBase Database supports this subprogram only for compatibility purposes and performs no actual operations.</p></main> |
