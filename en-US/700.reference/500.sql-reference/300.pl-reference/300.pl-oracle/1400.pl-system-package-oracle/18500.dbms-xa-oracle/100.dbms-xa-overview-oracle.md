...
|slug|overview-dbms-xa-overview-oracle-mode|
...
|--------------------------------------------------------------|-----------------------------------------------|
| [DIST_TXN_SYNC](../18500.dbms-xa-oracle/400.dist-txn-sync-oracle.md) | Used for recovery synchronization. <main id="notice" type='explain'><h4>Note</h4><p>OceanBase Database supports this procedure for compatibility purposes only. It does not perform any substantive operations.</p></main> |
