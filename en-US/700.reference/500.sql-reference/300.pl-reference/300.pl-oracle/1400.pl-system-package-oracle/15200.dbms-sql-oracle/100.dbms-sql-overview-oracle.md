...
| [VARIABLE_VALUE](../15200.dbms-sql-oracle/2100.variable-value-oracle.md) | Used to obtain the value of an output variable after a dynamic SQL statement is executed.
