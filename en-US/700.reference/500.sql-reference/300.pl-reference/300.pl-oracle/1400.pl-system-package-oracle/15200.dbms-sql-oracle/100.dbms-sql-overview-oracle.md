...
|slug|overview-dbms-sql-overview-oracle-mode|
...
| [VARIABLE_VALUE](../15200.dbms-sql-oracle/2100.variable-value-oracle.md) | Returns the value of an output variable after a dynamic SQL statement is executed.
