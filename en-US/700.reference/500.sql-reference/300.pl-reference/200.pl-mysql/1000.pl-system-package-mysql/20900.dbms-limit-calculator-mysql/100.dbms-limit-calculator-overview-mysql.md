...
|[CALCULATE_MIN_PHY_RES_NEEDED_BY_LOGIC_RES](300.calculate-min-phy-res-needed-by-loglc-res-mysql.md)| Calculates the amount of physical resources required to accommodate the specified types and amounts of logical resources in a tenant. |
|[CALCULATE_MIN_PHY_RES_NEEDED_BY_STANDBY_TENANT](400.calculate-min-phy-res-needed-by-standby-tenant-mysql.md)| Calculates the amount of physical resources required for each of the specified units for a standby tenant to be created for the specified primary tenant. |