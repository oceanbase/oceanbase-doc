...
| [DELETE_SYSTEM_STATS](860.delete-system-stats-mysql.md)                                   | Deletes system statistics. |
...
| [GATHER_SYSTEM_STATS](1850.gather-system-stats-mysql.md)                                    | Collect system statistics. |
...
| [RESTORE_TABLE_STATS](../15900.dbms-stats-mysql/3000.restore-table-stats-mysql.md)            | Restores the table-level historical statistics as of the specified point in time.                         |
| [RESTORE_SCHEMA_STATS](../15900.dbms-stats-mysql/3100.restore-schema-stats-mysql.md)           | Restores the schema-level historical statistics as of the specified point in time.                  |
| [RESET_GLOBAL_PREF_DEFAULTS](../15900.dbms-stats-mysql/3200.reset-global-pref-defaults-mysql.md)     | Resets global preferences to default values.                    |
...
| [SET_SYSTEM_STATS](4050.set-system-stats-mysql.md)                                    | Sets system statistics. |
