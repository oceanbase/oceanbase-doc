...
1. Log in to the `sys` tenant as the root user from a client through ODP.
   ...
   In this example, the IP address of ODP is `10.10.10.1`, the name of the cluster is `obdemo`, and the use connects to the cluster through OBClient. For detailed operations on connecting to the OceanBase tenant, see [Connection methods (MySQL-compatible mode)](../../../../300.develop/100.application-development-of-mysql-mode/100.connect-to-oceanbase-database-of-mysql-mode/100.connection-methods-overview-of-mysql-mode.md) and [Connection methods (Oracle-compatible mode)](../../../../300.develop/200.application-development-of-oracle-mode/100.connect-to-oceanbase-database-of-oracle-mode/100.connection-methods-overview-of-oracle-mode.md).
