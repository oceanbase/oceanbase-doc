...
To use read/write splitting, you must perform the following steps:
...
#### Configure a weak-consistency read by using a hint
...
To configure weak-consistency read for SQL statements by using a hint, you must modify the SQL statements, which can be complex sometimes. You can change the value of the `obproxy_read_consistency` parameter to configure weak-consistency read.
