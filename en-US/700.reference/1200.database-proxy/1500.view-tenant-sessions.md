...
2. Execute the following statement to view tenant sessions.
   ...
   * `PROXY_USER`: the username of the proxy user when a proxy user is used for logon. The value of this column is empty when a non-proxy user is used for logon.
