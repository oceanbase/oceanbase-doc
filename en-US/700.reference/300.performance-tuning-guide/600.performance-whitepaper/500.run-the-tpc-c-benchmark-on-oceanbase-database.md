...
* OceanBase Database: We recommend that you deploy OceanBase Database Proxy (ODP) separately. For more information, see [Get started with OceanBase Database](../../../2.quickstart/1.quickly-experience-oceanbase-for-community.md).
...
* Tenant specifications:
   ...
   <h4>Notice</h4>
   <ul>
      <li>The preceding tenant specifications are provided based on the hardware configuration described in <a href="6.tpc-c-benchmark-report-of-oceanbase-database.md">TPC-C benchmark report of OceanBase Database</a>. You need to adjust the specifications based on your hardware configuration. </li>
...
For more information about the test result, see [TPC-C benchmark report of OceanBase Database](6.tpc-c-benchmark-report-of-oceanbase-database.md).
