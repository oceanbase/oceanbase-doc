...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <p>The plugin mechanism is currently experimental and is not recommended for use in production environments.</p>
</main>
...
* [Overview of OceanBase plugin mechanism](../100.oceanbase-database-concepts/1200.observer-node-architecture/600.plugin-mechanism.md)
