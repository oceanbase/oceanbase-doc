...
For more information about variables, see [Overview (MySQL mode)](../../../500.system-reference/200.system-variable-of-mysql-mode/100.overview-of-system-variables-of-mysql-mode.md) or [Overview (Oracle mode)](../../../500.system-reference/300.system-variable-of-oracle-mode/100.overview-of-system-variables-of-oracle-mode.md). For more information about how to set the user variables, see [SET](../../../400.development-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/600.sql-statement-of-mysql-mode/8200.set-of-mysql-mode.md).
