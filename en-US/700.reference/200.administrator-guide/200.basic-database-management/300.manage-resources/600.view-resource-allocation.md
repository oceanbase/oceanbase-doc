...
3. Execute the following statement to query the resource allocation of all OBServer nodes in the cluster:
   ...
   *************************** 3. row ***************************
   ...
   For more information about the `oceanbase.GV$OB_SERVERS` view, see [GV$OB_SERVERS](../../../5.system-reference/4.system-overview-of-mysql-mode/3.performance-view-of-mysql-mode/9.gv-ob_servers-of-mysql-mode.md).
