...
* Named notation.
  ...
  You can explicitly specify the parameter names and values. The parameters do not need to be passed in the order they are defined. The syntax is `argument1 => parameter1 [, argument2 => parameter2[, ...]]`
...
<h4>Notice</h4>
<p>Functions with the <code>PARALLEL_ENABLE</code> feature may be called by multiple threads simultaneously in a parallel execution environment. Therefore, you must ensure that the function is thread-safe. </p>
</main>
