...
The syntax of a pipeline function is as follows. For more information about the complete syntax of the CREATE FUNCTION statement, see [CREATE FUNCTION](../../1100.ddl-operations-on-stored-pl-units-oracle/700.create-function-oracle.md).
...
* Generally, a pipeline function has one or more cursor variable parameters. For more information about cursor variables, see [Cursor variables](../../500.pl-static-sql-oracle/200.cursor-oracle/500.cursor-variable-oracle.md).
