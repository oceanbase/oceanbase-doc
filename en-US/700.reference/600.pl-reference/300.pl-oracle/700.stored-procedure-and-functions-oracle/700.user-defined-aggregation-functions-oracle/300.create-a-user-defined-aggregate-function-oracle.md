...
This topic uses `SecMax()` as an example to describe how to create a user-defined aggregate function. `SecMax()` returns the second largest value in a set of numbers.
