...
`INSTEAD OF` DML triggers are created on non-updatable views and can be used to update the view. `INSTEAD OF` triggers can determine the intended operation and execute the appropriate DML operation on the base table.
