...
| REPORT_TYPE | The type of the report. Only the `TEXT` type is supported. This parameter is optional. |
| REPORT_TYPE | The type of the report. The `HTML` and `TEXT` types are supported. If this parameter is not specified, the default value is `TEXT`. |
...
| TENANT_ID | The ID of the tenant that generates the ASH report. If this parameter is not specified or is set to `NULL`, the `TENANT_ID` is not restricted. |
