...
| stattype | The type of the statistics to be locked. Three types are supported: <ul><li> `'ALL'` </li>  <li> `'DATA'`   </li>  <li> `'CACHE'` </li>  </ul>    **Note**: OceanBase Database in Oracle-compatible mode supports only the `'ALL'` type.  |
