...
```
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p>In Oracle-compatible mode, you do not need to specify the <code>tabname</code> parameter because the index is unique under the current user. In MySQL-compatible mode, you must explicitly specify the table name because indexes are not unique under the current user. </p>
  </main>