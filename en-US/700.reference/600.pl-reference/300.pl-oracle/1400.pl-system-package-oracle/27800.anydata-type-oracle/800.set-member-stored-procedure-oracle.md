...
|slug|set-member-stored-procedure-oracle-mode|
...
* `DBMS_TYPES.INVALID_PARAMETERS`: Invalid parameters (for example, when a value cannot be added at a certain stage of the procedure creation).
