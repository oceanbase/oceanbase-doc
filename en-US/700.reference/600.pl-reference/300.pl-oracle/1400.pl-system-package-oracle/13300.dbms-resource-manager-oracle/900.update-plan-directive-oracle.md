...
| NEW_MGMT_P1       | The maximum CPU utilization relative to availability when the system is at full load. |
...
* Update the comment for the resource group `group1` bound to the resource plan `DAY`.
...
* Update the resource plan content for CPU, IOPS, and network bandwidth resources in the resource group `big_group` bound to the resource plan `plan_a`.
...
For more information about how to update the resource management plan content, see [Update a plan directive](../../../../../600.manage/200.tenant-management/600.common-tenant-operations/300.resource-isolation/200.resource-isolation-of-oracle-mode/400.update-a-plan-directive-of-oracle-mode.md).