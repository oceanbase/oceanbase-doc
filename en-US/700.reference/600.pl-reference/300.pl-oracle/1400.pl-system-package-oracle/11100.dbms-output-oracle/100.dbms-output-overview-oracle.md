...
|----------------------------------------------------------|-----------------|
| [DISABLE](../11100.dbms-output-oracle/200.output-disable-oracle.md) | Disables the output of messages.  |
| [ENABLE](../11100.dbms-output-oracle/300.output-enable-oracle.md) | Enables the output of messages.  |
