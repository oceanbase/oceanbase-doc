...
The `GET_LINE` procedure is used to retrieve information about a specific line from the buffer.
  ...
  <main id="notice" >
    <h4>Applicability</h4>
    <p>The following descriptions apply only to OceanBase Database Enterprise Edition. OceanBase Database Community Edition provides only MySQL-compatible mode.</p>
  </main>
