...
|--------------------------------------------------------------|-----------------------------------------------|
| [DIST_TXN_SYNC](../18500.dbms-xa-oracle/400.dist-txn-sync-oracle.md) | Used for synchronized recovery. <main id='notice' type='explain'><h4>Note</h4><p>OceanBase Database supports this procedure for compatibility only, with no substantive operation.</p></main> |
