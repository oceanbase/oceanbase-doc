...
| schema | The schema to which the objects to be recompiled belong. The value `NULL` specifies to recompile all objects in the tenant. A value other than `NULL` specifies to recompile objects that belong to the specified schema. |
