...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>This function is introduced in V4.4.2 for V4.4.x versions and in V4.6.0 for V4.6.x versions. </p>
</main>
...
Execute the following statement to extract index DDL statements for a table in batches:
