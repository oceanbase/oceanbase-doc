...
| refresh_parallel | The number of threads that execute the refresh operation at the same time.<main id="notice" type='explain'><h4>Note</h4><p>Starting from OceanBase Database V4.3.5 and V4.3.1 BP1, the default value of this parameter can be changed to 0. </p></main>|