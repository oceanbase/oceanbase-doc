...
For user-defined exceptions, the numeric code is `+1` (the default) or the error code associated with the exception using the `EXCEPTION_INIT` compiler directive.
