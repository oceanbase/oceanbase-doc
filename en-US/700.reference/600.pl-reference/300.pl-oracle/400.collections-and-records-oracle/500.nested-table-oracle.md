...
You can define a table type and declare a variable of the type. Then, you can add records to the PL/SQL table and reference the records in a manner similar to referencing array elements.
...
| PRIOR(n)      | Returns the row number of the record preceding the nth row in the PL/SQL table.                                                                                                                                                                                      |
| NEXT(n)       | Returns the row number of the record following the nth row in the PL/SQL table.                                                                                                                                                                                      |
...
* The indexes are not continuous.
