...
Once a level number is defined, it cannot be changed. If a level is used in any existing tag, its short name cannot be changed, but its long name can be changed.
