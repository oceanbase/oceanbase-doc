...
The `SA_LABEL_ADMIN.ALTER_LABEL` procedure is used to change the string label definitions associated with a label tag. The label itself cannot be changed.

If you change the string associated with a label tag, the sensitivity of the data in the row will change accordingly. Make sure that you can refer to the label by its label tag or string value when specifying the label to change.
