...
| default_options | The default enforcement options. When a policy is applied but no specific table or schema is specified, the default enforcement options (including enforcement options and hidden label column options) are used. Separate each option with a comma. |
