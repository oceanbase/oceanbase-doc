...
The contents of the system package `STANDARD` are directly visible to applications. Users can call the package from database triggers, stored subprograms, or OceanBase Database tools without prefixing the package name.
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p>System functions of OceanBase Database are not registered in the <code>STANDARD</code> package. The <code>STANDARD</code> package in the current version supports only predefined data types, constants, and exceptions. </p>
  </main>
