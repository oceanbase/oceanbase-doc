...
|slug|manage-packages-oracle-mode|
...
You can use the `DROP PACKAGE` statement to delete an unnecessary package. Syntax:
...
* `USER_OBJECTS`: This view displays database objects. You can use this view to obtain the names, current status, and creation times of packages.
...
* `USER_SOURCE`: This view displays the contents of packages and package bodies.

* `USER_ERRORS`: This view displays the error messages generated during the last compilation of a package or package body.

**Example 1: Query the status and creation time of all packages in the current user schema.**
...
**Example 2: Query the content of the package body named** **`OBDEMO_PACK`** **.**
...
**Example 3: Query the error messages and location of the last compilation of the** **`PKG`** **package.**
