...
* `USER_OBJECTS`: queries database objects. You can use this view to list the names, current statuses, and creation times of packages.
...
* `USER_SOURCE`: queries the contents of a package and its body.

* `USER_ERRORS`: queries the error messages generated during the last compilation of a package or its body.
