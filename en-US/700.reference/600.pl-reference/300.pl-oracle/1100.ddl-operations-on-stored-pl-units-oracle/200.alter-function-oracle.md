...
|-------------------------|---------------|------------------------------------|
| alter_function          | schema        | The schema name where the function is located. The default value is the current user's schema. |
