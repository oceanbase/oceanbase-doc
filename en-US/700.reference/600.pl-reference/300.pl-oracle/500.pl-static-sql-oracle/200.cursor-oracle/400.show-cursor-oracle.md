...
1. Declare a cursor in the declaration section. You can use either of the following methods.
...
2. Declare a record variable in the declaration section to store the records returned by the cursor.

   ```sql
   record_name cursor_name%ROWTYPE;
   ```

3. Open the cursor in the execution section. You can use either of the following methods.
...
4. Fetch the row data from the cursor record set in the execution section. You can use the following `LOOP` statement to fetch multiple rows of data at a time.
