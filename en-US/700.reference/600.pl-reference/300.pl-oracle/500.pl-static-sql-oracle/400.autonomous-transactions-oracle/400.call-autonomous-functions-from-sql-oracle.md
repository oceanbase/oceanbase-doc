...
In the following example, the package function `oblog_msg` is autonomous. Therefore, when you query this function, it inserts a message into the `obdebug_output` table without violating the rule that it cannot modify database tables.
