...
| [COPY_TABLE_STATS](../15900.dbms-stats-mysql/4550.copy-table-stats-mysql.md)                | Copies the statistics from a source partition (or subpartition) to a target partition (or subpartition). |
