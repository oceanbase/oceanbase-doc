...
| [COPY_TABLE_STATS](../15900.dbms-stats-mysql/4550.copy-table-stats-mysql.md)                | Copies statistics from a source partition (or subpartition) to a destination partition (or subpartition). |
