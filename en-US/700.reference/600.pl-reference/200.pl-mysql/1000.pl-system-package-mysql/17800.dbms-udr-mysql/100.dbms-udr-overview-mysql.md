...
- Perform an exact match for the database name specified when a rule was created. In Oracle-compatible mode, you do not need to specify this parameter, and the rule applies to the current user.
