...
* After setting partition weights, if an Offline DDL operation (such as Truncate Table or Truncate Partition) is performed, the partition weights will become invalid and need to be reset. See [Online DDL and Offline DDL operations (MySQL mode)](../../../../500.sql-reference/100.sql-syntax/200.common-tenant-of-mysql-mode/700.ddl-function-of-mysql-mode/150.online-and-offline-ddl-list-of-mysql-mode.md) for a list of Offline DDL operations that may invalidate partition weights.
