...
| idx_parameters | The index parameters. This is the string of vector index parameters used when creating the table, such as `distance=l2, type=hnsw, lib=vsag`. For more information, see Vector index performance optimization <temp-hide-link>. | No |
