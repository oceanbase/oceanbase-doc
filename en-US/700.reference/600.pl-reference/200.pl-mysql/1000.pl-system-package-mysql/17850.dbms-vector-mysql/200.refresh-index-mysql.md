...
|slug|refresh_index-mysql-compatible-mode|

# REFRESH_INDEX

The `REFRESH_INDEX` procedure is used to incrementally refresh vector indexes.
...
| refresh_threshold | The number of incremental data. |
| refresh_type | The refresh type. The optional value is `FAST`. |
...
* [DBMS_VECTOR Subprograms Overview](100.dbms-vector-overview-mysql.md)
