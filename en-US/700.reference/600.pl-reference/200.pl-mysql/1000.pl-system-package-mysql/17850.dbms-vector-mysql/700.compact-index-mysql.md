...
The `COMPACT_INDEX` procedure is used to manually trigger a compaction task, which corresponds to the process of **merging incremental segments with the base segment** in an HNSW vector index. For more information about the principles of vector indexes, see [Vector index principles](../../../../100.oceanbase-database-concepts/400.database-objects/200.database-objects-of-mysql-mode/300.index-of-mysql-mode/330.vector-indexes-of-mysql-mode-in-concepts.md).
