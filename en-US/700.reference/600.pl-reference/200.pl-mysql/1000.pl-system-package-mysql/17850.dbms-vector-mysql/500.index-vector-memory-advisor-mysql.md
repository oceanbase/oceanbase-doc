...
| idx_parameters | The index parameters. The string of the vector index parameters used when the table is created, for example, `distance=l2, type=hnsw, lib=vsag`. For more information, see Vector index memory management <temp-hide-link>. |
