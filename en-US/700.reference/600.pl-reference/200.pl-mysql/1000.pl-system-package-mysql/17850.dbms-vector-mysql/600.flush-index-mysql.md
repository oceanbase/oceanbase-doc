...
|slug|flush_index-mysql-mode|

# FLUSH_INDEX

The `FLUSH_INDEX` procedure is used to manually trigger the dumping task, which corresponds to the process of **freezing and persisting the active incremental segments** in the HNSW vector index. For more information, see [Vector index principle](../../../../100.oceanbase-database-concepts/400.database-objects/200.database-objects-of-mysql-mode/300.index-of-mysql-mode/330.vector-indexes-of-mysql-mode-in-concepts.md).
