...
The `FLUSH_INDEX` procedure is used to manually trigger the **freezing and persisting of active incremental segments** in HNSW vector indexes. For more information, see [Vector index principles](../../../../100.oceanbase-database-concepts/400.database-objects/200.database-objects-of-mysql-mode/300.index-of-mysql-mode/330.vector-indexes-of-mysql-mode-in-concepts.md).
