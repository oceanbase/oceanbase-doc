...
| idx_parameters | The index parameters. The value is the vector index parameters used when the table was created, for example, `distance=l2, type=hnsw, lib=vsag`. For more information about the parameters, see Vector index memory management <temp-hide-link>. |
