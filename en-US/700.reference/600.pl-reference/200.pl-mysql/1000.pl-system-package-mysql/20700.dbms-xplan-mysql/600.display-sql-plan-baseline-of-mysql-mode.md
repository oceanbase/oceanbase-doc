...
|slug|display_sql_plan_baseline-mysql-compatible-mode|

# DISPLAY_SQL_PLAN_BASELINE

The `DISPLAY_SQL_PLAN_BASELINE` function is used to view the baseline plans in the SPM.
...
| --- | --- |
| sql_handle | The SQL handle of the baseline plan, which can be obtained from the SPM views. |
| plan_name | The name of the baseline plan. |
| format | The plan format. Valid values: <ul><li>`'BASIC'`: displays basic information such as operator ID, operator name, operator remarks, and expression information. </li><li>`'TYPICAL'`: displays basic information such as operator ID, operator name, operator remarks, optimizer-estimated output rows, optimizer-estimated execution time, and expression information. If the plan has been executed, it also displays the actual feedback information of the plan's first execution, such as actual rows and cost. </li><li>`'ALL'`: displays rich plan information such as operator ID, operator name, operator remarks, optimizer-estimated output rows, optimizer-estimated execution time, and expression information, as well as effective hints, query block name trace information, outline information, base table optimization information, constant parameterization information, constraint information, and plan notes. </li><li>`'ADVANCED'`: displays rich plan information, which is the same as the 'ALL' parameter. In addition, it displays tree structure information for complex plans. </li></ul>|
