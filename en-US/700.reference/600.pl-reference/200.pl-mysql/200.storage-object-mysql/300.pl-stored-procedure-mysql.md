...
You can use the `CREATE PROCEDURE` statement to create a stored procedure. In MySQL mode, the following features are different from those in Oracle mode:
...
* You can define `sp_create_chistic` information such as `DETERMINISTIC / LANGUAGE SQL` to enhance the functionality of the stored procedure.
...
```sql
//Create a sample table named emp.
