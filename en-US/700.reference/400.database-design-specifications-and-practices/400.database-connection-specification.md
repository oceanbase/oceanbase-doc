...
* For frontend applications with a connection pool, set the initial, minimum, and maximum numbers of connections based on the business requirements. We recommend that you set the timeout period to 30s, set the connection detection or idle timeout period, and set the connection recycling mechanism (maximum value: 3600s).
