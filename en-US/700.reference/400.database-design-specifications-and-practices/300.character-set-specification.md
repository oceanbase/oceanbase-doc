...
* Set the character set when you create a tenant
  ...
  * Select `GBK` as the character set when you create a tenant in OceanBase Cloud Platform (OCP).
  ...
  <main id="notice" type='notice'>
    <h4>Notice</h4>
    <ul>
    <li>In Oracle mode, the character set is specified at the tenant level. In a tenant whose character set is set to <code>GBK</code>, the <code>GBK</code> character set is used for the <code>CHAR</code>, <code>VARCHAR2</code>, and <code>CLOB</code> fields in all user tables. However, the utf8 character set is still used for the <code>CHAR</code>, <code>VARCHAR2</code>, and other fields in system tables. </li>
