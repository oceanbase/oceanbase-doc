...
|slug|data-integrity-overview-oracle-compatible-mode|

# Data integrity overview

In the Oracle-compatible mode of OceanBase Database, tenants can use integrity constraints to prevent the insertion of invalid data into tables. This chapter mainly introduces the types and application scenarios of integrity constraints.
