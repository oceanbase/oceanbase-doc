...
A full-text index is a technology used for fast text search. It enables comprehensive indexing and retrieval of text content. A full-text index can index an entire document or large segments of text. Its primary function is to enable full-text search, which allows users to quickly find matching text in the database based on keywords entered by the user. It can handle large volumes of text data, including articles, reports, web pages, emails, and more.

For more information about full-text indexes, see [Full-text indexes](320.full-text-indexes-of-oracle-mode-in-concepts.md).