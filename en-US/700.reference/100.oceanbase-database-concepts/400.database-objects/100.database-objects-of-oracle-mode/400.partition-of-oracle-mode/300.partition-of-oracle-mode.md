...
INTERVAL partitioning extends RANGE partitioning by allowing new partitions to be automatically created when new data is inserted into existing partitions.
