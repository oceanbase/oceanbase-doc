...
<main id="notice" type='notice'>
  ...
  <p>In Oracle-compatible mode, a JSON-based virtual generation function can create a secondary index on an element within any JSON object. </p>
