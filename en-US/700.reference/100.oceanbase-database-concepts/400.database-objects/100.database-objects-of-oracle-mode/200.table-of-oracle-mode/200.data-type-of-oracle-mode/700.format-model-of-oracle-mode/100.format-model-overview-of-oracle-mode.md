...
|slug|format-model-overview-oracle-mode|

# Format model overview

In the Oracle-compatible mode of OceanBase Database, you can use format models to specify the format of datetime data or numeric data stored in the database.
