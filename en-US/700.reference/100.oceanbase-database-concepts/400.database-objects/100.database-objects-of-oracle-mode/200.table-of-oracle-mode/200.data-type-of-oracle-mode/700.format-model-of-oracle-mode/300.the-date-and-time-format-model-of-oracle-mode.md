...
|slug|the-date-and-time-format-model-of-oracle-mode|
...
| TZR | Yes | The region information of the time zone, such as US/Pacific.  Valid in timestamp and interval formats, but not in `DATE` formats.  |
