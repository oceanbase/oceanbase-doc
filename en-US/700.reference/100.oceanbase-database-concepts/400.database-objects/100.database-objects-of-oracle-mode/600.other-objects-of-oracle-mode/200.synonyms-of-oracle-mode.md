...
/*Log in to the database as the SYS user. The synonym is not created.*/
...
/*Log in to the database as the SYS user and grant the user the CREATE SYNONYM privilege.*/
