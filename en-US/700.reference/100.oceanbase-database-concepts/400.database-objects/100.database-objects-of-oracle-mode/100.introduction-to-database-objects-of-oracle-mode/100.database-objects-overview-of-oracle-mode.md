...
|slug|database-objects-overview-oracle-mode|

# Database objects overview

Database objects are components of a database and can be operated and used through SQL statements. This topic provides an overview of the supported types of database objects and their storage methods in the Oracle-compatible mode of OceanBase Database. Additionally, it explores the relationships and dependencies between these objects.

The database objects supported in the Oracle-compatible mode of OceanBase Database include tables, views, indexes, partitions, sequences, synonyms, triggers, and various procedural language (PL) objects like PL subprograms and packages.

Authorized users in the Oracle-compatible mode of OceanBase Database can access the database and have ownership of specific database objects.
