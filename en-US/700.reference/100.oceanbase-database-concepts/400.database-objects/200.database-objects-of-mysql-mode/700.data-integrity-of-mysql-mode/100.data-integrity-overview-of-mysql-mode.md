...
|slug|data-integrity-overview-mysql-compatible-mode|

# Overview

In the MySQL-compatible mode of OceanBase Database, tenants can use integrity constraints to prevent the insertion of invalid data into tables. This chapter mainly introduces the types and application scenarios of integrity constraints.
