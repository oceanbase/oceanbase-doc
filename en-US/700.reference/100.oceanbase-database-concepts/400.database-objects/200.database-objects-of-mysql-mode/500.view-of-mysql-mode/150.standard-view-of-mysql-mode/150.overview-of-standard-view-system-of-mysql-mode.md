...
|slug|standard-view-system-overview-mysql-mode|
...
<table>
  ...
  <tr>
    <td rowspan="2">Oracle-compatible views in MySQL-compatible tenants</td>
    <td>Data dictionary views</td>
...
* `information_schema.*`:
   Views of this type display database metadata of MySQL-compatible tenants, including the names of databases or tables, data types of columns, and access privileges.
* `mysql.*`:
