...
Views can package complex queries to simplify the queries from applications. You can query views the same way you query normal tables.
...
- [Materialized views](200.materialized-view-overview-of-mysql-mode.md)
