...
In addition to regular columns, the MySQL mode of OceanBase Database also supports virtual columns (also known as generated columns) and auto-increment columns.
...
* Their values are globally unique across multiple partitions.

* Their values increase in sequence within a statement.
