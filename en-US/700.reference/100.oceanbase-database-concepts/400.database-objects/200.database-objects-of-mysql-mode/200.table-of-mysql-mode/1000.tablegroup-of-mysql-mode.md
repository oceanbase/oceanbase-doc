...
1. **Table groups with SHARDING = PARTITION**:
   ...
   - In these table groups, data is partitioned at the first level, and all subpartitions of the same partition are aggregated. The partitioning definitions of all partitions must be the same to allow the coexistence of partitions and subpartitions.
