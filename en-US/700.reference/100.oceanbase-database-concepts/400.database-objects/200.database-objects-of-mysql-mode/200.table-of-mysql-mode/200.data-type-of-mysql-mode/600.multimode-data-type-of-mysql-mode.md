...
<main id="notice" type='notice'>
  <h4>Notice</h4>
  <ul>
  <li>Currently, the MySQL-compatible mode of OceanBase Database supports only the multi-model data types GIS and JSON. </li>
  <li>In MySQL-compatible mode, a JSON-based virtual generation function can create a secondary index on an element within any JSON object. </li>
  </ul>
</main>