...
In this example, the log stream with the ID (`LS_ID`) of `1003` is a broadcast log stream. All replicated tables of the current tenant are created in this log stream. For more information about broadcast log streams, see [Overview](../../../../../600.manage/300.replica-management/100.replica-introduction.md).
...
For more information about database connection methods, see [Overview](../../../../../300.develop/100.application-development-of-mysql-mode/100.connect-to-oceanbase-database-of-mysql-mode/100.connection-methods-overview-of-mysql-mode.md).
