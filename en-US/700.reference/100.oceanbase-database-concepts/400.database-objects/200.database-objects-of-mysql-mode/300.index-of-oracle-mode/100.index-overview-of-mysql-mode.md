...
|slug|index-overview-of-mysql-mode|
...
An index created based on the values of one or more columns in a table is called a function-based index. Function-based indexes are an optimization technique that allows you to quickly locate matching function values during queries, avoiding redundant calculations and improving query efficiency.
