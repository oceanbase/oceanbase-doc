...
mode:1, // The compatibility mode. Valid values: 0 and 1. The value 0 indicates the MySQL-compatible mode. The value 1 indicates the Oracle-compatible mode.
