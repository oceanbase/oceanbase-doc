...
* system_cpu_quota
  ...
  The number of virtual CPU cores of the `sys` tenant. This parameter is not directly related to the physical CPU. It only affects the initial and maximum sizes of the multi-tenant thread pool.
...
* large_query_threshold
  ...
  The value range is [1 ms, +∞], with the default value of 5s. This parameter takes effect immediately after it is modified.
