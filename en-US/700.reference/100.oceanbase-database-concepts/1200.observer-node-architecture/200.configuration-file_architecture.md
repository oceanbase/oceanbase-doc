...
In MySQL-compatible mode, you can use the following SQL syntax to modify a parameter:
...
In Oracle-compatible mode, you can use the following SQL syntax to modify a parameter:
...
When an OBServer node starts, it first loads the parameters from the configuration file. The loading order is:
