...
* Format
  ...
  ```javascript
  [Time] Log level [Module] File:Line number [Thread ID] [0] [trace_id] [lt] [Number of discarded logs]
  ```
...
* Parameters
  ...
  | File:Line number | The source code file path and line number, which indicates the location of the source code where the log was generated. |
