...
OceanBase Connector/C is a C/C++-based OceanBase client development component that supports the C API library.

OceanBase Connector/C allows C/C++ programs to access OceanBase distributed clusters in a low-level manner for operations such as database connection, data access, error handling, and prepared statement processing.
...
For more information about the following functions, see the C API function documentation of OceanBase Connector/C.
