...
In the MySQL mode of OceanBase Database, you can use official MySQL connectors to access OceanBase Database. In the Oracle mode, you must use the proprietary database drivers of OceanBase Database. The following sections describe the drivers provided by OceanBase Database.
