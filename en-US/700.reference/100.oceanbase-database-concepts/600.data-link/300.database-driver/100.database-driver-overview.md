...
In the MySQL mode of OceanBase Database, users can directly use official MySQL Connectors to access OceanBase Database. In the Oracle mode, users must use the proprietary database drivers of OceanBase Database. The following sections describe the drivers provided by OceanBase Database.
