...
A full-featured replica is also called a Paxos replica. Paxos replicas can constitute a Paxos group and participate in leader election and log voting. A read-only replica is also called a non-Paxos replica. Non-Paxos replicas cannot constitute a Paxos group or participate in leader election or log voting.
