...
* Cannot join a Paxos group or participate in log voting as a Paxos member. Instead, it acts as a listener to follow up logs of a Paxos member in real time and replays the logs locally. This type of replicas do not act as voting members and therefore cause no delay in transaction commits.
...
| Resource cost           | High                                             |
| Service             | It supports non-consistent read.                                        |
