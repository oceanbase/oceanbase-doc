...
# Distributed database objects overview
...
OceanBase Database adopts the shared-nothing architecture. User data is organized based on log streams and tablets. A tablet stores data, can be transferred between servers, and is the smallest unit for data balancing.
