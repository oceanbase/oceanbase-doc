...
* Identity authentication
  ...
  OceanBase Database supports identity identification and authentication, user management, and role management. It also provides password security enhancements through the Authentication Plugin to improve database security. For more information, see [Identity authentication](../1100.database-security/200.identity-authentication.md).
