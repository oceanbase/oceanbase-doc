...
# Transaction isolation levels in MySQL-compatible mode

## Isolation levels supported in MySQL-compatible mode

The MySQL-compatible mode of OceanBase Database supports the following isolation levels:
...
MySQL Database supports four isolation levels: **read uncommitted**, **read committed**, **repeatable read**, and **serializable**. The MySQL-compatible mode of OceanBase Database shows some differences in behavior compared with the MySQL database across these four isolation levels.
