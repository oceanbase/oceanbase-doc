...
* MySQL-compatible mode
   ...
   * Serializable
     ...
     The serializable isolation level in the MySQL-compatible mode is similar to the serializable level in Oracle Database but does not strictly adhere to the concept of serializable.
