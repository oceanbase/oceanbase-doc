...
* The write statements and SFU statement support only strong consistency. If the consistency level of the transaction that contains the preceding statements is WEAK, `OB_NOT_SUPPORTED` is reported.
