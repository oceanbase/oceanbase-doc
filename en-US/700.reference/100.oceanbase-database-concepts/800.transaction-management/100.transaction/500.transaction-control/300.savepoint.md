...
For example, if you make mistakes in operations after defining a savepoint, you do not need to roll back the entire transaction and execute it again. Instead, you can run the `ROLLBACK TO` command to roll back only operations after the savepoint.
