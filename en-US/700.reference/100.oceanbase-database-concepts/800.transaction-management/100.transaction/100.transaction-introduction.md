...
* Isolation
  ...
  OceanBase Database supports the Oracle and MySQL modes. In Oracle mode, the Read Committed and Serializable transaction isolation levels are supported. In MySQL mode, the Read Committed, Repeatable Read, Read Uncommitted, and Serializable transaction isolation levels are supported.
