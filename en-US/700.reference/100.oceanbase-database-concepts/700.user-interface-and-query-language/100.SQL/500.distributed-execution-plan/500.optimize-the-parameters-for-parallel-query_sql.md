...
`EXCHANGE` (shuffle) parameters specify the memory for data shuffle between data flow operations (DFOs). OceanBase Database encapsulates its data transfer service into a module called Data Transfer Layer (DTL).
