...
* Data redistribution
   ...
   When the join key is unrelated to the partitioning keys of both tables, you can choose `BROADCAST` or `HASH HASH` for data redistribution based on rules. See the following example:
