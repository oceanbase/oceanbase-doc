...
* You can create a trigger only for a permanent table, but not for a temporary table.
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p><ul><li>Starting from OceanBase Database V4.1.0 BP4, the temporary table feature is disabled in MySQL-compatible mode.</li><li>For V4.4.x versions, the temporary table feature is supported in MySQL-compatible mode starting from V4.4.2.</li></ul></p>
  </main>
