...
* You can create a trigger only for a permanent table, but not for a temporary table.
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p><ul><li>Starting from OceanBase Database V4.1.0 BP4, the temporary table feature is disabled in MySQL mode. <li>For V4.4.x versions, the temporary table feature is supported in MySQL mode starting from V4.4.2. </li></p>
  </main>
