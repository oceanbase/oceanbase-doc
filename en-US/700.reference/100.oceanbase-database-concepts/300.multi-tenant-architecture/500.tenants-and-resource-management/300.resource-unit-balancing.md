...
OceanBase Database provides the following parameters for you to manage load balancing for resource units:
...
* [enable_rebalance](../../../800.configuration-items-and-system-variables/100.system-configuration-items/400.tenant-level-configuration-items/2800.enable_rebalance.md)
  ...
  This parameter is the master switch for load balancing and controls resource unit balancing.
...
* [server_balance_disk_tolerance_percent](../../../800.configuration-items-and-system-variables/100.system-configuration-items/300.cluster-level-configuration-items/19700.server_balance_disk_tolerance_percent.md)
  ...
  This parameter specifies the tolerance for disk imbalance in the resource unit (unit) balancing strategy between nodes. A node will participate in disk-based unit balancing only when its disk water level exceeds the average disk water level of nodes in the same zone by the value specified in `server_balance_disk_tolerance_percent`.
...
* [server_balance_critical_disk_waterlevel](../../../800.configuration-items-and-system-variables/100.system-configuration-items/300.cluster-level-configuration-items/19600.server_balance_critical_disk_waterlevel.md)
  ...
  This parameter specifies the water level for disk space load balancing. When the disk water level exceeds the value specified in `server_balance_critical_disk_waterlevel`, the load balancing strategy will prioritize disk balancing.
