...
Compared with Docker and VMs, OceanBase Database offers more lightweight tenant isolation and is easier to implement priority and other advanced features. From the perspective of OceanBase Database requirements, Docker or VMs have the following disadvantages:
...
unit_status:"NORMAL", // The status of the resource unit. Valid values: UNIT_NORMAL, UNIT_MIGRATE_IN, UNIT_MIGRATE_OUT, UNIT_MARK_DELETING, UNIT_WAIT_GC_IN_OBSERVER, UNIT_DELETING_IN_OBSERVER, and UNIT_ERROR_STAT.
