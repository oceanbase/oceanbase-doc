...
* **Preliminary application in financial business**
   ...
   OceanBase Database entered Alipay (later Ant Group) and started to be applied in financial-grade business scenarios. During the Double 11 shopping festival in 2014, OceanBase Database began to handle a portion of the transaction database's traffic. Subsequently, the newly established MYbank ran all its core transaction databases on OceanBase Database.
...
* **Reaching new heights**
   ...
   In 2019, OceanBase Database V2.2 participated in TPC-C, the world's most authoritative OLTP database benchmark, and topped the world rankings with a score of 60 million tpmC. Subsequently, in 2020, it set a new record with 700 million tpmC. This fully demonstrates the excellent scalability and stability of OceanBase Database. It was the first distributed database to enter the TPC-C rankings and the first Chinese database to make the list.
...
* **Open source**
   ...
   On June 1, 2021 (Children's Day), OceanBase Database announced that it was fully open source, open for cooperation, and committed to building an ecosystem together.
