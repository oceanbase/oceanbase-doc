...
* Oracle-compatible mode: `AS OF SCN` and `AS OF TIMESTAMP`

* MySQL-compatible mode: `AS OF SNAPSHOT`
...
For detailed operations and examples of flashback queries, see [Flashback query](../../../../600.manage/400.high-availability/600.manage-flashback-query.md).
