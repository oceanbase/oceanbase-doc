...
The `PURGE` command permanently deletes the information about an object from the recycle bin of OceanBase Database, and the actual data is also recycled. When a parent object is purged, the associated child objects in the recycle bin are also purged.
