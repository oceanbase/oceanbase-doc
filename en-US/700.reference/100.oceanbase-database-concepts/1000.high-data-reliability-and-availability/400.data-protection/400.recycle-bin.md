...
In the current version, objects that can be moved to the recycle bin are indexes, tables, databases, and tenants. The following table describes the objects that can be moved to the recycle bin in different modes.
