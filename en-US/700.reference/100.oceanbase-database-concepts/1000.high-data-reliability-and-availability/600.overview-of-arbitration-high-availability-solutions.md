...
<main id="notice" >
<h4>Applicability</h4>
<p>This content applies only to OceanBase Database Enterprise Edition. OceanBase Database Community Edition does not support the arbitration service. </p>
</main>
...
For a comparison of disaster recovery solutions, see [Disaster recovery deployment plan](200.disaster-recovery-deployment-plan.md).
...
![Arbitration deployment example](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer/V4.3.5/%E9%85%8D%E7%BD%AE%E4%BB%B2%E8%A3%81%E6%9C%8D%E5%8A%A1.jpg)
...
The following figure illustrates the principle of automatic upgrade and downgrade. During a downgrade, failed full-featured replicas are changed to the Learner role; during an upgrade, the reverse change is performed and Learners are changed back to full-featured replicas.

<!-- ![Principle of automatic upgrade and downgrade](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer/V4.3.5/%E8%87%AA%E5%8A%A8%E5%8D%87%E9%99%8D%E7%BA%A7%E6%9C%BA%E5%88%B6.jpg) -->
...
After the arbitration service is enabled in an OceanBase cluster, you can replace or remove the arbitration service.
