...
## How the Paxos consensus protocol works

For more information about the principle of Paxos, see [Paxos Made Simple](https://www.microsoft.com/en-us/research/uploads/prod/2016/12/paxos-simple-Copy.pdf).

## Relationship between the Paxos and election protocols of OceanBase Database

The Paxos and election protocols of OceanBase Database together form the consensus protocol (log service). The two are related to some extent but are implemented with minimal coupling.
