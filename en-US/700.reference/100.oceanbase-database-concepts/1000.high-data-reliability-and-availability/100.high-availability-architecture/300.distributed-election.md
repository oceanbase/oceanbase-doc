...
When the lease expires, the leader cannot be connected to the majority of replicas, and a new round of elections will be initiated to elect the next leader. The default lease period is 4s.
