...
<h4>Note</h4>
<p>Because different versions of zlib may cause inconsistent compression results for the same data, OceanBase Database no longer supports the <code>zlib_1.0</code> compression algorithm starting from V4.2.2. This change is aimed at preventing issues with restoring replica data during the upgrade process.</p>
</main>
