...
Valid values of the `compression` option in MySQL-compatible mode are as follows:
...
The following table describes the valid values of the `row_format` option in MySQL-compatible mode.
...
The following table describes the valid values of compression options in Oracle-compatible mode.
