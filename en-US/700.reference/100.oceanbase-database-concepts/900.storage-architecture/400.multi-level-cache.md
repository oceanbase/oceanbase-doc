...
The preceding figure uses a typical table get to illustrate the various cache types in OceanBase Database that serve the query process. the various cache types in OceanBase Database that serve the query process.
