...
| Variable | Description |
|----------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------|
| [time_zone](../200.system-variable-for-mysql/12700.time_zone-1-2-3.md) | The session time zone of the current tenant. The value can be an offset, such as `'+08:00'`, or a geographical location, such as, `Asia/Shanghai`.  |
...
| Variable | Description |
|---------------------------------------------------------------------|-------------------------------------------------------|
| [debug_sync](../200.system-variable-for-mysql/2200.debug_sync-1-2-3.md) | The synchronization point during debugging, which is compatible with MySQL.  |
...
| [ob_enable_rich_error_msg](14600.ob_enable_rich_error_msg.md) | Specifies whether to display information such as svr_ip, time, and trace_id when an error occurs during SQL execution.  |
