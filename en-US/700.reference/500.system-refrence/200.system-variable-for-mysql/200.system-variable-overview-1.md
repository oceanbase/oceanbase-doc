...
| [ob_proxy_set_trx_executed](89.ob_proxy_set_trx_executed-1-2-3.md) | Specifies whether to send `START TRANSACTION Syntax` to OBServer nodes by using obproxy.  |
...
| [init_connect](30.init_connect-1-2-3.md) | The character string that the server executes for each connected client. The string consists of one or more SQL statements which are separated by semicolons (<span>;</span>).  |
...
| [max_user_connections](40.max_user_connections-1-2-3.md) | The maximum number of simultaneous connections that a single user can set up with OBServer nodes. When the value is set to `0`, the number of connections is not limited.  |
...
| Variable | Description |
|----------------------------------------------------------------------------------|-------------------------------------------|
| [version_comment](136.version_comment-1-2-3.md) | The version information of the OBServer node.  |
| [version](135.version-1-2-3-4.md) | The version number of the OBServer node.  |
| [ob_last_schema_version](79.ob_last_schema_version-1-2-3.md) | The latest schema version used in the session.  |
| [ob_proxy_global_variables_version](87.ob_proxy_global_variables_version-1-2-3.md) | Specifies the latest version of global variables that needs to be returned by the OBServer node to obproxy.  |
...
| [net_buffer_length](41.net_buffer_length-1-2-3.md) | The SQL query size acceptable to the OBServer node.  |
...
| [ob_enable_transmission_checksum](76.ob_enable_transmission_checksum-1-2-3.md) | Specifies whether to perform checksum comparisons on packets transmitted between obproxy and OBServer nodes. The setting takes effect immediately.  |
...
| [ob_capability_flag](62.ob_capability_flag-1-2-3.md) | The capabilities that the OBServer node can provide. It is used to inform obproxy of the features supported and unsupported by the OBServer node during capability negotiation between the OBServer node and obproxy.  |
| [ob_compatibility_mode](63.ob_compatibility_mode-1-2-3.md) | The compatibility mode of a tenant.  |
| [ob_route_policy](93.ob_route_policy-1-2-3.md) | The routing strategy for retries between the OBServer node and obproxy or Java clients.  |
...
| [ob_proxy_partition_hit](88.ob_proxy_partition_hit-1-2-3.md) | Specifies whether to enable obproxy to send the data requested by SQL statements to the OBServer node where the primary partition of the data is located.  |
...
| [server_uuid](144.server_uuid.md) | The UUID of the OBServer node.  |
| [default_storage_engine](145.default_storage_engine.md) | The default storage engine of the OBServer node.  |
