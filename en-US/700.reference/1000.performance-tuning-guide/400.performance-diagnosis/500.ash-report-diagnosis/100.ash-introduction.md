...
## Scenarios
 ...
 ASH reports are used to diagnose the following types of exceptions and issues that occur transiently: This issue may arise in the following scenario:
...
ASH reports provide you with the information about SQL statements that use a large amount of database resources during a diagnosis period, the execution details of historical sessions of an OceanBase cluster, and other information. You can optimize the SQL statements based on the information and improve the SQL execution efficiency.
