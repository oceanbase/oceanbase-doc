...
This topic describes how to perform performance monitoring and diagnosis for OceanBase clusters.
...
|----------|-----------------------------------------------------------------------------------------|
| Select Time (also called: monitoring window) | This parameter is not displayed in auto-refresh mode. Select a time range to return data within that range.  |
...
| Module | Description |
|------|-------------------------------------|
| Basic information | Includes version, node resources, tenant resources, data partitions, and other information.  |
