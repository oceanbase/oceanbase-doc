...
The deployment details are crucial and impact SQL forwarding, transaction model, and performance, among other aspects. Here are the key points:
...
You can evaluate whether the response time (RT) of a single SQL statement conforms to the expectation based on the delay information. The specific delay information of the entire cluster is as follows:

* Inter-room latency;

* Zone latency;

* OBProxy to OBServer delay;
