...
* Index Nested Loop Join
  ...
  In the `outputs & filters` output, if the `nl_param` parameter contains `[t2.c1]`, it indicates that the condition pushdown optimization is performed. For more information, see [JOIN](../../../../../1000.performance-tuning-guide/500.sql-optimization/200.sql-execution-plan/200.execution-plan-operator/300.JOIN.md).
