|slug|query-the-top-n-requests-with-the-most-execution-time|
|---|---|

# Find the TOP N queries with the longest execution time within a certain period

You can execute the following statement to find the TOP N queries with the longest execution time within a certain period:
