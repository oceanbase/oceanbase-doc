...
In some scenarios, performance bottlenecks may occur due to load imbalance between nodes. You can execute the following statement to query the distribution of SQL traffic and QPS among OBServer nodes:
