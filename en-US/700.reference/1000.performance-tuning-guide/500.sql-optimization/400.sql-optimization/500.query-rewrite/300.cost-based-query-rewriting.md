...
Many advanced rewriting rules in databases (such as Complex View Merge and window function rewrite) require cost-based rewriting. OceanBase Database will support these complex rewriting rules in later versions.
