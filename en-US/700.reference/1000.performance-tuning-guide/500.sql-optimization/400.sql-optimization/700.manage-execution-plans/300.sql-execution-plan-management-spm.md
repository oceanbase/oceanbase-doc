...
- ACCEPT_SQL_PLAN_BASELINE (MySQL-compatible mode) <temp-hide-link>
- ALTER_SQL_PLAN_BASELINE (MySQL-compatible mode) <temp-hide-link>
- CANCEL_EVOLVE_TASK (MySQL-compatible mode) <temp-hide-link>
- CONFIGURE (MySQL-compatible mode) <temp-hide-link>
- DROP_EVOLVE_TASK (MySQL-compatible mode) <temp-hide-link>
- DROP_SQL_PLAN_BASELINE (MySQL-compatible mode) <temp-hide-link>
- LOAD_PLANS_FROM_CURSOR_CACH (MySQL-compatible mode) <temp-hide-link>

In Oracle-compatible mode:

- ACCEPT_SQL_PLAN_BASELINE (Oracle-compatible mode) <temp-hide-link>
- ALTER_SQL_PLAN_BASELINE (Oracle-compatible mode) <temp-hide-link>
- CANCEL_EVOLVE_TASK (Oracle-compatible mode) <temp-hide-link>
- CONFIGURE (Oracle-compatible mode) <temp-hide-link>
- DROP_EVOLVE_TASK (Oracle-compatible mode) <temp-hide-link>
- DROP_SQL_PLAN_BASELINE (Oracle-compatible mode) <temp-hide-link>
- LOAD_PLANS_FROM_CURSOR_CACH (Oracle-compatible mode) <temp-hide-link>