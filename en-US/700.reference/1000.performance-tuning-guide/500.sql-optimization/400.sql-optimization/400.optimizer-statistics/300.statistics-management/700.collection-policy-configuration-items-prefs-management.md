...
## Statistics collection policy Prefs parameters

In Oracle-compatible mode, the following virtual tables are provided for you to query the current Prefs settings:
...
## Statistics policy Prefs setting and retrieval

### Global statistics policy Prefs setting and retrieval

Global statistics policy Prefs are set and retrieved by using the following stored procedures:
...
### Table-level statistics policy Prefs setting and retrieval

Table-level statistics policy Prefs are set and retrieved by using the following stored procedures:
...
|---------|-----------------------------------|
| ownname | <ul><li>Oracle-compatible mode: the username. If the parameter is set to `NULL`, the current login username is used by default. </li><li>MySQL-compatible mode: the name of the database to which the table belongs.  |
