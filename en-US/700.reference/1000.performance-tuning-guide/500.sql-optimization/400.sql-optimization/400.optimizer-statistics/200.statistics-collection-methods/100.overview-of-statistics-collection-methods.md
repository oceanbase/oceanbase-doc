...
OceanBase Database provides views compatible with Oracle Database that display the statistics collection status in Oracle-compatible mode. The following table describes these views.
...
The following table describes the views that display statistics in the MySQL-compatible mode of OceanBase Database.
