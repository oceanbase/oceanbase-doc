...
| Oracle mode | sys.ALL_VIRTUAL_TENANT_SCHEDULER_JOB_REAL_AGENT | Query the agent table for job information |
...
| Mode | View name | Description |
| --- | --- | --- |
| Oracle mode | GV\$DML_STATS, V\$DML_STATS | Query the DML STATS of tables recorded in the virtual table |
| Oracle mode | sys.ALL_VIRTUAL_MONITOR_MODIFIED_REAL_AGENT | Query the DML STATS of tables recorded in the agent table |
| Oracle mode | ALL_TAB_MODIFICATIONS, DBA_TAB_MODIFICATIONS, USER_TAB_MODIFICATIONS | Query all DML STATS in the table |
| MySQL mode | oceanbase.GV\$DML_STATS, oceanbase.V\$DML_STATS | Query the DML STATS of tables recorded in the virtual table |
| MySQL mode | oceanbase.DBA_TAB_MODIFICATIONS | Query all DML STATS in the table |
