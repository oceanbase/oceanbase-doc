...
When the tenant-level parameter `enable_sql_extension` is set to `TRUE`, you can use the Oracle mode syntax, which is an extended syntax provided by OceanBase Database for MySQL mode.
