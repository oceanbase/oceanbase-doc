# Collection and update strategy of partition table statistics

In OceanBase Database, the statistics of partitioned tables are managed at the **partition level** and **global level**. This statistics mechanism applies only to partitioned tables. For non-partitioned tables (i.e., regular single tables), there is only a single global statistics, and there is no partition statistics or derivation logic involved.

The statistics mechanism for partitioned tables in OceanBase Database has the following characteristics:

1. **Distinguish global and partition statistics**: They are stored separately and distinguished by `partition_id`.
2. **Default simultaneous collection**: At the `APPROX_GLOBAL AND PARTITION` level, both global and partition statistics are collected simultaneously.
3. **Automatic detection of missing or expired statistics**: Automatically detects missing or expired statistics and triggers collection.
4. **Derive global statistics from partition statistics**: Derive global statistics based on partition statistics to improve the timeliness and accuracy of global statistics.
...
This example is based on OceanBase Database (MySQL mode) and demonstrates how to create a partitioned table, view the collection and automatic update behavior of its statistics, and show how global statistics can be derived from partition statistics.
...
- [SET_GLOBAL_PREFS in MySQL mode](../../../../600.pl-reference/200.pl-mysql/1000.pl-system-package-mysql/15900.dbms-stats-mysql/3800.set-global-prefs-mysql.md)
- [SET_SCHEMA_PREFS in MySQL mode](../../../../600.pl-reference/200.pl-mysql/1000.pl-system-package-mysql/15900.dbms-stats-mysql/4000.set-schema-prefs-mysql.md)
- [SET_TABLE_PREFS in MySQL mode](../../../../600.pl-reference/200.pl-mysql/1000.pl-system-package-mysql/15900.dbms-stats-mysql/4100.set-table-prefs-mysql.md)
- [SET_GLOBAL_PREFS in Oracle mode](../../../../600.pl-reference/300.pl-oracle/1400.pl-system-package-oracle/15900.dbms-stats-oracle/3800.set-global-prefs-oracle.md)
- [SET_SCHEMA_PREFS in Oracle mode](../../../../600.pl-reference/300.pl-oracle/1400.pl-system-package-oracle/15900.dbms-stats-oracle/4000.set-schema-prefs-oracle.md)
- [SET_TABLE_PREFS in Oracle mode](../../../../600.pl-reference/300.pl-oracle/1400.pl-system-package-oracle/15900.dbms-stats-oracle/4100.set-table-prefs-oracle.md)