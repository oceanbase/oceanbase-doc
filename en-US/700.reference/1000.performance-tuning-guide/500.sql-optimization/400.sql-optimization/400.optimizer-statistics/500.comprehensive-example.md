...
The following examples are based on the MySQL-compatible mode. The operations are fully compatible in the Oracle-compatible mode, so no further details are provided.
...
1. Query table-level statistics.
...
2. Query column-level statistics
...
1. Export statistics to a user table.
...
2. Restore historical statistics.
...
3. Delete historical statistics.
