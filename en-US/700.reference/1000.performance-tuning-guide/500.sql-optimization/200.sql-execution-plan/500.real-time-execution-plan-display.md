...
| REAL_CARDINALITY | The actual number of output rows of the current operator during the first execution of the plan based on the execution feedback. |
...
| PARTITION_START | The partition scanned by the `TABLE SCAN` operator. |
