...
You can enable SQL plan monitor by setting [`enable_perf_event`](../../../800.configuration-items-and-system-variables/100.system-configuration-items/300.cluster-level-configuration-items/7700.enable_perf_event.md) to `true`.
