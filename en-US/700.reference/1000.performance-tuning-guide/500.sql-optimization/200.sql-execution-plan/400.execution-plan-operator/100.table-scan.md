...
<main id="notice">
  <h4>Applicability</h4>
  <p>The MySQL-compatible tenant of OceanBase Database does not support the <b>CONNECT BY LEVEL</b> syntax as shown in query Q4. </p>
</main>
...
<main id="notice">
  <h4>Applicability</h4>
  <p>String-to-number conversion is not supported in MySQL-compatible tenants of OceanBase Database. </p>
</main>
