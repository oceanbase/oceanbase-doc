...
You can manually specify a DOP for a table so that the table is always scanned based on the specified DOP. The syntax for specifying a DOP varies in Oracle-compatible mode and MySQL-compatible mode. 

### Manually specify a DOP in MySQL-compatible mode
...
### Manually specify a DOP in Oracle-compatible mode
