...
- Increase the value of the `parallel_min_time_threshold` variable to make it harder to trigger parallel execution and reduce the utilization of parallel execution resources.
