...
* Execute the following statement in a user tenant to disable parallel table creation for the tenant:
    ...
    **Oracle-compatible mode:**
    ...
    <main id="notice" type='explain'>
      <h4>Note</h4>
      <p>In Oracle-compatible mode, the parameter must be enclosed in double quotation marks in the syntax. </p>
    </main>
...
* Execute the following statement in a user tenant to disable parallel table truncation and enable parallel index creation for the tenant:
    ...
    **Oracle-compatible mode**:
    ...
    <main id="notice" type='explain'>
      <h4>Note</h4>
      <p>In Oracle-compatible mode, hidden parameters need to be enclosed with double quotation marks (" ") in terms of the syntax. </p>
    </main>
