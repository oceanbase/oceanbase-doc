...
DOP variables determine the number of parallel workers in each query.

| **Variable** | **Description** | **Value range** | **Default value** | **Recommended configuration** |
|-------------------------|-----------------------------|-------------|-----------------------------|-------------------------------------|
...
You can use `SHOW VARIABLES` to view the value of these variables, as shown in the following example:
