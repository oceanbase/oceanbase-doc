...
A granule is the smallest unit of parallel work for data scanning:

* A granule describes a continuous range of data scanning tasks and is strictly limited to a single table partition.
