...
* `%util`: the percentage of CPU time occupied by I/O requests. 
  ...
  <main id="notice" type='explain'>
    <h4>Note</h4>
    <p><code>%util</code> indicates the I/O utilization of the disk. A high value usually indicates that I/O may become a bottleneck. In addition, await = average I/O service time + I/O wait time. Therefore, if await is far greater than svctm, the I/O wait time is long and the I/O queue is large.</p>
  </main>
