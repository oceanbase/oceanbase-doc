...
Top is a commonly used performance analysis tool in Linux. It displays the system load, memory usage, and resource usage of each process in real time. 
...
You can use the following interactive commands to view more information:
