...
Follow the disk metrics and refer to the percentage of CPU time consumed for I/O waiting to evaluate system I/O performance bottlenecks. 
...
The larger these two values are, the more CPU time threads consume. Under normal circumstances, the value of cs should be smaller than that of in. If the value of cs is larger than that of in, the system may need to process a lot of I/O requests or high-intensity system calls for a long period. 
