...
| CONSISTENCY_LEVEL | bigint(20) | NO | The consistency level. Valid values include: <ul><li>`-1`: Invalid.</li> <li>`1`: Reads data stored in SSTable.</li><li>`2`: Weak consistency read.</li><li>`3`: Strong consistency read.</li></ul> |
