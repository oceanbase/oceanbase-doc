...
| max_syslog_file_count | The maximum allowed number of observer.log files. The log files are automatically recycled when the specified number is reached. | We recommend that you adjust the value based on the disk space. |
