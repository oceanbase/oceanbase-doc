...
* Cause: The `RAISE_APPLICATION_ERROR` procedure was called, which generated this error.

* Solution: Fix the issue described in the error message, or contact the application administrator or DBA for more information.
