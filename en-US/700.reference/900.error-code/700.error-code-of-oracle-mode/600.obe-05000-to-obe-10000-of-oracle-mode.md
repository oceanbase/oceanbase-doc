...
* Error code in OceanBase Database: 9825

* SQLSTATE: HY000

* Cause: An error occurred during the execution of the PL/SQL code coverage process.

* Solution: Check the error stack for details.
