...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The source transaction data table for migration was reclaimed. During copying to the destination, it was found that the transaction data table was discontinuous, causing a failure and prompting a retry.
=======
...
* Cause: A transfer system error occurred.
...
* Cause: The log stream member lists at the source and destination are inconsistent during a transfer operation.

* Solution: Check the member lists at the source and destination. Verify that the disaster recovery module is running normally, check for any ongoing log stream replication tasks, and wait for them to complete.
...
* Cause: The transfer timestamp (SCN) is too small when changing the member list.
...
* SQLSTATE: HY000
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Cause: The binary geometry functions returned two different SRIDs: %u and %u. They should be the same. The geometric values passed as parameters to spatial functions must have the same SRID value.
=======
...
* SQLSTATE: HY000
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: An error occurred during the calculation of geometry turn information. The geometry data is invalid in function %s.
=======
...
* SQLSTATE: HY000
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The intersection point analysis process was unexpectedly interrupted in function %s.
=======
...
* SQLSTATE: HY000
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: An unknown exception was thrown in function %s.
=======
...
* SQLSTATE: HY000
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The geometry byte string must be in little-endian format.
=======
...
* SQLSTATE: SR001
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The function %s is defined only for Cartesian spatial reference systems, but one of its parameters is in undefined SRID %u.
=======
...
* SQLSTATE: 01000
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Cause: No spatial reference system with SRID %u exists. The axis order is unknown.
=======
...
* SQLSTATE: HY000
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Cause: The SRID of the geometry does not match the SRID of column '%s'. The geometry's SRID is %lu, but the column's SRID is %lu. Consider changing the geometry's SRID or the column's SRID attribute.
=======
...
* SQLSTATE: SR006
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The attribute %s has multiple definitions.
=======
...
* SQLSTATE: SR006
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The spatial reference system name cannot be an empty string, nor can it start or end with a space.
=======
...
* SQLSTATE: SR006
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The organization name cannot be an empty string, nor can it start or end with a space.
=======
...
* SQLSTATE: 01S01
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error message: The SRID range [%u, %u] is reserved for system use. During the upgrade process, SRSs within this range may be added, modified, or deleted without warning.
=======
...
* SQLSTATE: SR002
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The inverse flattening must be greater than 1.0, or 0.0 if the ellipsoid is a sphere.
=======
...
* SQLSTATE: SR002
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The prime meridian must be within (*180, 180] degrees, as specified by the SRS angular unit.
=======
...
* SQLSTATE: SU001
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The geometry passed to the %s function has SRID 0 and no length unit specified, so it cannot be converted to "%s".
=======
...
* SQLSTATE: 22S05
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The parameters of the %s function contain geometries %u and %u with different SRIDs. All geometries must have the same SRID.
=======
...
* SQLSTATE: 22S02
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error message: The longitude %f is out of the range of the function %s. It must be within the range of (%f, %f).
=======
...
* SQLSTATE: 22S03
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error message: The latitude %f is out of the range of the function %s. It must be within the range of [%f, %f].
=======
...
* SQLSTATE: HY000
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Cause: Invalid parameter error, %s in function %s.
=======
...
* SQLSTATE: HY000
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The Srid is used incorrectly. The Srid column attribute is supported only for geometry.
=======
...
* SQLSTATE: HY000
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The spatial/fulltext/hash index and explicit index order are used incorrectly.
=======
...
* SQLSTATE: 22023
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error message: The option key "%s" is invalid in the %s function.
=======
...
* SQLSTATE: 22023
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error message: The value "%s" of the option "%s" is invalid in the "%s" function.
=======
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Solution: Ensure that the data types of all columns used to create the FTS index are TEXT, such as VARCHAR, TEXT, or CHAR.
=======
...
* Cause: The `COMMIT` operation failed during direct load, possibly due to a leader switchover.
...
* Cause: The provided offset for an Append operation in object storage is inconsistent with the current object's length.
...
* Cause: When performing an Append operation in object storage, if the provided offset is smaller than the current object length for some reason, a Get request is initiated to read the overlapping content. An error is reported if the content is inconsistent.
...
* Cause: An error occurred during object storage data verification.

* Solution: This is an internal error code. Please contact technical support for troubleshooting.
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Cause: The amount of data written to disk as temporary files exceeds the configured limit.
=======
* Error reason: The amount of data written to the disk by the temporary file exceeds the set limit.
>>>>>>> V4.6.0

<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Solution: Check whether the current erroneous SQL statement generates more data than expected (for example, the maximum expected data size for temporary files on disk is 500 GB). If so, adjust the `temporary_file_max_disk_size` parameter to an appropriate value.
=======
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Cause: The `log_only` cleanup policy applies only when only log archiving is enabled and no data backup is performed. When the `log_only` cleanup policy is in effect, configuring a data backup path is not allowed.
=======
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Cause: The `log_only` cleanup policy applies only when only log archiving is enabled and no data backup is performed. When a data backup path is already configured, the cleanup policy cannot be set to `log_only`.
=======
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Solution: Check whether the tenant status is normal. For expiration cleanup scenarios, confirm whether the relevant tenant has a cleanup policy correctly configured.
=======
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Solution: Correctly mount the backup medium to ensure that all OBServer nodes of the tenant initiating the archiving/backup/restoration operation can access the same backup medium. For detailed operations on mounting NFS, refer to [Deploy NFS](../../../600.manage/600.backup-and-recovery/200.deploy-nfs.md).
=======
...
* Cause: In shared storage mode, the size of the microblock to be cached exceeds the upper limit allowed by the microblock cache (default 128KB), and the system refuses to write the microblock to the microblock cache.
...
* Cause: The log stream is in a GC state and no longer accepts new write or operation requests.

* Solution: Retry may succeed. If failures persist, contact OceanBase Technical Support for assistance.

<main id="notice" type='explain'>
<h4>Note</h4>
<p>This error code is introduced in V4.6.0 for V4.6.x versions.</p>
</main>
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
<h4>Note</h4>
<p>For V4.6.x versions, this error code is introduced in V4.6.0.</p>
=======
<h4>Note</h4>
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Cause: No backup set is available to restore to the specified time.
=======
...
* Solution: Check whether there is any DDL operation in progress on the base table of the materialized view.
...
* Cause: A table cannot be updated during its creation.

* Solution: Wait for the table creation to complete and then try again.
...
* Solution:
  ...
  * Check whether the file content is damaged or has format errors.
...
* Solution:
  ...
  * Verify that the HDFS datanode node is running normally and the network connection is intact.
...
* Solution:
  ...
  * Check the spelling of the `LOCATION` field in the external table or backup configuration.
...
* Cause:
  ...
  * The HDFS client environment is not initialized or is invalid.
  * The HDFS connection parameters are invalid.
  * The HDFS parameter settings failed.

* Solution:

  * Check whether the HDFS URI format is correct and whether the HDFS-related configurations are complete.
  * Confirm that the files required for Kerberos authentication (keytab, krb5.conf, and ticket cache) exist and the paths are correct.
  * Check the network connectivity of the HDFS cluster to ensure the namenode is accessible.
  * Check whether the `key=value` format of the HDFS custom parameters is correct and ensure there are no empty keys or values.
...
* Cause: An attempt was made to use a feature that is not yet implemented in HDFS. The current HDFS storage backend does not support pwrite and append write operations.
...
* Cause:
  ...
  * Duplicate access, possibly attempting to open a file that is already open.

  * Attempting to perform operations such as delete, mkdir, or list before a connection to HDFS is successfully established.

  * File deletion failed, possibly due to the file not existing or insufficient permissions.
...
* Solution:
  ...
  * Verify that the target path exists and has the correct format.

  * Ensure proper lifecycle management of HDFS components to avoid repeated access or operations when a connection fails to establish.
...
* Cause:
  ...
  * The spelling or case of the column name or path specified in the DDL statement does not match that in the file (format such as Parquet, ORC, and Arrow are typically case-sensitive).

  * An incorrect nested structure path was entered. For example, the intended access target is `addr.city`, but it was written as `addr_city` or `address.city` in the DDL statement.

  * In the same external table, some files lack this column.

  * Format symbol issues. For example, extra spaces, quotation marks before or after the column name, or incorrect escape characters.

* Solution:

  * Verify whether the `data_access_path` or `EXTERNAL_FILE_COLUMN_PATTERN` on the external column in the DDL statement actually exists in the file's schema.

  * When specifying nested types, use the actual hierarchical path separator of the file for precise matching.

  * If the schemas of files in different partitions differ, create separate external tables for the files lacking the column, or set a default value for that column. Avoid directly using path mapping to handle missing columns.
...
* Solution: Compare the file content with the table definition to identify the mismatched column type, and modify the table definition or the file content.
...
* Solution: Check the value of the `query_memory_limit_percentage` parameter to verify if the setting is reasonable.
...
* Solution:
  ...
  * If using `CSV`, add parameters such as the delimiter and encoding as needed to avoid successful table creation but abnormal query parsing.
...
* Cause: A data access path was not specified when creating an external table. This is usually due to the `LOCATION` parameter being unconfigured, empty, or not correctly bound to a Location object.
...
* Solution:
  ...
  * It is recommended to use a protocol prefix agreed upon with relevant personnel for the path (such as `file://`, `oss://`, `hdfs://`, etc., subject to the support of the current version).
...
* Cause: `PARSE_HEADER` and `SKIP_HEADER` cannot be used simultaneously, as they conflict in semantics.
...
* Solution: Check the Catalog permission.
...
* Error cause: A CCL rule with the same name already exists when creating the CCL rule.
...
* Error cause: The rule does not exist when modifying or deleting the CCL rule.
...
* Cause: The SQL concurrency has reached the upper limit specified by the CCL rule.
...
* Cause: The reject limit of %ld has been reached.
...
* Solution: Check all external tables that depend on this Location object to confirm if the dependency has been removed, and then re-execute the operation.
...
* Solution: Check the user's access permissions for this Location object. Grant the `READ` privilege to the user using the command `GRANT READ ON LOCATION location_name TO user_name WITH GRANT OPTION;`.
...
* Solution: Check if the specified Location object already exists. Replace the original Location object definition with a new one by adding the `OR REPLACE` keyword, or create a completely new Location object.
...
* Solution: Check whether the specified Location object already exists, and then specify a valid one.
...
* Error cause: The RPC execution of the log service failed due to insufficient resources or network issues on the target node.

* Solution: First, locate the target node logs by using the trace_id. Then, resolve the issue by checking the resource monitoring data and adjusting parameters.
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: A sensitive rule with the same name already exists. This usually occurs when adding a new sensitive rule via a DDL statement, and the new rule name duplicates an existing one.
=======
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Solution: Check whether the specified sensitive rule name already exists, and then specify a unique one.
=======
...
* Error cause: A sensitive rule with the specified name does not exist. This usually occurs when deleting a sensitive rule via a DDL statement, and the specified rule name does not correspond to any rule.

* Solution: Check whether the entered sensitive rule name is correct, and then enter a valid one.
...
* Error cause: A column with the specified name is already a sensitive column. This usually occurs when adding or modifying a sensitive rule via a DDL statement, and you attempt to apply a sensitive rule to a column that is already covered by another sensitive rule.
...
* Cause: The specified sensitive column does not exist. This typically occurs when modifying sensitive column rules via DDL statements and attempting to remove a column that is not a sensitive column.
...
* Solution: Check the user's permissions and grant the appropriate explicit access permission using the `GRANT PLAINACCESS ON SENSITIVE RULE '%.*s' TO '%.*s'@'%.*s'` command.
...
* SQLSTATE: HY000
* Cause: A property that was not defined on a database object was referenced.
...
* Solution: The key to resolving this issue is to identify the source of the restriction and adopt a bypass strategy.
...
* Solution: When encountering this error, do not forcibly perform the narrowing operation; instead, reassess the necessity of shortening the length.
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Solution: Refer to the "SQL Reference (Oracle-compatible mode)" for your corresponding OceanBase Database version to find the correct SQL statement.
=======
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The SQL statement is missing a keyword.
=======
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The specified string length exceeds the supported length for the data type. Specifically, for the CHAR and RAW data types, the specified length exceeds 2000; for other data types, the specified length exceeds 4000.
=======
...
* Solution: Correct the syntax by carefully checking the SQL statement for missing commas or incorrect comma usage.
=======
...
* [Using CREATE OR REPLACE to create an object in Oracle-compatible mode results in loss of privileges on the object](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000180193)
=======
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Cause: Column names are duplicated.
=======
...
* SQLSTATE: HY000
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: The current version does not support nested cursor variables within records, objects, or collections.
...
<<<<<<< llm_translation_of_commit_25990d6d_260605182303
* Error cause: This expression must be named with a column alias.
=======
