...
This topic describes the error messages for Oracle-compatible tenants in OceanBase Database.
...
For Oracle-compatible tenants in OceanBase Database, error messages are returned in the format of prefix+numeric code.
...
In Oracle-compatible tenants of OceanBase Database, for errors that are incompatible with Oracle databases, this error code is returned in the following format:
