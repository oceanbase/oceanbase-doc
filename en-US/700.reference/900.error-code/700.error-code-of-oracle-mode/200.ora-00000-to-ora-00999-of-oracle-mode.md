...
* [An error indicating duplicate data occurred while inserting data. Error code: ORA-00001](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000217892) -->
...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>This error code is introduced since OceanBase Database V4.2.4. </p>
</main>
...
* [An error occurred while executing the INSERT ALL statement in a trigger of a table in Oracle mode. Error code: ORA-00904](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000246038) -->
...
* [An attempt to insert data of different data types. Error code: ORA-00932](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000217851) -->
...
* Cause: The `LEVEL`, `PRIOR`, `ROWNUM`, `CONNECT_BY_ROOT`, `CONNECT_BY_ISLEAF`, and `CONNECT_BY_ISCYCLE` keywords are not allowed at the current location.

* Solution: Delete the `LEVEL`, `PRIOR`, `ROWNUM`, `CONNECT_BY_ROOT`, `CONNECT_BY_ISLEAF`, and `CONNECT_BY_ISCYCLE` keywords.
