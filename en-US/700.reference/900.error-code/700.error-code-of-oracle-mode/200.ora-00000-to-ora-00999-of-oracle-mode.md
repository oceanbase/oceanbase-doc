...
* Error cause: The source transaction data table was recycled during migration, and the destination copy found that the transaction data table was not continuous, resulting in a failure and a retry.
...
* Error cause: The arbitration service address has not been configured for the cluster.
...
* Error cause: The cluster already has a valid arbitration service address.
...
* Error cause: The timeout occurs when waiting for the tenant to be degraded during the Stop Server operation.
