...
* Cause: When the `rollbackWhenCheckFailed` parameter of the OBKV [checkAndInsertup API](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002025908) is set to `true`, this error code is thrown if the check fails.
