...
|slug|use-error-information-mysql-mode|
...
|---------------------|-------------------------|
| [0001 to 3999](../600.error-code-of-mysql-mode/200.0001-3999-of-mysql-mode.md)            | Error codes compatible with MySQL. <li>For more information about the error codes on MySQL servers, visit <br> <https://dev.mysql.com/doc/mysql-errors/8.0/en/server-error-reference.html>.   <li>For more information about the error codes on MySQL clients, visit <br> <https://dev.mysql.com/doc/mysql-errors/8.0/en/client-error-reference.html>.    |
| [4000 to 4499](../600.error-code-of-mysql-mode/300.4000-4499-of-mysql-mode.md)            | Common error codes.   |
| [4500 to 4999](../600.error-code-of-mysql-mode/400.4500-4999-of-mysql-mode.md)            | RootService error codes.  |
...
| [22998, 30926, 38104, and 38105](../600.error-code-of-mysql-mode/1100.22998-30926-38104-38105-of-mysql-mode.md) | Binary large object (BLOB) and character large object (CLOB) error codes. |
