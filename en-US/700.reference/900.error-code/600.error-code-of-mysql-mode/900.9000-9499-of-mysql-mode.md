...
* Cause: The recovery operation failed.

* Solution: Review the configuration and parameter settings for the recovery to ensure that they are consistent with the requirements and expectations of the recovery goal.
