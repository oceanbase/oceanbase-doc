...
<p>For OceanBase Database V4.3.5, this error code is introduced since V4.3.5 BP2. </p>
...
<p>For version V4.3.5, this error code was introduced starting from the V4.3.5 BP2 version.</p>
* Cause of error: The source transaction data table was recycled, and when the destination end tried to copy it, it found that the transaction data table was discontinuous, resulting in a failure and error report, followed by a retry.