...
* [An error occurred while executing the UPDATE operation on a CLOB column in Oracle-compatible mode. Error code: 5083](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000322504) -->
...
* [An error occurred while dropping or replacing a read-only view created by a normal user in Oracle-compatible mode](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000207728) -->
...
* Cause: Temporary tables in Oracle-compatible mode cannot contain invisible columns.
...
* Solution: Make sure that the value is within the range of [-12,14] in MySQL-compatible mode.
...
* [Error message "ERROR 5868: Incorrect usage of UPDATE and ORDER BY" is returned in MySQL-compatible mode](https://www.oceanbase.com/knowledge-base/oceanbase-database-1000000000209975) -->
