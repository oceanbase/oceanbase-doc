...
* Error code in OceanBase Database: 5727

* Cause: The current SQL request needs to be redirected to another OBServer node for execution.

* Solution:

  * In the normal working process of OBProxy, the client driver automatically handles the redirection.
  * If this error frequently appears in the application logs, it may indicate improper OBProxy routing configuration, frequent cluster topology changes, or network or node stability issues.
...
## ERROR 5930 (HY000): maximum open %s exceeded
