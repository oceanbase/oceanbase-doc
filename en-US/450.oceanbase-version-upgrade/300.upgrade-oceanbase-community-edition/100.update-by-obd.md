...
6. After the major compaction is completed, execute the following command to upgrade OceanBase Database.
   ...
   Here is an example where the cluster name is obtest and the target upgrade version is 4.2.0. You need to replace the cluster name and target upgrade version with the actual values.
...
6. After the major compaction is completed, run the following command to upgrade OceanBase Database.
   ...
   In this example, the cluster name is obtest, and the target upgrade version is 4.2.0. You need to replace the cluster name and target upgrade version with the actual values.
