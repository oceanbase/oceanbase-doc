...
5. Perform a major compaction on OceanBase Database.
   ...
   For more information about the fields in the `oceanbase.CDB_OB_MAJOR_COMPACTION` view, see [oceanbase.CDB_OB_MAJOR_COMPACTION](../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/9800.o-cdb_ob_major_compaction-of-sys-tenant.md).
...
5. Perform a major compaction on OceanBase Database.
   ...
   For more information about the output fields of the `oceanbase.CDB_OB_MAJOR_COMPACTION` view, see [oceanbase.CDB_OB_MAJOR_COMPACTION](../../700.reference/700.system-views/300.system-view-of-sys-tenant/200.dictionary-view-of-sys-tenant/9800.o-cdb_ob_major_compaction-of-sys-tenant.md).
