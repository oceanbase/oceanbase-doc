...
You can install an oblogproxy by using the RPM package or the source code. For more information, see [Build an oblogproxy by using the source code](/en-US/9.ecological-tools/4.CDC/3.oblogproxy/1.installation-and-deployment-2/1.installation-and-deployment-1.md). 
...
Deploy the Canal adapter. For more information, see[Deploy the RDB adapter](/en-US/7.developer-guide-1/5.migrate-data-to-oceanbase/4.use-canal-to-incrementally-migrate-data-to-oceanbase-database.md).
