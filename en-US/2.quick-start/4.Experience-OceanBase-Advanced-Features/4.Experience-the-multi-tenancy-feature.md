...
For more information about how to manage resource units, see [Manage resources](../../6.basic-database-management/3.manage-resources/1.overview-of-resource-management.md). 
