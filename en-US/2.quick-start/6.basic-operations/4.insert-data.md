...
For more information on the syntax of the `INSERT` statement, see the "[INSERT](/en-US/11.sql-reference-en/5.sql-statements/39.sql-statements-insert.md)" topic in SQL Reference. 
