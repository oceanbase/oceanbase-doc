...
3. Return the values of the corresponding `id`, `name`, and `num` fields based on the filtering condition `name = 'a'` from Table `a`. 
   ...
   For more information on the syntax of the `SELECT` statement, see the "[SELECT](/en-US/11.sql-reference-en/5.sql-statements/52.select.md)" topic in SQL Reference (MySQL Mode). 

   For more information on the syntax of the `SELECT` statement, see the "[SELECT](/en-US/11.sql-reference-en/5.sql-statements/52.select.md)" topic in SQL Reference.
