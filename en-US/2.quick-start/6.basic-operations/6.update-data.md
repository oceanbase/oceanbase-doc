...
For more information on the syntax of the `UPDATE` statement, see the "[UPDATE](/en-US/11.sql-reference-en/5.sql-statements/59.sql-statements-update.md)" topic in SQL Reference. 
