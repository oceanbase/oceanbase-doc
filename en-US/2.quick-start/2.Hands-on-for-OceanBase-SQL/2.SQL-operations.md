...
For more information about database management operations, see [Manage databases](../../7.database-object-management/1.manage-databases/1.create-a-database.md). 
...
For more information about the syntax of the `CREATE TABLE` statement, see [CREATE TABLE](../../../14.developer-guide/7.sql-reference/5.sql-statements/19.create-table.md). 
...
For more information about the syntax of the `ALTER TABLE` statement, see [ALTER TABLE](../../../14.developer-guide/7.sql-reference/5.sql-statements/7.alter-table.md). 
...
For more information about the syntax of the `DROP TABLE` statement, see [DROP TABLE](../../../14.developer-guide/7.sql-reference/5.sql-statements/33.drop-table.md). 
...
For more information about the syntax of the `CREATE INDEX` statement, see [CREATE INDEX](../../../14.developer-guide/7.sql-reference/5.sql-statements/14.create-index.md). 
...
For more information about the syntax of the `DROP INDEX` statement, see [DROP INDEX](../../../14.developer-guide/7.sql-reference/5.sql-statements/28.drop-index.md). 
...
For more information about the `INSERT` statement, see [INSERT](../../../14.developer-guide/7.sql-reference/5.sql-statements/43.sql-statements-insert.md). 
...
For more information about the syntax of the `DELETE` statement, see [DELETE](../../../14.developer-guide/7.sql-reference/5.sql-statements/25.sql-statements-delete.md). 
...
For more information about the syntax of the `UPDATE` statement, see [UPDATE](../../../14.developer-guide/7.sql-reference/5.sql-statements/68.sql-statements-update.md). 
...
For more information about the syntax of the `SELECT` statement, see [SELECT](../../../14.developer-guide/7.sql-reference/5.sql-statements/56.sql-statements-select/1.select-statement.md). 
...
For more information about transaction control statements, see [About transaction control statements](../../../14.developer-guide/4.about-dml-statements-and-transactions/2.transaction/1.about-transactional-control-statements.md). 
