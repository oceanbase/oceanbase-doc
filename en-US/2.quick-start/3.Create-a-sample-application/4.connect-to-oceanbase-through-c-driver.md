...
You need to visit the image repository and find the installation packages based on your system version. For more information, see [Software and hardware requirements](../../../1.users-guide/3.installation-and-deployment/2.download-installation-packages.md).
...
For more information about OceanBase Connector/C, see [OceanBase Connector/C Developer Guide](https://www.oceanbase.com/docs/community/connector-c-cn/V1.0.0/10000000000017244). 
