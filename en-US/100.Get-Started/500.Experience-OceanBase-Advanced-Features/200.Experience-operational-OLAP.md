...
```
After the preceding command is executed, OBD starts to run the benchmark. You can observe each step of the process:<br />![image.png](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer/V3.1.4/en-US/1.Get-Started/5.Experience-OceanBase-Advanced-Features/2.Experience-operational-OLAP.md/olap1.png)<br />![image.png](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/observer/V3.1.4/en-US/1.Get-Started/5.Experience-OceanBase-Advanced-Features/2.Experience-operational-OLAP.md/olap2.png)<br />After the data is imported, OBD automatically executes 22 SQL statements and displays the time consumed for executing each SQL statement and the total time.
<a name="b8djR"></a>
