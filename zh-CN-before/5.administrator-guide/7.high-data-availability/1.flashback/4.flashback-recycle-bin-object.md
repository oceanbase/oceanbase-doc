...
更多 `FLASHBACK` 语句的说明信息，请参见 MySQL 模式中的 [FLASHBACK](../../../10.sql-reference-mysql-mode/6.sql-statement/43.flashback-database.md) 和 Oracle 模式中的 [FLASHBACK TABLE BEFORE DROP](../../../11.sql-reference-oracle-mode/9.sql-statement-1/3.DCL/6.flashback-table-before-drop.md)。
