...
2. 分别执行以下语句，获取备份相关的参数配置信息。
   ...
   * 查看日志归档的并发度设置。
     ...
     *************************** 1. row ***************************
     ...
     更多配置项 `log_archive_concurrency` 的说明请参见 [log_archive_concurrency](../../../../12.reference-mysql-mode/3.system-configuration-items-1/3.cluster-level-configuration-items-1/129.log_archive_concurrency-1-2-3.md)。
   ...
   * 示例如下：
     ...
     *************************** 1. row ***************************
     ...
     更多配置项 `log_archive_batch_buffer_limit` 的说明请参见 [log_archive_batch_buffer_limit](../../../../12.reference-mysql-mode/3.system-configuration-items-1/3.cluster-level-configuration-items-1/127.log_archive_batch_buffer_limit-1-2-3.md)。
